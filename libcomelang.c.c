...
char* __result197__;
    ...
    while(1) {
        char buf2_229[8192];
        memset(&buf2_229, 0, sizeof(char)        *(8192)        );
        size_230=fread(buf2_229,1,8192,f);
...
char* __result204__;
    ...
    while(1) {
        char buf2_243[8192];
        memset(&buf2_243, 0, sizeof(char)        *(8192)        );
        size_244=fread(buf2_243,1,8192,f_241);
...
char* __result208__;
    ...
    while(1) {
        char buf2_249[8192];
        memset(&buf2_249, 0, sizeof(char)        *(8192)        );
        size_250=fread(buf2_249,1,8192,f_247);
...
struct list$1charph* __result210__;
    ...
    while(1) {
        char buf_254[8192];
        memset(&buf_254, 0, sizeof(char)        *(8192)        );
        if(        fgets(buf_254,8192,f)==((void*)0)) {
            break;
        }
