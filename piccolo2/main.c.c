...
struct fd_set
{
    unsigned long  int __fds_bits[(((64)+((((int)sizeof(unsigned long  int)*8))-1))/(((int)sizeof(unsigned long  int)*8)))];
};
...
typedef unsigned long  int u_register_t;
...
typedef long long int sbintime_t;
...
typedef struct anonymous_typeX15 pthread_mutexattr_t;
...
typedef struct anonymous_typeX16 pthread_condattr_t;
...
typedef struct anonymous_typeX17 pthread_once_t;
...
typedef struct anonymous_typeX18 piccolo_os_internals_t;
...
int select(int __n, struct fd_set* __readfds, struct fd_set* __writefds, struct fd_set* __exceptfds, struct timeval* __timeout);
int pselect(int __n, struct fd_set* __readfds, struct fd_set* __writefds, struct fd_set* __exceptfds, const struct timespec* __timeout, const unsigned long  int* __set);
unsigned long  int clock();
double difftime(long _time2, long _time1);
long mktime(struct tm* _timeptr);
long time(long* _timer);
char* asctime(const struct tm* _tblock);
char* ctime(const long* _time);
struct tm* gmtime(const long* _timer);
struct tm* localtime(const long* _timer);
unsigned long  int strftime(char* _s, unsigned long  int _maxsize, const char* _fmt, const struct tm* _t);
unsigned long  int strftime_l(char* _s, unsigned long  int _maxsize, const char* _fmt, const struct tm* _t, struct __locale_t* _l);
char* asctime_r(const struct tm* anonymous_var_nameX1246, char* anonymous_var_nameX1247);
char* ctime_r(const long* anonymous_var_nameX1248, char* anonymous_var_nameX1249);
struct tm* gmtime_r(const long* anonymous_var_nameX1250, struct tm* anonymous_var_nameX1251);
struct tm* localtime_r(const long* anonymous_var_nameX1252, struct tm* anonymous_var_nameX1253);
char* strptime(const char* anonymous_var_nameX1254, const char* anonymous_var_nameX1255, struct tm* anonymous_var_nameX1256);
char* strptime_l(const char* anonymous_var_nameX1257, const char* anonymous_var_nameX1258, struct tm* anonymous_var_nameX1259, struct __locale_t* anonymous_var_nameX1260);
void tzset();
void _tzset_r(struct _reent* anonymous_var_nameX1261);
void piccolo_yield();
...
unsigned int t_273;
int p_274;
int __list_values1___275[9];
void* __right_value280 = (void*)0;
void* __right_value281 = (void*)0;
struct __current_stack2__ __current_stack2__;
void* __right_value284 = (void*)0;
struct list$1int* li_285;
struct list$1int* o2_saved_286;
int it_289;
memset(&t_271, 0, sizeof(unsigned int));
memset(&p_272, 0, sizeof(int));
memset(&t_273, 0, sizeof(unsigned int));
memset(&p_274, 0, sizeof(int));
memset(&__current_stack2__, 0, sizeof(struct __current_stack2__));
    while(1) {
        while(1) {
            __current_stack2__.__list_values1___275 = &__list_values1___275;
            __current_stack2__.t_273 = &t_273;
            __current_stack2__.p_274 = &p_274;
            __current_stack2__.t_271 = &t_271;
            __current_stack2__.p_272 = &p_272;
            li_285=(struct list$1int*)come_increment_ref_count(list$1int_map(((struct list$1int*)(__right_value281=(__list_values1___275[0]=1,
__list_values1___275[1]=2,
__list_values1___275[2]=3,
__list_values1___275[3]=4,
__list_values1___275[4]=5,
__list_values1___275[5]=6,
__list_values1___275[6]=7,
__list_values1___275[7]=8,
__list_values1___275[8]=9,
list$1int_initialize_with_values((struct list$1int*)come_increment_ref_count((struct list$1int*)come_calloc(1, sizeof(struct list$1int)*(1), "main.c", 68, "struct list$1int")),9,__list_values1___275)))),&__current_stack2__,(void*)method_block2_));
            /*g*/come_call_finalizer3(__right_value281,list$1intp_finalize, 0, 1, 0, 0, (void*)0);
            for(            o2_saved_286=(struct list$1int*)come_increment_ref_count((li_285)),it_289=list$1int_begin((o2_saved_286));            !list$1int_end((o2_saved_286));            it_289=list$1int_next((o2_saved_286))            ){
                printf("task2: Created!\n");
                printf("it %d\n",it_289);
                piccolo_sleep(&t_273,75);
            }
            /*i*/come_call_finalizer3(o2_saved_286,list$1intp_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(li_285,list$1intp_finalize, 0, 0, 0, 0, (void*)0);
        }
        piccolo_yield();
    }
}
...
struct list$1int* result_282;
struct list_item$1int* it_283;
int item_284;
struct list$1int* __result228__;
    result_282=(struct list$1int*)come_increment_ref_count(list$1int_initialize((struct list$1int*)come_increment_ref_count((struct list$1int*)come_calloc(1, sizeof(struct list$1int)*(1), "/usr/local/include/comelang.h", 1785, "list$1int"))));
    it_283=self->head;
    while(it_283!=((void*)0)) {
        item_284=block(parent,it_283->item);
        list$1int_push_back(result_282,item_284);
        it_283=it_283->next;
    }
    __result228__ = gComeFunResultObject = __result_obj__ = result_282;
    /*i*/come_call_finalizer3(result_282,list$1intp_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
memset(&result_288, 0, sizeof(int));
    if(    self==((void*)0)) {
        memset(&result_287,0,sizeof(int));
        return result_287;
    }
...
memset(&result_291, 0, sizeof(int));
