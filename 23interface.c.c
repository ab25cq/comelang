...
default_value_134 = (void*)0;
    ...
    keys_119=(char**)come_increment_ref_count(((char**)(__right_value178=(char**)come_calloc(1, sizeof(char*)*(1*(size_118)), "/usr/local/include/comelang.h", 1620, "char*%"))));
    items_120=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value179=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_118)), "/usr/local/include/comelang.h", 1621, "sClass*%"))));
    item_existance_121=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value180=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_118)), "/usr/local/include/comelang.h", 1622, "bool"))));
    len_122=0;
