...
default_value_137 = (void*)0;
    ...
    keys_122=(char**)come_increment_ref_count(((char**)(__right_value181=(char**)come_calloc(1, sizeof(char*)*(1*(size_121)), "./comelang.h", 1658, "char*%"))));
    items_123=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value182=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_121)), "./comelang.h", 1659, "sClass*%"))));
    item_existance_124=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value183=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_121)), "./comelang.h", 1660, "bool"))));
    len_125=0;
