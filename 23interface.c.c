...
struct sInterfaceNode* __result236__;
    ...
    come_call_finalizer3(__dec_obj45,sClass_finalize, 0, 0, 0, 0, (void*)0);
    self->mOutput=output;
...
struct sClass* __dec_obj48;
    ...
    if(    self!=((void*)0)&&self->klass!=((void*)0)) {
        if(        self->klass==gComeFunResultObject) {
            ...
            come_call_finalizer3(__dec_obj48,sClass_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
...
default_value_364 = (void*)0;
    ...
    for(    it_355=map$2voidphvoidphp_begin(self);    !map$2voidphvoidphp_end(self);    it_355=map$2voidphvoidphp_next(self)    ){
        ...
        come_call_finalizer3(__right_value274,(void*)0, 0, 1, 0, 0, (void*)0);
...
struct tuple2$2sTypephcharph* __result286__;
    ...
    come_call_finalizer3(__dec_obj100,list$1voidph_finalize, 0, 0, 0, 0, (void*)0);
...
struct sType* __result280__;
    ...
    if(    self!=((void*)0)&&self->mGenericsTypes!=((void*)0)) {
        __dec_obj79=result_416->mGenericsTypes;
    ...
    if(    self!=((void*)0)&&self->mArrayNum!=((void*)0)) {
        __dec_obj83=result_416->mArrayNum;
    ...
    if(    self!=((void*)0)&&self->mParamTypes!=((void*)0)) {
        __dec_obj84=result_416->mParamTypes;
    ...
    if(    self!=((void*)0)&&self->mParamNames!=((void*)0)) {
        __dec_obj88=result_416->mParamNames;
    ...
    if(    self!=((void*)0)&&self->mResultType!=((void*)0)) {
        __dec_obj89=result_416->mResultType;
    ...
    if(    self!=((void*)0)&&self->mAlignas!=((void*)0)) {
        __dec_obj90=result_416->mAlignas;
    ...
    if(    self!=((void*)0)&&self->mChannelType!=((void*)0)) {
        __dec_obj91=result_416->mChannelType;
    ...
    if(    self!=((void*)0)&&self->mSizeNum!=((void*)0)) {
        __dec_obj92=result_416->mSizeNum;
...
struct list$1sNodeph* __result273__;
    if(    self->len==0) {
        litem_419=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value298=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang.h", 1382, "struct list_item$1sNodeph*", (void*)0, (void*)0, (void*)0, (void*)0))));
        litem_419->prev=((void*)0);
        litem_419->next=((void*)0);
        __dec_obj80=litem_419->item;
        ...
        litem_420=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value299=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang.h", 1392, "struct list_item$1sNodeph*", (void*)0, (void*)0, (void*)0, (void*)0))));
        litem_420->prev=self->head;
        litem_420->next=((void*)0);
        __dec_obj81=litem_420->item;
        ...
        litem_421=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value300=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang.h", 1402, "struct list_item$1sNodeph*", (void*)0, (void*)0, (void*)0, (void*)0))));
        litem_421->prev=self->tail;
        litem_421->next=((void*)0);
        __dec_obj82=litem_421->item;
...
struct list$1charph* __result278__;
    if(    self->len==0) {
        litem_425=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value307=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 1382, "struct list_item$1charph*", (void*)0, (void*)0, (void*)0, (void*)0))));
        litem_425->prev=((void*)0);
        litem_425->next=((void*)0);
        __dec_obj85=litem_425->item;
        ...
        litem_426=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value308=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 1392, "struct list_item$1charph*", (void*)0, (void*)0, (void*)0, (void*)0))));
        litem_426->prev=self->head;
        litem_426->next=((void*)0);
        __dec_obj86=litem_426->item;
        ...
        litem_427=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value309=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 1402, "struct list_item$1charph*", (void*)0, (void*)0, (void*)0, (void*)0))));
        litem_427->prev=self->tail;
        litem_427->next=((void*)0);
        __dec_obj87=litem_427->item;
...
klass_442 = (void*)0;
    if(    !gComeC&&(charp_operator_equals(buf,"interface")||charp_operator_equals(buf,"protocol"))) {
        ...
        if(        (_if_conditional1=(((struct sClass*)((void*)(__right_value337=map$2voidphvoidphp_at(info->classes,type_name_441,((void*)0)))))==((void*)0))),        come_call_finalizer3(__right_value337,(void*)0, 0, 1, 0, 0, __result_obj__),
        _if_conditional1) {
            ...
            come_call_finalizer3(__dec_obj112,sClass_finalize, 0, 0, 0, 0, (void*)0);
