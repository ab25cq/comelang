...
int BN_BLINDING_convert_ex(struct bignum_st* n, struct bignum_st* r, struct bn_blinding_st* b, struct bignum_ctx* anonymous_var_nameX1264);
int BN_BLINDING_invert_ex(struct bignum_st* n, const struct bignum_st* r, struct bn_blinding_st* b, struct bignum_ctx* anonymous_var_nameX1265);
...
unsigned long unsigned  int BN_BLINDING_get_flags(const struct bn_blinding_st* anonymous_var_nameX1266);
void BN_BLINDING_set_flags(struct bn_blinding_st* anonymous_var_nameX1267, unsigned long unsigned  int anonymous_var_nameX1268);
...
char* check_user_query_115;
_Bool _or_conditional1;
struct MYSQL_RES* result_116;
...
_Bool _or_conditional4;
    ...
    check_user_query_115=(char*)come_increment_ref_count(xsprintf("SELECT COUNT(*) FROM mysql.user WHERE user = '\%s' AND host = '\%s'",((char*)(__right_value119=charp_to_string(user))),((char*)(__right_value120=charp_to_string(host_name)))));
    ...
    if((_or_conditional1=(mysql_query(gComeMySQL,check_user_query_115))),    _or_conditional1 != 0) {
        finish_with_error();
    }
    if((_and_conditional4=(result_116=mysql_store_result(gComeMySQL))),    _and_conditional4 == 0) {
        finish_with_error();
    }
    row_117=mysql_fetch_row(result_116);
    user_exists_118=atoi(row_117[0]);
    mysql_free_result(result_116);
    if(user_exists_118==0) {
    ...
    come_mysql_final();
    check_user_query_115 = come_decrement_ref_count2(check_user_query_115, (void*)0, (void*)0, 0, 0, 0, (void*)0);
}
...
_Bool _or_conditional5;
    ...
    create_db_query_119=(char*)come_increment_ref_count(xsprintf("CREATE DATABASE IF NOT EXISTS \%s",((char*)(__right_value129=charp_to_string(database_name)))));
    __right_value129 = come_decrement_ref_count2(__right_value129, (void*)0, (void*)0, 1, 0, 0, (void*)0);
    if((_or_conditional5=(mysql_query(gComeMySQL,create_db_query_119))),    _or_conditional5 != 0) {
        finish_with_error();
    }
    come_mysql_final();
    create_db_query_119 = come_decrement_ref_count2(create_db_query_119, (void*)0, (void*)0, 0, 0, 0, (void*)0);
}
...
struct MYSQL_RES* res_120;
_Bool _and_conditional10;
int num_fields_121;
void* __right_value131 = (void*)0;
void* __right_value132 = (void*)0;
struct list$1list$1charphph* result_122;
char** row_129;
void* __right_value133 = (void*)0;
void* __right_value134 = (void*)0;
struct list$1charph* li_130;
int i_131;
...
row_129 = (void*)0;
    ...
    if((_and_conditional10=(res_120=mysql_store_result(gComeMySQL))),    _and_conditional10 == 0) {
        finish_with_error();
    }
    num_fields_121=mysql_num_fields(res_120);
    result_122=(struct list$1list$1charphph*)come_increment_ref_count(list$1list$1charphph_initialize((struct list$1list$1charphph*)come_increment_ref_count((struct list$1list$1charphph*)come_calloc(1, sizeof(struct list$1list$1charphph)*(1), "libcomelang-net.c", 404, "list$1list$1charphph"))));
    while((row_129=mysql_fetch_row(res_120))!=((void*)0)) {
        li_130=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-net.c", 408, "list$1charph"))));
        for(        i_131=0;        i_131<num_fields_121;        i_131++        ){
            if(row_129[i_131]) {
                list$1charph_add(li_130,(char*)come_increment_ref_count(__builtin_string(row_129[i_131])));
            }
        }
        list$1list$1charphph_add(result_122,(struct list$1charph*)come_increment_ref_count(li_130));
        /*i*/come_call_finalizer3(li_130,list$1charphp_finalize, 0, 0, 0, 0, (void*)0);
    }
    mysql_free_result(res_120);
    come_mysql_final();
    __result74__ = gComeFunResultObject = __result_obj__ = result_122;
    /*i*/come_call_finalizer3(result_122,list$1list$1charphphp_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
    return __result74__;
}
...
static void list$1list$1charphphp_finalize(struct list$1list$1charphph* self){
struct list_item$1list$1charphph* it_123;
struct list_item$1list$1charphph* prev_it_124;
    it_123=self->head;
    while(it_123!=((void*)0)) {
        prev_it_124=it_123;
        it_123=it_123->next;
        /*i*/come_call_finalizer3(prev_it_124,list_item$1list$1charphphp_finalize, 0, 0, 0, 0, (void*)0);
    }
}
...
struct list$1charph* __dec_obj15;
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        if(self->item==gComeFunResultObject) {
            ...
            /* a*/come_call_finalizer3(__dec_obj15,list$1charph_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
...
struct list_item$1charph* prev_it_126;
    it_125=self->head;
    while(it_125!=((void*)0)) {
        prev_it_126=it_125;
        it_125=it_125->next;
        /*i*/come_call_finalizer3(prev_it_126,list_item$1charphp_finalize, 0, 0, 0, 0, (void*)0);
    }
}
...
struct list$1charph* __result72__;
    if(self->len==0) {
        litem_132=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value135=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 151, "list_item$1charph"))));
        litem_132->prev=((void*)0);
        litem_132->next=((void*)0);
        __dec_obj17=litem_132->item;
        ...
        if(self->len==1) {
            litem_133=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value136=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 161, "list_item$1charph"))));
            litem_133->prev=self->head;
            litem_133->next=((void*)0);
            __dec_obj18=litem_133->item;
            ...
            litem_134=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value137=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 171, "list_item$1charph"))));
            litem_134->prev=self->tail;
            litem_134->next=((void*)0);
            __dec_obj19=litem_134->item;
...
struct list_item$1list$1charphph* litem_135;
...
struct list$1list$1charphph* __result73__;
    if(self->len==0) {
        litem_135=(struct list_item$1list$1charphph*)come_increment_ref_count(((struct list_item$1list$1charphph*)(__right_value139=(struct list_item$1list$1charphph*)come_calloc(1, sizeof(struct list_item$1list$1charphph)*(1), "/usr/local/include/comelang.h", 151, "list_item$1list$1charphph"))));
        litem_135->prev=((void*)0);
        litem_135->next=((void*)0);
        __dec_obj20=litem_135->item;
        litem_135->item=(struct list$1charph*)come_increment_ref_count(item);
        ...
        if(self->len==1) {
            litem_136=(struct list_item$1list$1charphph*)come_increment_ref_count(((struct list_item$1list$1charphph*)(__right_value140=(struct list_item$1list$1charphph*)come_calloc(1, sizeof(struct list_item$1list$1charphph)*(1), "/usr/local/include/comelang.h", 161, "list_item$1list$1charphph"))));
            litem_136->prev=self->head;
            litem_136->next=((void*)0);
            __dec_obj21=litem_136->item;
            ...
            litem_137=(struct list_item$1list$1charphph*)come_increment_ref_count(((struct list_item$1list$1charphph*)(__right_value141=(struct list_item$1list$1charphph*)come_calloc(1, sizeof(struct list_item$1list$1charphph)*(1), "/usr/local/include/comelang.h", 171, "list_item$1list$1charphph"))));
            litem_137->prev=self->tail;
            litem_137->next=((void*)0);
            __dec_obj22=litem_137->item;
