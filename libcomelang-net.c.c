...
int opt_79;
struct sockaddr_in address_80;
int addrlen_81;
int new_socket_82;
_Bool break__83;
memset(&address_80, 0, sizeof(struct sockaddr_in));
    if((_and_conditional2=(sock_78=socket(socket_family,socket_type,protocol))),    _and_conditional2 == 0) {
    ...
    if(reuse) {
        opt_79=1;
        if(setsockopt(sock_78,1,2,&opt_79,sizeof(opt_79))) {
            perror("setsockopt failed");
            close(sock_78);
            exit(1);
        }
    }
    address_80.sin_family=2;
    address_80.sin_addr.s_addr=((unsigned int)0);
    address_80.sin_port=htons(port);
    addrlen_81=sizeof(address_80);
    if(bind(sock_78,(struct sockaddr*)&address_80,sizeof(address_80))<0) {
        perror("Unable to bind");
        exit(1);
    }
    if(listen(sock_78,3)<0) {
        perror("Unable to listen");
        exit(1);
    }
    while(1) {
        new_socket_82=accept(sock_78,(struct sockaddr*)&address_80,(unsigned int*)&addrlen_81);
        break__83=(_Bool)0;
        block(parent,new_socket_82,&break__83);
        close(new_socket_82);
        if(break__83) {
            break;
        }
    ...
    close(sock_78);
    /*i*/come_call_finalizer3((&address_80),sockaddr_in_finalize, 1, 0, 0, 0, (void*)0);
}
...
int httpsd_socket(int port, _Bool reuse, void* parent, void (*block)(void*,struct ssl_st*,_Bool*)){
int sock_84;
struct ssl_ctx_st* ctx_85;
const struct ssl_method_st* method_86;
int opt_87;
...
memset(&addr_89, 0, sizeof(struct sockaddr_in));
    ...
    method_86=TLS_server_method();
    ctx_85=SSL_CTX_new(method_86);
    if(!ctx_85) {
        perror("Unable to create SSL context");
        ERR_print_errors_fp((stdout));
        exit(1);
    }
    if(SSL_CTX_use_certificate_file(ctx_85,"cert.pem",1)<=0) {
        ERR_print_errors_fp((stdout));
        exit(1);
    }
    if(SSL_CTX_use_PrivateKey_file(ctx_85,"key.pem",1)<=0) {
        ERR_print_errors_fp((stdout));
        exit(1);
    }
    sock_84=socket(2,1,0);
    if(sock_84<0) {
    ...
    if(reuse) {
        opt_87=1;
        if(setsockopt(sock_84,1,2|15,&opt_87,sizeof(opt_87))) {
            perror("setsockopt failed");
            close(sock_84);
            exit(1);
        }
    ...
    if(bind(sock_84,(struct sockaddr*)&addr_88,sizeof(addr_88))<0) {
        perror("Unable to bind");
        exit(1);
    }
    if(listen(sock_84,1)<0) {
        perror("Unable to listen");
        exit(1);
    }
    while(1) {
        len_90=sizeof(addr_89);
        client_91=accept(sock_84,(struct sockaddr*)&addr_89,&len_90);
        if(client_91<0) {
            perror("Unable to accept");
            exit(1);
        }
        ssl_92=SSL_new(ctx_85);
        ...
        if(SSL_accept(ssl_92)<=0) {
            ...
            if(break__93) {
                /*i*/come_call_finalizer3((&addr_89),sockaddr_in_finalize, 1, 0, 0, 0, (void*)0);
                break;
            }
        }
        SSL_shutdown(ssl_92);
    ...
    __result66__ = 0;
    /*i*/come_call_finalizer3((&addr_88),sockaddr_in_finalize, 1, 0, 0, 0, (void*)0);
    return __result66__;
}
...
_Bool _or_conditional4;
    ...
    check_user_query_94=(char*)come_increment_ref_count(xsprintf("SELECT COUNT(*) FROM mysql.user WHERE user = '\%s' AND host = '\%s'",((char*)(__right_value116=charp_to_string(user))),((char*)(__right_value117=charp_to_string(host_name)))));
    ...
    come_mysql_final();
    check_user_query_94 = come_decrement_ref_count2(check_user_query_94, (void*)0, (void*)0, 0, 0, 0, (void*)0);
}
...
_Bool _or_conditional5;
    ...
    create_db_query_98=(char*)come_increment_ref_count(xsprintf("CREATE DATABASE IF NOT EXISTS \%s",((char*)(__right_value126=charp_to_string(database_name)))));
    ...
    come_mysql_final();
    create_db_query_98 = come_decrement_ref_count2(create_db_query_98, (void*)0, (void*)0, 0, 0, 0, (void*)0);
}
...
row_108 = (void*)0;
    ...
    result_101=(struct list$1list$1charphph*)come_increment_ref_count(list$1list$1charphph_initialize((struct list$1list$1charphph*)come_increment_ref_count((struct list$1list$1charphph*)come_calloc(1, sizeof(struct list$1list$1charphph)*(1), "libcomelang-net.c", 371, "list$1list$1charphph"))));
    while((row_108=mysql_fetch_row(res_99))!=((void*)0)) {
        li_109=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-net.c", 375, "list$1charph"))));
        for(        i_110=0;        i_110<num_fields_100;        i_110++        ){
            if(row_108[i_110]) {
                list$1charph_add(li_109,(char*)come_increment_ref_count(__builtin_string(row_108[i_110])));
            }
        }
        list$1list$1charphph_add(result_101,(struct list$1charph*)come_increment_ref_count(li_109));
        /*i*/come_call_finalizer3(li_109,list$1charphp_finalize, 0, 0, 0, 0, (void*)0);
    }
    mysql_free_result(res_99);
    come_mysql_final();
    __result71__ = gComeFunResultObject = __result_obj__ = result_101;
    /*i*/come_call_finalizer3(result_101,list$1list$1charphphp_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
    return __result71__;
}
...
static void list$1list$1charphphp_finalize(struct list$1list$1charphph* self){
struct list_item$1list$1charphph* it_102;
struct list_item$1list$1charphph* prev_it_103;
    it_102=self->head;
    while(it_102!=((void*)0)) {
        prev_it_103=it_102;
        it_102=it_102->next;
        /*i*/come_call_finalizer3(prev_it_103,list_item$1list$1charphphp_finalize, 0, 0, 0, 0, (void*)0);
    }
}
...
struct list_item$1charph* prev_it_105;
    it_104=self->head;
    while(it_104!=((void*)0)) {
        prev_it_105=it_104;
        it_104=it_104->next;
        /*i*/come_call_finalizer3(prev_it_105,list_item$1charphp_finalize, 0, 0, 0, 0, (void*)0);
    }
}
...
struct list_item$1charph* prev_it_107;
    ...
    while(it_106!=((void*)0)) {
        prev_it_107=it_106;
        it_106=it_106->next;
        /*i*/come_call_finalizer3(prev_it_107,list_item$1charphp_finalize, 0, 0, 0, 0, (void*)0);
    }
}
...
struct list$1charph* __result69__;
    if(self->len==0) {
        litem_111=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value132=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 151, "list_item$1charph"))));
        litem_111->prev=((void*)0);
        litem_111->next=((void*)0);
        __dec_obj17=litem_111->item;
        ...
        if(self->len==1) {
            litem_112=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value133=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 161, "list_item$1charph"))));
            litem_112->prev=self->head;
            litem_112->next=((void*)0);
            __dec_obj18=litem_112->item;
            ...
            litem_113=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value134=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 171, "list_item$1charph"))));
            litem_113->prev=self->tail;
            litem_113->next=((void*)0);
            __dec_obj19=litem_113->item;
...
struct list_item$1list$1charphph* litem_114;
struct list$1charph* __dec_obj20;
void* __right_value137 = (void*)0;
struct list_item$1list$1charphph* litem_115;
struct list$1charph* __dec_obj21;
void* __right_value138 = (void*)0;
struct list_item$1list$1charphph* litem_116;
struct list$1charph* __dec_obj22;
struct list$1list$1charphph* __result70__;
    if(self->len==0) {
        litem_114=(struct list_item$1list$1charphph*)come_increment_ref_count(((struct list_item$1list$1charphph*)(__right_value136=(struct list_item$1list$1charphph*)come_calloc(1, sizeof(struct list_item$1list$1charphph)*(1), "./comelang.h", 151, "list_item$1list$1charphph"))));
        litem_114->prev=((void*)0);
        litem_114->next=((void*)0);
        __dec_obj20=litem_114->item;
        litem_114->item=(struct list$1charph*)come_increment_ref_count(item);
        ...
        if(self->len==1) {
            litem_115=(struct list_item$1list$1charphph*)come_increment_ref_count(((struct list_item$1list$1charphph*)(__right_value137=(struct list_item$1list$1charphph*)come_calloc(1, sizeof(struct list_item$1list$1charphph)*(1), "./comelang.h", 161, "list_item$1list$1charphph"))));
            litem_115->prev=self->head;
            litem_115->next=((void*)0);
            __dec_obj21=litem_115->item;
            litem_115->item=(struct list$1charph*)come_increment_ref_count(item);
            /* a*/come_call_finalizer3(__dec_obj21,list$1charph_finalize, 0, 0, 0, 0, (void*)0);
            self->tail=litem_115;
            self->head->next=litem_115;
        }
        else {
            litem_116=(struct list_item$1list$1charphph*)come_increment_ref_count(((struct list_item$1list$1charphph*)(__right_value138=(struct list_item$1list$1charphph*)come_calloc(1, sizeof(struct list_item$1list$1charphph)*(1), "./comelang.h", 171, "list_item$1list$1charphph"))));
            litem_116->prev=self->tail;
            litem_116->next=((void*)0);
            __dec_obj22=litem_116->item;
            litem_116->item=(struct list$1charph*)come_increment_ref_count(item);
