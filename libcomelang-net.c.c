...
struct timex
{
    ...
    long  int stbcnt;
    int tai;
    int anonymous_var_nameX86;
    int anonymous_var_nameX88;
    int anonymous_var_nameX90;
    int anonymous_var_nameX92;
    int anonymous_var_nameX94;
    int anonymous_var_nameX96;
    int anonymous_var_nameX98;
    int anonymous_var_nameX100;
    int anonymous_var_nameX102;
    int anonymous_var_nameX104;
    int anonymous_var_nameX106;
};
...
int OPENSSL_sk_num(const struct stack_st* anonymous_var_nameX111);
void* OPENSSL_sk_value(const struct stack_st* anonymous_var_nameX112, int anonymous_var_nameX113);
...
void OPENSSL_sk_free(struct stack_st* anonymous_var_nameX114);
void OPENSSL_sk_pop_free(struct stack_st* st, void (*func)(void*));
struct stack_st* OPENSSL_sk_deep_copy(const struct stack_st* anonymous_var_nameX116, void* (*c)(const void*), void (*f)(void*));
...
int sched_getcpu();
int getcpu(unsigned int* anonymous_var_nameX117, unsigned int* anonymous_var_nameX118);
...
void OSSL_LIB_CTX_free(struct ossl_lib_ctx_st* anonymous_var_nameX126);
...
void BIO_ADDR_free(union bio_addr_st* anonymous_var_nameX130);
...
int BN_BLINDING_convert_ex(struct bignum_st* n, struct bignum_st* r, struct bn_blinding_st* b, struct bignum_ctx* anonymous_var_nameX175);
int BN_BLINDING_invert_ex(struct bignum_st* n, const struct bignum_st* r, struct bn_blinding_st* b, struct bignum_ctx* anonymous_var_nameX176);
...
unsigned long  int BN_BLINDING_get_flags(const struct bn_blinding_st* anonymous_var_nameX177);
void BN_BLINDING_set_flags(struct bn_blinding_st* anonymous_var_nameX178, unsigned long  int anonymous_var_nameX179);
...
int ASN1_STRING_TABLE_add(int anonymous_var_nameX185, long anonymous_var_nameX186, long anonymous_var_nameX187, unsigned long  int anonymous_var_nameX188, unsigned long  int anonymous_var_nameX189);
...
enum anonymous_typeY33 EC_GROUP_get_point_conversion_form(const struct ec_group_st* anonymous_var_nameX208);
unsigned char* EC_GROUP_get0_seed(const struct ec_group_st* x);
unsigned long  int EC_GROUP_get_seed_len(const struct ec_group_st* anonymous_var_nameX209);
unsigned long  int EC_GROUP_set_seed(struct ec_group_st* anonymous_var_nameX210, const unsigned char* anonymous_var_nameX211, unsigned long  int len);
...
struct bignum_st* EC_POINT_point2bn(const struct ec_group_st* anonymous_var_nameX212, const struct ec_point_st* anonymous_var_nameX213, enum anonymous_typeY33 form, struct bignum_st* anonymous_var_nameX214, struct bignum_ctx* anonymous_var_nameX215);
struct ec_point_st* EC_POINT_bn2point(const struct ec_group_st* anonymous_var_nameX216, const struct bignum_st* anonymous_var_nameX217, struct ec_point_st* anonymous_var_nameX218, struct bignum_ctx* anonymous_var_nameX219);
char* EC_POINT_point2hex(const struct ec_group_st* anonymous_var_nameX220, const struct ec_point_st* anonymous_var_nameX221, enum anonymous_typeY33 form, struct bignum_ctx* anonymous_var_nameX222);
struct ec_point_st* EC_POINT_hex2point(const struct ec_group_st* anonymous_var_nameX223, const char* anonymous_var_nameX224, struct ec_point_st* anonymous_var_nameX225, struct bignum_ctx* anonymous_var_nameX226);
...
int EC_GROUP_get_basis_type(const struct ec_group_st* anonymous_var_nameX227);
int EC_GROUP_get_trinomial_basis(const struct ec_group_st* anonymous_var_nameX228, unsigned int* k);
int EC_GROUP_get_pentanomial_basis(const struct ec_group_st* anonymous_var_nameX229, unsigned int* k1, unsigned int* k2, unsigned int* k3);
struct ec_group_st* d2i_ECPKParameters(struct ec_group_st** anonymous_var_nameX230, const unsigned char** in, long len);
int i2d_ECPKParameters(const struct ec_group_st* anonymous_var_nameX231, unsigned char** out);
...
int RSA_check_key(const struct rsa_st* anonymous_var_nameX235);
int RSA_check_key_ex(const struct rsa_st* anonymous_var_nameX236, struct bn_gencb_st* cb);
...
void DSA_set_default_method(const struct dsa_method* anonymous_var_nameX254);
const struct dsa_method* DSA_get_default_method();
int DSA_set_method(struct dsa_st* dsa, const struct dsa_method* anonymous_var_nameX255);
...
int DSA_size(const struct dsa_st* anonymous_var_nameX256);
...
void X509_VERIFY_PARAM_move_peername(struct X509_VERIFY_PARAM_st* anonymous_var_nameX318, struct X509_VERIFY_PARAM_st* anonymous_var_nameX319);
...
int PEM_write_bio_PKCS8PrivateKey(struct bio_st* anonymous_var_nameX320, const struct evp_pkey_st* anonymous_var_nameX321, const struct evp_cipher_st* anonymous_var_nameX322, const char* kstr, int klen, int (*cb)(char*,int,int,void*), void* u);
...
int SSL_CTX_set_cipher_list(struct ssl_ctx_st* anonymous_var_nameX334, const char* str);
...
void SSL_CTX_free(struct ssl_ctx_st* anonymous_var_nameX335);
long SSL_CTX_set_timeout(struct ssl_ctx_st* ctx, long t);
long SSL_CTX_get_timeout(const struct ssl_ctx_st* ctx);
struct x509_store_st* SSL_CTX_get_cert_store(const struct ssl_ctx_st* anonymous_var_nameX336);
void SSL_CTX_set_cert_store(struct ssl_ctx_st* anonymous_var_nameX337, struct x509_store_st* anonymous_var_nameX338);
void SSL_CTX_set1_cert_store(struct ssl_ctx_st* anonymous_var_nameX339, struct x509_store_st* anonymous_var_nameX340);
...
long SSL_callback_ctrl(struct ssl_st* anonymous_var_nameX350, int anonymous_var_nameX351, void (*anonymous_lambda_var_nameZ1)());
long SSL_CTX_ctrl(struct ssl_ctx_st* ctx, int cmd, long larg, void* parg);
long SSL_CTX_callback_ctrl(struct ssl_ctx_st* anonymous_var_nameX352, int anonymous_var_nameX353, void (*anonymous_lambda_var_nameZ2)());
...
char* SSL_CIPHER_description(const struct ssl_cipher_st* anonymous_var_nameX354, char* buf, int size);
...
void ERR_remove_thread_state(void* anonymous_var_nameX355);
...
int isalnum(int anonymous_var_nameX358);
int isalpha(int anonymous_var_nameX359);
int iscntrl(int anonymous_var_nameX360);
int isdigit(int anonymous_var_nameX361);
int islower(int anonymous_var_nameX362);
int isgraph(int anonymous_var_nameX363);
int isprint(int anonymous_var_nameX364);
int ispunct(int anonymous_var_nameX365);
int isspace(int anonymous_var_nameX366);
int isupper(int anonymous_var_nameX367);
int isxdigit(int anonymous_var_nameX368);
int tolower(int __c);
int toupper(int __c);
int isblank(int anonymous_var_nameX369);
int isctype(int __c, int __mask);
int isascii(int __c);
int toascii(int __c);
int _toupper(int anonymous_var_nameX370);
int _tolower(int anonymous_var_nameX371);
int isalnum_l(int anonymous_var_nameX372, struct __locale_struct* anonymous_var_nameX373);
int isalpha_l(int anonymous_var_nameX374, struct __locale_struct* anonymous_var_nameX375);
int iscntrl_l(int anonymous_var_nameX376, struct __locale_struct* anonymous_var_nameX377);
int isdigit_l(int anonymous_var_nameX378, struct __locale_struct* anonymous_var_nameX379);
int islower_l(int anonymous_var_nameX380, struct __locale_struct* anonymous_var_nameX381);
int isgraph_l(int anonymous_var_nameX382, struct __locale_struct* anonymous_var_nameX383);
int isprint_l(int anonymous_var_nameX384, struct __locale_struct* anonymous_var_nameX385);
int ispunct_l(int anonymous_var_nameX386, struct __locale_struct* anonymous_var_nameX387);
int isspace_l(int anonymous_var_nameX388, struct __locale_struct* anonymous_var_nameX389);
int isupper_l(int anonymous_var_nameX390, struct __locale_struct* anonymous_var_nameX391);
int isxdigit_l(int anonymous_var_nameX392, struct __locale_struct* anonymous_var_nameX393);
int isblank_l(int anonymous_var_nameX394, struct __locale_struct* anonymous_var_nameX395);
...
void mysql_set_local_infile_handler(struct st_mysql* mysql, int (*local_infile_init)(void**,const char*,void*), int (*local_infile_read)(void*,char*,unsigned int), void (*local_infile_end)(void*), int (*local_infile_error)(void*,char*,unsigned int), void* anonymous_var_nameX445);
...
struct st_mysql_rows* mysql_row_seek(struct st_mysql_res* result, struct st_mysql_rows* anonymous_var_nameX446);
...
int new_socket_70;
_Bool reconnection_71;
_Bool break__72;
int __result68__;
memset(&address_68, 0, sizeof(struct sockaddr_in));
    sock_66=socket(socket_family,socket_type,protocol);
    if(    sock_66<0) {
    ...
    if(    reuse) {
        opt_67=1;
        if(        setsockopt(sock_66,1,2,&opt_67,sizeof(opt_67))) {
            close(sock_66);
    ...
    address_68.sin_family=2;
    address_68.sin_addr.s_addr=((unsigned int)0);
    address_68.sin_port=htons(port);
    addrlen_69=sizeof(address_68);
    if(    bind(sock_66,(struct sockaddr*)&address_68,sizeof(address_68))<0) {
        close(sock_66);
    ...
    new_socket_70=accept(sock_66,(struct sockaddr*)&address_68,(unsigned int*)&addrlen_69);
    while(1) {
        reconnection_71=(_Bool)0;
        break__72=(_Bool)0;
        block(parent,new_socket_70,&break__72,&reconnection_71);
        if(        reconnection_71) {
            close(new_socket_70);
            new_socket_70=accept(sock_66,(struct sockaddr*)&address_68,(unsigned int*)&addrlen_69);
        }
    ...
    close(sock_66);
    __result68__ = 0;
    /*i*/come_call_finalizer3((&address_68),sockaddr_in_finalize, 1, 0, 0, 0, (void*)0);
    return __result68__;
}
...
int client_socket(int port, char* address, void* parent, void (*block)(void*,int,_Bool*)){
int sock_73;
struct sockaddr_in serv_addr_74;
...
_Bool break__76;
int __result69__;
memset(&serv_addr_74, 0, sizeof(struct sockaddr_in));
    sock_73=0;
    if(    (sock_73=socket(2,(1),0))<0) {
    ...
    serv_addr_74.sin_family=2;
    serv_addr_74.sin_port=htons(port);
    if(    inet_pton(2,address,&serv_addr_74.sin_addr)<=0) {
        close(sock_73);
    ...
    if(    connect(sock_73,(struct sockaddr*)&serv_addr_74,sizeof(serv_addr_74))<0) {
        close(sock_73);
    ...
    while(1) {
        break__76=(_Bool)0;
        block(parent,sock_73,&break__76);
        if(        break__76) {
            break;
        }
    }
    close(sock_73);
    __result69__ = 0;
    /*i*/come_call_finalizer3((&serv_addr_74),sockaddr_in_finalize, 1, 0, 0, 0, (void*)0);
    return __result69__;
}
...
void* __result_obj__=(void*)0;
int sock_77;
struct sockaddr_in serv_addr_78;
...
char* __result70__;
memset(&serv_addr_78, 0, sizeof(struct sockaddr_in));
    sock_77=0;
    if(    (sock_77=socket(2,(1),0))<0) {
    ...
    serv_addr_78.sin_family=2;
    serv_addr_78.sin_port=htons(port);
    if(    inet_pton(2,address,&serv_addr_78.sin_addr)<=0) {
        close(sock_77);
    ...
    if(    connect(sock_77,(struct sockaddr*)&serv_addr_78,sizeof(serv_addr_78))<0) {
        close(sock_77);
    ...
    if(    write(sock_77,data,strlen(data))<0) {
        close(sock_77);
    ...
    buf_79=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang-net.c", 132, "buffer"))));
    char buf2_80[1024]={0};
    size_81=read(sock_77,buf2_80,1024);
    if(    size_81<0) {
        close(sock_77);
    ...
    buffer_append(buf_79,buf2_80,size_81);
    close(sock_77);
    __result70__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value130=buffer_to_string(buf_79)));
    /*i*/come_call_finalizer3((&serv_addr_78),sockaddr_in_finalize, 1, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(buf_79,buffer_finalize, 0, 0, 0, 0, (void*)0);
...
_Bool break__87;
int __result71__;
memset(&address_84, 0, sizeof(struct sockaddr_in));
    sock_82=socket(socket_family,socket_type,protocol);
    if(    sock_82<0) {
    ...
    if(    reuse) {
        opt_83=1;
        if(        setsockopt(sock_82,1,2,&opt_83,sizeof(opt_83))) {
            close(sock_82);
    ...
    address_84.sin_family=2;
    address_84.sin_addr.s_addr=((unsigned int)0);
    address_84.sin_port=htons(port);
    addrlen_85=sizeof(address_84);
    if(    bind(sock_82,(struct sockaddr*)&address_84,sizeof(address_84))<0) {
        close(sock_82);
    ...
    while(1) {
        new_socket_86=accept(sock_82,(struct sockaddr*)&address_84,(unsigned int*)&addrlen_85);
        break__87=(_Bool)0;
        block(parent,new_socket_86,&break__87);
        close(new_socket_86);
        if(        break__87) {
            break;
        }
    ...
    close(sock_82);
    __result71__ = 0;
    /*i*/come_call_finalizer3((&address_84),sockaddr_in_finalize, 1, 0, 0, 0, (void*)0);
    return __result71__;
}
...
int httpsd_socket(int port, _Bool reuse, void* parent, void (*block)(void*,struct ssl_st*,_Bool*)){
int sock_88;
struct ssl_ctx_st* ctx_89;
const struct ssl_method_st* method_90;
...
struct ssl_st* ssl_95;
_Bool break__96;
int __result72__;
memset(&sock_88, 0, sizeof(int));
ctx_89 = (void*)0;
method_90 = (void*)0;
...
memset(&addr_92, 0, sizeof(struct sockaddr_in));
    ...
    method_90=TLS_server_method();
    ctx_89=SSL_CTX_new(method_90);
    if(    !ctx_89) {
    ...
    if(    SSL_CTX_use_certificate_file(ctx_89,"cert.pem",1)<=0) {
    ...
    if(    SSL_CTX_use_PrivateKey_file(ctx_89,"key.pem",1)<=0) {
    ...
    addr_91.sin_family=2;
    addr_91.sin_port=htons(port);
    addr_91.sin_addr.s_addr=((unsigned int)0);
    if(    bind(sock_88,(struct sockaddr*)&addr_91,sizeof(addr_91))<0) {
    ...
    while(1) {
        len_93=sizeof(addr_92);
        client_94=accept(sock_88,(struct sockaddr*)&addr_92,&len_93);
        if(        client_94<0) {
        ...
        ssl_95=SSL_new(ctx_89);
        SSL_set_fd(ssl_95,client_94);
        if(        SSL_accept(ssl_95)<=0) {
            ERR_print_errors_fp(stdout);
        }
        else {
            break__96=(_Bool)0;
            block(parent,ssl_95,&break__96);
            if(            break__96) {
    ...
    __result72__ = 0;
    /*i*/come_call_finalizer3((&addr_91),sockaddr_in_finalize, 1, 0, 0, 0, (void*)0);
    return __result72__;
}
...
char* check_user_query_97;
struct st_mysql_res* result_98;
char** row_99;
int user_exists_100;
...
int __result73__;
    ...
    check_user_query_97=(char*)come_increment_ref_count(xsprintf("SELECT COUNT(*) FROM mysql.user WHERE user = '\%s' AND host = '\%s'",((char*)(__right_value144=charp_to_string(user))),((char*)(__right_value145=charp_to_string(host_name)))));
    ...
    if(    mysql_query(gComeMySQL,check_user_query_97)==((void*)0)) {
        finish_with_error();
    }
    result_98=mysql_store_result(gComeMySQL);
    if(    result_98==((void*)0)) {
        finish_with_error();
    }
    row_99=mysql_fetch_row(result_98);
    user_exists_100=atoi(row_99[0]);
    mysql_free_result(result_98);
    if(    user_exists_100==0) {
    ...
    come_mysql_final();
    __result73__ = 0;
    /* U13 */check_user_query_97 = come_decrement_ref_count2(check_user_query_97, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    return __result73__;
}
...
char* create_db_query_101;
int __result74__;
    come_mysql_init();
    if(    mysql_real_connect(gComeMySQL,host_name,user_name,password,((void*)0),0,((void*)0),0)==((void*)0)) {
        finish_with_error();
    }
    create_db_query_101=(char*)come_increment_ref_count(xsprintf("CREATE DATABASE IF NOT EXISTS \%s",((char*)(__right_value154=charp_to_string(database_name)))));
    /* U11 */__right_value154 = come_decrement_ref_count2(__right_value154, (void*)0, (void*)0, 1, 0, 0, (void*)0);
    if(    mysql_query(gComeMySQL,create_db_query_101)==((void*)0)) {
        finish_with_error();
    }
    come_mysql_final();
    __result74__ = 0;
    /* U13 */create_db_query_101 = come_decrement_ref_count2(create_db_query_101, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    return __result74__;
}
...
struct list$1list$1charphph* xmysql_query_and_fetch_row(char* query, char* user, char* password, _Bool create_user, _Bool create_database, char* root_password, char* database_name, char* host_name){
void* __result_obj__=(void*)0;
struct st_mysql_res* res_102;
int num_fields_103;
void* __right_value156 = (void*)0;
void* __right_value157 = (void*)0;
struct list$1list$1charphph* result_104;
char** row_111;
void* __right_value158 = (void*)0;
void* __right_value159 = (void*)0;
struct list$1charph* li_112;
int i_113;
...
row_111 = (void*)0;
    ...
    res_102=mysql_store_result(gComeMySQL);
    if(    res_102) {
        finish_with_error();
    }
    num_fields_103=mysql_num_fields(res_102);
    result_104=(struct list$1list$1charphph*)come_increment_ref_count(list$1list$1charphph_initialize((struct list$1list$1charphph*)come_increment_ref_count((struct list$1list$1charphph*)come_calloc(1, sizeof(struct list$1list$1charphph)*(1), "libcomelang-net.c", 421, "list$1list$1charphph"))));
    while((row_111=mysql_fetch_row(res_102))!=((void*)0)) {
        li_112=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-net.c", 425, "list$1charph"))));
        for(        i_113=0;        i_113<num_fields_103;        i_113++        ){
            if(            row_111[i_113]) {
                list$1charph_add(li_112,(char*)come_increment_ref_count(__builtin_string(row_111[i_113])));
            }
        }
        list$1list$1charphph_add(result_104,(struct list$1charph*)come_increment_ref_count(li_112));
        /*i*/come_call_finalizer3(li_112,list$1charphp_finalize, 0, 0, 0, 0, (void*)0);
    }
    mysql_free_result(res_102);
    come_mysql_final();
    __result79__ = gComeFunResultObject = __result_obj__ = result_104;
    /*i*/come_call_finalizer3(result_104,list$1list$1charphphp_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
    return __result79__;
}
...
static void list$1list$1charphphp_finalize(struct list$1list$1charphph* self){
struct list_item$1list$1charphph* it_105;
struct list_item$1list$1charphph* prev_it_106;
    it_105=self->head;
    while(it_105!=((void*)0)) {
        prev_it_106=it_105;
        it_105=it_105->next;
        /*i*/come_call_finalizer3(prev_it_106,list_item$1list$1charphphp_finalize, 0, 0, 0, 0, (void*)0);
    }
}
...
struct list_item$1charph* prev_it_108;
    it_107=self->head;
    while(it_107!=((void*)0)) {
        prev_it_108=it_107;
        it_107=it_107->next;
        /*i*/come_call_finalizer3(prev_it_108,list_item$1charphp_finalize, 0, 0, 0, 0, (void*)0);
    }
}
...
struct list$1charph* __result77__;
    if(    self->len==0) {
        litem_114=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value160=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 149, "list_item$1charph"))));
        litem_114->prev=((void*)0);
        litem_114->next=((void*)0);
        __dec_obj17=litem_114->item;
        ...
        litem_115=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value161=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 159, "list_item$1charph"))));
        litem_115->prev=self->head;
        litem_115->next=((void*)0);
        __dec_obj18=litem_115->item;
        ...
        litem_116=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value162=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 169, "list_item$1charph"))));
        litem_116->prev=self->tail;
        litem_116->next=((void*)0);
        __dec_obj19=litem_116->item;
...
struct list_item$1list$1charphph* litem_117;
...
struct list$1list$1charphph* __result78__;
    if(    self->len==0) {
        litem_117=(struct list_item$1list$1charphph*)come_increment_ref_count(((struct list_item$1list$1charphph*)(__right_value164=(struct list_item$1list$1charphph*)come_calloc(1, sizeof(struct list_item$1list$1charphph)*(1), "./comelang.h", 149, "list_item$1list$1charphph"))));
        litem_117->prev=((void*)0);
        litem_117->next=((void*)0);
        __dec_obj20=litem_117->item;
        litem_117->item=(struct list$1charph*)come_increment_ref_count(item);
        come_call_finalizer3(__dec_obj20,list$1charph_finalize, 0, 0, 0, 0, (void*)0);
        self->tail=litem_117;
        self->head=litem_117;
    }
    else if(    self->len==1) {
        litem_118=(struct list_item$1list$1charphph*)come_increment_ref_count(((struct list_item$1list$1charphph*)(__right_value165=(struct list_item$1list$1charphph*)come_calloc(1, sizeof(struct list_item$1list$1charphph)*(1), "./comelang.h", 159, "list_item$1list$1charphph"))));
        litem_118->prev=self->head;
        litem_118->next=((void*)0);
        __dec_obj21=litem_118->item;
        ...
        litem_119=(struct list_item$1list$1charphph*)come_increment_ref_count(((struct list_item$1list$1charphph*)(__right_value166=(struct list_item$1list$1charphph*)come_calloc(1, sizeof(struct list_item$1list$1charphph)*(1), "./comelang.h", 169, "list_item$1list$1charphph"))));
        litem_119->prev=self->tail;
        litem_119->next=((void*)0);
        __dec_obj22=litem_119->item;
