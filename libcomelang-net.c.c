...
unsigned short int data_66;
    data_66=*(unsigned short int*)((unsigned long unsigned  int)base+byteOffset);
...
unsigned int data_67;
    data_67=*(unsigned int*)((unsigned long unsigned  int)base+byteOffset);
...
unsigned long unsigned  long data_68;
    data_68=*(unsigned long unsigned  long*)((unsigned long unsigned  int)base+byteOffset);
...
unsigned long unsigned  int (*hfn_conv_77)(const struct anonymous_typeX26*);
memset(&hfn_conv_77, 0, sizeof(unsigned long unsigned  int (*)(const struct anonymous_typeX26*)));
    hfn_conv_77=(unsigned long unsigned  int (*)(const struct anonymous_typeX26*))hfn;
...
memset(&serv_addr_98, 0, sizeof(struct sockaddr_in));
    ...
    close(sock_97);
    __result70__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value129=buffer_to_string(buf_99)));
...
struct list$1charph* __result77__;
    if(    self->len==0) {
        litem_134=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value159=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 153, "list_item$1charph"))));
        ...
        litem_135=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value160=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 163, "list_item$1charph"))));
        ...
        litem_136=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value161=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 173, "list_item$1charph"))));
...
struct list$1list$1charphph* __result78__;
    if(    self->len==0) {
        litem_137=(struct list_item$1list$1charphph*)come_increment_ref_count(((struct list_item$1list$1charphph*)(__right_value163=(struct list_item$1list$1charphph*)come_calloc(1, sizeof(struct list_item$1list$1charphph)*(1), "/usr/local/include/comelang.h", 153, "list_item$1list$1charphph"))));
        ...
        litem_138=(struct list_item$1list$1charphph*)come_increment_ref_count(((struct list_item$1list$1charphph*)(__right_value164=(struct list_item$1list$1charphph*)come_calloc(1, sizeof(struct list_item$1list$1charphph)*(1), "/usr/local/include/comelang.h", 163, "list_item$1list$1charphph"))));
        ...
        litem_139=(struct list_item$1list$1charphph*)come_increment_ref_count(((struct list_item$1list$1charphph*)(__right_value165=(struct list_item$1list$1charphph*)come_calloc(1, sizeof(struct list_item$1list$1charphph)*(1), "/usr/local/include/comelang.h", 173, "list_item$1list$1charphph"))));
