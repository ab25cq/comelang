...
int pipe(int anonymous_var_nameX753[2]);
int pipe2(int anonymous_var_nameX754[2], int anonymous_var_nameX755);
int close(int anonymous_var_nameX756);
int posix_close(int anonymous_var_nameX757, int anonymous_var_nameX758);
int dup(int anonymous_var_nameX759);
int dup2(int anonymous_var_nameX760, int anonymous_var_nameX761);
int dup3(int anonymous_var_nameX762, int anonymous_var_nameX763, int anonymous_var_nameX764);
long lseek(int anonymous_var_nameX765, long anonymous_var_nameX766, int anonymous_var_nameX767);
int fsync(int anonymous_var_nameX768);
int fdatasync(int anonymous_var_nameX769);
long read(int anonymous_var_nameX770, void* anonymous_var_nameX771, unsigned long  int anonymous_var_nameX772);
long write(int anonymous_var_nameX773, const void* anonymous_var_nameX774, unsigned long  int anonymous_var_nameX775);
long pread(int anonymous_var_nameX776, void* anonymous_var_nameX777, unsigned long  int anonymous_var_nameX778, long anonymous_var_nameX779);
long pwrite(int anonymous_var_nameX780, const void* anonymous_var_nameX781, unsigned long  int anonymous_var_nameX782, long anonymous_var_nameX783);
int chown(const char* anonymous_var_nameX784, unsigned int anonymous_var_nameX785, unsigned int anonymous_var_nameX786);
int fchown(int anonymous_var_nameX787, unsigned int anonymous_var_nameX788, unsigned int anonymous_var_nameX789);
int lchown(const char* anonymous_var_nameX790, unsigned int anonymous_var_nameX791, unsigned int anonymous_var_nameX792);
int fchownat(int anonymous_var_nameX793, const char* anonymous_var_nameX794, unsigned int anonymous_var_nameX795, unsigned int anonymous_var_nameX796, int anonymous_var_nameX797);
int link(const char* anonymous_var_nameX798, const char* anonymous_var_nameX799);
int linkat(int anonymous_var_nameX800, const char* anonymous_var_nameX801, int anonymous_var_nameX802, const char* anonymous_var_nameX803, int anonymous_var_nameX804);
int symlink(const char* anonymous_var_nameX805, const char* anonymous_var_nameX806);
int symlinkat(const char* anonymous_var_nameX807, int anonymous_var_nameX808, const char* anonymous_var_nameX809);
long readlink(const char* anonymous_var_nameX810, char* anonymous_var_nameX811, unsigned long  int anonymous_var_nameX812);
long readlinkat(int anonymous_var_nameX813, const char* anonymous_var_nameX814, char* anonymous_var_nameX815, unsigned long  int anonymous_var_nameX816);
int unlink(const char* anonymous_var_nameX817);
int unlinkat(int anonymous_var_nameX818, const char* anonymous_var_nameX819, int anonymous_var_nameX820);
int rmdir(const char* anonymous_var_nameX821);
int truncate(const char* anonymous_var_nameX822, long anonymous_var_nameX823);
int ftruncate(int anonymous_var_nameX824, long anonymous_var_nameX825);
int access(const char* anonymous_var_nameX826, int anonymous_var_nameX827);
int faccessat(int anonymous_var_nameX828, const char* anonymous_var_nameX829, int anonymous_var_nameX830, int anonymous_var_nameX831);
int chdir(const char* anonymous_var_nameX832);
int fchdir(int anonymous_var_nameX833);
char* getcwd(char* anonymous_var_nameX834, unsigned long  int anonymous_var_nameX835);
unsigned int alarm(unsigned int anonymous_var_nameX836);
unsigned int sleep(unsigned int anonymous_var_nameX837);
int pause();
int fork();
int _Fork();
int execve(const char* anonymous_var_nameX838, char* anonymous_var_nameX839[], char* anonymous_var_nameX840[]);
int execv(const char* anonymous_var_nameX841, char* anonymous_var_nameX842[]);
int execle(const char* anonymous_var_nameX843, const char* anonymous_var_nameX844, ...);
int execl(const char* anonymous_var_nameX845, const char* anonymous_var_nameX846, ...);
int execvp(const char* anonymous_var_nameX847, char* anonymous_var_nameX848[]);
int execlp(const char* anonymous_var_nameX849, const char* anonymous_var_nameX850, ...);
int fexecve(int anonymous_var_nameX851, char* anonymous_var_nameX852[], char* anonymous_var_nameX853[]);
void _exit(int anonymous_var_nameX854);
int getpid();
int getppid();
int getpgrp();
int getpgid(int anonymous_var_nameX855);
int setpgid(int anonymous_var_nameX856, int anonymous_var_nameX857);
int setsid();
int getsid(int anonymous_var_nameX858);
char* ttyname(int anonymous_var_nameX859);
int ttyname_r(int anonymous_var_nameX860, char* anonymous_var_nameX861, unsigned long  int anonymous_var_nameX862);
int isatty(int anonymous_var_nameX863);
int tcgetpgrp(int anonymous_var_nameX864);
int tcsetpgrp(int anonymous_var_nameX865, int anonymous_var_nameX866);
unsigned int getuid();
unsigned int geteuid();
unsigned int getgid();
unsigned int getegid();
int getgroups(int anonymous_var_nameX867, unsigned int anonymous_var_nameX868[]);
int setuid(unsigned int anonymous_var_nameX869);
int seteuid(unsigned int anonymous_var_nameX870);
int setgid(unsigned int anonymous_var_nameX871);
int setegid(unsigned int anonymous_var_nameX872);
char* getlogin();
int getlogin_r(char* anonymous_var_nameX873, unsigned long  int anonymous_var_nameX874);
int gethostname(char* anonymous_var_nameX875, unsigned long  int anonymous_var_nameX876);
char* ctermid(char* anonymous_var_nameX877);
int getopt(int anonymous_var_nameX878, char* anonymous_var_nameX879[], const char* anonymous_var_nameX880);
long pathconf(const char* anonymous_var_nameX881, int anonymous_var_nameX882);
long fpathconf(int anonymous_var_nameX883, int anonymous_var_nameX884);
long sysconf(int anonymous_var_nameX885);
unsigned long  int confstr(int anonymous_var_nameX886, char* anonymous_var_nameX887, unsigned long  int anonymous_var_nameX888);
int setreuid(unsigned int anonymous_var_nameX889, unsigned int anonymous_var_nameX890);
int setregid(unsigned int anonymous_var_nameX891, unsigned int anonymous_var_nameX892);
int lockf(int anonymous_var_nameX893, int anonymous_var_nameX894, long anonymous_var_nameX895);
long gethostid();
int nice(int anonymous_var_nameX896);
void sync();
int setpgrp();
char* crypt(const char* anonymous_var_nameX897, const char* anonymous_var_nameX898);
void encrypt(char* anonymous_var_nameX899, int anonymous_var_nameX900);
void swab(const void* anonymous_var_nameX901, void* anonymous_var_nameX902, long anonymous_var_nameX903);
int usleep(unsigned int anonymous_var_nameX904);
unsigned int ualarm(unsigned int anonymous_var_nameX905, unsigned int anonymous_var_nameX906);
int brk(void* anonymous_var_nameX907);
void* sbrk(long anonymous_var_nameX908);
int vfork();
int vhangup();
int chroot(const char* anonymous_var_nameX909);
int getpagesize();
int getdtablesize();
int sethostname(const char* anonymous_var_nameX910, unsigned long  int anonymous_var_nameX911);
int getdomainname(char* anonymous_var_nameX912, unsigned long  int anonymous_var_nameX913);
int setdomainname(const char* anonymous_var_nameX914, unsigned long  int anonymous_var_nameX915);
int setgroups(unsigned long  int anonymous_var_nameX916, const unsigned int* anonymous_var_nameX917);
char* getpass(const char* anonymous_var_nameX918);
int daemon(int anonymous_var_nameX919, int anonymous_var_nameX920);
void setusershell();
void endusershell();
char* getusershell();
int acct(const char* anonymous_var_nameX921);
long syscall(long anonymous_var_nameX922, ...);
int execvpe(const char* anonymous_var_nameX923, char* anonymous_var_nameX924[], char* anonymous_var_nameX925[]);
int issetugid();
int getentropy(void* anonymous_var_nameX926, unsigned long  int anonymous_var_nameX927);
int setresuid(unsigned int anonymous_var_nameX928, unsigned int anonymous_var_nameX929, unsigned int anonymous_var_nameX930);
int setresgid(unsigned int anonymous_var_nameX931, unsigned int anonymous_var_nameX932, unsigned int anonymous_var_nameX933);
int getresuid(unsigned int* anonymous_var_nameX934, unsigned int* anonymous_var_nameX935, unsigned int* anonymous_var_nameX936);
int getresgid(unsigned int* anonymous_var_nameX937, unsigned int* anonymous_var_nameX938, unsigned int* anonymous_var_nameX939);
char* get_current_dir_name();
int syncfs(int anonymous_var_nameX940);
int euidaccess(const char* anonymous_var_nameX941, int anonymous_var_nameX942);
int eaccess(const char* anonymous_var_nameX943, int anonymous_var_nameX944);
long copy_file_range(int anonymous_var_nameX945, long* anonymous_var_nameX946, int anonymous_var_nameX947, long* anonymous_var_nameX948, unsigned long  int anonymous_var_nameX949, unsigned int anonymous_var_nameX950);
int gettid();
long imaxabs(long anonymous_var_nameX951);
struct anonymous_typeX4 imaxdiv(long anonymous_var_nameX952, long anonymous_var_nameX953);
long strtoimax(const char* anonymous_var_nameX954, char** anonymous_var_nameX955, int anonymous_var_nameX956);
unsigned long  int strtoumax(const char* anonymous_var_nameX957, char** anonymous_var_nameX958, int anonymous_var_nameX959);
long wcstoimax(const unsigned int* anonymous_var_nameX960, unsigned int** anonymous_var_nameX961, int anonymous_var_nameX962);
unsigned long  int wcstoumax(const unsigned int* anonymous_var_nameX963, unsigned int** anonymous_var_nameX964, int anonymous_var_nameX965);
int sendmmsg(int anonymous_var_nameX966, struct mmsghdr* anonymous_var_nameX967, unsigned int anonymous_var_nameX968, unsigned int anonymous_var_nameX969);
int recvmmsg(int anonymous_var_nameX970, struct mmsghdr* anonymous_var_nameX971, unsigned int anonymous_var_nameX972, unsigned int anonymous_var_nameX973, struct timespec* anonymous_var_nameX974);
int socket(int anonymous_var_nameX975, int anonymous_var_nameX976, int anonymous_var_nameX977);
int socketpair(int anonymous_var_nameX978, int anonymous_var_nameX979, int anonymous_var_nameX980, int anonymous_var_nameX981[2]);
int shutdown(int anonymous_var_nameX982, int anonymous_var_nameX983);
int bind(int anonymous_var_nameX984, const struct sockaddr* anonymous_var_nameX985, unsigned int anonymous_var_nameX986);
int connect(int anonymous_var_nameX987, const struct sockaddr* anonymous_var_nameX988, unsigned int anonymous_var_nameX989);
int listen(int anonymous_var_nameX990, int anonymous_var_nameX991);
int accept(int anonymous_var_nameX992, struct sockaddr* anonymous_var_nameX993, unsigned int* anonymous_var_nameX994);
int accept4(int anonymous_var_nameX995, struct sockaddr* anonymous_var_nameX996, unsigned int* anonymous_var_nameX997, int anonymous_var_nameX998);
int getsockname(int anonymous_var_nameX999, struct sockaddr* anonymous_var_nameX1000, unsigned int* anonymous_var_nameX1001);
int getpeername(int anonymous_var_nameX1002, struct sockaddr* anonymous_var_nameX1003, unsigned int* anonymous_var_nameX1004);
long send(int anonymous_var_nameX1005, const void* anonymous_var_nameX1006, unsigned long  int anonymous_var_nameX1007, int anonymous_var_nameX1008);
long recv(int anonymous_var_nameX1009, void* anonymous_var_nameX1010, unsigned long  int anonymous_var_nameX1011, int anonymous_var_nameX1012);
long sendto(int anonymous_var_nameX1013, const void* anonymous_var_nameX1014, unsigned long  int anonymous_var_nameX1015, int anonymous_var_nameX1016, const struct sockaddr* anonymous_var_nameX1017, unsigned int anonymous_var_nameX1018);
long recvfrom(int anonymous_var_nameX1019, void* anonymous_var_nameX1020, unsigned long  int anonymous_var_nameX1021, int anonymous_var_nameX1022, struct sockaddr* anonymous_var_nameX1023, unsigned int* anonymous_var_nameX1024);
long sendmsg(int anonymous_var_nameX1025, const struct msghdr* anonymous_var_nameX1026, int anonymous_var_nameX1027);
long recvmsg(int anonymous_var_nameX1028, struct msghdr* anonymous_var_nameX1029, int anonymous_var_nameX1030);
int getsockopt(int anonymous_var_nameX1031, int anonymous_var_nameX1032, int anonymous_var_nameX1033, void* anonymous_var_nameX1034, unsigned int* anonymous_var_nameX1035);
int setsockopt(int anonymous_var_nameX1036, int anonymous_var_nameX1037, int anonymous_var_nameX1038, const void* anonymous_var_nameX1039, unsigned int anonymous_var_nameX1040);
int sockatmark(int anonymous_var_nameX1041);
unsigned int htonl(unsigned int anonymous_var_nameX1046);
unsigned short int htons(unsigned short int anonymous_var_nameX1047);
unsigned int ntohl(unsigned int anonymous_var_nameX1048);
unsigned short int ntohs(unsigned short int anonymous_var_nameX1049);
unsigned int inet_addr(const char* anonymous_var_nameX1050);
unsigned int inet_network(const char* anonymous_var_nameX1051);
char* inet_ntoa(struct in_addr anonymous_var_nameX1052);
int inet_pton(int anonymous_var_nameX1053, const char* anonymous_var_nameX1054, void* anonymous_var_nameX1055);
const char* inet_ntop(int anonymous_var_nameX1056, const void* anonymous_var_nameX1057, char* anonymous_var_nameX1058, unsigned int anonymous_var_nameX1059);
int inet_aton(const char* anonymous_var_nameX1060, struct in_addr* anonymous_var_nameX1061);
struct in_addr inet_makeaddr(unsigned int anonymous_var_nameX1062, unsigned int anonymous_var_nameX1063);
unsigned int inet_lnaof(struct in_addr anonymous_var_nameX1064);
unsigned int inet_netof(struct in_addr anonymous_var_nameX1065);
int select(int anonymous_var_nameX1066, struct anonymous_typeX7* anonymous_var_nameX1067, struct anonymous_typeX7* anonymous_var_nameX1068, struct anonymous_typeX7* anonymous_var_nameX1069, struct timeval* anonymous_var_nameX1070);
int pselect(int anonymous_var_nameX1071, struct anonymous_typeX7* anonymous_var_nameX1072, struct anonymous_typeX7* anonymous_var_nameX1073, struct anonymous_typeX7* anonymous_var_nameX1074, const struct timespec* anonymous_var_nameX1075, const struct __sigset_t* anonymous_var_nameX1076);
int gettimeofday(struct timeval* anonymous_var_nameX1077, void* anonymous_var_nameX1078);
int getitimer(int anonymous_var_nameX1079, struct itimerval* anonymous_var_nameX1080);
int setitimer(int anonymous_var_nameX1081, const struct itimerval* anonymous_var_nameX1082, struct itimerval* anonymous_var_nameX1083);
int utimes(const char* anonymous_var_nameX1084, const struct timeval anonymous_var_nameX1085[2]);
int futimes(int anonymous_var_nameX1086, const struct timeval anonymous_var_nameX1087[2]);
int futimesat(int anonymous_var_nameX1088, const char* anonymous_var_nameX1089, const struct timeval anonymous_var_nameX1090[2]);
int lutimes(const char* anonymous_var_nameX1091, const struct timeval anonymous_var_nameX1092[2]);
int settimeofday(const struct timeval* anonymous_var_nameX1093, const struct timezone* anonymous_var_nameX1094);
int adjtime(const struct timeval* anonymous_var_nameX1095, struct timeval* anonymous_var_nameX1096);
long clock();
long time(long* anonymous_var_nameX1097);
double difftime(long anonymous_var_nameX1098, long anonymous_var_nameX1099);
long mktime(struct tm* anonymous_var_nameX1100);
unsigned long  int strftime(char* anonymous_var_nameX1101, unsigned long  int anonymous_var_nameX1102, const char* anonymous_var_nameX1103, const struct tm* anonymous_var_nameX1104);
struct tm* gmtime(const long* anonymous_var_nameX1105);
struct tm* localtime(const long* anonymous_var_nameX1106);
char* asctime(const struct tm* anonymous_var_nameX1107);
char* ctime(const long* anonymous_var_nameX1108);
int timespec_get(struct timespec* anonymous_var_nameX1109, int anonymous_var_nameX1110);
unsigned long  int strftime_l(char* anonymous_var_nameX1111, unsigned long  int anonymous_var_nameX1112, const char* anonymous_var_nameX1113, const struct tm* anonymous_var_nameX1114, struct __locale_struct* anonymous_var_nameX1115);
struct tm* gmtime_r(const long* anonymous_var_nameX1116, struct tm* anonymous_var_nameX1117);
struct tm* localtime_r(const long* anonymous_var_nameX1118, struct tm* anonymous_var_nameX1119);
char* asctime_r(const struct tm* anonymous_var_nameX1120, char* anonymous_var_nameX1121);
char* ctime_r(const long* anonymous_var_nameX1122, char* anonymous_var_nameX1123);
void tzset();
int nanosleep(const struct timespec* anonymous_var_nameX1124, struct timespec* anonymous_var_nameX1125);
int clock_getres(int anonymous_var_nameX1126, struct timespec* anonymous_var_nameX1127);
int clock_gettime(int anonymous_var_nameX1128, struct timespec* anonymous_var_nameX1129);
int clock_settime(int anonymous_var_nameX1130, const struct timespec* anonymous_var_nameX1131);
int clock_nanosleep(int anonymous_var_nameX1132, int anonymous_var_nameX1133, const struct timespec* anonymous_var_nameX1134, struct timespec* anonymous_var_nameX1135);
int clock_getcpuclockid(int anonymous_var_nameX1136, int* anonymous_var_nameX1137);
int timer_create(int anonymous_var_nameX1138, struct sigevent* anonymous_var_nameX1139, void** anonymous_var_nameX1140);
int timer_delete(void* anonymous_var_nameX1141);
int timer_settime(void* anonymous_var_nameX1142, int anonymous_var_nameX1143, const struct itimerspec* anonymous_var_nameX1144, struct itimerspec* anonymous_var_nameX1145);
int timer_gettime(void* anonymous_var_nameX1146, struct itimerspec* anonymous_var_nameX1147);
int timer_getoverrun(void* anonymous_var_nameX1148);
char* strptime(const char* anonymous_var_nameX1149, const char* anonymous_var_nameX1150, struct tm* anonymous_var_nameX1151);
struct tm* getdate(const char* anonymous_var_nameX1152);
int stime(const long* anonymous_var_nameX1153);
long timegm(struct tm* anonymous_var_nameX1154);
int OPENSSL_sk_num(const struct stack_st* anonymous_var_nameX1159);
void* OPENSSL_sk_value(const struct stack_st* anonymous_var_nameX1160, int anonymous_var_nameX1161);
...
void OPENSSL_sk_free(struct stack_st* anonymous_var_nameX1162);
void OPENSSL_sk_pop_free(struct stack_st* st, void (*func)(void*));
struct stack_st* OPENSSL_sk_deep_copy(const struct stack_st* anonymous_var_nameX1164, void* (*c)(const void*), void (*f)(void*));
...
int sched_get_priority_max(int anonymous_var_nameX1165);
int sched_get_priority_min(int anonymous_var_nameX1166);
int sched_getparam(int anonymous_var_nameX1167, struct sched_param* anonymous_var_nameX1168);
int sched_getscheduler(int anonymous_var_nameX1169);
int sched_rr_get_interval(int anonymous_var_nameX1170, struct timespec* anonymous_var_nameX1171);
int sched_setparam(int anonymous_var_nameX1172, const struct sched_param* anonymous_var_nameX1173);
int sched_setscheduler(int anonymous_var_nameX1174, int anonymous_var_nameX1175, const struct sched_param* anonymous_var_nameX1176);
int sched_yield();
int clone(int (*anonymous_lambda_var_nameZ6)(void*), void* anonymous_var_nameX1178, int anonymous_var_nameX1179, void* anonymous_var_nameX1180, ...);
int unshare(int anonymous_var_nameX1181);
int setns(int anonymous_var_nameX1182, int anonymous_var_nameX1183);
void* memcpy(void* anonymous_var_nameX1184, const void* anonymous_var_nameX1185, unsigned long  int anonymous_var_nameX1186);
int memcmp(const void* anonymous_var_nameX1187, const void* anonymous_var_nameX1188, unsigned long  int anonymous_var_nameX1189);
void* memset(void* anonymous_var_nameX1190, int anonymous_var_nameX1191, unsigned long  int anonymous_var_nameX1192);
void* calloc(unsigned long  int anonymous_var_nameX1193, unsigned long  int anonymous_var_nameX1194);
void free(void* anonymous_var_nameX1195);
int __sched_cpucount(unsigned long  int anonymous_var_nameX1196, const struct cpu_set_t* anonymous_var_nameX1197);
int sched_getcpu();
int sched_getaffinity(int anonymous_var_nameX1198, unsigned long  int anonymous_var_nameX1199, struct cpu_set_t* anonymous_var_nameX1200);
int sched_setaffinity(int anonymous_var_nameX1201, unsigned long  int anonymous_var_nameX1202, const struct cpu_set_t* anonymous_var_nameX1203);
int pthread_create(struct __pthread** anonymous_var_nameX1204, const struct anonymous_typeX14* anonymous_var_nameX1205, void* (*anonymous_lambda_var_nameZ7)(void*), void* anonymous_var_nameX1207);
int pthread_detach(struct __pthread* anonymous_var_nameX1208);
void pthread_exit(void* anonymous_var_nameX1209);
int pthread_join(struct __pthread* anonymous_var_nameX1210, void** anonymous_var_nameX1211);
struct __pthread* pthread_self();
int pthread_equal(struct __pthread* anonymous_var_nameX1212, struct __pthread* anonymous_var_nameX1213);
int pthread_setcancelstate(int anonymous_var_nameX1214, int* anonymous_var_nameX1215);
int pthread_setcanceltype(int anonymous_var_nameX1216, int* anonymous_var_nameX1217);
void pthread_testcancel();
int pthread_cancel(struct __pthread* anonymous_var_nameX1218);
int pthread_getschedparam(struct __pthread* anonymous_var_nameX1219, int* anonymous_var_nameX1220, struct sched_param* anonymous_var_nameX1221);
int pthread_setschedparam(struct __pthread* anonymous_var_nameX1222, int anonymous_var_nameX1223, const struct sched_param* anonymous_var_nameX1224);
int pthread_setschedprio(struct __pthread* anonymous_var_nameX1225, int anonymous_var_nameX1226);
int pthread_once(int* anonymous_var_nameX1227, void (*anonymous_lambda_var_nameZ8)());
int pthread_mutex_init(struct anonymous_typeX17* anonymous_var_nameX1228, const struct anonymous_typeX10* anonymous_var_nameX1229);
int pthread_mutex_lock(struct anonymous_typeX17* anonymous_var_nameX1230);
int pthread_mutex_unlock(struct anonymous_typeX17* anonymous_var_nameX1231);
int pthread_mutex_trylock(struct anonymous_typeX17* anonymous_var_nameX1232);
int pthread_mutex_timedlock(struct anonymous_typeX17* anonymous_var_nameX1233, const struct timespec* anonymous_var_nameX1234);
int pthread_mutex_destroy(struct anonymous_typeX17* anonymous_var_nameX1235);
int pthread_mutex_consistent(struct anonymous_typeX17* anonymous_var_nameX1236);
int pthread_mutex_getprioceiling(const struct anonymous_typeX17* anonymous_var_nameX1237, int* anonymous_var_nameX1238);
int pthread_mutex_setprioceiling(struct anonymous_typeX17* anonymous_var_nameX1239, int anonymous_var_nameX1240, int* anonymous_var_nameX1241);
int pthread_cond_init(struct anonymous_typeX20* anonymous_var_nameX1242, const struct anonymous_typeX11* anonymous_var_nameX1243);
int pthread_cond_destroy(struct anonymous_typeX20* anonymous_var_nameX1244);
int pthread_cond_wait(struct anonymous_typeX20* anonymous_var_nameX1245, struct anonymous_typeX17* anonymous_var_nameX1246);
int pthread_cond_timedwait(struct anonymous_typeX20* anonymous_var_nameX1247, struct anonymous_typeX17* anonymous_var_nameX1248, const struct timespec* anonymous_var_nameX1249);
int pthread_cond_broadcast(struct anonymous_typeX20* anonymous_var_nameX1250);
int pthread_cond_signal(struct anonymous_typeX20* anonymous_var_nameX1251);
int pthread_rwlock_init(struct anonymous_typeX23* anonymous_var_nameX1252, const struct anonymous_typeX13* anonymous_var_nameX1253);
int pthread_rwlock_destroy(struct anonymous_typeX23* anonymous_var_nameX1254);
int pthread_rwlock_rdlock(struct anonymous_typeX23* anonymous_var_nameX1255);
int pthread_rwlock_tryrdlock(struct anonymous_typeX23* anonymous_var_nameX1256);
int pthread_rwlock_timedrdlock(struct anonymous_typeX23* anonymous_var_nameX1257, const struct timespec* anonymous_var_nameX1258);
int pthread_rwlock_wrlock(struct anonymous_typeX23* anonymous_var_nameX1259);
int pthread_rwlock_trywrlock(struct anonymous_typeX23* anonymous_var_nameX1260);
int pthread_rwlock_timedwrlock(struct anonymous_typeX23* anonymous_var_nameX1261, const struct timespec* anonymous_var_nameX1262);
int pthread_rwlock_unlock(struct anonymous_typeX23* anonymous_var_nameX1263);
int pthread_spin_init(int* anonymous_var_nameX1264, int anonymous_var_nameX1265);
int pthread_spin_destroy(int* anonymous_var_nameX1266);
int pthread_spin_lock(int* anonymous_var_nameX1267);
int pthread_spin_trylock(int* anonymous_var_nameX1268);
int pthread_spin_unlock(int* anonymous_var_nameX1269);
int pthread_barrier_init(struct anonymous_typeX26* anonymous_var_nameX1270, const struct anonymous_typeX12* anonymous_var_nameX1271, unsigned int anonymous_var_nameX1272);
int pthread_barrier_destroy(struct anonymous_typeX26* anonymous_var_nameX1273);
int pthread_barrier_wait(struct anonymous_typeX26* anonymous_var_nameX1274);
int pthread_key_create(unsigned int* anonymous_var_nameX1275, void (*anonymous_lambda_var_nameZ9)(void*));
int pthread_key_delete(unsigned int anonymous_var_nameX1277);
void* pthread_getspecific(unsigned int anonymous_var_nameX1278);
int pthread_setspecific(unsigned int anonymous_var_nameX1279, const void* anonymous_var_nameX1280);
int pthread_attr_init(struct anonymous_typeX14* anonymous_var_nameX1281);
int pthread_attr_destroy(struct anonymous_typeX14* anonymous_var_nameX1282);
int pthread_attr_getguardsize(const struct anonymous_typeX14* anonymous_var_nameX1283, unsigned long  int* anonymous_var_nameX1284);
int pthread_attr_setguardsize(struct anonymous_typeX14* anonymous_var_nameX1285, unsigned long  int anonymous_var_nameX1286);
int pthread_attr_getstacksize(const struct anonymous_typeX14* anonymous_var_nameX1287, unsigned long  int* anonymous_var_nameX1288);
int pthread_attr_setstacksize(struct anonymous_typeX14* anonymous_var_nameX1289, unsigned long  int anonymous_var_nameX1290);
int pthread_attr_getdetachstate(const struct anonymous_typeX14* anonymous_var_nameX1291, int* anonymous_var_nameX1292);
int pthread_attr_setdetachstate(struct anonymous_typeX14* anonymous_var_nameX1293, int anonymous_var_nameX1294);
int pthread_attr_getstack(const struct anonymous_typeX14* anonymous_var_nameX1295, void** anonymous_var_nameX1296, unsigned long  int* anonymous_var_nameX1297);
int pthread_attr_setstack(struct anonymous_typeX14* anonymous_var_nameX1298, void* anonymous_var_nameX1299, unsigned long  int anonymous_var_nameX1300);
int pthread_attr_getscope(const struct anonymous_typeX14* anonymous_var_nameX1301, int* anonymous_var_nameX1302);
int pthread_attr_setscope(struct anonymous_typeX14* anonymous_var_nameX1303, int anonymous_var_nameX1304);
int pthread_attr_getschedpolicy(const struct anonymous_typeX14* anonymous_var_nameX1305, int* anonymous_var_nameX1306);
int pthread_attr_setschedpolicy(struct anonymous_typeX14* anonymous_var_nameX1307, int anonymous_var_nameX1308);
int pthread_attr_getschedparam(const struct anonymous_typeX14* anonymous_var_nameX1309, struct sched_param* anonymous_var_nameX1310);
int pthread_attr_setschedparam(struct anonymous_typeX14* anonymous_var_nameX1311, const struct sched_param* anonymous_var_nameX1312);
int pthread_attr_getinheritsched(const struct anonymous_typeX14* anonymous_var_nameX1313, int* anonymous_var_nameX1314);
int pthread_attr_setinheritsched(struct anonymous_typeX14* anonymous_var_nameX1315, int anonymous_var_nameX1316);
int pthread_mutexattr_destroy(struct anonymous_typeX10* anonymous_var_nameX1317);
int pthread_mutexattr_getprioceiling(const struct anonymous_typeX10* anonymous_var_nameX1318, int* anonymous_var_nameX1319);
int pthread_mutexattr_getprotocol(const struct anonymous_typeX10* anonymous_var_nameX1320, int* anonymous_var_nameX1321);
int pthread_mutexattr_getpshared(const struct anonymous_typeX10* anonymous_var_nameX1322, int* anonymous_var_nameX1323);
int pthread_mutexattr_getrobust(const struct anonymous_typeX10* anonymous_var_nameX1324, int* anonymous_var_nameX1325);
int pthread_mutexattr_gettype(const struct anonymous_typeX10* anonymous_var_nameX1326, int* anonymous_var_nameX1327);
int pthread_mutexattr_init(struct anonymous_typeX10* anonymous_var_nameX1328);
int pthread_mutexattr_setprioceiling(struct anonymous_typeX10* anonymous_var_nameX1329, int anonymous_var_nameX1330);
int pthread_mutexattr_setprotocol(struct anonymous_typeX10* anonymous_var_nameX1331, int anonymous_var_nameX1332);
int pthread_mutexattr_setpshared(struct anonymous_typeX10* anonymous_var_nameX1333, int anonymous_var_nameX1334);
int pthread_mutexattr_setrobust(struct anonymous_typeX10* anonymous_var_nameX1335, int anonymous_var_nameX1336);
int pthread_mutexattr_settype(struct anonymous_typeX10* anonymous_var_nameX1337, int anonymous_var_nameX1338);
int pthread_condattr_init(struct anonymous_typeX11* anonymous_var_nameX1339);
int pthread_condattr_destroy(struct anonymous_typeX11* anonymous_var_nameX1340);
int pthread_condattr_setclock(struct anonymous_typeX11* anonymous_var_nameX1341, int anonymous_var_nameX1342);
int pthread_condattr_setpshared(struct anonymous_typeX11* anonymous_var_nameX1343, int anonymous_var_nameX1344);
int pthread_condattr_getclock(const struct anonymous_typeX11* anonymous_var_nameX1345, int* anonymous_var_nameX1346);
int pthread_condattr_getpshared(const struct anonymous_typeX11* anonymous_var_nameX1347, int* anonymous_var_nameX1348);
int pthread_rwlockattr_init(struct anonymous_typeX13* anonymous_var_nameX1349);
int pthread_rwlockattr_destroy(struct anonymous_typeX13* anonymous_var_nameX1350);
int pthread_rwlockattr_setpshared(struct anonymous_typeX13* anonymous_var_nameX1351, int anonymous_var_nameX1352);
int pthread_rwlockattr_getpshared(const struct anonymous_typeX13* anonymous_var_nameX1353, int* anonymous_var_nameX1354);
int pthread_barrierattr_destroy(struct anonymous_typeX12* anonymous_var_nameX1355);
int pthread_barrierattr_getpshared(const struct anonymous_typeX12* anonymous_var_nameX1356, int* anonymous_var_nameX1357);
int pthread_barrierattr_init(struct anonymous_typeX12* anonymous_var_nameX1358);
int pthread_barrierattr_setpshared(struct anonymous_typeX12* anonymous_var_nameX1359, int anonymous_var_nameX1360);
...
int pthread_setconcurrency(int anonymous_var_nameX1361);
int pthread_getcpuclockid(struct __pthread* anonymous_var_nameX1362, int* anonymous_var_nameX1363);
void _pthread_cleanup_push(struct __ptcb* anonymous_var_nameX1366, void (*anonymous_lambda_var_nameZ13)(void*), void* anonymous_var_nameX1368);
void _pthread_cleanup_pop(struct __ptcb* anonymous_var_nameX1369, int anonymous_var_nameX1370);
int pthread_getaffinity_np(struct __pthread* anonymous_var_nameX1371, unsigned long  int anonymous_var_nameX1372, struct cpu_set_t* anonymous_var_nameX1373);
int pthread_setaffinity_np(struct __pthread* anonymous_var_nameX1374, unsigned long  int anonymous_var_nameX1375, const struct cpu_set_t* anonymous_var_nameX1376);
int pthread_getattr_np(struct __pthread* anonymous_var_nameX1377, struct anonymous_typeX14* anonymous_var_nameX1378);
int pthread_setname_np(struct __pthread* anonymous_var_nameX1379, const char* anonymous_var_nameX1380);
int pthread_getname_np(struct __pthread* anonymous_var_nameX1381, char* anonymous_var_nameX1382, unsigned long  int anonymous_var_nameX1383);
int pthread_getattr_default_np(struct anonymous_typeX14* anonymous_var_nameX1384);
int pthread_setattr_default_np(const struct anonymous_typeX14* anonymous_var_nameX1385);
int pthread_tryjoin_np(struct __pthread* anonymous_var_nameX1386, void** anonymous_var_nameX1387);
int pthread_timedjoin_np(struct __pthread* anonymous_var_nameX1388, void** anonymous_var_nameX1389, const struct timespec* anonymous_var_nameX1390);
...
void OSSL_LIB_CTX_free(struct ossl_lib_ctx_st* anonymous_var_nameX1392);
...
void BIO_ADDR_free(union bio_addr_st* anonymous_var_nameX1396);
...
int BN_BLINDING_convert_ex(struct bignum_st* n, struct bignum_st* r, struct bn_blinding_st* b, struct bignum_ctx* anonymous_var_nameX1453);
int BN_BLINDING_invert_ex(struct bignum_st* n, const struct bignum_st* r, struct bn_blinding_st* b, struct bignum_ctx* anonymous_var_nameX1454);
...
unsigned long  int BN_BLINDING_get_flags(const struct bn_blinding_st* anonymous_var_nameX1455);
void BN_BLINDING_set_flags(struct bn_blinding_st* anonymous_var_nameX1456, unsigned long  int anonymous_var_nameX1457);
...
int ASN1_STRING_TABLE_add(int anonymous_var_nameX1463, long anonymous_var_nameX1464, long anonymous_var_nameX1465, unsigned long  int anonymous_var_nameX1466, unsigned long  int anonymous_var_nameX1467);
...
enum anonymous_typeY36 EC_GROUP_get_point_conversion_form(const struct ec_group_st* anonymous_var_nameX1486);
unsigned char* EC_GROUP_get0_seed(const struct ec_group_st* x);
unsigned long  int EC_GROUP_get_seed_len(const struct ec_group_st* anonymous_var_nameX1487);
unsigned long  int EC_GROUP_set_seed(struct ec_group_st* anonymous_var_nameX1488, const unsigned char* anonymous_var_nameX1489, unsigned long  int len);
...
struct bignum_st* EC_POINT_point2bn(const struct ec_group_st* anonymous_var_nameX1490, const struct ec_point_st* anonymous_var_nameX1491, enum anonymous_typeY36 form, struct bignum_st* anonymous_var_nameX1492, struct bignum_ctx* anonymous_var_nameX1493);
struct ec_point_st* EC_POINT_bn2point(const struct ec_group_st* anonymous_var_nameX1494, const struct bignum_st* anonymous_var_nameX1495, struct ec_point_st* anonymous_var_nameX1496, struct bignum_ctx* anonymous_var_nameX1497);
char* EC_POINT_point2hex(const struct ec_group_st* anonymous_var_nameX1498, const struct ec_point_st* anonymous_var_nameX1499, enum anonymous_typeY36 form, struct bignum_ctx* anonymous_var_nameX1500);
struct ec_point_st* EC_POINT_hex2point(const struct ec_group_st* anonymous_var_nameX1501, const char* anonymous_var_nameX1502, struct ec_point_st* anonymous_var_nameX1503, struct bignum_ctx* anonymous_var_nameX1504);
...
int EC_GROUP_get_basis_type(const struct ec_group_st* anonymous_var_nameX1505);
struct ec_group_st* d2i_ECPKParameters(struct ec_group_st** anonymous_var_nameX1506, const unsigned char** in, long len);
int i2d_ECPKParameters(const struct ec_group_st* anonymous_var_nameX1507, unsigned char** out);
...
int RSA_check_key(const struct rsa_st* anonymous_var_nameX1511);
int RSA_check_key_ex(const struct rsa_st* anonymous_var_nameX1512, struct bn_gencb_st* cb);
...
void DSA_set_default_method(const struct dsa_method* anonymous_var_nameX1530);
const struct dsa_method* DSA_get_default_method();
int DSA_set_method(struct dsa_st* dsa, const struct dsa_method* anonymous_var_nameX1531);
...
int DSA_size(const struct dsa_st* anonymous_var_nameX1532);
...
void X509_VERIFY_PARAM_move_peername(struct X509_VERIFY_PARAM_st* anonymous_var_nameX1660, struct X509_VERIFY_PARAM_st* anonymous_var_nameX1661);
...
int PEM_write_bio_PKCS8PrivateKey(struct bio_st* anonymous_var_nameX1692, const struct evp_pkey_st* anonymous_var_nameX1693, const struct evp_cipher_st* anonymous_var_nameX1694, const char* kstr, int klen, int (*cb)(char*,int,int,void*), void* u);
...
int SSL_CTX_set_cipher_list(struct ssl_ctx_st* anonymous_var_nameX1706, const char* str);
...
void SSL_CTX_free(struct ssl_ctx_st* anonymous_var_nameX1707);
long SSL_CTX_set_timeout(struct ssl_ctx_st* ctx, long t);
long SSL_CTX_get_timeout(const struct ssl_ctx_st* ctx);
struct x509_store_st* SSL_CTX_get_cert_store(const struct ssl_ctx_st* anonymous_var_nameX1708);
void SSL_CTX_set_cert_store(struct ssl_ctx_st* anonymous_var_nameX1709, struct x509_store_st* anonymous_var_nameX1710);
void SSL_CTX_set1_cert_store(struct ssl_ctx_st* anonymous_var_nameX1711, struct x509_store_st* anonymous_var_nameX1712);
...
long SSL_callback_ctrl(struct ssl_st* anonymous_var_nameX1722, int anonymous_var_nameX1723, void (*anonymous_lambda_var_nameZ38)());
long SSL_CTX_ctrl(struct ssl_ctx_st* ctx, int cmd, long larg, void* parg);
long SSL_CTX_callback_ctrl(struct ssl_ctx_st* anonymous_var_nameX1724, int anonymous_var_nameX1725, void (*anonymous_lambda_var_nameZ39)());
...
char* SSL_CIPHER_description(const struct ssl_cipher_st* anonymous_var_nameX1726, char* buf, int size);
...
void ERR_remove_thread_state(void* anonymous_var_nameX1757);
...
int isalnum(int anonymous_var_nameX1760);
int isalpha(int anonymous_var_nameX1761);
int isblank(int anonymous_var_nameX1762);
int iscntrl(int anonymous_var_nameX1763);
int isdigit(int anonymous_var_nameX1764);
int isgraph(int anonymous_var_nameX1765);
int islower(int anonymous_var_nameX1766);
int isprint(int anonymous_var_nameX1767);
int ispunct(int anonymous_var_nameX1768);
int isspace(int anonymous_var_nameX1769);
int isupper(int anonymous_var_nameX1770);
int isxdigit(int anonymous_var_nameX1771);
int tolower(int anonymous_var_nameX1772);
int toupper(int anonymous_var_nameX1773);
int isalnum_l(int anonymous_var_nameX1775, struct __locale_struct* anonymous_var_nameX1776);
int isalpha_l(int anonymous_var_nameX1777, struct __locale_struct* anonymous_var_nameX1778);
int isblank_l(int anonymous_var_nameX1779, struct __locale_struct* anonymous_var_nameX1780);
int iscntrl_l(int anonymous_var_nameX1781, struct __locale_struct* anonymous_var_nameX1782);
int isdigit_l(int anonymous_var_nameX1783, struct __locale_struct* anonymous_var_nameX1784);
int isgraph_l(int anonymous_var_nameX1785, struct __locale_struct* anonymous_var_nameX1786);
int islower_l(int anonymous_var_nameX1787, struct __locale_struct* anonymous_var_nameX1788);
int isprint_l(int anonymous_var_nameX1789, struct __locale_struct* anonymous_var_nameX1790);
int ispunct_l(int anonymous_var_nameX1791, struct __locale_struct* anonymous_var_nameX1792);
int isspace_l(int anonymous_var_nameX1793, struct __locale_struct* anonymous_var_nameX1794);
int isupper_l(int anonymous_var_nameX1795, struct __locale_struct* anonymous_var_nameX1796);
int isxdigit_l(int anonymous_var_nameX1797, struct __locale_struct* anonymous_var_nameX1798);
int tolower_l(int anonymous_var_nameX1799, struct __locale_struct* anonymous_var_nameX1800);
int toupper_l(int anonymous_var_nameX1801, struct __locale_struct* anonymous_var_nameX1802);
int isascii(int anonymous_var_nameX1803);
int toascii(int anonymous_var_nameX1804);
...
void mysql_set_local_infile_handler(struct st_mysql* mysql, int (*local_infile_init)(void**,const char*,void*), int (*local_infile_read)(void*,char*,unsigned int), void (*local_infile_end)(void*), int (*local_infile_error)(void*,char*,unsigned int), void* anonymous_var_nameX1854);
...
struct st_mysql_rows* mysql_row_seek(struct st_mysql_res* result, struct st_mysql_rows* anonymous_var_nameX1855);
...
unsigned long  int __i_247;
memset(&__i_247, 0, sizeof(unsigned long  int));
    for(    __i_247=0;    __i_247<__size/sizeof(long);    __i_247++    ){
        ((unsigned long  int*)__dest)[__i_247]=((unsigned long  int*)__src1)[__i_247]&((unsigned long  int*)__src2)[__i_247];
    }
}
...
unsigned long  int __i_248;
memset(&__i_248, 0, sizeof(unsigned long  int));
    for(    __i_248=0;    __i_248<__size/sizeof(long);    __i_248++    ){
        ((unsigned long  int*)__dest)[__i_248]=((unsigned long  int*)__src1)[__i_248]|((unsigned long  int*)__src2)[__i_248];
    }
}
...
unsigned long  int __i_249;
memset(&__i_249, 0, sizeof(unsigned long  int));
    for(    __i_249=0;    __i_249<__size/sizeof(long);    __i_249++    ){
        ((unsigned long  int*)__dest)[__i_249]=((unsigned long  int*)__src1)[__i_249]^((unsigned long  int*)__src2)[__i_249];
    }
}
...
unsigned long  int (*hfn_conv_258)(const struct anonymous_typeX43*);
memset(&hfn_conv_258, 0, sizeof(unsigned long  int (*)(const struct anonymous_typeX43*)));
    hfn_conv_258=(unsigned long  int (*)(const struct anonymous_typeX43*))hfn;
    return hfn_conv_258((const struct anonymous_typeX43*)data);
}
static int lh_CONF_VALUE_comp_thunk(const void* da, const void* db, int (*cfn)(const void*,const void*)){
int (*cfn_conv_259)(const struct anonymous_typeX43*,const struct anonymous_typeX43*);
memset(&cfn_conv_259, 0, sizeof(int (*)(const struct anonymous_typeX43*,const struct anonymous_typeX43*)));
    cfn_conv_259=(int (*)(const struct anonymous_typeX43*,const struct anonymous_typeX43*))cfn;
    return cfn_conv_259((const struct anonymous_typeX43*)da,(const struct anonymous_typeX43*)db);
}
static void lh_CONF_VALUE_doall_thunk(void* node, void (*doall)(void*)){
void (*doall_conv_260)(struct anonymous_typeX43*);
memset(&doall_conv_260, 0, sizeof(void (*)(struct anonymous_typeX43*)));
    doall_conv_260=(void (*)(struct anonymous_typeX43*))doall;
    doall_conv_260((struct anonymous_typeX43*)node);
}
static void lh_CONF_VALUE_doall_arg_thunk(void* node, void* arg, void (*doall)(void*,void*)){
void (*doall_conv_261)(struct anonymous_typeX43*,void*);
memset(&doall_conv_261, 0, sizeof(void (*)(struct anonymous_typeX43*,void*)));
    doall_conv_261=(void (*)(struct anonymous_typeX43*,void*))doall;
    doall_conv_261((struct anonymous_typeX43*)node,arg);
}
...
int socket_fd_write(int self, char* str){
int __result198__;
    __result198__ = write(self,str,string_length(str));
...
memset(&address_269, 0, sizeof(struct sockaddr_in));
    ...
    if(    reuse) {
        opt_268=1;
        if(        setsockopt(sock_267,1,2,&opt_268,sizeof(opt_268))) {
            close(sock_267);
    ...
    address_269.sin_port=htons(port);
...
memset(&serv_addr_275, 0, sizeof(struct sockaddr_in));
    ...
    serv_addr_275.sin_port=htons(port);
...
memset(&serv_addr_279, 0, sizeof(struct sockaddr_in));
    ...
    serv_addr_279.sin_port=htons(port);
    ...
    close(sock_278);
    __result201__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value258=buffer_to_string(buf_280)));
...
memset(&address_285, 0, sizeof(struct sockaddr_in));
    ...
    if(    reuse) {
        opt_284=1;
        if(        setsockopt(sock_283,1,2,&opt_284,sizeof(opt_284))) {
            close(sock_283);
    ...
    address_285.sin_port=htons(port);
...
struct st_mysql_res* result_299;
char** row_300;
int user_exists_301;
...
struct list$1list$1charphph* __result209__;
row_310 = (void*)0;
    if(    create_user) {
        create_user_if_not_exists(user,password,root_password,"localhost");
    }
    ...
    come_mysql_final();
    __result209__ = gComeFunResultObject = __result_obj__ = result_305;
...
static struct list$1list$1charphph* list$1list$1charphph_initialize(struct list$1list$1charphph* self){
void* __result_obj__=(void*)0;
struct list$1list$1charphph* __result206__;
    self->head=((void*)0);
    self->tail=((void*)0);
    self->len=0;
...
struct list$1charph* __result207__;
    if(    self->len==0) {
        litem_313=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value288=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 1036, "list_item$1charph"))));
        ...
        litem_314=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value289=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 1046, "list_item$1charph"))));
        ...
        litem_315=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value290=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 1056, "list_item$1charph"))));
...
struct list$1list$1charphph* __result208__;
    if(    self->len==0) {
        litem_316=(struct list_item$1list$1charphph*)come_increment_ref_count(((struct list_item$1list$1charphph*)(__right_value292=(struct list_item$1list$1charphph*)come_calloc(1, sizeof(struct list_item$1list$1charphph)*(1), "./comelang.h", 1036, "list_item$1list$1charphph"))));
        ...
        litem_317=(struct list_item$1list$1charphph*)come_increment_ref_count(((struct list_item$1list$1charphph*)(__right_value293=(struct list_item$1list$1charphph*)come_calloc(1, sizeof(struct list_item$1list$1charphph)*(1), "./comelang.h", 1046, "list_item$1list$1charphph"))));
        ...
        litem_318=(struct list_item$1list$1charphph*)come_increment_ref_count(((struct list_item$1list$1charphph*)(__right_value294=(struct list_item$1list$1charphph*)come_calloc(1, sizeof(struct list_item$1list$1charphph)*(1), "./comelang.h", 1056, "list_item$1list$1charphph"))));
