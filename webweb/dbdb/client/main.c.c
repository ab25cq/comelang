...
struct in6_addr
{
    union anonymous_typeZ18 __u6_addr;
};
...
typedef struct anonymous_typeX19 imaxdiv_t;
...
typedef struct anonymous_typeX20 CRYPTO_dynlock;
...
typedef struct anonymous_typeX25 EVP_CTRL_TLS1_1_MULTIBLOCK_PARAM;
...
enum   anonymous_typeY25 { POINT_CONVERSION_COMPRESSED=(2),
POINT_CONVERSION_UNCOMPRESSED=(4),
POINT_CONVERSION_HYBRID=(6)
};

typedef enum anonymous_typeY25 point_conversion_form_t;
...
typedef struct anonymous_typeX26 EC_builtin_curve;
...
typedef struct anonymous_typeX29 PBMAC1PARAM;
...
typedef int (*sk_OCSP_RESPONSE_compfunc)(const struct ocsp_response_st**,const struct ocsp_response_st**);
...
enum   anonymous_typeY29 { X509_LU_NONE=(0),
X509_LU_X509 
,X509_LU_CRL 
};

typedef enum anonymous_typeY29 X509_LOOKUP_TYPE;
...
typedef int (*X509_LOOKUP_get_by_subject_fn)(struct x509_lookup_st*,enum anonymous_typeY29,const struct X509_name_st*,struct x509_object_st*);

typedef int (*X509_LOOKUP_get_by_subject_ex_fn)(struct x509_lookup_st*,enum anonymous_typeY29,const struct X509_name_st*,struct x509_object_st*,struct ossl_lib_ctx_st*,const char*);

typedef int (*X509_LOOKUP_get_by_issuer_serial_fn)(struct x509_lookup_st*,enum anonymous_typeY29,const struct X509_name_st*,const struct asn1_string_st*,struct x509_object_st*);

typedef int (*X509_LOOKUP_get_by_fingerprint_fn)(struct x509_lookup_st*,enum anonymous_typeY29,const unsigned char*,int,struct x509_object_st*);

typedef int (*X509_LOOKUP_get_by_alias_fn)(struct x509_lookup_st*,enum anonymous_typeY29,const char*,int,struct x509_object_st*);
...
typedef struct anonymous_typeX32 CONF_VALUE;

typedef int (*sk_CONF_VALUE_compfunc)(const struct anonymous_typeX32**,const struct anonymous_typeX32**);

typedef void (*sk_CONF_VALUE_freefunc)(struct anonymous_typeX32*);

typedef struct anonymous_typeX32* (*sk_CONF_VALUE_copyfunc)(const struct anonymous_typeX32*);
...
typedef int (*lh_CONF_VALUE_compfunc)(const struct anonymous_typeX32*,const struct anonymous_typeX32*);

typedef unsigned long  int (*lh_CONF_VALUE_hashfunc)(const struct anonymous_typeX32*);

typedef void (*lh_CONF_VALUE_doallfunc)(struct anonymous_typeX32*);
...
enum   anonymous_typeY32 { CT_LOG_ENTRY_TYPE_NOT_SET=(-1),
CT_LOG_ENTRY_TYPE_X509=(0),
CT_LOG_ENTRY_TYPE_PRECERT=(1)
};

typedef enum anonymous_typeY32 ct_log_entry_type_t;

typedef enum anonymous_typeY32 sct_version_t;

typedef enum anonymous_typeY32 sct_source_t;

typedef enum anonymous_typeY32 sct_validation_status_t;
...
typedef enum anonymous_typeY32 OSSL_HANDSHAKE_STATE;
...
extern struct MYSQL* gComeMySQL;

struct list_item$1list$1char$ph$ph
{
    struct list$1char$ph* item;
    struct list_item$1list$1char$ph$ph* prev;
    struct list_item$1list$1char$ph$ph* next;
};

struct list$1list$1char$ph$ph
{
    struct list_item$1list$1char$ph$ph* head;
    struct list_item$1list$1char$ph$ph* tail;
    int len;
    struct list_item$1list$1char$ph$ph* it;
};
...
int getattrlistbulk(int anonymous_var_nameX603, void* anonymous_var_nameX604, void* anonymous_var_nameX605, unsigned long  int anonymous_var_nameX606, unsigned long  long anonymous_var_nameX607);
int getattrlistat(int anonymous_var_nameX608, const char* anonymous_var_nameX609, void* anonymous_var_nameX610, void* anonymous_var_nameX611, unsigned long  int anonymous_var_nameX612, unsigned long  int anonymous_var_nameX613);
int setattrlistat(int anonymous_var_nameX614, const char* anonymous_var_nameX615, void* anonymous_var_nameX616, void* anonymous_var_nameX617, unsigned long  int anonymous_var_nameX618, unsigned int anonymous_var_nameX619);
long freadlink(int anonymous_var_nameX620, char* anonymous_var_nameX621, unsigned long  int anonymous_var_nameX622);
...
int fchownat(int anonymous_var_nameX627, const char* anonymous_var_nameX628, unsigned int anonymous_var_nameX629, unsigned int anonymous_var_nameX630, int anonymous_var_nameX631);
int linkat(int anonymous_var_nameX632, const char* anonymous_var_nameX633, int anonymous_var_nameX634, const char* anonymous_var_nameX635, int anonymous_var_nameX636);
long readlinkat(int anonymous_var_nameX637, const char* anonymous_var_nameX638, char* anonymous_var_nameX639, unsigned long  int anonymous_var_nameX640);
int symlinkat(const char* anonymous_var_nameX641, int anonymous_var_nameX642, const char* anonymous_var_nameX643);
int unlinkat(int anonymous_var_nameX644, const char* anonymous_var_nameX645, int anonymous_var_nameX646);
void _exit(int anonymous_var_nameX647);
int access(const char* anonymous_var_nameX648, int anonymous_var_nameX649);
unsigned int alarm(unsigned int anonymous_var_nameX650);
int chdir(const char* anonymous_var_nameX651);
int chown(const char* anonymous_var_nameX652, unsigned int anonymous_var_nameX653, unsigned int anonymous_var_nameX654);
int close(int anonymous_var_nameX655);
int dup(int anonymous_var_nameX656);
int dup2(int anonymous_var_nameX657, int anonymous_var_nameX658);
...
int fork();
long fpathconf(int anonymous_var_nameX659, int anonymous_var_nameX660);
char* getcwd(char* anonymous_var_nameX661, unsigned long  int __size);
unsigned int getegid();
unsigned int geteuid();
unsigned int getgid();
int getgroups(int __gidsetsize, unsigned int anonymous_var_nameX662[]);
char* getlogin();
int getpgrp();
int getpid();
int getppid();
unsigned int getuid();
int isatty(int anonymous_var_nameX663);
int link(const char* anonymous_var_nameX664, const char* anonymous_var_nameX665);
long long lseek(int anonymous_var_nameX666, long long anonymous_var_nameX667, int anonymous_var_nameX668);
long pathconf(const char* anonymous_var_nameX669, int anonymous_var_nameX670);
int pause();
int pipe(int anonymous_var_nameX671[2]);
long read(int anonymous_var_nameX672, void* anonymous_var_nameX673, unsigned long  int __nbyte);
int rmdir(const char* anonymous_var_nameX674);
int setgid(unsigned int anonymous_var_nameX675);
int setpgid(int anonymous_var_nameX676, int anonymous_var_nameX677);
int setsid();
int setuid(unsigned int anonymous_var_nameX678);
unsigned int sleep(unsigned int anonymous_var_nameX679);
long sysconf(int anonymous_var_nameX680);
int tcgetpgrp(int anonymous_var_nameX681);
int tcsetpgrp(int anonymous_var_nameX682, int anonymous_var_nameX683);
char* ttyname(int anonymous_var_nameX684);
int ttyname_r(int anonymous_var_nameX685, char* anonymous_var_nameX686, unsigned long  int __len);
int unlink(const char* anonymous_var_nameX687);
long write(int __fd, const void* __buf, unsigned long  int __nbyte);
unsigned long  int confstr(int anonymous_var_nameX688, char* anonymous_var_nameX689, unsigned long  int __len);
int getopt(int __argc, char* anonymous_var_nameX690[], const char* anonymous_var_nameX691);
void* brk(const void* anonymous_var_nameX692);
int chroot(const char* anonymous_var_nameX693);
char* crypt(const char* anonymous_var_nameX694, const char* anonymous_var_nameX695);
void encrypt(char* anonymous_var_nameX696, int anonymous_var_nameX697);
int fchdir(int anonymous_var_nameX698);
long gethostid();
int getpgid(int anonymous_var_nameX699);
int getsid(int anonymous_var_nameX700);
int getdtablesize();
int getpagesize();
char* getpass(const char* anonymous_var_nameX701);
char* getwd(char* anonymous_var_nameX702);
int lchown(const char* anonymous_var_nameX703, unsigned int anonymous_var_nameX704, unsigned int anonymous_var_nameX705);
int lockf(int anonymous_var_nameX706, int anonymous_var_nameX707, long long anonymous_var_nameX708);
int nice(int anonymous_var_nameX709);
...
void* sbrk(int anonymous_var_nameX710);
int setpgrp();
int setregid(unsigned int anonymous_var_nameX711, unsigned int anonymous_var_nameX712);
int setreuid(unsigned int anonymous_var_nameX713, unsigned int anonymous_var_nameX714);
void swab(const void* anonymous_var_nameX715, void* anonymous_var_nameX716, long __nbytes);
void sync();
int truncate(const char* anonymous_var_nameX717, long long anonymous_var_nameX718);
unsigned int ualarm(unsigned int anonymous_var_nameX719, unsigned int anonymous_var_nameX720);
int usleep(unsigned int anonymous_var_nameX721);
int vfork();
int fsync(int anonymous_var_nameX722);
int ftruncate(int anonymous_var_nameX723, long long anonymous_var_nameX724);
int getlogin_r(char* anonymous_var_nameX725, unsigned long  int __namelen);
int fchown(int anonymous_var_nameX726, unsigned int anonymous_var_nameX727, unsigned int anonymous_var_nameX728);
int gethostname(char* anonymous_var_nameX729, unsigned long  int __namelen);
long readlink(const char* anonymous_var_nameX730, char* anonymous_var_nameX731, unsigned long  int __bufsize);
int setegid(unsigned int anonymous_var_nameX732);
int seteuid(unsigned int anonymous_var_nameX733);
int symlink(const char* anonymous_var_nameX734, const char* anonymous_var_nameX735);
int __darwin_check_fd_set_overflow(int anonymous_var_nameX736, const void* anonymous_var_nameX737, int anonymous_var_nameX738);
int pselect(int anonymous_var_nameX739, struct fd_set* anonymous_var_nameX740, struct fd_set* anonymous_var_nameX741, struct fd_set* anonymous_var_nameX742, const struct timespec* anonymous_var_nameX743, const unsigned int* anonymous_var_nameX744);
int select(int anonymous_var_nameX745, struct fd_set* anonymous_var_nameX746, struct fd_set* anonymous_var_nameX747, struct fd_set* anonymous_var_nameX748, struct timeval* anonymous_var_nameX749);
void _Exit(int anonymous_var_nameX750);
int accessx_np(const struct accessx_descriptor* anonymous_var_nameX751, unsigned long  int __sz, int* anonymous_var_nameX752, unsigned int anonymous_var_nameX753);
int acct(const char* anonymous_var_nameX754);
int add_profil(char* anonymous_var_nameX755, unsigned long  int __bufsiz, unsigned long  int anonymous_var_nameX756, unsigned int anonymous_var_nameX757);
void endusershell();
int execvP(const char* __file, const char* __searchpath, char** __argv);
char* fflagstostr(unsigned long  int anonymous_var_nameX758);
int getdomainname(char* anonymous_var_nameX759, int __namelen);
int getgrouplist(const char* anonymous_var_nameX760, int anonymous_var_nameX761, int* anonymous_var_nameX762, int* __ngroups);
int gethostuuid(unsigned char anonymous_var_nameX763[16], const struct timespec* anonymous_var_nameX764);
unsigned short int getmode(const void* anonymous_var_nameX765, unsigned short int anonymous_var_nameX766);
int getpeereid(int anonymous_var_nameX767, unsigned int* anonymous_var_nameX768, unsigned int* anonymous_var_nameX769);
int getsgroups_np(int* anonymous_var_nameX770, unsigned char anonymous_var_nameX771[16]);
char* getusershell();
int getwgroups_np(int* anonymous_var_nameX772, unsigned char anonymous_var_nameX773[16]);
int initgroups(const char* anonymous_var_nameX774, int anonymous_var_nameX775);
int issetugid();
char* mkdtemp(char* anonymous_var_nameX776);
int mknod(const char* anonymous_var_nameX777, unsigned short int anonymous_var_nameX778, int anonymous_var_nameX779);
int mkpath_np(const char* path, unsigned short int omode);
int mkpathat_np(int dfd, const char* path, unsigned short int omode);
int mkstemp(char* anonymous_var_nameX780);
int mkstemps(char* anonymous_var_nameX781, int anonymous_var_nameX782);
char* mktemp(char* anonymous_var_nameX783);
...
int nfssvc(int anonymous_var_nameX784, void* anonymous_var_nameX785);
int profil(char* anonymous_var_nameX786, unsigned long  int __bufsiz, unsigned long  int anonymous_var_nameX787, unsigned int anonymous_var_nameX788);
int pthread_setugid_np(unsigned int anonymous_var_nameX789, unsigned int anonymous_var_nameX790);
int pthread_getugid_np(unsigned int* anonymous_var_nameX791, unsigned int* anonymous_var_nameX792);
int reboot(int anonymous_var_nameX793);
int revoke(const char* anonymous_var_nameX794);
int rcmd(char** anonymous_var_nameX795, int anonymous_var_nameX796, const char* anonymous_var_nameX797, const char* anonymous_var_nameX798, const char* anonymous_var_nameX799, int* anonymous_var_nameX800);
int rcmd_af(char** anonymous_var_nameX801, int anonymous_var_nameX802, const char* anonymous_var_nameX803, const char* anonymous_var_nameX804, const char* anonymous_var_nameX805, int* anonymous_var_nameX806, int anonymous_var_nameX807);
int rresvport(int* anonymous_var_nameX808);
int rresvport_af(int* anonymous_var_nameX809, int anonymous_var_nameX810);
int iruserok(unsigned long  int anonymous_var_nameX811, int anonymous_var_nameX812, const char* anonymous_var_nameX813, const char* anonymous_var_nameX814);
int iruserok_sa(const void* anonymous_var_nameX815, int anonymous_var_nameX816, int anonymous_var_nameX817, const char* anonymous_var_nameX818, const char* anonymous_var_nameX819);
int ruserok(const char* anonymous_var_nameX820, int anonymous_var_nameX821, const char* anonymous_var_nameX822, const char* anonymous_var_nameX823);
int setdomainname(const char* anonymous_var_nameX824, int __namelen);
int setgroups(int anonymous_var_nameX825, const unsigned int* anonymous_var_nameX826);
void sethostid(long anonymous_var_nameX827);
int sethostname(const char* anonymous_var_nameX828, int __namelen);
void setkey(const char* anonymous_var_nameX829);
int setlogin(const char* anonymous_var_nameX830);
void* setmode(const char* anonymous_var_nameX831);
int setrgid(unsigned int anonymous_var_nameX832);
int setruid(unsigned int anonymous_var_nameX833);
int setsgroups_np(int anonymous_var_nameX834, const unsigned char anonymous_var_nameX835[16]);
void setusershell();
int setwgroups_np(int anonymous_var_nameX836, const unsigned char anonymous_var_nameX837[16]);
int strtofflags(char** anonymous_var_nameX838, unsigned long  int* anonymous_var_nameX839, unsigned long  int* anonymous_var_nameX840);
int swapon(const char* anonymous_var_nameX841);
int ttyslot();
int undelete(const char* anonymous_var_nameX842);
int unwhiteout(const char* anonymous_var_nameX843);
void* valloc(unsigned long  int __size);
int syscall(int anonymous_var_nameX844, ...);
int getsubopt(char** anonymous_var_nameX845, char** anonymous_var_nameX846, char** anonymous_var_nameX847);
int fgetattrlist(int anonymous_var_nameX848, void* anonymous_var_nameX849, void* anonymous_var_nameX850, unsigned long  int __attrBufSize, unsigned int anonymous_var_nameX851);
int fsetattrlist(int anonymous_var_nameX852, void* anonymous_var_nameX853, void* anonymous_var_nameX854, unsigned long  int __attrBufSize, unsigned int anonymous_var_nameX855);
int getattrlist(const char* anonymous_var_nameX856, void* anonymous_var_nameX857, void* anonymous_var_nameX858, unsigned long  int __attrBufSize, unsigned int anonymous_var_nameX859);
int setattrlist(const char* anonymous_var_nameX860, void* anonymous_var_nameX861, void* anonymous_var_nameX862, unsigned long  int __attrBufSize, unsigned int anonymous_var_nameX863);
int exchangedata(const char* anonymous_var_nameX864, const char* anonymous_var_nameX865, unsigned int anonymous_var_nameX866);
int getdirentriesattr(int anonymous_var_nameX867, void* anonymous_var_nameX868, void* anonymous_var_nameX869, unsigned long  int __attrBufSize, unsigned int* anonymous_var_nameX870, unsigned int* anonymous_var_nameX871, unsigned int* anonymous_var_nameX872, unsigned int anonymous_var_nameX873);
int searchfs(const char* anonymous_var_nameX874, struct fssearchblock* anonymous_var_nameX875, unsigned long  int* anonymous_var_nameX876, unsigned int anonymous_var_nameX877, unsigned int anonymous_var_nameX878, struct searchstate* anonymous_var_nameX879);
int fsctl(const char* anonymous_var_nameX880, unsigned long  int anonymous_var_nameX881, void* anonymous_var_nameX882, unsigned int anonymous_var_nameX883);
int ffsctl(int anonymous_var_nameX884, unsigned long  int anonymous_var_nameX885, void* anonymous_var_nameX886, unsigned int anonymous_var_nameX887);
int fsync_volume_np(int anonymous_var_nameX888, int anonymous_var_nameX889);
int sync_volume_np(const char* anonymous_var_nameX890, int anonymous_var_nameX891);
int accept(int anonymous_var_nameX892, struct sockaddr* anonymous_var_nameX893, unsigned int* anonymous_var_nameX894);
int bind(int anonymous_var_nameX895, const struct sockaddr* anonymous_var_nameX896, unsigned int anonymous_var_nameX897);
int connect(int anonymous_var_nameX898, const struct sockaddr* anonymous_var_nameX899, unsigned int anonymous_var_nameX900);
int getpeername(int anonymous_var_nameX901, struct sockaddr* anonymous_var_nameX902, unsigned int* anonymous_var_nameX903);
int getsockname(int anonymous_var_nameX904, struct sockaddr* anonymous_var_nameX905, unsigned int* anonymous_var_nameX906);
int getsockopt(int anonymous_var_nameX907, int anonymous_var_nameX908, int anonymous_var_nameX909, void* anonymous_var_nameX910, unsigned int* anonymous_var_nameX911);
int listen(int anonymous_var_nameX912, int anonymous_var_nameX913);
long recv(int anonymous_var_nameX914, void* anonymous_var_nameX915, unsigned long  int anonymous_var_nameX916, int anonymous_var_nameX917);
long recvfrom(int anonymous_var_nameX918, void* anonymous_var_nameX919, unsigned long  int anonymous_var_nameX920, int anonymous_var_nameX921, struct sockaddr* anonymous_var_nameX922, unsigned int* anonymous_var_nameX923);
long recvmsg(int anonymous_var_nameX924, struct msghdr* anonymous_var_nameX925, int anonymous_var_nameX926);
long send(int anonymous_var_nameX927, const void* anonymous_var_nameX928, unsigned long  int anonymous_var_nameX929, int anonymous_var_nameX930);
long sendmsg(int anonymous_var_nameX931, const struct msghdr* anonymous_var_nameX932, int anonymous_var_nameX933);
long sendto(int anonymous_var_nameX934, const void* anonymous_var_nameX935, unsigned long  int anonymous_var_nameX936, int anonymous_var_nameX937, const struct sockaddr* anonymous_var_nameX938, unsigned int anonymous_var_nameX939);
int setsockopt(int anonymous_var_nameX940, int anonymous_var_nameX941, int anonymous_var_nameX942, const void* anonymous_var_nameX943, unsigned int anonymous_var_nameX944);
int shutdown(int anonymous_var_nameX945, int anonymous_var_nameX946);
int sockatmark(int anonymous_var_nameX947);
int socket(int anonymous_var_nameX948, int anonymous_var_nameX949, int anonymous_var_nameX950);
int socketpair(int anonymous_var_nameX951, int anonymous_var_nameX952, int anonymous_var_nameX953, int* anonymous_var_nameX954);
int sendfile(int anonymous_var_nameX955, int anonymous_var_nameX956, long long anonymous_var_nameX957, long long* anonymous_var_nameX958, struct sf_hdtr* anonymous_var_nameX959, int anonymous_var_nameX960);
void pfctlinput(int anonymous_var_nameX961, struct sockaddr* anonymous_var_nameX962);
int connectx(int anonymous_var_nameX963, const struct sa_endpoints* anonymous_var_nameX964, unsigned int anonymous_var_nameX965, unsigned int anonymous_var_nameX966, const struct iovec* anonymous_var_nameX967, unsigned int anonymous_var_nameX968, unsigned long  int* anonymous_var_nameX969, unsigned int* anonymous_var_nameX970);
int disconnectx(int anonymous_var_nameX971, unsigned int anonymous_var_nameX972, unsigned int anonymous_var_nameX973);
int setipv4sourcefilter(int anonymous_var_nameX974, struct in_addr anonymous_var_nameX975, struct in_addr anonymous_var_nameX976, unsigned int anonymous_var_nameX977, unsigned int anonymous_var_nameX978, struct in_addr* anonymous_var_nameX979);
int getipv4sourcefilter(int anonymous_var_nameX980, struct in_addr anonymous_var_nameX981, struct in_addr anonymous_var_nameX982, unsigned int* anonymous_var_nameX983, unsigned int* anonymous_var_nameX984, struct in_addr* anonymous_var_nameX985);
int setsourcefilter(int anonymous_var_nameX986, unsigned int anonymous_var_nameX987, struct sockaddr* anonymous_var_nameX988, unsigned int anonymous_var_nameX989, unsigned int anonymous_var_nameX990, unsigned int anonymous_var_nameX991, struct sockaddr_storage* anonymous_var_nameX992);
int getsourcefilter(int anonymous_var_nameX993, unsigned int anonymous_var_nameX994, struct sockaddr* anonymous_var_nameX995, unsigned int anonymous_var_nameX996, unsigned int* anonymous_var_nameX997, unsigned int* anonymous_var_nameX998, struct sockaddr_storage* anonymous_var_nameX999);
int inet6_option_space(int anonymous_var_nameX1000);
int inet6_option_init(void* anonymous_var_nameX1001, struct cmsghdr** anonymous_var_nameX1002, int anonymous_var_nameX1003);
int inet6_option_append(struct cmsghdr* anonymous_var_nameX1004, const unsigned char* anonymous_var_nameX1005, int anonymous_var_nameX1006, int anonymous_var_nameX1007);
unsigned char* inet6_option_alloc(struct cmsghdr* anonymous_var_nameX1008, int anonymous_var_nameX1009, int anonymous_var_nameX1010, int anonymous_var_nameX1011);
int inet6_option_next(const struct cmsghdr* anonymous_var_nameX1012, unsigned char** anonymous_var_nameX1013);
int inet6_option_find(const struct cmsghdr* anonymous_var_nameX1014, unsigned char** anonymous_var_nameX1015, int anonymous_var_nameX1016);
unsigned long  int inet6_rthdr_space(int anonymous_var_nameX1017, int anonymous_var_nameX1018);
struct cmsghdr* inet6_rthdr_init(void* anonymous_var_nameX1019, int anonymous_var_nameX1020);
int inet6_rthdr_add(struct cmsghdr* anonymous_var_nameX1021, const struct in6_addr* anonymous_var_nameX1022, unsigned int anonymous_var_nameX1023);
int inet6_rthdr_lasthop(struct cmsghdr* anonymous_var_nameX1024, unsigned int anonymous_var_nameX1025);
int inet6_rthdr_segments(const struct cmsghdr* anonymous_var_nameX1026);
struct in6_addr* inet6_rthdr_getaddr(struct cmsghdr* anonymous_var_nameX1027, int anonymous_var_nameX1028);
int inet6_rthdr_getflags(const struct cmsghdr* anonymous_var_nameX1029, int anonymous_var_nameX1030);
int inet6_opt_init(void* anonymous_var_nameX1031, unsigned int anonymous_var_nameX1032);
int inet6_opt_append(void* anonymous_var_nameX1033, unsigned int anonymous_var_nameX1034, int anonymous_var_nameX1035, unsigned char anonymous_var_nameX1036, unsigned int anonymous_var_nameX1037, unsigned char anonymous_var_nameX1038, void** anonymous_var_nameX1039);
int inet6_opt_finish(void* anonymous_var_nameX1040, unsigned int anonymous_var_nameX1041, int anonymous_var_nameX1042);
int inet6_opt_set_val(void* anonymous_var_nameX1043, int anonymous_var_nameX1044, void* anonymous_var_nameX1045, unsigned int anonymous_var_nameX1046);
int inet6_opt_next(void* anonymous_var_nameX1047, unsigned int anonymous_var_nameX1048, int anonymous_var_nameX1049, unsigned char* anonymous_var_nameX1050, unsigned int* anonymous_var_nameX1051, void** anonymous_var_nameX1052);
int inet6_opt_find(void* anonymous_var_nameX1053, unsigned int anonymous_var_nameX1054, int anonymous_var_nameX1055, unsigned char anonymous_var_nameX1056, unsigned int* anonymous_var_nameX1057, void** anonymous_var_nameX1058);
int inet6_opt_get_val(void* anonymous_var_nameX1059, int anonymous_var_nameX1060, void* anonymous_var_nameX1061, unsigned int anonymous_var_nameX1062);
unsigned int inet6_rth_space(int anonymous_var_nameX1063, int anonymous_var_nameX1064);
void* inet6_rth_init(void* anonymous_var_nameX1065, unsigned int anonymous_var_nameX1066, int anonymous_var_nameX1067, int anonymous_var_nameX1068);
int inet6_rth_add(void* anonymous_var_nameX1069, const struct in6_addr* anonymous_var_nameX1070);
int inet6_rth_reverse(const void* anonymous_var_nameX1071, void* anonymous_var_nameX1072);
int inet6_rth_segments(const void* anonymous_var_nameX1073);
struct in6_addr* inet6_rth_getaddr(const void* anonymous_var_nameX1074, int anonymous_var_nameX1075);
int bindresvport(int anonymous_var_nameX1076, struct sockaddr_in* anonymous_var_nameX1077);
int bindresvport_sa(int anonymous_var_nameX1078, struct sockaddr* anonymous_var_nameX1079);
unsigned int inet_addr(const char* anonymous_var_nameX1080);
char* inet_ntoa(struct in_addr anonymous_var_nameX1081);
const char* inet_ntop(int anonymous_var_nameX1082, const void* anonymous_var_nameX1083, char* anonymous_var_nameX1084, unsigned int __size);
int inet_pton(int anonymous_var_nameX1085, const char* anonymous_var_nameX1086, void* anonymous_var_nameX1087);
int ascii2addr(int anonymous_var_nameX1088, const char* anonymous_var_nameX1089, void* anonymous_var_nameX1090);
char* addr2ascii(int anonymous_var_nameX1091, const void* anonymous_var_nameX1092, int __size, char* anonymous_var_nameX1093);
int inet_aton(const char* anonymous_var_nameX1094, struct in_addr* anonymous_var_nameX1095);
unsigned int inet_lnaof(struct in_addr anonymous_var_nameX1096);
struct in_addr inet_makeaddr(unsigned int anonymous_var_nameX1097, unsigned int anonymous_var_nameX1098);
unsigned int inet_netof(struct in_addr anonymous_var_nameX1099);
unsigned int inet_network(const char* anonymous_var_nameX1100);
char* inet_net_ntop(int anonymous_var_nameX1101, const void* anonymous_var_nameX1102, int anonymous_var_nameX1103, char* anonymous_var_nameX1104, unsigned long  int __size);
int inet_net_pton(int anonymous_var_nameX1105, const char* anonymous_var_nameX1106, void* anonymous_var_nameX1107, unsigned long  int __size);
char* inet_neta(unsigned int anonymous_var_nameX1108, char* anonymous_var_nameX1109, unsigned long  int __size);
unsigned int inet_nsap_addr(const char* anonymous_var_nameX1110, unsigned char* anonymous_var_nameX1111, int __maxlen);
char* inet_nsap_ntoa(int __binlen, const unsigned char* anonymous_var_nameX1112, char* anonymous_var_nameX1113);
long  int imaxabs(long  int j);
struct anonymous_typeX19 imaxdiv(long  int __numer, long  int __denom);
...
int adjtime(const struct timeval* anonymous_var_nameX1114, struct timeval* anonymous_var_nameX1115);
int futimes(int anonymous_var_nameX1116, const struct timeval* anonymous_var_nameX1117);
int lutimes(const char* anonymous_var_nameX1118, const struct timeval* anonymous_var_nameX1119);
int settimeofday(const struct timeval* anonymous_var_nameX1120, const struct timezone* anonymous_var_nameX1121);
int getitimer(int anonymous_var_nameX1122, struct itimerval* anonymous_var_nameX1123);
int gettimeofday(struct timeval* anonymous_var_nameX1124, void* anonymous_var_nameX1125);
int setitimer(int anonymous_var_nameX1126, const struct itimerval* anonymous_var_nameX1127, struct itimerval* anonymous_var_nameX1128);
int utimes(const char* anonymous_var_nameX1129, const struct timeval* anonymous_var_nameX1130);
int OPENSSL_sk_num(const struct stack_st* anonymous_var_nameX1137);
void* OPENSSL_sk_value(const struct stack_st* anonymous_var_nameX1138, int anonymous_var_nameX1139);
...
void OPENSSL_sk_free(struct stack_st* anonymous_var_nameX1140);
void OPENSSL_sk_pop_free(struct stack_st* st, void (*func)(void*));
struct stack_st* OPENSSL_sk_deep_copy(const struct stack_st* anonymous_var_nameX1141, void* (*c)(const void*), void (*f)(void*));
...
void* CRYPTO_malloc_array(unsigned long  int num, unsigned long  int size, const char* file, int line);
void* CRYPTO_calloc(unsigned long  int num, unsigned long  int size, const char* file, int line);
void* CRYPTO_aligned_alloc(unsigned long  int num, unsigned long  int align, void** freeptr, const char* file, int line);
void* CRYPTO_aligned_alloc_array(unsigned long  int num, unsigned long  int size, unsigned long  int align, void** freeptr, const char* file, int line);
...
void* CRYPTO_secure_malloc_array(unsigned long  int num, unsigned long  int size, const char* file, int line);
void* CRYPTO_secure_calloc(unsigned long  int num, unsigned long  int size, const char* file, int line);
...
int sched_yield();
int sched_get_priority_min(int anonymous_var_nameX1142);
int sched_get_priority_max(int anonymous_var_nameX1143);
...
int pthread_attr_destroy(struct _opaque_pthread_attr_t* anonymous_var_nameX1144);
int pthread_attr_getdetachstate(const struct _opaque_pthread_attr_t* anonymous_var_nameX1145, int* anonymous_var_nameX1146);
int pthread_attr_getguardsize(const struct _opaque_pthread_attr_t* anonymous_var_nameX1147, unsigned long  int* anonymous_var_nameX1148);
int pthread_attr_getinheritsched(const struct _opaque_pthread_attr_t* anonymous_var_nameX1149, int* anonymous_var_nameX1150);
int pthread_attr_getschedparam(const struct _opaque_pthread_attr_t* anonymous_var_nameX1151, struct sched_param* anonymous_var_nameX1152);
int pthread_attr_getschedpolicy(const struct _opaque_pthread_attr_t* anonymous_var_nameX1153, int* anonymous_var_nameX1154);
int pthread_attr_getscope(const struct _opaque_pthread_attr_t* anonymous_var_nameX1155, int* anonymous_var_nameX1156);
int pthread_attr_getstack(const struct _opaque_pthread_attr_t* anonymous_var_nameX1157, void** anonymous_var_nameX1158, unsigned long  int* anonymous_var_nameX1159);
int pthread_attr_getstackaddr(const struct _opaque_pthread_attr_t* anonymous_var_nameX1160, void** anonymous_var_nameX1161);
int pthread_attr_getstacksize(const struct _opaque_pthread_attr_t* anonymous_var_nameX1162, unsigned long  int* anonymous_var_nameX1163);
int pthread_attr_init(struct _opaque_pthread_attr_t* anonymous_var_nameX1164);
int pthread_attr_setdetachstate(struct _opaque_pthread_attr_t* anonymous_var_nameX1165, int anonymous_var_nameX1166);
int pthread_attr_setguardsize(struct _opaque_pthread_attr_t* anonymous_var_nameX1167, unsigned long  int anonymous_var_nameX1168);
int pthread_attr_setinheritsched(struct _opaque_pthread_attr_t* anonymous_var_nameX1169, int anonymous_var_nameX1170);
int pthread_attr_setschedparam(struct _opaque_pthread_attr_t* anonymous_var_nameX1171, const struct sched_param* anonymous_var_nameX1172);
int pthread_attr_setschedpolicy(struct _opaque_pthread_attr_t* anonymous_var_nameX1173, int anonymous_var_nameX1174);
int pthread_attr_setscope(struct _opaque_pthread_attr_t* anonymous_var_nameX1175, int anonymous_var_nameX1176);
int pthread_attr_setstack(struct _opaque_pthread_attr_t* anonymous_var_nameX1177, void* anonymous_var_nameX1178, unsigned long  int anonymous_var_nameX1179);
int pthread_attr_setstackaddr(struct _opaque_pthread_attr_t* anonymous_var_nameX1180, void* anonymous_var_nameX1181);
int pthread_attr_setstacksize(struct _opaque_pthread_attr_t* anonymous_var_nameX1182, unsigned long  int anonymous_var_nameX1183);
int pthread_cancel(struct _opaque_pthread_t* anonymous_var_nameX1184);
int pthread_cond_broadcast(struct _opaque_pthread_cond_t* anonymous_var_nameX1185);
int pthread_cond_destroy(struct _opaque_pthread_cond_t* anonymous_var_nameX1186);
int pthread_cond_init(struct _opaque_pthread_cond_t* anonymous_var_nameX1187, const struct _opaque_pthread_condattr_t* anonymous_var_nameX1188);
int pthread_cond_signal(struct _opaque_pthread_cond_t* anonymous_var_nameX1189);
int pthread_cond_timedwait(struct _opaque_pthread_cond_t* anonymous_var_nameX1190, struct _opaque_pthread_mutex_t* anonymous_var_nameX1191, const struct timespec* anonymous_var_nameX1192);
int pthread_cond_wait(struct _opaque_pthread_cond_t* anonymous_var_nameX1193, struct _opaque_pthread_mutex_t* anonymous_var_nameX1194);
int pthread_condattr_destroy(struct _opaque_pthread_condattr_t* anonymous_var_nameX1195);
int pthread_condattr_init(struct _opaque_pthread_condattr_t* anonymous_var_nameX1196);
int pthread_condattr_getpshared(const struct _opaque_pthread_condattr_t* anonymous_var_nameX1197, int* anonymous_var_nameX1198);
int pthread_condattr_setpshared(struct _opaque_pthread_condattr_t* anonymous_var_nameX1199, int anonymous_var_nameX1200);
int pthread_create(struct _opaque_pthread_t** anonymous_var_nameX1201, const struct _opaque_pthread_attr_t* anonymous_var_nameX1202, void* (*anonymous_lambda_var_nameZ12)(void*), void* anonymous_var_nameX1204);
int pthread_detach(struct _opaque_pthread_t* anonymous_var_nameX1205);
int pthread_equal(struct _opaque_pthread_t* anonymous_var_nameX1206, struct _opaque_pthread_t* anonymous_var_nameX1207);
void pthread_exit(void* anonymous_var_nameX1208);
int pthread_getconcurrency();
int pthread_getschedparam(struct _opaque_pthread_t* anonymous_var_nameX1209, int* anonymous_var_nameX1210, struct sched_param* anonymous_var_nameX1211);
void* pthread_getspecific(unsigned long  int anonymous_var_nameX1212);
int pthread_join(struct _opaque_pthread_t* anonymous_var_nameX1213, void** anonymous_var_nameX1214);
int pthread_key_create(unsigned long  int* anonymous_var_nameX1215, void (*anonymous_lambda_var_nameZ13)(void*));
int pthread_key_delete(unsigned long  int anonymous_var_nameX1217);
int pthread_mutex_destroy(struct _opaque_pthread_mutex_t* anonymous_var_nameX1218);
int pthread_mutex_getprioceiling(const struct _opaque_pthread_mutex_t* anonymous_var_nameX1219, int* anonymous_var_nameX1220);
int pthread_mutex_init(struct _opaque_pthread_mutex_t* anonymous_var_nameX1221, const struct _opaque_pthread_mutexattr_t* anonymous_var_nameX1222);
int pthread_mutex_lock(struct _opaque_pthread_mutex_t* anonymous_var_nameX1223);
int pthread_mutex_setprioceiling(struct _opaque_pthread_mutex_t* anonymous_var_nameX1224, int anonymous_var_nameX1225, int* anonymous_var_nameX1226);
int pthread_mutex_trylock(struct _opaque_pthread_mutex_t* anonymous_var_nameX1227);
int pthread_mutex_unlock(struct _opaque_pthread_mutex_t* anonymous_var_nameX1228);
int pthread_mutexattr_destroy(struct _opaque_pthread_mutexattr_t* anonymous_var_nameX1229);
int pthread_mutexattr_getprioceiling(const struct _opaque_pthread_mutexattr_t* anonymous_var_nameX1230, int* anonymous_var_nameX1231);
int pthread_mutexattr_getprotocol(const struct _opaque_pthread_mutexattr_t* anonymous_var_nameX1232, int* anonymous_var_nameX1233);
int pthread_mutexattr_getpshared(const struct _opaque_pthread_mutexattr_t* anonymous_var_nameX1234, int* anonymous_var_nameX1235);
int pthread_mutexattr_gettype(const struct _opaque_pthread_mutexattr_t* anonymous_var_nameX1236, int* anonymous_var_nameX1237);
int pthread_mutexattr_getpolicy_np(const struct _opaque_pthread_mutexattr_t* anonymous_var_nameX1238, int* anonymous_var_nameX1239);
int pthread_mutexattr_init(struct _opaque_pthread_mutexattr_t* anonymous_var_nameX1240);
int pthread_mutexattr_setprioceiling(struct _opaque_pthread_mutexattr_t* anonymous_var_nameX1241, int anonymous_var_nameX1242);
int pthread_mutexattr_setprotocol(struct _opaque_pthread_mutexattr_t* anonymous_var_nameX1243, int anonymous_var_nameX1244);
int pthread_mutexattr_setpshared(struct _opaque_pthread_mutexattr_t* anonymous_var_nameX1245, int anonymous_var_nameX1246);
int pthread_mutexattr_settype(struct _opaque_pthread_mutexattr_t* anonymous_var_nameX1247, int anonymous_var_nameX1248);
int pthread_mutexattr_setpolicy_np(struct _opaque_pthread_mutexattr_t* anonymous_var_nameX1249, int anonymous_var_nameX1250);
int pthread_once(struct _opaque_pthread_once_t* anonymous_var_nameX1251, void (*anonymous_lambda_var_nameZ14)());
int pthread_rwlock_destroy(struct _opaque_pthread_rwlock_t* anonymous_var_nameX1252);
int pthread_rwlock_init(struct _opaque_pthread_rwlock_t* anonymous_var_nameX1253, const struct _opaque_pthread_rwlockattr_t* anonymous_var_nameX1254);
int pthread_rwlock_rdlock(struct _opaque_pthread_rwlock_t* anonymous_var_nameX1255);
int pthread_rwlock_tryrdlock(struct _opaque_pthread_rwlock_t* anonymous_var_nameX1256);
int pthread_rwlock_trywrlock(struct _opaque_pthread_rwlock_t* anonymous_var_nameX1257);
int pthread_rwlock_wrlock(struct _opaque_pthread_rwlock_t* anonymous_var_nameX1258);
int pthread_rwlock_unlock(struct _opaque_pthread_rwlock_t* anonymous_var_nameX1259);
int pthread_rwlockattr_destroy(struct _opaque_pthread_rwlockattr_t* anonymous_var_nameX1260);
int pthread_rwlockattr_getpshared(const struct _opaque_pthread_rwlockattr_t* anonymous_var_nameX1261, int* anonymous_var_nameX1262);
int pthread_rwlockattr_init(struct _opaque_pthread_rwlockattr_t* anonymous_var_nameX1263);
int pthread_rwlockattr_setpshared(struct _opaque_pthread_rwlockattr_t* anonymous_var_nameX1264, int anonymous_var_nameX1265);
struct _opaque_pthread_t* pthread_self();
int pthread_setcancelstate(int anonymous_var_nameX1266, int* anonymous_var_nameX1267);
int pthread_setcanceltype(int anonymous_var_nameX1268, int* anonymous_var_nameX1269);
int pthread_setconcurrency(int anonymous_var_nameX1270);
int pthread_setschedparam(struct _opaque_pthread_t* anonymous_var_nameX1271, int anonymous_var_nameX1272, const struct sched_param* anonymous_var_nameX1273);
int pthread_setspecific(unsigned long  int anonymous_var_nameX1274, const void* anonymous_var_nameX1275);
...
void OSSL_LIB_CTX_free(struct ossl_lib_ctx_st* anonymous_var_nameX1277);
...
void BIO_ADDR_free(union bio_addr_st* anonymous_var_nameX1281);
...
int BN_BLINDING_convert_ex(struct bignum_st* n, struct bignum_st* r, struct bn_blinding_st* b, struct bignum_ctx* anonymous_var_nameX1337);
int BN_BLINDING_invert_ex(struct bignum_st* n, const struct bignum_st* r, struct bn_blinding_st* b, struct bignum_ctx* anonymous_var_nameX1338);
...
unsigned long  int BN_BLINDING_get_flags(const struct bn_blinding_st* anonymous_var_nameX1339);
void BN_BLINDING_set_flags(struct bn_blinding_st* anonymous_var_nameX1340, unsigned long  int anonymous_var_nameX1341);
...
int ASN1_STRING_TABLE_add(int anonymous_var_nameX1350, long anonymous_var_nameX1351, long anonymous_var_nameX1352, unsigned long  int anonymous_var_nameX1353, unsigned long  int anonymous_var_nameX1354);
...
void EC_GROUP_set_point_conversion_form(struct ec_group_st* group, enum anonymous_typeY25 form);
enum anonymous_typeY25 EC_GROUP_get_point_conversion_form(const struct ec_group_st* anonymous_var_nameX1373);
unsigned char* EC_GROUP_get0_seed(const struct ec_group_st* x);
unsigned long  int EC_GROUP_get_seed_len(const struct ec_group_st* anonymous_var_nameX1374);
unsigned long  int EC_GROUP_set_seed(struct ec_group_st* anonymous_var_nameX1375, const unsigned char* anonymous_var_nameX1376, unsigned long  int len);
...
unsigned long  int EC_get_builtin_curves(struct anonymous_typeX26* r, unsigned long  int nitems);
...
unsigned long  int EC_POINT_point2oct(const struct ec_group_st* group, const struct ec_point_st* p, enum anonymous_typeY25 form, unsigned char* buf, unsigned long  int len, struct bignum_ctx* ctx);
...
unsigned long  int EC_POINT_point2buf(const struct ec_group_st* group, const struct ec_point_st* point, enum anonymous_typeY25 form, unsigned char** pbuf, struct bignum_ctx* ctx);
struct bignum_st* EC_POINT_point2bn(const struct ec_group_st* anonymous_var_nameX1377, const struct ec_point_st* anonymous_var_nameX1378, enum anonymous_typeY25 form, struct bignum_st* anonymous_var_nameX1379, struct bignum_ctx* anonymous_var_nameX1380);
struct ec_point_st* EC_POINT_bn2point(const struct ec_group_st* anonymous_var_nameX1381, const struct bignum_st* anonymous_var_nameX1382, struct ec_point_st* anonymous_var_nameX1383, struct bignum_ctx* anonymous_var_nameX1384);
char* EC_POINT_point2hex(const struct ec_group_st* anonymous_var_nameX1385, const struct ec_point_st* anonymous_var_nameX1386, enum anonymous_typeY25 form, struct bignum_ctx* anonymous_var_nameX1387);
struct ec_point_st* EC_POINT_hex2point(const struct ec_group_st* anonymous_var_nameX1388, const char* anonymous_var_nameX1389, struct ec_point_st* anonymous_var_nameX1390, struct bignum_ctx* anonymous_var_nameX1391);
...
int EC_GROUP_get_basis_type(const struct ec_group_st* anonymous_var_nameX1392);
int EC_GROUP_get_trinomial_basis(const struct ec_group_st* anonymous_var_nameX1393, unsigned int* k);
int EC_GROUP_get_pentanomial_basis(const struct ec_group_st* anonymous_var_nameX1394, unsigned int* k1, unsigned int* k2, unsigned int* k3);
struct ec_group_st* d2i_ECPKParameters(struct ec_group_st** anonymous_var_nameX1395, const unsigned char** in, long len);
int i2d_ECPKParameters(const struct ec_group_st* anonymous_var_nameX1396, unsigned char** out);
...
enum anonymous_typeY25 EC_KEY_get_conv_form(const struct ec_key_st* key);
void EC_KEY_set_conv_form(struct ec_key_st* eckey, enum anonymous_typeY25 cform);
...
unsigned long  int EC_KEY_key2buf(const struct ec_key_st* key, enum anonymous_typeY25 form, unsigned char** pbuf, struct bignum_ctx* ctx);
...
int RSA_check_key(const struct rsa_st* anonymous_var_nameX1400);
int RSA_check_key_ex(const struct rsa_st* anonymous_var_nameX1401, struct bn_gencb_st* cb);
...
void DSA_set_default_method(const struct dsa_method* anonymous_var_nameX1419);
const struct dsa_method* DSA_get_default_method();
int DSA_set_method(struct dsa_st* dsa, const struct dsa_method* anonymous_var_nameX1420);
...
int DSA_size(const struct dsa_st* anonymous_var_nameX1421);
...
int X509_OBJECT_idx_by_subject(struct stack_st_X509_OBJECT* h, enum anonymous_typeY29 type, const struct X509_name_st* name);
struct x509_object_st* X509_OBJECT_retrieve_by_subject(struct stack_st_X509_OBJECT* h, enum anonymous_typeY29 type, const struct X509_name_st* name);
...
enum anonymous_typeY29 X509_OBJECT_get_type(const struct x509_object_st* a);
...
int X509_LOOKUP_meth_set_get_by_subject(struct x509_lookup_method_st* method, int (*fn)(struct x509_lookup_st*,enum anonymous_typeY29,const struct X509_name_st*,struct x509_object_st*));
int (*X509_LOOKUP_meth_get_get_by_subject(const struct x509_lookup_method_st* method))(struct x509_lookup_st*,enum anonymous_typeY29,const struct X509_name_st*,struct x509_object_st*);
int X509_LOOKUP_meth_set_get_by_issuer_serial(struct x509_lookup_method_st* method, int (*fn)(struct x509_lookup_st*,enum anonymous_typeY29,const struct X509_name_st*,const struct asn1_string_st*,struct x509_object_st*));
int (*X509_LOOKUP_meth_get_get_by_issuer_serial(const struct x509_lookup_method_st* method))(struct x509_lookup_st*,enum anonymous_typeY29,const struct X509_name_st*,const struct asn1_string_st*,struct x509_object_st*);
int X509_LOOKUP_meth_set_get_by_fingerprint(struct x509_lookup_method_st* method, int (*fn)(struct x509_lookup_st*,enum anonymous_typeY29,const unsigned char*,int,struct x509_object_st*));
int (*X509_LOOKUP_meth_get_get_by_fingerprint(const struct x509_lookup_method_st* method))(struct x509_lookup_st*,enum anonymous_typeY29,const unsigned char*,int,struct x509_object_st*);
int X509_LOOKUP_meth_set_get_by_alias(struct x509_lookup_method_st* method, int (*fn)(struct x509_lookup_st*,enum anonymous_typeY29,const char*,int,struct x509_object_st*));
int (*X509_LOOKUP_meth_get_get_by_alias(const struct x509_lookup_method_st* method))(struct x509_lookup_st*,enum anonymous_typeY29,const char*,int,struct x509_object_st*);
...
int X509_STORE_CTX_get_by_subject(const struct x509_store_ctx_st* vs, enum anonymous_typeY29 type, const struct X509_name_st* name, struct x509_object_st* ret);
struct x509_object_st* X509_STORE_CTX_get_obj_by_subject(struct x509_store_ctx_st* vs, enum anonymous_typeY29 type, const struct X509_name_st* name);
...
int X509_LOOKUP_by_subject(struct x509_lookup_st* ctx, enum anonymous_typeY29 type, const struct X509_name_st* name, struct x509_object_st* ret);
int X509_LOOKUP_by_subject_ex(struct x509_lookup_st* ctx, enum anonymous_typeY29 type, const struct X509_name_st* name, struct x509_object_st* ret, struct ossl_lib_ctx_st* libctx, const char* propq);
int X509_LOOKUP_by_issuer_serial(struct x509_lookup_st* ctx, enum anonymous_typeY29 type, const struct X509_name_st* name, const struct asn1_string_st* serial, struct x509_object_st* ret);
int X509_LOOKUP_by_fingerprint(struct x509_lookup_st* ctx, enum anonymous_typeY29 type, const unsigned char* bytes, int len, struct x509_object_st* ret);
int X509_LOOKUP_by_alias(struct x509_lookup_st* ctx, enum anonymous_typeY29 type, const char* str, int len, struct x509_object_st* ret);
...
void X509_VERIFY_PARAM_move_peername(struct X509_VERIFY_PARAM_st* anonymous_var_nameX1573, struct X509_VERIFY_PARAM_st* anonymous_var_nameX1574);
...
struct anonymous_typeX29* PBMAC1PARAM_new();
void PBMAC1PARAM_free(struct anonymous_typeX29* a);
struct anonymous_typeX29* d2i_PBMAC1PARAM(struct anonymous_typeX29** a, const unsigned char** in, long len);
int i2d_PBMAC1PARAM(const struct anonymous_typeX29* a, unsigned char** out);
...
int PEM_write_bio_PKCS8PrivateKey(struct bio_st* anonymous_var_nameX1617, const struct evp_pkey_st* anonymous_var_nameX1618, const struct evp_cipher_st* anonymous_var_nameX1619, const char* kstr, int klen, int (*cb)(char*,int,int,void*), void* u);
...
struct sct_st* SCT_new_from_base64(unsigned char version, const char* logid_base64, enum anonymous_typeY32 entry_type, unsigned long  long timestamp, const char* extensions_base64, const char* signature_base64);
...
enum anonymous_typeY32 SCT_get_log_entry_type(const struct sct_st* sct);
int SCT_set_log_entry_type(struct sct_st* sct, enum anonymous_typeY32 entry_type);
...
enum anonymous_typeY32 SCT_get_source(const struct sct_st* sct);
int SCT_set_source(struct sct_st* sct, enum anonymous_typeY32 source);
...
enum anonymous_typeY32 SCT_get_validation_status(const struct sct_st* sct);
...
int SSL_CTX_set_cipher_list(struct ssl_ctx_st* anonymous_var_nameX1631, const char* str);
...
void SSL_CTX_free(struct ssl_ctx_st* anonymous_var_nameX1632);
long SSL_CTX_set_timeout(struct ssl_ctx_st* ctx, long t);
long SSL_CTX_get_timeout(const struct ssl_ctx_st* ctx);
struct x509_store_st* SSL_CTX_get_cert_store(const struct ssl_ctx_st* anonymous_var_nameX1633);
void SSL_CTX_set_cert_store(struct ssl_ctx_st* anonymous_var_nameX1634, struct x509_store_st* anonymous_var_nameX1635);
void SSL_CTX_set1_cert_store(struct ssl_ctx_st* anonymous_var_nameX1636, struct x509_store_st* anonymous_var_nameX1637);
...
long SSL_callback_ctrl(struct ssl_st* anonymous_var_nameX1647, int anonymous_var_nameX1648, void (*anonymous_lambda_var_nameZ63)());
long SSL_CTX_ctrl(struct ssl_ctx_st* ctx, int cmd, long larg, void* parg);
long SSL_CTX_callback_ctrl(struct ssl_ctx_st* anonymous_var_nameX1649, int anonymous_var_nameX1650, void (*anonymous_lambda_var_nameZ64)());
...
char* SSL_CIPHER_description(const struct ssl_cipher_st* anonymous_var_nameX1651, char* buf, int size);
...
enum anonymous_typeY32 SSL_get_state(const struct ssl_st* ssl);
...
void ERR_remove_thread_state(void* anonymous_var_nameX1694);
...
unsigned int list_length(struct LIST* anonymous_var_nameX1697);
int list_walk(struct LIST* anonymous_var_nameX1698, int (*action)(void*,void*), unsigned char* argument);
...
void mysql_set_local_infile_handler(struct MYSQL* mysql, int (*local_infile_init)(void**,const char*,void*), int (*local_infile_read)(void*,char*,unsigned int), void (*local_infile_end)(void*), int (*local_infile_error)(void*,char*,unsigned int), void* anonymous_var_nameX1778);
...
void fun_block1_mainc(struct __current_stack1__* parent, int it, _Bool* it2);
...
static struct list$1list$1char$ph$ph* list$1list$1char$ph$ph_initialize(struct list$1list$1char$ph$ph* self);
static void list$1list$1char$ph$ph$p_finalize(struct list$1list$1char$ph$ph* self);
static void list_item$1list$1char$ph$ph$p_finalize(struct list_item$1list$1char$ph$ph* self);
static struct list$1list$1char$ph$ph* list$1list$1char$ph$ph_add(struct list$1list$1char$ph$ph* self, struct list$1char$ph* item);
static void list$1char$ph_finalize(struct list$1char$ph* self);
struct list$1list$1char$ph$ph* xmysql_query_and_fetch_row(char* query, char* user, char* password, _Bool create_user, _Bool create_database, char* root_password, char* database_name, char* host_name);
...
static inline unsigned short int _OSSwapInt16(unsigned short int data){
    return ((unsigned short int)((((unsigned short int)(data)&0xff00U)>>8)|(((unsigned short int)(data)&0x00ffU)<<8)));
}
static inline unsigned int _OSSwapInt32(unsigned int data){
    return ((unsigned int)((((unsigned int)(data)&0xff000000U)>>24)|(((unsigned int)(data)&0x00ff0000U)>>8)|(((unsigned int)(data)&0x0000ff00U)<<8)|(((unsigned int)(data)&0x000000ffU)<<24)));
}
static inline unsigned long  long _OSSwapInt64(unsigned long  long data){
    return ((unsigned long  long)((((unsigned long  long)(data)&0xff00000000000000ULL)>>56)|(((unsigned long  long)(data)&0x00ff000000000000ULL)>>40)|(((unsigned long  long)(data)&0x0000ff0000000000ULL)>>24)|(((unsigned long  long)(data)&0x000000ff00000000ULL)>>8)|(((unsigned long  long)(data)&0x00000000ff000000ULL)<<8)|(((unsigned long  long)(data)&0x0000000000ff0000ULL)<<24)|(((unsigned long  long)(data)&0x000000000000ff00ULL)<<40)|(((unsigned long  long)(data)&0x00000000000000ffULL)<<56)));
}
static inline unsigned short int OSReadSwapInt16(const void* base, unsigned long  int byteOffset){
unsigned short int data;
    data=*(unsigned short int*)((unsigned long  int)base+byteOffset);
    return _OSSwapInt16(data);
}
static inline unsigned int OSReadSwapInt32(const void* base, unsigned long  int byteOffset){
unsigned int data;
    data=*(unsigned int*)((unsigned long  int)base+byteOffset);
...
unsigned long  long data;
    data=*(unsigned long  long*)((unsigned long  int)base+byteOffset);
...
static inline int (*OSSL_FUNC_core_count_to_mark(const struct ossl_dispatch_st* opf))(const struct ossl_core_handle_st*){
    return (int (*)(const struct ossl_core_handle_st*))opf->function;
}
...
static inline int (*OSSL_FUNC_provider_random_bytes(const struct ossl_dispatch_st* opf))(void*,int,void*,unsigned long  int,unsigned int){
    return (int (*)(void*,int,void*,unsigned long  int,unsigned int))opf->function;
}
static inline int (*OSSL_FUNC_SSL_QUIC_TLS_crypto_send(const struct ossl_dispatch_st* opf))(struct ssl_st*,const unsigned char*,unsigned long  int,unsigned long  int*,void*){
    return (int (*)(struct ssl_st*,const unsigned char*,unsigned long  int,unsigned long  int*,void*))opf->function;
}
static inline int (*OSSL_FUNC_SSL_QUIC_TLS_crypto_recv_rcd(const struct ossl_dispatch_st* opf))(struct ssl_st*,const unsigned char**,unsigned long  int*,void*){
    return (int (*)(struct ssl_st*,const unsigned char**,unsigned long  int*,void*))opf->function;
}
static inline int (*OSSL_FUNC_SSL_QUIC_TLS_crypto_release_rcd(const struct ossl_dispatch_st* opf))(struct ssl_st*,unsigned long  int,void*){
    return (int (*)(struct ssl_st*,unsigned long  int,void*))opf->function;
}
static inline int (*OSSL_FUNC_SSL_QUIC_TLS_yield_secret(const struct ossl_dispatch_st* opf))(struct ssl_st*,unsigned int,int,const unsigned char*,unsigned long  int,void*){
    return (int (*)(struct ssl_st*,unsigned int,int,const unsigned char*,unsigned long  int,void*))opf->function;
}
static inline int (*OSSL_FUNC_SSL_QUIC_TLS_got_transport_params(const struct ossl_dispatch_st* opf))(struct ssl_st*,const unsigned char*,unsigned long  int,void*){
    return (int (*)(struct ssl_st*,const unsigned char*,unsigned long  int,void*))opf->function;
}
static inline int (*OSSL_FUNC_SSL_QUIC_TLS_alert(const struct ossl_dispatch_st* opf))(struct ssl_st*,unsigned char,void*){
...
static inline void (*OSSL_FUNC_digest_copyctx(const struct ossl_dispatch_st* opf))(void*,void*){
...
static inline int (*OSSL_FUNC_cipher_pipeline_encrypt_init(const struct ossl_dispatch_st* opf))(void*,const unsigned char*,unsigned long  int,unsigned long  int,const unsigned char**,unsigned long  int,const struct ossl_param_st*){
...
static inline int (*OSSL_FUNC_cipher_pipeline_decrypt_init(const struct ossl_dispatch_st* opf))(void*,const unsigned char*,unsigned long  int,unsigned long  int,const unsigned char**,unsigned long  int,const struct ossl_param_st*){
    return (int (*)(void*,const unsigned char*,unsigned long  int,unsigned long  int,const unsigned char**,unsigned long  int,const struct ossl_param_st*))opf->function;
}
static inline int (*OSSL_FUNC_cipher_pipeline_update(const struct ossl_dispatch_st* opf))(void*,unsigned long  int,unsigned char**,unsigned long  int*,const unsigned long  int*,const unsigned char**,const unsigned long  int*){
...
static inline int (*OSSL_FUNC_cipher_pipeline_final(const struct ossl_dispatch_st* opf))(void*,unsigned long  int,unsigned char**,unsigned long  int*,const unsigned long  int*){
...
static inline int (*OSSL_FUNC_cipher_encrypt_skey_init(const struct ossl_dispatch_st* opf))(void*,void*,const unsigned char*,unsigned long  int,const struct ossl_param_st*){
    return (int (*)(void*,void*,const unsigned char*,unsigned long  int,const struct ossl_param_st*))opf->function;
}
static inline int (*OSSL_FUNC_cipher_decrypt_skey_init(const struct ossl_dispatch_st* opf))(void*,void*,const unsigned char*,unsigned long  int,const struct ossl_param_st*){
    return (int (*)(void*,void*,const unsigned char*,unsigned long  int,const struct ossl_param_st*))opf->function;
}
...
static inline int (*OSSL_FUNC_mac_init_skey(const struct ossl_dispatch_st* opf))(void*,void*,const struct ossl_param_st*){
    return (int (*)(void*,void*,const struct ossl_param_st*))opf->function;
}
static inline void (*OSSL_FUNC_skeymgmt_free(const struct ossl_dispatch_st* opf))(void*){
    return (void (*)(void*))opf->function;
}
static inline const struct ossl_param_st* (*OSSL_FUNC_skeymgmt_imp_settable_params(const struct ossl_dispatch_st* opf))(void*){
    return (const struct ossl_param_st* (*)(void*))opf->function;
}
static inline void* (*OSSL_FUNC_skeymgmt_import(const struct ossl_dispatch_st* opf))(void*,int,const struct ossl_param_st*){
    return (void* (*)(void*,int,const struct ossl_param_st*))opf->function;
}
static inline int (*OSSL_FUNC_skeymgmt_export(const struct ossl_dispatch_st* opf))(void*,int,int (*)(const struct ossl_param_st*,void*),void*){
    return (int (*)(void*,int,int (*)(const struct ossl_param_st*,void*),void*))opf->function;
}
static inline const struct ossl_param_st* (*OSSL_FUNC_skeymgmt_gen_settable_params(const struct ossl_dispatch_st* opf))(void*){
    return (const struct ossl_param_st* (*)(void*))opf->function;
}
static inline void* (*OSSL_FUNC_skeymgmt_generate(const struct ossl_dispatch_st* opf))(void*,const struct ossl_param_st*){
    return (void* (*)(void*,const struct ossl_param_st*))opf->function;
}
static inline const char* (*OSSL_FUNC_skeymgmt_get_key_id(const struct ossl_dispatch_st* opf))(void*){
...
static inline int (*OSSL_FUNC_kdf_set_skey(const struct ossl_dispatch_st* opf))(void*,void*,const char*){
    return (int (*)(void*,void*,const char*))opf->function;
}
static inline void* (*OSSL_FUNC_kdf_derive_skey(const struct ossl_dispatch_st* opf))(void*,const char*,void*,void* (*)(void*,int,const struct ossl_param_st*),unsigned long  int,const struct ossl_param_st*){
...
static inline void* (*OSSL_FUNC_keyexch_derive_skey(const struct ossl_dispatch_st* opf))(void*,const char*,void*,void* (*)(void*,int,const struct ossl_param_st*),unsigned long  int,const struct ossl_param_st*){
    return (void* (*)(void*,const char*,void*,void* (*)(void*,int,const struct ossl_param_st*),unsigned long  int,const struct ossl_param_st*))opf->function;
}
...
static inline int sk_OCSP_RESPONSE_num(const struct stack_st_OCSP_RESPONSE* sk){
    return OPENSSL_sk_num((const struct stack_st*)sk);
}
static inline struct ocsp_response_st* sk_OCSP_RESPONSE_value(const struct stack_st_OCSP_RESPONSE* sk, int idx){
    return (struct ocsp_response_st*)OPENSSL_sk_value((const struct stack_st*)sk,idx);
}
static inline struct stack_st_OCSP_RESPONSE* sk_OCSP_RESPONSE_new(int (*compare)(const struct ocsp_response_st**,const struct ocsp_response_st**)){
struct stack_st* ret;
void (*f_thunk)(void (*)(void*),void*);
memset(&f_thunk, 0, sizeof(void (*)(void (*)(void*),void*)));
...
static inline struct stack_st_OCSP_RESPONSE* sk_OCSP_RESPONSE_new_null(){
    return (struct stack_st_OCSP_RESPONSE*)OPENSSL_sk_new_null();
}
static inline struct stack_st_OCSP_RESPONSE* sk_OCSP_RESPONSE_new_reserve(int (*compare)(const struct ocsp_response_st**,const struct ocsp_response_st**), int n){
struct stack_st* ret;
void (*f_thunk)(void (*)(void*),void*);
memset(&f_thunk, 0, sizeof(void (*)(void (*)(void*),void*)));
...
static inline int sk_OCSP_RESPONSE_reserve(struct stack_st_OCSP_RESPONSE* sk, int n){
    return OPENSSL_sk_reserve((struct stack_st*)sk,n);
}
static inline void sk_OCSP_RESPONSE_free(struct stack_st_OCSP_RESPONSE* sk){
    OPENSSL_sk_free((struct stack_st*)sk);
}
static inline void sk_OCSP_RESPONSE_zero(struct stack_st_OCSP_RESPONSE* sk){
    OPENSSL_sk_zero((struct stack_st*)sk);
}
static inline struct ocsp_response_st* sk_OCSP_RESPONSE_delete(struct stack_st_OCSP_RESPONSE* sk, int i){
    return (struct ocsp_response_st*)OPENSSL_sk_delete((struct stack_st*)sk,i);
}
static inline struct ocsp_response_st* sk_OCSP_RESPONSE_delete_ptr(struct stack_st_OCSP_RESPONSE* sk, struct ocsp_response_st* ptr){
    return (struct ocsp_response_st*)OPENSSL_sk_delete_ptr((struct stack_st*)sk,(const void*)ptr);
}
static inline int sk_OCSP_RESPONSE_push(struct stack_st_OCSP_RESPONSE* sk, struct ocsp_response_st* ptr){
    return OPENSSL_sk_push((struct stack_st*)sk,(const void*)ptr);
}
static inline int sk_OCSP_RESPONSE_unshift(struct stack_st_OCSP_RESPONSE* sk, struct ocsp_response_st* ptr){
    return OPENSSL_sk_unshift((struct stack_st*)sk,(const void*)ptr);
}
static inline struct ocsp_response_st* sk_OCSP_RESPONSE_pop(struct stack_st_OCSP_RESPONSE* sk){
    return (struct ocsp_response_st*)OPENSSL_sk_pop((struct stack_st*)sk);
}
static inline struct ocsp_response_st* sk_OCSP_RESPONSE_shift(struct stack_st_OCSP_RESPONSE* sk){
    return (struct ocsp_response_st*)OPENSSL_sk_shift((struct stack_st*)sk);
}
static inline void sk_OCSP_RESPONSE_pop_free(struct stack_st_OCSP_RESPONSE* sk, void (*freefunc)(struct ocsp_response_st*)){
void (*f_thunk)(void (*)(void*),void*);
memset(&f_thunk, 0, sizeof(void (*)(void (*)(void*),void*)));
    f_thunk=(void (*)(void (*)(void*),void*))sk_OCSP_RESPONSE_freefunc_thunk;
...
static inline int sk_OCSP_RESPONSE_insert(struct stack_st_OCSP_RESPONSE* sk, struct ocsp_response_st* ptr, int idx){
    return OPENSSL_sk_insert((struct stack_st*)sk,(const void*)ptr,idx);
}
static inline struct ocsp_response_st* sk_OCSP_RESPONSE_set(struct stack_st_OCSP_RESPONSE* sk, int idx, struct ocsp_response_st* ptr){
    return (struct ocsp_response_st*)OPENSSL_sk_set((struct stack_st*)sk,idx,(const void*)ptr);
}
static inline int sk_OCSP_RESPONSE_find(struct stack_st_OCSP_RESPONSE* sk, struct ocsp_response_st* ptr){
    return OPENSSL_sk_find((struct stack_st*)sk,(const void*)ptr);
}
static inline int sk_OCSP_RESPONSE_find_ex(struct stack_st_OCSP_RESPONSE* sk, struct ocsp_response_st* ptr){
    return OPENSSL_sk_find_ex((struct stack_st*)sk,(const void*)ptr);
}
static inline int sk_OCSP_RESPONSE_find_all(struct stack_st_OCSP_RESPONSE* sk, struct ocsp_response_st* ptr, int* pnum){
    return OPENSSL_sk_find_all((struct stack_st*)sk,(const void*)ptr,pnum);
}
static inline void sk_OCSP_RESPONSE_sort(struct stack_st_OCSP_RESPONSE* sk){
    OPENSSL_sk_sort((struct stack_st*)sk);
}
static inline int sk_OCSP_RESPONSE_is_sorted(const struct stack_st_OCSP_RESPONSE* sk){
    return OPENSSL_sk_is_sorted((const struct stack_st*)sk);
}
static inline struct stack_st_OCSP_RESPONSE* sk_OCSP_RESPONSE_dup(const struct stack_st_OCSP_RESPONSE* sk){
    return (struct stack_st_OCSP_RESPONSE*)OPENSSL_sk_dup((const struct stack_st*)sk);
}
static inline struct stack_st_OCSP_RESPONSE* sk_OCSP_RESPONSE_deep_copy(const struct stack_st_OCSP_RESPONSE* sk, struct ocsp_response_st* (*copyfunc)(const struct ocsp_response_st*), void (*freefunc)(struct ocsp_response_st*)){
...
static inline int (*sk_OCSP_RESPONSE_set_cmp_func(struct stack_st_OCSP_RESPONSE* sk, int (*compare)(const struct ocsp_response_st**,const struct ocsp_response_st**)))(const struct ocsp_response_st**,const struct ocsp_response_st**){
    return (int (*)(const struct ocsp_response_st**,const struct ocsp_response_st**))OPENSSL_sk_set_cmp_func((struct stack_st*)sk,(int (*)(const void*,const void*))compare);
}
...
void (*freefunc)(struct anonymous_typeX32*);
    freefunc=(void (*)(struct anonymous_typeX32*))freefunc_arg;
    freefunc((struct anonymous_typeX32*)ptr);
}
static inline struct anonymous_typeX32* ossl_check_CONF_VALUE_type(struct anonymous_typeX32* ptr){
    return ptr;
}
...
static inline int (*ossl_check_CONF_VALUE_compfunc_type(int (*cmp)(const struct anonymous_typeX32**,const struct anonymous_typeX32**)))(const void*,const void*){
    return (int (*)(const void*,const void*))cmp;
}
static inline void* (*ossl_check_CONF_VALUE_copyfunc_type(struct anonymous_typeX32* (*cpy)(const struct anonymous_typeX32*)))(const void*){
    return (void* (*)(const void*))cpy;
}
static inline void (*ossl_check_CONF_VALUE_freefunc_type(void (*fr)(struct anonymous_typeX32*)))(void*){
    return (void (*)(void*))fr;
}
static inline unsigned long  int lh_CONF_VALUE_hash_thunk(const void* data, unsigned long  int (*hfn)(const void*)){
unsigned long  int (*hfn_conv)(const struct anonymous_typeX32*);
    hfn_conv=(unsigned long  int (*)(const struct anonymous_typeX32*))hfn;
    return hfn_conv((const struct anonymous_typeX32*)data);
}
static inline int lh_CONF_VALUE_comp_thunk(const void* da, const void* db, int (*cfn)(const void*,const void*)){
int (*cfn_conv)(const struct anonymous_typeX32*,const struct anonymous_typeX32*);
    cfn_conv=(int (*)(const struct anonymous_typeX32*,const struct anonymous_typeX32*))cfn;
    return cfn_conv((const struct anonymous_typeX32*)da,(const struct anonymous_typeX32*)db);
}
static inline void lh_CONF_VALUE_doall_thunk(void* node, void (*doall)(void*)){
void (*doall_conv)(struct anonymous_typeX32*);
    doall_conv=(void (*)(struct anonymous_typeX32*))doall;
    doall_conv((struct anonymous_typeX32*)node);
}
static inline void lh_CONF_VALUE_doall_arg_thunk(void* node, void* arg, void (*doall)(void*,void*)){
void (*doall_conv)(struct anonymous_typeX32*,void*);
    doall_conv=(void (*)(struct anonymous_typeX32*,void*))doall;
    doall_conv((struct anonymous_typeX32*)node,arg);
}
static inline struct anonymous_typeX32* ossl_check_CONF_VALUE_lh_plain_type(struct anonymous_typeX32* ptr){
    return ptr;
}
static inline const struct anonymous_typeX32* ossl_check_const_CONF_VALUE_lh_plain_type(const struct anonymous_typeX32* ptr){
    return ptr;
}
...
static inline int (*ossl_check_CONF_VALUE_lh_compfunc_type(int (*cmp)(const struct anonymous_typeX32*,const struct anonymous_typeX32*)))(const void*,const void*){
    return (int (*)(const void*,const void*))cmp;
}
static inline unsigned long  int (*ossl_check_CONF_VALUE_lh_hashfunc_type(unsigned long  int (*hfn)(const struct anonymous_typeX32*)))(const void*){
    return (unsigned long  int (*)(const void*))hfn;
}
static inline void (*ossl_check_CONF_VALUE_lh_doallfunc_type(void (*dfn)(struct anonymous_typeX32*)))(void*){
    return (void (*)(void*))dfn;
}
...
memset(&d, 0, sizeof(struct bio_poll_descriptor_st));
    d.type=2;
    d.value.ssl=s;
    return d;
}
...
memset(&__current_stack1__, 0, sizeof(struct __current_stack1__));
    ...
    client_socket(3366,"127.0.0.1",&__current_stack1__,(void*)fun_block1_mainc);
come_heap_final();
}
...
char* __result_obj__1;
    __result_obj__1 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(gComeStackFrameBuffer))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
memset(&i_7, 0, sizeof(int));
    if(    gComeDebugLib    ) {
        ...
        gAllocMem=it;
        gNumAlloc++;
        __result_obj__3 = (char*)result+sizeof(struct sMemHeader);
        ...
        gNumAlloc++;
        __result_obj__4 = (char*)result_8+sizeof(struct sMemHeaderTiny);
...
char* __result_obj__6;
    if(    gComeDebugLib    ) {
        ...
        __result_obj__6 = it_11->class_name;
...
void* __result_obj__7;
    ...
    *size2=size*count+sizeof(unsigned long  int)+sizeof(unsigned long  int);
    __result_obj__7 = mem+sizeof(unsigned long  int)+sizeof(unsigned long  int);
...
char* __result_obj__19;
    ...
    __result_obj__19 = (char*)come_increment_ref_count(result);
...
char* __result_obj__20;
    __result_obj__20 = (char*)come_increment_ref_count(((char*)(__right_value0=come_get_stackframe())));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
struct buffer* __result_obj__25;
    ...
    __result_obj__25 = (struct buffer*)come_increment_ref_count(result);
...
_Bool __result_obj__26;
    ...
    __result_obj__26 = string_equals(((char*)(__right_value0=buffer_to_string(left))),((char*)(__right_value1=buffer_to_string(right))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
struct buffer* __result_obj__46;
    ...
    if(    self==((void*)0)    ) {
        __result_obj__45 = (struct buffer*)come_increment_ref_count(result);
        come_call_finalizer(buffer_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
char* __result_obj__48;
    if(    self==((void*)0)    ) {
        __result_obj__47 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__result_obj__47 = come_decrement_ref_count(__result_obj__47, (void*)0, (void*)0, 0, 1, (void*)0));
        return __result_obj__47;
    }
    __right_value0 = (void*)0;
    __result_obj__48 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(self->buf))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__57;
    ...
    result[n]=0;
    __result_obj__57 = (char*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
struct list$1char$* __result_obj__59;
    ...
    come_call_finalizer(list$1char$$p_finalize, __result_obj__59, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct list$1char$* __result_obj__60;
    __result_obj__60 = (struct list$1char$*)come_increment_ref_count(((struct list$1char$*)(__right_value1=list$1char$_initialize_with_values((struct list$1char$*)come_increment_ref_count((struct list$1char$*)come_calloc_v2(1, sizeof(struct list$1char$)*(1), "/usr/local/include/neo-c.h", 8539, "struct list$1char$*")),len,self))));
...
struct list$1char$p* __result_obj__62;
    ...
    come_call_finalizer(list$1char$p$p_finalize, __result_obj__62, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct list$1short$* __result_obj__65;
    ...
    come_call_finalizer(list$1short$$p_finalize, __result_obj__65, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct list$1short$* __result_obj__66;
    __result_obj__66 = (struct list$1short$*)come_increment_ref_count(((struct list$1short$*)(__right_value1=list$1short$_initialize_with_values((struct list$1short$*)come_increment_ref_count((struct list$1short$*)come_calloc_v2(1, sizeof(struct list$1short$)*(1), "/usr/local/include/neo-c.h", 8549, "struct list$1short$*")),len,self))));
...
struct list$1int$* __result_obj__68;
    ...
    come_call_finalizer(list$1int$$p_finalize, __result_obj__68, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct list$1int$* __result_obj__69;
    __result_obj__69 = (struct list$1int$*)come_increment_ref_count(((struct list$1int$*)(__right_value1=list$1int$_initialize_with_values((struct list$1int$*)come_increment_ref_count((struct list$1int$*)come_calloc_v2(1, sizeof(struct list$1int$)*(1), "/usr/local/include/neo-c.h", 8554, "struct list$1int$*")),len,self))));
...
struct list$1long$* __result_obj__71;
    ...
    come_call_finalizer(list$1long$$p_finalize, __result_obj__71, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct list$1long$* __result_obj__72;
    __result_obj__72 = (struct list$1long$*)come_increment_ref_count(((struct list$1long$*)(__right_value1=list$1long$_initialize_with_values((struct list$1long$*)come_increment_ref_count((struct list$1long$*)come_calloc_v2(1, sizeof(struct list$1long$)*(1), "/usr/local/include/neo-c.h", 8559, "struct list$1long$*")),len,self))));
...
struct list$1float$* __result_obj__74;
    ...
    come_call_finalizer(list$1float$$p_finalize, __result_obj__74, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct list$1float$* __result_obj__75;
    __result_obj__75 = (struct list$1float$*)come_increment_ref_count(((struct list$1float$*)(__right_value1=list$1float$_initialize_with_values((struct list$1float$*)come_increment_ref_count((struct list$1float$*)come_calloc_v2(1, sizeof(struct list$1float$)*(1), "/usr/local/include/neo-c.h", 8564, "struct list$1float$*")),len,self))));
...
struct list$1double$* __result_obj__77;
    ...
    come_call_finalizer(list$1double$$p_finalize, __result_obj__77, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct list$1double$* __result_obj__78;
    __result_obj__78 = (struct list$1double$*)come_increment_ref_count(((struct list$1double$*)(__right_value1=list$1double$_initialize_with_values((struct list$1double$*)come_increment_ref_count((struct list$1double$*)come_calloc_v2(1, sizeof(struct list$1double$)*(1), "/usr/local/include/neo-c.h", 8569, "struct list$1double$*")),len,self))));
...
char* __result_obj__80;
    ...
    __result_obj__80 = (char*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
char* __result_obj__82;
    ...
    strncpy(result,self,len+1);
    strncat(result,right,len+1);
    __result_obj__82 = (char*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
char* __result_obj__84;
    if(    self==((void*)0)    ) {
        __result_obj__83 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    __right_value0 = (void*)0;
    __result_obj__84 = (char*)come_increment_ref_count(((char*)(__right_value0=buffer_to_string(buf))));
    come_call_finalizer(buffer_finalize, buf, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__86;
    ...
    __right_value0 = (void*)0;
    __result_obj__86 = (char*)come_increment_ref_count(((char*)(__right_value0=buffer_to_string(buf))));
    come_call_finalizer(buffer_finalize, buf, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__93;
    ...
    if(    head>tail    ) {
        __right_value0 = (void*)0;
        __result_obj__90 = (char*)come_increment_ref_count(((char*)(__right_value1=charp_reverse(((char*)(__right_value0=charp_substring(str,tail,head)))))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__98;
    if(    str==((void*)0)    ) {
        __result_obj__94 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    if(    head>tail    ) {
        __right_value0 = (void*)0;
        __result_obj__95 = (char*)come_increment_ref_count(((char*)(__right_value1=charp_reverse(((char*)(__right_value0=charp_substring(str,tail,head)))))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    if(    head==tail    ) {
        __right_value0 = (void*)0;
        __result_obj__96 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__103;
    if(    str==((void*)0)    ) {
        __result_obj__99 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    if(    head>tail    ) {
        __right_value0 = (void*)0;
        __result_obj__100 = (char*)come_increment_ref_count(((char*)(__right_value1=charp_reverse(((char*)(__right_value0=charp_substring(str,tail,head)))))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    if(    head==tail    ) {
        __right_value0 = (void*)0;
        __result_obj__101 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
result = (void*)0;
    ...
    free(result);
    __result_obj__106 = (char*)come_increment_ref_count(result2);
...
char* __result_obj__110;
    ...
    if(    strcmp(str,"")==0    ) {
        __right_value0 = (void*)0;
        __result_obj__108 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(str))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    __result_obj__110 = (char*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
struct list$1char$ph* __result_obj__111;
    ...
    come_call_finalizer(list$1char$ph$p_finalize, __result_obj__111, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct list$1char$ph* __result_obj__114;
    if(    self==((void*)0)    ) {
        __result_obj__112 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value1=list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 9291, "struct list$1char$ph*"))))));
    ...
    __result_obj__114 = (struct list$1char$ph*)come_increment_ref_count(result);
    come_call_finalizer(list$1char$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(buffer_finalize, str, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    come_call_finalizer(list$1char$ph$p_finalize, __result_obj__114, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
char* __result_obj__115;
    __result_obj__115 = (char*)come_increment_ref_count(((char*)(__right_value0=xsprintf(msg,self))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__117;
    ...
    result[n]=0;
    __result_obj__117 = (char*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
char* __result_obj__119;
    if(    str==((void*)0)||replace==((void*)0)    ) {
        __result_obj__118 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(self))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    __right_value0 = (void*)0;
    __result_obj__119 = (char*)come_increment_ref_count(((char*)(__right_value0=buffer_to_string(result))));
...
char* __result_obj__123;
    ...
    if(    p<path    ) {
        __right_value0 = (void*)0;
        __result_obj__121 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(path))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        ...
        __right_value0 = (void*)0;
        __result_obj__122 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(p+1))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__127;
    ...
    if(    p<path2    ) {
        __right_value0 = (void*)0;
        __result_obj__125 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(path2))));
        ...
        __right_value0 = (void*)0;
        __result_obj__126 = (char*)come_increment_ref_count(((char*)(__right_value0=charp_substring(path2,0,p-path2))));
        (path2 = come_decrement_ref_count(path2, (void*)0, (void*)0, 0, 0, (void*)0));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__131;
    ...
    if(    p<path    ) {
        __right_value0 = (void*)0;
        __result_obj__129 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(path))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        ...
        __right_value0 = (void*)0;
        __result_obj__130 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(p+1))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__result_obj__130 = come_decrement_ref_count(__result_obj__130, (void*)0, (void*)0, 0, 1, (void*)0));
        return __result_obj__130;
    }
    __right_value0 = (void*)0;
    __result_obj__131 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__133;
    if(    self    ) {
        __result_obj__132 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string("true"))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        ...
        __right_value0 = (void*)0;
        __result_obj__133 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string("false"))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__135;
    if(    self    ) {
        __result_obj__134 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string("true"))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        ...
        __right_value0 = (void*)0;
        __result_obj__135 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string("false"))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__136;
    __result_obj__136 = (char*)come_increment_ref_count(((char*)(__right_value0=xsprintf("%c",self))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__137;
    __result_obj__137 = (char*)come_increment_ref_count(((char*)(__right_value0=xsprintf("%d",self))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__139;
    __result_obj__139 = (char*)come_increment_ref_count(((char*)(__right_value0=xsprintf("%ld",self))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__141;
    __result_obj__141 = (char*)come_increment_ref_count(((char*)(__right_value0=xsprintf("%f",self))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__142;
    __result_obj__142 = (char*)come_increment_ref_count(((char*)(__right_value0=xsprintf("%lf",self))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__144;
    if(    self==((void*)0)    ) {
        __result_obj__143 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__result_obj__143 = come_decrement_ref_count(__result_obj__143, (void*)0, (void*)0, 0, 1, (void*)0));
        return __result_obj__143;
    }
    __right_value0 = (void*)0;
    __result_obj__144 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(self))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__146;
    if(    self==((void*)0)    ) {
        __result_obj__145 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__result_obj__145 = come_decrement_ref_count(__result_obj__145, (void*)0, (void*)0, 0, 1, (void*)0));
        return __result_obj__145;
    }
    __right_value0 = (void*)0;
    __result_obj__146 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(self))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__148;
    if(    self==((void*)0)    ) {
        __result_obj__147 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    puts(self);
    __right_value0 = (void*)0;
    __result_obj__148 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(self))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        ...
        while(        1        ) {
            ...
            if(            end_33!=0            ) {
                ...
                *matchlength=(int)(end_33-cursor);
                __result_obj__156 = (int)(cursor-text);
                come_call_finalizer(match_context_finalize, (&ctx), (void*)0, (void*)0, 1, 0, 0, (void*)0);
...
int pos;
struct regex_t* head;
struct re_program* __result_obj__158;
...
memset(&state, 0, sizeof(struct anonymous_typeX15));
    ...
    __result_obj__159 = (struct re_program*)&program;
    come_call_finalizer(regex_program_t_finalize, (&program), (void*)0, (void*)0, 1, 0, 0, (void*)0);
    come_call_finalizer(compiler_state_finalize, (&state), (void*)0, (void*)0, 1, 0, 0, (void*)0);
...
struct regex_t* new_token(struct anonymous_typeX15* st){
struct regex_t* __result_obj__160;
...
const char* __result_obj__202;
    ...
    restore_captures(ctx,snapshot_entry);
    __result_obj__202 = matchpattern(rest,text,ctx);
...
const char* __result_obj__223;
    switch (    token->type) {
        case (1):
        __result_obj__210 = (((*text!=0&&matchdot(*text)))?(text+1):(0));
        return __result_obj__210;
        case (7):
        __result_obj__211 = (((*text!=0&&token->u.ch==(unsigned char)*text))?(text+1):(0));
        return __result_obj__211;
        case (8):
        __result_obj__212 = (((*text!=0&&matchcharclass(*text,(const char*)token->u.ccl)))?(text+1):(0));
        return __result_obj__212;
        case (9):
        __result_obj__213 = (((*text!=0&&!matchcharclass(*text,(const char*)token->u.ccl)))?(text+1):(0));
        return __result_obj__213;
        case (10):
        __result_obj__214 = (((*text!=0&&matchdigit(*text)))?(text+1):(0));
        return __result_obj__214;
        case (11):
        __result_obj__215 = (((*text!=0&&!matchdigit(*text)))?(text+1):(0));
        return __result_obj__215;
        case (12):
        __result_obj__216 = (((*text!=0&&matchalphanum(*text)))?(text+1):(0));
        return __result_obj__216;
        case (13):
        __result_obj__217 = (((*text!=0&&!matchalphanum(*text)))?(text+1):(0));
        return __result_obj__217;
        case (14):
        __result_obj__218 = (((*text!=0&&matchwhitespace(*text)))?(text+1):(0));
        return __result_obj__218;
        case (15):
        __result_obj__219 = (((*text!=0&&!matchwhitespace(*text)))?(text+1):(0));
        return __result_obj__219;
        case (16):
        __result_obj__220 = matchgroup(token,(struct regex_t*)0,text,ctx);
        return __result_obj__220;
        case (2):
        __result_obj__221 = (((text==ctx->base))?(text):(0));
        return __result_obj__221;
        case (3):
        __result_obj__222 = (((*text==0))?(text):(0));
        return __result_obj__222;
        default:
        break;
    }
    __result_obj__223 = (const char*)0;
...
struct list$1char$ph* __result_obj__230;
    if(    reg==((void*)0)||reg==((void*)0)    ) {
        __result_obj__227 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value1=list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 11118, "struct list$1char$ph*"))))));
        come_call_finalizer(list$1char$ph$p_finalize, __right_value1, (void*)0, (void*)0, 0, 1, 0, (void*)0);
        come_call_finalizer(list$1char$ph$p_finalize, __result_obj__227, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    ...
    if(    re==((void*)0)    ) {
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        __result_obj__228 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value1=list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 11125, "struct list$1char$ph*"))))));
    ...
    __result_obj__230 = (struct list$1char$ph*)come_increment_ref_count(result);
    come_call_finalizer(list$1char$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(list$1char$ph$p_finalize, __result_obj__230, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
struct list$1char$ph* __result_obj__233;
    if(    reg==((void*)0)||reg==((void*)0)    ) {
        __result_obj__231 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value1=list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 11181, "struct list$1char$ph*"))))));
        come_call_finalizer(list$1char$ph$p_finalize, __right_value1, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    ...
    if(    re==((void*)0)    ) {
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        __result_obj__232 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value1=list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 11189, "struct list$1char$ph*"))))));
        come_call_finalizer(list$1char$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        come_call_finalizer(list$1char$ph$p_finalize, __right_value1, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    ...
    __result_obj__233 = (struct list$1char$ph*)come_increment_ref_count(result);
    come_call_finalizer(list$1char$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
char* __result_obj__234;
    __result_obj__234 = (char*)come_increment_ref_count(((char*)(__right_value0=charp_sub(self,reg,replace))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
struct list$1char$ph* __result_obj__235;
    __result_obj__235 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value0=charp_scan(self,reg))));
...
struct list$1char$ph* __result_obj__236;
    __result_obj__236 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value0=charp_split(self,reg))));
    come_call_finalizer(list$1char$ph$p_finalize, __right_value0, (void*)0, (void*)0, 0, 1, 0, (void*)0);
...
char* __result_obj__239;
    if(    reg==((void*)0)||reg==((void*)0)    ) {
        __result_obj__237 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    __right_value0 = (void*)0;
    __result_obj__239 = (char*)come_increment_ref_count(((char*)(__right_value0=buffer_to_string(result))));
    come_call_finalizer(buffer_finalize, result, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__242;
    if(    reg==((void*)0)||reg==((void*)0)    ) {
        __result_obj__240 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    __right_value0 = (void*)0;
    __result_obj__242 = (char*)come_increment_ref_count(((char*)(__right_value0=buffer_to_string(result))));
    come_call_finalizer(buffer_finalize, result, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
struct list$1char$ph* __result_obj__245;
    if(    reg==((void*)0)||reg==((void*)0)    ) {
        __result_obj__243 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value1=list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 11399, "struct list$1char$ph*"))))));
        come_call_finalizer(list$1char$ph$p_finalize, __right_value1, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    ...
    if(    re==((void*)0)    ) {
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        __result_obj__244 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value1=list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c.h", 11406, "struct list$1char$ph*"))))));
        come_call_finalizer(list$1char$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        come_call_finalizer(list$1char$ph$p_finalize, __right_value1, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    ...
    __result_obj__245 = (struct list$1char$ph*)come_increment_ref_count(result);
    come_call_finalizer(list$1char$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
char* __result_obj__246;
    __result_obj__246 = (char*)come_increment_ref_count(((char*)(__right_value0=charp_sub_block(self,reg,parent,block))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__248;
    ...
    __result_obj__248 = (int*)come_increment_ref_count(wstr);
...
char* __result_obj__249;
    ...
    __result_obj__249 = (char*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
int* __result_obj__255;
    if(    str==((void*)0)    ) {
        __result_obj__251 = (int*)come_increment_ref_count(((int*)(__right_value0=__builtin_wstring(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    result[tail-head]=0;
    __result_obj__255 = (int*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
char* __result_obj__256;
    ...
    __result_obj__256 = (char*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
int* charp_to_wstring(char* str){
void* __right_value0 = (void*)0;
int* __result_obj__258;
    __result_obj__258 = (int*)come_increment_ref_count(((int*)(__right_value0=__builtin_wstring(str))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__261;
    len=wcslen(str);
    if(    len==0    ) {
        __result_obj__259 = (int*)come_increment_ref_count(((int*)(__right_value1=string_to_wstring(((char*)(__right_value0=wchar_tp_to_string(str)))))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__262;
    ...
    result[len]=0;
    __result_obj__262 = (int*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
int* __result_obj__265;
    __result_obj__265 = (int*)come_increment_ref_count(((int*)(__right_value0=wchar_tp_multiply(str,n))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__267;
    ...
    wcscpy(result,left);
    wcscat(result,right);
    __result_obj__267 = (int*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
char* __result_obj__270;
    len=strlen(self);
    if(    strcmp(self,"")==0    ) {
        __result_obj__269 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(self))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__271;
    ...
    __result_obj__271 = (char*)come_increment_ref_count(result);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
struct list$1char$ph* __result_obj__272;
    ...
    __result_obj__272 = (struct list$1char$ph*)come_increment_ref_count(result);
    come_call_finalizer(list$1char$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(buffer_finalize, buf, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    come_call_finalizer(list$1char$ph$p_finalize, __result_obj__272, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
char* __result_obj__273;
    __result_obj__273 = (char*)come_increment_ref_count(((char*)(__right_value0=xsprintf("%ls",wc))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__275;
    ...
    if(    result[string_length(result)-1]==10    ) {
        __right_value0 = (void*)0;
        __result_obj__274 = (char*)come_increment_ref_count(((char*)(__right_value0=charp_substring(result,0,-2))));
...
char* __result_obj__277;
    if(    path==((void*)0)    ) {
        __result_obj__276 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    result2=(char*)come_increment_ref_count(__builtin_string(result));
    free(result);
    __result_obj__277 = (char*)come_increment_ref_count(result2);
    (result2 = come_decrement_ref_count(result2, (void*)0, (void*)0, 0, 1, (void*)0));
...
char* __result_obj__279;
    if(    path==((void*)0)    ) {
        __result_obj__278 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__result_obj__278 = come_decrement_ref_count(__result_obj__278, (void*)0, (void*)0, 0, 1, (void*)0));
        return __result_obj__278;
    }
    __right_value0 = (void*)0;
    __result_obj__279 = (char*)come_increment_ref_count(((char*)(__right_value1=__builtin_string(dirname(((char*)(__right_value0=__builtin_string(path))))))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* wstring_substring(int* str, int head, int tail){
void* __right_value0 = (void*)0;
int* __result_obj__280;
    __result_obj__280 = (int*)come_increment_ref_count(((int*)(__right_value0=wchar_tp_substring(str,head,tail))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__281;
    __result_obj__281 = (char*)come_increment_ref_count(((char*)(__right_value0=charp_strip(self))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__282;
    __result_obj__282 = (char*)come_increment_ref_count(((char*)(__right_value0=wchar_tp_to_string(wstr))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__283;
    __result_obj__283 = (int*)come_increment_ref_count(((int*)(__right_value1=string_to_wstring(((char*)(__right_value0=xsprintf("%d",self)))))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__284;
    __result_obj__284 = (int*)come_increment_ref_count(((int*)(__right_value0=wchar_tp_delete(str,head,tail))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__285;
    __result_obj__285 = (int*)come_increment_ref_count(((int*)(__right_value0=wchar_tp_reverse(str))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__286;
    __result_obj__286 = (int*)come_increment_ref_count(((int*)(__right_value0=wchar_tp_multiply(str,n))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
int* __result_obj__287;
    __result_obj__287 = (int*)come_increment_ref_count(((int*)(__right_value0=wchar_tp_printable(str))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__288;
    __result_obj__288 = (char*)come_increment_ref_count(((char*)(__right_value0=charp_replace(self,index,c))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__289;
    __result_obj__289 = (char*)come_increment_ref_count(((char*)(__right_value0=charp_multiply(str,n))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
struct list$1char$ph* __result_obj__290;
    __result_obj__290 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value0=charp_split_str(self,str))));
    come_call_finalizer(list$1char$ph$p_finalize, __right_value0, (void*)0, (void*)0, 0, 1, 0, (void*)0);
...
int* string_to_wstring(char* str){
void* __right_value0 = (void*)0;
int* __result_obj__291;
    __result_obj__291 = (int*)come_increment_ref_count(((int*)(__right_value0=charp_to_wstring(str))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__292;
    __result_obj__292 = (char*)come_increment_ref_count(((char*)(__right_value0=string_chomp(str))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
char* __result_obj__294;
    if(    f==((void*)0)    ) {
        __result_obj__293 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    __right_value0 = (void*)0;
    __result_obj__294 = (char*)come_increment_ref_count(((char*)(__right_value0=buffer_to_string(buf))));
    come_call_finalizer(buffer_finalize, buf, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
...
struct __sFILE* FILE_fprintf(struct __sFILE* f, const char* msg, ...){
struct __sFILE* __result_obj__295;
va_list args;
int result;
...
char* __result_obj__301;
    if(    file_name==((void*)0)    ) {
        __result_obj__298 = (char*)come_increment_ref_count(((char*)(__right_value0=__builtin_string(""))));
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    __result_obj__301 = (char*)come_increment_ref_count(result);
    come_call_finalizer(buffer_finalize, buf, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    (result = come_decrement_ref_count(result, (void*)0, (void*)0, 0, 1, (void*)0));
...
struct list$1char$ph* __result_obj__303;
    ...
    if(    f==((void*)0)    ) {
        __result_obj__302 = (struct list$1char$ph*)come_increment_ref_count(result);
        come_call_finalizer(list$1char$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0);
        come_call_finalizer(list$1char$ph$p_finalize, __result_obj__302, (void*)0, (void*)0, 0, 0, 1, (void*)0);
...
int socket_fd_write(int self, char* str){
int __result_obj__304;
    __result_obj__304 = write(self,str,string_length(str));
    (str = come_decrement_ref_count(str, (void*)0, (void*)0, 0, 0, (void*)0));
...
memset(&address, 0, sizeof(struct sockaddr_in));
    ...
    if(    sock<0    ) {
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 37, 0),__exception_result_var_b1=die("socket failed"), come_pop_stackframe(), __exception_result_var_b1);
    }
    if(    reuse    ) {
        opt=1;
        if(        setsockopt(sock,0xffff,0x0004,&opt,sizeof(opt))        ) {
            close(sock);
            (come_push_stackframe("/usr/local/include/neo-c-net.h", 44, 1),__exception_result_var_b2=die(((char*)(__right_value0=xsprintf("setsockopt")))), come_pop_stackframe(), __exception_result_var_b2);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        }
    }
    address.sin_family=2;
    address.sin_addr.s_addr=(unsigned int)0x00000000;
    address.sin_port=_OSSwapInt16(port);
    addrlen=sizeof(address);
    if(    bind(sock,(struct sockaddr*)&address,sizeof(address))<0    ) {
        close(sock);
        __right_value0 = (void*)0;
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 58, 2),__exception_result_var_b3=die(((char*)(__right_value0=xsprintf("Unable to bind")))), come_pop_stackframe(), __exception_result_var_b3);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    if(    listen(sock,3)<0    ) {
        close(sock);
        __right_value0 = (void*)0;
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 63, 3),__exception_result_var_b4=die(((char*)(__right_value0=xsprintf("Unable to listen")))), come_pop_stackframe(), __exception_result_var_b4);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
...
_Bool break_;
_Bool break__54;
int __result_obj__306;
memset(&serv_addr, 0, sizeof(struct sockaddr_in));
    sock=0;
    if(    (sock=socket(2,1,0))<0    ) {
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 96, 4),__exception_result_var_b5=die(((char*)(__right_value0=xsprintf("socket")))), come_pop_stackframe(), __exception_result_var_b5);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    serv_addr.sin_family=2;
    serv_addr.sin_port=_OSSwapInt16(port);
    if(    inet_pton(2,address,&serv_addr.sin_addr)<=0    ) {
        close(sock);
        __right_value0 = (void*)0;
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 104, 5),__exception_result_var_b6=die(((char*)(__right_value0=xsprintf("Invalid address/ Address not supported")))), come_pop_stackframe(), __exception_result_var_b6);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    if(    connect(sock,(struct sockaddr*)&serv_addr,sizeof(serv_addr))<0    ) {
        close(sock);
        __right_value0 = (void*)0;
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 108, 6),__exception_result_var_b7=die(((char*)(__right_value0=xsprintf("Connection Failed")))), come_pop_stackframe(), __exception_result_var_b7);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    break_=0;
    while(    1    ) {
        break__54=0;
        block(parent,sock,&break__54);
        if(        break__54        ) {
            break;
        }
    }
...
memset(&serv_addr, 0, sizeof(struct sockaddr_in));
    sock=0;
    if(    (sock=socket(2,1,0))<0    ) {
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 133, 7),__exception_result_var_b8=die(((char*)(__right_value0=xsprintf("Socket creation error")))), come_pop_stackframe(), __exception_result_var_b8);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    serv_addr.sin_family=2;
    serv_addr.sin_port=_OSSwapInt16(port);
    if(    inet_pton(2,address,&serv_addr.sin_addr)<=0    ) {
        close(sock);
        __right_value0 = (void*)0;
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 141, 8),__exception_result_var_b9=die(((char*)(__right_value0=xsprintf("Invalid address/ Address not supported")))), come_pop_stackframe(), __exception_result_var_b9);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    if(    connect(sock,(struct sockaddr*)&serv_addr,sizeof(serv_addr))<0    ) {
        close(sock);
        __right_value0 = (void*)0;
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 145, 9),__exception_result_var_b10=die(((char*)(__right_value0=xsprintf("Connection Failed")))), come_pop_stackframe(), __exception_result_var_b10);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    if(    write(sock,data,strlen(data))<0    ) {
        close(sock);
        __right_value0 = (void*)0;
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 150, 10),__exception_result_var_b11=die(((char*)(__right_value0=xsprintf("Write Failed")))), come_pop_stackframe(), __exception_result_var_b11);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    __right_value0 = (void*)0;
    buf=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/neo-c-net.h", 153, "struct buffer*"))));
    char buf2[1024]={ '\0' };
    size=read(sock,buf2,1024);
    if(    size<0    ) {
        close(sock);
        __right_value0 = (void*)0;
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 161, 11),__exception_result_var_b12=die(((char*)(__right_value0=xsprintf("Read Failed")))), come_pop_stackframe(), __exception_result_var_b12);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    buffer_append(buf,buf2,size);
    close(sock);
    __right_value0 = (void*)0;
    __result_obj__307 = (char*)come_increment_ref_count(((char*)(__right_value0=buffer_to_string(buf))));
    come_call_finalizer(sockaddr_in_finalize, (&serv_addr), (void*)0, (void*)0, 1, 0, 0, (void*)0);
    come_call_finalizer(buffer_finalize, buf, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    (__result_obj__307 = come_decrement_ref_count(__result_obj__307, (void*)0, (void*)0, 0, 1, (void*)0));
...
int new_socket;
_Bool break_;
int __result_obj__308;
memset(&address, 0, sizeof(struct sockaddr_in));
    sock=socket(socket_family,socket_type,protocol);
    if(    sock<0    ) {
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 174, 12),__exception_result_var_b13=die("socket failed"), come_pop_stackframe(), __exception_result_var_b13);
    }
    if(    reuse    ) {
        opt=1;
        if(        setsockopt(sock,0xffff,0x0004,&opt,sizeof(opt))        ) {
            close(sock);
            (come_push_stackframe("/usr/local/include/neo-c-net.h", 181, 13),__exception_result_var_b14=die(((char*)(__right_value0=xsprintf("setsockpt failed")))), come_pop_stackframe(), __exception_result_var_b14);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        }
    }
    address.sin_family=2;
    ...
    if(    bind(sock,(struct sockaddr*)&address,sizeof(address))<0    ) {
        close(sock);
        __right_value0 = (void*)0;
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 195, 14),__exception_result_var_b15=die(((char*)(__right_value0=xsprintf("Unable to bind")))), come_pop_stackframe(), __exception_result_var_b15);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    if(    listen(sock,3)<0    ) {
        close(sock);
        __right_value0 = (void*)0;
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 200, 15),__exception_result_var_b16=die(((char*)(__right_value0=xsprintf("Unable to listen")))), come_pop_stackframe(), __exception_result_var_b16);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    while(    1    ) {
        new_socket=accept(sock,(struct sockaddr*)&address,(unsigned int*)&addrlen);
...
struct sockaddr_in addr_55;
unsigned int len;
int client;
_Bool __exception_result_var_b23;
struct ssl_st* ssl;
_Bool break_;
int __result_obj__309;
memset(&sock, 0, sizeof(int));
ctx = (void*)0;
method = (void*)0;
memset(&addr, 0, sizeof(struct sockaddr_in));
memset(&addr_55, 0, sizeof(struct sockaddr_in));
    OPENSSL_init_ssl(0x00200000L|0x00000002L,((void*)0));
    OPENSSL_init_ssl(0,((void*)0));
    method=TLS_server_method();
    ctx=SSL_CTX_new(method);
    if(    !ctx    ) {
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 246, 16),__exception_result_var_b17=die(((char*)(__right_value0=xsprintf("Unable to create SSL context")))), come_pop_stackframe(), __exception_result_var_b17);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    if(    SSL_CTX_use_certificate_file(ctx,"cert.pem",1)<=0    ) {
        __right_value0 = (void*)0;
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 251, 17),__exception_result_var_b18=die(((char*)(__right_value0=xsprintf("SSL_CTX_use_certificate_file")))), come_pop_stackframe(), __exception_result_var_b18);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    if(    SSL_CTX_use_PrivateKey_file(ctx,"key.pem",1)<=0    ) {
        __right_value0 = (void*)0;
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 256, 18),__exception_result_var_b19=die(((char*)(__right_value0=xsprintf("SSL_CTX_use_PrivateKey_file")))), come_pop_stackframe(), __exception_result_var_b19);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    sock=socket(2,1,0);
    if(    sock<0    ) {
        __right_value0 = (void*)0;
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 261, 19),__exception_result_var_b20=die(((char*)(__right_value0=xsprintf("Unable to create socket")))), come_pop_stackframe(), __exception_result_var_b20);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    addr.sin_family=2;
    addr.sin_port=_OSSwapInt16(port);
    addr.sin_addr.s_addr=(unsigned int)0x00000000;
    if(    bind(sock,(struct sockaddr*)&addr,sizeof(addr))<0    ) {
        __right_value0 = (void*)0;
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 270, 20),__exception_result_var_b21=die(((char*)(__right_value0=xsprintf("Unable to bind")))), come_pop_stackframe(), __exception_result_var_b21);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    if(    listen(sock,1)<0    ) {
        __right_value0 = (void*)0;
        (come_push_stackframe("/usr/local/include/neo-c-net.h", 274, 21),__exception_result_var_b22=die(((char*)(__right_value0=xsprintf("Unable to listen")))), come_pop_stackframe(), __exception_result_var_b22);
        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    }
    while(    1    ) {
        len=sizeof(addr_55);
        client=accept(sock,(struct sockaddr*)&addr_55,&len);
        if(        client<0        ) {
            __right_value0 = (void*)0;
            (come_push_stackframe("/usr/local/include/neo-c-net.h", 283, 22),__exception_result_var_b23=die(((char*)(__right_value0=xsprintf("Unable to accept")))), come_pop_stackframe(), __exception_result_var_b23);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        }
        ssl=SSL_new(ctx);
        ...
        if(        SSL_accept(ssl)<=0        ) {
            ...
            if(            break_            ) {
                come_call_finalizer(sockaddr_in_finalize, (&addr_55), (void*)0, (void*)0, 1, 0, 0, (void*)0);
                break;
            }
        }
        SSL_shutdown(ssl);
...
_Bool __exception_result_var_b24;
    if(    gComeMySQL==((void*)0)    ) {
        ...
        if(        gComeMySQL==((void*)0)        ) {
            (come_push_stackframe("/usr/local/include/neo-c-net.h", 320, 23),__exception_result_var_b24=die(((char*)(__right_value0=xsprintf("mysql_init failed")))), come_pop_stackframe(), __exception_result_var_b24);
            (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        }
    }
    return 0;
...
_Bool __exception_result_var_b25;
    mysql_close(gComeMySQL);
    (come_push_stackframe("/usr/local/include/neo-c-net.h", 338, 24),__exception_result_var_b25=die(((char*)(__right_value1=xsprintf("\%s",((char*)(__right_value0=charp_to_string(mysql_error(gComeMySQL)))))))), come_pop_stackframe(), __exception_result_var_b25);
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
}
...
int __result_obj__310;
    come_mysql_init();
    if(    mysql_real_connect(gComeMySQL,host_name,"root",root_password,((void*)0),0,((void*)0),0)==((void*)0)    ) {
        finish_with_error();
    }
    check_user_query=(char*)come_increment_ref_count(xsprintf("SELECT COUNT(*) FROM mysql.user WHERE user = '\%s' AND host = '\%s'",((char*)(__right_value0=charp_to_string(user))),((char*)(__right_value1=charp_to_string(host_name)))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
    if(    mysql_query(gComeMySQL,check_user_query)==((void*)0)    ) {
        finish_with_error();
    }
    result=mysql_store_result(gComeMySQL);
    if(    result==((void*)0)    ) {
        finish_with_error();
    }
    row=mysql_fetch_row(result);
    user_exists=atoi(row[0]);
    mysql_free_result(result);
    if(    user_exists==0    ) {
        if(        __right_value0 = (void*)0,         __right_value1 = (void*)0,         __right_value2 = (void*)0,         ({(_conditional_value_X0=(mysql_query(gComeMySQL,((char*)(__right_value3=xsprintf("CREATE USER '\%s'@'\%s' IDENTIFIED BY '\%s'",((char*)(__right_value0=charp_to_string(user))),((char*)(__right_value1=charp_to_string(host_name))),((char*)(__right_value2=charp_to_string(password)))))))==((void*)0)));        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
        ...
        if(        __right_value0 = (void*)0,         __right_value1 = (void*)0,         __right_value2 = (void*)0,         ({(_conditional_value_X1=(mysql_query(gComeMySQL,((char*)(__right_value2=xsprintf("GRANT ALL PRIVILEGES ON *.* TO '\%s'@'\%s'",((char*)(__right_value0=charp_to_string(user))),((char*)(__right_value1=charp_to_string(host_name)))))))==((void*)0)));        (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
        (__right_value1 = come_decrement_ref_count(__right_value1, (void*)0, (void*)0, 1, 0, (void*)0));
        (__right_value2 = come_decrement_ref_count(__right_value2, (void*)0, (void*)0, 1, 0, (void*)0));
    ...
    come_mysql_final();
    __result_obj__310 = 0;
    (check_user_query = come_decrement_ref_count(check_user_query, (void*)0, (void*)0, 0, 0, (void*)0));
...
int __result_obj__311;
    ...
    create_db_query=(char*)come_increment_ref_count(xsprintf("CREATE DATABASE IF NOT EXISTS \%s",((char*)(__right_value0=charp_to_string(database_name)))));
    (__right_value0 = come_decrement_ref_count(__right_value0, (void*)0, (void*)0, 1, 0, (void*)0));
    if(    mysql_query(gComeMySQL,create_db_query)==((void*)0)    ) {
        finish_with_error();
    }
    come_mysql_final();
    __result_obj__311 = 0;
    (create_db_query = come_decrement_ref_count(create_db_query, (void*)0, (void*)0, 0, 0, (void*)0));
...
static struct list$1list$1char$ph$ph* list$1list$1char$ph$ph_initialize(struct list$1list$1char$ph$ph* self){
struct list$1list$1char$ph$ph* __result_obj__312;
    self->head=((void*)0);
    self->tail=((void*)0);
    self->len=0;
    __result_obj__312 = (struct list$1list$1char$ph$ph*)come_increment_ref_count(self);
    come_call_finalizer(list$1list$1char$ph$ph$p_finalize, self, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(list$1list$1char$ph$ph$p_finalize, __result_obj__312, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    return __result_obj__312;
}

static void list$1list$1char$ph$ph$p_finalize(struct list$1list$1char$ph$ph* self){
struct list_item$1list$1char$ph$ph* it;
struct list_item$1list$1char$ph$ph* prev_it;
    it=self->head;
    while(    it!=((void*)0)    ) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1list$1char$ph$ph$p_finalize, prev_it, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
}

static void list_item$1list$1char$ph$ph$p_finalize(struct list_item$1list$1char$ph$ph* self){
    if(    self!=((void*)0)&&self->item!=((void*)0)    ) {
        come_call_finalizer(list$1char$ph$p_finalize, self->item, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
}

static struct list$1list$1char$ph$ph* list$1list$1char$ph$ph_add(struct list$1list$1char$ph$ph* self, struct list$1char$ph* item){
void* __right_value0 = (void*)0;
struct list_item$1list$1char$ph$ph* litem;
struct list$1char$ph* __dec_obj19;
struct list_item$1list$1char$ph$ph* litem_56;
struct list$1char$ph* __dec_obj20;
struct list_item$1list$1char$ph$ph* litem_57;
struct list$1char$ph* __dec_obj21;
struct list$1list$1char$ph$ph* __result_obj__313;
    if(    self->len==0    ) {
        litem=(struct list_item$1list$1char$ph$ph*)come_increment_ref_count(((struct list_item$1list$1char$ph$ph*)(__right_value0=(struct list_item$1list$1char$ph$ph*)come_calloc_v2(1, sizeof(struct list_item$1list$1char$ph$ph)*(1), "/usr/local/include/neo-c.h", 6161, "struct list_item$1list$1char$ph$ph*"))));
        litem->prev=((void*)0);
        litem->next=((void*)0);
        __dec_obj19=litem->item,
        litem->item=(struct list$1char$ph*)come_increment_ref_count(item);
        ...
        __right_value0 = (void*)0;
        litem_56=(struct list_item$1list$1char$ph$ph*)come_increment_ref_count(((struct list_item$1list$1char$ph$ph*)(__right_value0=(struct list_item$1list$1char$ph$ph*)come_calloc_v2(1, sizeof(struct list_item$1list$1char$ph$ph)*(1), "/usr/local/include/neo-c.h", 6171, "struct list_item$1list$1char$ph$ph*"))));
        litem_56->prev=self->head;
        litem_56->next=((void*)0);
        __dec_obj20=litem_56->item,
        litem_56->item=(struct list$1char$ph*)come_increment_ref_count(item);
        ...
        __right_value0 = (void*)0;
        litem_57=(struct list_item$1list$1char$ph$ph*)come_increment_ref_count(((struct list_item$1list$1char$ph$ph*)(__right_value0=(struct list_item$1list$1char$ph$ph*)come_calloc_v2(1, sizeof(struct list_item$1list$1char$ph$ph)*(1), "/usr/local/include/neo-c.h", 6181, "struct list_item$1list$1char$ph$ph*"))));
        litem_57->prev=self->tail;
        litem_57->next=((void*)0);
        __dec_obj21=litem_57->item,
        litem_57->item=(struct list$1char$ph*)come_increment_ref_count(item);
    ...
    come_call_finalizer(list$1char$ph$p_finalize, item, (void*)0, (void*)0, 0, 0, 0, (void*)0);
...
struct list$1list$1char$ph$ph* xmysql_query_and_fetch_row(char* query, char* user, char* password, _Bool create_user, _Bool create_database, char* root_password, char* database_name, char* host_name){
struct MYSQL_RES* res;
int num_fields;
void* __right_value0 = (void*)0;
void* __right_value1 = (void*)0;
struct list$1list$1char$ph$ph* result;
char** row;
struct list$1char$ph* li;
int i;
struct list$1list$1char$ph$ph* __result_obj__314;
row = (void*)0;
    if(    create_user    ) {
        create_user_if_not_exists(user,password,root_password,"localhost");
    }
    ...
    res=mysql_store_result(gComeMySQL);
    if(    res    ) {
        finish_with_error();
    }
    num_fields=mysql_num_fields(res);
    result=(struct list$1list$1char$ph$ph*)come_increment_ref_count(list$1list$1char$ph$ph_initialize((struct list$1list$1char$ph$ph*)come_increment_ref_count((struct list$1list$1char$ph$ph*)come_calloc_v2(1, sizeof(struct list$1list$1char$ph$ph)*(1), "/usr/local/include/neo-c-net.h", 442, "struct list$1list$1char$ph$ph*"))));
    while(    (row=mysql_fetch_row(res))!=((void*)0)    ) {
        __right_value0 = (void*)0;
        __right_value1 = (void*)0;
        li=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/neo-c-net.h", 446, "struct list$1char$ph*"))));
        for(        i=0        ;        i<num_fields        ;        i++        ){
            if(            row[i]            ) {
                __right_value0 = (void*)0;
                list$1char$ph_add(li,(char*)come_increment_ref_count(__builtin_string(row[i])));
            }
        }
        list$1list$1char$ph$ph_add(result,(struct list$1char$ph*)come_increment_ref_count(li));
        come_call_finalizer(list$1char$ph$p_finalize, li, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    mysql_free_result(res);
    come_mysql_final();
    __result_obj__314 = (struct list$1list$1char$ph$ph*)come_increment_ref_count(result);
    come_call_finalizer(list$1list$1char$ph$ph$p_finalize, result, (void*)0, (void*)0, 0, 0, 1, (void*)0);
    come_call_finalizer(list$1list$1char$ph$ph$p_finalize, __result_obj__314, (void*)0, (void*)0, 0, 0, 1, (void*)0);
