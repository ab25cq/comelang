...
void* __right_value2 = (void*)0;
    buf_0=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 126, "buffer"))));
...
char* __result23__;
    ...
    len_62=strlen(str)+1;
    result_63=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_62)), "/usr/local/include/comelang.h", 960, "char"));
...
struct buffer* __result24__;
    self->size=128;
    __dec_obj2=self->buf;
    self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3250, "char"));
...
struct buffer* __result25__;
    self->size=128;
    __dec_obj3=self->buf;
    self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3260, "char"));
...
struct buffer* __result27__;
    ...
    result_66=(struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 3280, "buffer"));
    result_66->size=self->size;
    __dec_obj4=result_66->buf;
    result_66->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3283, "char"));
...
struct buffer* __result29__;
    ...
    if(    self->len+size+1+1>=self->size) {
        old_buf_67=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3322, "char"));
        memcpy(old_buf_67,self->buf,self->size);
        old_len_68=self->len;
        new_size_69=(self->size+size+1)*2;
        __dec_obj5=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_69)), "/usr/local/include/comelang.h", 3326, "char"));
...
struct buffer* __result31__;
    ...
    if(    self->len+1+1+1>=self->size) {
        old_buf_70=(char*)come_increment_ref_count((char*)come_memdup(self->buf, "/usr/local/include/comelang.h", 3345, "char*"));
        old_len_71=self->len;
        new_size_72=(self->size+10+1)*2;
        __dec_obj6=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_72)), "/usr/local/include/comelang.h", 3349, "char"));
...
struct buffer* __result33__;
    ...
    if(    self->len+size_73+1+1>=self->size) {
        old_buf_74=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3371, "char"));
        memcpy(old_buf_74,self->buf,self->size);
        old_len_75=self->len;
        new_size_76=(self->size+size_73+1)*2;
        __dec_obj7=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_76)), "/usr/local/include/comelang.h", 3375, "char"));
...
result_78 = (void*)0;
    ...
    if(    self->len+size_81+1+1>=self->size) {
        old_buf_82=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3408, "char"));
        memcpy(old_buf_82,self->buf,self->size);
        old_len_83=self->len;
        new_size_84=(self->size+size_81+1)*2;
        __dec_obj8=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_84)), "/usr/local/include/comelang.h", 3412, "char"));
...
struct buffer* __result38__;
    ...
    if(    self->len+size_85+1+1+1>=self->size) {
        old_buf_86=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3434, "char"));
        memcpy(old_buf_86,self->buf,self->size);
        old_len_87=self->len;
        new_size_88=(self->size+size_85+1)*2;
        __dec_obj9=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_88)), "/usr/local/include/comelang.h", 3438, "char"));
...
struct buffer* __result40__;
    ...
    if(    self->len+size_90+1+1>=self->size) {
        old_buf_91=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3461, "char"));
        memcpy(old_buf_91,self->buf,self->size);
        old_len_92=self->len;
        new_size_93=(self->size+size_90+1)*2;
        __dec_obj10=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_93)), "/usr/local/include/comelang.h", 3465, "char"));
...
struct buffer* __result41__;
    ...
    if(    self->len+size_95+1+1>=self->size) {
        old_buf_96=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3484, "char"));
        memcpy(old_buf_96,self->buf,self->size);
        old_len_97=self->len;
        new_size_98=(self->size+size_95+1)*2;
        __dec_obj11=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_98)), "/usr/local/include/comelang.h", 3488, "char"));
...
struct buffer* __result43__;
    ...
    if(    self->len+size_100+1+1>=self->size) {
        old_buf_101=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3511, "char"));
        memcpy(old_buf_101,self->buf,self->size);
        old_len_102=self->len;
        new_size_103=(self->size+size_100+1)*2;
        __dec_obj12=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_103)), "/usr/local/include/comelang.h", 3515, "char"));
...
struct buffer* __result45__;
    ...
    if(    len_104>=self->size) {
        ...
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_105)), "/usr/local/include/comelang.h", 3539, "char"));
...
struct buffer* __result47__;
    result_107=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 3569, "buffer"))));
    if(    self==((void*)0)) {
...
struct buffer* __result49__;
    result_108=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 3582, "buffer"))));
    if(    self==((void*)0)) {
...
char* __result60__;
    len_117=self->len;
    result_118=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_117*2+1)), "/usr/local/include/comelang.h", 3661, "char"));
    n_119=0;
...
char* __result116__;
    ...
    result_179=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_178+1)), "/usr/local/include/comelang.h", 4348, "char"));
...
char* __result118__;
    ...
    result_181=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_180+1)), "/usr/local/include/comelang.h", 4363, "char"));
...
char* __result120__;
    ...
    buf_182=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 4376, "buffer"))));
...
char* __result122__;
    ...
    buf_184=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 4390, "buffer"))));
...
char* __result128__;
    ...
    len_196=strlen(str);
    result_197=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_196+1)), "/usr/local/include/comelang.h", 4637, "char"));
...
char* __result130__;
    ...
    len_199=strlen(str);
    result_200=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_199+1)), "/usr/local/include/comelang.h", 4654, "char"));
...
char* __result135__;
    ...
    result_203=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "/usr/local/include/comelang.h", 4700, "char"));
...
char* __result140__;
    ...
    result_205=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "/usr/local/include/comelang.h", 4743, "char"));
...
char* __result145__;
    ...
    result_207=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "/usr/local/include/comelang.h", 4786, "char"));
...
char* __result150__;
    ...
    result_209=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "/usr/local/include/comelang.h", 4829, "char"));
...
char* __result157__;
    ...
    result_215=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_214-(tail-head)+1)), "/usr/local/include/comelang.h", 4891, "char"));
...
struct list$1charph* __result165__;
    if(    self==((void*)0)) {
        __result163__ = gComeFunResultObject = __result_obj__ = ((struct list$1charph*)(__right_value202=list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang.h", 4943, "list$1charph")))));
        /*g*/come_call_finalizer3(__right_value202,list$1charphp_finalize, 0, 1, 0, 0, __result_obj__);
        gComeFunResultObject = (void*)0;
        return __result163__;
    }
    result_220=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang.h", 4946, "list$1charph"))));
    str_221=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 4948, "buffer"))));
...
struct list$1charph* __result167__;
    if(    self==((void*)0)) {
        __result166__ = gComeFunResultObject = __result_obj__ = ((struct list$1charph*)(__right_value213=list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang.h", 4969, "list$1charph")))));
        /*g*/come_call_finalizer3(__right_value213,list$1charphp_finalize, 0, 1, 0, 0, __result_obj__);
        gComeFunResultObject = (void*)0;
        return __result166__;
    }
    result_226=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang.h", 4972, "list$1charph"))));
    str_227=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 4974, "buffer"))));
...
char* __result171__;
    ...
    result_230=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_229*2+1)), "/usr/local/include/comelang.h", 5011, "char"));
    n_231=0;
...
char* __result199__;
    ...
    buf_238=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 5336, "buffer"))));
    while(1) {
        char buf2_239[1024];
...
char* __result206__;
    ...
    buf_252=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 5476, "buffer"))));
    while(1) {
        char buf2_253[1024];
...
char* __result210__;
    ...
    buf_258=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 5513, "buffer"))));
    while(1) {
        char buf2_259[1024];
...
struct list$1charph* __result212__;
    result_263=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang.h", 5540, "list$1charph"))));
    if(    f==((void*)0)) {
...
struct come_regex* come_exception_var_c1_292=0;
char* Err_293=0;
...
struct come_regex* come_exception_var_c3_304=0;
char* Err_305=0;
void* __right_value317 = (void*)0;
struct list$1charph* li_303;
...
char* redirect_response_306;
void* __right_value325 = (void*)0;
void* __right_value326 = (void*)0;
char* redirect_response_307;
int __result251__;
    come_heap_init(0, 0, 0);
    input_291=(char*)come_increment_ref_count(FILE_read(__stdinp));
    multiple_assign_var1=((struct tuple2$2come_regexphcharph*)(__right_value308=charp_to_regex("username=(.+)&password=(.+)",0,0,0,0,0,0,0,0)));
    come_exception_var_c1_292=(struct come_regex*)come_increment_ref_count(multiple_assign_var1->v1);
    Err_293=(char*)come_increment_ref_count(multiple_assign_var1->v2);
    ((Err_293)?(puts(Err_293),exit(0)):(0));
    /*g*/come_call_finalizer3(__right_value308,tuple2$2come_regexphcharphp_finalize, 0, 1, 0, 0, (void*)0);
    result_294=(struct list$1charph*)come_increment_ref_count(string_scan(input_291,come_exception_var_c1_292));
    username_298=list$1charphp_operator_load_element(result_294,1);
    password_299=list$1charphp_operator_load_element(result_294,2);
    if(    username_298&&password_299) {
        ((char*)(__right_value310=client_socket2(3336,"CREATE DATABASE testdb","127.0.0.1")));
        /* U11 */__right_value310 = come_decrement_ref_count2(__right_value310, (void*)0, (void*)0, 1, 0, 0, (void*)0);
        ((char*)(__right_value311=client_socket2(3336,"use testdb","127.0.0.1")));
        /* U11 */__right_value311 = come_decrement_ref_count2(__right_value311, (void*)0, (void*)0, 1, 0, 0, (void*)0);
        const char* create_table_query_300="CREATE TABLE IF NOT EXISTS users (id INT AUTO_INCREMENT PRIMARY KEY, username VARCHAR(100) NOT NULL, password VARCHAR(100) NOT NULL)";
        ((char*)(__right_value312=client_socket2(3336,create_table_query_300,"127.0.0.1")));
        /* U11 */__right_value312 = come_decrement_ref_count2(__right_value312, (void*)0, (void*)0, 1, 0, 0, (void*)0);
        query_301=(char*)come_increment_ref_count(xsprintf("SELECT username, password FROM users WHERE username = '\%s'",((char*)(__right_value313=string_to_string(username_298)))));
        /* U11 */__right_value313 = come_decrement_ref_count2(__right_value313, (void*)0, (void*)0, 1, 0, 0, (void*)0);
        read_data_302=(char*)come_increment_ref_count(client_socket2(3336,query_301,"127.0.0.1"));
        multiple_assign_var2=((struct tuple2$2come_regexphcharph*)(__right_value316=charp_to_regex("\n",0,0,0,0,0,0,0,0)));
        come_exception_var_c3_304=(struct come_regex*)come_increment_ref_count(multiple_assign_var2->v1);
        Err_305=(char*)come_increment_ref_count(multiple_assign_var2->v2);
        ((Err_305)?(puts(Err_305),exit(0)):(0));
        /*g*/come_call_finalizer3(__right_value316,tuple2$2come_regexphcharphp_finalize, 0, 1, 0, 0, (void*)0);
        li_303=(struct list$1charph*)come_increment_ref_count(string_scan(read_data_302,come_exception_var_c3_304));
        if(        (_if_conditional1=(list$1charph_length(li_303)==1&&string_operator_equals(((char*)(__right_value318=string_chomp(list$1charphp_operator_load_element(li_303,0)))),""))),        /* U10 */ (__right_value318 = come_decrement_ref_count2(__right_value318, (void*)0, (void*)0, 1, 0, 0, (void*)0)),
        _if_conditional1) {
            ((char*)(__right_value322=client_socket2(3336,((char*)(__right_value321=xsprintf("INSERT INTO users(username, password) VALUES('\%s', '\%s')",((char*)(__right_value319=string_to_string(username_298))),((char*)(__right_value320=string_to_string(password_299)))))),"127.0.0.1")));
            ...
            redirect_response_306=(char*)come_increment_ref_count(xsprintf("HTTP/1.1 302 Found\r\nSet-Cookie: username=\%s;\r\nLocation: /cgi-bin/main.cgi\r\nContent-Length: 0\r\n\r\n",((char*)(__right_value323=string_to_string(username_298)))));
            /* U11 */__right_value323 = come_decrement_ref_count2(__right_value323, (void*)0, (void*)0, 1, 0, 0, (void*)0);
            printf(redirect_response_306);
            /* U13 */redirect_response_306 = come_decrement_ref_count2(redirect_response_306, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        }
        else {
            if(            string_operator_equals(password_299,list$1charphp_operator_load_element(li_303,1))) {
                redirect_response_307=(char*)come_increment_ref_count(xsprintf("HTTP/1.1 302 Found\r\nSet-Cookie: username=\%s;\r\nLocation: /cgi-bin/main.cgi\r\nContent-Length: 0\r\n\r\n",((char*)(__right_value325=string_to_string(username_298)))));
                /* U11 */__right_value325 = come_decrement_ref_count2(__right_value325, (void*)0, (void*)0, 1, 0, 0, (void*)0);
                printf(redirect_response_307);
                /* U13 */redirect_response_307 = come_decrement_ref_count2(redirect_response_307, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            }
            else {
                const char* not_found_308="HTTP/1.1 404 Not Found\r\nContent-Type: text/html\r\n\r\n<html><body><h1>Invalid Password</h1></body></html>";
                puts(not_found_308);
            }
        }
        /* U13 */query_301 = come_decrement_ref_count2(query_301, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        /* U13 */read_data_302 = come_decrement_ref_count2(read_data_302, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(li_303,list$1charphp_finalize, 0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(come_exception_var_c3_304,come_regex_finalize, 0, 0, 0, 0, (void*)0);
        /* U13 */Err_305 = come_decrement_ref_count2(Err_305, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
    else {
        const char* not_found_309="HTTP/1.1 404 Not Found\r\nContent-Type: text/html\r\n\r\n<html><body><h1>404 Not Found</h1></body></html>";
        puts(not_found_309);
    }
    __result251__ = 0;
    /* U13 */input_291 = come_decrement_ref_count2(input_291, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(come_exception_var_c1_292,come_regex_finalize, 0, 0, 0, 0, (void*)0);
    /* U13 */Err_293 = come_decrement_ref_count2(Err_293, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(result_294,list$1charphp_finalize, 0, 0, 0, 0, (void*)0);
    come_heap_final();
    return __result251__;
}

static void tuple2$2come_regexphcharphp_finalize(struct tuple2$2come_regexphcharph* self){
struct come_regex* __dec_obj32;
char* __dec_obj33;
    if(    self!=((void*)0)&&self->v1!=((void*)0)) {
        if(        self->v1==gComeFunResultObject) {
            __dec_obj32=self->v1;
            come_call_finalizer3(__dec_obj32,come_regex_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
...
default_value_297 = (void*)0;
    ...
    while(it_295!=((void*)0)) {
        if(        position==i_296) {
            __result249__ = gComeFunResultObject = __result_obj__ = it_295->item;
            gComeFunResultObject = (void*)0;
    ...
    __result250__ = gComeFunResultObject = __result_obj__ = default_value_297;
    /* U13 */default_value_297 = come_decrement_ref_count2(default_value_297, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
