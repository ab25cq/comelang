...
memset(&address_65, 0, sizeof(struct sockaddr_in));
    if((_and_conditional1=(sock_63=socket(socket_family,socket_type,protocol))),    _and_conditional1 == 0) {
        (come_push_stackframe("libcomelang2-net-gc.c", 15, 0),__exception_result_var_b1=die("socket failed"), come_pop_stackframe(), __exception_result_var_b1);
    }
    if(reuse) {
        opt_64=1;
...
memset(&address_76, 0, sizeof(struct sockaddr_in));
    if((_and_conditional2=(sock_74=socket(socket_family,socket_type,protocol))),    _and_conditional2 == 0) {
        (come_push_stackframe("libcomelang2-net-gc.c", 106, 1),__exception_result_var_b2=die("socket failed"), come_pop_stackframe(), __exception_result_var_b2);
    }
    if(reuse) {
        opt_75=1;
...
row_98 = (void*)0;
    ...
    result_97=list$1list$1charphph_initialize((struct list$1list$1charphph*)come_calloc(1, sizeof(struct list$1list$1charphph)*(1), "libcomelang2-net-gc.c", 371, "list$1list$1charphph"));
    while((row_98=mysql_fetch_row(res_95))!=((void*)0)) {
        li_99=list$1charph_initialize((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang2-net-gc.c", 375, "list$1charph"));
...
struct list$1charph* __result67__;
    if(self->len==0) {
        litem_101=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 151, "list_item$1charph");
        ...
        if(self->len==1) {
            litem_102=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 161, "list_item$1charph");
            ...
            litem_103=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 171, "list_item$1charph");
...
struct list$1list$1charphph* __result68__;
    if(self->len==0) {
        litem_104=(struct list_item$1list$1charphph*)come_calloc(1, sizeof(struct list_item$1list$1charphph)*(1), "./comelang2.h", 151, "list_item$1list$1charphph");
        ...
        if(self->len==1) {
            litem_105=(struct list_item$1list$1charphph*)come_calloc(1, sizeof(struct list_item$1list$1charphph)*(1), "./comelang2.h", 161, "list_item$1list$1charphph");
            ...
            litem_106=(struct list_item$1list$1charphph*)come_calloc(1, sizeof(struct list_item$1list$1charphph)*(1), "./comelang2.h", 171, "list_item$1list$1charphph");
