...
struct map$2charphsVarph* __result121__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value242=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "/usr/local/include/comelang.h", 1370, "char*%"))));
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value243=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(128)), "/usr/local/include/comelang.h", 1371, "sVar*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value244=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "/usr/local/include/comelang.h", 1372, "bool"))));
...
default_value_178 = (void*)0;
    ...
    keys_169=(char**)come_increment_ref_count(((char**)(__right_value250=(char**)come_calloc(1, sizeof(char*)*(1*(size_168)), "/usr/local/include/comelang.h", 1621, "char*%"))));
    items_170=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value251=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_168)), "/usr/local/include/comelang.h", 1622, "sVar*%"))));
    item_existance_171=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value252=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_168)), "/usr/local/include/comelang.h", 1623, "bool"))));
    len_172=0;
