...
struct list$1CVALUE$ph* __result_obj__201;
    if(    self->len==0) {
        litem_310=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value264=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./comelang.h", 1113, "struct list_item$1CVALUE$ph*"))));
        ...
        litem_311=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value265=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./comelang.h", 1123, "struct list_item$1CVALUE$ph*"))));
        ...
        litem_312=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value266=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./comelang.h", 1133, "struct list_item$1CVALUE$ph*"))));
...
default_value_354 = (void*)0;
    ...
    result_348=(struct map$2char$phsVar$ph*)come_increment_ref_count(map$2char$phsVar$ph_initialize((struct map$2char$phsVar$ph*)come_increment_ref_count((struct map$2char$phsVar$ph*)come_calloc_v2(1, sizeof(struct map$2char$phsVar$ph)*(1), "./comelang.h", 1999, "struct map$2char$phsVar$ph*"))));
    __dec_obj84=result_348->key_list,
    result_348->key_list=(struct list$1char$p*)come_increment_ref_count(list$1char$p_initialize((struct list$1char$p*)come_increment_ref_count((struct list$1char$p*)come_calloc_v2(1, sizeof(struct list$1char$p)*(1), "./comelang.h", 2001, "struct list$1char$p*"))));
    ...
    for(    it_351=map$2char$phsVar$ph_begin(self);    !map$2char$phsVar$ph_end(self);    it_351=map$2char$phsVar$ph_next(self)    ){
        ...
        if(        1&&1) {
            map$2char$phsVar$ph_put(result_348,(char*)come_increment_ref_count((char*)come_memdup(it_351, "./comelang.h", 2010, "char*")),(struct sVar*)come_increment_ref_count(sVar_clone(it2_357)));
        }
        else if(        1) {
            map$2char$phsVar$ph_put(result_348,(char*)come_increment_ref_count((char*)come_memdup(it_351, "./comelang.h", 2013, "char*")),(struct sVar*)come_increment_ref_count(sVar_clone(it2_357)));
        }
        else if(        1) {
...
struct map$2char$phsVar$ph* __result_obj__239;
    ...
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value345=(struct sVar**)come_calloc_v2(1, sizeof(struct sVar*)*(1*(128)), "./comelang.h", 1929, "struct sVar**"))));
...
default_value_368 = (void*)0;
    ...
    keys_359=(char**)come_increment_ref_count(((char**)(__right_value353=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size_358)), "./comelang.h", 2167, "char**"))));
    items_360=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value354=(struct sVar**)come_calloc_v2(1, sizeof(struct sVar*)*(1*(size_358)), "./comelang.h", 2168, "struct sVar**"))));
    item_existance_361=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value355=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(size_358)), "./comelang.h", 2169, "_Bool*"))));
    len_362=0;
