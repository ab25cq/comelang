...
default_value_164 = (void*)0;
    ...
    result_158=(struct map$2charphsVarph*)come_increment_ref_count(map$2charphsVarph_initialize((struct map$2charphsVarph*)come_increment_ref_count((struct map$2charphsVarph*)come_calloc(1, sizeof(struct map$2charphsVarph)*(1), "./comelang.h", 1463, "map$2charphsVarph"))));
    __dec_obj141=result_158->key_list;
    result_158->key_list=(struct list$1charp*)come_increment_ref_count(list$1charp_initialize((struct list$1charp*)come_increment_ref_count((struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "./comelang.h", 1465, "list$1charp"))));
...
struct map$2charphsVarph* __result121__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value242=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 1369, "char*%"))));
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value243=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(128)), "./comelang.h", 1370, "sVar*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value244=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 1371, "bool"))));
...
default_value_178 = (void*)0;
    ...
    keys_169=(char**)come_increment_ref_count(((char**)(__right_value250=(char**)come_calloc(1, sizeof(char*)*(1*(size_168)), "./comelang.h", 1620, "char*%"))));
    items_170=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value251=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_168)), "./comelang.h", 1621, "sVar*%"))));
    item_existance_171=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value252=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_168)), "./comelang.h", 1622, "bool"))));
    len_172=0;
