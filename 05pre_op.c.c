...
struct list$1CVALUE$ph* __result_obj__23;
    if(    self->len==0    ) {
        litem_48=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value56=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./comelang.h", 1115, "struct list_item$1CVALUE$ph*"))));
        ...
        litem_49=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value57=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./comelang.h", 1125, "struct list_item$1CVALUE$ph*"))));
        ...
        litem_50=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value58=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./comelang.h", 1135, "struct list_item$1CVALUE$ph*"))));
...
default_value_94 = (void*)0;
    ...
    result_88=(struct map$2char$phsVar$ph*)come_increment_ref_count(map$2char$phsVar$ph_initialize((struct map$2char$phsVar$ph*)come_increment_ref_count((struct map$2char$phsVar$ph*)come_calloc_v2(1, sizeof(struct map$2char$phsVar$ph)*(1), "./comelang.h", 2013, "struct map$2char$phsVar$ph*"))));
    __dec_obj66=result_88->key_list,
    result_88->key_list=(struct list$1char$p*)come_increment_ref_count(list$1char$p_initialize((struct list$1char$p*)come_increment_ref_count((struct list$1char$p*)come_calloc_v2(1, sizeof(struct list$1char$p)*(1), "./comelang.h", 2015, "struct list$1char$p*"))));
    ...
    for(    it_91=map$2char$phsVar$ph_begin(self)    ;    !map$2char$phsVar$ph_end(self)    ;    it_91=map$2char$phsVar$ph_next(self)    ){
        ...
        if(        1&&1        ) {
            map$2char$phsVar$ph_put(result_88,(char*)come_increment_ref_count((char*)come_memdup(it_91, "./comelang.h", 2024, "char*")),(struct sVar*)come_increment_ref_count(sVar_clone(it2_97)));
        }
        else if(        1        ) {
            map$2char$phsVar$ph_put(result_88,(char*)come_increment_ref_count((char*)come_memdup(it_91, "./comelang.h", 2027, "char*")),(struct sVar*)come_increment_ref_count(sVar_clone(it2_97)));
        }
        else if(        1        ) {
...
struct map$2char$phsVar$ph* __result_obj__61;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value136=(char**)come_calloc_v2(1, sizeof(char*)*(1*(128)), "./comelang.h", 1942, "char**"))));
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value137=(struct sVar**)come_calloc_v2(1, sizeof(struct sVar*)*(1*(128)), "./comelang.h", 1943, "struct sVar**"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value138=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 1944, "_Bool*"))));
...
default_value_108 = (void*)0;
    ...
    keys_99=(char**)come_increment_ref_count(((char**)(__right_value145=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size_98)), "./comelang.h", 2181, "char**"))));
    items_100=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value146=(struct sVar**)come_calloc_v2(1, sizeof(struct sVar*)*(1*(size_98)), "./comelang.h", 2182, "struct sVar**"))));
    item_existance_101=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value147=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(size_98)), "./comelang.h", 2183, "_Bool*"))));
    len_102=0;
...
struct list$1char$ph* __result_obj__82;
    if(    self->len==0    ) {
        litem_133=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value150=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "./comelang.h", 1115, "struct list_item$1char$ph*"))));
        ...
        litem_134=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value151=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "./comelang.h", 1125, "struct list_item$1char$ph*"))));
        ...
        litem_135=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value152=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "./comelang.h", 1135, "struct list_item$1char$ph*"))));
