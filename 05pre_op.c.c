...
left_value2_294 = (void*)0;
    ...
    if(    operator_fun_269) {
        ...
        if(        type3_301->mHeap) {
            append_object_to_right_values2(come_value_293,(struct sType*)come_increment_ref_count(type3_301),info,(_Bool)0,((void*)0),((void*)0));
        }
...
struct list$1CVALUE$ph* __result_obj__190;
    if(    self->len==0) {
        litem_302=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value259=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "/usr/local/include/comelang.h", 1111, "struct list_item$1CVALUE$ph*"))));
        ...
        litem_303=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value260=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "/usr/local/include/comelang.h", 1121, "struct list_item$1CVALUE$ph*"))));
        ...
        litem_304=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value261=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "/usr/local/include/comelang.h", 1131, "struct list_item$1CVALUE$ph*"))));
...
default_value_349 = (void*)0;
    ...
    result_343=(struct map$2char$phsVar$ph*)come_increment_ref_count(map$2char$phsVar$ph_initialize((struct map$2char$phsVar$ph*)come_increment_ref_count((struct map$2char$phsVar$ph*)come_calloc_v2(1, sizeof(struct map$2char$phsVar$ph)*(1), "/usr/local/include/comelang.h", 1997, "struct map$2char$phsVar$ph*"))));
    __dec_obj84=result_343->key_list,
    result_343->key_list=(struct list$1char$p*)come_increment_ref_count(list$1char$p_initialize((struct list$1char$p*)come_increment_ref_count((struct list$1char$p*)come_calloc_v2(1, sizeof(struct list$1char$p)*(1), "/usr/local/include/comelang.h", 1999, "struct list$1char$p*"))));
    ...
    for(    it_346=map$2char$phsVar$ph_begin(self);    !map$2char$phsVar$ph_end(self);    it_346=map$2char$phsVar$ph_next(self)    ){
        ...
        if(        1&&1) {
            map$2char$phsVar$ph_put(result_343,(char*)come_increment_ref_count((char*)come_memdup(it_346, "/usr/local/include/comelang.h", 2008, "char*")),(struct sVar*)come_increment_ref_count(sVar_clone(it2_352)));
        }
        else if(        1) {
            map$2char$phsVar$ph_put(result_343,(char*)come_increment_ref_count((char*)come_memdup(it_346, "/usr/local/include/comelang.h", 2011, "char*")),(struct sVar*)come_increment_ref_count(sVar_clone(it2_352)));
        }
        else if(        1) {
...
struct map$2char$phsVar$ph* __result_obj__230;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value343=(char**)come_calloc_v2(1, sizeof(char*)*(1*(128)), "/usr/local/include/comelang.h", 1926, "char**"))));
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value344=(struct sVar**)come_calloc_v2(1, sizeof(struct sVar*)*(1*(128)), "/usr/local/include/comelang.h", 1927, "struct sVar**"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value345=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(128)), "/usr/local/include/comelang.h", 1928, "_Bool*"))));
...
default_value_363 = (void*)0;
    ...
    keys_354=(char**)come_increment_ref_count(((char**)(__right_value352=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size_353)), "/usr/local/include/comelang.h", 2165, "char**"))));
    items_355=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value353=(struct sVar**)come_calloc_v2(1, sizeof(struct sVar*)*(1*(size_353)), "/usr/local/include/comelang.h", 2166, "struct sVar**"))));
    item_existance_356=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value354=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(size_353)), "/usr/local/include/comelang.h", 2167, "_Bool*"))));
    len_357=0;
