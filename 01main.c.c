...
char* __result44__;
    ...
    result_101=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_100)), "/usr/local/include/comelang.h", 1243, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
struct buffer* __result45__;
    self->size=128;
    __dec_obj1=self->buf;
    self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3548, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
struct buffer* __result46__;
    self->size=128;
    __dec_obj2=self->buf;
    self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3558, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
struct buffer* __result48__;
    ...
    result_104->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3581, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
struct buffer* __result50__;
    ...
    if(    self->len+size+1+1>=self->size) {
        old_buf_105=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3620, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
        memcpy(old_buf_105,self->buf,self->size);
        old_len_106=self->len;
        new_size_107=(self->size+size+1)*2;
        __dec_obj4=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_107)), "/usr/local/include/comelang.h", 3624, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
struct buffer* __result52__;
    ...
    if(    self->len+1+1+1>=self->size) {
        ...
        __dec_obj5=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_110)), "/usr/local/include/comelang.h", 3647, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
struct buffer* __result54__;
    ...
    if(    self->len+size_111+1+1>=self->size) {
        old_buf_112=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3669, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
        memcpy(old_buf_112,self->buf,self->size);
        old_len_113=self->len;
        new_size_114=(self->size+size_111+1)*2;
        __dec_obj6=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_114)), "/usr/local/include/comelang.h", 3673, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
result_116 = (void*)0;
    ...
    if(    self->len+size_119+1+1>=self->size) {
        old_buf_120=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3706, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
        memcpy(old_buf_120,self->buf,self->size);
        old_len_121=self->len;
        new_size_122=(self->size+size_119+1)*2;
        __dec_obj7=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_122)), "/usr/local/include/comelang.h", 3710, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
struct buffer* __result59__;
    ...
    if(    self->len+size_123+1+1+1>=self->size) {
        old_buf_124=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3732, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
        memcpy(old_buf_124,self->buf,self->size);
        old_len_125=self->len;
        new_size_126=(self->size+size_123+1)*2;
        __dec_obj8=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_126)), "/usr/local/include/comelang.h", 3736, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
struct buffer* __result61__;
    ...
    if(    self->len+size_128+1+1>=self->size) {
        old_buf_129=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3759, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
        memcpy(old_buf_129,self->buf,self->size);
        old_len_130=self->len;
        new_size_131=(self->size+size_128+1)*2;
        __dec_obj9=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_131)), "/usr/local/include/comelang.h", 3763, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
struct buffer* __result62__;
    ...
    if(    self->len+size_133+1+1>=self->size) {
        old_buf_134=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3782, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
        memcpy(old_buf_134,self->buf,self->size);
        old_len_135=self->len;
        new_size_136=(self->size+size_133+1)*2;
        __dec_obj10=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_136)), "/usr/local/include/comelang.h", 3786, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
struct buffer* __result64__;
    ...
    if(    self->len+size_138+1+1>=self->size) {
        old_buf_139=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3809, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
        memcpy(old_buf_139,self->buf,self->size);
        old_len_140=self->len;
        new_size_141=(self->size+size_138+1)*2;
        __dec_obj11=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_141)), "/usr/local/include/comelang.h", 3813, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
struct buffer* __result66__;
    ...
    if(    len_142>=self->size) {
        ...
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_143)), "/usr/local/include/comelang.h", 3837, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
char* __result79__;
    len_154=self->len;
    result_155=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_154*2+1)), "/usr/local/include/comelang.h", 3946, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
    n_156=0;
...
char* __result135__;
    ...
    result_216=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_215+1)), "/usr/local/include/comelang.h", 4647, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
char* __result137__;
    ...
    result_218=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_217+1)), "/usr/local/include/comelang.h", 4662, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
char* __result147__;
    ...
    len_233=strlen(str);
    result_234=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_233+1)), "/usr/local/include/comelang.h", 4963, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
char* __result152__;
    ...
    result_237=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "/usr/local/include/comelang.h", 5009, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
char* __result157__;
    ...
    result_239=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "/usr/local/include/comelang.h", 5052, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
char* __result162__;
    ...
    result_241=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "/usr/local/include/comelang.h", 5095, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
char* __result169__;
    ...
    result_247=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_246-(tail-head)+1)), "/usr/local/include/comelang.h", 5157, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
...
struct list$1charph* __result173__;
    if(    self==((void*)0)) {
        __result171__ = gComeFunResultObject = __result_obj__ = ((struct list$1charph*)(__right_value187=list$1charphp_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang.h", 5170, "struct list$1charph*", (void*)0, (void*)0, (void*)0, (void*)0)))));
        come_call_finalizer3(__right_value187,list$1charphp_finalize, 0, 1, 0, 0, __result_obj__);
        gComeFunResultObject = (void*)0;
        return __result171__;
    }
    result_250=(struct list$1charph*)come_increment_ref_count(list$1charphp_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang.h", 5173, "struct list$1charph*", (void*)0, (void*)0, (void*)0, (void*)0))));
    str_251=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 5175, "struct buffer*", (void*)0, (void*)0, (void*)0, (void*)0))));
...
char* __result176__;
    ...
    result_257=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_256*2+1)), "/usr/local/include/comelang.h", 5207, "char", (void*)0, charp_clone, charp_get_hash_key, charp_equals));
    n_258=0;
...
char* __result178__;
    ...
    result_261=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 5235, "struct buffer*", (void*)0, (void*)0, (void*)0, (void*)0))));
    p_262=self;
    while((_Bool)1) {
...
char* __result205__;
    ...
    buf_268=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 5571, "struct buffer*", (void*)0, (void*)0, (void*)0, (void*)0))));
    while(1) {
        char buf2_269[1024];
...
char* __result212__;
    ...
    buf_279=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 5679, "struct buffer*", (void*)0, (void*)0, (void*)0, (void*)0))));
    while(1) {
        char buf2_280[1024];
...
struct list$1charph* __result214__;
    result_284=(struct list$1charph*)come_increment_ref_count(list$1charphp_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang.h", 5706, "struct list$1charph*", (void*)0, (void*)0, (void*)0, (void*)0))));
    if(    f==((void*)0)) {
