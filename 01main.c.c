...
void* __right_value2 = (void*)0;
    buf_0=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./comelang.h", 709, "struct buffer*"))));
...
char* __result_obj__20;
    ...
    len_56=strlen(str)+1;
    result_57=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len_56)), "./comelang.h", 1385, "char*"));
...
struct buffer* __result_obj__23;
    self->size=128;
    __dec_obj1=self->buf,
    self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "./comelang.h", 3339, "char*"));
...
struct buffer* __result_obj__24;
    self->size=128;
    __dec_obj2=self->buf,
    self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "./comelang.h", 3349, "char*"));
...
struct buffer* __result_obj__26;
    ...
    result_58=(struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./comelang.h", 3369, "struct buffer*"));
    result_58->size=self->size;
    __dec_obj3=result_58->buf,
    result_58->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "./comelang.h", 3372, "char*"));
...
struct buffer* __result_obj__29;
    ...
    if(    self->len+size+1+1>=self->size    ) {
        old_buf_59=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "./comelang.h", 3420, "char*"));
        memcpy(old_buf_59,self->buf,self->size);
        old_len_60=self->len;
        new_size_61=(self->size+size+1)*2;
        __dec_obj4=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size_61)), "./comelang.h", 3424, "char*"));
...
struct buffer* __result_obj__31;
    ...
    if(    self->len+1+1+1>=self->size    ) {
        old_buf_62=(char*)come_increment_ref_count((char*)come_memdup(self->buf, "./comelang.h", 3443, "char*"));
        old_len_63=self->len;
        new_size_64=(self->size+10+1)*2;
        __dec_obj5=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size_64)), "./comelang.h", 3447, "char*"));
...
struct buffer* __result_obj__33;
    ...
    if(    self->len+size_65+1+1>=self->size    ) {
        old_buf_66=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "./comelang.h", 3469, "char*"));
        memcpy(old_buf_66,self->buf,self->size);
        old_len_67=self->len;
        new_size_68=(self->size+size_65+1)*2;
        __dec_obj6=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size_68)), "./comelang.h", 3473, "char*"));
...
result_70 = (void*)0;
    ...
    if(    self->len+size_73+1+1>=self->size    ) {
        old_buf_74=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "./comelang.h", 3506, "char*"));
        memcpy(old_buf_74,self->buf,self->size);
        old_len_75=self->len;
        new_size_76=(self->size+size_73+1)*2;
        __dec_obj7=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size_76)), "./comelang.h", 3510, "char*"));
...
struct buffer* __result_obj__38;
    ...
    if(    self->len+size_77+1+1+1>=self->size    ) {
        old_buf_78=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "./comelang.h", 3532, "char*"));
        memcpy(old_buf_78,self->buf,self->size);
        old_len_79=self->len;
        new_size_80=(self->size+size_77+1)*2;
        __dec_obj8=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size_80)), "./comelang.h", 3536, "char*"));
...
struct buffer* __result_obj__40;
    ...
    if(    self->len+size_82+1+1>=self->size    ) {
        old_buf_83=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "./comelang.h", 3559, "char*"));
        memcpy(old_buf_83,self->buf,self->size);
        old_len_84=self->len;
        new_size_85=(self->size+size_82+1)*2;
        __dec_obj9=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size_85)), "./comelang.h", 3563, "char*"));
...
struct buffer* __result_obj__41;
    ...
    if(    self->len+size_87+1+1>=self->size    ) {
        old_buf_88=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "./comelang.h", 3582, "char*"));
        memcpy(old_buf_88,self->buf,self->size);
        old_len_89=self->len;
        new_size_90=(self->size+size_87+1)*2;
        __dec_obj10=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size_90)), "./comelang.h", 3586, "char*"));
...
struct buffer* __result_obj__43;
    ...
    if(    self->len+size_92+1+1>=self->size    ) {
        old_buf_93=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "./comelang.h", 3609, "char*"));
        memcpy(old_buf_93,self->buf,self->size);
        old_len_94=self->len;
        new_size_95=(self->size+size_92+1)*2;
        __dec_obj11=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size_95)), "./comelang.h", 3613, "char*"));
...
struct buffer* __result_obj__45;
    ...
    if(    len_96>=self->size    ) {
        ...
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size_97)), "./comelang.h", 3637, "char*"));
...
struct buffer* __result_obj__47;
    result_99=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./comelang.h", 3667, "struct buffer*"))));
    if(    self==((void*)0)    ) {
...
struct buffer* __result_obj__51;
    result_100=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./comelang.h", 3694, "struct buffer*"))));
...
struct buffer* __result_obj__52;
    result_101=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./comelang.h", 3701, "struct buffer*"))));
...
struct buffer* __result_obj__53;
    result_103=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./comelang.h", 3710, "struct buffer*"))));
...
struct buffer* __result_obj__54;
    result_104=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./comelang.h", 3717, "struct buffer*"))));
...
struct buffer* __result_obj__55;
    result_105=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./comelang.h", 3724, "struct buffer*"))));
...
struct buffer* __result_obj__56;
    result_106=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./comelang.h", 3731, "struct buffer*"))));
...
struct buffer* __result_obj__57;
    result_107=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./comelang.h", 3738, "struct buffer*"))));
...
char* __result_obj__58;
    len_108=self->len;
    result_109=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len_108*2+1)), "./comelang.h", 3746, "char*"));
    n_110=0;
...
struct list$1char$* __result_obj__59;
    if(    self->len==0    ) {
        litem_114=(struct list_item$1char$*)come_increment_ref_count(((struct list_item$1char$*)(__right_value50=(struct list_item$1char$*)come_calloc_v2(1, sizeof(struct list_item$1char$)*(1), "./comelang.h", 1568, "struct list_item$1char$*"))));
        ...
        litem_115=(struct list_item$1char$*)come_increment_ref_count(((struct list_item$1char$*)(__right_value51=(struct list_item$1char$*)come_calloc_v2(1, sizeof(struct list_item$1char$)*(1), "./comelang.h", 1578, "struct list_item$1char$*"))));
        ...
        litem_116=(struct list_item$1char$*)come_increment_ref_count(((struct list_item$1char$*)(__right_value52=(struct list_item$1char$*)come_calloc_v2(1, sizeof(struct list_item$1char$)*(1), "./comelang.h", 1588, "struct list_item$1char$*"))));
...
struct list$1char$* __result_obj__61;
    __result_obj__61 = (struct list$1char$*)come_increment_ref_count(((struct list$1char$*)(__right_value53=list$1char$_initialize_with_values((struct list$1char$*)come_increment_ref_count((struct list$1char$*)come_calloc_v2(1, sizeof(struct list$1char$)*(1), "./comelang.h", 3787, "struct list$1char$*")),len,self))));
...
struct list$1char$p* __result_obj__62;
    if(    self->len==0    ) {
        litem_120=(struct list_item$1char$p*)come_increment_ref_count(((struct list_item$1char$p*)(__right_value55=(struct list_item$1char$p*)come_calloc_v2(1, sizeof(struct list_item$1char$p)*(1), "./comelang.h", 1568, "struct list_item$1char$p*"))));
        ...
        litem_121=(struct list_item$1char$p*)come_increment_ref_count(((struct list_item$1char$p*)(__right_value56=(struct list_item$1char$p*)come_calloc_v2(1, sizeof(struct list_item$1char$p)*(1), "./comelang.h", 1578, "struct list_item$1char$p*"))));
        ...
        litem_122=(struct list_item$1char$p*)come_increment_ref_count(((struct list_item$1char$p*)(__right_value57=(struct list_item$1char$p*)come_calloc_v2(1, sizeof(struct list_item$1char$p)*(1), "./comelang.h", 1588, "struct list_item$1char$p*"))));
...
struct list$1char$p* __result_obj__64;
    __result_obj__64 = (struct list$1char$p*)come_increment_ref_count(((struct list$1char$p*)(__right_value58=list$1char$p_initialize_with_values((struct list$1char$p*)come_increment_ref_count((struct list$1char$p*)come_calloc_v2(1, sizeof(struct list$1char$p)*(1), "./comelang.h", 3792, "struct list$1char$p*")),len,self))));
...
struct list$1short$* __result_obj__65;
    if(    self->len==0    ) {
        litem_126=(struct list_item$1short$*)come_increment_ref_count(((struct list_item$1short$*)(__right_value60=(struct list_item$1short$*)come_calloc_v2(1, sizeof(struct list_item$1short$)*(1), "./comelang.h", 1568, "struct list_item$1short$*"))));
        ...
        litem_127=(struct list_item$1short$*)come_increment_ref_count(((struct list_item$1short$*)(__right_value61=(struct list_item$1short$*)come_calloc_v2(1, sizeof(struct list_item$1short$)*(1), "./comelang.h", 1578, "struct list_item$1short$*"))));
        ...
        litem_128=(struct list_item$1short$*)come_increment_ref_count(((struct list_item$1short$*)(__right_value62=(struct list_item$1short$*)come_calloc_v2(1, sizeof(struct list_item$1short$)*(1), "./comelang.h", 1588, "struct list_item$1short$*"))));
...
struct list$1short$* __result_obj__67;
    __result_obj__67 = (struct list$1short$*)come_increment_ref_count(((struct list$1short$*)(__right_value63=list$1short$_initialize_with_values((struct list$1short$*)come_increment_ref_count((struct list$1short$*)come_calloc_v2(1, sizeof(struct list$1short$)*(1), "./comelang.h", 3797, "struct list$1short$*")),len,self))));
...
struct list$1int$* __result_obj__68;
    if(    self->len==0    ) {
        litem_132=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value65=(struct list_item$1int$*)come_calloc_v2(1, sizeof(struct list_item$1int$)*(1), "./comelang.h", 1568, "struct list_item$1int$*"))));
        ...
        litem_133=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value66=(struct list_item$1int$*)come_calloc_v2(1, sizeof(struct list_item$1int$)*(1), "./comelang.h", 1578, "struct list_item$1int$*"))));
        ...
        litem_134=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value67=(struct list_item$1int$*)come_calloc_v2(1, sizeof(struct list_item$1int$)*(1), "./comelang.h", 1588, "struct list_item$1int$*"))));
...
struct list$1int$* __result_obj__70;
    __result_obj__70 = (struct list$1int$*)come_increment_ref_count(((struct list$1int$*)(__right_value68=list$1int$_initialize_with_values((struct list$1int$*)come_increment_ref_count((struct list$1int$*)come_calloc_v2(1, sizeof(struct list$1int$)*(1), "./comelang.h", 3802, "struct list$1int$*")),len,self))));
...
struct list$1long$* __result_obj__71;
    if(    self->len==0    ) {
        litem_138=(struct list_item$1long$*)come_increment_ref_count(((struct list_item$1long$*)(__right_value70=(struct list_item$1long$*)come_calloc_v2(1, sizeof(struct list_item$1long$)*(1), "./comelang.h", 1568, "struct list_item$1long$*"))));
        ...
        litem_139=(struct list_item$1long$*)come_increment_ref_count(((struct list_item$1long$*)(__right_value71=(struct list_item$1long$*)come_calloc_v2(1, sizeof(struct list_item$1long$)*(1), "./comelang.h", 1578, "struct list_item$1long$*"))));
        ...
        litem_140=(struct list_item$1long$*)come_increment_ref_count(((struct list_item$1long$*)(__right_value72=(struct list_item$1long$*)come_calloc_v2(1, sizeof(struct list_item$1long$)*(1), "./comelang.h", 1588, "struct list_item$1long$*"))));
...
struct list$1long$* __result_obj__73;
    __result_obj__73 = (struct list$1long$*)come_increment_ref_count(((struct list$1long$*)(__right_value73=list$1long$_initialize_with_values((struct list$1long$*)come_increment_ref_count((struct list$1long$*)come_calloc_v2(1, sizeof(struct list$1long$)*(1), "./comelang.h", 3807, "struct list$1long$*")),len,self))));
...
struct list$1float$* __result_obj__74;
    if(    self->len==0    ) {
        litem_144=(struct list_item$1float$*)come_increment_ref_count(((struct list_item$1float$*)(__right_value75=(struct list_item$1float$*)come_calloc_v2(1, sizeof(struct list_item$1float$)*(1), "./comelang.h", 1568, "struct list_item$1float$*"))));
        ...
        litem_145=(struct list_item$1float$*)come_increment_ref_count(((struct list_item$1float$*)(__right_value76=(struct list_item$1float$*)come_calloc_v2(1, sizeof(struct list_item$1float$)*(1), "./comelang.h", 1578, "struct list_item$1float$*"))));
        ...
        litem_146=(struct list_item$1float$*)come_increment_ref_count(((struct list_item$1float$*)(__right_value77=(struct list_item$1float$*)come_calloc_v2(1, sizeof(struct list_item$1float$)*(1), "./comelang.h", 1588, "struct list_item$1float$*"))));
...
struct list$1float$* __result_obj__76;
    __result_obj__76 = (struct list$1float$*)come_increment_ref_count(((struct list$1float$*)(__right_value78=list$1float$_initialize_with_values((struct list$1float$*)come_increment_ref_count((struct list$1float$*)come_calloc_v2(1, sizeof(struct list$1float$)*(1), "./comelang.h", 3812, "struct list$1float$*")),len,self))));
...
struct list$1double$* __result_obj__77;
    if(    self->len==0    ) {
        litem_150=(struct list_item$1double$*)come_increment_ref_count(((struct list_item$1double$*)(__right_value80=(struct list_item$1double$*)come_calloc_v2(1, sizeof(struct list_item$1double$)*(1), "./comelang.h", 1568, "struct list_item$1double$*"))));
        ...
        litem_151=(struct list_item$1double$*)come_increment_ref_count(((struct list_item$1double$*)(__right_value81=(struct list_item$1double$*)come_calloc_v2(1, sizeof(struct list_item$1double$)*(1), "./comelang.h", 1578, "struct list_item$1double$*"))));
        ...
        litem_152=(struct list_item$1double$*)come_increment_ref_count(((struct list_item$1double$*)(__right_value82=(struct list_item$1double$*)come_calloc_v2(1, sizeof(struct list_item$1double$)*(1), "./comelang.h", 1588, "struct list_item$1double$*"))));
...
struct list$1double$* __result_obj__79;
    __result_obj__79 = (struct list$1double$*)come_increment_ref_count(((struct list$1double$*)(__right_value83=list$1double$_initialize_with_values((struct list$1double$*)come_increment_ref_count((struct list$1double$*)come_calloc_v2(1, sizeof(struct list$1double$)*(1), "./comelang.h", 3817, "struct list$1double$*")),len,self))));
...
char* __result_obj__81;
    ...
    result_156=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len_155+1)), "./comelang.h", 4046, "char*"));
...
char* __result_obj__83;
    ...
    result_158=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len_157+1)), "./comelang.h", 4061, "char*"));
...
char* __result_obj__85;
    ...
    buf_159=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./comelang.h", 4074, "struct buffer*"))));
...
char* __result_obj__87;
    ...
    buf_161=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./comelang.h", 4088, "struct buffer*"))));
...
char* __result_obj__89;
    ...
    len_173=strlen(str);
    result_174=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len_173+1)), "./comelang.h", 4356, "char*"));
...
char* __result_obj__94;
    ...
    result_177=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(tail-head+1)), "./comelang.h", 4402, "char*"));
...
char* __result_obj__99;
    ...
    result_179=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(tail-head+1)), "./comelang.h", 4445, "char*"));
...
char* __result_obj__104;
    ...
    result_181=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(tail-head+1)), "./comelang.h", 4488, "char*"));
...
char* __result_obj__111;
    ...
    result_187=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len_186-(tail-head)+1)), "./comelang.h", 4550, "char*"));
...
struct list$1char$ph* __result_obj__114;
    if(    self->len==0    ) {
        litem_193=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value129=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "./comelang.h", 1568, "struct list_item$1char$ph*"))));
        ...
        litem_194=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value130=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "./comelang.h", 1578, "struct list_item$1char$ph*"))));
        ...
        litem_195=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value131=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "./comelang.h", 1588, "struct list_item$1char$ph*"))));
...
struct list$1char$ph* __result_obj__115;
    if(    self==((void*)0)    ) {
        __result_obj__113 = (struct list$1char$ph*)come_increment_ref_count(((struct list$1char$ph*)(__right_value124=list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "./comelang.h", 4563, "struct list$1char$ph*"))))));
    ...
    result_190=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "./comelang.h", 4566, "struct list$1char$ph*"))));
    str_191=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./comelang.h", 4568, "struct buffer*"))));
...
char* __result_obj__118;
    ...
    result_197=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len_196*2+1)), "./comelang.h", 4600, "char*"));
    n_198=0;
...
char* __result_obj__120;
    ...
    result_201=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./comelang.h", 4628, "struct buffer*"))));
    p_202=self;
    while(    (_Bool)1    ) {
...
char* __result_obj__149;
    ...
    buf_208=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./comelang.h", 4993, "struct buffer*"))));
    while(    1    ) {
        char buf2_209[1024];
        memset(&buf2_209, 0, sizeof(char)        *(1024)        );
        size_210=fread(buf2_209,1,1024,f);
...
char* __result_obj__156;
    ...
    buf_219=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "./comelang.h", 5105, "struct buffer*"))));
    while(    1    ) {
        char buf2_220[1024];
...
struct list$1char$ph* __result_obj__158;
    result_224=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "./comelang.h", 5132, "struct list$1char$ph*"))));
    if(    f==((void*)0)    ) {
    ...
    while(    1    ) {
        char buf_225[1024];
        memset(&buf_225, 0, sizeof(char)        *(1024)        );
        if(        fgets(buf_225,1024,f)==((void*)0)        ) {
            break;
        }
...
default_value_267 = (void*)0;
    ...
    keys_252=(char**)come_increment_ref_count(((char**)(__right_value200=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size_251)), "./comelang.h", 2605, "char**"))));
    items_253=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value201=(struct sClass**)come_calloc_v2(1, sizeof(struct sClass*)*(1*(size_251)), "./comelang.h", 2606, "struct sClass**"))));
    item_existance_254=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value202=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(size_251)), "./comelang.h", 2607, "_Bool*"))));
    len_255=0;
...
struct sType* __result_obj__199;
    ...
    if(    klass_242    ) {
        ...
        klass2_250=(struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "common.h", 185, "struct sClass*"));
...
struct list$1sType$ph* __result_obj__206;
    if(    self->len==0    ) {
        litem_304=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value221=(struct list_item$1sType$ph*)come_calloc_v2(1, sizeof(struct list_item$1sType$ph)*(1), "./comelang.h", 1568, "struct list_item$1sType$ph*"))));
        ...
        litem_305=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value222=(struct list_item$1sType$ph*)come_calloc_v2(1, sizeof(struct list_item$1sType$ph)*(1), "./comelang.h", 1578, "struct list_item$1sType$ph*"))));
        ...
        litem_306=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value223=(struct list_item$1sType$ph*)come_calloc_v2(1, sizeof(struct list_item$1sType$ph)*(1), "./comelang.h", 1588, "struct list_item$1sType$ph*"))));
...
struct list$1sType$ph* __result_obj__210;
    ...
    result_308=(struct list$1sType$ph*)come_increment_ref_count(list$1sType$ph_initialize((struct list$1sType$ph*)come_increment_ref_count((struct list$1sType$ph*)come_calloc_v2(1, sizeof(struct list$1sType$ph)*(1), "./comelang.h", 1479, "struct list$1sType$ph*"))));
    it_309=self->head;
    while(    it_309!=((void*)0)    ) {
        if(        1        ) {
...
struct list$1sType$ph* __result_obj__209;
    if(    self->len==0    ) {
        litem_310=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value229=(struct list_item$1sType$ph*)come_calloc_v2(1, sizeof(struct list_item$1sType$ph)*(1), "./comelang.h", 1498, "struct list_item$1sType$ph*"))));
        ...
        litem_311=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value230=(struct list_item$1sType$ph*)come_calloc_v2(1, sizeof(struct list_item$1sType$ph)*(1), "./comelang.h", 1508, "struct list_item$1sType$ph*"))));
        ...
        litem_312=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value231=(struct list_item$1sType$ph*)come_calloc_v2(1, sizeof(struct list_item$1sType$ph)*(1), "./comelang.h", 1518, "struct list_item$1sType$ph*"))));
...
struct list$1sNode$ph* __result_obj__215;
    ...
    result_314=(struct list$1sNode$ph*)come_increment_ref_count(list$1sNode$ph_initialize((struct list$1sNode$ph*)come_increment_ref_count((struct list$1sNode$ph*)come_calloc_v2(1, sizeof(struct list$1sNode$ph)*(1), "./comelang.h", 1479, "struct list$1sNode$ph*"))));
    it_315=self->head;
    while(    it_315!=((void*)0)    ) {
        if(        1        ) {
...
struct list$1sNode$ph* __result_obj__214;
    if(    self->len==0    ) {
        litem_316=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value244=(struct list_item$1sNode$ph*)come_calloc_v2(1, sizeof(struct list_item$1sNode$ph)*(1), "./comelang.h", 1498, "struct list_item$1sNode$ph*"))));
        ...
        litem_317=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value245=(struct list_item$1sNode$ph*)come_calloc_v2(1, sizeof(struct list_item$1sNode$ph)*(1), "./comelang.h", 1508, "struct list_item$1sNode$ph*"))));
        ...
        litem_318=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value246=(struct list_item$1sNode$ph*)come_calloc_v2(1, sizeof(struct list_item$1sNode$ph)*(1), "./comelang.h", 1518, "struct list_item$1sNode$ph*"))));
...
struct list$1char$ph* __result_obj__218;
    ...
    result_319=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "./comelang.h", 1479, "struct list$1char$ph*"))));
    it_320=self->head;
    while(    it_320!=((void*)0)    ) {
        if(        1        ) {
            list$1char$ph_add(result_319,(char*)come_increment_ref_count((char*)come_memdup(it_320->item, "./comelang.h", 1484, "char*")));
        }
        else {
            list$1char$ph_add(result_319,(char*)come_increment_ref_count((char*)come_memdup(it_320->item, "./comelang.h", 1487, "char*")));
        }
        it_320=it_320->next;
    }
...
struct list$1char$ph* __result_obj__217;
    if(    self->len==0    ) {
        litem_321=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value254=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "./comelang.h", 1498, "struct list_item$1char$ph*"))));
        ...
        litem_322=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value255=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "./comelang.h", 1508, "struct list_item$1char$ph*"))));
        ...
        litem_323=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value256=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "./comelang.h", 1518, "struct list_item$1char$ph*"))));
...
struct sFun* __result_obj__220;
    ...
    for(    o2_saved_324=(struct list$1char$ph*)come_increment_ref_count((param_names)),it_325=list$1char$ph_begin((o2_saved_324))    ;    !list$1char$ph_end((o2_saved_324))    ;    it_325=list$1char$ph_next((o2_saved_324))    ){
        list$1char$ph_push_back(self->mLambdaType->mParamNames,(char*)come_increment_ref_count((char*)come_memdup(it_325, "common.h", 295, "char*")));
    }
...
struct map$2char$phchar$ph* __result_obj__224;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value279=(char**)come_calloc_v2(1, sizeof(char*)*(1*(128)), "./comelang.h", 2366, "char**"))));
    self->items=(char**)come_increment_ref_count(((char**)(__right_value280=(char**)come_calloc_v2(1, sizeof(char*)*(1*(128)), "./comelang.h", 2367, "char**"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value281=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 2368, "_Bool*"))));
...
struct map$2char$phsVar$ph* __result_obj__226;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value288=(char**)come_calloc_v2(1, sizeof(char*)*(1*(128)), "./comelang.h", 2366, "char**"))));
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value289=(struct sVar**)come_calloc_v2(1, sizeof(struct sVar*)*(1*(128)), "./comelang.h", 2367, "struct sVar**"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value290=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 2368, "_Bool*"))));
    ...
    while(    (_Bool)1    ) {
        if(        self->item_existance[it_349]        ) {
            if(            string_equals(self->keys[it_349],key)            ) {
                __result_obj__241 = (struct sVar*)come_increment_ref_count(self->items[it_349]);
                come_call_finalizer(sVar_finalize, default_value_347, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
            ...
            if(            it_349>=self->size            ) {
                ...
                __result_obj__242 = (struct sVar*)come_increment_ref_count(default_value_347);
                come_call_finalizer(sVar_finalize, default_value_347, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
                come_call_finalizer(sVar_finalize, __result_obj__242, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
                return __result_obj__242;
            }
        }
        else {
            __result_obj__243 = (struct sVar*)come_increment_ref_count(default_value_347);
            come_call_finalizer(sVar_finalize, default_value_347, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
            come_call_finalizer(sVar_finalize, __result_obj__243, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
            return __result_obj__243;
        }
    }
    __result_obj__244 = (struct sVar*)come_increment_ref_count(default_value_347);
    come_call_finalizer(sVar_finalize, default_value_347, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
...
default_value_350 = (void*)0;
    memset(&default_value_350,0,sizeof(struct sVar*));
    hash_351=string_get_hash_key(((char*)key))%self->size;
    it_352=hash_351;
    while(    (_Bool)1    ) {
        if(        self->item_existance[it_352]        ) {
            if(            string_equals(self->keys[it_352],key)            ) {
                __result_obj__245 = (struct sVar*)come_increment_ref_count(self->items[it_352]);
                come_call_finalizer(sVar_finalize, default_value_350, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
            ...
            if(            it_352>=self->size            ) {
                ...
                __result_obj__246 = (struct sVar*)come_increment_ref_count(default_value_350);
                come_call_finalizer(sVar_finalize, default_value_350, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
                come_call_finalizer(sVar_finalize, __result_obj__246, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
                return __result_obj__246;
            }
        }
        else {
            __result_obj__247 = (struct sVar*)come_increment_ref_count(default_value_350);
            come_call_finalizer(sVar_finalize, default_value_350, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
            come_call_finalizer(sVar_finalize, __result_obj__247, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
            return __result_obj__247;
        }
    }
    __result_obj__248 = (struct sVar*)come_increment_ref_count(default_value_350);
    come_call_finalizer(sVar_finalize, default_value_350, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
...
struct list$1sNode$ph* __result_obj__250;
    ...
    while(    it_356!=((void*)0)    ) {
        prev_it_357=it_356;
        it_356=it_356->next;
        come_call_finalizer(list_item$1sNode$ph$p_finalize, prev_it_357, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    self->head=((void*)0);
    self->tail=((void*)0);
    self->len=0;
...
struct tuple2$2char$phsType$ph* __result_obj__253;
    ...
    result_362=(struct tuple2$2char$phsType$ph*)come_increment_ref_count((struct tuple2$2char$phsType$ph*)come_calloc_v2(1, sizeof(struct tuple2$2char$phsType$ph)*(1), "tuple2$2char$phsType$ph_clone", 3, "struct tuple2$2char$phsType$ph*"));
    if(    self!=((void*)0)&&self->v1!=((void*)0)    ) {
        __dec_obj99=result_362->v1,
        result_362->v1=(char*)come_increment_ref_count((char*)come_memdup(self->v1, "tuple2$2char$phsType$ph_clone", 4, "char*"));
        __dec_obj99 = come_decrement_ref_count(__dec_obj99, (void*)0, (void*)0, 0/* no_decrement */,0/* no_free */, (void*)0);
    }
    if(    self!=((void*)0)&&self->v2!=((void*)0)    ) {
        __dec_obj100=result_362->v2,
        result_362->v2=(struct sType*)come_increment_ref_count(sType_clone(self->v2));
        come_call_finalizer(sType_finalize, __dec_obj100,(void*)0, (void*)0, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, (void*)0);
    }
    __result_obj__253 = (struct tuple2$2char$phsType$ph*)come_increment_ref_count(result_362);
    come_call_finalizer(tuple2$2char$phsType$ph_finalize, result_362, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
...
struct list$1CVALUE$ph* __result_obj__254;
    if(    self->len==0    ) {
        litem_370=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value337=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./comelang.h", 1568, "struct list_item$1CVALUE$ph*"))));
        litem_370->prev=((void*)0);
        litem_370->next=((void*)0);
        __dec_obj103=litem_370->item,
        ...
        litem_371=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value338=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./comelang.h", 1578, "struct list_item$1CVALUE$ph*"))));
        litem_371->prev=self->head;
        litem_371->next=((void*)0);
        __dec_obj104=litem_371->item,
        ...
        litem_372=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value339=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./comelang.h", 1588, "struct list_item$1CVALUE$ph*"))));
        litem_372->prev=self->tail;
        litem_372->next=((void*)0);
        __dec_obj105=litem_372->item,
...
struct map$2char$phsVar$ph* o2_saved_339;
char* it_342;
char* key_345;
...
struct tuple2$2char$phsType$ph* item_354;
void* __right_value316 = (void*)0;
struct sType* type3_355;
void* __right_value317 = (void*)0;
void* __right_value318 = (void*)0;
void* __right_value319 = (void*)0;
struct tuple2$2char$phsType$ph* item2_358;
void* __right_value326 = (void*)0;
void* __right_value327 = (void*)0;
struct map$2char$phsVar$ph* o2_saved_363;
char* it_364;
char* key_365;
void* __right_value328 = (void*)0;
struct sVar* value_366;
void* __right_value329 = (void*)0;
struct sType* type2_367;
void* __right_value330 = (void*)0;
void* __right_value331 = (void*)0;
struct tuple2$2char$phsType$ph* item_368;
...
_Bool __result_obj__255;
    ...
    current_stack_337=(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "common.h", 642, "struct sClass*")),(char*)come_increment_ref_count(class_name_336),(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)1,(_Bool)0,-1,-1,(_Bool)0,(_Bool)0,info));
    vtable_338=info->lv_table;
    while(    vtable_338    ) {
        for(        o2_saved_339=(struct map$2char$phsVar$ph*)come_increment_ref_count((vtable_338->mVars)),it_342=map$2char$phsVar$ph_begin((o2_saved_339))        ;        !map$2char$phsVar$ph_end((o2_saved_339))        ;        it_342=map$2char$phsVar$ph_next((o2_saved_339))        ){
            key_345=it_342;
            value_346=((struct sVar*)(__right_value311=map$2char$phsVar$ph_operator_load_element(vtable_338->mVars,((char*)(__right_value310=__builtin_string(key_345))))));
            ...
            type2_353=(struct sType*)come_increment_ref_count(sType_clone(value_346->mType));
            type2_353->mPointerNum++;
            item_354=(struct tuple2$2char$phsType$ph*)come_increment_ref_count(tuple2$2char$phsType$ph_initialize((struct tuple2$2char$phsType$ph**)come_increment_ref_count((struct tuple2$2char$phsType$ph*)come_calloc_v2(1, sizeof(struct tuple2$2char$phsType$ph)*(1), "common.h", 655, "struct tuple2$2char$phsType$ph")),(char*)come_increment_ref_count(__builtin_string(value_346->mCValueName)),(struct sType*)come_increment_ref_count(type2_353)));
            if(            value_346->mCValueName!=((void*)0)            ) {
                ...
                else if(                list$1sNode$ph_length(type2_353->mArrayNum)==1                ) {
                    type3_355=(struct sType*)come_increment_ref_count(sType_clone(type2_353));
                    list$1sNode$ph_reset(type3_355->mArrayNum);
                    type3_355->mPointerNum=1;
                    type3_355->mOriginIsArray=(_Bool)1;
                    item2_358=(struct tuple2$2char$phsType$ph*)come_increment_ref_count(tuple2$2char$phsType$ph_initialize((struct tuple2$2char$phsType$ph**)come_increment_ref_count((struct tuple2$2char$phsType$ph*)come_calloc_v2(1, sizeof(struct tuple2$2char$phsType$ph)*(1), "common.h", 675, "struct tuple2$2char$phsType$ph")),(char*)come_increment_ref_count(__builtin_string(value_346->mCValueName)),(struct sType*)come_increment_ref_count(type3_355)));
                    list$1tuple2$2char$phsType$ph$ph_push_back(current_stack_337->mFields,(struct tuple2$2char$phsType$ph*)come_increment_ref_count(tuple2$2char$phsType$ph_clone(item2_358)));
                    value_346->mType->mOriginIsArray=(_Bool)1;
                    come_call_finalizer(sType_finalize, type3_355, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
                    come_call_finalizer(tuple2$2char$phsType$ph$p_finalize, item2_358, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
                }
                else {
                    list$1tuple2$2char$phsType$ph$ph_push_back(current_stack_337->mFields,(struct tuple2$2char$phsType$ph*)come_increment_ref_count(tuple2$2char$phsType$ph_clone(item_354)));
                }
            }
            come_call_finalizer(sType_finalize, type2_353, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
            come_call_finalizer(tuple2$2char$phsType$ph$p_finalize, item_354, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
        }
        come_call_finalizer(map$2char$phsVar$ph$p_finalize, o2_saved_339, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
        vtable_338=vtable_338->mParent;
    }
    output_struct(current_stack_337,info);
    map$2char$phsClass$ph_insert(info->classes,(char*)come_increment_ref_count(class_name_336),(struct sClass*)come_increment_ref_count(current_stack_337));
    add_come_code_at_function_head(info,"struct %s __current_stack%d__;\n",class_name_336,info->current_stack_num);
    add_come_code_at_function_head2(info,"memset(&__current_stack%d__, 0, sizeof(struct %s));\n",info->current_stack_num,class_name_336);
    vtable_338=info->lv_table;
    while(    vtable_338    ) {
        for(        o2_saved_363=(struct map$2char$phsVar$ph*)come_increment_ref_count((vtable_338->mVars)),it_364=map$2char$phsVar$ph_begin((o2_saved_363))        ;        !map$2char$phsVar$ph_end((o2_saved_363))        ;        it_364=map$2char$phsVar$ph_next((o2_saved_363))        ){
            key_365=it_364;
            value_366=((struct sVar*)(__right_value328=map$2char$phsVar$ph_operator_load_element(vtable_338->mVars,key_365)));
            come_call_finalizer(sVar_finalize, __right_value328, (void*)0, (void*)0, 0/* alloca value */, 1/* no_decrement */, 0/* no_free */, (void*)0);
            type2_367=(struct sType*)come_increment_ref_count(sType_clone(value_366->mType));
            item_368=(struct tuple2$2char$phsType$ph*)come_increment_ref_count(tuple2$2char$phsType$ph_initialize((struct tuple2$2char$phsType$ph**)come_increment_ref_count((struct tuple2$2char$phsType$ph*)come_calloc_v2(1, sizeof(struct tuple2$2char$phsType$ph)*(1), "common.h", 704, "struct tuple2$2char$phsType$ph")),(char*)come_increment_ref_count(value_366->mCValueName),(struct sType*)come_increment_ref_count(type2_367)));
            if(            value_366->mCValueName!=((void*)0)            ) {
                if(                strcmp(value_366->mCValueName,"__list_values")==0                ) {
                }
                else if(                strcmp(value_366->mCValueName,"__map_keys")==0                ) {
                }
                else if(                strcmp(value_366->mCValueName,"__map_element")==0                ) {
                }
                else if(                string_operator_equals(value_366->mType->mClass->mName,"va_list")||string_operator_equals(value_366->mType->mClass->mName,"__builtin_va_list")                ) {
                }
                else {
                    if(                    string_operator_equals(value_366->mFunName,info->come_fun->mName)                    ) {
                        if(                        string_operator_equals(type2_367->mClass->mName,"lambda")                        ) {
                            add_come_code(info,"__current_stack%d__.%s = %s;\n",info->current_stack_num,value_366->mCValueName,value_366->mCValueName);
                        }
                        else {
                            add_come_code(info,"__current_stack%d__.%s = &%s;\n",info->current_stack_num,value_366->mCValueName,value_366->mCValueName);
                        }
            ...
            come_call_finalizer(sType_finalize, type2_367, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
            come_call_finalizer(tuple2$2char$phsType$ph$p_finalize, item_368, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
        }
        come_call_finalizer(map$2char$phsVar$ph$p_finalize, o2_saved_363, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
        vtable_338=vtable_338->mParent;
    }
    come_value_369=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc_v2(1, sizeof(struct CVALUE)*(1), "common.h", 743, "struct CVALUE*"))));
    __dec_obj101=come_value_369->c_value,
    come_value_369->c_value=(char*)come_increment_ref_count(xsprintf("&__current_stack%d__",info->current_stack_num));
    __dec_obj101 = come_decrement_ref_count(__dec_obj101, (void*)0, (void*)0, 0/* no_decrement */,0/* no_free */, (void*)0);
    __dec_obj102=come_value_369->type,
    come_value_369->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "common.h", 746, "struct sType*")),(char*)come_increment_ref_count(class_name_336),(_Bool)0,info));
    ...
    (class_name_336 = come_decrement_ref_count(class_name_336, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    come_call_finalizer(sClass_finalize, current_stack_337, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    come_call_finalizer(CVALUE_finalize, come_value_369, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
