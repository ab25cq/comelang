...
void GC_set_oom_fn(void* (*anonymous_var_nameX414)(unsigned long unsigned  int));
void* (*GC_get_oom_fn())(unsigned long unsigned  int);
void GC_set_on_heap_resize(void (*anonymous_var_nameX416)(unsigned long unsigned  int));
void (*GC_get_on_heap_resize())(unsigned long unsigned  int);
void GC_set_on_collection_event(void (*anonymous_var_nameX418)(enum anonymous_typeY8));
void (*GC_get_on_collection_event())(enum anonymous_typeY8);
void GC_set_find_leak(int anonymous_var_nameX419);
int GC_get_find_leak();
void GC_set_all_interior_pointers(int anonymous_var_nameX420);
int GC_get_all_interior_pointers();
void GC_set_finalize_on_demand(int anonymous_var_nameX421);
int GC_get_finalize_on_demand();
void GC_set_java_finalization(int anonymous_var_nameX422);
int GC_get_java_finalization();
void GC_set_finalizer_notifier(void (*anonymous_var_nameX423)());
void (*GC_get_finalizer_notifier())();
void GC_set_dont_expand(int anonymous_var_nameX424);
int GC_get_dont_expand();
void GC_set_full_freq(int anonymous_var_nameX425);
int GC_get_full_freq();
void GC_set_non_gc_bytes(unsigned long unsigned  int anonymous_var_nameX426);
unsigned long unsigned  int GC_get_non_gc_bytes();
void GC_set_no_dls(int anonymous_var_nameX427);
int GC_get_no_dls();
void GC_set_free_space_divisor(unsigned long unsigned  int anonymous_var_nameX428);
unsigned long unsigned  int GC_get_free_space_divisor();
void GC_set_max_retries(unsigned long unsigned  int anonymous_var_nameX429);
unsigned long unsigned  int GC_get_max_retries();
void GC_set_dont_precollect(int anonymous_var_nameX430);
int GC_get_dont_precollect();
void GC_set_time_limit(unsigned long unsigned  int anonymous_var_nameX431);
unsigned long unsigned  int GC_get_time_limit();
void GC_set_time_limit_tv(struct GC_timeval_s anonymous_var_nameX432);
struct GC_timeval_s GC_get_time_limit_tv();
void GC_set_allocd_bytes_per_finalizer(unsigned long unsigned  int anonymous_var_nameX433);
unsigned long unsigned  int GC_get_allocd_bytes_per_finalizer();
void GC_start_performance_measurement();
unsigned long unsigned  int GC_get_full_gc_total_time();
void GC_set_pages_executable(int anonymous_var_nameX434);
int GC_get_pages_executable();
void GC_set_min_bytes_allocd(unsigned long unsigned  int anonymous_var_nameX435);
unsigned long unsigned  int GC_get_min_bytes_allocd();
void GC_set_rate(int anonymous_var_nameX436);
int GC_get_rate();
void GC_set_max_prior_attempts(int anonymous_var_nameX437);
int GC_get_max_prior_attempts();
void GC_set_disable_automatic_collection(int anonymous_var_nameX438);
int GC_get_disable_automatic_collection();
void GC_set_handle_fork(int anonymous_var_nameX439);
...
void GC_deinit();
void* GC_malloc(unsigned long unsigned  int anonymous_var_nameX440);
void* GC_malloc_atomic(unsigned long unsigned  int anonymous_var_nameX441);
char* GC_strdup(const char* anonymous_var_nameX442);
char* GC_strndup(const char* anonymous_var_nameX443, unsigned long unsigned  int anonymous_var_nameX444);
void* GC_malloc_uncollectable(unsigned long unsigned  int anonymous_var_nameX445);
void* GC_malloc_stubborn(unsigned long unsigned  int anonymous_var_nameX446);
void* GC_memalign(unsigned long unsigned  int anonymous_var_nameX447, unsigned long unsigned  int anonymous_var_nameX448);
int GC_posix_memalign(void** anonymous_var_nameX449, unsigned long unsigned  int anonymous_var_nameX450, unsigned long unsigned  int anonymous_var_nameX451);
void GC_free(void* anonymous_var_nameX452);
void GC_change_stubborn(const void* anonymous_var_nameX453);
void GC_end_stubborn_change(const void* anonymous_var_nameX454);
void* GC_base(void* anonymous_var_nameX455);
int GC_is_heap_ptr(const void* anonymous_var_nameX456);
unsigned long unsigned  int GC_size(const void* anonymous_var_nameX457);
void* GC_realloc(void* anonymous_var_nameX458, unsigned long unsigned  int anonymous_var_nameX459);
int GC_expand_hp(unsigned long unsigned  int anonymous_var_nameX460);
void GC_set_max_heap_size(unsigned long unsigned  int anonymous_var_nameX461);
void GC_exclude_static_roots(void* anonymous_var_nameX462, void* anonymous_var_nameX463);
void GC_clear_exclusion_table();
void GC_clear_roots();
void GC_add_roots(void* anonymous_var_nameX464, void* anonymous_var_nameX465);
void GC_remove_roots(void* anonymous_var_nameX466, void* anonymous_var_nameX467);
void GC_register_displacement(unsigned long unsigned  int anonymous_var_nameX468);
void GC_debug_register_displacement(unsigned long unsigned  int anonymous_var_nameX469);
void GC_gcollect();
void GC_gcollect_and_unmap();
int GC_try_to_collect(int (*anonymous_var_nameX470)());
void GC_set_stop_func(int (*anonymous_var_nameX471)());
...
void GC_get_heap_usage_safe(unsigned long unsigned  int* anonymous_var_nameX472, unsigned long unsigned  int* anonymous_var_nameX473, unsigned long unsigned  int* anonymous_var_nameX474, unsigned long unsigned  int* anonymous_var_nameX475, unsigned long unsigned  int* anonymous_var_nameX476);
unsigned long unsigned  int GC_get_prof_stats(struct GC_prof_stats_s* anonymous_var_nameX477, unsigned long unsigned  int anonymous_var_nameX478);
unsigned long unsigned  int GC_get_size_map_at(int i);
unsigned long unsigned  int GC_get_memory_use();
void GC_disable();
int GC_is_disabled();
void GC_enable();
void GC_set_manual_vdb_allowed(int anonymous_var_nameX479);
...
void* GC_malloc_ignore_off_page(unsigned long unsigned  int anonymous_var_nameX480);
void* GC_malloc_atomic_ignore_off_page(unsigned long unsigned  int anonymous_var_nameX481);
void* GC_malloc_atomic_uncollectable(unsigned long unsigned  int anonymous_var_nameX482);
void* GC_debug_malloc_atomic_uncollectable(unsigned long unsigned  int anonymous_var_nameX483, const char* s, int i);
void* GC_debug_malloc(unsigned long unsigned  int anonymous_var_nameX484, const char* s, int i);
void* GC_debug_malloc_atomic(unsigned long unsigned  int anonymous_var_nameX485, const char* s, int i);
char* GC_debug_strdup(const char* anonymous_var_nameX486, const char* s, int i);
char* GC_debug_strndup(const char* anonymous_var_nameX487, unsigned long unsigned  int anonymous_var_nameX488, const char* s, int i);
void* GC_debug_malloc_uncollectable(unsigned long unsigned  int anonymous_var_nameX489, const char* s, int i);
void* GC_debug_malloc_stubborn(unsigned long unsigned  int anonymous_var_nameX490, const char* s, int i);
void* GC_debug_malloc_ignore_off_page(unsigned long unsigned  int anonymous_var_nameX491, const char* s, int i);
void* GC_debug_malloc_atomic_ignore_off_page(unsigned long unsigned  int anonymous_var_nameX492, const char* s, int i);
void GC_debug_free(void* anonymous_var_nameX493);
void* GC_debug_realloc(void* anonymous_var_nameX494, unsigned long unsigned  int anonymous_var_nameX495, const char* s, int i);
void GC_debug_change_stubborn(const void* anonymous_var_nameX496);
void GC_debug_end_stubborn_change(const void* anonymous_var_nameX497);
void* GC_debug_malloc_replacement(unsigned long unsigned  int anonymous_var_nameX498);
void* GC_debug_realloc_replacement(void* anonymous_var_nameX499, unsigned long unsigned  int anonymous_var_nameX500);
void GC_register_finalizer(void* anonymous_var_nameX503, void (*anonymous_var_nameX504)(void*,void*), void* anonymous_var_nameX505, void (*anonymous_var_nameX506)(void*,void*), void** anonymous_var_nameX507);
void GC_debug_register_finalizer(void* anonymous_var_nameX508, void (*anonymous_var_nameX509)(void*,void*), void* anonymous_var_nameX510, void (*anonymous_var_nameX511)(void*,void*), void** anonymous_var_nameX512);
void GC_register_finalizer_ignore_self(void* anonymous_var_nameX513, void (*anonymous_var_nameX514)(void*,void*), void* anonymous_var_nameX515, void (*anonymous_var_nameX516)(void*,void*), void** anonymous_var_nameX517);
void GC_debug_register_finalizer_ignore_self(void* anonymous_var_nameX518, void (*anonymous_var_nameX519)(void*,void*), void* anonymous_var_nameX520, void (*anonymous_var_nameX521)(void*,void*), void** anonymous_var_nameX522);
void GC_register_finalizer_no_order(void* anonymous_var_nameX523, void (*anonymous_var_nameX524)(void*,void*), void* anonymous_var_nameX525, void (*anonymous_var_nameX526)(void*,void*), void** anonymous_var_nameX527);
void GC_debug_register_finalizer_no_order(void* anonymous_var_nameX528, void (*anonymous_var_nameX529)(void*,void*), void* anonymous_var_nameX530, void (*anonymous_var_nameX531)(void*,void*), void** anonymous_var_nameX532);
void GC_register_finalizer_unreachable(void* anonymous_var_nameX533, void (*anonymous_var_nameX534)(void*,void*), void* anonymous_var_nameX535, void (*anonymous_var_nameX536)(void*,void*), void** anonymous_var_nameX537);
void GC_debug_register_finalizer_unreachable(void* anonymous_var_nameX538, void (*anonymous_var_nameX539)(void*,void*), void* anonymous_var_nameX540, void (*anonymous_var_nameX541)(void*,void*), void** anonymous_var_nameX542);
int GC_register_disappearing_link(void** anonymous_var_nameX543);
int GC_general_register_disappearing_link(void** anonymous_var_nameX544, const void* anonymous_var_nameX545);
int GC_move_disappearing_link(void** anonymous_var_nameX546, void** anonymous_var_nameX547);
int GC_unregister_disappearing_link(void** anonymous_var_nameX548);
int GC_register_long_link(void** anonymous_var_nameX549, const void* anonymous_var_nameX550);
int GC_move_long_link(void** anonymous_var_nameX551, void** anonymous_var_nameX552);
int GC_unregister_long_link(void** anonymous_var_nameX553);
void GC_set_toggleref_func(enum anonymous_typeY9 (*anonymous_var_nameX555)(void*));
enum anonymous_typeY9 (*GC_get_toggleref_func())(void*);
int GC_toggleref_add(void* anonymous_var_nameX556, int anonymous_var_nameX557);
void GC_set_await_finalize_proc(void (*anonymous_var_nameX559)(void*));
void (*GC_get_await_finalize_proc())(void*);
int GC_should_invoke_finalizers();
int GC_invoke_finalizers();
void GC_noop1(unsigned long unsigned  int anonymous_var_nameX560);
void GC_set_warn_proc(void (*anonymous_var_nameX563)(char*,unsigned long unsigned  int));
void (*GC_get_warn_proc())(char*,unsigned long unsigned  int);
void GC_ignore_warn_proc(char* anonymous_var_nameX564, unsigned long unsigned  int anonymous_var_nameX565);
void GC_set_log_fd(int anonymous_var_nameX566);
void GC_set_abort_func(void (*anonymous_var_nameX568)(const char*));
void (*GC_get_abort_func())(const char*);
void GC_abort_on_oom();
void* GC_call_with_alloc_lock(void* (*anonymous_var_nameX570)(void*), void* anonymous_var_nameX571);
void* GC_call_with_stack_base(void* (*anonymous_var_nameX574)(struct GC_stack_base*,void*), void* anonymous_var_nameX575);
void GC_start_mark_threads();
void* GC_do_blocking(void* (*anonymous_var_nameX576)(void*), void* anonymous_var_nameX577);
void* GC_call_with_gc_active(void* (*anonymous_var_nameX578)(void*), void* anonymous_var_nameX579);
int GC_get_stack_base(struct GC_stack_base* anonymous_var_nameX580);
void* GC_get_my_stackbottom(struct GC_stack_base* anonymous_var_nameX581);
void GC_set_stackbottom(void* anonymous_var_nameX582, const struct GC_stack_base* anonymous_var_nameX583);
void* GC_same_obj(void* anonymous_var_nameX584, void* anonymous_var_nameX585);
void* GC_pre_incr(void** anonymous_var_nameX586, long  int anonymous_var_nameX587);
void* GC_post_incr(void** anonymous_var_nameX588, long  int anonymous_var_nameX589);
void* GC_is_visible(void* anonymous_var_nameX590);
void* GC_is_valid_displacement(void* anonymous_var_nameX591);
void GC_dump();
void GC_dump_named(const char* anonymous_var_nameX592);
void GC_dump_regions();
void GC_dump_finalization();
void GC_ptr_store_and_dirty(void* anonymous_var_nameX593, const void* anonymous_var_nameX594);
void GC_debug_ptr_store_and_dirty(void* anonymous_var_nameX595, const void* anonymous_var_nameX596);
void* GC_malloc_many(unsigned long unsigned  int anonymous_var_nameX617);
void GC_register_has_static_roots_callback(int (*anonymous_var_nameX621)(const char*,void*,unsigned long unsigned  int));
void GC_set_force_unmap_on_gcollect(int anonymous_var_nameX622);
...
int i_44;
    buf_43=buffer_initialize((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang-gc.c", 49, "buffer"));
...
char* __result87__;
    ...
    result_106=(char*)come_calloc(1, sizeof(char)*(1*(len_105)), "libcomelang-gc.c", 901, "char");
...
struct buffer* __result88__;
    self->size=128;
    self->buf=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang-gc.c", 926, "char");
    self->buf[0]=0;
    self->len=0;
...
struct buffer* __result90__;
    ...
    result_109=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang-gc.c", 948, "buffer");
    result_109->size=self->size;
    result_109->buf=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang-gc.c", 951, "char");
...
struct buffer* __result92__;
    ...
    if(self->len+size+1+1>=self->size) {
        old_buf_110=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang-gc.c", 990, "char");
        memcpy(old_buf_110,self->buf,self->size);
        old_len_111=self->len;
        new_size_112=(self->size+size+1)*2;
        self->buf=(char*)come_calloc(1, sizeof(char)*(1*(new_size_112)), "libcomelang-gc.c", 994, "char");
...
struct buffer* __result94__;
    ...
    if(self->len+1+1+1>=self->size) {
        ...
        self->buf=(char*)come_calloc(1, sizeof(char)*(1*(new_size_115)), "libcomelang-gc.c", 1017, "char");
...
struct buffer* __result96__;
    ...
    if(self->len+size_116+1+1>=self->size) {
        old_buf_117=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang-gc.c", 1039, "char");
        memcpy(old_buf_117,self->buf,self->size);
        old_len_118=self->len;
        new_size_119=(self->size+size_116+1)*2;
        self->buf=(char*)come_calloc(1, sizeof(char)*(1*(new_size_119)), "libcomelang-gc.c", 1043, "char");
...
struct buffer* __result98__;
    ...
    if(self->len+size_120+1+1+1>=self->size) {
        old_buf_121=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang-gc.c", 1063, "char");
        memcpy(old_buf_121,self->buf,self->size);
        old_len_122=self->len;
        new_size_123=(self->size+size_120+1)*2;
        self->buf=(char*)come_calloc(1, sizeof(char)*(1*(new_size_123)), "libcomelang-gc.c", 1067, "char");
...
struct buffer* __result100__;
    ...
    if(self->len+size_125+1+1>=self->size) {
        old_buf_126=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang-gc.c", 1090, "char");
        memcpy(old_buf_126,self->buf,self->size);
        old_len_127=self->len;
        new_size_128=(self->size+size_125+1)*2;
        self->buf=(char*)come_calloc(1, sizeof(char)*(1*(new_size_128)), "libcomelang-gc.c", 1094, "char");
...
struct buffer* __result101__;
    ...
    if(self->len+size_130+1+1>=self->size) {
        old_buf_131=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang-gc.c", 1113, "char");
        memcpy(old_buf_131,self->buf,self->size);
        old_len_132=self->len;
        new_size_133=(self->size+size_130+1)*2;
        self->buf=(char*)come_calloc(1, sizeof(char)*(1*(new_size_133)), "libcomelang-gc.c", 1117, "char");
...
struct buffer* __result103__;
    ...
    if(self->len+size_135+1+1>=self->size) {
        old_buf_136=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang-gc.c", 1140, "char");
        memcpy(old_buf_136,self->buf,self->size);
        old_len_137=self->len;
        new_size_138=(self->size+size_135+1)*2;
        self->buf=(char*)come_calloc(1, sizeof(char)*(1*(new_size_138)), "libcomelang-gc.c", 1144, "char");
...
struct buffer* __result105__;
    ...
    if(len_139>=self->size) {
        ...
        self->buf=(char*)come_calloc(1, sizeof(char)*(1*(new_size_140)), "libcomelang-gc.c", 1168, "char");
...
struct buffer* __result107__;
    result_142=buffer_initialize((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang-gc.c", 1198, "buffer"));
    if(self==((void*)0)) {
...
struct buffer* __result109__;
    result_143=buffer_initialize((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang-gc.c", 1211, "buffer"));
    if(self==((void*)0)) {
...
char* __result113__;
    ...
    result_145=(char*)come_calloc(1, sizeof(char)*(1*(len_144+1)), "libcomelang-gc.c", 1373, "char");
...
char* __result115__;
    ...
    result_147=(char*)come_calloc(1, sizeof(char)*(1*(len_146+1)), "libcomelang-gc.c", 1388, "char");
...
char* __result117__;
    ...
    buf_148=buffer_initialize((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang-gc.c", 1401, "buffer"));
...
char* __result119__;
    ...
    buf_150=buffer_initialize((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang-gc.c", 1415, "buffer"));
...
char* __result125__;
    ...
    len_160=strlen(str);
    result_161=(char*)come_calloc(1, sizeof(char)*(1*(len_160+1)), "libcomelang-gc.c", 1632, "char");
...
char* __result127__;
    ...
    len_163=strlen(str);
    result_164=(char*)come_calloc(1, sizeof(char)*(1*(len_163+1)), "libcomelang-gc.c", 1649, "char");
...
char* __result132__;
    ...
    result_167=(char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "libcomelang-gc.c", 1694, "char");
...
char* __result137__;
    ...
    result_169=(char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "libcomelang-gc.c", 1737, "char");
...
char* __result142__;
    ...
    result_171=(char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "libcomelang-gc.c", 1780, "char");
...
char* __result147__;
    ...
    result_173=(char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "libcomelang-gc.c", 1823, "char");
...
struct list$1charph* __result162__;
    if(self==((void*)0)) {
        __result160__ = gComeFunResultObject = __result_obj__ = list$1charph_initialize((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-gc.c", 1934, "list$1charph"));
        gComeFunResultObject = (void*)0;
        return __result160__;
    }
    result_182=list$1charph_initialize((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-gc.c", 1937, "list$1charph"));
    str_183=buffer_initialize((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang-gc.c", 1939, "buffer"));
...
struct list$1charph* __result161__;
    if(self->len==0) {
        litem_185=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 221, "list_item$1charph");
        ...
        if(self->len==1) {
            litem_186=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 231, "list_item$1charph");
            ...
            litem_187=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 241, "list_item$1charph");
...
struct list$1charph* __result164__;
    if(self==((void*)0)) {
        __result163__ = gComeFunResultObject = __result_obj__ = list$1charph_initialize((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-gc.c", 1960, "list$1charph"));
        gComeFunResultObject = (void*)0;
        return __result163__;
    }
    result_188=list$1charph_initialize((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-gc.c", 1963, "list$1charph"));
    str_189=buffer_initialize((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang-gc.c", 1965, "buffer"));
...
char* __result191__;
    ...
    buf_195=buffer_initialize((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang-gc.c", 2295, "buffer"));
    while(1) {
        char buf2_196[1024];
...
char* __result198__;
    ...
    buf_209=buffer_initialize((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang-gc.c", 2435, "buffer"));
    while(1) {
        char buf2_210[1024];
...
char* __result202__;
    ...
    buf_215=buffer_initialize((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang-gc.c", 2472, "buffer"));
    while(1) {
        char buf2_216[1024];
...
struct list$1charph* __result204__;
    result_220=list$1charph_initialize((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-gc.c", 2499, "list$1charph"));
    if(f==((void*)0)) {
...
struct integer* __result216__;
    __result216__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2642, "integer"),self);
    gComeFunResultObject = (void*)0;
...
struct integer* __result217__;
    __result217__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2647, "integer"),self);
    gComeFunResultObject = (void*)0;
...
struct integer* __result218__;
    __result218__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2652, "integer"),self);
    gComeFunResultObject = (void*)0;
...
struct integer* __result219__;
    __result219__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2657, "integer"),self);
    gComeFunResultObject = (void*)0;
...
struct integer* __result220__;
    __result220__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2692, "integer"),left->value+right->value);
    gComeFunResultObject = (void*)0;
...
struct integer* __result221__;
    __result221__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2697, "integer"),left->value-right->value);
    gComeFunResultObject = (void*)0;
...
struct integer* __result222__;
    __result222__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2702, "integer"),left->value*right->value);
    gComeFunResultObject = (void*)0;
...
struct integer* __result223__;
    __result223__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2707, "integer"),left->value/right->value);
    gComeFunResultObject = (void*)0;
...
struct integer* __result224__;
    __result224__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2712, "integer"),left->value%right->value);
    gComeFunResultObject = (void*)0;
...
struct integer* __result225__;
    __result225__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2717, "integer"),left->value<<right->value);
    gComeFunResultObject = (void*)0;
...
struct integer* __result226__;
    __result226__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2722, "integer"),left->value>>right->value);
    gComeFunResultObject = (void*)0;
...
struct integer* __result227__;
    __result227__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2727, "integer"),left->value>=right->value);
    gComeFunResultObject = (void*)0;
...
struct integer* __result228__;
    __result228__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2732, "integer"),left->value<=right->value);
    gComeFunResultObject = (void*)0;
...
struct integer* __result229__;
    __result229__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2737, "integer"),left->value<right->value);
    gComeFunResultObject = (void*)0;
...
struct integer* __result230__;
    __result230__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2742, "integer"),left->value>right->value);
    gComeFunResultObject = (void*)0;
...
struct integer* __result231__;
    __result231__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2747, "integer"),left->value&right->value);
    gComeFunResultObject = (void*)0;
...
struct integer* __result232__;
    __result232__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2752, "integer"),left->value^right->value);
    gComeFunResultObject = (void*)0;
...
struct integer* __result233__;
    __result233__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2757, "integer"),left->value|right->value);
    gComeFunResultObject = (void*)0;
...
struct integer* __result234__;
    __result234__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2762, "integer"),left->value&&right->value);
    gComeFunResultObject = (void*)0;
...
struct integer* __result235__;
    __result235__ = gComeFunResultObject = __result_obj__ = integer_initialize((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "libcomelang-gc.c", 2767, "integer"),left->value||right->value);
    gComeFunResultObject = (void*)0;
