...
class sStoreArrayNode extends sNodeBase
{
    ...
    bool compile(sInfo* info)
    {
        ...
        if(operator_fun) {
            ...
            if(!is_inner_calling_ && param_type2 && param_type2.mHeap && param_type2.mClass.mName === "object" && param_type2.mRefference && param_type2.mRefferenceOriginalType && param_type2.mRefferenceOriginalType.v1)
            {
                node_compile(right).elif {
                    return false;
                }
