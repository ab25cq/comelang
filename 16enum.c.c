...
c_value_105 = (void*)0;
    ...
    for(    o2_saved_95=(elements_90),it_98=list$1tuple2$2charphsNodephph_begin((o2_saved_95));    !list$1tuple2$2charphsNodephph_end((o2_saved_95));    it_98=list$1tuple2$2charphsNodephph_next((o2_saved_95))    ){
        ...
        if(        (_if_conditional1=(map$2charphsVarph_at(info->gv_table->mVars,((char*)(__right_value138=__builtin_string(name_101))),((void*)0))!=((void*)0))),        /* U10 */ (__right_value138 = come_decrement_ref_count2(__right_value138, (void*)0, (void*)0, 1, 0, 0, (void*)0)),
        _if_conditional1) {
        ...
        if(        value_102==((void*)0)) {
            ...
            /* U13 */c_value_105 = come_decrement_ref_count2(c_value_105, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        }
        else {
            if(            !node_compile(value_102,info)) {
                __result86__ = (_Bool)0;
                /* U13 */name_101 = come_decrement_ref_count2(name_101, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            ...
            /* U13 */c_value_107 = come_decrement_ref_count2(c_value_107, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        }
        i_92++;
        n_93++;
        /* U13 */name_101 = come_decrement_ref_count2(name_101, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    ...
    if(    info->output_header_file&&string_operator_not_equals(self->mDeclareSName,info->base_sname)) {
        ...
        if(        self->mOutput) {
            ...
            /* U11 */__right_value150 = come_decrement_ref_count2(__right_value150, (void*)0, (void*)0, 1, 0, 0, (void*)0);
        }
    }
...
struct list$1tuple2$2charphsNodephph* __result72__;
    ...
    result_68=(struct list$1tuple2$2charphsNodephph*)come_increment_ref_count(list$1tuple2$2charphsNodephph_initialize((struct list$1tuple2$2charphsNodephph*)come_increment_ref_count((struct list$1tuple2$2charphsNodephph*)come_calloc(1, sizeof(struct list$1tuple2$2charphsNodephph)*(1), "/usr/local/include/comelang.h", 143, "list$1tuple2$2charphsNodephph"))));
    it_69=self->head;
    while(it_69!=((void*)0)) {
...
struct list$1tuple2$2charphsNodephph* __result67__;
    if(    self->len==0) {
        litem_70=(struct list_item$1tuple2$2charphsNodephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsNodephph*)(__right_value120=(struct list_item$1tuple2$2charphsNodephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsNodephph)*(1), "/usr/local/include/comelang.h", 157, "list_item$1tuple2$2charphsNodephph"))));
        ...
        litem_72=(struct list_item$1tuple2$2charphsNodephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsNodephph*)(__right_value122=(struct list_item$1tuple2$2charphsNodephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsNodephph)*(1), "/usr/local/include/comelang.h", 177, "list_item$1tuple2$2charphsNodephph"))));
...
memset(&output_109, 0, sizeof(_Bool));
    ...
    while((_Bool)1) {
        ...
        if(        *info->p==125) {
            info->p++;
            skip_spaces_and_lf(info);
            /* U13 */element_name_187 = come_decrement_ref_count2(element_name_187, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            break;
        }
        /* U13 */element_name_187 = come_decrement_ref_count2(element_name_187, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
...
default_value_130 = (void*)0;
    ...
    keys_117=(char**)come_increment_ref_count(((char**)(__right_value153=(char**)come_calloc(1, sizeof(char*)*(1*(size_116)), "/usr/local/include/comelang.h", 1655, "char*%"))));
    items_118=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value154=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_116)), "/usr/local/include/comelang.h", 1656, "sClass*%"))));
    item_existance_119=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value155=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_116)), "/usr/local/include/comelang.h", 1657, "bool"))));
    len_120=0;
...
struct list$1tuple2$2charphsTypephph* __result137__;
    ...
    result_156=(struct list$1tuple2$2charphsTypephph*)come_increment_ref_count(list$1tuple2$2charphsTypephph_initialize((struct list$1tuple2$2charphsTypephph*)come_increment_ref_count((struct list$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang.h", 143, "list$1tuple2$2charphsTypephph"))));
    it_157=self->head;
    while(it_157!=((void*)0)) {
...
struct list$1tuple2$2charphsTypephph* __result112__;
    if(    self->len==0) {
        litem_158=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value160=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang.h", 157, "list_item$1tuple2$2charphsTypephph"))));
        ...
        litem_159=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value161=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang.h", 167, "list_item$1tuple2$2charphsTypephph"))));
        ...
        litem_160=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value162=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang.h", 177, "list_item$1tuple2$2charphsTypephph"))));
...
struct list$1sTypeph* __result124__;
    ...
    result_166=(struct list$1sTypeph*)come_increment_ref_count(list$1sTypeph_initialize((struct list$1sTypeph*)come_increment_ref_count((struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "/usr/local/include/comelang.h", 143, "list$1sTypeph"))));
    it_167=self->head;
    while(it_167!=((void*)0)) {
...
struct list$1sTypeph* __result123__;
    if(    self->len==0) {
        litem_168=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value178=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang.h", 157, "list_item$1sTypeph"))));
        ...
        litem_169=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value179=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang.h", 167, "list_item$1sTypeph"))));
        ...
        litem_170=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value180=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang.h", 177, "list_item$1sTypeph"))));
...
struct list$1sNodeph* __result128__;
    ...
    result_171=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count((struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "/usr/local/include/comelang.h", 143, "list$1sNodeph"))));
    it_172=self->head;
    while(it_172!=((void*)0)) {
...
struct list$1sNodeph* __result127__;
    if(    self->len==0) {
        litem_173=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value185=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 157, "list_item$1sNodeph"))));
        ...
        litem_174=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value186=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 167, "list_item$1sNodeph"))));
        ...
        litem_175=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value187=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 177, "list_item$1sNodeph"))));
...
struct list$1charph* __result132__;
    ...
    result_176=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang.h", 143, "list$1charph"))));
    it_177=self->head;
    while(it_177!=((void*)0)) {
...
struct list$1charph* __result131__;
    if(    self->len==0) {
        litem_178=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value193=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 157, "list_item$1charph"))));
        ...
        litem_179=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value194=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 167, "list_item$1charph"))));
        ...
        litem_180=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value195=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 177, "list_item$1charph"))));
...
struct list$1tuple2$2charphsNodephph* __result139__;
    if(    self->len==0) {
        litem_190=(struct list_item$1tuple2$2charphsNodephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsNodephph*)(__right_value216=(struct list_item$1tuple2$2charphsNodephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsNodephph)*(1), "/usr/local/include/comelang.h", 227, "list_item$1tuple2$2charphsNodephph"))));
        ...
        litem_191=(struct list_item$1tuple2$2charphsNodephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsNodephph*)(__right_value217=(struct list_item$1tuple2$2charphsNodephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsNodephph)*(1), "/usr/local/include/comelang.h", 237, "list_item$1tuple2$2charphsNodephph"))));
        ...
        litem_192=(struct list_item$1tuple2$2charphsNodephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsNodephph*)(__right_value218=(struct list_item$1tuple2$2charphsNodephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsNodephph)*(1), "/usr/local/include/comelang.h", 247, "list_item$1tuple2$2charphsNodephph"))));
...
struct sNode* __result148__;
    if(    charp_operator_equals(buf,"enum")) {
        ...
        if(        *info->p==58) {
            ...
            /* U13 */name_199 = come_decrement_ref_count2(name_199, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        }
        if(        *info->p==123) {
            ...
            if(            *info->p==58) {
                ...
                /* U13 */name_202 = come_decrement_ref_count2(name_202, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            }
        }
        parse_sharp_v5(info);
        expected_next_character(123,info);
        ...
        while((_Bool)1) {
            ...
            if(            *info->p==125) {
                info->p++;
                skip_spaces_and_lf(info);
                /* U13 */element_name_205 = come_decrement_ref_count2(element_name_205, (void*)0, (void*)0, 0, 0, 0, (void*)0);
                break;
            }
            /* U13 */element_name_205 = come_decrement_ref_count2(element_name_205, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        }
        ...
        /* U13 */type_name_196 = come_decrement_ref_count2(type_name_196, (void*)0, (void*)0, 0, 0, 0, (void*)0);
