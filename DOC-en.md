...
Memory is a device in a computer that has a state of 0 and 1. For one address, a 32-bit CPU has 32\*8 binary digits, and a 64-bit CPU has 64\*8 digits of 0 and 1. Can store numbers.
...
For now, it's completed. I'm satisfied this time. I would like to set the version to 10.0.0.
How many years have you been doing it? It's been about 3 years. Well, it was fun.
I have no regrets this time. I feel like I've accomplished something.
