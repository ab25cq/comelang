...
struct map$2charphsVarph* __result68__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value127=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 1369, "char*%"))));
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value128=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(128)), "./comelang.h", 1370, "sVar*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value129=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 1371, "bool"))));
...
default_value_111 = (void*)0;
    ...
    keys_96=(char**)come_increment_ref_count(((char**)(__right_value138=(char**)come_calloc(1, sizeof(char*)*(1*(size_95)), "./comelang.h", 1620, "char*%"))));
    items_97=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value139=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_95)), "./comelang.h", 1621, "sClass*%"))));
    item_existance_98=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value140=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_95)), "./comelang.h", 1622, "bool"))));
    len_99=0;
