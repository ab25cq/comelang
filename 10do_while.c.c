...
struct sDoWhileNode* __result271__;
    ...
    result_387=(void*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "struct sDoWhileNode", sDoWhileNode_finalize, sDoWhileNode_clone));
    if(    self!=((void*)0)) {
        ((struct sDoWhileNode*)result_387)->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj101=((struct sDoWhileNode*)result_387)->sname;
        ((struct sDoWhileNode*)result_387)->sname=(char*)come_increment_ref_count(come_call_cloner(string_clone, self->sname));
        __dec_obj101 = come_decrement_ref_count2(__dec_obj101, (void*)0, (void*)0, 0,0,0, (void*)0);
    }
    if(    self!=((void*)0)) {
        ((struct sDoWhileNode*)result_387)->sline_real=self->sline_real;
    }
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj102=((struct sDoWhileNode*)result_387)->mExpressionNode;
        ((struct sDoWhileNode*)result_387)->mExpressionNode=(struct sNode*)come_increment_ref_count(come_call_cloner(sNode_clone, self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj103=((struct sDoWhileNode*)result_387)->mBlock;
        ((struct sDoWhileNode*)result_387)->mBlock=(struct sBlock*)come_increment_ref_count(come_call_cloner(sBlock_clone, self->mBlock));
        come_call_finalizer3(__dec_obj103,sBlock_finalize, 0, 0, 0, 0, (void*)0);
    }
    __result271__ = gComeFunResultObject = __result_obj__ = ((struct sDoWhileNode*)result_387);
