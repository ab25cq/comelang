...
int num_while_conditional_stack_99;
    ...
    if(    normal_if_95) {
        ...
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_conditional_stack_99,conditional_value_97->c_value);
...
struct sNode* __result_obj__56;
    if(    charp_operator_equals(buf,"do")) {
        sname_100=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "10do_while.c", 85, "char*"));
        ...
        _inf_value1=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "10do_while.c", 104, "struct sNode");
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value88=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc_v2(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 104, "struct sDoWhileNode*")),(struct sNode*)come_increment_ref_count(expression_node_104),block_102,info))));
