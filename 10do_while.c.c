...
_Bool sDoWhileNode_compile(struct sDoWhileNode* self, struct sInfo* info){
_Bool in_loop_379;
struct sBlock* block_380;
struct sNode* expression_node_381;
_Bool comma_instead_of_semicolon_382;
_Bool Value_383;
_Bool normal_if_384;
...
int num_while_conditional_stack_388;
    if(    info->comma_instead_of_semicolon) {
        err_msg(info,"In conditional operator comelang can't use do while statment");
        return (_Bool)0;
    }
    in_loop_379=info->in_loop;
    info->in_loop=(_Bool)1;
    block_380=self->mBlock;
    add_come_code(info,"do {\n");
    transpile_block(block_380,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    expression_node_381=self->mExpressionNode;
    comma_instead_of_semicolon_382=info->comma_instead_of_semicolon;
    info->comma_instead_of_semicolon=(_Bool)1;
    info->without_semicolon=(_Bool)1;
    Value_383=node_compile(expression_node_381,info);
    if(    !Value_383) {
        return (_Bool)0;
    }
    else {
    ...
    info->comma_instead_of_semicolon=comma_instead_of_semicolon_382;
    ...
    if(    normal_if_384) {
        ...
        dec_stack_ptr(1,info);
        static int num_while_condtional_387=0;
        add_come_code_at_function_head(info,"_Bool _do_while_condtional%d;\n",++num_while_condtional_387);
        num_while_conditional_stack_388=num_while_condtional_387;
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_condtional_387,conditional_value_386->c_value);
        add_last_code_to_source_with_comma(info);
        free_right_value_objects(info,(_Bool)1);
        add_come_code(info,"_do_while_condtional%d);\n",num_while_conditional_stack_388);
        come_call_finalizer3(conditional_value_386,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    transpiler_clear_last_code(info);
    info->in_loop=in_loop_379;
    return (_Bool)1;
}
...
struct sNode* __result273__;
    if(    charp_operator_equals(buf,"do")) {
        sname_389=(char*)come_increment_ref_count(come_call_cloner(string_clone, info->sname));
        ...
        if(        string_operator_not_equals(buf2_392,"while")) {
            err_msg(info,"require while");
            exit(2);
        }
        expected_next_character(40,info);
        expression_node_393=(struct sNode*)come_increment_ref_count(expression_v13(info));
        expected_next_character(41,info);
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "10do_while.c", 111, "struct sNode", (void*)0, (void*)0, (void*)0);
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value326=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 111, "struct sDoWhileNode*", (void*)0, (void*)0, (void*)0)),(struct sNode*)come_increment_ref_count(expression_node_393),block_391,info))));
        ...
        sname_389 = come_decrement_ref_count2(sname_389, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        come_call_finalizer3(block_391,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        buf2_392 = come_decrement_ref_count2(buf2_392, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        if(expression_node_393) { expression_node_393 = come_decrement_ref_count2(expression_node_393, ((struct sNode*)expression_node_393)->finalize, ((struct sNode*)expression_node_393)->_protocol_obj, 0, 0, 0, (void*)0); } 
...
struct sDoWhileNode* result_395;
...
struct sDoWhileNode* __result271__;
    ...
    result_395=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "struct sDoWhileNode", sDoWhileNode_finalize, sDoWhileNode_clone, sDoWhileNode_get_hash_key));
    if(    self!=((void*)0)) {
        result_395->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj101=result_395->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj102=result_395->mExpressionNode;
        result_395->mExpressionNode=(struct sNode*)come_increment_ref_count(come_call_cloner(sNode_clone, self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj103=result_395->mBlock;
        result_395->mBlock=(struct sBlock*)come_increment_ref_count(come_call_cloner(sBlock_clone, self->mBlock));
    ...
    come_call_finalizer3(result_395,sDoWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
unsigned int result_394;
    ...
    result_394+=int_get_hash_key(((int)self->mExpressionNode));
    result_394+=int_get_hash_key(((int)self->mBlock));
    return result_394;
}
