...
struct sDoWhileNode* __result235__;
...
char* __result236__;
    __result236__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value276=__builtin_string("sDoWhileNode")));
...
_Bool sDoWhileNode_compile(struct sDoWhileNode* self, struct sInfo* info){
_Bool in_loop_318;
struct sBlock* block_319;
struct sNode* expression_node_320;
_Bool comma_instead_of_semicolon_321;
_Bool Value_322;
_Bool normal_if_323;
void* __right_value277 = (void*)0;
struct CVALUE* conditional_value_324;
void* __right_value278 = (void*)0;
struct CVALUE* conditional_value_325;
int num_while_conditional_stack_327;
    if(    info->comma_instead_of_semicolon) {
        err_msg(info,"In conditional operator comelang can't use do while statment");
        return (_Bool)0;
    }
    in_loop_318=info->in_loop;
    info->in_loop=(_Bool)1;
    block_319=self->mBlock;
    add_come_code(info,"do {\n");
    transpile_block(block_319,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    expression_node_320=self->mExpressionNode;
    ...
    Value_322=node_compile(expression_node_320,info);
    if(    !Value_322) {
        return (_Bool)0;
    }
    else {
    ...
    if(    normal_if_323) {
        conditional_value_324=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        dec_stack_ptr(1,info);
        add_come_code(info,"} while(%s);\n",conditional_value_324->c_value);
        come_call_finalizer3(conditional_value_324,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    else {
        conditional_value_325=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        dec_stack_ptr(1,info);
        static int num_while_condtional_326=0;
        add_come_code_at_function_head(info,"_Bool _do_while_condtional%d;\n",++num_while_condtional_326);
        num_while_conditional_stack_327=num_while_condtional_326;
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_condtional_326,conditional_value_325->c_value);
        add_last_code_to_source_with_comma(info);
        free_right_value_objects(info,(_Bool)1);
        add_come_code(info,"_do_while_condtional%d);\n",num_while_conditional_stack_327);
        come_call_finalizer3(conditional_value_325,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    transpiler_clear_last_code(info);
    info->in_loop=in_loop_318;
    return (_Bool)1;
}
...
struct sNode* __result240__;
    if(    charp_operator_equals(buf,"do")) {
        sname_328=(char*)come_increment_ref_count(string_clone(info->sname));
        sline_329=info->sline;
        block_330=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        buf2_331=(char*)come_increment_ref_count(parse_word(info));
        if(        string_operator_not_equals(buf2_331,"while")) {
            err_msg(info,"require while");
            exit(2);
        }
        expected_next_character(40,info);
        expression_node_332=(struct sNode*)come_increment_ref_count(expression_v13(info));
        expected_next_character(41,info);
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "10do_while.c", 111, "struct sNode");
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value284=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 111, "sDoWhileNode")),(struct sNode*)come_increment_ref_count(expression_node_332),block_330,info))));
        ...
        __result239__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value289=_inf_value1));
        sname_328 = come_decrement_ref_count2(sname_328, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        come_call_finalizer3(block_330,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        ...
        come_call_finalizer3(__right_value284,sDoWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
    ...
    __result240__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value290=string_node_v9(buf,head,head_sline,info)));
...
static struct sDoWhileNode* sDoWhileNode_clone(struct sDoWhileNode* self){
void* __result_obj__=(void*)0;
struct sDoWhileNode* __result237__;
void* __right_value285 = (void*)0;
struct sDoWhileNode* result_333;
...
struct sDoWhileNode* __result238__;
    if(    self==(void*)0) {
        __result237__ = gComeFunResultObject = __result_obj__ = (void*)0;
        gComeFunResultObject = (void*)0;
        return __result237__;
    }
    result_333=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "sDoWhileNode"));
    if(    self!=((void*)0)) {
        result_333->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj79=result_333->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj80=result_333->mExpressionNode;
        result_333->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode));
        if(__dec_obj80) { __dec_obj80 = come_decrement_ref_count2(__dec_obj80, ((struct sNode*)__dec_obj80)->finalize, ((struct sNode*)__dec_obj80)->_protocol_obj, 0,0,0, (void*)0); };
    }
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj81=result_333->mBlock;
        result_333->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
    ...
    come_call_finalizer3(result_333,sDoWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
