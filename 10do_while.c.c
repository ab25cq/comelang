...
int num_while_conditional_stack_144;
    ...
    if(    !node_compile(expression_node_138,info)) {
        return (_Bool)0;
    }
    ...
    if(    normal_if_140) {
        ...
        add_come_code(info,"} while(%s);\n",conditional_value_141->c_value);
        /*i*/come_call_finalizer3(conditional_value_141,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    else {
        conditional_value_142=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        dec_stack_ptr(1,info);
        static int num_while_condtional_143=0;
        add_come_code_at_function_head(info,"_Bool _do_while_condtional%d;\n",++num_while_condtional_143);
        num_while_conditional_stack_144=num_while_condtional_143;
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_condtional_143,conditional_value_142->c_value);
        add_last_code_to_source_with_comma(info);
        free_right_value_objects(info,(_Bool)1);
        add_come_code(info,"_do_while_condtional%d);\n",num_while_conditional_stack_144);
...
struct sNode* __result105__;
    if(    charp_operator_equals(buf,"do")) {
        sname_145=(char*)come_increment_ref_count(string_clone(info->sname));
        sline_146=info->sline;
        block_147=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        buf2_148=(char*)come_increment_ref_count(parse_word(info));
        if(        string_operator_not_equals(buf2_148,"while")) {
        ...
        _inf_obj_value1=come_increment_ref_count(((struct sDoWhileNode*)(__right_value151=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 111, "sDoWhileNode")),(struct sNode*)come_increment_ref_count(expression_node_149),block_147,info))));
        ...
        sname_145 = come_decrement_ref_count2(sname_145, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(block_147,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        buf2_148 = come_decrement_ref_count2(buf2_148, (void*)0, (void*)0, 0, 0, 0, (void*)0);
...
struct sBlock* __dec_obj60;
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        if(        self->mBlock==gComeFunResultObject) {
            ...
            come_call_finalizer3(__dec_obj60,sBlock_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
...
struct sDoWhileNode* result_150;
...
struct sDoWhileNode* __result103__;
    ...
    result_150=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "sDoWhileNode"));
    if(    self!=((void*)0)) {
        result_150->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj61=result_150->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj62=result_150->mExpressionNode;
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj63=result_150->mBlock;
        result_150->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
        come_call_finalizer3(__dec_obj63,sBlock_finalize, 0, 0, 0, 0, (void*)0);
    }
    __result103__ = gComeFunResultObject = __result_obj__ = result_150;
    /*i*/come_call_finalizer3(result_150,sDoWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
