...
struct sNode* __result_obj__56;
    if(    charp_operator_equals(buf,"do")    ) {
        ...
        if(        string_operator_not_equals(buf2_100,"while")        ) {
            ...
            come_call_finalizer(tuple2$2int$bool$$p_finalize, __right_value85, (void*)0, (void*)0, 0/* alloca value */, 1/* no_decrement */, 0/* no_free */, (void*)0);
            exit(2);
        }
        ...
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value88=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc_v2(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 100, "struct sDoWhileNode*")),(struct sNode*)come_increment_ref_count(expression_node_101),block_99,info))));
        ...
        come_call_finalizer(sDoWhileNode_finalize, __right_value88, (void*)0, (void*)0, 0/* alloca value */, 1/* no_decrement */, 0/* no_free */, (void*)0);
