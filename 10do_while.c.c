...
struct sDoWhileNode* __result_obj__211;
    ...
    __result_obj__211 = (struct sDoWhileNode*)come_increment_ref_count(self);
    ...
    /*c*/ come_call_finalizer3(__result_obj__211,sDoWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 0/* force_delete */ , (void*)0);
...
char* __result_obj__212;
    __result_obj__212 = (char*)come_increment_ref_count(((char*)(__right_value263=__builtin_string("sDoWhileNode"))));
...
_Bool without_semicolon_327;
_Bool Value_328;
_Bool normal_if_329;
void* __right_value265 = (void*)0;
struct CVALUE* conditional_value_330;
void* __right_value266 = (void*)0;
struct CVALUE* conditional_value_331;
int num_while_conditional_stack_333;
    if(    info->comma_instead_of_semicolon) {
        multiple_assign_var1=((struct tuple2$2int$char$ph*)(__right_value264=err_msg(info,"In conditional operator comelang can't use do while statment")));
    ...
    in_loop_323=info->in_loop;
    info->in_loop=(_Bool)1;
    block_324=self->mBlock;
    add_come_code(info,"do {\n");
    transpile_block(block_324,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    expression_node_325=self->mExpressionNode;
    comma_instead_of_semicolon_326=info->comma_instead_of_semicolon;
    info->comma_instead_of_semicolon=(_Bool)1;
    without_semicolon_327=info->without_semicolon;
    info->without_semicolon=(_Bool)1;
    Value_328=node_compile(expression_node_325,info);
    if(    !Value_328) {
        return (_Bool)0;
    }
    else {
    }
    info->without_semicolon=without_semicolon_327;
    info->comma_instead_of_semicolon=comma_instead_of_semicolon_326;
    normal_if_329=(_Bool)1;
    if(    existance_free_right_value_objects(info)) {
        normal_if_329=(_Bool)0;
    }
    if(    normal_if_329) {
        ...
        conditional_value_331=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        static int num_while_condtional_332=0;
        add_come_code_at_function_head(info,"_Bool _do_while_condtional%d;\n",++num_while_condtional_332);
        num_while_conditional_stack_333=num_while_condtional_332;
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_condtional_332,conditional_value_331->c_value);
        add_last_code_to_source_with_comma(info);
        free_right_value_objects(info,(_Bool)1);
        add_come_code(info,"_do_while_condtional%d);\n",num_while_conditional_stack_333);
        /*c*/ come_call_finalizer3(conditional_value_331,CVALUE_finalize, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
    }
    transpiler_clear_last_code(info);
    info->in_loop=in_loop_323;
    return (_Bool)1;
}
...
struct sBlock* block_336;
void* __right_value269 = (void*)0;
char* buf2_337;
void* __right_value270 = (void*)0;
struct tuple2$2int$char$ph* multiple_assign_var2 = (void*)0;
int come_exception_var_c1_338=0;
char* Err_339=0;
...
struct sNode* __result_obj__217;
    if(    charp_operator_equals(buf,"do")) {
        sname_334=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "10do_while.c", 92, "char*"));
        sline_335=info->sline;
        block_336=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        buf2_337=(char*)come_increment_ref_count(parse_word(info));
        if(        string_operator_not_equals(buf2_337,"while")) {
            multiple_assign_var2=((struct tuple2$2int$char$ph*)(__right_value270=err_msg(info,"require while")));
            come_exception_var_c1_338=multiple_assign_var2->v1;
            Err_339=(char*)come_increment_ref_count(multiple_assign_var2->v2);
            ((Err_339)?(puts(Err_339),exit(0)):(0));
            /*c*/ come_call_finalizer3(__right_value270,tuple2$2int$char$ph$p_finalize, 0/* alloca value */, 1/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
            exit(2);
        ...
        _inf_value1=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "10do_while.c", 111, "struct sNode");
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value273=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc_v2(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 111, "struct sDoWhileNode*")),(struct sNode*)come_increment_ref_count(expression_node_340),block_336,info))));
        ...
        __result_obj__216 = (struct sNode*)come_increment_ref_count(((struct sNode*)(__right_value278=_inf_value1)));
        (sname_334 = come_decrement_ref_count(sname_334, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        /*c*/ come_call_finalizer3(block_336,sBlock_finalize, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
        (buf2_337 = come_decrement_ref_count(buf2_337, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    ...
    __result_obj__217 = (struct sNode*)come_increment_ref_count(((struct sNode*)(__right_value279=string_node_v9(buf,head,head_sline,info))));
...
static struct sDoWhileNode* sDoWhileNode_clone(struct sDoWhileNode* self){
struct sDoWhileNode* __result_obj__214;
void* __right_value274 = (void*)0;
struct sDoWhileNode* result_341;
...
struct sDoWhileNode* __result_obj__215;
    ...
    result_341=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc_v2(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "struct sDoWhileNode*"));
    if(    self!=((void*)0)) {
        result_341->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj51=result_341->sname,
        result_341->sname=(char*)come_increment_ref_count((char*)come_memdup(self->sname, "sDoWhileNode_clone", 5, "char*"));
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj52=result_341->mExpressionNode,
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj53=result_341->mBlock,
        result_341->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
    ...
    /*c*/ come_call_finalizer3(result_341,sDoWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 0/* force_delete */ , (void*)0);
