...
_Bool comma_instead_of_semicolon_100;
_Bool Value_101;
_Bool normal_if_102;
void* __right_value80 = (void*)0;
struct CVALUE* conditional_value_103;
...
struct CVALUE* conditional_value_104;
    ...
    in_loop_97=info->in_loop;
    info->in_loop=(_Bool)1;
    block_98=self->mBlock;
    add_come_code(info,"do {\n");
    transpile_block(block_98,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    expression_node_99=self->mExpressionNode;
    comma_instead_of_semicolon_100=info->comma_instead_of_semicolon;
    info->comma_instead_of_semicolon=(_Bool)1;
    Value_101=node_compile(expression_node_99,info);
    if(    !Value_101    ) {
        return (_Bool)0;
    }
    else {
    }
    info->comma_instead_of_semicolon=comma_instead_of_semicolon_100;
    normal_if_102=(_Bool)1;
    if(    existance_free_right_value_objects(info)    ) {
        normal_if_102=(_Bool)0;
    }
    add_come_code(info,"} while(");
    if(    normal_if_102    ) {
        conditional_value_103=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        add_come_code(info,"%s",conditional_value_103->c_value);
        come_call_finalizer(CVALUE_finalize, conditional_value_103, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    else {
        conditional_value_104=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        transpile_conditional_with_free_right_object_value((struct CVALUE*)come_increment_ref_count(conditional_value_104),info);
        come_call_finalizer(CVALUE_finalize, conditional_value_104, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    add_come_code(info,");\n");
    transpiler_clear_last_code(info);
    info->in_loop=in_loop_97;
    return (_Bool)1;
}
...
struct sNode* __result_obj__56;
    if(    charp_operator_equals(buf,"do")    ) {
        sname_105=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "10do_while.c", 81, "char*"));
        sline_106=info->sline;
        block_107=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        buf2_108=(char*)come_increment_ref_count(parse_word(info));
        if(        string_operator_not_equals(buf2_108,"while")        ) {
        ...
        (sname_105 = come_decrement_ref_count(sname_105, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
        come_call_finalizer(sBlock_finalize, block_107, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
        (buf2_108 = come_decrement_ref_count(buf2_108, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
        ((expression_node_109) ? expression_node_109 = come_decrement_ref_count(expression_node_109, ((struct sNode*)expression_node_109)->finalize, ((struct sNode*)expression_node_109)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,(void*)0):(void*)0);
...
struct sDoWhileNode* result_110;
...
struct sDoWhileNode* __result_obj__54;
    ...
    result_110=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc_v2(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "struct sDoWhileNode*"));
    if(    self!=((void*)0)    ) {
        result_110->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)    ) {
        __dec_obj38=result_110->sname,
        result_110->sname=(char*)come_increment_ref_count((char*)come_memdup(self->sname, "sDoWhileNode_clone", 5, "char*"));
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)    ) {
        __dec_obj39=result_110->mExpressionNode,
        result_110->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)    ) {
        __dec_obj40=result_110->mBlock,
        result_110->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
        come_call_finalizer(sBlock_finalize, __dec_obj40,(void*)0, (void*)0, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, (void*)0);
    }
    __result_obj__54 = result_110;
    come_call_finalizer(sDoWhileNode_finalize, result_110, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
