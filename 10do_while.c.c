...
struct sDoWhileNode* __result101__;
...
char* __result102__;
    __result102__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value144=__builtin_string("sDoWhileNode")));
...
struct sNode* __result106__;
    if(    charp_operator_equals(buf,"do")) {
        ...
        __result105__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value157=_inf_value1));
    ...
    __result106__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value158=string_node_v9(buf,head,head_sline,info)));
