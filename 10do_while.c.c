...
int num_while_conditional_stack_324;
    ...
    if(    normal_if_320) {
        ...
        come_call_finalizer3(conditional_value_321,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    else {
...
struct sNode* __result238__;
    if(    charp_operator_equals(buf,"do")) {
        ...
        sname_325 = come_decrement_ref_count2(sname_325, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        come_call_finalizer3(block_327,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        ...
        come_call_finalizer3(__right_value280,sDoWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
...
struct sDoWhileNode* __result236__;
    ...
    come_call_finalizer3(result_330,sDoWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
