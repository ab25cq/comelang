...
struct sDoWhileNode* __result291__;
...
char* __result292__;
    __result292__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value341=__builtin_string("sDoWhileNode")));
...
struct sNode* __result297__;
    if(    charp_operator_equals(buf,"do")) {
        ...
        if(        string_operator_not_equals(buf2_472,"while")) {
            ...
            come_call_finalizer3(__right_value348,tuple2$2int$char$ph$p_finalize, 0, 1, 0, 0, __result_obj__);
            exit(2);
        ...
        __result296__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value356=_inf_value1));
        ...
        ((expression_node_475) ? expression_node_475 = come_decrement_ref_count2(expression_node_475, ((struct sNode*)expression_node_475)->finalize, ((struct sNode*)expression_node_475)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,0/*force_delete*/, (void*)0):0);
        come_call_finalizer3(__right_value351,sDoWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
    ...
    __result297__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value357=string_node_v9(buf,head,head_sline,info)));
...
static struct sDoWhileNode* sDoWhileNode_clone(struct sDoWhileNode* self){
void* __result_obj__=(void*)0;
struct sDoWhileNode* __result294__;
...
struct sDoWhileNode* __result295__;
    if(    self==(void*)0) {
    ...
    __result295__ = gComeFunResultObject = __result_obj__ = result_476;
