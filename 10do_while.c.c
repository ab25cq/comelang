...
struct sDoWhileNode* __result258__;
...
char* __result259__;
    __result259__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value307=__builtin_string("sDoWhileNode")));
...
struct sNode* expression_node_341;
_Bool comma_instead_of_semicolon_342;
_Bool Value_343;
_Bool normal_if_344;
void* __right_value308 = (void*)0;
struct CVALUE* conditional_value_345;
void* __right_value309 = (void*)0;
struct CVALUE* conditional_value_346;
int num_while_conditional_stack_348;
    if(    info->comma_instead_of_semicolon) {
        err_msg(info,"In conditional operator comelang can't use do while statment");
        return (_Bool)0;
    }
    in_loop_339=info->in_loop;
    info->in_loop=(_Bool)1;
    block_340=self->mBlock;
    add_come_code(info,"do {\n");
    transpile_block(block_340,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    expression_node_341=self->mExpressionNode;
    comma_instead_of_semicolon_342=info->comma_instead_of_semicolon;
    info->comma_instead_of_semicolon=(_Bool)1;
    info->without_semicolon=(_Bool)1;
    Value_343=node_compile(expression_node_341,info);
    if(    !Value_343) {
        return (_Bool)0;
    }
    else {
    ...
    info->comma_instead_of_semicolon=comma_instead_of_semicolon_342;
    normal_if_344=(_Bool)1;
    if(    existance_free_right_value_objects(info)) {
        normal_if_344=(_Bool)0;
    }
    if(    normal_if_344) {
        conditional_value_345=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        dec_stack_ptr(1,info);
        add_come_code(info,"} while(%s);\n",conditional_value_345->c_value);
        /*i*/come_call_finalizer3(conditional_value_345,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    else {
        conditional_value_346=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        dec_stack_ptr(1,info);
        static int num_while_condtional_347=0;
        add_come_code_at_function_head(info,"_Bool _do_while_condtional%d;\n",++num_while_condtional_347);
        num_while_conditional_stack_348=num_while_condtional_347;
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_condtional_347,conditional_value_346->c_value);
        add_last_code_to_source_with_comma(info);
        free_right_value_objects(info,(_Bool)1);
        add_come_code(info,"_do_while_condtional%d);\n",num_while_conditional_stack_348);
        /*i*/come_call_finalizer3(conditional_value_346,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    transpiler_clear_last_code(info);
    info->in_loop=in_loop_339;
    return (_Bool)1;
}
...
struct sBlock* block_351;
void* __right_value312 = (void*)0;
char* buf2_352;
void* __right_value313 = (void*)0;
struct sNode* expression_node_353;
...
struct sNode* __result263__;
    if(    charp_operator_equals(buf,"do")) {
        ...
        block_351=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        buf2_352=(char*)come_increment_ref_count(parse_word(info));
        if(        string_operator_not_equals(buf2_352,"while")) {
            err_msg(info,"require while");
            exit(2);
        }
        expected_next_character(40,info);
        expression_node_353=(struct sNode*)come_increment_ref_count(expression_v13(info));
        expected_next_character(41,info);
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "10do_while.c", 109, "struct sNode");
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value315=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 109, "sDoWhileNode")),(struct sNode*)come_increment_ref_count(expression_node_353),block_351,info))));
        ...
        __result262__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value320=_inf_value1));
        /* U13 */sname_349 = come_decrement_ref_count2(sname_349, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(block_351,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        /* U13 */buf2_352 = come_decrement_ref_count2(buf2_352, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        if(expression_node_353) { expression_node_353 = come_decrement_ref_count2(expression_node_353, ((struct sNode*)expression_node_353)->finalize, ((struct sNode*)expression_node_353)->_protocol_obj, 0, 0, 0, (void*)0); } 
        /*g*/come_call_finalizer3(__right_value315,sDoWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
    ...
    __result263__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value321=string_node_v9(buf,head,head_sline,info)));
...
static struct sDoWhileNode* sDoWhileNode_clone(struct sDoWhileNode* self){
void* __result_obj__=(void*)0;
struct sDoWhileNode* __result260__;
void* __right_value316 = (void*)0;
struct sDoWhileNode* result_354;
...
struct sDoWhileNode* __result261__;
    if(    self==(void*)0) {
        __result260__ = gComeFunResultObject = __result_obj__ = (void*)0;
        gComeFunResultObject = (void*)0;
        return __result260__;
    }
    result_354=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "sDoWhileNode"));
    if(    self!=((void*)0)) {
        result_354->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj78=result_354->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj79=result_354->mExpressionNode;
        result_354->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj80=result_354->mBlock;
        result_354->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
        come_call_finalizer3(__dec_obj80,sBlock_finalize, 0, 0, 0, 0, (void*)0);
    }
    __result261__ = gComeFunResultObject = __result_obj__ = result_354;
    /*i*/come_call_finalizer3(result_354,sDoWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
