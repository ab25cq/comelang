...
struct sNode* __result_obj__57;
    if(({    (_condtional_value_X236=(charp_operator_equals(buf,"do")));    _condtional_value_X236;    })) {
        sname=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "10do_while.c", 68, "char*"));
        sline=info->sline;
        ...
        if(({        (_condtional_value_X237=(string_operator_not_equals(buf2,"while")));        _condtional_value_X237;        })) {
        ...
        _inf_value1=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "10do_while.c", 87, "struct sNode");
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value87=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc_v2(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 87, "struct sDoWhileNode*")),(struct sNode*)come_increment_ref_count(expression_node),block,info))));
...
struct sDoWhileNode* __result_obj__55;
    ...
    if(({    (_condtional_value_X242=(self!=((void*)0)&&self->mExpressionNode!=((void*)0)));    _condtional_value_X242;    })) {
    ...
    if(({    (_condtional_value_X243=(self!=((void*)0)&&self->mBlock!=((void*)0)));    _condtional_value_X243;    })) {
