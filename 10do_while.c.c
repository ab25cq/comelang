...
struct sDoWhileNode* __result271__;
...
char* __result272__;
    __result272__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value335=__builtin_string("sDoWhileNode")));
...
_Bool sDoWhileNode_compile(struct sDoWhileNode* self, struct sInfo* info){
_Bool in_loop_363;
struct sBlock* block_364;
struct sNode* expression_node_365;
_Bool comma_instead_of_semicolon_366;
_Bool Value_367;
_Bool normal_if_368;
...
int num_while_conditional_stack_372;
    if(    info->comma_instead_of_semicolon) {
        err_msg(info,"In conditional operator comelang can't use do while statment");
        return (_Bool)0;
    }
    in_loop_363=info->in_loop;
    info->in_loop=(_Bool)1;
    block_364=self->mBlock;
    add_come_code(info,"do {\n");
    transpile_block(block_364,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    expression_node_365=self->mExpressionNode;
    comma_instead_of_semicolon_366=info->comma_instead_of_semicolon;
    info->comma_instead_of_semicolon=(_Bool)1;
    info->without_semicolon=(_Bool)1;
    Value_367=node_compile(expression_node_365,info);
    if(    !Value_367) {
        return (_Bool)0;
    }
    else {
    ...
    info->comma_instead_of_semicolon=comma_instead_of_semicolon_366;
    ...
    if(    normal_if_368) {
        ...
        dec_stack_ptr(1,info);
        static int num_while_condtional_371=0;
        add_come_code_at_function_head(info,"_Bool _do_while_condtional%d;\n",++num_while_condtional_371);
        num_while_conditional_stack_372=num_while_condtional_371;
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_condtional_371,conditional_value_370->c_value);
        add_last_code_to_source_with_comma(info);
        free_right_value_objects(info,(_Bool)1);
        add_come_code(info,"_do_while_condtional%d);\n",num_while_conditional_stack_372);
        come_call_finalizer3(conditional_value_370,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    transpiler_clear_last_code(info);
    info->in_loop=in_loop_363;
    return (_Bool)1;
}
...
struct sBlock* block_375;
void* __right_value340 = (void*)0;
char* buf2_376;
void* __right_value341 = (void*)0;
struct sNode* expression_node_377;
...
struct sNode* __result276__;
    if(    charp_operator_equals(buf,"do")) {
        sname_373=(char*)come_increment_ref_count(string_clone(info->sname));
        sline_374=info->sline;
        block_375=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        buf2_376=(char*)come_increment_ref_count(parse_word(info));
        if(        string_operator_not_equals(buf2_376,"while")) {
            err_msg(info,"require while");
            exit(2);
        }
        expected_next_character(40,info);
        expression_node_377=(struct sNode*)come_increment_ref_count(expression_v13(info));
        expected_next_character(41,info);
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "10do_while.c", 111, "struct sNode");
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value343=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 111, "sDoWhileNode")),(struct sNode*)come_increment_ref_count(expression_node_377),block_375,info))));
        ...
        __result275__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value348=_inf_value1));
        sname_373 = come_decrement_ref_count2(sname_373, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        come_call_finalizer3(block_375,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        buf2_376 = come_decrement_ref_count2(buf2_376, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        if(expression_node_377) { expression_node_377 = come_decrement_ref_count2(expression_node_377, ((struct sNode*)expression_node_377)->finalize, ((struct sNode*)expression_node_377)->_protocol_obj, 0, 0, 0, (void*)0); } 
        come_call_finalizer3(__right_value343,sDoWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
    ...
    __result276__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value349=string_node_v9(buf,head,head_sline,info)));
...
static struct sDoWhileNode* sDoWhileNode_clone(struct sDoWhileNode* self){
void* __result_obj__=(void*)0;
struct sDoWhileNode* __result273__;
void* __right_value344 = (void*)0;
struct sDoWhileNode* result_378;
...
struct sDoWhileNode* __result274__;
    if(    self==(void*)0) {
        __result273__ = gComeFunResultObject = __result_obj__ = (void*)0;
        gComeFunResultObject = (void*)0;
        return __result273__;
    }
    result_378=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "sDoWhileNode"));
    if(    self!=((void*)0)) {
        result_378->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj119=result_378->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj120=result_378->mExpressionNode;
        result_378->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode));
        if(__dec_obj120) { __dec_obj120 = come_decrement_ref_count2(__dec_obj120, ((struct sNode*)__dec_obj120)->finalize, ((struct sNode*)__dec_obj120)->_protocol_obj, 0,0,0, (void*)0); };
    }
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj121=result_378->mBlock;
        result_378->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
    ...
    come_call_finalizer3(result_378,sDoWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
