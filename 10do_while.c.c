...
struct sDoWhileNode* __result102__;
    ...
    /*i*/come_call_finalizer3(self,sDoWhileNode_finalize, 0, 0, 1, 0, (void*)0);
...
char* __result103__;
    __result103__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value144=__builtin_string("sDoWhileNode")));
...
_Bool sDoWhileNode_compile(struct sDoWhileNode* self, struct sInfo* info){
_Bool in_loop_136;
struct sBlock* block_137;
struct sNode* expression_node_138;
_Bool comma_instead_of_semicolon_139;
_Bool Value_140;
_Bool normal_if_141;
...
int num_while_conditional_stack_145;
    ...
    block_137=self->mBlock;
    add_come_code(info,"do {\n");
    transpile_block(block_137,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    expression_node_138=self->mExpressionNode;
    comma_instead_of_semicolon_139=info->comma_instead_of_semicolon;
    info->comma_instead_of_semicolon=(_Bool)1;
    info->without_semicolon=(_Bool)1;
    Value_140=node_compile(expression_node_138,info);
    if(    !Value_140) {
        return (_Bool)0;
    }
    else {
    ...
    info->comma_instead_of_semicolon=comma_instead_of_semicolon_139;
    ...
    if(    normal_if_141) {
        ...
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_condtional_144,conditional_value_143->c_value);
...
struct sNode* __result107__;
    if(    charp_operator_equals(buf,"do")) {
        ...
        block_148=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        buf2_149=(char*)come_increment_ref_count(parse_word(info));
        if(        string_operator_not_equals(buf2_149,"while")) {
            err_msg(info,"require while");
            exit(2);
        }
        expected_next_character(40,info);
        expression_node_150=(struct sNode*)come_increment_ref_count(expression_v13(info));
        expected_next_character(41,info);
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "10do_while.c", 111, "struct sNode");
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value152=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 111, "sDoWhileNode")),(struct sNode*)come_increment_ref_count(expression_node_150),block_148,info))));
        ...
        __result106__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value157=_inf_value1));
        /* U13 */sname_146 = come_decrement_ref_count2(sname_146, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(block_148,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        /* U13 */buf2_149 = come_decrement_ref_count2(buf2_149, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        if(expression_node_150) { expression_node_150 = come_decrement_ref_count2(expression_node_150, ((struct sNode*)expression_node_150)->finalize, ((struct sNode*)expression_node_150)->_protocol_obj, 0, 0, 0, (void*)0); } 
        /*g*/come_call_finalizer3(__right_value152,sDoWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
    ...
    __result107__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value158=string_node_v9(buf,head,head_sline,info)));
...
static struct sDoWhileNode* sDoWhileNode_clone(struct sDoWhileNode* self){
void* __result_obj__=(void*)0;
struct sDoWhileNode* __result104__;
void* __right_value153 = (void*)0;
struct sDoWhileNode* result_151;
...
struct sDoWhileNode* __result105__;
    if(    self==(void*)0) {
        __result104__ = gComeFunResultObject = __result_obj__ = (void*)0;
        gComeFunResultObject = (void*)0;
        return __result104__;
    }
    result_151=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "sDoWhileNode"));
    if(    self!=((void*)0)) {
        result_151->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj62=result_151->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj63=result_151->mExpressionNode;
    ...
    /*i*/come_call_finalizer3(result_151,sDoWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
