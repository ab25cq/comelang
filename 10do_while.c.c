...
_Bool sDoWhileNode_compile(struct sDoWhileNode* self, struct sInfo* info){
_Bool in_loop_144;
struct sBlock* block_145;
struct sNode* expression_node_146;
_Bool comma_instead_of_semicolon_147;
_Bool normal_if_148;
void* __right_value144 = (void*)0;
struct CVALUE* conditional_value_149;
void* __right_value145 = (void*)0;
struct CVALUE* conditional_value_150;
int num_while_conditional_stack_152;
    if(    info->comma_instead_of_semicolon) {
        err_msg(info,"In conditional operator comelang can't use do while statment");
        return (_Bool)0;
    }
    in_loop_144=info->in_loop;
    info->in_loop=(_Bool)1;
    block_145=self->mBlock;
    add_come_code(info,"do {\n");
    transpile_block(block_145,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    expression_node_146=self->mExpressionNode;
    comma_instead_of_semicolon_147=info->comma_instead_of_semicolon;
    ...
    info->comma_instead_of_semicolon=comma_instead_of_semicolon_147;
    normal_if_148=(_Bool)1;
    if(    existance_free_right_value_objects(info)) {
        normal_if_148=(_Bool)0;
    }
    if(    normal_if_148) {
        conditional_value_149=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        dec_stack_ptr(1,info);
        add_come_code(info,"} while(%s);\n",conditional_value_149->c_value);
        /*i*/come_call_finalizer3(conditional_value_149,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    else {
        conditional_value_150=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        dec_stack_ptr(1,info);
        static int num_while_condtional_151=0;
        add_come_code_at_function_head(info,"_Bool _do_while_condtional%d;\n",++num_while_condtional_151);
        num_while_conditional_stack_152=num_while_condtional_151;
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_condtional_151,conditional_value_150->c_value);
        add_last_code_to_source_with_comma(info);
        free_right_value_objects(info,(_Bool)1);
        add_come_code(info,"_do_while_condtional%d);\n",num_while_conditional_stack_152);
        /*i*/come_call_finalizer3(conditional_value_150,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    transpiler_clear_last_code(info);
    info->in_loop=in_loop_144;
    return (_Bool)1;
}
...
struct sNode* __result105__;
    if(    charp_operator_equals(buf,"do")) {
        sname_153=(char*)come_increment_ref_count(string_clone(info->sname));
        sline_154=info->sline;
        block_155=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        buf2_156=(char*)come_increment_ref_count(parse_word(info));
        if(        string_operator_not_equals(buf2_156,"while")) {
            err_msg(info,"require while");
            exit(2);
        }
        expected_next_character(40,info);
        expression_node_157=(struct sNode*)come_increment_ref_count(expression_v13(info));
        ...
        /* U13 */sname_153 = come_decrement_ref_count2(sname_153, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(block_155,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        /* U13 */buf2_156 = come_decrement_ref_count2(buf2_156, (void*)0, (void*)0, 0, 0, 0, (void*)0);
...
struct sBlock* __dec_obj62;
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        if(        self->mBlock==gComeFunResultObject) {
            ...
            come_call_finalizer3(__dec_obj62,sBlock_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
...
struct sDoWhileNode* result_158;
...
struct sDoWhileNode* __result103__;
    ...
    result_158=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "sDoWhileNode"));
    if(    self!=((void*)0)) {
        result_158->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj63=result_158->sname;
        result_158->sname=(char*)come_increment_ref_count(string_clone(self->sname));
        /*G*/ __dec_obj63 = come_decrement_ref_count2(__dec_obj63, (void*)0, (void*)0, 0,0,0, (void*)0);
    }
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj64=result_158->mExpressionNode;
        result_158->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj65=result_158->mBlock;
        result_158->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
        come_call_finalizer3(__dec_obj65,sBlock_finalize, 0, 0, 0, 0, (void*)0);
    }
    __result103__ = gComeFunResultObject = __result_obj__ = result_158;
    /*i*/come_call_finalizer3(result_158,sDoWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
