...
struct sDoWhileNode* __result_obj__51;
    ...
    __result_obj__51 = (struct sDoWhileNode*)come_increment_ref_count(self);
    /*c*/ come_call_finalizer3(self,sDoWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 1/* force_delete */ , (void*)0);
    ...
    /*c*/ come_call_finalizer3(__result_obj__51,sDoWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 0/* force_delete */ , (void*)0);
...
char* __result_obj__52;
    __result_obj__52 = (char*)come_increment_ref_count(((char*)(__right_value78=__builtin_string("sDoWhileNode"))));
...
_Bool comma_instead_of_semicolon_95;
_Bool without_semicolon_96;
_Bool Value_97;
_Bool normal_if_98;
void* __right_value80 = (void*)0;
struct CVALUE* conditional_value_99;
...
struct CVALUE* conditional_value_100;
    ...
    comma_instead_of_semicolon_95=info->comma_instead_of_semicolon;
    info->comma_instead_of_semicolon=(_Bool)1;
    without_semicolon_96=info->without_semicolon;
    info->without_semicolon=(_Bool)1;
    Value_97=node_compile(expression_node_94,info);
    if(    !Value_97    ) {
        return (_Bool)0;
    }
    else {
    }
    info->without_semicolon=without_semicolon_96;
    info->comma_instead_of_semicolon=comma_instead_of_semicolon_95;
    normal_if_98=(_Bool)1;
    if(    existance_free_right_value_objects(info)    ) {
        normal_if_98=(_Bool)0;
    }
    add_come_code(info,"} while(");
    if(    normal_if_98    ) {
        conditional_value_99=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        add_come_code(info,"%s",conditional_value_99->c_value);
        /*c*/ come_call_finalizer3(conditional_value_99,CVALUE_finalize, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
    }
    else {
        conditional_value_100=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        transpile_conditional_with_free_right_object_value((struct CVALUE*)come_increment_ref_count(conditional_value_100),info);
        /*c*/ come_call_finalizer3(conditional_value_100,CVALUE_finalize, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
    }
    add_come_code(info,");\n");
    transpiler_clear_last_code(info);
    info->in_loop=in_loop_92;
    return (_Bool)1;
}
...
struct sNode* expression_node_105;
...
struct sNode* __result_obj__56;
    if(    charp_operator_equals(buf,"do")    ) {
        sname_101=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "10do_while.c", 80, "char*"));
        ...
        if(        string_operator_not_equals(buf2_104,"while")        ) {
            ((struct tuple2$2int$bool$*)(__right_value85=err_msg(info,"require while")));
        ...
        expression_node_105=(struct sNode*)come_increment_ref_count(expression_v13(info));
        expected_next_character(41,info);
        _inf_value1=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "10do_while.c", 99, "struct sNode");
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value88=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc_v2(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 99, "struct sDoWhileNode*")),(struct sNode*)come_increment_ref_count(expression_node_105),block_103,info))));
        ...
        __result_obj__55 = (struct sNode*)come_increment_ref_count(((struct sNode*)(__right_value93=_inf_value1)));
        (sname_101 = come_decrement_ref_count(sname_101, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        /*c*/ come_call_finalizer3(block_103,sBlock_finalize, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
        (buf2_104 = come_decrement_ref_count(buf2_104, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        ((expression_node_105) ? expression_node_105 = come_decrement_ref_count(expression_node_105, ((struct sNode*)expression_node_105)->finalize, ((struct sNode*)expression_node_105)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,0/*force_delete*/, (void*)0):(void*)0);
        /*c*/ come_call_finalizer3(__right_value88,sDoWhileNode_finalize, 0/* alloca value */, 1/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
    ...
    __result_obj__56 = (struct sNode*)come_increment_ref_count(((struct sNode*)(__right_value94=string_node_v9(buf,head,head_sline,info))));
...
static struct sDoWhileNode* sDoWhileNode_clone(struct sDoWhileNode* self){
struct sDoWhileNode* __result_obj__53;
void* __right_value89 = (void*)0;
struct sDoWhileNode* result_106;
...
struct sDoWhileNode* __result_obj__54;
    if(    self==(void*)0    ) {
        __result_obj__53 = (void*)0;
        return __result_obj__53;
    }
    result_106=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc_v2(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "struct sDoWhileNode*"));
    if(    self!=((void*)0)    ) {
        result_106->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)    ) {
        __dec_obj38=result_106->sname,
        result_106->sname=(char*)come_increment_ref_count((char*)come_memdup(self->sname, "sDoWhileNode_clone", 5, "char*"));
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)    ) {
        __dec_obj39=result_106->mExpressionNode,
        result_106->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)    ) {
        __dec_obj40=result_106->mBlock,
        result_106->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
    ...
    /*c*/ come_call_finalizer3(result_106,sDoWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 1/* force_delete */ , (void*)0);
