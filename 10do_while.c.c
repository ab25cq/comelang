...
struct sDoWhileNode* __result_obj__213;
    ...
    __result_obj__213 = (struct sDoWhileNode*)come_increment_ref_count(self);
    ...
    /*c*/ come_call_finalizer3(__result_obj__213,sDoWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 0/* force_delete */ , (void*)0);
...
char* __result_obj__214;
    __result_obj__214 = (char*)come_increment_ref_count(((char*)(__right_value265=__builtin_string("sDoWhileNode"))));
...
_Bool sDoWhileNode_compile(struct sDoWhileNode* self, struct sInfo* info){
_Bool in_loop_321;
struct sBlock* block_322;
struct sNode* expression_node_323;
_Bool comma_instead_of_semicolon_324;
_Bool without_semicolon_325;
_Bool Value_326;
_Bool normal_if_327;
void* __right_value266 = (void*)0;
struct CVALUE* conditional_value_328;
void* __right_value267 = (void*)0;
struct CVALUE* conditional_value_329;
int num_while_conditional_stack_331;
    if(    info->comma_instead_of_semicolon) {
        err_msg(info,"In conditional operator comelang can't use do while statment");
    }
    in_loop_321=info->in_loop;
    info->in_loop=(_Bool)1;
    block_322=self->mBlock;
    add_come_code(info,"do {\n");
    transpile_block(block_322,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    expression_node_323=self->mExpressionNode;
    comma_instead_of_semicolon_324=info->comma_instead_of_semicolon;
    info->comma_instead_of_semicolon=(_Bool)1;
    without_semicolon_325=info->without_semicolon;
    info->without_semicolon=(_Bool)1;
    Value_326=node_compile(expression_node_323,info);
    if(    !Value_326) {
        return (_Bool)0;
    }
    else {
    }
    info->without_semicolon=without_semicolon_325;
    info->comma_instead_of_semicolon=comma_instead_of_semicolon_324;
    normal_if_327=(_Bool)1;
    if(    existance_free_right_value_objects(info)) {
        normal_if_327=(_Bool)0;
    }
    if(    normal_if_327) {
        conditional_value_328=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        add_come_code(info,"} while(%s);\n",conditional_value_328->c_value);
        /*c*/ come_call_finalizer3(conditional_value_328,CVALUE_finalize, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
    }
    else {
        conditional_value_329=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        static int num_while_condtional_330=0;
        add_come_code_at_function_head(info,"_Bool _do_while_condtional%d;\n",++num_while_condtional_330);
        num_while_conditional_stack_331=num_while_condtional_330;
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_condtional_330,conditional_value_329->c_value);
        add_last_code_to_source_with_comma(info);
        free_right_value_objects(info,(_Bool)1);
        add_come_code(info,"_do_while_condtional%d);\n",num_while_conditional_stack_331);
        /*c*/ come_call_finalizer3(conditional_value_329,CVALUE_finalize, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
    }
    transpiler_clear_last_code(info);
    info->in_loop=in_loop_321;
    return (_Bool)1;
}
...
struct sNode* __result_obj__218;
    if(    charp_operator_equals(buf,"do")) {
        sname_332=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "10do_while.c", 90, "char*"));
        sline_333=info->sline;
        block_334=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        buf2_335=(char*)come_increment_ref_count(parse_word(info));
        if(        string_operator_not_equals(buf2_335,"while")) {
        ...
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value273=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc_v2(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 109, "struct sDoWhileNode*")),(struct sNode*)come_increment_ref_count(expression_node_336),block_334,info))));
        ...
        __result_obj__217 = (struct sNode*)come_increment_ref_count(((struct sNode*)(__right_value278=_inf_value1)));
        (sname_332 = come_decrement_ref_count(sname_332, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        /*c*/ come_call_finalizer3(block_334,sBlock_finalize, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
        (buf2_335 = come_decrement_ref_count(buf2_335, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        ((expression_node_336) ? expression_node_336 = come_decrement_ref_count(expression_node_336, ((struct sNode*)expression_node_336)->finalize, ((struct sNode*)expression_node_336)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,0/*force_delete*/, (void*)0):(void*)0);
        /*c*/ come_call_finalizer3(__right_value273,sDoWhileNode_finalize, 0/* alloca value */, 1/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
    ...
    __result_obj__218 = (struct sNode*)come_increment_ref_count(((struct sNode*)(__right_value279=string_node_v9(buf,head,head_sline,info))));
...
struct sDoWhileNode* result_337;
...
struct sDoWhileNode* __result_obj__216;
    if(    self==(void*)0) {
        __result_obj__215 = (void*)0;
        return __result_obj__215;
    }
    result_337=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc_v2(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "struct sDoWhileNode*"));
    if(    self!=((void*)0)) {
        result_337->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj51=result_337->sname,
        result_337->sname=(char*)come_increment_ref_count((char*)come_memdup(self->sname, "sDoWhileNode_clone", 5, "char*"));
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj52=result_337->mExpressionNode,
        result_337->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj53=result_337->mBlock,
        result_337->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
        /*b*/ come_call_finalizer3(__dec_obj53,sBlock_finalize, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, 0/* force_delete_ */, (void*)0);
    }
    __result_obj__216 = result_337;
    /*c*/ come_call_finalizer3(result_337,sDoWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 1/* force_delete */ , (void*)0);
