...
char* __result_obj__52;
    __result_obj__52 = (char*)come_increment_ref_count(((char*)(__right_value80=__builtin_string("sDoWhileNode"))));
...
struct sNode* __result_obj__57;
    if(({    (_condtional_value_X235=(charp_operator_equals(buf,"do")));    _condtional_value_X235;    })) {
        sname=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "10do_while.c", 63, "char*"));
        sline=info->sline;
        ...
        if(({        (_condtional_value_X236=(string_operator_not_equals(buf2,"while")));        _condtional_value_X236;        })) {
        ...
        _inf_value1=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "10do_while.c", 82, "struct sNode");
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value87=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc_v2(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 82, "struct sDoWhileNode*")),(struct sNode*)come_increment_ref_count(expression_node),block,info))));
        ...
        __result_obj__56 = (struct sNode*)come_increment_ref_count(((struct sNode*)(__right_value92=_inf_value1)));
        ...
        ((expression_node) ? expression_node = come_decrement_ref_count(expression_node, ((struct sNode*)expression_node)->finalize, ((struct sNode*)expression_node)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,(void*)0):(void*)0);
        come_call_finalizer(sDoWhileNode_finalize, __right_value87, (void*)0, (void*)0, 0/* alloca value */, 1/* no_decrement */, 0/* no_free */, (void*)0);
    ...
    __result_obj__57 = (struct sNode*)come_increment_ref_count(((struct sNode*)(__right_value93=string_node_v9(buf,head,head_sline,info))));
...
struct sDoWhileNode* __result_obj__55;
    ...
    if(({    (_condtional_value_X241=(self!=((void*)0)&&self->mExpressionNode!=((void*)0)));    _condtional_value_X241;    })) {
    ...
    if(({    (_condtional_value_X242=(self!=((void*)0)&&self->mBlock!=((void*)0)));    _condtional_value_X242;    })) {
    ...
    come_call_finalizer(sDoWhileNode_finalize, result, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
