...
struct sNode* __result289__;
    if(    charp_operator_equals(buf,"do")) {
        ...
        expression_node_445=(struct sNode*)come_increment_ref_count(expression_v13(info));
        ...
        if(expression_node_445) { expression_node_445 = come_decrement_ref_count2(expression_node_445, ((struct sNode*)expression_node_445)->finalize, ((struct sNode*)expression_node_445)->_protocol_obj, 0, 0, 0, (void*)0); } 
...
struct sDoWhileNode* result_447;
...
struct sDoWhileNode* __result287__;
    ...
    result_447=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "struct sDoWhileNode", sDoWhileNode_finalize, sDoWhileNode_clone, sDoWhileNode_get_hash_key, sDoWhileNode_equals));
    if(    self!=((void*)0)) {
        result_447->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj101=result_447->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj102=result_447->mExpressionNode;
        result_447->mExpressionNode=(struct sNode*)come_increment_ref_count(come_call_cloner(sNode_clone, self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj103=result_447->mBlock;
    ...
    __result287__ = gComeFunResultObject = __result_obj__ = result_447;
    come_call_finalizer3(result_447,sDoWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
unsigned int result_446;
    ...
    result_446+=int_get_hash_key(((int)self->mExpressionNode));
    result_446+=int_get_hash_key(((int)self->mBlock));
    return result_446;
}
