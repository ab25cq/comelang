...
struct sDoWhileNode* __result103__;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj62=result_151->mExpressionNode;
    ...
    __result103__ = gComeFunResultObject = __result_obj__ = result_151;
