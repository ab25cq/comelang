...
struct sDoWhileNode* __result284__;
...
char* __result285__;
    __result285__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value327=__builtin_string("sDoWhileNode")));
...
_Bool comma_instead_of_semicolon_432;
_Bool Value_433;
_Bool normal_if_434;
...
int num_while_conditional_stack_438;
    if(    info->comma_instead_of_semicolon) {
        err_msg(info,"In conditional operator comelang can't use do while statment");
        return (_Bool)0;
    }
    in_loop_429=info->in_loop;
    info->in_loop=(_Bool)1;
    block_430=self->mBlock;
    add_come_code(info,"do {\n");
    transpile_block(block_430,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    expression_node_431=self->mExpressionNode;
    comma_instead_of_semicolon_432=info->comma_instead_of_semicolon;
    info->comma_instead_of_semicolon=(_Bool)1;
    info->without_semicolon=(_Bool)1;
    Value_433=node_compile(expression_node_431,info);
    if(    !Value_433) {
        return (_Bool)0;
    }
    else {
    ...
    info->comma_instead_of_semicolon=comma_instead_of_semicolon_432;
    normal_if_434=(_Bool)1;
    if(    existance_free_right_value_objects(info)) {
        normal_if_434=(_Bool)0;
    }
    if(    normal_if_434) {
        ...
        dec_stack_ptr(1,info);
        static int num_while_condtional_437=0;
        add_come_code_at_function_head(info,"_Bool _do_while_condtional%d;\n",++num_while_condtional_437);
        num_while_conditional_stack_438=num_while_condtional_437;
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_condtional_437,conditional_value_436->c_value);
        add_last_code_to_source_with_comma(info);
        free_right_value_objects(info,(_Bool)1);
        add_come_code(info,"_do_while_condtional%d);\n",num_while_conditional_stack_438);
        come_call_finalizer3(conditional_value_436,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    transpiler_clear_last_code(info);
    info->in_loop=in_loop_429;
    return (_Bool)1;
}
...
struct sNode* expression_node_443;
...
struct sNode* __result289__;
    if(    charp_operator_equals(buf,"do")) {
        sname_439=(char*)come_increment_ref_count(come_call_cloner(string_clone, info->sname));
        sline_440=info->sline;
        block_441=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        buf2_442=(char*)come_increment_ref_count(parse_word(info));
        if(        string_operator_not_equals(buf2_442,"while")) {
            err_msg(info,"require while");
            exit(2);
        }
        expected_next_character(40,info);
        expression_node_443=(struct sNode*)come_increment_ref_count(expression_v13(info));
        ...
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value335=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 111, "struct sDoWhileNode*", (void*)0, (void*)0, (void*)0, (void*)0)),(struct sNode*)come_increment_ref_count(expression_node_443),block_441,info))));
        ...
        __result288__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value340=_inf_value1));
        sname_439 = come_decrement_ref_count2(sname_439, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        come_call_finalizer3(block_441,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        buf2_442 = come_decrement_ref_count2(buf2_442, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        if(expression_node_443) { expression_node_443 = come_decrement_ref_count2(expression_node_443, ((struct sNode*)expression_node_443)->finalize, ((struct sNode*)expression_node_443)->_protocol_obj, 0, 0, 0, (void*)0); } 
        come_call_finalizer3(__right_value335,sDoWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
    ...
    __result289__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value341=string_node_v9(buf,head,head_sline,info)));
...
static struct sDoWhileNode* sDoWhileNode_clone(struct sDoWhileNode* self){
void* __result_obj__=(void*)0;
struct sDoWhileNode* __result286__;
void* __right_value336 = (void*)0;
struct sDoWhileNode* result_444;
...
struct sDoWhileNode* __result287__;
    if(    self==(void*)0) {
        __result286__ = gComeFunResultObject = __result_obj__ = (void*)0;
        gComeFunResultObject = (void*)0;
        return __result286__;
    }
    result_444=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "struct sDoWhileNode*", (void*)0, (void*)0, (void*)0, (void*)0));
    if(    self!=((void*)0)) {
        result_444->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj101=result_444->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj102=result_444->mExpressionNode;
        result_444->mExpressionNode=(struct sNode*)come_increment_ref_count(come_call_cloner(sNode_clone, self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj103=result_444->mBlock;
        result_444->mBlock=(struct sBlock*)come_increment_ref_count(come_call_cloner(sBlock_clone, self->mBlock));
        come_call_finalizer3(__dec_obj103,sBlock_finalize, 0, 0, 0, 0, (void*)0);
    }
    __result287__ = gComeFunResultObject = __result_obj__ = result_444;
    come_call_finalizer3(result_444,sDoWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
