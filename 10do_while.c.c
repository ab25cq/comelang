...
char* __result285__;
    __result285__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value325=__builtin_string("sDoWhileNode")));
...
int num_while_conditional_stack_440;
    if(    info->comma_instead_of_semicolon) {
        multiple_assign_var1=((struct tuple2$2intcharph*)(__right_value326=err_msg(info,"In conditional operator comelang can't use do while statment")));
    ...
    normal_if_436=(_Bool)1;
    if(    existance_free_right_value_objects(info)) {
        normal_if_436=(_Bool)0;
    }
    if(    normal_if_436) {
        ...
        come_call_finalizer3(conditional_value_437,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    else {
        conditional_value_438=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        dec_stack_ptr(1,info);
        static int num_while_condtional_439=0;
        add_come_code_at_function_head(info,"_Bool _do_while_condtional%d;\n",++num_while_condtional_439);
        num_while_conditional_stack_440=num_while_condtional_439;
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_condtional_439,conditional_value_438->c_value);
        add_last_code_to_source_with_comma(info);
        free_right_value_objects(info,(_Bool)1);
        add_come_code(info,"_do_while_condtional%d);\n",num_while_conditional_stack_440);
...
struct sNode* __result290__;
    if(    charp_operator_equals(buf,"do")) {
        sname_441=(char*)come_increment_ref_count(come_call_cloner(string_clone, info->sname));
        sline_442=info->sline;
        block_443=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        buf2_444=(char*)come_increment_ref_count(parse_word(info));
        if(        string_operator_not_equals(buf2_444,"while")) {
            multiple_assign_var2=((struct tuple2$2intcharph*)(__right_value332=err_msg(info,"require while")));
            come_exception_var_c1_445=multiple_assign_var2->v1;
            Err_446=(char*)come_increment_ref_count(multiple_assign_var2->v2);
            ((Err_446)?(puts(Err_446),exit(0)):(0));
            come_call_finalizer3(__right_value332,tuple2$2intcharphp_finalize, 0, 1, 0, 0, __result_obj__);
            exit(2);
            (Err_446 = come_decrement_ref_count2(Err_446, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        }
        expected_next_character(40,info);
        expression_node_447=(struct sNode*)come_increment_ref_count(expression_v13(info));
        ...
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value335=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 112, "struct sDoWhileNode*", (void*)0, (void*)0, (void*)0, (void*)0)),(struct sNode*)come_increment_ref_count(expression_node_447),block_443,info))));
        ...
        __result289__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value340=_inf_value1));
        (sname_441 = come_decrement_ref_count2(sname_441, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        come_call_finalizer3(block_443,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        (buf2_444 = come_decrement_ref_count2(buf2_444, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        ((expression_node_447) ? expression_node_447 = come_decrement_ref_count2(expression_node_447, ((struct sNode*)expression_node_447)->finalize, ((struct sNode*)expression_node_447)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,0/*force_delete*/, (void*)0):0);
        come_call_finalizer3(__right_value335,sDoWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
        ((__right_value340) ? __right_value340 = come_decrement_ref_count2(__right_value340, ((struct sNode*)__right_value340)->finalize, ((struct sNode*)__right_value340)->_protocol_obj, 1/* no_decrement */, 0/*no_free*/,0/*force_delete*/, __result_obj__):0);
        gComeFunResultObject = (void*)0;
    ...
    __result290__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value341=string_node_v9(buf,head,head_sline,info)));
    ((__right_value341) ? __right_value341 = come_decrement_ref_count2(__right_value341, ((struct sNode*)__right_value341)->finalize, ((struct sNode*)__right_value341)->_protocol_obj, 1/* no_decrement */, 0/*no_free*/,0/*force_delete*/, __result_obj__):0);
    gComeFunResultObject = (void*)0;
...
struct sDoWhileNode* result_448;
...
struct sDoWhileNode* __result288__;
    if(    self==(void*)0) {
        __result287__ = gComeFunResultObject = __result_obj__ = (void*)0;
        gComeFunResultObject = (void*)0;
        return __result287__;
    }
    result_448=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "struct sDoWhileNode*", (void*)0, (void*)0, (void*)0, (void*)0));
    if(    self!=((void*)0)) {
        result_448->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj98=result_448->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj99=result_448->mExpressionNode;
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj100=result_448->mBlock;
    ...
    __result288__ = gComeFunResultObject = __result_obj__ = result_448;
    come_call_finalizer3(result_448,sDoWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
