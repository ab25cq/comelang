...
struct sDoWhileNode* __result_obj__51;
    ...
    /*c*/ come_call_finalizer2(sDoWhileNode_finalize, self, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
    ...
    /*c*/ come_call_finalizer2(sDoWhileNode_finalize, __result_obj__51, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
...
_Bool comma_instead_of_semicolon_92;
_Bool Value_93;
_Bool normal_if_94;
...
struct CVALUE* conditional_value_96;
    ...
    transpile_block(block_90,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    expression_node_91=self->mExpressionNode;
    comma_instead_of_semicolon_92=info->comma_instead_of_semicolon;
    info->comma_instead_of_semicolon=(_Bool)1;
    Value_93=node_compile(expression_node_91,info);
    if(    !Value_93    ) {
        return (_Bool)0;
    }
    else {
    }
    info->comma_instead_of_semicolon=comma_instead_of_semicolon_92;
    ...
    if(    normal_if_94    ) {
        ...
        /*c*/ come_call_finalizer2(CVALUE_finalize, conditional_value_95, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    else {
        ...
        /*c*/ come_call_finalizer2(CVALUE_finalize, conditional_value_96, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    add_come_code(info,");\n");
...
struct sNode* __result_obj__56;
    if(    charp_operator_equals(buf,"do")    ) {
        sname_97=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "10do_while.c", 77, "char*"));
        sline_98=info->sline;
        block_99=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        buf2_100=(char*)come_increment_ref_count(parse_word(info));
        if(        string_operator_not_equals(buf2_100,"while")        ) {
            ((struct tuple2$2int$bool$*)(__right_value85=err_msg(info,"require while")));
            /*c*/ come_call_finalizer2(tuple2$2int$bool$$p_finalize, __right_value85, (void*)0, (void*)0, 0/* alloca value */, 1/* no_decrement */, 0/* no_free */, (void*)0);
            exit(2);
        }
        expected_next_character(40,info);
        expression_node_101=(struct sNode*)come_increment_ref_count(expression_v13(info));
        expected_next_character(41,info);
        _inf_value1=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "10do_while.c", 96, "struct sNode");
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value88=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc_v2(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 96, "struct sDoWhileNode*")),(struct sNode*)come_increment_ref_count(expression_node_101),block_99,info))));
        ...
        /*c*/ come_call_finalizer2(sBlock_finalize, block_99, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
        (buf2_100 = come_decrement_ref_count(buf2_100, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
        ((expression_node_101) ? expression_node_101 = come_decrement_ref_count(expression_node_101, ((struct sNode*)expression_node_101)->finalize, ((struct sNode*)expression_node_101)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,(void*)0):(void*)0);
        /*c*/ come_call_finalizer2(sDoWhileNode_finalize, __right_value88, (void*)0, (void*)0, 0/* alloca value */, 1/* no_decrement */, 0/* no_free */, (void*)0);
...
struct sDoWhileNode* result_102;
...
struct sDoWhileNode* __result_obj__54;
    ...
    result_102=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc_v2(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "struct sDoWhileNode*"));
    if(    self!=((void*)0)    ) {
        result_102->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)    ) {
        __dec_obj38=result_102->sname,
        result_102->sname=(char*)come_increment_ref_count((char*)come_memdup(self->sname, "sDoWhileNode_clone", 5, "char*"));
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)    ) {
        __dec_obj39=result_102->mExpressionNode,
        result_102->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)    ) {
        __dec_obj40=result_102->mBlock,
        result_102->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
        /*b*/ come_call_finalizer2(sBlock_finalize, __dec_obj40,(void*)0, (void*)0, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, (void*)0);
    }
    __result_obj__54 = result_102;
    /*c*/ come_call_finalizer2(sDoWhileNode_finalize, result_102, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
