...
struct sDoWhileNode* __result269__;
...
char* __result270__;
    __result270__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value321=__builtin_string("sDoWhileNode")));
...
_Bool comma_instead_of_semicolon_376;
_Bool Value_377;
_Bool normal_if_378;
...
int num_while_conditional_stack_382;
    if(    info->comma_instead_of_semicolon) {
        err_msg(info,"In conditional operator comelang can't use do while statment");
        return (_Bool)0;
    }
    in_loop_373=info->in_loop;
    info->in_loop=(_Bool)1;
    block_374=self->mBlock;
    add_come_code(info,"do {\n");
    transpile_block(block_374,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    expression_node_375=self->mExpressionNode;
    comma_instead_of_semicolon_376=info->comma_instead_of_semicolon;
    info->comma_instead_of_semicolon=(_Bool)1;
    info->without_semicolon=(_Bool)1;
    Value_377=node_compile(expression_node_375,info);
    if(    !Value_377) {
        return (_Bool)0;
    }
    else {
    ...
    info->comma_instead_of_semicolon=comma_instead_of_semicolon_376;
    ...
    if(    normal_if_378) {
        ...
        come_call_finalizer3(conditional_value_379,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    else {
        conditional_value_380=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        dec_stack_ptr(1,info);
        static int num_while_condtional_381=0;
        add_come_code_at_function_head(info,"_Bool _do_while_condtional%d;\n",++num_while_condtional_381);
        num_while_conditional_stack_382=num_while_condtional_381;
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_condtional_381,conditional_value_380->c_value);
        add_last_code_to_source_with_comma(info);
        free_right_value_objects(info,(_Bool)1);
        add_come_code(info,"_do_while_condtional%d);\n",num_while_conditional_stack_382);
        come_call_finalizer3(conditional_value_380,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    transpiler_clear_last_code(info);
    info->in_loop=in_loop_373;
    return (_Bool)1;
}
...
struct sBlock* block_385;
void* __right_value326 = (void*)0;
char* buf2_386;
void* __right_value327 = (void*)0;
struct sNode* expression_node_387;
...
struct sNode* __result274__;
    if(    charp_operator_equals(buf,"do")) {
        sname_383=(char*)come_increment_ref_count(come_call_cloner(string_clone, info->sname));
        sline_384=info->sline;
        block_385=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        buf2_386=(char*)come_increment_ref_count(parse_word(info));
        if(        string_operator_not_equals(buf2_386,"while")) {
            err_msg(info,"require while");
            exit(2);
        }
        expected_next_character(40,info);
        expression_node_387=(struct sNode*)come_increment_ref_count(expression_v13(info));
        expected_next_character(41,info);
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "10do_while.c", 111, "struct sNode", (void*)0, (void*)0);
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value329=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 111, "struct sDoWhileNode*", (void*)0, (void*)0)),(struct sNode*)come_increment_ref_count(expression_node_387),block_385,info))));
        ...
        __result273__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value334=_inf_value1));
        sname_383 = come_decrement_ref_count2(sname_383, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        come_call_finalizer3(block_385,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        buf2_386 = come_decrement_ref_count2(buf2_386, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        if(expression_node_387) { expression_node_387 = come_decrement_ref_count2(expression_node_387, ((struct sNode*)expression_node_387)->finalize, ((struct sNode*)expression_node_387)->_protocol_obj, 0, 0, 0, (void*)0); } 
        come_call_finalizer3(__right_value329,sDoWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
    ...
    __result274__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value335=string_node_v9(buf,head,head_sline,info)));
...
struct sDoWhileNode* result_388;
...
struct sDoWhileNode* __result272__;
    if(    self==(void*)0) {
        __result271__ = gComeFunResultObject = __result_obj__ = (void*)0;
        gComeFunResultObject = (void*)0;
        return __result271__;
    }
    result_388=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "struct sDoWhileNode*", (void*)0, (void*)0));
    if(    self!=((void*)0)) {
        result_388->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj105=result_388->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj106=result_388->mExpressionNode;
        result_388->mExpressionNode=(struct sNode*)come_increment_ref_count(come_call_cloner(sNode_clone, self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj107=result_388->mBlock;
        result_388->mBlock=(struct sBlock*)come_increment_ref_count(come_call_cloner(sBlock_clone, self->mBlock));
        come_call_finalizer3(__dec_obj107,sBlock_finalize, 0, 0, 0, 0, (void*)0);
    }
    __result272__ = gComeFunResultObject = __result_obj__ = result_388;
    come_call_finalizer3(result_388,sDoWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
