...
int num_while_conditional_stack_99;
    ...
    without_semicolon_93=info->without_semicolon;
    info->without_semicolon=(_Bool)1;
    Value_94=node_compile(expression_node_91,info);
    if(    !Value_94) {
        return (_Bool)0;
    }
    else {
    }
    info->without_semicolon=without_semicolon_93;
    info->comma_instead_of_semicolon=comma_instead_of_semicolon_92;
    normal_if_95=(_Bool)1;
    if(    existance_free_right_value_objects(info)) {
        normal_if_95=(_Bool)0;
    }
    if(    normal_if_95) {
        ...
        conditional_value_97=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        static int num_while_condtional_98=0;
        add_come_code_at_function_head(info,"_Bool _do_while_condtional%d;\n",++num_while_condtional_98);
        num_while_conditional_stack_99=num_while_condtional_98;
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_condtional_98,conditional_value_97->c_value);
        add_last_code_to_source_with_comma(info);
        free_right_value_objects(info,(_Bool)1);
        add_come_code(info,"_do_while_condtional%d);\n",num_while_conditional_stack_99);
        /*c*/ come_call_finalizer3(conditional_value_97,CVALUE_finalize, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
    }
...
struct sNode* __result_obj__56;
    if(    charp_operator_equals(buf,"do")) {
        ...
        if(        string_operator_not_equals(buf2_103,"while")) {
            ((struct tuple2$2int$bool$*)(__right_value86=err_msg(info,"require while")));
            /*c*/ come_call_finalizer3(__right_value86,tuple2$2int$bool$$p_finalize, 0/* alloca value */, 1/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
            exit(2);
        }
        ...
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value89=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc_v2(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 109, "struct sDoWhileNode*")),(struct sNode*)come_increment_ref_count(expression_node_104),block_102,info))));
        ...
        /*c*/ come_call_finalizer3(block_102,sBlock_finalize, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
        (buf2_103 = come_decrement_ref_count(buf2_103, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        ((expression_node_104) ? expression_node_104 = come_decrement_ref_count(expression_node_104, ((struct sNode*)expression_node_104)->finalize, ((struct sNode*)expression_node_104)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,0/*force_delete*/, (void*)0):(void*)0);
        /*c*/ come_call_finalizer3(__right_value89,sDoWhileNode_finalize, 0/* alloca value */, 1/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
...
struct sDoWhileNode* result_105;
...
struct sDoWhileNode* __result_obj__54;
    ...
    result_105=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc_v2(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "struct sDoWhileNode*"));
    if(    self!=((void*)0)) {
        result_105->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj39=result_105->sname,
        result_105->sname=(char*)come_increment_ref_count((char*)come_memdup(self->sname, "sDoWhileNode_clone", 5, "char*"));
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj40=result_105->mExpressionNode,
        result_105->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj41=result_105->mBlock,
        result_105->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
        /*b*/ come_call_finalizer3(__dec_obj41,sBlock_finalize, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, 0/* force_delete_ */, (void*)0);
    }
    __result_obj__54 = result_105;
    /*c*/ come_call_finalizer3(result_105,sDoWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 1/* force_delete */ , (void*)0);
