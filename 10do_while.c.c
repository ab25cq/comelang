...
struct sDoWhileNode* __result_obj__221;
    ...
    __result_obj__221 = (struct sDoWhileNode*)come_increment_ref_count(self);
    ...
    /*c*/ come_call_finalizer3(__result_obj__221,sDoWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 0/* force_delete */ , (void*)0);
...
char* __result_obj__222;
    __result_obj__222 = (char*)come_increment_ref_count(((char*)(__right_value289=__builtin_string("sDoWhileNode"))));
...
struct sNode* expression_node_328;
_Bool comma_instead_of_semicolon_329;
_Bool without_semicolon_330;
_Bool Value_331;
_Bool normal_if_332;
void* __right_value290 = (void*)0;
struct CVALUE* conditional_value_333;
void* __right_value291 = (void*)0;
struct CVALUE* conditional_value_334;
int num_while_conditional_stack_336;
    if(    info->comma_instead_of_semicolon) {
        err_msg(info,"In conditional operator comelang can't use do while statment");
    }
    in_loop_326=info->in_loop;
    info->in_loop=(_Bool)1;
    block_327=self->mBlock;
    add_come_code(info,"do {\n");
    transpile_block(block_327,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    expression_node_328=self->mExpressionNode;
    comma_instead_of_semicolon_329=info->comma_instead_of_semicolon;
    info->comma_instead_of_semicolon=(_Bool)1;
    without_semicolon_330=info->without_semicolon;
    info->without_semicolon=(_Bool)1;
    Value_331=node_compile(expression_node_328,info);
    if(    !Value_331) {
        return (_Bool)0;
    }
    else {
    }
    info->without_semicolon=without_semicolon_330;
    info->comma_instead_of_semicolon=comma_instead_of_semicolon_329;
    normal_if_332=(_Bool)1;
    if(    existance_free_right_value_objects(info)) {
        normal_if_332=(_Bool)0;
    }
    if(    normal_if_332) {
        conditional_value_333=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        add_come_code(info,"} while(%s);\n",conditional_value_333->c_value);
        /*c*/ come_call_finalizer3(conditional_value_333,CVALUE_finalize, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
    }
    else {
        conditional_value_334=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        static int num_while_condtional_335=0;
        add_come_code_at_function_head(info,"_Bool _do_while_condtional%d;\n",++num_while_condtional_335);
        num_while_conditional_stack_336=num_while_condtional_335;
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_condtional_335,conditional_value_334->c_value);
        add_last_code_to_source_with_comma(info);
        free_right_value_objects(info,(_Bool)1);
        add_come_code(info,"_do_while_condtional%d);\n",num_while_conditional_stack_336);
        /*c*/ come_call_finalizer3(conditional_value_334,CVALUE_finalize, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
    }
    transpiler_clear_last_code(info);
    info->in_loop=in_loop_326;
    return (_Bool)1;
}
...
struct sNode* __result_obj__226;
    if(    charp_operator_equals(buf,"do")) {
        sname_337=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "10do_while.c", 90, "char*"));
        ...
        if(        string_operator_not_equals(buf2_340,"while")) {
            err_msg(info,"require while");
            exit(2);
        }
        expected_next_character(40,info);
        expression_node_341=(struct sNode*)come_increment_ref_count(expression_v13(info));
        expected_next_character(41,info);
        _inf_value1=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "10do_while.c", 109, "struct sNode");
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value297=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc_v2(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 109, "struct sDoWhileNode*")),(struct sNode*)come_increment_ref_count(expression_node_341),block_339,info))));
        ...
        __result_obj__225 = (struct sNode*)come_increment_ref_count(((struct sNode*)(__right_value302=_inf_value1)));
        (sname_337 = come_decrement_ref_count(sname_337, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        ...
        ((expression_node_341) ? expression_node_341 = come_decrement_ref_count(expression_node_341, ((struct sNode*)expression_node_341)->finalize, ((struct sNode*)expression_node_341)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,0/*force_delete*/, (void*)0):(void*)0);
        /*c*/ come_call_finalizer3(__right_value297,sDoWhileNode_finalize, 0/* alloca value */, 1/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
    ...
    __result_obj__226 = (struct sNode*)come_increment_ref_count(((struct sNode*)(__right_value303=string_node_v9(buf,head,head_sline,info))));
...
static struct sDoWhileNode* sDoWhileNode_clone(struct sDoWhileNode* self){
struct sDoWhileNode* __result_obj__223;
void* __right_value298 = (void*)0;
struct sDoWhileNode* result_342;
...
struct sDoWhileNode* __result_obj__224;
    if(    self==(void*)0) {
        __result_obj__223 = (void*)0;
        return __result_obj__223;
    }
    result_342=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc_v2(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "struct sDoWhileNode*"));
    if(    self!=((void*)0)) {
        result_342->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj65=result_342->sname,
        result_342->sname=(char*)come_increment_ref_count((char*)come_memdup(self->sname, "sDoWhileNode_clone", 5, "char*"));
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj66=result_342->mExpressionNode,
    ...
    __result_obj__224 = result_342;
    /*c*/ come_call_finalizer3(result_342,sDoWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 1/* force_delete */ , (void*)0);
