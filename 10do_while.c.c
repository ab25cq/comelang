...
char* __result259__;
    __result259__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value328=__builtin_string("sDoWhileNode")));
...
int num_while_conditional_stack_346;
    if(    info->comma_instead_of_semicolon) {
        err_msg(info,"In conditional operator comelang can't use do while statment");
        return (_Bool)0;
    }
    in_loop_337=info->in_loop;
    info->in_loop=(_Bool)1;
    block_338=self->mBlock;
    add_come_code(info,"do {\n");
    transpile_block(block_338,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    expression_node_339=self->mExpressionNode;
    ...
    Value_341=node_compile(expression_node_339,info);
    if(    !Value_341) {
        return (_Bool)0;
    }
    else {
    ...
    if(    normal_if_342) {
        ...
        come_call_finalizer3(conditional_value_343,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    else {
        conditional_value_344=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        dec_stack_ptr(1,info);
        static int num_while_condtional_345=0;
        add_come_code_at_function_head(info,"_Bool _do_while_condtional%d;\n",++num_while_condtional_345);
        num_while_conditional_stack_346=num_while_condtional_345;
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_condtional_345,conditional_value_344->c_value);
        add_last_code_to_source_with_comma(info);
        free_right_value_objects(info,(_Bool)1);
        add_come_code(info,"_do_while_condtional%d);\n",num_while_conditional_stack_346);
        come_call_finalizer3(conditional_value_344,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    transpiler_clear_last_code(info);
    info->in_loop=in_loop_337;
    return (_Bool)1;
}
...
struct sNode* __result263__;
    if(    charp_operator_equals(buf,"do")) {
        sname_347=(char*)come_increment_ref_count(string_clone(info->sname));
        sline_348=info->sline;
        block_349=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        buf2_350=(char*)come_increment_ref_count(parse_word(info));
        if(        string_operator_not_equals(buf2_350,"while")) {
        ...
        __result262__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value341=_inf_value1));
        sname_347 = come_decrement_ref_count2(sname_347, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        come_call_finalizer3(block_349,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        buf2_350 = come_decrement_ref_count2(buf2_350, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        if(expression_node_351) { expression_node_351 = come_decrement_ref_count2(expression_node_351, ((struct sNode*)expression_node_351)->finalize, ((struct sNode*)expression_node_351)->_protocol_obj, 0, 0, 0, (void*)0); } 
    ...
    __result263__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value342=string_node_v9(buf,head,head_sline,info)));
...
struct sDoWhileNode* __result261__;
    ...
    result_352=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "sDoWhileNode"));
    if(    self!=((void*)0)) {
        result_352->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj115=result_352->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj116=result_352->mExpressionNode;
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj117=result_352->mBlock;
        result_352->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
        come_call_finalizer3(__dec_obj117,sBlock_finalize, 0, 0, 0, 0, (void*)0);
    }
    __result261__ = gComeFunResultObject = __result_obj__ = result_352;
    come_call_finalizer3(result_352,sDoWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
