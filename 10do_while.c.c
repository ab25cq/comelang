...
struct sDoWhileNode* __result233__;
...
char* __result234__;
    __result234__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value272=__builtin_string("sDoWhileNode")));
...
struct sNode* expression_node_317;
_Bool comma_instead_of_semicolon_318;
_Bool Value_319;
_Bool normal_if_320;
void* __right_value273 = (void*)0;
struct CVALUE* conditional_value_321;
void* __right_value274 = (void*)0;
struct CVALUE* conditional_value_322;
int num_while_conditional_stack_324;
    ...
    expression_node_317=self->mExpressionNode;
    comma_instead_of_semicolon_318=info->comma_instead_of_semicolon;
    info->comma_instead_of_semicolon=(_Bool)1;
    info->without_semicolon=(_Bool)1;
    Value_319=node_compile(expression_node_317,info);
    if(    !Value_319) {
        return (_Bool)0;
    }
    else {
    ...
    info->comma_instead_of_semicolon=comma_instead_of_semicolon_318;
    normal_if_320=(_Bool)1;
    if(    existance_free_right_value_objects(info)) {
        normal_if_320=(_Bool)0;
    }
    if(    normal_if_320) {
        conditional_value_321=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        dec_stack_ptr(1,info);
        add_come_code(info,"} while(%s);\n",conditional_value_321->c_value);
        /*i*/come_call_finalizer3(conditional_value_321,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    else {
        conditional_value_322=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        dec_stack_ptr(1,info);
        static int num_while_condtional_323=0;
        add_come_code_at_function_head(info,"_Bool _do_while_condtional%d;\n",++num_while_condtional_323);
        num_while_conditional_stack_324=num_while_condtional_323;
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_condtional_323,conditional_value_322->c_value);
        add_last_code_to_source_with_comma(info);
        free_right_value_objects(info,(_Bool)1);
        add_come_code(info,"_do_while_condtional%d);\n",num_while_conditional_stack_324);
        /*i*/come_call_finalizer3(conditional_value_322,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
...
struct list$1sNodeph* __result204__;
    ...
    result_251=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count((struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "/usr/local/include/comelang.h", 1026, "list$1sNodeph"))));
    it_252=self->head;
    while(it_252!=((void*)0)) {
...
struct list$1sNodeph* __result203__;
    if(    self->len==0) {
        litem_253=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value251=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 1040, "list_item$1sNodeph"))));
        ...
        litem_254=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value252=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 1050, "list_item$1sNodeph"))));
        ...
        litem_255=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value253=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 1060, "list_item$1sNodeph"))));
...
default_value_274 = (void*)0;
    ...
    result_268=(struct map$2charphsVarph*)come_increment_ref_count(map$2charphsVarph_initialize((struct map$2charphsVarph*)come_increment_ref_count((struct map$2charphsVarph*)come_calloc(1, sizeof(struct map$2charphsVarph)*(1), "/usr/local/include/comelang.h", 2358, "map$2charphsVarph"))));
    __dec_obj63=result_268->key_list;
    result_268->key_list=(struct list$1charp*)come_increment_ref_count(list$1charp_initialize((struct list$1charp*)come_increment_ref_count((struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "/usr/local/include/comelang.h", 2360, "list$1charp"))));
...
struct map$2charphsVarph* __result208__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value258=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "/usr/local/include/comelang.h", 2287, "char*%"))));
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value259=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(128)), "/usr/local/include/comelang.h", 2288, "sVar*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value260=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "/usr/local/include/comelang.h", 2289, "bool"))));
...
default_value_288 = (void*)0;
    ...
    keys_279=(char**)come_increment_ref_count(((char**)(__right_value266=(char**)come_calloc(1, sizeof(char*)*(1*(size_278)), "/usr/local/include/comelang.h", 2515, "char*%"))));
    items_280=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value267=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_278)), "/usr/local/include/comelang.h", 2516, "sVar*%"))));
    item_existance_281=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value268=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_278)), "/usr/local/include/comelang.h", 2517, "bool"))));
    len_282=0;
...
struct sNode* __result238__;
    if(    charp_operator_equals(buf,"do")) {
        sname_325=(char*)come_increment_ref_count(string_clone(info->sname));
        sline_326=info->sline;
        block_327=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        buf2_328=(char*)come_increment_ref_count(parse_word(info));
        if(        string_operator_not_equals(buf2_328,"while")) {
        ...
        __result237__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value285=_inf_value1));
        /* U13 */sname_325 = come_decrement_ref_count2(sname_325, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(block_327,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        /* U13 */buf2_328 = come_decrement_ref_count2(buf2_328, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        ...
        /*g*/come_call_finalizer3(__right_value280,sDoWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
    ...
    __result238__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value286=string_node_v9(buf,head,head_sline,info)));
...
struct sDoWhileNode* result_330;
...
struct sDoWhileNode* __result236__;
    if(    self==(void*)0) {
        __result235__ = gComeFunResultObject = __result_obj__ = (void*)0;
        gComeFunResultObject = (void*)0;
        return __result235__;
    }
    result_330=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "sDoWhileNode"));
    if(    self!=((void*)0)) {
        result_330->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj78=result_330->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj79=result_330->mExpressionNode;
        result_330->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj80=result_330->mBlock;
        result_330->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
    ...
    /*i*/come_call_finalizer3(result_330,sDoWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
