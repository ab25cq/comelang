...
struct sDoWhileNode* __result268__;
...
char* __result269__;
    __result269__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value318=__builtin_string("sDoWhileNode")));
...
int num_while_conditional_stack_381;
    ...
    if(    normal_if_377) {
        ...
        come_call_finalizer3(conditional_value_378,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    else {
        conditional_value_379=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        dec_stack_ptr(1,info);
        static int num_while_condtional_380=0;
        add_come_code_at_function_head(info,"_Bool _do_while_condtional%d;\n",++num_while_condtional_380);
        num_while_conditional_stack_381=num_while_condtional_380;
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_condtional_380,conditional_value_379->c_value);
        add_last_code_to_source_with_comma(info);
        free_right_value_objects(info,(_Bool)1);
        add_come_code(info,"_do_while_condtional%d);\n",num_while_conditional_stack_381);
        come_call_finalizer3(conditional_value_379,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    transpiler_clear_last_code(info);
    info->in_loop=in_loop_372;
    return (_Bool)1;
}
...
struct sNode* expression_node_386;
...
struct sNode* __result273__;
    if(    charp_operator_equals(buf,"do")) {
        sname_382=(char*)come_increment_ref_count(come_call_cloner(string_clone, info->sname));
        sline_383=info->sline;
        block_384=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        buf2_385=(char*)come_increment_ref_count(parse_word(info));
        if(        string_operator_not_equals(buf2_385,"while")) {
            err_msg(info,"require while");
            exit(2);
        }
        expected_next_character(40,info);
        expression_node_386=(struct sNode*)come_increment_ref_count(expression_v13(info));
        expected_next_character(41,info);
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "10do_while.c", 111, "struct sNode", (void*)0, (void*)0);
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value326=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 111, "struct sDoWhileNode*", (void*)0, (void*)0)),(struct sNode*)come_increment_ref_count(expression_node_386),block_384,info))));
        ...
        __result272__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value331=_inf_value1));
        sname_382 = come_decrement_ref_count2(sname_382, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        come_call_finalizer3(block_384,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        buf2_385 = come_decrement_ref_count2(buf2_385, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        if(expression_node_386) { expression_node_386 = come_decrement_ref_count2(expression_node_386, ((struct sNode*)expression_node_386)->finalize, ((struct sNode*)expression_node_386)->_protocol_obj, 0, 0, 0, (void*)0); } 
        come_call_finalizer3(__right_value326,sDoWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
    ...
    __result273__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value332=string_node_v9(buf,head,head_sline,info)));
...
struct sDoWhileNode* result_387;
...
struct sDoWhileNode* __result271__;
    ...
    result_387=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "struct sDoWhileNode", sDoWhileNode_finalize, sDoWhileNode_clone));
    if(    self!=((void*)0)) {
        result_387->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj101=result_387->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj102=result_387->mExpressionNode;
        result_387->mExpressionNode=(struct sNode*)come_increment_ref_count(come_call_cloner(sNode_clone, self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj103=result_387->mBlock;
        result_387->mBlock=(struct sBlock*)come_increment_ref_count(come_call_cloner(sBlock_clone, self->mBlock));
    ...
    come_call_finalizer3(result_387,sDoWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
