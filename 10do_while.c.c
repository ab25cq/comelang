...
_Bool comma_instead_of_semicolon_137;
_Bool normal_if_138;
...
int num_while_conditional_stack_142;
    ...
    transpile_block(block_135,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    expression_node_136=self->mExpressionNode;
    comma_instead_of_semicolon_137=info->comma_instead_of_semicolon;
    ...
    info->comma_instead_of_semicolon=comma_instead_of_semicolon_137;
    normal_if_138=(_Bool)1;
    if(    existance_free_right_value_objects(info)) {
        normal_if_138=(_Bool)0;
    }
    if(    normal_if_138) {
        ...
        dec_stack_ptr(1,info);
        static int num_while_condtional_141=0;
        add_come_code_at_function_head(info,"_Bool _do_while_condtional%d;\n",++num_while_condtional_141);
        num_while_conditional_stack_142=num_while_condtional_141;
        add_come_code(info,"} while((_do_while_condtional%d=(%s)),",num_while_condtional_141,conditional_value_140->c_value);
        add_last_code_to_source_with_comma(info);
        free_right_value_objects(info,(_Bool)1);
        add_come_code(info,"_do_while_condtional%d);\n",num_while_conditional_stack_142);
...
struct sNode* expression_node_147;
...
struct sNode* __result105__;
    if(    charp_operator_equals(buf,"do")) {
        ...
        sname_143 = come_decrement_ref_count2(sname_143, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(block_145,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        buf2_146 = come_decrement_ref_count2(buf2_146, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        if(expression_node_147) { expression_node_147 = come_decrement_ref_count2(expression_node_147, ((struct sNode*)expression_node_147)->finalize, ((struct sNode*)expression_node_147)->_protocol_obj, 0, 0, 0, (void*)0); } 
...
struct sDoWhileNode* result_148;
...
struct sDoWhileNode* __result103__;
    ...
    result_148=(struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "sDoWhileNode"));
    if(    self!=((void*)0)) {
        result_148->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj61=result_148->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj62=result_148->mExpressionNode;
        result_148->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode));
        if(__dec_obj62) { __dec_obj62 = come_decrement_ref_count2(__dec_obj62, ((struct sNode*)__dec_obj62)->finalize, ((struct sNode*)__dec_obj62)->_protocol_obj, 0,0,0, (void*)0); };
    }
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj63=result_148->mBlock;
        result_148->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
    ...
    /*i*/come_call_finalizer3(result_148,sDoWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
