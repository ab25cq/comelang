...
char* __result285__;
    __result285__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value328=__builtin_string("sDoWhileNode")));
...
struct sNode* __result289__;
    if(    charp_operator_equals(buf,"do")) {
        ...
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value336=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 111, "struct sDoWhileNode*", (void*)0, (void*)0, (void*)0, (void*)0)),(struct sNode*)come_increment_ref_count(expression_node_443),block_441,info))));
        ...
        __result288__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value341=_inf_value1));
    ...
    __result289__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value342=string_node_v9(buf,head,head_sline,info)));
...
struct sDoWhileNode* __result287__;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj104=result_444->mExpressionNode;
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj105=result_444->mBlock;
