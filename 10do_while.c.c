...
char* __result270__;
    __result270__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value320=__builtin_string("sDoWhileNode")));
...
struct sNode* __result274__;
    if(    charp_operator_equals(buf,"do")) {
        ...
        _inf_obj_value1=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(__right_value328=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 111, "struct sDoWhileNode*", (void*)0, (void*)0)),(struct sNode*)come_increment_ref_count(expression_node_387),block_385,info))));
        ...
        __result273__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value333=_inf_value1));
        ...
        come_call_finalizer3(__right_value328,sDoWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
    ...
    __result274__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value334=string_node_v9(buf,head,head_sline,info)));
...
struct sDoWhileNode* __result272__;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj105=result_388->mExpressionNode;
