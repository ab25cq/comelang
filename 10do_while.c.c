...
struct sNode* __result105__;
    if(charp_operator_equals(buf,"do")) {
        ...
        _inf_obj_value1=come_increment_ref_count(((struct sDoWhileNode*)(__right_value151=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count((struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 109, "sDoWhileNode")),(struct sNode*)come_increment_ref_count(expression_node_146),block_144,info))));
