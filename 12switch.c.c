...
struct sSwitchNode* __result138__;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj98=result_154->mExpressionNode;
