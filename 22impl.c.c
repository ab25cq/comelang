...
struct buffer* header_99;
void* __right_value128 = (void*)0;
struct sNode* __result67__;
void* __right_value129 = (void*)0;
struct sNode* __result68__;
    if(    charp_operator_equals(buf,"impl")) {
        source_head_74=info->p;
        word_75=(char*)come_increment_ref_count(parse_word(info));
        if(        *info->p==60) {
            info->p++;
            skip_spaces_and_lf(info);
            list$1charph_reset(info->generics_type_names);
            while((_Bool)1) {
                generics_name_78=(char*)come_increment_ref_count(parse_word(info));
                list$1charph_push_back(info->generics_type_names,(char*)come_increment_ref_count(string_clone(generics_name_78)));
                if(                *info->p==44) {
                    info->p++;
                    skip_spaces_and_lf(info);
                }
                    ...
                    info->p++;
                    skip_spaces_and_lf(info);
                    /* U13 */generics_name_78 = come_decrement_ref_count2(generics_name_78, (void*)0, (void*)0, 0, 0, 0, (void*)0);
                    break;
                }
                else {
        ...
        info->impl_type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "22impl.c", 45, "sType")),word_75,(_Bool)0,info));
        come_call_finalizer3(__dec_obj19,sType_finalize, 0, 0, 0, 0, (void*)0);
        info->impl_type->mPointerNum=pointer_num_82;
        while(*info->p!=125) {
            parse_sharp_v5(info);
            head_95=info->p;
            buf_96=(char*)come_increment_ref_count(parse_word(info));
            parse_sharp_v5(info);
            node_97=(struct sNode*)come_increment_ref_count(top_level_v99(buf_96,head_95,head_sline,info));
            parse_sharp_v5(info);
            while(*info->p==59) {
                info->p++;
                skip_spaces_and_lf(info);
            ...
            parse_sharp_v5(info);
            skip_spaces_and_lf(info);
            /* U13 */buf_96 = come_decrement_ref_count2(buf_96, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        ...
        source_tail_98=info->p;
        header_99=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "22impl.c", 82, "buffer"))));
        buffer_append(header_99,source_head_74,source_tail_98-source_head_74);
        add_come_code_at_come_header(info,"impl %s\n",((char*)(__right_value128=buffer_to_string(header_99))));
        ...
        /* U13 */word_75 = come_decrement_ref_count2(word_75, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(header_99,buffer_finalize, 0, 0, 0, 0, (void*)0);
        gComeFunResultObject = (void*)0;
        return __result67__;
        /* U13 */word_75 = come_decrement_ref_count2(word_75, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(header_99,buffer_finalize, 0, 0, 0, 0, (void*)0);
...
struct list$1charph* __result66__;
    if(    self->len==0) {
        litem_79=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value118=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 219, "list_item$1charph"))));
        ...
        litem_80=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value119=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 229, "list_item$1charph"))));
        ...
        litem_81=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value120=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 239, "list_item$1charph"))));
