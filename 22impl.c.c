...
struct buffer* header_29;
void* __right_value14 = (void*)0;
char* anonymous_name_31;
void* __right_value15 = (void*)0;
struct sNode* __result_obj__3;
void* __right_value16 = (void*)0;
struct sNode* __result_obj__4;
    if(    !gComeC&&charp_operator_equals(buf,"impl")    ) {
        source_head_8=info->p;
        word_9=(char*)come_increment_ref_count(parse_word(info));
        if(        *info->p==60        ) {
            info->p++;
            skip_spaces_and_lf(info);
            list$1char$ph_reset(info->generics_type_names);
            while(            (_Bool)1            ) {
                generics_name_12=(char*)come_increment_ref_count(parse_word(info));
                list$1char$ph_push_back(info->generics_type_names,(char*)come_increment_ref_count((char*)come_memdup(generics_name_12, "22impl.c", 18, "char*")));
                if(                *info->p==44                ) {
                    info->p++;
                    skip_spaces_and_lf(info);
                }
                    ...
                    info->p++;
                    skip_spaces_and_lf(info);
                    (generics_name_12 = come_decrement_ref_count(generics_name_12, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
                    break;
                }
                else {
        ...
        info->impl_type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "22impl.c", 45, "struct sType*")),(char*)come_increment_ref_count(word_9),(_Bool)0,info));
        come_call_finalizer(sType_finalize, __dec_obj4,(void*)0, (void*)0, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, (void*)0);
        info->impl_type->mPointerNum=pointer_num_16;
        while(        *info->p!=125        ) {
            parse_sharp_v5(info);
            head_23=info->p;
            buf_24=(char*)come_increment_ref_count(parse_word(info));
            parse_sharp_v5(info);
            node_25=(struct sNode*)come_increment_ref_count(top_level_v99(buf_24,head_23,head_sline,info));
            parse_sharp_v5(info);
            while(            *info->p==59            ) {
                info->p++;
                skip_spaces_and_lf(info);
            ...
            parse_sharp_v5(info);
            impl_type_26=(struct sType*)come_increment_ref_count(info->impl_type);
            __dec_obj5=info->impl_type,
            info->impl_type=((void*)0);
            come_call_finalizer(sType_finalize, __dec_obj5,(void*)0, (void*)0, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, (void*)0);
            if(            node_25!=((void*)0)            ) {
                Value_27=node_compile(node_25,info);
                if(                !Value_27                ) {
            ...
            info->impl_type=(struct sType*)come_increment_ref_count(impl_type_26);
            come_call_finalizer(sType_finalize, __dec_obj6,(void*)0, (void*)0, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, (void*)0);
            skip_spaces_and_lf(info);
            (buf_24 = come_decrement_ref_count(buf_24, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
            ...
            come_call_finalizer(sType_finalize, impl_type_26, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
        }
        ...
        source_tail_28=info->p;
        header_29=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "22impl.c", 87, "struct buffer*"))));
        buffer_append(header_29,source_head_8,source_tail_28-source_head_8);
        if(        info->output_header_file        ) {
            static int n_30=0;
            anonymous_name_31=(char*)come_increment_ref_count(xsprintf("annymous_impl_name_%d",n_30++));
            add_come_code_at_come_header(info,anonymous_name_31,"impl %s\n",((char*)(__right_value15=buffer_to_string(header_29))));
            (__right_value15 = come_decrement_ref_count(__right_value15, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, (void*)0));
            (anonymous_name_31 = come_decrement_ref_count(anonymous_name_31, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
        }
        __result_obj__3 = (struct sNode*)come_increment_ref_count((struct sNode*)((void*)0));
        (word_9 = come_decrement_ref_count(word_9, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
        come_call_finalizer(buffer_finalize, header_29, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
...
struct list$1char$ph* __result_obj__2;
    if(    self->len==0    ) {
        litem_13=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value2=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1097, "struct list_item$1char$ph*"))));
        litem_13->prev=((void*)0);
        litem_13->next=((void*)0);
        __dec_obj1=litem_13->item,
        ...
        litem_14=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value3=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1107, "struct list_item$1char$ph*"))));
        ...
        litem_15=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value4=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1117, "struct list_item$1char$ph*"))));
