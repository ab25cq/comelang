...
struct sNode* top_level_v93(char* buf, char* head, int head_sline, struct sInfo* info){
void* __result_obj__=(void*)0;
char* source_head_271;
void* __right_value280 = (void*)0;
char* word_272;
void* __right_value281 = (void*)0;
char* generics_name_275;
...
struct sNode* __result225__;
    if(    charp_operator_equals(buf,"impl")) {
        ...
        if(        *info->p==60) {
            ...
            while((_Bool)1) {
                generics_name_275=(char*)come_increment_ref_count(parse_word(info));
                list$1charph_push_back(info->generics_type_names,(char*)come_increment_ref_count(string_clone(generics_name_275)));
                if(                *info->p==44) {
                    info->p++;
                    skip_spaces_and_lf(info);
                }
                    ...
                    info->p++;
                    skip_spaces_and_lf(info);
                    /* U13 */generics_name_275 = come_decrement_ref_count2(generics_name_275, (void*)0, (void*)0, 0, 0, 0, (void*)0);
                    break;
                }
                else {
        ...
        info->impl_type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "22impl.c", 45, "sType")),word_272,(_Bool)0,info));
        come_call_finalizer3(__dec_obj32,sType_finalize, 0, 0, 0, 0, (void*)0);
        info->impl_type->mPointerNum=pointer_num_276;
        while(*info->p!=125) {
            parse_sharp_v5(info);
            head_287=info->p;
            buf_288=(char*)come_increment_ref_count(parse_word(info));
            parse_sharp_v5(info);
            node_289=(struct sNode*)come_increment_ref_count(top_level_v99(buf_288,head_287,head_sline,info));
            parse_sharp_v5(info);
            while(*info->p==59) {
                info->p++;
                skip_spaces_and_lf(info);
            ...
            parse_sharp_v5(info);
            if(            node_289!=((void*)0)) {
                Value_290=node_compile(node_289,info);
                if(                !Value_290) {
            ...
            parse_sharp_v5(info);
            skip_spaces_and_lf(info);
            /* U13 */buf_288 = come_decrement_ref_count2(buf_288, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        ...
        source_tail_291=info->p;
        header_292=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "22impl.c", 82, "buffer"))));
        buffer_append(header_292,source_head_271,source_tail_291-source_head_271);
        add_come_code_at_come_header(info,"impl %s\n",((char*)(__right_value289=buffer_to_string(header_292))));
        ...
        /* U13 */word_272 = come_decrement_ref_count2(word_272, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(header_292,buffer_finalize, 0, 0, 0, 0, (void*)0);
        gComeFunResultObject = (void*)0;
        return __result224__;
        /* U13 */word_272 = come_decrement_ref_count2(word_272, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(header_292,buffer_finalize, 0, 0, 0, 0, (void*)0);
    }
    __result225__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value290=top_level_v92(buf,head,head_sline,info)));
...
struct list$1charph* __result223__;
    ...
    while(it_273!=((void*)0)) {
        prev_it_274=it_273;
        it_273=it_273->next;
        /*i*/come_call_finalizer3(prev_it_274,list_item$1charphp_finalize, 0, 0, 0, 0, (void*)0);
    }
    self->head=((void*)0);
    self->tail=((void*)0);
    self->len=0;
