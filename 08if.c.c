...
__list_values5___297[1]=come_increment_ref_count(((char*)(__right_value343=xsprintf("Err"))));
}    multiple_assign_298=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize_with_values((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "08if.c", 681, "struct list$1charph")),2,__list_values5___297));
    ...
    p_301=info->p;
    head_302=info->head;
    buf_303=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "08if.c", 690, "buffer"))));
    ...
    info->head=head_302;
    info->sline=sline_295;
    elif_expression_nodes_305=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count((struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "08if.c", 706, "list$1sNodeph"))));
    elif_num_306=0;
    elif_blocks_307=(struct list$1sBlockph*)come_increment_ref_count(list$1sBlockph_initialize((struct list$1sBlockph*)come_increment_ref_count((struct list$1sBlockph*)come_calloc(1, sizeof(struct list$1sBlockph)*(1), "08if.c", 709, "list$1sBlockph"))));
    ...
    _inf_value13=(struct sNode*)come_calloc(1, sizeof(struct sNode), "08if.c", 715, "struct sNode");
    _inf_obj_value13=come_increment_ref_count(((struct sIfNode*)(__right_value359=sIfNode_initialize((struct sIfNode*)come_increment_ref_count((struct sIfNode*)come_calloc(1, sizeof(struct sIfNode)*(1), "08if.c", 715, "sIfNode")),(struct sNode*)come_increment_ref_count(expression_node2_309),if_block_304,elif_expression_nodes_305,elif_blocks_307,elif_num_306,else_block_308,(_Bool)0,info))));
    ...
    _inf_value14=(struct sNode*)come_calloc(1, sizeof(struct sNode), "08if.c", 717, "struct sNode");
    _inf_obj_value14=come_increment_ref_count(((struct sFreeITNode*)(__right_value372=sFreeITNode_initialize((struct sFreeITNode*)come_increment_ref_count((struct sFreeITNode*)come_calloc(1, sizeof(struct sFreeITNode)*(1), "08if.c", 717, "sFreeITNode")),info))));
    ...
    _inf_value15=(struct sNode*)come_calloc(1, sizeof(struct sNode), "08if.c", 719, "struct sNode");
    _inf_obj_value15=come_increment_ref_count(((struct sSaveRightValueObjects*)(__right_value377=sSaveRightValueObjects_initialize((struct sSaveRightValueObjects*)come_increment_ref_count((struct sSaveRightValueObjects*)come_calloc(1, sizeof(struct sSaveRightValueObjects)*(1), "08if.c", 719, "sSaveRightValueObjects")),info))));
    ...
    _inf_value16=(struct sNode*)come_calloc(1, sizeof(struct sNode), "08if.c", 720, "struct sNode");
    _inf_obj_value16=come_increment_ref_count(((struct sRestoreRightValueObjects*)(__right_value382=sRestoreRightValueObjects_initialize((struct sRestoreRightValueObjects*)come_increment_ref_count((struct sRestoreRightValueObjects*)come_calloc(1, sizeof(struct sRestoreRightValueObjects)*(1), "08if.c", 720, "sRestoreRightValueObjects")),info))));
...
}    multiple_node_319=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodeph_initialize_with_values((struct list$1sNodeph*)come_increment_ref_count((struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "08if.c", 722, "struct list$1sNodeph")),6,__list_values6___320));
    _inf_value17=(struct sNode*)come_calloc(1, sizeof(struct sNode), "08if.c", 724, "struct sNode");
    _inf_obj_value17=come_increment_ref_count(((struct sMultipleNode*)(__right_value389=sMultipleNode_initialize((struct sMultipleNode*)come_increment_ref_count((struct sMultipleNode*)come_calloc(1, sizeof(struct sMultipleNode)*(1), "08if.c", 724, "sMultipleNode")),(struct list$1sNodeph*)come_increment_ref_count(multiple_node_319),info))));
...
struct sNode* __result185__;
    if(charp_operator_equals(buf,"if")) {
        ...
        elif_expression_nodes_326=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count((struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "08if.c", 745, "list$1sNodeph"))));
        elif_blocks_327=(struct list$1sBlockph*)come_increment_ref_count(list$1sBlockph_initialize((struct list$1sBlockph*)come_increment_ref_count((struct list$1sBlockph*)come_calloc(1, sizeof(struct list$1sBlockph)*(1), "08if.c", 747, "list$1sBlockph"))));
        elif_num_328=0;
        ...
        _inf_value18=(struct sNode*)come_calloc(1, sizeof(struct sNode), "08if.c", 807, "struct sNode");
        _inf_obj_value18=come_increment_ref_count(((struct sIfNode*)(__right_value406=sIfNode_initialize((struct sIfNode*)come_increment_ref_count((struct sIfNode*)come_calloc(1, sizeof(struct sIfNode)*(1), "08if.c", 807, "sIfNode")),(struct sNode*)come_increment_ref_count(expression_node_324),if_block_325,elif_expression_nodes_326,elif_blocks_327,elif_num_328,else_block_329,(_Bool)0,info))));
...
struct sNode* __result188__;
    ...
    _inf_value19=(struct sNode*)come_calloc(1, sizeof(struct sNode), "08if.c", 824, "struct sNode");
    _inf_obj_value19=come_increment_ref_count(((struct sOrStatmentNode*)(__right_value419=sOrStatmentNode_initialize((struct sOrStatmentNode*)come_increment_ref_count((struct sOrStatmentNode*)come_calloc(1, sizeof(struct sOrStatmentNode)*(1), "08if.c", 824, "sOrStatmentNode")),(struct sNode*)come_increment_ref_count(expression_node),if_block_339,info))));
...
struct sNode* __result191__;
    ...
    _inf_value20=(struct sNode*)come_calloc(1, sizeof(struct sNode), "08if.c", 836, "struct sNode");
    _inf_obj_value20=come_increment_ref_count(((struct sAndStatmentNode*)(__right_value428=sAndStatmentNode_initialize((struct sAndStatmentNode*)come_increment_ref_count((struct sAndStatmentNode*)come_calloc(1, sizeof(struct sAndStatmentNode)*(1), "08if.c", 836, "sAndStatmentNode")),(struct sNode*)come_increment_ref_count(expression_node),if_block_343,info))));
