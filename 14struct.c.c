...
default_value_162 = (void*)0;
    ...
    keys_147=(char**)come_increment_ref_count(((char**)(__right_value173=(char**)come_calloc(1, sizeof(char*)*(1*(size_146)), "./comelang.h", 1658, "char*%"))));
    items_148=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value174=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_146)), "./comelang.h", 1659, "sClass*%"))));
    item_existance_149=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value175=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_146)), "./comelang.h", 1660, "bool"))));
    len_150=0;
...
default_value_237 = (void*)0;
    ...
    keys_222=(char**)come_increment_ref_count(((char**)(__right_value220=(char**)come_calloc(1, sizeof(char*)*(1*(size_221)), "./comelang.h", 1658, "char*%"))));
    items_223=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value221=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_221)), "./comelang.h", 1659, "sType*%"))));
    item_existance_224=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value222=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_221)), "./comelang.h", 1660, "bool"))));
    len_225=0;
...
struct list$1sClassp* __result186__;
    result_337=(struct list$1sClassp*)come_increment_ref_count(list$1sClassp_initialize((struct list$1sClassp*)come_increment_ref_count((struct list$1sClassp*)come_calloc(1, sizeof(struct list$1sClassp)*(1), "./comelang.h", 895, "list$1sClassp"))));
    it_338=self->tail;
    while(it_338!=((void*)0)) {
...
struct map$2charphcharph* __result200__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value399=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 1407, "char*%"))));
    self->items=(char**)come_increment_ref_count(((char**)(__right_value400=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 1408, "char*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value401=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 1409, "bool"))));
...
default_value_428 = (void*)0;
    ...
    keys_413=(char**)come_increment_ref_count(((char**)(__right_value407=(char**)come_calloc(1, sizeof(char*)*(1*(size_412)), "./comelang.h", 1658, "char*%"))));
    items_414=(char**)come_increment_ref_count(((char**)(__right_value408=(char**)come_calloc(1, sizeof(char*)*(1*(size_412)), "./comelang.h", 1659, "char*%"))));
    item_existance_415=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value409=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_412)), "./comelang.h", 1660, "bool"))));
    len_416=0;
