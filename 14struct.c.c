...
default_value_156 = (void*)0;
    ...
    keys_141=(char**)come_increment_ref_count(((char**)(__right_value172=(char**)come_calloc(1, sizeof(char*)*(1*(size_140)), "/usr/local/include/comelang.h", 1620, "char*%"))));
    items_142=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value173=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_140)), "/usr/local/include/comelang.h", 1621, "sClass*%"))));
    item_existance_143=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value174=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_140)), "/usr/local/include/comelang.h", 1622, "bool"))));
    len_144=0;
...
default_value_231 = (void*)0;
    ...
    keys_216=(char**)come_increment_ref_count(((char**)(__right_value219=(char**)come_calloc(1, sizeof(char*)*(1*(size_215)), "/usr/local/include/comelang.h", 1620, "char*%"))));
    items_217=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value220=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_215)), "/usr/local/include/comelang.h", 1621, "sType*%"))));
    item_existance_218=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value221=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_215)), "/usr/local/include/comelang.h", 1622, "bool"))));
    len_219=0;
...
struct list$1sClassp* __result186__;
    result_331=(struct list$1sClassp*)come_increment_ref_count(list$1sClassp_initialize((struct list$1sClassp*)come_increment_ref_count((struct list$1sClassp*)come_calloc(1, sizeof(struct list$1sClassp)*(1), "/usr/local/include/comelang.h", 873, "list$1sClassp"))));
    it_332=self->tail;
    while(it_332!=((void*)0)) {
...
struct map$2charphcharph* __result200__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value398=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "/usr/local/include/comelang.h", 1369, "char*%"))));
    self->items=(char**)come_increment_ref_count(((char**)(__right_value399=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "/usr/local/include/comelang.h", 1370, "char*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value400=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "/usr/local/include/comelang.h", 1371, "bool"))));
...
default_value_422 = (void*)0;
    ...
    keys_407=(char**)come_increment_ref_count(((char**)(__right_value406=(char**)come_calloc(1, sizeof(char*)*(1*(size_406)), "/usr/local/include/comelang.h", 1620, "char*%"))));
    items_408=(char**)come_increment_ref_count(((char**)(__right_value407=(char**)come_calloc(1, sizeof(char*)*(1*(size_406)), "/usr/local/include/comelang.h", 1621, "char*%"))));
    item_existance_409=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value408=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_406)), "/usr/local/include/comelang.h", 1622, "bool"))));
    len_410=0;
