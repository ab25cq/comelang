...
int __isoc23_vfwscanf(struct _IO_FILE* __s, const int* __format, va_list __arg);
int __isoc23_vwscanf(const int* __format, va_list __arg);
int __isoc23_vswscanf(const int* __s, const int* __format, va_list __arg);
...
default_value_41 = (void*)0;
    ...
    keys_26=(char**)come_increment_ref_count(((char**)(__right_value6=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size_25)), "./comelang.h", 2137, "char**"))));
    items_27=(struct buffer**)come_increment_ref_count(((struct buffer**)(__right_value7=(struct buffer**)come_calloc_v2(1, sizeof(struct buffer*)*(1*(size_25)), "./comelang.h", 2138, "struct buffer**"))));
    item_existance_28=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value8=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(size_25)), "./comelang.h", 2139, "_Bool*"))));
    len_29=0;
...
default_value_101 = (void*)0;
    ...
    keys_86=(char**)come_increment_ref_count(((char**)(__right_value25=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size_85)), "./comelang.h", 2137, "char**"))));
    items_87=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value26=(struct sClass**)come_calloc_v2(1, sizeof(struct sClass*)*(1*(size_85)), "./comelang.h", 2138, "struct sClass**"))));
    item_existance_88=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value27=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(size_85)), "./comelang.h", 2139, "_Bool*"))));
    len_89=0;
...
default_value_175 = (void*)0;
    ...
    keys_162=(char**)come_increment_ref_count(((char**)(__right_value132=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size_161)), "./comelang.h", 2137, "char**"))));
    items_163=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value133=(struct sType**)come_calloc_v2(1, sizeof(struct sType*)*(1*(size_161)), "./comelang.h", 2138, "struct sType**"))));
    item_existance_164=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value134=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(size_161)), "./comelang.h", 2139, "_Bool*"))));
    len_165=0;
...
struct list$1sClass$p* __result_obj__131;
    result_279=(struct list$1sClass$p*)come_increment_ref_count(list$1sClass$p_initialize((struct list$1sClass$p*)come_increment_ref_count((struct list$1sClass$p*)come_calloc_v2(1, sizeof(struct list$1sClass$p)*(1), "./comelang.h", 1777, "struct list$1sClass$p*"))));
    it_280=self->tail;
    while(    it_280!=((void*)0)    ) {
...
struct map$2char$phchar$ph* __result_obj__148;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value342=(char**)come_calloc_v2(1, sizeof(char*)*(1*(128)), "./comelang.h", 1898, "char**"))));
    self->items=(char**)come_increment_ref_count(((char**)(__right_value343=(char**)come_calloc_v2(1, sizeof(char*)*(1*(128)), "./comelang.h", 1899, "char**"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value344=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 1900, "_Bool*"))));
...
default_value_361 = (void*)0;
    ...
    keys_346=(char**)come_increment_ref_count(((char**)(__right_value349=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size_345)), "./comelang.h", 2137, "char**"))));
    items_347=(char**)come_increment_ref_count(((char**)(__right_value350=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size_345)), "./comelang.h", 2138, "char**"))));
    item_existance_348=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value351=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(size_345)), "./comelang.h", 2139, "_Bool*"))));
    len_349=0;
