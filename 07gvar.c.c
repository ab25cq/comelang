...
_Bool __result_obj__65;
    ...
    if(({    (_conditional_value_X0=(self->multiple_declare));    _conditional_value_X0;    })) {
        for(        ({        (_conditional_value_X1=(o2_saved=(struct list$1tuple3$3sType$phchar$phchar$ph$ph*)come_increment_ref_count(self->multiple_declare),it=list$1tuple3$3sType$phchar$phchar$ph$ph_begin(o2_saved)));        _conditional_value_X1;        });        ({        (_conditional_value_X2=(!list$1tuple3$3sType$phchar$phchar$ph$ph_end(o2_saved)));        _conditional_value_X2;        });        ({        (_conditional_value_X3=(it=list$1tuple3$3sType$phchar$phchar$ph$ph_next(o2_saved)));        _conditional_value_X3;        })        ){
            ...
            else if(({            (_conditional_value_X7=(initializer));            _conditional_value_X7;            })) {
                __right_value0 = (void*)0;
                __right_value1 = (void*)0;
                __right_value2 = (void*)0;
        ...
        if(({        (_conditional_value_X8=(array_initializer));        _conditional_value_X8;        })) {
            if(({            (_conditional_value_X9=(info->output_header_file));            _conditional_value_X9;            })) {
                if(({                (_conditional_value_X10=(!type->mStatic));                _conditional_value_X10;                })) {
                    __right_value0 = (void*)0;
            ...
            else if(({            (_conditional_value_X11=(type->mUniq));            _conditional_value_X11;            })) {
                __right_value0 = (void*)0;
                __right_value1 = (void*)0;
                __right_value2 = (void*)0;
                __right_value3 = (void*)0;
        ...
        else if(({        (_conditional_value_X12=(right_node));        _conditional_value_X12;        })) {
            ...
            if(({            (_conditional_value_X14=(info->output_header_file));            _conditional_value_X14;            })) {
                if(({                (_conditional_value_X15=(!type->mStatic));                _conditional_value_X15;                })) {
                    __right_value0 = (void*)0;
            ...
            else if(({            (_conditional_value_X16=(type->mUniq));            _conditional_value_X16;            })) {
                __right_value0 = (void*)0;
                __right_value1 = (void*)0;
                __right_value2 = (void*)0;
                __right_value3 = (void*)0;
            ...
            if(({            (_conditional_value_X17=(info->output_header_file));            _conditional_value_X17;            })) {
                if(({                (_conditional_value_X18=(!type->mStatic));                _conditional_value_X18;                })) {
                    __right_value0 = (void*)0;
            ...
            else if(({            (_conditional_value_X19=(type->mUniq));            _conditional_value_X19;            })) {
                __right_value0 = (void*)0;
                __right_value1 = (void*)0;
                __right_value2 = (void*)0;
                __right_value3 = (void*)0;
...
struct list$1char$ph* __result_obj__51;
    if(({    (_conditional_value_X0=(self->len==0));    _conditional_value_X0;    })) {
        ...
        __right_value0 = (void*)0;
        litem_23=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1124, "struct list_item$1char$ph*"))));
        ...
        __right_value0 = (void*)0;
        litem_24=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1134, "struct list_item$1char$ph*"))));
