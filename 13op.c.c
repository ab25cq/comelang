...
struct list$1CVALUEph* __result251__;
    if(    self->len==0) {
        litem_341=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(__right_value354=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "/usr/local/include/comelang.h", 1112, "list_item$1CVALUEph"))));
        ...
        litem_342=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(__right_value355=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "/usr/local/include/comelang.h", 1122, "list_item$1CVALUEph"))));
        ...
        litem_343=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(__right_value356=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "/usr/local/include/comelang.h", 1132, "list_item$1CVALUEph"))));
...
memset(&calling_fun_355, 0, sizeof(_Bool));
    ...
    if(    !calling_fun_355) {
        ...
        come_value_357=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 256, "CVALUE"))));
...
memset(&calling_fun_366, 0, sizeof(_Bool));
    ...
    if(    !calling_fun_366) {
        ...
        if(        left_value_360->type->mPointerNum>0&&right_value_363->type->mPointerNum>0) {
            ...
            result_type_367=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "13op.c", 322, "sType")),"long",(_Bool)0,info));
            come_call_finalizer3(__dec_obj143,sType_finalize, 0, 0, 0, 0, (void*)0);
        }
        come_value_368=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 325, "CVALUE"))));
...
memset(&calling_fun_377, 0, sizeof(_Bool));
    ...
    if(    !calling_fun_377) {
        come_value_378=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 389, "CVALUE"))));
...
memset(&calling_fun_387, 0, sizeof(_Bool));
    ...
    if(    !calling_fun_387) {
        come_value_388=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 453, "CVALUE"))));
...
memset(&calling_fun_397, 0, sizeof(_Bool));
    ...
    if(    !calling_fun_397) {
        come_value_398=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 517, "CVALUE"))));
...
memset(&calling_fun_407, 0, sizeof(_Bool));
    ...
    if(    !calling_fun_407) {
        come_value_408=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 582, "CVALUE"))));
...
memset(&calling_fun_417, 0, sizeof(_Bool));
    ...
    if(    !calling_fun_417) {
        come_value_418=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 646, "CVALUE"))));
...
memset(&calling_fun_427, 0, sizeof(_Bool));
    ...
    if(    !calling_fun_427) {
        come_value_428=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 710, "CVALUE"))));
...
memset(&calling_fun_437, 0, sizeof(_Bool));
    ...
    if(    !calling_fun_437) {
        come_value_438=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 774, "CVALUE"))));
...
memset(&calling_fun_447, 0, sizeof(_Bool));
    ...
    if(    !calling_fun_447) {
        come_value_448=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 838, "CVALUE"))));
...
memset(&calling_fun_457, 0, sizeof(_Bool));
    ...
    if(    !calling_fun_457) {
        come_value_458=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 902, "CVALUE"))));
...
_Bool __result309__;
    ...
    dec_stack_ptr(1,info);
    come_value_465=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 954, "CVALUE"))));
...
_Bool __result313__;
    ...
    dec_stack_ptr(1,info);
    come_value_472=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 1005, "CVALUE"))));
...
memset(&calling_fun_481, 0, sizeof(_Bool));
    ...
    if(    !calling_fun_481) {
        come_value_482=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 1069, "CVALUE"))));
...
memset(&calling_fun_491, 0, sizeof(_Bool));
    ...
    if(    !calling_fun_491) {
        come_value_492=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 1133, "CVALUE"))));
...
memset(&calling_fun_501, 0, sizeof(_Bool));
    ...
    if(    !calling_fun_501) {
        come_value_502=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 1198, "CVALUE"))));
...
memset(&calling_fun_511, 0, sizeof(_Bool));
    ...
    if(    !calling_fun_511) {
        come_value_512=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 1262, "CVALUE"))));
...
memset(&calling_fun_521, 0, sizeof(_Bool));
    ...
    if(    !calling_fun_521) {
        come_value_522=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 1327, "CVALUE"))));
...
memset(&calling_fun_531, 0, sizeof(_Bool));
    ...
    if(    !calling_fun_531) {
        come_value_532=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 1392, "CVALUE"))));
...
memset(&calling_fun_541, 0, sizeof(_Bool));
    ...
    if(    !calling_fun_541) {
        come_value_542=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 1456, "CVALUE"))));
...
_Bool __result345__;
    ...
    dec_stack_ptr(1,info);
    come_value_549=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 1507, "CVALUE"))));
...
_Bool __result350__;
    ...
    dec_stack_ptr(1,info);
    come_value_560=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "13op.c", 1569, "CVALUE"))));
...
struct sNode* __result372__;
    ...
    while(*info->p) {
        if(        !node_562->terminated(node_562->_protocol_obj)&&*info->p==42&&*(info->p+1)!=61) {
            ...
            _inf_value6=(struct sNode*)come_calloc(1, sizeof(struct sNode), "13op.c", 1627, "struct sNode");
            _inf_obj_value6=(struct sMultNode*)come_increment_ref_count(((struct sMultNode*)(__right_value638=sMultNode_initialize((struct sMultNode*)come_increment_ref_count((struct sMultNode*)come_calloc(1, sizeof(struct sMultNode)*(1), "13op.c", 1627, "sMultNode")),(struct sNode*)come_increment_ref_count(node_562),(struct sNode*)come_increment_ref_count(right_569),(_Bool)1,info))));
...
struct sNode* __result385__;
    ...
    while(*info->p) {
        if(        *info->p==43&&*(info->p+1)!=61&&*(info->p+1)!=43) {
            ...
            _inf_value12=(struct sNode*)come_calloc(1, sizeof(struct sNode), "13op.c", 1696, "struct sNode");
            _inf_obj_value12=(struct sSubNode*)come_increment_ref_count(((struct sSubNode*)(__right_value687=sSubNode_initialize((struct sSubNode*)come_increment_ref_count((struct sSubNode*)come_calloc(1, sizeof(struct sSubNode)*(1), "13op.c", 1696, "sSubNode")),(struct sNode*)come_increment_ref_count(node_575),(struct sNode*)come_increment_ref_count(right_582),(_Bool)1,info))));
...
struct sNode* __result423__;
    ...
    while(*info->p) {
        if(        *info->p==62&&*(info->p+1)==61) {
            ...
            _inf_value17=(struct sNode*)come_calloc(1, sizeof(struct sNode), "13op.c", 1774, "struct sNode");
...
struct sNode* __result455__;
    ...
    while(*info->p) {
        if(        !node_627->terminated(node_627->_protocol_obj)&&*info->p==38&&*(info->p+1)!=38&&*(info->p+1)!=61) {
            ...
            _inf_value34=(struct sNode*)come_calloc(1, sizeof(struct sNode), "13op.c", 1948, "struct sNode");
...
struct sNode* __result483__;
    ...
    while(*info->p) {
        if(        *info->p==124&&*(info->p+1)==124) {
            ...
            _inf_value42=(struct sNode*)come_calloc(1, sizeof(struct sNode), "13op.c", 2088, "struct sNode");
            _inf_obj_value42=(struct sOrOrNode*)come_increment_ref_count(((struct sOrOrNode*)(__right_value935=sOrOrNode_initialize((struct sOrOrNode*)come_increment_ref_count((struct sOrOrNode*)come_calloc(1, sizeof(struct sOrOrNode)*(1), "13op.c", 2088, "sOrOrNode")),(struct sNode*)come_increment_ref_count(node_647),(struct sNode*)come_increment_ref_count(right_650),(_Bool)1,info))));
...
value1_656 = (void*)0;
    ...
    while(*info->p) {
        if(        *info->p==63) {
            ...
            parse_sharp_v5(info);
            if(            *info->p==58) {
                _inf_value44=(struct sNode*)come_calloc(1, sizeof(struct sNode), "13op.c", 2144, "struct sNode");
                _inf_obj_value44=(struct sNullNode*)come_increment_ref_count(((struct sNullNode*)(__right_value952=sNullNode_initialize((struct sNullNode*)come_increment_ref_count((struct sNullNode*)come_calloc(1, sizeof(struct sNullNode)*(1), "13op.c", 2144, "sNullNode")),info))));
...
struct sNode* __result501__;
    if(    !gComeC&&charp_operator_equals(buf,"null")) {
        _inf_value46=(struct sNode*)come_calloc(1, sizeof(struct sNode), "13op.c", 2185, "struct sNode");
        _inf_obj_value46=(struct sNullNode*)come_increment_ref_count(((struct sNullNode*)(__right_value968=sNullNode_initialize((struct sNullNode*)come_increment_ref_count((struct sNullNode*)come_calloc(1, sizeof(struct sNullNode)*(1), "13op.c", 2185, "sNullNode")),info))));
        ...
        _inf_value47=(struct sNode*)come_calloc(1, sizeof(struct sNode), "13op.c", 2188, "struct sNode");
        _inf_obj_value47=(struct sNilNode*)come_increment_ref_count(((struct sNilNode*)(__right_value973=sNilNode_initialize((struct sNilNode*)come_increment_ref_count((struct sNilNode*)come_calloc(1, sizeof(struct sNilNode)*(1), "13op.c", 2188, "sNilNode")),info))));
