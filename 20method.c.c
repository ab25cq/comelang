        ...
        if(        obj_array_type_657&&list$1sNodephp_length(obj_array_type_657->mArrayNum)>0) {
            ...
            if(            string_operator_equals(generics_fun_name_593,array_method_name_658)) {
                if(                string_operator_equals(fun_name_495,"to_pointer")) {
                    ...
                    come_value_669->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "20method.c", 839, "struct sType", sType_finalize, sType_clone)),"long",(_Bool)0,info));
                    ...
                    come_value_679->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "20method.c", 868, "struct sType", sType_finalize, sType_clone)),"long",(_Bool)0,info));
                    ...
                    come_value_686->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "20method.c", 897, "struct sType", sType_finalize, sType_clone)),"long",(_Bool)0,info));
                    ...
                    come_value_693->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "20method.c", 926, "struct sType", sType_finalize, sType_clone)),"long",(_Bool)0,info));
                    ...
                    come_value_700->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "20method.c", 955, "struct sType", sType_finalize, sType_clone)),"long",(_Bool)0,info));
