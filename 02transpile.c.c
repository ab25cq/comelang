...
struct __current_stack3__
{
    ...
    struct buffer** cpp_option_306;
    struct list$1charph** files_307;
    struct list$1charph** object_files_308;
    _Bool* output_object_file_309;
    _Bool* output_cpp_file_310;
    _Bool* output_source_file_flag_311;
    char** output_file_name_312;
    _Bool* verbose_313;
    _Bool* come_debug_314;
    _Bool* come_malloc_315;
    int* argc;
    char*** argv;
};
...
struct list$1charph* __result73__;
    result_88=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "./comelang.h", 861, "list$1charph"))));
    it_89=self->head;
    while(it_89!=((void*)0)) {
...
char* __result81__;
    buf_91=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "./comelang.h", 957, "buffer"))));
    n_92=0;
...
default_value_130 = (void*)0;
    ...
    if(position==0) {
        litem_131=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value172=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 381, "list_item$1charph"))));
        ...
        if(self->len==1) {
            litem_132=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value173=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 393, "list_item$1charph"))));
            ...
            while(it_133!=((void*)0)) {
                if(position==i_134) {
                    litem_135=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value174=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 409, "list_item$1charph"))));
...
_Bool __result89__;
    ...
    buffer_append_str(command_137,((char*)(__right_value180=xsprintf("clang -o %s ",output_file_name_136))));
    ...
    for(    o2_saved_138=(object_files),it_139=list$1charph_begin((o2_saved_138));    !list$1charph_end((o2_saved_138));    it_139=list$1charph_next((o2_saved_138))    ){
        buffer_append_str(command_137,((char*)(__right_value181=xsprintf("%s ",it_139))));
    ...
    rc_141=system(cmd_140);
    if(rc_141==0) {
        buffer_append_str(command_137,((char*)(__right_value185=xsprintf(" -L%s/lib ",getenv("HOME")))));
    ...
    rc_141=system(cmd_140);
    if(rc_141==0) {
        buffer_append_str(command_137,((char*)(__right_value187=xsprintf(" -L%s/lib ","/usr/local/"))));
        __right_value187 = come_decrement_ref_count2(__right_value187, (void*)0, (void*)0, 1, 0, 0, (void*)0);
    }
    buffer_append_str(command_137,((char*)(__right_value188=xsprintf(" %s ",info->clang_option))));
    ...
    if(info->verbose) {
        puts(((char*)(__right_value192=buffer_to_string(command_137))));
        __right_value192 = come_decrement_ref_count2(__right_value192, (void*)0, (void*)0, 1, 0, 0, (void*)0);
    }
    rc_141=system(((char*)(__right_value193=buffer_to_string(command_137))));
...
_Bool __result90__;
    ...
    project_name_debug_147=(char*)come_increment_ref_count(string_operator_add(((char*)(__right_value195=__builtin_string(argv[2]))),((char*)(__right_value196=__builtin_string("-debug")))));
    ...
    if((_or_conditional1=(system(((char*)(__right_value206=xsprintf("mkdir \%s",((char*)(__right_value205=string_to_string(project_name_146))))))))),    (__right_value205 = come_decrement_ref_count2(__right_value205, (void*)0, (void*)0, 1, 0, 0, (void*)0)),
    (__right_value206 = come_decrement_ref_count2(__right_value206, (void*)0, (void*)0, 1, 0, 0, (void*)0)),
    _or_conditional1 != 0) {
        (come_push_stackframe("02transpile.c", 404, 0),__exception_result_var_b1=die("mkdir error"), come_pop_stackframe(), __exception_result_var_b1);
    }
    charp_write(((char*)(__right_value233=xsprintf("\#########################################\n\# istalled directories\n\#########################################\nprefix=\%s\nexec_prefix=${prefix}\nbindir=${exec_prefix}/bin\ndatadir=${datarootdir}\nmandir=${datarootdir}/man\nsharedstatedir=${prefix}/\%s\nsysconfdir=${prefix}/etc/\%s\nincludedir=${prefix}/include/\%s\ndatarootdir=${prefix}/share/\%s\ndocdir=${datarootdir}/doc\nlibdir=${exec_prefix}/lib\n\n\#########################################\n\# environmnet variables\n\#########################################\nCC=\%s\nINSTALL=\%s\nCFLAGS=\%s\nCFLAGS_DEBUG=\%s\nLIBS=\%s\nOS=\%s\nDESTDIR=\%s\nSRCS=$(wildcard *.c)\nSINGLE_SRCS=$(filter-out %%.c.c, $(SRCS))\nOBJS=$(SINGLE_SRCS:.c=.o)\nDEBUG_OBJS=$(SINGLE_SRCS:.c=.debug.o)\nTARGET=\%s\nTARGET_DEBUG=\%s\n\n\#########################################\n\# main\n\#########################################\nall: $(TARGET)\n\n$(TARGET): $(OBJS)\n\t$(CC) $(CFLAGS) $^ -o $@\n\n$(TARGET_DEBUG): $(DEBUG_OBJS)\n\t$(CC) $(CFLAGS_DEBUG) $^ -o $@\n\n%%.o: %%.c\n\t$(CC) $(CFLAGS) -c $< -o $@\n\n%%.debug.o: %%.c\n\t$(CC) $(CFLAGS_DEBUG) -c $< -o $@\n\n\#########################################\n\# header\n\#########################################\n\nheader: common.h\n\ncommon.h: $(SINGLE_SRCS)\n\tcomelang header -common-header $(SINGLE_SRCS)\n\n\#########################################\n\# install\n\#########################################\ninstall:\n\tmkdir -p \"$(DESTDIR)/bin\"\n\t$(INSTALL) -m 755 ./\%s \"$(DESTDIR)/bin\"\n\tmkdir -p \"$(DESTDIR)/include\"\n\tmkdir -p \"$(DESTDIR)/lib\"\n\tmkdir -p \"$(DESTDIR)/share/doc/\%s\"\n\t$(INSTALL) -m 644 README.md \"$(DESTDIR)/share/doc/\%s/README.md\"\n\n\#########################################\n\# clean\n\#########################################\nclean:\n\trm -fR *.o *.c.i *.c.out *.c.c \%s *.log *.out common.h \%s\n\n\#########################################\n\# uninstall\n\#########################################\nuninstall:\n\trm -f \"$(DESTDIR)\"/bin/\%s\n\trm -f \"$(DESTDIR)/share/doc/\%s/README.md\"\n\nrun: \%s\n\trm -f *.log\n\t./\%s\n\ncompile: \%s\n\ndebug: \%s\n\trm -f *.log\n\t./\%s\n",((char*)(__right_value207=string_to_string(prefix_152))),((char*)(__right_value208=string_to_string(project_name_146))),((char*)(__right_value209=string_to_string(project_name_146))),((char*)(__right_value210=string_to_string(project_name_146))),((char*)(__right_value211=string_to_string(project_name_146))),((char*)(__right_value212=string_to_string(cc_148))),((char*)(__right_value213=string_to_string(install_149))),((char*)(__right_value214=string_to_string(cflags_153))),((char*)(__right_value215=string_to_string(cflags_debug_154))),((char*)(__right_value216=string_to_string(libs_150))),((char*)(__right_value217=string_to_string(os_151))),((char*)(__right_value218=string_to_string(prefix_152))),((char*)(__right_value219=string_to_string(project_name_146))),((char*)(__right_value220=string_to_string(project_name_debug_147))),((char*)(__right_value221=string_to_string(project_name_146))),((char*)(__right_value222=string_to_string(project_name_146))),((char*)(__right_value223=string_to_string(project_name_146))),((char*)(__right_value224=string_to_string(project_name_146))),((char*)(__right_value225=string_to_string(project_name_debug_147))),((char*)(__right_value226=string_to_string(project_name_146))),((char*)(__right_value227=string_to_string(project_name_146))),((char*)(__right_value228=string_to_string(project_name_146))),((char*)(__right_value229=string_to_string(project_name_146))),((char*)(__right_value230=string_to_string(project_name_146))),((char*)(__right_value231=string_to_string(project_name_debug_147))),((char*)(__right_value232=string_to_string(project_name_debug_147)))))),((char*)(__right_value235=xsprintf("\%s/Makefile",((char*)(__right_value234=string_to_string(project_name_146)))))),(_Bool)0);
...
_Bool __exception_result_var_b3;
    ...
    if(f_155==((void*)0)) {
        if((_or_conditional2=(system("make header"))),        _or_conditional2 != 0) {
            (come_push_stackframe("02transpile.c", 508, 1),__exception_result_var_b2=die("system"), come_pop_stackframe(), __exception_result_var_b2);
        }
    }
    else {
        fclose(f_155);
...
_Bool __exception_result_var_b4;
    if((_or_conditional4=(system("make header"))),    _or_conditional4 != 0) {
        (come_push_stackframe("02transpile.c", 521, 3),__exception_result_var_b4=die("system"), come_pop_stackframe(), __exception_result_var_b4);
    }
    return (_Bool)1;
}
...
_Bool __exception_result_var_b6;
    ...
    if((_or_conditional6=(system("make compile"))),    _or_conditional6 != 0) {
        (come_push_stackframe("02transpile.c", 536, 5),__exception_result_var_b6=die("system"), come_pop_stackframe(), __exception_result_var_b6);
    }
    return (_Bool)1;
}
...
_Bool __exception_result_var_b8;
    ...
    if(f_157==((void*)0)) {
        if((_or_conditional7=(system("make header"))),        _or_conditional7 != 0) {
            (come_push_stackframe("02transpile.c", 546, 6),__exception_result_var_b7=die("system"), come_pop_stackframe(), __exception_result_var_b7);
        }
    }
    else {
        fclose(f_157);
    ...
    if((_or_conditional8=(system("make debug"))),    _or_conditional8 != 0) {
        (come_push_stackframe("02transpile.c", 551, 7),__exception_result_var_b8=die("system"), come_pop_stackframe(), __exception_result_var_b8);
    }
    return (_Bool)1;
}
...
_Bool __exception_result_var_b9;
    if((_or_conditional9=(system("make clean"))),    _or_conditional9 != 0) {
        (come_push_stackframe("02transpile.c", 558, 8),__exception_result_var_b9=die("system"), come_pop_stackframe(), __exception_result_var_b9);
    }
    return (_Bool)1;
}
...
_Bool __exception_result_var_b10;
    ...
    _or_conditional10 != 0) {
        (come_push_stackframe("02transpile.c", 565, 9),__exception_result_var_b10=die("system"), come_pop_stackframe(), __exception_result_var_b10);
    }
    return (_Bool)1;
}
...
void* __right_value325 = (void*)0;
    ...
    for(    i_215=0;    i_215<7;    i_215++    ){
        ...
        map$2charphsClassph_insert(info->classes,(char*)come_increment_ref_count(generics_type_216),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc(1, sizeof(struct sClass)*(1), "02transpile.c", 590, "sClass")),generics_type_216,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0,(_Bool)0,-1,i_215,(_Bool)0,info)));
    ...
    if(rc_218==0) {
        map$2charphsClassph_insert(info->classes,(char*)come_increment_ref_count(__builtin_string("__builtin_va_list")),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc(1, sizeof(struct sClass)*(1), "02transpile.c", 597, "sClass")),"__builtin_va_list",(_Bool)1,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,-1,-1,(_Bool)0,info)));
        type_name_219=(char*)come_increment_ref_count(__builtin_string("__builtin_va_list"));
        type_220=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "02transpile.c", 601, "sType")),"__builtin_va_list",(_Bool)0,info));
        __dec_obj62=type_220->mOriginalTypeName;
        ...
        klass_242=(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc(1, sizeof(struct sClass)*(1), "02transpile.c", 609, "sClass")),"__builtin_va_list",(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)1,(_Bool)0,-1,-1,(_Bool)0,info));
        list$1tuple2$2charphsTypephph_push_back(klass_242->mFields,(struct tuple2$2charphsTypeph*)come_increment_ref_count(tuple2$2charphsTypeph_initialize((struct tuple2$2charphsTypeph*)come_increment_ref_count((struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "02transpile.c", 611, "struct tuple2$2charphsTypeph")),(char*)come_increment_ref_count(__builtin_string("v1")),(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "02transpile.c", 611, "sType")),"char*",(_Bool)0,info)))));
        list$1tuple2$2charphsTypephph_push_back(klass_242->mFields,(struct tuple2$2charphsTypeph*)come_increment_ref_count(tuple2$2charphsTypeph_initialize((struct tuple2$2charphsTypeph*)come_increment_ref_count((struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "02transpile.c", 612, "struct tuple2$2charphsTypeph")),(char*)come_increment_ref_count(__builtin_string("v2")),(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "02transpile.c", 612, "sType")),"char*",(_Bool)0,info)))));
        list$1tuple2$2charphsTypephph_push_back(klass_242->mFields,(struct tuple2$2charphsTypeph*)come_increment_ref_count(tuple2$2charphsTypeph_initialize((struct tuple2$2charphsTypeph*)come_increment_ref_count((struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "02transpile.c", 613, "struct tuple2$2charphsTypeph")),(char*)come_increment_ref_count(__builtin_string("v3")),(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "02transpile.c", 613, "sType")),"char*",(_Bool)0,info)))));
        list$1tuple2$2charphsTypephph_push_back(klass_242->mFields,(struct tuple2$2charphsTypeph*)come_increment_ref_count(tuple2$2charphsTypeph_initialize((struct tuple2$2charphsTypeph*)come_increment_ref_count((struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "02transpile.c", 614, "struct tuple2$2charphsTypeph")),(char*)come_increment_ref_count(__builtin_string("v4")),(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "02transpile.c", 614, "sType")),"int",(_Bool)0,info)))));
        list$1tuple2$2charphsTypephph_push_back(klass_242->mFields,(struct tuple2$2charphsTypeph*)come_increment_ref_count(tuple2$2charphsTypeph_initialize((struct tuple2$2charphsTypeph*)come_increment_ref_count((struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "02transpile.c", 615, "struct tuple2$2charphsTypeph")),(char*)come_increment_ref_count(__builtin_string("v5")),(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "02transpile.c", 615, "sType")),"int",(_Bool)0,info)))));
...
default_value_188 = (void*)0;
    ...
    keys_159=(char**)come_increment_ref_count(((char**)(__right_value238=(char**)come_calloc(1, sizeof(char*)*(1*(size_158)), "./comelang.h", 1621, "char*%"))));
    items_160=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value239=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_158)), "./comelang.h", 1622, "sClass*%"))));
    item_existance_161=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value240=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_158)), "./comelang.h", 1623, "bool"))));
    len_162=0;
...
char* __dec_obj59;
    ...
    if(self!=((void*)0)&&self->mNoExceptionType!=((void*)0)) {
        if(self->mNoExceptionType==gComeFunResultObject) {
            ...
            /* a*/come_call_finalizer3(__dec_obj45,tuple1$1sTypephp_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->mGenericsTypes!=((void*)0)) {
        if(self->mGenericsTypes==gComeFunResultObject) {
            ...
            /* a*/come_call_finalizer3(__dec_obj48,list$1sTypeph_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->mArrayNum!=((void*)0)) {
        if(self->mArrayNum==gComeFunResultObject) {
            ...
            /* a*/come_call_finalizer3(__dec_obj50,list$1sNodeph_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->mParamTypes!=((void*)0)) {
        if(self->mParamTypes==gComeFunResultObject) {
            ...
            /* a*/come_call_finalizer3(__dec_obj52,list$1sTypeph_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->mParamNames!=((void*)0)) {
        if(self->mParamNames==gComeFunResultObject) {
            ...
            /* a*/come_call_finalizer3(__dec_obj53,list$1charph_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->mResultType!=((void*)0)) {
        if(self->mResultType==gComeFunResultObject) {
            ...
            /* a*/come_call_finalizer3(__dec_obj54,tuple1$1sTypephp_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
...
struct sType* __dec_obj55;
    if(self!=((void*)0)&&self->v1!=((void*)0)) {
        if(self->v1==gComeFunResultObject) {
            __dec_obj55=self->v1;
            /* a*/come_call_finalizer3(__dec_obj55,sType_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
...
default_value_237 = (void*)0;
    ...
    keys_222=(char**)come_increment_ref_count(((char**)(__right_value291=(char**)come_calloc(1, sizeof(char*)*(1*(size_221)), "./comelang.h", 1621, "char*%"))));
    items_223=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value292=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_221)), "./comelang.h", 1622, "sType*%"))));
    item_existance_224=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value293=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_221)), "./comelang.h", 1623, "bool"))));
    len_225=0;
...
struct list$1tuple2$2charphsTypephph* __result123__;
    if(self->len==0) {
        litem_243=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value297=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "./comelang.h", 221, "list_item$1tuple2$2charphsTypephph"))));
        litem_243->prev=((void*)0);
        litem_243->next=((void*)0);
        __dec_obj63=litem_243->item;
        ...
        if(self->len==1) {
            litem_244=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value298=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "./comelang.h", 231, "list_item$1tuple2$2charphsTypephph"))));
            litem_244->prev=self->head;
            litem_244->next=((void*)0);
            __dec_obj66=litem_244->item;
            ...
            litem_245=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value299=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "./comelang.h", 241, "list_item$1tuple2$2charphsTypephph"))));
            litem_245->prev=self->tail;
            litem_245->next=((void*)0);
            __dec_obj69=litem_245->item;
...
struct map$2charphsClassModuleph* __dec_obj115;
...
struct map$2charphsClassph* __dec_obj140;
...
struct list$1charph* o2_saved_317;
char* it_318;
struct sInfo info_319;
struct _IO_FILE* tmp_file_320;
...
struct map$2charphsFunph* __dec_obj184;
void* __right_value447 = (void*)0;
void* __right_value448 = (void*)0;
struct map$2charphsGenericsFunph* __dec_obj185;
void* __right_value449 = (void*)0;
void* __right_value450 = (void*)0;
struct map$2charphsClassph* __dec_obj186;
void* __right_value451 = (void*)0;
void* __right_value452 = (void*)0;
struct map$2charphsClassModuleph* __dec_obj187;
void* __right_value453 = (void*)0;
void* __right_value454 = (void*)0;
struct map$2charphsTypeph* __dec_obj188;
...
struct map$2charphsClassph* __dec_obj195;
...
memset(&info_319, 0, sizeof(struct sInfo));
...
memset(&__current_stack3__, 0, sizeof(struct __current_stack3__));
    if(charp_operator_equals(argv[1],"header")&&argc>=3) {
        gProgramName=argv[0];
        clang_option_246=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "02transpile.c", 626, "buffer"))));
        cpp_option_247=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "02transpile.c", 627, "buffer"))));
        files_248=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "02transpile.c", 628, "list$1charph"))));
        object_files_249=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "02transpile.c", 629, "list$1charph"))));
        ...
        for(        i_258=2;        i_258<argc;        i_258++        ){
            if(charp_operator_equals(argv[i_258],"-o")&&i_258+1<argc) {
                __dec_obj74=output_file_name_253;
                                ...
                                if(charp_operator_equals(argv[i_258],"-cg")) {
                                    ...
                                    if(charp_operator_equals(argv[i_258],"-common-header")) {
                                        ...
                                        if(charp_operator_equals(argv[i_258],"-original-position")) {
                                            ...
                                            if((_if_conditional1=(string_operator_equals(((char*)(__right_value336=charp_operator_load_range_element(argv[i_258],0,2))),"-O"))),                                            (__right_value336 = come_decrement_ref_count2(__right_value336, (void*)0, (void*)0, 1, 0, 0, (void*)0)),
                                            _if_conditional1) {
                                                buffer_append_str(clang_option_246,((char*)(__right_value338=xsprintf(" \%s ",((char*)(__right_value337=charp_to_string(argv[i_258])))))));
                                                ...
                                                if((_if_conditional2=(string_operator_equals(((char*)(__right_value339=charp_operator_load_range_element(argv[i_258],0,2))),"-D"))),                                                (__right_value339 = come_decrement_ref_count2(__right_value339, (void*)0, (void*)0, 1, 0, 0, (void*)0)),
                                                _if_conditional2) {
                                                    buffer_append_str(cpp_option_247,((char*)(__right_value341=xsprintf(" \%s ",((char*)(__right_value340=charp_to_string(argv[i_258])))))));
                                                    ...
                                                    buffer_append_str(clang_option_246,((char*)(__right_value343=xsprintf(" \%s ",((char*)(__right_value342=charp_to_string(argv[i_258])))))));
                                                    ...
                                                    if(charp_operator_equals(argv[i_258],"-v")) {
                                                        ...
                                                        if(strlen(argv[i_258])>=2&&memcmp(argv[i_258],"-I",strlen("-I"))==0) {
                                                            buffer_append_str(cpp_option_247,((char*)(__right_value345=charp_operator_add(" ",((char*)(__right_value344=charp_operator_add(argv[i_258]," ")))))));
                                                                ...
                                                                if(charp_operator_equals(argv[i_258],"-s")||charp_operator_equals(argv[i_258],"-S")) {
                                                                    ...
                                                                    if(charp_operator_equals(argv[i_258],"-c")) {
                                                                        ...
                                                                        if(charp_operator_equals(argv[i_258],"-E")) {
                                                                            ...
                                                                            if(argv[i_258][0]==45) {
                                                                                buffer_append_str(clang_option_246,((char*)(__right_value346=charp_operator_add(argv[i_258]," "))));
        ...
        if((_or_conditional11=(system(((char*)(__right_value350=xsprintf("%s %s",RM,output_file_name_253)))))),        (__right_value350 = come_decrement_ref_count2(__right_value350, (void*)0, (void*)0, 1, 0, 0, (void*)0)),
        _or_conditional11 != 0) {
            (come_push_stackframe("02transpile.c", 710, 10),__exception_result_var_b11=die("rm"), come_pop_stackframe(), __exception_result_var_b11);
        }
        if((_and_conditional1=(f_259=fopen(output_file_name_253,"w"))),        _and_conditional1 == 0) {
            (come_push_stackframe("02transpile.c", 712, 11),__exception_result_var_b12=die("fopen"), come_pop_stackframe(), __exception_result_var_b12);
        }
        fclose(f_259);
        tmp_file_260=(char*)come_increment_ref_count(__builtin_string("tmp-common-header.c"));
        system(((char*)(__right_value355=xsprintf("cat \%s > \%s",((char*)(__right_value353=string_to_string(((char*)(__right_value352=list$1charph_join(files_248," ")))))),((char*)(__right_value354=string_to_string(tmp_file_260)))))));
        ...
        __dec_obj95=info_261.funcs;
        info_261.funcs=(struct map$2charphsFunph*)come_increment_ref_count(map$2charphsFunph_initialize((struct map$2charphsFunph*)come_increment_ref_count((struct map$2charphsFunph*)come_calloc(1, sizeof(struct map$2charphsFunph)*(1), "02transpile.c", 730, "map$2charphsFunph"))));
        /* a*/come_call_finalizer3(__dec_obj95,map$2charphsFunph_finalize, 0, 0, 0, 0, (void*)0);
        __dec_obj107=info_261.generics_funcs;
        info_261.generics_funcs=(struct map$2charphsGenericsFunph*)come_increment_ref_count(map$2charphsGenericsFunph_initialize((struct map$2charphsGenericsFunph*)come_increment_ref_count((struct map$2charphsGenericsFunph*)come_calloc(1, sizeof(struct map$2charphsGenericsFunph)*(1), "02transpile.c", 731, "map$2charphsGenericsFunph"))));
        /* a*/come_call_finalizer3(__dec_obj107,map$2charphsGenericsFunph_finalize, 0, 0, 0, 0, (void*)0);
        __dec_obj109=info_261.classes;
        info_261.classes=(struct map$2charphsClassph*)come_increment_ref_count(map$2charphsClassph_initialize((struct map$2charphsClassph*)come_increment_ref_count((struct map$2charphsClassph*)come_calloc(1, sizeof(struct map$2charphsClassph)*(1), "02transpile.c", 732, "map$2charphsClassph"))));
        /* a*/come_call_finalizer3(__dec_obj109,map$2charphsClassph_finalize, 0, 0, 0, 0, (void*)0);
        __dec_obj115=info_261.modules;
        info_261.modules=(struct map$2charphsClassModuleph*)come_increment_ref_count(map$2charphsClassModuleph_initialize((struct map$2charphsClassModuleph*)come_increment_ref_count((struct map$2charphsClassModuleph*)come_calloc(1, sizeof(struct map$2charphsClassModuleph)*(1), "02transpile.c", 733, "map$2charphsClassModuleph"))));
        /* a*/come_call_finalizer3(__dec_obj115,map$2charphsClassModuleph_finalize, 0, 0, 0, 0, (void*)0);
        __dec_obj117=info_261.types;
        info_261.types=(struct map$2charphsTypeph*)come_increment_ref_count(map$2charphsTypeph_initialize((struct map$2charphsTypeph*)come_increment_ref_count((struct map$2charphsTypeph*)come_calloc(1, sizeof(struct map$2charphsTypeph)*(1), "02transpile.c", 734, "map$2charphsTypeph"))));
        /* a*/come_call_finalizer3(__dec_obj117,map$2charphsTypeph_finalize, 0, 0, 0, 0, (void*)0);
        __dec_obj118=info_261.module;
        info_261.module=(struct sModule*)come_increment_ref_count(sModule_initialize((struct sModule*)come_increment_ref_count((struct sModule*)come_calloc(1, sizeof(struct sModule)*(1), "02transpile.c", 735, "sModule"))));
        /* a*/come_call_finalizer3(__dec_obj118,sModule_finalize, 0, 0, 0, 0, (void*)0);
        __dec_obj131=info_261.right_value_objects;
        info_261.right_value_objects=(struct list$1sRightValueObjectph*)come_increment_ref_count(list$1sRightValueObjectph_initialize((struct list$1sRightValueObjectph*)come_increment_ref_count((struct list$1sRightValueObjectph*)come_calloc(1, sizeof(struct list$1sRightValueObjectph)*(1), "02transpile.c", 736, "list$1sRightValueObjectph"))));
        /* a*/come_call_finalizer3(__dec_obj131,list$1sRightValueObjectph_finalize, 0, 0, 0, 0, (void*)0);
        __dec_obj136=info_261.stack;
        info_261.stack=(struct list$1CVALUEph*)come_increment_ref_count(list$1CVALUEph_initialize((struct list$1CVALUEph*)come_increment_ref_count((struct list$1CVALUEph*)come_calloc(1, sizeof(struct list$1CVALUEph)*(1), "02transpile.c", 737, "list$1CVALUEph"))));
        /* a*/come_call_finalizer3(__dec_obj136,list$1CVALUEph_finalize, 0, 0, 0, 0, (void*)0);
        __dec_obj137=info_261.gv_table;
        info_261.gv_table=(struct sVarTable*)come_increment_ref_count(sVarTable_initialize((struct sVarTable*)come_increment_ref_count((struct sVarTable*)come_calloc(1, sizeof(struct sVarTable)*(1), "02transpile.c", 738, "sVarTable")),(_Bool)1,((void*)0)));
        /* a*/come_call_finalizer3(__dec_obj137,sVarTable_finalize, 0, 0, 0, 0, (void*)0);
        lv_table_295=(struct sVarTable*)come_increment_ref_count(sVarTable_initialize((struct sVarTable*)come_increment_ref_count((struct sVarTable*)come_calloc(1, sizeof(struct sVarTable)*(1), "02transpile.c", 739, "sVarTable")),(_Bool)0,((void*)0)));
        info_261.lv_table=lv_table_295;
        __dec_obj138=info_261.generics_type_names;
        info_261.generics_type_names=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "02transpile.c", 741, "list$1charph"))));
        /* a*/come_call_finalizer3(__dec_obj138,list$1charph_finalize, 0, 0, 0, 0, (void*)0);
        __dec_obj139=info_261.method_generics_type_names;
        info_261.method_generics_type_names=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "02transpile.c", 742, "list$1charph"))));
        /* a*/come_call_finalizer3(__dec_obj139,list$1charph_finalize, 0, 0, 0, 0, (void*)0);
        __dec_obj140=info_261.generics_classes;
        info_261.generics_classes=(struct map$2charphsClassph*)come_increment_ref_count(map$2charphsClassph_initialize((struct map$2charphsClassph*)come_increment_ref_count((struct map$2charphsClassph*)come_calloc(1, sizeof(struct map$2charphsClassph)*(1), "02transpile.c", 743, "map$2charphsClassph"))));
        /* a*/come_call_finalizer3(__dec_obj140,map$2charphsClassph_finalize, 0, 0, 0, 0, (void*)0);
        ...
        __dec_obj141=info_261.output_file_name;
        ...
        __dec_obj142=info_261.original_source;
        info_261.original_source=(struct buffer*)come_increment_ref_count(string_to_buffer(((char*)(__right_value413=string_read(((char*)(__right_value412=xsprintf("%s",tmp_file_260))))))));
        /* a*/come_call_finalizer3(__dec_obj142,buffer_finalize, 0, 0, 0, 0, (void*)0);
        ...
        __dec_obj143=info_261.source;
        info_261.source=(struct buffer*)come_increment_ref_count(string_to_buffer(((char*)(__right_value416=string_read(((char*)(__right_value415=xsprintf("%s.i",tmp_file_260))))))));
        ...
        system(((char*)(__right_value418=xsprintf("%s %s*",RM,tmp_file_260))));
                        ...
                        if(charp_operator_equals(argv[1],"debug")&&argc==2) {
                            ...
                            if(charp_operator_equals(argv[1],"clean")&&argc==2) {
                                ...
                                if(charp_operator_equals(argv[1],"install")&&argc>=2) {
                                    ...
                                    gProgramName=argv[0];
                                    clang_option_305=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "02transpile.c", 823, "buffer"))));
                                    cpp_option_306=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "02transpile.c", 824, "buffer"))));
                                    files_307=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "02transpile.c", 825, "list$1charph"))));
                                    object_files_308=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "02transpile.c", 826, "list$1charph"))));
                                    output_object_file_309=(_Bool)0;
                                    output_cpp_file_310=(_Bool)0;
                                    output_source_file_flag_311=(_Bool)0;
                                    output_file_name_312=((void*)0);
                                    verbose_313=(_Bool)0;
                                    come_debug_314=(_Bool)0;
                                    come_malloc_315=(_Bool)0;
                                    for(                                    i_316=1;                                    i_316<argc;                                    i_316++                                    ){
                                        if(charp_operator_equals(argv[i_316],"-o")&&i_316+1<argc) {
                                            __dec_obj180=output_file_name_312;
                                            output_file_name_312=(char*)come_increment_ref_count(__builtin_string(argv[i_316+1]));
                                            __dec_obj180 = come_decrement_ref_count2(__dec_obj180, (void*)0, (void*)0, 0,0,0, (void*)0);
                                            i_316++;
                                        }
                                        else {
                                            if(charp_operator_equals(argv[i_316],"-str")) {
                                                gComeStr=(_Bool)1;
                                            }
                                            else {
                                                if(charp_operator_equals(argv[i_316],"-net")) {
                                                    gComeNet=(_Bool)1;
                                                }
                                                else {
                                                    if(charp_operator_equals(argv[i_316],"-gc")) {
                                                        gComeGC=(_Bool)1;
                                                    }
                                                    else {
                                                        if(charp_operator_equals(argv[i_316],"-cg")) {
                                                            come_debug_314=(_Bool)1;
                                                            buffer_append_str(clang_option_305,"-g ");
                                                        }
                                                        else {
                                                            if(charp_operator_equals(argv[i_316],"-common-header")) {
                                                                gCommonHeader=(_Bool)1;
                                                            }
                                                            else {
                                                                if(charp_operator_equals(argv[i_316],"-original-position")) {
                                                                    gComeOriginalSourcePosition=(_Bool)0;
                                                                }
                                                                else {
                                                                    if((_if_conditional3=(string_operator_equals(((char*)(__right_value428=charp_operator_load_range_element(argv[i_316],0,2))),"-O"))),                                                                    (__right_value428 = come_decrement_ref_count2(__right_value428, (void*)0, (void*)0, 1, 0, 0, (void*)0)),
                                                                    _if_conditional3) {
                                                                        buffer_append_str(clang_option_305,((char*)(__right_value430=xsprintf(" \%s ",((char*)(__right_value429=charp_to_string(argv[i_316])))))));
                                                                        ...
                                                                        if((_if_conditional4=(string_operator_equals(((char*)(__right_value431=charp_operator_load_range_element(argv[i_316],0,2))),"-D"))),                                                                        (__right_value431 = come_decrement_ref_count2(__right_value431, (void*)0, (void*)0, 1, 0, 0, (void*)0)),
                                                                        _if_conditional4) {
                                                                            buffer_append_str(cpp_option_306,((char*)(__right_value433=xsprintf(" \%s ",((char*)(__right_value432=charp_to_string(argv[i_316])))))));
                                                                            ...
                                                                            buffer_append_str(clang_option_305,((char*)(__right_value435=xsprintf(" \%s ",((char*)(__right_value434=charp_to_string(argv[i_316])))))));
                                                                            ...
                                                                            if(charp_operator_equals(argv[i_316],"-g")) {
                                                                                buffer_append_str(clang_option_305,"-g ");
                                                                            }
                                                                            else {
                                                                                if(charp_operator_equals(argv[i_316],"-v")) {
                                                                                    buffer_append_str(clang_option_305,"-v ");
                                                                                    verbose_313=(_Bool)1;
                                                                                }
                                                                                else {
                                                                                    if(strlen(argv[i_316])>=2&&memcmp(argv[i_316],"-I",strlen("-I"))==0) {
                                                                                        buffer_append_str(cpp_option_306,((char*)(__right_value437=charp_operator_add(" ",((char*)(__right_value436=charp_operator_add(argv[i_316]," ")))))));
                                                                                        ...
                                                                                        if(charp_operator_equals(argv[i_316],"-gdwarf-4")) {
                                                                                            buffer_append_str(clang_option_305,"-gdwarf-4 ");
                                                                                        }
                                                                                        else {
                                                                                            if(charp_operator_equals(argv[i_316],"-s")||charp_operator_equals(argv[i_316],"-S")) {
                                                                                                output_source_file_flag_311=(_Bool)1;
                                                                                                gComeOriginalSourcePosition=(_Bool)0;
                                                                                            }
                                                                                            else {
                                                                                                if(charp_operator_equals(argv[i_316],"-c")) {
                                                                                                    output_object_file_309=(_Bool)1;
                                                                                                }
                                                                                                else {
                                                                                                    if(charp_operator_equals(argv[i_316],"-E")) {
                                                                                                        output_cpp_file_310=(_Bool)1;
                                                                                                    }
                                                                                                    else {
                                                                                                        if(argv[i_316][0]==45) {
                                                                                                            buffer_append_str(clang_option_305,((char*)(__right_value438=charp_operator_add(argv[i_316]," "))));
                                                                                                            __right_value438 = come_decrement_ref_count2(__right_value438, (void*)0, (void*)0, 1, 0, 0, (void*)0);
                                                                                                        }
                                                                                                        else {
                                                                                                            if(strlen(argv[i_316])>2&&memcmp(argv[i_316]+strlen(argv[i_316])-2,".o",2)==0) {
                                                                                                                list$1charph_push_back(object_files_308,(char*)come_increment_ref_count(__builtin_string(argv[i_316])));
                                                                                                            }
                                                                                                            else {
                                                                                                                if(strlen(argv[i_316])>2&&memcmp(argv[i_316]+strlen(argv[i_316])-2,".a",2)==0) {
                                                                                                                    list$1charph_push_back(object_files_308,(char*)come_increment_ref_count(__builtin_string(argv[i_316])));
                                                                                                                }
                                                                                                                else {
                                                                                                                    list$1charph_push_back(files_307,(char*)come_increment_ref_count(__builtin_string(argv[i_316])));
                                                                                                                }
                                                                                                            }
                                                                                                        }
                                                                                                    }
                                    ...
                                    gComeDebug=come_debug_314;
                                    gComeMalloc=come_malloc_315;
                                    for(                                    o2_saved_317=(struct list$1charph*)come_increment_ref_count((files_307)),it_318=list$1charph_begin((o2_saved_317));                                    !list$1charph_end((o2_saved_317));                                    it_318=list$1charph_next((o2_saved_317))                                    ){
                                        memset(&info_319,0,sizeof(struct sInfo));
                                        tmp_file_320=fopen(it_318,"r");
                                        if(tmp_file_320==((void*)0)) {
                                            /*i*/come_call_finalizer3((&info_319),sInfo_finalize, 1, 0, 0, 0, (void*)0);
                                            continue;
                                        }
                                        else {
                                            fclose(tmp_file_320);
                                        }
                                        __dec_obj181=info_319.sname;
                                        info_319.sname=(char*)come_increment_ref_count(__builtin_string(it_318));
                                        __dec_obj181 = come_decrement_ref_count2(__dec_obj181, (void*)0, (void*)0, 0,0,0, (void*)0);
                                        info_319.sline=1;
                                        info_319.err_num=0;
                                        __dec_obj182=info_319.clang_option;
                                        info_319.clang_option=(char*)come_increment_ref_count(buffer_to_string(clang_option_305));
                                        __dec_obj182 = come_decrement_ref_count2(__dec_obj182, (void*)0, (void*)0, 0,0,0, (void*)0);
                                        __dec_obj183=info_319.cpp_option;
                                        info_319.cpp_option=(char*)come_increment_ref_count(buffer_to_string(cpp_option_306));
                                        __dec_obj183 = come_decrement_ref_count2(__dec_obj183, (void*)0, (void*)0, 0,0,0, (void*)0);
                                        info_319.no_output_err=(_Bool)0;
                                        __dec_obj184=info_319.funcs;
                                        info_319.funcs=(struct map$2charphsFunph*)come_increment_ref_count(map$2charphsFunph_initialize((struct map$2charphsFunph*)come_increment_ref_count((struct map$2charphsFunph*)come_calloc(1, sizeof(struct map$2charphsFunph)*(1), "02transpile.c", 925, "map$2charphsFunph"))));
                                        /* a*/come_call_finalizer3(__dec_obj184,map$2charphsFunph_finalize, 0, 0, 0, 0, (void*)0);
                                        __dec_obj185=info_319.generics_funcs;
                                        info_319.generics_funcs=(struct map$2charphsGenericsFunph*)come_increment_ref_count(map$2charphsGenericsFunph_initialize((struct map$2charphsGenericsFunph*)come_increment_ref_count((struct map$2charphsGenericsFunph*)come_calloc(1, sizeof(struct map$2charphsGenericsFunph)*(1), "02transpile.c", 926, "map$2charphsGenericsFunph"))));
                                        /* a*/come_call_finalizer3(__dec_obj185,map$2charphsGenericsFunph_finalize, 0, 0, 0, 0, (void*)0);
                                        __dec_obj186=info_319.classes;
                                        info_319.classes=(struct map$2charphsClassph*)come_increment_ref_count(map$2charphsClassph_initialize((struct map$2charphsClassph*)come_increment_ref_count((struct map$2charphsClassph*)come_calloc(1, sizeof(struct map$2charphsClassph)*(1), "02transpile.c", 927, "map$2charphsClassph"))));
                                        /* a*/come_call_finalizer3(__dec_obj186,map$2charphsClassph_finalize, 0, 0, 0, 0, (void*)0);
                                        __dec_obj187=info_319.modules;
                                        info_319.modules=(struct map$2charphsClassModuleph*)come_increment_ref_count(map$2charphsClassModuleph_initialize((struct map$2charphsClassModuleph*)come_increment_ref_count((struct map$2charphsClassModuleph*)come_calloc(1, sizeof(struct map$2charphsClassModuleph)*(1), "02transpile.c", 928, "map$2charphsClassModuleph"))));
                                        /* a*/come_call_finalizer3(__dec_obj187,map$2charphsClassModuleph_finalize, 0, 0, 0, 0, (void*)0);
                                        __dec_obj188=info_319.types;
                                        info_319.types=(struct map$2charphsTypeph*)come_increment_ref_count(map$2charphsTypeph_initialize((struct map$2charphsTypeph*)come_increment_ref_count((struct map$2charphsTypeph*)come_calloc(1, sizeof(struct map$2charphsTypeph)*(1), "02transpile.c", 929, "map$2charphsTypeph"))));
                                        /* a*/come_call_finalizer3(__dec_obj188,map$2charphsTypeph_finalize, 0, 0, 0, 0, (void*)0);
                                        __dec_obj189=info_319.module;
                                        info_319.module=(struct sModule*)come_increment_ref_count(sModule_initialize((struct sModule*)come_increment_ref_count((struct sModule*)come_calloc(1, sizeof(struct sModule)*(1), "02transpile.c", 930, "sModule"))));
                                        /* a*/come_call_finalizer3(__dec_obj189,sModule_finalize, 0, 0, 0, 0, (void*)0);
                                        __dec_obj190=info_319.right_value_objects;
                                        info_319.right_value_objects=(struct list$1sRightValueObjectph*)come_increment_ref_count(list$1sRightValueObjectph_initialize((struct list$1sRightValueObjectph*)come_increment_ref_count((struct list$1sRightValueObjectph*)come_calloc(1, sizeof(struct list$1sRightValueObjectph)*(1), "02transpile.c", 931, "list$1sRightValueObjectph"))));
                                        /* a*/come_call_finalizer3(__dec_obj190,list$1sRightValueObjectph_finalize, 0, 0, 0, 0, (void*)0);
                                        __dec_obj191=info_319.stack;
                                        info_319.stack=(struct list$1CVALUEph*)come_increment_ref_count(list$1CVALUEph_initialize((struct list$1CVALUEph*)come_increment_ref_count((struct list$1CVALUEph*)come_calloc(1, sizeof(struct list$1CVALUEph)*(1), "02transpile.c", 932, "list$1CVALUEph"))));
                                        /* a*/come_call_finalizer3(__dec_obj191,list$1CVALUEph_finalize, 0, 0, 0, 0, (void*)0);
                                        __dec_obj192=info_319.gv_table;
                                        info_319.gv_table=(struct sVarTable*)come_increment_ref_count(sVarTable_initialize((struct sVarTable*)come_increment_ref_count((struct sVarTable*)come_calloc(1, sizeof(struct sVarTable)*(1), "02transpile.c", 933, "sVarTable")),(_Bool)1,((void*)0)));
                                        /* a*/come_call_finalizer3(__dec_obj192,sVarTable_finalize, 0, 0, 0, 0, (void*)0);
                                        lv_table_321=(struct sVarTable*)come_increment_ref_count(sVarTable_initialize((struct sVarTable*)come_increment_ref_count((struct sVarTable*)come_calloc(1, sizeof(struct sVarTable)*(1), "02transpile.c", 934, "sVarTable")),(_Bool)0,((void*)0)));
                                        info_319.lv_table=lv_table_321;
                                        __dec_obj193=info_319.generics_type_names;
                                        info_319.generics_type_names=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "02transpile.c", 936, "list$1charph"))));
                                        /* a*/come_call_finalizer3(__dec_obj193,list$1charph_finalize, 0, 0, 0, 0, (void*)0);
                                        __dec_obj194=info_319.method_generics_type_names;
                                        info_319.method_generics_type_names=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "02transpile.c", 937, "list$1charph"))));
                                        /* a*/come_call_finalizer3(__dec_obj194,list$1charph_finalize, 0, 0, 0, 0, (void*)0);
                                        __dec_obj195=info_319.generics_classes;
                                        info_319.generics_classes=(struct map$2charphsClassph*)come_increment_ref_count(map$2charphsClassph_initialize((struct map$2charphsClassph*)come_increment_ref_count((struct map$2charphsClassph*)come_calloc(1, sizeof(struct map$2charphsClassph)*(1), "02transpile.c", 938, "map$2charphsClassph"))));
                                        /* a*/come_call_finalizer3(__dec_obj195,map$2charphsClassph_finalize, 0, 0, 0, 0, (void*)0);
                                        info_319.verbose=verbose_313;
                                        init_classes(&info_319);
                                        clear_tmp_file(&info_319);
                                        if(!cpp(&info_319)) {
                                            printf("%s %d: transpile failed\n",info_319.sname,info_319.sline);
                                            exit(2);
                                        }
                                        __dec_obj196=info_319.original_source;
                                        info_319.original_source=(struct buffer*)come_increment_ref_count(string_to_buffer(((char*)(__right_value472=string_read(((char*)(__right_value471=xsprintf("%s",it_318))))))));
                                        /* a*/come_call_finalizer3(__dec_obj196,buffer_finalize, 0, 0, 0, 0, (void*)0);
                                        ...
                                        __dec_obj197=info_319.source;
                                        info_319.source=(struct buffer*)come_increment_ref_count(string_to_buffer(((char*)(__right_value475=string_read(((char*)(__right_value474=xsprintf("%s.i",it_318))))))));
                                        /* a*/come_call_finalizer3(__dec_obj197,buffer_finalize, 0, 0, 0, 0, (void*)0);
                                        ...
                                        info_319.p=info_319.source->buf;
                                        info_319.head=info_319.source->buf;
                                        if(output_file_name_312) {
                                            __dec_obj198=info_319.output_file_name;
                                            info_319.output_file_name=(char*)come_increment_ref_count(__builtin_string(output_file_name_312));
                                            __dec_obj198 = come_decrement_ref_count2(__dec_obj198, (void*)0, (void*)0, 0,0,0, (void*)0);
                                        }
                                        else {
                                            __dec_obj199=info_319.output_file_name;
                                            info_319.output_file_name=((void*)0);
                                            __dec_obj199 = come_decrement_ref_count2(__dec_obj199, (void*)0, (void*)0, 0,0,0, (void*)0);
                                        }
                                        if(!output_cpp_file_310) {
                                            transpile_v5(&info_319);
                                            if(!output_source_file_v3(&info_319)) {
                                                printf("%s %d: output source file faield\n",info_319.sname,info_319.sline);
                                                exit(2);
                                            }
                                            if(info_319.err_num>0) {
                                                printf("transpile error. err num %d\n",info_319.err_num);
                                                exit(2);
                                            }
                                            else {
                                                if(!compile(&info_319,output_object_file_309,object_files_308)) {
                                        ...
                                        if(output_cpp_file_310) {
                                            ...
                                            if(info_319.err_num>0) {
                                                ...
                                                if(output_source_file_flag_311) {
                                                    clear_tmp_file_without_object_file_and_ccfile(&info_319);
                                                }
                                                else {
                                                    clear_tmp_file_without_object_file(&info_319);
                                                }
                                            }
                                        }
                                        /*i*/come_call_finalizer3((&info_319),sInfo_finalize, 1, 0, 0, 0, (void*)0);
                                    ...
                                    /*i*/come_call_finalizer3(o2_saved_317,list$1charphp_finalize, 0, 0, 0, 0, (void*)0);
                                    if(!output_object_file_309&&!output_cpp_file_310&&(list$1charph_length(files_307)>0||list$1charph_length(object_files_308)>0)) {
                                        memset(&info_322,0,sizeof(struct sInfo));
                                        __dec_obj200=info_322.sname;
                                        info_322.sname=(char*)come_increment_ref_count(string_clone(list$1charphp_operator_load_element(files_307,0)));
                                        __dec_obj200 = come_decrement_ref_count2(__dec_obj200, (void*)0, (void*)0, 0,0,0, (void*)0);
                                        __dec_obj201=info_322.clang_option;
                                        info_322.clang_option=(char*)come_increment_ref_count(buffer_to_string(clang_option_305));
                                        __dec_obj201 = come_decrement_ref_count2(__dec_obj201, (void*)0, (void*)0, 0,0,0, (void*)0);
                                        info_322.verbose=verbose_313;
                                        if(output_file_name_312) {
                                            __dec_obj202=info_322.output_file_name;
                                            info_322.output_file_name=(char*)come_increment_ref_count(__builtin_string(output_file_name_312));
                                            __dec_obj202 = come_decrement_ref_count2(__dec_obj202, (void*)0, (void*)0, 0,0,0, (void*)0);
                                        }
                                        else {
                                            __dec_obj203=info_322.output_file_name;
                                            info_322.output_file_name=((void*)0);
                                            __dec_obj203 = come_decrement_ref_count2(__dec_obj203, (void*)0, (void*)0, 0,0,0, (void*)0);
                                        }
                                        __current_stack3__.info_322 = &info_322;
                                        __current_stack3__.clang_option_305 = &clang_option_305;
                                        __current_stack3__.cpp_option_306 = &cpp_option_306;
                                        __current_stack3__.files_307 = &files_307;
                                        __current_stack3__.object_files_308 = &object_files_308;
                                        __current_stack3__.output_object_file_309 = &output_object_file_309;
                                        __current_stack3__.output_cpp_file_310 = &output_cpp_file_310;
                                        __current_stack3__.output_source_file_flag_311 = &output_source_file_flag_311;
                                        __current_stack3__.output_file_name_312 = &output_file_name_312;
                                        __current_stack3__.verbose_313 = &verbose_313;
                                        __current_stack3__.come_debug_314 = &come_debug_314;
                                        __current_stack3__.come_malloc_315 = &come_malloc_315;
                                        __current_stack3__.argc = &argc;
                                        __current_stack3__.argv = &argv;
                                        bool_expect(linker(&info_322,object_files_308),&__current_stack3__,(void*)method_block3_02transpilec);
                                        if(!output_cpp_file_310&&!output_source_file_flag_311) {
                                            clear_tmp_file(&info_322);
                                        }
                                        /*i*/come_call_finalizer3((&info_322),sInfo_finalize, 1, 0, 0, 0, (void*)0);
                                    }
                                    /*i*/come_call_finalizer3(clang_option_305,buffer_finalize, 0, 0, 0, 0, (void*)0);
                                    /*i*/come_call_finalizer3(cpp_option_306,buffer_finalize, 0, 0, 0, 0, (void*)0);
                                    /*i*/come_call_finalizer3(files_307,list$1charphp_finalize, 0, 0, 0, 0, (void*)0);
                                    /*i*/come_call_finalizer3(object_files_308,list$1charphp_finalize, 0, 0, 0, 0, (void*)0);
                                    output_file_name_312 = come_decrement_ref_count2(output_file_name_312, (void*)0, (void*)0, 0, 0, 0, (void*)0);
                                }
                            }
                        }
                    }
...
struct map$2charphsFunph* __result126__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value361=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 1370, "char*%"))));
    self->items=(struct sFun**)come_increment_ref_count(((struct sFun**)(__right_value362=(struct sFun**)come_calloc(1, sizeof(struct sFun*)*(1*(128)), "./comelang.h", 1371, "sFun*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value363=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 1372, "bool"))));
    ...
    /* a*/come_call_finalizer3(__dec_obj79,list$1charp_finalize, 0, 0, 0, 0, (void*)0);
    self->it=0;
...
struct map$2charphsGenericsFunph* __result127__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value368=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 1370, "char*%"))));
    self->items=(struct sGenericsFun**)come_increment_ref_count(((struct sGenericsFun**)(__right_value369=(struct sGenericsFun**)come_calloc(1, sizeof(struct sGenericsFun*)*(1*(128)), "./comelang.h", 1371, "sGenericsFun*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value370=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 1372, "bool"))));
    ...
    self->key_list=(struct list$1charp*)come_increment_ref_count(list$1charp_initialize((struct list$1charp*)come_increment_ref_count((struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "./comelang.h", 1382, "list$1charp"))));
    /* a*/come_call_finalizer3(__dec_obj96,list$1charp_finalize, 0, 0, 0, 0, (void*)0);
    self->it=0;
...
char* __dec_obj106;
    if(self!=((void*)0)&&self->mImplType!=((void*)0)) {
        if(self->mImplType==gComeFunResultObject) {
            ...
            /* a*/come_call_finalizer3(__dec_obj97,sType_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->mParamTypes!=((void*)0)) {
        if(self->mParamTypes==gComeFunResultObject) {
            ...
            /* a*/come_call_finalizer3(__dec_obj102,list$1sTypeph_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
            /*i*/come_call_finalizer3(self->mParamTypes,list$1sTypephp_finalize, 0, 0, 0, 0, (void*)0);
        }
...
struct map$2charphsClassph* __result128__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value375=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 1370, "char*%"))));
    self->items=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value376=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(128)), "./comelang.h", 1371, "sClass*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value377=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 1372, "bool"))));
...
struct map$2charphsClassModuleph* __result129__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value382=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 1370, "char*%"))));
    self->items=(struct sClassModule**)come_increment_ref_count(((struct sClassModule**)(__right_value383=(struct sClassModule**)come_calloc(1, sizeof(struct sClassModule*)*(1*(128)), "./comelang.h", 1371, "sClassModule*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value384=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 1372, "bool"))));
    ...
    self->key_list=(struct list$1charp*)come_increment_ref_count(list$1charp_initialize((struct list$1charp*)come_increment_ref_count((struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "./comelang.h", 1382, "list$1charp"))));
    /* a*/come_call_finalizer3(__dec_obj110,list$1charp_finalize, 0, 0, 0, 0, (void*)0);
    self->it=0;
...
struct map$2charphsTypeph* __result130__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value389=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 1370, "char*%"))));
    self->items=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value390=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(128)), "./comelang.h", 1371, "sType*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value391=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 1372, "bool"))));
    ...
    self->key_list=(struct list$1charp*)come_increment_ref_count(list$1charp_initialize((struct list$1charp*)come_increment_ref_count((struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "./comelang.h", 1382, "list$1charp"))));
    /* a*/come_call_finalizer3(__dec_obj116,list$1charp_finalize, 0, 0, 0, 0, (void*)0);
    self->it=0;
...
struct buffer* __dec_obj126;
    ...
    if(self!=((void*)0)&&self->mSourceHead3!=((void*)0)) {
        if(self->mSourceHead3==gComeFunResultObject) {
            __dec_obj121=self->mSourceHead3;
    ...
    if(self!=((void*)0)&&self->mHeader!=((void*)0)) {
        if(self->mHeader==gComeFunResultObject) {
            __dec_obj126=self->mHeader;
            /* a*/come_call_finalizer3(__dec_obj126,buffer_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
...
static void list_item$1sRightValueObjectphp_finalize(struct list_item$1sRightValueObjectph* self){
struct sRightValueObject* __dec_obj127;
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        if(self->item==gComeFunResultObject) {
            __dec_obj127=self->item;
            /* a*/come_call_finalizer3(__dec_obj127,sRightValueObject_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
...
struct CVALUE* __dec_obj132;
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        if(self->item==gComeFunResultObject) {
            ...
            /* a*/come_call_finalizer3(__dec_obj132,CVALUE_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
...
char* __dec_obj150;
char* __dec_obj151;
struct map$2charphsFunph* __dec_obj152;
struct map$2charphsGenericsFunph* __dec_obj153;
struct map$2charphsClassph* __dec_obj154;
struct map$2charphsClassModuleph* __dec_obj155;
struct map$2charphsTypeph* __dec_obj156;
struct map$2charphsClassph* __dec_obj157;
struct sModule* __dec_obj158;
struct sType* __dec_obj159;
struct list$1sRightValueObjectph* __dec_obj160;
struct sType* __dec_obj161;
struct list$1sTypeph* __dec_obj162;
struct list$1CVALUEph* __dec_obj163;
...
struct list$1sVarph* __dec_obj174;
    if(self!=((void*)0)&&self->original_source!=((void*)0)) {
        if(self->original_source==gComeFunResultObject) {
            __dec_obj144=self->original_source;
            /* a*/come_call_finalizer3(__dec_obj144,buffer_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->clang_option!=((void*)0)) {
        if(self->clang_option==gComeFunResultObject) {
            __dec_obj149=self->clang_option;
    ...
    if(self!=((void*)0)&&self->come_fun_name!=((void*)0)) {
        if(self->come_fun_name==gComeFunResultObject) {
            __dec_obj151=self->come_fun_name;
    ...
    if(self!=((void*)0)&&self->funcs!=((void*)0)) {
        if(self->funcs==gComeFunResultObject) {
            __dec_obj152=self->funcs;
            /* a*/come_call_finalizer3(__dec_obj152,map$2charphsFunph_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->generics_funcs!=((void*)0)) {
        if(self->generics_funcs==gComeFunResultObject) {
            __dec_obj153=self->generics_funcs;
            /* a*/come_call_finalizer3(__dec_obj153,map$2charphsGenericsFunph_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->classes!=((void*)0)) {
        if(self->classes==gComeFunResultObject) {
            __dec_obj154=self->classes;
            /* a*/come_call_finalizer3(__dec_obj154,map$2charphsClassph_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->modules!=((void*)0)) {
        if(self->modules==gComeFunResultObject) {
            __dec_obj155=self->modules;
            /* a*/come_call_finalizer3(__dec_obj155,map$2charphsClassModuleph_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->types!=((void*)0)) {
        if(self->types==gComeFunResultObject) {
            __dec_obj156=self->types;
            /* a*/come_call_finalizer3(__dec_obj156,map$2charphsTypeph_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->generics_classes!=((void*)0)) {
        if(self->generics_classes==gComeFunResultObject) {
            __dec_obj157=self->generics_classes;
            /* a*/come_call_finalizer3(__dec_obj157,map$2charphsClassph_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->module!=((void*)0)) {
        if(self->module==gComeFunResultObject) {
            __dec_obj158=self->module;
            /* a*/come_call_finalizer3(__dec_obj158,sModule_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->right_value_objects!=((void*)0)) {
        if(self->right_value_objects==gComeFunResultObject) {
            __dec_obj160=self->right_value_objects;
            /* a*/come_call_finalizer3(__dec_obj160,list$1sRightValueObjectph_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->generics_type!=((void*)0)) {
        if(self->generics_type==gComeFunResultObject) {
            __dec_obj161=self->generics_type;
            /* a*/come_call_finalizer3(__dec_obj161,sType_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->method_generics_types!=((void*)0)) {
        if(self->method_generics_types==gComeFunResultObject) {
            ...
            /* a*/come_call_finalizer3(__dec_obj162,list$1sTypeph_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->stack!=((void*)0)) {
        if(self->stack==gComeFunResultObject) {
            __dec_obj163=self->stack;
            /* a*/come_call_finalizer3(__dec_obj163,list$1CVALUEph_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->come_function_result_type!=((void*)0)) {
        if(self->come_function_result_type==gComeFunResultObject) {
            __dec_obj164=self->come_function_result_type;
            /* a*/come_call_finalizer3(__dec_obj164,sType_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->come_method_block_function_result_type!=((void*)0)) {
        if(self->come_method_block_function_result_type==gComeFunResultObject) {
            __dec_obj165=self->come_method_block_function_result_type;
    ...
    if(self!=((void*)0)&&self->gv_table!=((void*)0)) {
        if(self->gv_table==gComeFunResultObject) {
            __dec_obj166=self->gv_table;
            /* a*/come_call_finalizer3(__dec_obj166,sVarTable_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->generics_type_names!=((void*)0)) {
        if(self->generics_type_names==gComeFunResultObject) {
            __dec_obj167=self->generics_type_names;
    ...
    if(self!=((void*)0)&&self->method_generics_type_names!=((void*)0)) {
        if(self->method_generics_type_names==gComeFunResultObject) {
            __dec_obj168=self->method_generics_type_names;
    ...
    if(self!=((void*)0)&&self->output_file_name!=((void*)0)) {
        if(self->output_file_name==gComeFunResultObject) {
            __dec_obj170=self->output_file_name;
    ...
    if(self!=((void*)0)&&self->function_result_type!=((void*)0)) {
        if(self->function_result_type==gComeFunResultObject) {
            __dec_obj171=self->function_result_type;
            /* a*/come_call_finalizer3(__dec_obj171,sType_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->module_params!=((void*)0)) {
        if(self->module_params==gComeFunResultObject) {
            __dec_obj172=self->module_params;
            /* a*/come_call_finalizer3(__dec_obj172,map$2charphcharph_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
    ...
    if(self!=((void*)0)&&self->if_result_var_name!=((void*)0)) {
        if(self->if_result_var_name==gComeFunResultObject) {
            __dec_obj173=self->if_result_var_name;
    ...
    if(self!=((void*)0)&&self->match_it_var!=((void*)0)) {
        if(self->match_it_var==gComeFunResultObject) {
            __dec_obj174=self->match_it_var;
            /* a*/come_call_finalizer3(__dec_obj174,list$1sVarph_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
...
static void list$1sVarph_finalize(struct list$1sVarph* self){
struct list_item$1sVarph* it_301;
struct list_item$1sVarph* prev_it_302;
    it_301=self->head;
    while(it_301!=((void*)0)) {
        prev_it_302=it_301;
        it_301=it_301->next;
        /*i*/come_call_finalizer3(prev_it_302,list_item$1sVarphp_finalize, 0, 0, 0, 0, (void*)0);
    }
}
...
struct sVar* __dec_obj175;
    if(self!=((void*)0)&&self->item!=((void*)0)) {
        if(self->item==gComeFunResultObject) {
            ...
            /* a*/come_call_finalizer3(__dec_obj175,sVar_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
...
char* __dec_obj179;
    ...
    if(self!=((void*)0)&&self->mType!=((void*)0)) {
        if(self->mType==gComeFunResultObject) {
            ...
            /* a*/come_call_finalizer3(__dec_obj178,sType_finalize, 0, 0, 1, 0, (void*)0);
        }
        else {
            /*i*/come_call_finalizer3(self->mType,sType_finalize, 0, 0, 0, 0, (void*)0);
        }
...
static void list$1sVarphp_finalize(struct list$1sVarph* self){
struct list_item$1sVarph* it_303;
struct list_item$1sVarph* prev_it_304;
    it_303=self->head;
    while(it_303!=((void*)0)) {
        prev_it_304=it_303;
        it_303=it_303->next;
        /*i*/come_call_finalizer3(prev_it_304,list_item$1sVarphp_finalize, 0, 0, 0, 0, (void*)0);
    }
}
...
default_value_325 = (void*)0;
    ...
    while(it_323!=((void*)0)) {
        if(position==i_324) {
            __result133__ = gComeFunResultObject = __result_obj__ = it_323->item;
            gComeFunResultObject = (void*)0;
    ...
    __result134__ = gComeFunResultObject = __result_obj__ = default_value_325;
    default_value_325 = come_decrement_ref_count2(default_value_325, (void*)0, (void*)0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
    return __result134__;
}

void method_block3_02transpilec(struct __current_stack3__* parent){
    printf("%s %d: linker faield\n",(*(parent->info_322)).sname,(*(parent->info_322)).sline);
    exit(13);
}
