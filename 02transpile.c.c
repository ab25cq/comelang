...
struct list$1charph* __result68__;
    result_74=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "./comelang2.h", 651, "list$1charph"))));
    if(begin<0) {
        begin+=self->len;
    }
    if(tail<0) {
...
struct list$1charph* __result67__;
    if(self->len==0) {
        litem_79=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value127=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 221, "list_item$1charph"))));
        ...
        if(self->len==1) {
            litem_80=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value128=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 231, "list_item$1charph"))));
            ...
            litem_81=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value129=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 241, "list_item$1charph"))));
...
struct list$1charph* __result69__;
    result_82=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "./comelang2.h", 860, "list$1charph"))));
    it_83=self->head;
    while(it_83!=((void*)0)) {
...
char* __result77__;
    buf_85=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "./comelang2.h", 956, "buffer"))));
    n_86=0;
...
default_value_124 = (void*)0;
    ...
    if(position==0) {
        litem_125=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value172=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 381, "list_item$1charph"))));
        ...
        if(self->len==1) {
            litem_126=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value173=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 393, "list_item$1charph"))));
            ...
            while(it_127!=((void*)0)) {
                if(position==i_128) {
                    litem_129=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value174=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 409, "list_item$1charph"))));
...
_Bool __result85__;
    ...
    if(gComeStr) {
        buffer_append_str(command_131," -lcomelang2-str -lpcre ");
    }
    if(gComeGC) {
        buffer_append_str(command_131," -lcomelang2-gc -lgc ");
    }
    if(gComeNet) {
        __dec_obj35=cmd_134;
        ...
        if(rc3_139==0) {
            buffer_append_str(command_131," -lcomelang2-net -lssl -I/data/data/com.termux/files/usr/include/mariadb -lmariadb");
        }
        else {
            if(rc_135==0||rc2_138==0) {
                buffer_append_str(command_131," -lcomelang2-net -lssl -I/usr/include/mariadb -L/usr/lib -lmariadb");
            }
            else {
                buffer_append_str(command_131," -lcomelang2-net -lssl `mysql_config --cflags --libs`");
            }
        }
    ...
    buffer_append_str(command_131," -lcomelang2 ");
    if(info->verbose) {
...
_Bool __result86__;
    ...
    cc_142=(char*)come_increment_ref_count(__builtin_string("comelang2"));
...
default_value_182 = (void*)0;
    ...
    keys_153=(char**)come_increment_ref_count(((char**)(__right_value238=(char**)come_calloc(1, sizeof(char*)*(1*(size_152)), "./comelang2.h", 1620, "char*%"))));
    items_154=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value239=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_152)), "./comelang2.h", 1621, "sClass*%"))));
    item_existance_155=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value240=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_152)), "./comelang2.h", 1622, "bool"))));
    len_156=0;
...
default_value_231 = (void*)0;
    ...
    keys_216=(char**)come_increment_ref_count(((char**)(__right_value291=(char**)come_calloc(1, sizeof(char*)*(1*(size_215)), "./comelang2.h", 1620, "char*%"))));
    items_217=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value292=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_215)), "./comelang2.h", 1621, "sType*%"))));
    item_existance_218=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value293=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_215)), "./comelang2.h", 1622, "bool"))));
    len_219=0;
...
struct list$1tuple2$2charphsTypephph* __result119__;
    if(self->len==0) {
        litem_237=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value297=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "./comelang2.h", 221, "list_item$1tuple2$2charphsTypephph"))));
        ...
        if(self->len==1) {
            litem_238=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value298=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "./comelang2.h", 231, "list_item$1tuple2$2charphsTypephph"))));
            ...
            litem_239=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value299=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "./comelang2.h", 241, "list_item$1tuple2$2charphsTypephph"))));
...
struct map$2charphsFunph* __result122__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value361=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang2.h", 1369, "char*%"))));
    self->items=(struct sFun**)come_increment_ref_count(((struct sFun**)(__right_value362=(struct sFun**)come_calloc(1, sizeof(struct sFun*)*(1*(128)), "./comelang2.h", 1370, "sFun*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value363=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang2.h", 1371, "bool"))));
...
struct map$2charphsGenericsFunph* __result123__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value368=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang2.h", 1369, "char*%"))));
    self->items=(struct sGenericsFun**)come_increment_ref_count(((struct sGenericsFun**)(__right_value369=(struct sGenericsFun**)come_calloc(1, sizeof(struct sGenericsFun*)*(1*(128)), "./comelang2.h", 1370, "sGenericsFun*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value370=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang2.h", 1371, "bool"))));
...
struct map$2charphsClassph* __result124__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value375=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang2.h", 1369, "char*%"))));
    self->items=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value376=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(128)), "./comelang2.h", 1370, "sClass*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value377=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang2.h", 1371, "bool"))));
...
struct map$2charphsClassModuleph* __result125__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value382=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang2.h", 1369, "char*%"))));
    self->items=(struct sClassModule**)come_increment_ref_count(((struct sClassModule**)(__right_value383=(struct sClassModule**)come_calloc(1, sizeof(struct sClassModule*)*(1*(128)), "./comelang2.h", 1370, "sClassModule*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value384=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang2.h", 1371, "bool"))));
...
struct map$2charphsTypeph* __result126__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value389=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang2.h", 1369, "char*%"))));
    self->items=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value390=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(128)), "./comelang2.h", 1370, "sType*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value391=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang2.h", 1371, "bool"))));
