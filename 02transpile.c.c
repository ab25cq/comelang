...
output_file_name = (void*)0;
    ...
    is_minux=system("uname | grep Minux")==0;
    if(({    (_condtional_value_X84=(is_minux));    _condtional_value_X84;    })) {
    }
    else {
        is_mac=system("uname -a | grep Darwin 1> /dev/null 2>/dev/null")==0;
        ...
        if(({        (_condtional_value_X87=(rc!=0));        _condtional_value_X87;        })) {
            ...
            if(({            (_condtional_value_X89=(rc_25!=0));            _condtional_value_X89;            })) {
                printf("%s is faild\n",CC);
...
default_value = (void*)0;
    ...
    if(({    (_condtional_value_X100=(position==0));    _condtional_value_X100;    })) {
        litem=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value64=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1264, "struct list_item$1char$ph*"))));
        litem->prev=((void*)0);
        ...
        litem_28=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value65=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1276, "struct list_item$1char$ph*"))));
        ...
        while(({        (_condtional_value_X102=(it!=((void*)0)));        _condtional_value_X102;        })) {
            if(({            (_condtional_value_X103=(position==i_29));            _condtional_value_X103;            })) {
                litem_30=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value66=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1292, "struct list_item$1char$ph*"))));
...
struct list$1char$ph* __result_obj__3;
    if(({    (_condtional_value_X98=(self->len==0));    _condtional_value_X98;    })) {
        litem=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value61=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1104, "struct list_item$1char$ph*"))));
        litem->prev=((void*)0);
        litem->next=((void*)0);
        ...
        litem_26=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value62=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1114, "struct list_item$1char$ph*"))));
        ...
        litem_27=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value63=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1124, "struct list_item$1char$ph*"))));
...
_Bool __result_obj__14;
    ...
    is_minux=system("uname | grep Minux")==0;
    if(({    (_condtional_value_X105=(is_minux));    _condtional_value_X105;    })) {
    }
    else {
        command=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "02transpile.c", 404, "struct buffer*"))));
        buffer_append_format(command,"%s -o %s ",CC,output_file_name);
        is_mac=system("uname -a | grep Darwin 1> /dev/null 2>/dev/null")==0;
        if(({        (_condtional_value_X106=(is_mac));        _condtional_value_X106;        })) {
        ...
        for(        ({        (_condtional_value_X109=(o2_saved=object_files,it=list$1char$ph_begin(o2_saved)));        _condtional_value_X109;        });        ({        (_condtional_value_X110=(!list$1char$ph_end(o2_saved)));        _condtional_value_X110;        });        ({        (_condtional_value_X113=(it=list$1char$ph_next(o2_saved)));        _condtional_value_X113;        })        ){
            buffer_append_format(command,"%s ",it);
        }
        is_mac_33=system("uname -a | grep Darwin 1> /dev/null 2>/dev/null")==0;
        if(({        (_condtional_value_X114=(is_mac_33));        _condtional_value_X114;        })) {
        ...
        rc=system(cmd);
        if(({        (_condtional_value_X115=(rc==0));        _condtional_value_X115;        })) {
        ...
        rc_35=system(cmd_34);
        if(({        (_condtional_value_X116=(rc_35==0));        _condtional_value_X116;        })) {
        ...
        rc_37=system(cmd_36);
        if(({        (_condtional_value_X117=(rc_37==0));        _condtional_value_X117;        })) {
            buffer_append_format(command," -L%s/lib ","/usr/local/");
        }
        buffer_append_format(command," %s ",info->clang_option);
        if(({        (_condtional_value_X118=(gComeStr));        _condtional_value_X118;        })) {
            buffer_append_format(command," -lpcre ");
        }
        if(({        (_condtional_value_X119=(gComeGC));        _condtional_value_X119;        })) {
            buffer_append_str(command," -lgc ");
        }
        if(({        (_condtional_value_X120=(gComePthread));        _condtional_value_X120;        })) {
            buffer_append_str(command," -lpthread ");
        }
        if(({        (_condtional_value_X121=(gComeNet));        _condtional_value_X121;        })) {
            is_apline=system("which apk 1> /dev/null 2>/dev/null")==0;
            is_debian=system("uname -a | grep Debian 1> /dev/null 2>/dev/null")==0;
            is_android=system("uname -a | grep Android 1>/dev/null 2>/dev/null")==0;
            if(({            (_condtional_value_X122=(is_android));            _condtional_value_X122;            })) {
                buffer_append_str(command," -lssl -I/data/data/com.termux/files/usr/include/mariadb -lmariadb");
            }
            else if(({            (_condtional_value_X123=(is_apline||is_debian));            _condtional_value_X123;            })) {
                buffer_append_str(command," -lssl -I/usr/include/mariadb -L/usr/lib -lmariadb");
            }
            else if(({            (_condtional_value_X124=(is_mac_33));            _condtional_value_X124;            })) {
        ...
        if(({        (_condtional_value_X125=(info->verbose));        _condtional_value_X125;        })) {
        ...
        if(({        (_condtional_value_X126=(Value));        (__right_value82 = come_decrement_ref_count(__right_value82, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, (void*)0));
        _condtional_value_X126;        })) {
            ...
            Value_38=system(str);
            if(({            (_condtional_value_X127=(Value_38));            _condtional_value_X127;            })) {
                printf("%s is failed\n",CC);
...
result_31 = (void*)0;
    ...
    self->it=self->head;
    if(({    (_condtional_value_X108=(self->it));    _condtional_value_X108;    })) {
...
result = (void*)0;
result_32 = (void*)0;
    if(({    (_condtional_value_X111=(self==((void*)0)||self->it==((void*)0)));    _condtional_value_X111;    })) {
        memset(&result,0,sizeof(char*));
        __result_obj__10 = result;
        return __result_obj__10;
    }
    self->it=self->it->next;
    if(({    (_condtional_value_X112=(self->it));    _condtional_value_X112;    })) {
...
_Bool __result_obj__15;
    ...
    if(({    (_condtional_value_X128=(Value<0));    (__right_value103 = come_decrement_ref_count(__right_value103, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, (void*)0));
    (__right_value104 = come_decrement_ref_count(__right_value104, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, (void*)0));
    _condtional_value_X128;    })) {
...
_Bool __exception_result_var_b4;
    Value=fopen("common.h","r");
    if(({    (_condtional_value_X129=(Value));    _condtional_value_X129;    })) {
        fclose(Value);
    }
    else {
        Value_39=system("make header");
        if(({        (_condtional_value_X130=(Value_39<0));        _condtional_value_X130;        })) {
            (come_push_stackframe("02transpile.c", 606, 1),__exception_result_var_b2=die("system"), come_pop_stackframe(), __exception_result_var_b2);
        }
        else {
        }
    }
    Value_40=system("make compile -j$(sysctl -n hw.logicalcpu)");
    if(({    (_condtional_value_X131=(Value_40<0));    _condtional_value_X131;    })) {
        (come_push_stackframe("02transpile.c", 612, 2),__exception_result_var_b3=die("system"), come_pop_stackframe(), __exception_result_var_b3);
    }
    else {
    }
    Value_41=system("make run");
    if(({    (_condtional_value_X132=(Value_41<0));    _condtional_value_X132;    })) {
        (come_push_stackframe("02transpile.c", 621, 3),__exception_result_var_b4=die("system"), come_pop_stackframe(), __exception_result_var_b4);
    }
    else {
    }
    return (_Bool)1;
...
_Bool __exception_result_var_b5;
    ...
    if(({    (_condtional_value_X133=(Value<0));    _condtional_value_X133;    })) {
        (come_push_stackframe("02transpile.c", 630, 4),__exception_result_var_b5=die("system"), come_pop_stackframe(), __exception_result_var_b5);
    }
    else {
    }
    return (_Bool)1;
...
_Bool __exception_result_var_b7;
    ...
    if(({    (_condtional_value_X134=(Value));    _condtional_value_X134;    })) {
        ...
        if(({        (_condtional_value_X135=(Value_42<0));        _condtional_value_X135;        })) {
            (come_push_stackframe("02transpile.c", 643, 5),__exception_result_var_b6=die("system"), come_pop_stackframe(), __exception_result_var_b6);
        }
        else {
        }
    }
    Value_43=system("make compile -j$(sysctl -n hw.logicalcpu)");
    if(({    (_condtional_value_X136=(Value_43<0));    _condtional_value_X136;    })) {
        (come_push_stackframe("02transpile.c", 649, 6),__exception_result_var_b7=die("system"), come_pop_stackframe(), __exception_result_var_b7);
    }
    else {
    }
    return (_Bool)1;
...
_Bool __exception_result_var_b9;
    Value=fopen("common.h","r");
    if(({    (_condtional_value_X137=(Value));    _condtional_value_X137;    })) {
        fclose(Value);
    }
    else {
        Value_44=system("make header");
        if(({        (_condtional_value_X138=(Value_44<0));        _condtional_value_X138;        })) {
            (come_push_stackframe("02transpile.c", 667, 7),__exception_result_var_b8=die("system"), come_pop_stackframe(), __exception_result_var_b8);
        }
        else {
        }
    }
    Value_45=system("make debug -j$(sysctl -n hw.logicalcpu)");
    if(({    (_condtional_value_X139=(Value_45<0));    _condtional_value_X139;    })) {
        (come_push_stackframe("02transpile.c", 673, 8),__exception_result_var_b9=die("system"), come_pop_stackframe(), __exception_result_var_b9);
    }
    else {
    }
    return (_Bool)1;
...
_Bool __exception_result_var_b10;
    ...
    if(({    (_condtional_value_X140=(Value<0));    _condtional_value_X140;    })) {
        (come_push_stackframe("02transpile.c", 687, 9),__exception_result_var_b10=die("system"), come_pop_stackframe(), __exception_result_var_b10);
    }
    else {
    }
    return (_Bool)1;
...
_Bool __exception_result_var_b11;
    ...
    if(({    (_condtional_value_X141=(Value<0));    (__right_value133 = come_decrement_ref_count(__right_value133, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, (void*)0));
    (__right_value134 = come_decrement_ref_count(__right_value134, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, (void*)0));
    _condtional_value_X141;    })) {
        (come_push_stackframe("02transpile.c", 696, 10),__exception_result_var_b11=die("system"), come_pop_stackframe(), __exception_result_var_b11);
    }
    else {
    }
    return (_Bool)1;
...
void* __right_value249 = (void*)0;
    map$2char$phsClass$ph_insert(info->classes,(char*)come_increment_ref_count(__builtin_string("int")),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "02transpile.c", 704, "struct sClass*")),(char*)come_increment_ref_count(xsprintf("int")),(_Bool)1,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,-1,-1,(_Bool)0,(_Bool)0,info)));
    map$2char$phsClass$ph_insert(info->classes,(char*)come_increment_ref_count(__builtin_string("short")),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "02transpile.c", 705, "struct sClass*")),(char*)come_increment_ref_count(xsprintf("short")),(_Bool)1,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,-1,-1,(_Bool)0,(_Bool)0,info)));
    map$2char$phsClass$ph_insert(info->classes,(char*)come_increment_ref_count(__builtin_string("long")),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "02transpile.c", 706, "struct sClass*")),(char*)come_increment_ref_count(xsprintf("long")),(_Bool)1,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,-1,-1,(_Bool)0,(_Bool)0,info)));
    map$2char$phsClass$ph_insert(info->classes,(char*)come_increment_ref_count(__builtin_string("char")),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "02transpile.c", 707, "struct sClass*")),(char*)come_increment_ref_count(xsprintf("char")),(_Bool)1,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,-1,-1,(_Bool)0,(_Bool)0,info)));
    map$2char$phsClass$ph_insert(info->classes,(char*)come_increment_ref_count(__builtin_string("bool")),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "02transpile.c", 708, "struct sClass*")),(char*)come_increment_ref_count(xsprintf("bool")),(_Bool)1,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,-1,-1,(_Bool)0,(_Bool)0,info)));
    map$2char$phsClass$ph_insert(info->classes,(char*)come_increment_ref_count(__builtin_string("_Bool")),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "02transpile.c", 709, "struct sClass*")),(char*)come_increment_ref_count(xsprintf("_Bool")),(_Bool)1,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,-1,-1,(_Bool)0,(_Bool)0,info)));
    map$2char$phsClass$ph_insert(info->classes,(char*)come_increment_ref_count(__builtin_string("void")),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "02transpile.c", 710, "struct sClass*")),(char*)come_increment_ref_count(xsprintf("void")),(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,-1,-1,(_Bool)0,(_Bool)0,info)));
    map$2char$phsClass$ph_insert(info->classes,(char*)come_increment_ref_count(__builtin_string("float")),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "02transpile.c", 711, "struct sClass*")),(char*)come_increment_ref_count(xsprintf("float")),(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)1,-1,-1,(_Bool)0,(_Bool)0,info)));
    map$2char$phsClass$ph_insert(info->classes,(char*)come_increment_ref_count(__builtin_string("double")),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "02transpile.c", 712, "struct sClass*")),(char*)come_increment_ref_count(xsprintf("double")),(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)1,-1,-1,(_Bool)0,(_Bool)0,info)));
    map$2char$phsClass$ph_insert(info->classes,(char*)come_increment_ref_count(__builtin_string("_Float16")),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "02transpile.c", 713, "struct sClass*")),(char*)come_increment_ref_count(xsprintf("_Float16")),(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)1,-1,-1,(_Bool)0,(_Bool)0,info)));
    map$2char$phsClass$ph_insert(info->classes,(char*)come_increment_ref_count(__builtin_string("lambda")),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "02transpile.c", 714, "struct sClass*")),(char*)come_increment_ref_count(xsprintf("lambda")),(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,-1,-1,(_Bool)0,(_Bool)0,info)));
    map$2char$phsClass$ph_insert(info->classes,(char*)come_increment_ref_count(__builtin_string("__uint128_t")),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "02transpile.c", 715, "struct sClass*")),(char*)come_increment_ref_count(xsprintf("__uint128_t")),(_Bool)1,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,-1,-1,(_Bool)0,(_Bool)0,info)));
    map$2char$phsClass$ph_insert(info->classes,(char*)come_increment_ref_count(__builtin_string("__int128")),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "02transpile.c", 716, "struct sClass*")),(char*)come_increment_ref_count(xsprintf("__int128")),(_Bool)1,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,-1,-1,(_Bool)0,(_Bool)0,info)));
    for(    ({    (_condtional_value_X205=(i=0));    _condtional_value_X205;    });    ({    (_condtional_value_X206=(i<12));    _condtional_value_X206;    });    ({    (_condtional_value_X207=(i++));    _condtional_value_X207;    })    ){
        generics_type=(char*)come_increment_ref_count(xsprintf("__generics_type%d",i));
        map$2char$phsClass$ph_insert(info->classes,(char*)come_increment_ref_count(generics_type),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "02transpile.c", 719, "struct sClass*")),(char*)come_increment_ref_count(generics_type),(_Bool)0,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,i,-1,(_Bool)0,(_Bool)0,info)));
        (generics_type = come_decrement_ref_count(generics_type, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    for(    ({    (_condtional_value_X208=(i_55=0));    _condtional_value_X208;    });    ({    (_condtional_value_X209=(i_55<7));    _condtional_value_X209;    });    ({    (_condtional_value_X210=(i_55++));    _condtional_value_X210;    })    ){
        generics_type_56=(char*)come_increment_ref_count(xsprintf("__mgenerics_type%d",i_55));
        map$2char$phsClass$ph_insert(info->classes,(char*)come_increment_ref_count(generics_type_56),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "02transpile.c", 723, "struct sClass*")),(char*)come_increment_ref_count(generics_type_56),(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0,(_Bool)0,-1,i_55,(_Bool)0,(_Bool)0,info)));
        (generics_type_56 = come_decrement_ref_count(generics_type_56, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    is_mac=system("uname -a | grep Darwin 1> /dev/null 2>/dev/null")==0;
    if(({    (_condtional_value_X211=(is_mac));    _condtional_value_X211;    })) {
        map$2char$phsClass$ph_insert(info->classes,(char*)come_increment_ref_count(__builtin_string("__builtin_va_list")),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "02transpile.c", 728, "struct sClass*")),(char*)come_increment_ref_count(xsprintf("__builtin_va_list")),(_Bool)1,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,-1,-1,(_Bool)0,(_Bool)0,info)));
        type_name=(char*)come_increment_ref_count(__builtin_string("__builtin_va_list"));
        type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "02transpile.c", 732, "struct sType*")),(char*)come_increment_ref_count(xsprintf("__builtin_va_list")),(_Bool)0,info));
        ...
        klass=(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc_v2(1, sizeof(struct sClass)*(1), "02transpile.c", 738, "struct sClass*")),(char*)come_increment_ref_count(xsprintf("__builtin_va_list")),(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)1,(_Bool)0,-1,-1,(_Bool)0,(_Bool)0,info));
        ...
        list$1tuple2$2char$phsType$ph$ph_push_back(klass->mFields,(struct tuple2$2char$phsType$ph*)come_increment_ref_count(tuple2$2char$phsType$ph_initialize((struct tuple2$2char$phsType$ph*)come_increment_ref_count((struct tuple2$2char$phsType$ph*)come_calloc_v2(1, sizeof(struct tuple2$2char$phsType$ph)*(1), "02transpile.c", 741, "struct tuple2$2char$phsType$ph")),(char*)come_increment_ref_count(__builtin_string("v2")),(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "02transpile.c", 741, "struct sType*")),(char*)come_increment_ref_count(xsprintf("char*")),(_Bool)0,info)))));
        list$1tuple2$2char$phsType$ph$ph_push_back(klass->mFields,(struct tuple2$2char$phsType$ph*)come_increment_ref_count(tuple2$2char$phsType$ph_initialize((struct tuple2$2char$phsType$ph*)come_increment_ref_count((struct tuple2$2char$phsType$ph*)come_calloc_v2(1, sizeof(struct tuple2$2char$phsType$ph)*(1), "02transpile.c", 742, "struct tuple2$2char$phsType$ph")),(char*)come_increment_ref_count(__builtin_string("v3")),(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "02transpile.c", 742, "struct sType*")),(char*)come_increment_ref_count(xsprintf("char*")),(_Bool)0,info)))));
        ...
        list$1tuple2$2char$phsType$ph$ph_push_back(klass->mFields,(struct tuple2$2char$phsType$ph*)come_increment_ref_count(tuple2$2char$phsType$ph_initialize((struct tuple2$2char$phsType$ph*)come_increment_ref_count((struct tuple2$2char$phsType$ph*)come_calloc_v2(1, sizeof(struct tuple2$2char$phsType$ph)*(1), "02transpile.c", 744, "struct tuple2$2char$phsType$ph")),(char*)come_increment_ref_count(__builtin_string("v5")),(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "02transpile.c", 744, "struct sType*")),(char*)come_increment_ref_count(xsprintf("int")),(_Bool)0,info)))));
...
struct map$2char$phsClass$ph* __result_obj__30;
    if(({    (_condtional_value_X142=(self->len*10>=self->size));    _condtional_value_X142;    })) {
        map$2char$phsClass$ph_rehash(self);
    }
    hash=string_get_hash_key(((char*)key))%self->size;
    it=hash;
    while(({    (_condtional_value_X167=((_Bool)1));    _condtional_value_X167;    })) {
        if(({        (_condtional_value_X168=(self->item_existance[it]));        _condtional_value_X168;        })) {
            if(({            (_condtional_value_X169=(string_equals(self->keys[it],key)));            _condtional_value_X169;            })) {
            ...
            it++;
            if(({            (_condtional_value_X196=(it>=self->size));            _condtional_value_X196;            })) {
                it=0;
            }
            else if(({            (_condtional_value_X197=(it==hash));            _condtional_value_X197;            })) {
            ...
            if(({            (_condtional_value_X199=(1));            _condtional_value_X199;            })) {
                self->items[it]=(struct sClass*)come_increment_ref_count(item);
            }
            else {
                self->items[it]=item;
    ...
    for(    ({    (_condtional_value_X200=(it2=list$1char$ph_begin(self->key_list)));    _condtional_value_X200;    });    ({    (_condtional_value_X201=(!list$1char$ph_end(self->key_list)));    _condtional_value_X201;    });    ({    (_condtional_value_X202=(it2=list$1char$ph_next(self->key_list)));    _condtional_value_X202;    })    ){
        if(({        (_condtional_value_X203=(string_equals(it2,key)));        _condtional_value_X203;        })) {
            same_key_exist=(_Bool)1;
        }
    }
    if(({    (_condtional_value_X204=(!same_key_exist));    _condtional_value_X204;    })) {
...
default_value_48 = (void*)0;
    size=self->size*10;
    keys=(char**)come_increment_ref_count(((char**)(__right_value135=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size)), "/usr/local/include/comelang.h", 2211, "char**"))));
    items=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value136=(struct sClass**)come_calloc_v2(1, sizeof(struct sClass*)*(1*(size)), "/usr/local/include/comelang.h", 2212, "struct sClass**"))));
    item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value137=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(size)), "/usr/local/include/comelang.h", 2213, "_Bool*"))));
    len=0;
    for(    ({    (_condtional_value_X145=(it=map$2char$phsClass$ph_begin(self)));    _condtional_value_X145;    });    ({    (_condtional_value_X146=(!map$2char$phsClass$ph_end(self)));    _condtional_value_X146;    });    ({    (_condtional_value_X149=(it=map$2char$phsClass$ph_next(self)));    _condtional_value_X149;    })    ){
        ...
        while(({        (_condtional_value_X163=((_Bool)1));        _condtional_value_X163;        })) {
            if(({            (_condtional_value_X164=(item_existance[n]));            _condtional_value_X164;            })) {
                n++;
                if(({                (_condtional_value_X165=(n>=size));                _condtional_value_X165;                })) {
                    n=0;
                }
                else if(({                (_condtional_value_X166=(n==hash));                _condtional_value_X166;                })) {
...
result = (void*)0;
result_46 = (void*)0;
    if(({    (_condtional_value_X143=(self==((void*)0)));    _condtional_value_X143;    })) {
        memset(&result,0,sizeof(char*));
...
result = (void*)0;
result_47 = (void*)0;
    if(({    (_condtional_value_X147=(self==((void*)0)||self->key_list->it==((void*)0)));    _condtional_value_X147;    })) {
        memset(&result,0,sizeof(char*));
        __result_obj__19 = result;
        return __result_obj__19;
    }
    self->key_list->it=self->key_list->it->next;
    if(({    (_condtional_value_X148=(self->key_list->it));    _condtional_value_X148;    })) {
...
struct list$1char$ph* __result_obj__29;
    it2=0;
    it=self->head;
    while(({    (_condtional_value_X171=(it!=((void*)0)));    _condtional_value_X171;    })) {
        if(({        (_condtional_value_X172=(string_equals(it->item,item)));        _condtional_value_X172;        })) {
...
struct list$1char$ph* __result_obj__28;
    ...
    if(({    (_condtional_value_X174=(tail<0));    _condtional_value_X174;    })) {
        tail+=self->len+1;
    }
    ...
    if(({    (_condtional_value_X176=(head<0));    _condtional_value_X176;    })) {
        head=0;
    }
    if(({    (_condtional_value_X177=(tail>self->len));    _condtional_value_X177;    })) {
        tail=self->len;
    }
    if(({    (_condtional_value_X178=(head==tail));    _condtional_value_X178;    })) {
        __result_obj__26 = self;
        return __result_obj__26;
    }
    if(({    (_condtional_value_X179=(head==0&&tail==self->len));    _condtional_value_X179;    })) {
        list$1char$ph_reset(self);
    }
    else if(({    (_condtional_value_X181=(head==0));    _condtional_value_X181;    })) {
        it=self->head;
        i=0;
        while(({        (_condtional_value_X182=(it!=((void*)0)));        _condtional_value_X182;        })) {
            if(({            (_condtional_value_X183=(i<tail));            _condtional_value_X183;            })) {
                prev_it=it;
                it=it->next;
                i++;
                come_call_finalizer(list_item$1char$ph$p_finalize, prev_it, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
            ...
            else if(({            (_condtional_value_X184=(i==tail));            _condtional_value_X184;            })) {
                self->head=it;
    ...
    else if(({    (_condtional_value_X185=(tail==self->len));    _condtional_value_X185;    })) {
        it_49=self->head;
        i_50=0;
        while(({        (_condtional_value_X186=(it_49!=((void*)0)));        _condtional_value_X186;        })) {
            if(({            (_condtional_value_X187=(i_50==head));            _condtional_value_X187;            })) {
                self->tail=it_49->prev;
                self->tail->next=((void*)0);
            }
            if(({            (_condtional_value_X188=(i_50>=head));            _condtional_value_X188;            })) {
                prev_it_51=it_49;
                it_49=it_49->next;
                i_50++;
        ...
        tail_it=((void*)0);
        i_53=0;
        while(({        (_condtional_value_X189=(it_52!=((void*)0)));        _condtional_value_X189;        })) {
            if(({            (_condtional_value_X190=(i_53==head));            _condtional_value_X190;            })) {
                head_prev_it=it_52->prev;
            }
            if(({            (_condtional_value_X191=(i_53==tail));            _condtional_value_X191;            })) {
                tail_it=it_52;
            }
            if(({            (_condtional_value_X192=(i_53>=head&&i_53<tail));            _condtional_value_X192;            })) {
                prev_it_54=it_52;
                it_52=it_52->next;
                i_53++;
        ...
        if(({        (_condtional_value_X193=(head_prev_it!=((void*)0)));        _condtional_value_X193;        })) {
            head_prev_it->next=tail_it;
        }
        if(({        (_condtional_value_X194=(tail_it!=((void*)0)));        _condtional_value_X194;        })) {
...
struct map$2char$phsType$ph* __result_obj__41;
    if(({    (_condtional_value_X212=(self->len*10>=self->size));    _condtional_value_X212;    })) {
        map$2char$phsType$ph_rehash(self);
    }
    hash=string_get_hash_key(((char*)key))%self->size;
    it=hash;
    while(({    (_condtional_value_X229=((_Bool)1));    _condtional_value_X229;    })) {
        if(({        (_condtional_value_X230=(self->item_existance[it]));        _condtional_value_X230;        })) {
            if(({            (_condtional_value_X231=(string_equals(self->keys[it],key)));            _condtional_value_X231;            })) {
            ...
            it++;
            if(({            (_condtional_value_X234=(it>=self->size));            _condtional_value_X234;            })) {
                it=0;
            }
            else if(({            (_condtional_value_X235=(it==hash));            _condtional_value_X235;            })) {
                printf("unexpected error in map.insert\n");
                stackframe_v2();
                exit(2);
            }
    ...
    same_key_exist=(_Bool)0;
    for(    ({    (_condtional_value_X238=(it2=list$1char$ph_begin(self->key_list)));    _condtional_value_X238;    });    ({    (_condtional_value_X239=(!list$1char$ph_end(self->key_list)));    _condtional_value_X239;    });    ({    (_condtional_value_X240=(it2=list$1char$ph_next(self->key_list)));    _condtional_value_X240;    })    ){
        if(({        (_condtional_value_X241=(string_equals(it2,key)));        _condtional_value_X241;        })) {
            same_key_exist=(_Bool)1;
        }
    }
    if(({    (_condtional_value_X242=(!same_key_exist));    _condtional_value_X242;    })) {
        list$1char$ph_push_back(self->key_list,(char*)come_increment_ref_count(key));
    }
...
default_value_59 = (void*)0;
    size=self->size*10;
    keys=(char**)come_increment_ref_count(((char**)(__right_value207=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size)), "/usr/local/include/comelang.h", 2211, "char**"))));
    items=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value208=(struct sType**)come_calloc_v2(1, sizeof(struct sType*)*(1*(size)), "/usr/local/include/comelang.h", 2212, "struct sType**"))));
    item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value209=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(size)), "/usr/local/include/comelang.h", 2213, "_Bool*"))));
    len=0;
    for(    ({    (_condtional_value_X215=(it=map$2char$phsType$ph_begin(self)));    _condtional_value_X215;    });    ({    (_condtional_value_X216=(!map$2char$phsType$ph_end(self)));    _condtional_value_X216;    });    ({    (_condtional_value_X219=(it=map$2char$phsType$ph_next(self)));    _condtional_value_X219;    })    ){
        ...
        hash=string_get_hash_key(((char*)it))%size;
        n=hash;
        while(({        (_condtional_value_X225=((_Bool)1));        _condtional_value_X225;        })) {
            if(({            (_condtional_value_X226=(item_existance[n]));            _condtional_value_X226;            })) {
                n++;
                if(({                (_condtional_value_X227=(n>=size));                _condtional_value_X227;                })) {
                    n=0;
                }
                else if(({                (_condtional_value_X228=(n==hash));                _condtional_value_X228;                })) {
                    printf("unexpected error in map.rehash(1)\n");
                    stackframe_v2();
                    exit(2);
                }
...
result_57 = (void*)0;
    ...
    self->key_list->it=self->key_list->head;
    if(({    (_condtional_value_X214=(self->key_list->it));    _condtional_value_X214;    })) {
...
result = (void*)0;
result_58 = (void*)0;
    if(({    (_condtional_value_X217=(self==((void*)0)||self->key_list->it==((void*)0)));    _condtional_value_X217;    })) {
        memset(&result,0,sizeof(char*));
...
struct sType* __result_obj__40;
    hash=string_get_hash_key(((char*)key))%self->size;
    it=hash;
    while(({    (_condtional_value_X220=((_Bool)1));    _condtional_value_X220;    })) {
        if(({        (_condtional_value_X221=(self->item_existance[it]));        _condtional_value_X221;        })) {
            if(({            (_condtional_value_X222=(string_equals(self->keys[it],key)));            _condtional_value_X222;            })) {
            ...
            it++;
            if(({            (_condtional_value_X223=(it>=self->size));            _condtional_value_X223;            })) {
                it=0;
            }
            else if(({            (_condtional_value_X224=(it==hash));            _condtional_value_X224;            })) {
...
struct list$1tuple2$2char$phsType$ph$ph* __result_obj__42;
    if(({    (_condtional_value_X243=(self->len==0));    _condtional_value_X243;    })) {
    ...
    else if(({    (_condtional_value_X244=(self->len==1));    _condtional_value_X244;    })) {
...
void* __right_value260 = (void*)0;
    if(({    (_condtional_value_X245=(getenv("PICO_SDK_PATH")));    _condtional_value_X245;    })) {
        ...
        if(({        (_condtional_value_X246=(Value));        (__right_value250 = come_decrement_ref_count(__right_value250, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, (void*)0));
        _condtional_value_X246;        })) {
            version_major=0;
            p=strstr(Value,"set(PICO_SDK_VERSION_MAJOR");
            if(({            (_condtional_value_X247=(p));            _condtional_value_X247;            })) {
                p+=strlen("set(PICO_SDK_VERSION_MAJOR");
                while(({                (_condtional_value_X248=(*p==32||*p==9));                _condtional_value_X248;                })) {
                    p++;
                }
                while(({                (_condtional_value_X249=(xisdigit(*p)));                _condtional_value_X249;                })) {
            ...
            if(({            (_condtional_value_X250=(p_62));            _condtional_value_X250;            })) {
                p_62+=strlen("set(PICO_SDK_VERSION_MINOR");
                while(({                (_condtional_value_X251=(*p_62==32||*p_62==9));                _condtional_value_X251;                })) {
                    p_62++;
                }
                while(({                (_condtional_value_X252=(xisdigit(*p_62)));                _condtional_value_X252;                })) {
            ...
            if(({            (_condtional_value_X253=(p_63));            _condtional_value_X253;            })) {
                p_63+=strlen("set(PICO_SDK_VERSION_REVISION");
                while(({                (_condtional_value_X254=(*p_63==32||*p_63==9));                _condtional_value_X254;                })) {
                    p_63++;
                }
                while(({                (_condtional_value_X255=(xisdigit(*p_63)));                _condtional_value_X255;                })) {
            ...
            if(({            (_condtional_value_X256=(!Value_64));            _condtional_value_X256;            })) {
...
memset(&info_124, 0, sizeof(struct sInfo));
    if(({    (_condtional_value_X257=(charp_operator_equals(argv[1],"header")&&argc>=3));    _condtional_value_X257;    })) {
        start_num=2;
        output_file_name_str=(char*)come_increment_ref_count(xsprintf("common.h"));
        clang_option=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "02transpile.c", 813, "struct buffer*"))));
        buffer_append_str(clang_option," -std=c99 ");
        linker_option=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "02transpile.c", 815, "struct buffer*"))));
        cpp_option=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "02transpile.c", 816, "struct buffer*"))));
        buffer_append_str(cpp_option,"-U__GNUC__");
        files=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "02transpile.c", 818, "struct list$1char$ph*"))));
        object_files=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "02transpile.c", 819, "struct list$1char$ph*"))));
        ...
        for(        ({        (_condtional_value_X258=(i=start_num));        _condtional_value_X258;        });        ({        (_condtional_value_X259=(i<argc));        _condtional_value_X259;        });        ({        (_condtional_value_X260=(i++));        _condtional_value_X260;        })        ){
            ext_name=(char*)come_increment_ref_count(xextname(argv[i]));
            if(({            (_condtional_value_X261=(charp_operator_equals(argv[i],"-o")&&i+1<argc));            _condtional_value_X261;            })) {
            ...
            else if(({            (_condtional_value_X262=(charp_operator_equals(argv[i],"-e")&&i+1<argc));            _condtional_value_X262;            })) {
            ...
            else if(({            (_condtional_value_X263=(charp_operator_equals(argv[i],"-str")));            _condtional_value_X263;            })) {
                gComeStr=(_Bool)1;
            }
            else if(({            (_condtional_value_X264=(charp_operator_equals(argv[i],"-pthread")));            _condtional_value_X264;            })) {
                gComePthread=(_Bool)1;
            }
            else if(({            (_condtional_value_X265=(charp_operator_equals(argv[i],"-gc")));            _condtional_value_X265;            })) {
                gComeGC=(_Bool)1;
            ...
            else if(({            (_condtional_value_X266=(charp_operator_equals(argv[i],"-gcc")));            _condtional_value_X266;            })) {
                gcc_compiler=(_Bool)1;
                CC="gcc";
            }
            else if(({            (_condtional_value_X267=(charp_operator_equals(argv[i],"-riscv")));            _condtional_value_X267;            })) {
                gcc_compiler=(_Bool)1;
            ...
            else if(({            (_condtional_value_X268=(charp_operator_equals(argv[i],"-bare")));            _condtional_value_X268;            })) {
            ...
            else if(({            (_condtional_value_X269=(charp_operator_equals(argv[i],"-pico")));            _condtional_value_X269;            })) {
                output_source_file_flag=(_Bool)1;
                output_object_file_flag=(_Bool)0;
                gComeOriginalSourcePosition=(_Bool)0;
                env=getenv("PICO_SDK_PATH");
                __dec_obj29=cpp_option,
                cpp_option=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "02transpile.c", 880, "struct buffer*"))));
            ...
            else if(({            (_condtional_value_X270=(charp_operator_equals(argv[i],"-emb")));            _condtional_value_X270;            })) {
                output_source_file_flag=(_Bool)1;
                output_object_file_flag=(_Bool)0;
                gComeOriginalSourcePosition=(_Bool)0;
                emb_cpp=(_Bool)1;
            }
            else if(({            (_condtional_value_X271=(charp_operator_equals(argv[i],"-m5stack")));            _condtional_value_X271;            })) {
                m5stack_cpp=(_Bool)1;
                output_source_file_flag=(_Bool)1;
                output_object_file_flag=(_Bool)0;
                gComeOriginalSourcePosition=(_Bool)0;
                ...
                cpp_option=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "02transpile.c", 897, "struct buffer*"))));
            ...
            else if(({            (_condtional_value_X272=(i+1<argc&&charp_operator_equals(argv[i],"-target")));            _condtional_value_X272;            })) {
            ...
            else if(({            (_condtional_value_X273=(i+1<argc&&charp_operator_equals(argv[i],"-T")));            _condtional_value_X273;            })) {
            ...
            else if(({            (_condtional_value_X274=(charp_operator_equals(argv[i],"-net")));            _condtional_value_X274;            })) {
                gComeNet=(_Bool)1;
            }
            else if(({            (_condtional_value_X275=(charp_operator_equals(argv[i],"-cg")));            _condtional_value_X275;            })) {
                come_debug=(_Bool)1;
                buffer_append_str(clang_option,"-g ");
            }
            else if(({            (_condtional_value_X276=(charp_operator_equals(argv[i],"-cg2")));            _condtional_value_X276;            })) {
            ...
            else if(({            (_condtional_value_X277=(charp_operator_equals(argv[i],"-C")));            _condtional_value_X277;            })) {
            ...
            else if(({            (_condtional_value_X278=(charp_operator_equals(argv[i],"-M")));            _condtional_value_X278;            })) {
            ...
            else if(({            (_condtional_value_X279=(charp_operator_equals(argv[i],"-MM")));            _condtional_value_X279;            })) {
            ...
            else if(({            (_condtional_value_X280=(charp_operator_equals(argv[i],"-dM")));            _condtional_value_X280;            })) {
            ...
            else if(({            (_condtional_value_X281=(charp_operator_equals(argv[i],"-dD")));            _condtional_value_X281;            })) {
            ...
            else if(({            (_condtional_value_X282=(charp_operator_equals(argv[i],"-H")));            _condtional_value_X282;            })) {
            ...
            else if(({            (_condtional_value_X283=(charp_operator_equals(argv[i],"-P")));            _condtional_value_X283;            })) {
            ...
            else if(({            (_condtional_value_X284=(charp_operator_equals(argv[i],"-nostdinc")));            _condtional_value_X284;            })) {
            ...
            else if(({            (_condtional_value_X285=(charp_operator_equals(argv[i],"-CC")));            _condtional_value_X285;            })) {
            ...
            else if(({            (_condtional_value_X286=(i+1<argc&&charp_operator_equals(argv[i],"-target")));            _condtional_value_X286;            })) {
            ...
            else if(({            (_condtional_value_X287=(i+1<argc&&charp_operator_equals(argv[i],"-include")));            _condtional_value_X287;            })) {
            ...
            else if(({            (_condtional_value_X288=(i+1<argc&&charp_operator_equals(argv[i],"-isystem")));            _condtional_value_X288;            })) {
            ...
            else if(({            (_condtional_value_X289=(i+1<argc&&charp_operator_equals(argv[i],"-T")));            _condtional_value_X289;            })) {
            ...
            else if(({            (_condtional_value_X290=(charp_operator_equals(argv[i],"-common-header")));            _condtional_value_X290;            })) {
                gCommonHeader=(_Bool)1;
            }
            else if(({            (_condtional_value_X291=(charp_operator_equals(argv[i],"-original-position")));            _condtional_value_X291;            })) {
                gComeOriginalSourcePosition=(_Bool)0;
            }
            else if(({            (_condtional_value_X292=(string_operator_equals(((char*)(__right_value343=charp_operator_load_range_element(argv[i],0,2))),"-O")));            (__right_value342 = come_decrement_ref_count(__right_value342, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, (void*)0));
            ...
            else if(({            (_condtional_value_X293=(string_operator_equals(((char*)(__right_value347=charp_operator_load_range_element(argv[i],0,2))),"-D")));            (__right_value346 = come_decrement_ref_count(__right_value346, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, (void*)0));
            ...
            else if(({            (_condtional_value_X294=(string_operator_equals(((char*)(__right_value353=charp_operator_load_range_element(argv[i],0,2))),"-U")));            (__right_value352 = come_decrement_ref_count(__right_value352, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, (void*)0));
            ...
            else if(({            (_condtional_value_X295=(charp_operator_equals(argv[i],"-g")));            _condtional_value_X295;            })) {
                buffer_append_str(clang_option,"-g ");
            }
            else if(({            (_condtional_value_X296=(charp_operator_equals(argv[i],"-v")));            _condtional_value_X296;            })) {
                buffer_append_str(clang_option,"-v ");
                buffer_append_str(cpp_option,"-v ");
                verbose=(_Bool)1;
            }
            else if(({            (_condtional_value_X297=(strlen(argv[i])>=2&&memcmp(argv[i],"-I",strlen("-I"))==0));            _condtional_value_X297;            })) {
            ...
            else if(({            (_condtional_value_X298=(charp_operator_equals(argv[i],"-gdwarf-4")));            _condtional_value_X298;            })) {
            ...
            else if(({            (_condtional_value_X300=(charp_operator_equals(argv[i],"-s")));            _condtional_value_X300;            })) {
                output_source_file_flag=(_Bool)1;
                output_object_file_flag=(_Bool)1;
                gComeOriginalSourcePosition=(_Bool)0;
            }
            else if(({            (_condtional_value_X301=(charp_operator_equals(argv[i],"-c")));            _condtional_value_X301;            })) {
                output_object_file=(_Bool)1;
            }
            else if(({            (_condtional_value_X302=(charp_operator_equals(argv[i],"-E")));            _condtional_value_X302;            })) {
                output_cpp_file=(_Bool)1;
            }
            else if(({            (_condtional_value_X303=(argv[i][0]==45));            _condtional_value_X303;            })) {
            ...
            else if(({            (_condtional_value_X304=(strlen(argv[i])>2&&memcmp(argv[i]+strlen(argv[i])-2,".o",2)==0));            _condtional_value_X304;            })) {
                list$1char$ph_push_back(object_files,(char*)come_increment_ref_count(__builtin_string(argv[i])));
            }
            else if(({            (_condtional_value_X305=(strlen(argv[i])>2&&memcmp(argv[i]+strlen(argv[i])-2,".a",2)==0));            _condtional_value_X305;            })) {
                list$1char$ph_push_back(object_files,(char*)come_increment_ref_count(__builtin_string(argv[i])));
            }
            else if(({            (_condtional_value_X306=(string_operator_equals(ext_name,"c")));            _condtional_value_X306;            })) {
        ...
        if(({        (_condtional_value_X307=(Value<0));        (__right_value366 = come_decrement_ref_count(__right_value366, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, (void*)0));
        _condtional_value_X307;        })) {
            (come_push_stackframe("02transpile.c", 1046, 11),__exception_result_var_b12=die("rm"), come_pop_stackframe(), __exception_result_var_b12);
        }
        else {
        }
        Value_66=fopen(output_file_name,"w");
        if(({        (_condtional_value_X308=(Value_66));        _condtional_value_X308;        })) {
            fclose(Value_66);
        }
        else {
            (come_push_stackframe("02transpile.c", 1053, 12),__exception_result_var_b13=die("fopen"), come_pop_stackframe(), __exception_result_var_b13);
        }
        ...
        if(({        (_condtional_value_X314=(Value_67<0));        (__right_value371 = come_decrement_ref_count(__right_value371, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, (void*)0));
        ...
        _condtional_value_X314;        })) {
            (come_push_stackframe("02transpile.c", 1059, 13),__exception_result_var_b14=die("cat"), come_pop_stackframe(), __exception_result_var_b14);
        }
        else {
        }
        memset(&info,0,sizeof(struct sInfo));
        ...
        info.funcs=(struct map$2char$phsFun$ph*)come_increment_ref_count(map$2char$phsFun$ph_initialize((struct map$2char$phsFun$ph*)come_increment_ref_count((struct map$2char$phsFun$ph*)come_calloc_v2(1, sizeof(struct map$2char$phsFun$ph)*(1), "02transpile.c", 1074, "struct map$2char$phsFun$ph*"))));
        ...
        info.uniq_funcs=(struct map$2char$phsFun$ph*)come_increment_ref_count(map$2char$phsFun$ph_initialize((struct map$2char$phsFun$ph*)come_increment_ref_count((struct map$2char$phsFun$ph*)come_calloc_v2(1, sizeof(struct map$2char$phsFun$ph)*(1), "02transpile.c", 1075, "struct map$2char$phsFun$ph*"))));
        ...
        info.struct_definition=(struct map$2char$phbuffer$ph*)come_increment_ref_count(map$2char$phbuffer$ph_initialize((struct map$2char$phbuffer$ph*)come_increment_ref_count((struct map$2char$phbuffer$ph*)come_calloc_v2(1, sizeof(struct map$2char$phbuffer$ph)*(1), "02transpile.c", 1076, "struct map$2char$phbuffer$ph*"))));
        ...
        info.uniq_definition=(struct map$2char$phchar$ph*)come_increment_ref_count(map$2char$phchar$ph_initialize((struct map$2char$phchar$ph*)come_increment_ref_count((struct map$2char$phchar$ph*)come_calloc_v2(1, sizeof(struct map$2char$phchar$ph)*(1), "02transpile.c", 1077, "struct map$2char$phchar$ph*"))));
        ...
        info.classes=(struct map$2char$phsClass$ph*)come_increment_ref_count(map$2char$phsClass$ph_initialize((struct map$2char$phsClass$ph*)come_increment_ref_count((struct map$2char$phsClass$ph*)come_calloc_v2(1, sizeof(struct map$2char$phsClass$ph)*(1), "02transpile.c", 1080, "struct map$2char$phsClass$ph*"))));
        ...
        info.types=(struct map$2char$phsType$ph*)come_increment_ref_count(map$2char$phsType$ph_initialize((struct map$2char$phsType$ph*)come_increment_ref_count((struct map$2char$phsType$ph*)come_calloc_v2(1, sizeof(struct map$2char$phsType$ph)*(1), "02transpile.c", 1082, "struct map$2char$phsType$ph*"))));
        ...
        info.module=(struct sModule*)come_increment_ref_count(sModule_initialize((struct sModule*)come_increment_ref_count((struct sModule*)come_calloc_v2(1, sizeof(struct sModule)*(1), "02transpile.c", 1083, "struct sModule*"))));
        ...
        info.stack=(struct list$1CVALUE$ph*)come_increment_ref_count(list$1CVALUE$ph_initialize((struct list$1CVALUE$ph*)come_increment_ref_count((struct list$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list$1CVALUE$ph)*(1), "02transpile.c", 1085, "struct list$1CVALUE$ph*"))));
        ...
        info.gv_table=(struct sVarTable*)come_increment_ref_count(sVarTable_initialize((struct sVarTable*)come_increment_ref_count((struct sVarTable*)come_calloc_v2(1, sizeof(struct sVarTable)*(1), "02transpile.c", 1086, "struct sVarTable*")),(_Bool)1,((void*)0)));
        come_call_finalizer(sVarTable_finalize, __dec_obj55,(void*)0, (void*)0, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, (void*)0);
        lv_table=(struct sVarTable*)come_increment_ref_count(sVarTable_initialize((struct sVarTable*)come_increment_ref_count((struct sVarTable*)come_calloc_v2(1, sizeof(struct sVarTable)*(1), "02transpile.c", 1087, "struct sVarTable*")),(_Bool)0,((void*)0)));
        info.lv_table=lv_table;
        __dec_obj56=info.generics_type_names,
        info.generics_type_names=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "02transpile.c", 1089, "struct list$1char$ph*"))));
        ...
        info.method_generics_type_names=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "02transpile.c", 1090, "struct list$1char$ph*"))));
        ...
        info.generics_classes=(struct map$2char$phsClass$ph*)come_increment_ref_count(map$2char$phsClass$ph_initialize((struct map$2char$phsClass$ph*)come_increment_ref_count((struct map$2char$phsClass$ph*)come_calloc_v2(1, sizeof(struct map$2char$phsClass$ph)*(1), "02transpile.c", 1091, "struct map$2char$phsClass$ph*"))));
        ...
        clear_tmp_file(&info);
        Value_82=cpp(&info);
        if(({        (_condtional_value_X533=(!Value_82));        _condtional_value_X533;        })) {
        ...
        if(({        (_condtional_value_X534=(!Value_83));        _condtional_value_X534;        })) {
            transpile(&info);
            Value_84=output_header_file(&info);
            if(({            (_condtional_value_X535=(!Value_84));            _condtional_value_X535;            })) {
    ...
    else if(({    (_condtional_value_X571=(charp_operator_equals(argv[1],"new")&&argc==3));    _condtional_value_X571;    })) {
        Value_85=new_project(argc,argv);
        if(({        (_condtional_value_X572=(!Value_85));        _condtional_value_X572;        })) {
            return (_Bool)0;
        }
        else {
        }
    }
    else if(({    (_condtional_value_X573=(charp_operator_equals(argv[1],"run")&&argc==2));    _condtional_value_X573;    })) {
        Value_86=run_project(argc,argv);
        if(({        (_condtional_value_X574=(!Value_86));        _condtional_value_X574;        })) {
            return (_Bool)0;
        }
        else {
        }
    }
    else if(({    (_condtional_value_X575=(charp_operator_equals(argv[1],"header")&&argc==2));    _condtional_value_X575;    })) {
        Value_87=make_header_project(argc,argv);
        if(({        (_condtional_value_X576=(!Value_87));        _condtional_value_X576;        })) {
            return (_Bool)0;
        }
        else {
        }
    }
    else if(({    (_condtional_value_X577=(charp_operator_equals(argv[1],"compile")&&argc==2));    _condtional_value_X577;    })) {
        Value_88=compile_project(argc,argv);
        if(({        (_condtional_value_X578=(!Value_88));        _condtional_value_X578;        })) {
            return (_Bool)0;
        }
        else {
        }
    }
    else if(({    (_condtional_value_X579=(charp_operator_equals(argv[1],"debug")&&argc==2));    _condtional_value_X579;    })) {
        Value_89=debug_run_project(argc,argv);
        if(({        (_condtional_value_X580=(!Value_89));        _condtional_value_X580;        })) {
            return (_Bool)0;
        }
        else {
        }
    }
    else if(({    (_condtional_value_X581=(charp_operator_equals(argv[1],"clean")&&argc==2));    _condtional_value_X581;    })) {
        Value_90=clean_project(argc,argv);
        if(({        (_condtional_value_X582=(!Value_90));        _condtional_value_X582;        })) {
            return (_Bool)0;
        }
        else {
        }
    }
    else if(({    (_condtional_value_X583=(charp_operator_equals(argv[1],"install")&&argc>=2));    _condtional_value_X583;    })) {
        if(({        (_condtional_value_X584=(argc==2));        _condtional_value_X584;        })) {
            Value_91=install_project(argc,argv,"/usr/local");
            if(({            (_condtional_value_X585=(!Value_91));            _condtional_value_X585;            })) {
                return (_Bool)0;
            }
            else {
            }
        }
        else if(({        (_condtional_value_X586=(argc>=3));        _condtional_value_X586;        })) {
            Value_92=install_project(argc,argv,argv[2]);
            if(({            (_condtional_value_X587=(!Value_92));            _condtional_value_X587;            })) {
                return (_Bool)0;
            }
            else {
            }
        ...
        clang_option_95=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "02transpile.c", 813, "struct buffer*"))));
        buffer_append_str(clang_option_95," -std=c99 ");
        linker_option_96=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "02transpile.c", 815, "struct buffer*"))));
        cpp_option_97=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "02transpile.c", 816, "struct buffer*"))));
        buffer_append_str(cpp_option_97,"-U__GNUC__");
        files_98=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "02transpile.c", 818, "struct list$1char$ph*"))));
        object_files_99=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "02transpile.c", 819, "struct list$1char$ph*"))));
        ...
        for(        ({        (_condtional_value_X588=(i_112=start_num_93));        _condtional_value_X588;        });        ({        (_condtional_value_X589=(i_112<argc));        _condtional_value_X589;        });        ({        (_condtional_value_X590=(i_112++));        _condtional_value_X590;        })        ){
            ext_name_113=(char*)come_increment_ref_count(xextname(argv[i_112]));
            if(({            (_condtional_value_X591=(charp_operator_equals(argv[i_112],"-o")&&i_112+1<argc));            _condtional_value_X591;            })) {
            ...
            else if(({            (_condtional_value_X592=(charp_operator_equals(argv[i_112],"-e")&&i_112+1<argc));            _condtional_value_X592;            })) {
            ...
            else if(({            (_condtional_value_X593=(charp_operator_equals(argv[i_112],"-str")));            _condtional_value_X593;            })) {
                gComeStr=(_Bool)1;
            }
            else if(({            (_condtional_value_X594=(charp_operator_equals(argv[i_112],"-pthread")));            _condtional_value_X594;            })) {
                gComePthread=(_Bool)1;
            }
            else if(({            (_condtional_value_X595=(charp_operator_equals(argv[i_112],"-gc")));            _condtional_value_X595;            })) {
                gComeGC=(_Bool)1;
            ...
            else if(({            (_condtional_value_X596=(charp_operator_equals(argv[i_112],"-gcc")));            _condtional_value_X596;            })) {
                gcc_compiler_111=(_Bool)1;
                CC="gcc";
            }
            else if(({            (_condtional_value_X597=(charp_operator_equals(argv[i_112],"-riscv")));            _condtional_value_X597;            })) {
                gcc_compiler_111=(_Bool)1;
            ...
            else if(({            (_condtional_value_X598=(charp_operator_equals(argv[i_112],"-bare")));            _condtional_value_X598;            })) {
            ...
            else if(({            (_condtional_value_X599=(charp_operator_equals(argv[i_112],"-pico")));            _condtional_value_X599;            })) {
                output_source_file_flag_102=(_Bool)1;
                output_object_file_flag_103=(_Bool)0;
                gComeOriginalSourcePosition=(_Bool)0;
                env_114=getenv("PICO_SDK_PATH");
                __dec_obj62=cpp_option_97,
                cpp_option_97=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "02transpile.c", 880, "struct buffer*"))));
            ...
            else if(({            (_condtional_value_X600=(charp_operator_equals(argv[i_112],"-emb")));            _condtional_value_X600;            })) {
                output_source_file_flag_102=(_Bool)1;
                output_object_file_flag_103=(_Bool)0;
                gComeOriginalSourcePosition=(_Bool)0;
                emb_cpp_110=(_Bool)1;
            }
            else if(({            (_condtional_value_X601=(charp_operator_equals(argv[i_112],"-m5stack")));            _condtional_value_X601;            })) {
                ...
                cpp_option_97=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "02transpile.c", 897, "struct buffer*"))));
            ...
            else if(({            (_condtional_value_X602=(i_112+1<argc&&charp_operator_equals(argv[i_112],"-target")));            _condtional_value_X602;            })) {
            ...
            else if(({            (_condtional_value_X603=(i_112+1<argc&&charp_operator_equals(argv[i_112],"-T")));            _condtional_value_X603;            })) {
            ...
            else if(({            (_condtional_value_X604=(charp_operator_equals(argv[i_112],"-net")));            _condtional_value_X604;            })) {
                gComeNet=(_Bool)1;
            }
            else if(({            (_condtional_value_X605=(charp_operator_equals(argv[i_112],"-cg")));            _condtional_value_X605;            })) {
                come_debug_106=(_Bool)1;
                buffer_append_str(clang_option_95,"-g ");
            }
            else if(({            (_condtional_value_X606=(charp_operator_equals(argv[i_112],"-cg2")));            _condtional_value_X606;            })) {
            ...
            else if(({            (_condtional_value_X607=(charp_operator_equals(argv[i_112],"-C")));            _condtional_value_X607;            })) {
            ...
            else if(({            (_condtional_value_X608=(charp_operator_equals(argv[i_112],"-M")));            _condtional_value_X608;            })) {
            ...
            else if(({            (_condtional_value_X609=(charp_operator_equals(argv[i_112],"-MM")));            _condtional_value_X609;            })) {
            ...
            else if(({            (_condtional_value_X610=(charp_operator_equals(argv[i_112],"-dM")));            _condtional_value_X610;            })) {
            ...
            else if(({            (_condtional_value_X611=(charp_operator_equals(argv[i_112],"-dD")));            _condtional_value_X611;            })) {
            ...
            else if(({            (_condtional_value_X612=(charp_operator_equals(argv[i_112],"-H")));            _condtional_value_X612;            })) {
            ...
            else if(({            (_condtional_value_X613=(charp_operator_equals(argv[i_112],"-P")));            _condtional_value_X613;            })) {
            ...
            else if(({            (_condtional_value_X614=(charp_operator_equals(argv[i_112],"-nostdinc")));            _condtional_value_X614;            })) {
            ...
            else if(({            (_condtional_value_X615=(charp_operator_equals(argv[i_112],"-CC")));            _condtional_value_X615;            })) {
            ...
            else if(({            (_condtional_value_X616=(i_112+1<argc&&charp_operator_equals(argv[i_112],"-target")));            _condtional_value_X616;            })) {
            ...
            else if(({            (_condtional_value_X617=(i_112+1<argc&&charp_operator_equals(argv[i_112],"-include")));            _condtional_value_X617;            })) {
            ...
            else if(({            (_condtional_value_X618=(i_112+1<argc&&charp_operator_equals(argv[i_112],"-isystem")));            _condtional_value_X618;            })) {
            ...
            else if(({            (_condtional_value_X619=(i_112+1<argc&&charp_operator_equals(argv[i_112],"-T")));            _condtional_value_X619;            })) {
            ...
            else if(({            (_condtional_value_X620=(charp_operator_equals(argv[i_112],"-common-header")));            _condtional_value_X620;            })) {
                gCommonHeader=(_Bool)1;
            }
            else if(({            (_condtional_value_X621=(charp_operator_equals(argv[i_112],"-original-position")));            _condtional_value_X621;            })) {
                gComeOriginalSourcePosition=(_Bool)0;
            }
            else if(({            (_condtional_value_X622=(string_operator_equals(((char*)(__right_value537=charp_operator_load_range_element(argv[i_112],0,2))),"-O")));            (__right_value536 = come_decrement_ref_count(__right_value536, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, (void*)0));
            ...
            else if(({            (_condtional_value_X623=(string_operator_equals(((char*)(__right_value541=charp_operator_load_range_element(argv[i_112],0,2))),"-D")));            (__right_value540 = come_decrement_ref_count(__right_value540, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, (void*)0));
            ...
            else if(({            (_condtional_value_X624=(string_operator_equals(((char*)(__right_value547=charp_operator_load_range_element(argv[i_112],0,2))),"-U")));            (__right_value546 = come_decrement_ref_count(__right_value546, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, (void*)0));
            (__right_value547 = come_decrement_ref_count(__right_value547, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, (void*)0));
            _condtional_value_X624;            })) {
            ...
            else if(({            (_condtional_value_X625=(charp_operator_equals(argv[i_112],"-g")));            _condtional_value_X625;            })) {
                buffer_append_str(clang_option_95,"-g ");
            }
            else if(({            (_condtional_value_X626=(charp_operator_equals(argv[i_112],"-v")));            _condtional_value_X626;            })) {
                buffer_append_str(clang_option_95,"-v ");
                buffer_append_str(cpp_option_97,"-v ");
                verbose_105=(_Bool)1;
            }
            else if(({            (_condtional_value_X627=(strlen(argv[i_112])>=2&&memcmp(argv[i_112],"-I",strlen("-I"))==0));            _condtional_value_X627;            })) {
            ...
            else if(({            (_condtional_value_X628=(charp_operator_equals(argv[i_112],"-gdwarf-4")));            _condtional_value_X628;            })) {
                buffer_append_str(clang_option_95,"-gdwarf-4 ");
            }
            else if(({            (_condtional_value_X629=(charp_operator_equals(argv[i_112],"-S")));            _condtional_value_X629;            })) {
                output_source_file_flag_102=(_Bool)1;
                output_object_file_flag_103=(_Bool)0;
                gComeOriginalSourcePosition=(_Bool)0;
            }
            else if(({            (_condtional_value_X630=(charp_operator_equals(argv[i_112],"-s")));            _condtional_value_X630;            })) {
                output_source_file_flag_102=(_Bool)1;
                output_object_file_flag_103=(_Bool)1;
                gComeOriginalSourcePosition=(_Bool)0;
            }
            else if(({            (_condtional_value_X631=(charp_operator_equals(argv[i_112],"-c")));            _condtional_value_X631;            })) {
                output_object_file_100=(_Bool)1;
            }
            else if(({            (_condtional_value_X632=(charp_operator_equals(argv[i_112],"-E")));            _condtional_value_X632;            })) {
                output_cpp_file_101=(_Bool)1;
            }
            else if(({            (_condtional_value_X633=(argv[i_112][0]==45));            _condtional_value_X633;            })) {
            ...
            else if(({            (_condtional_value_X634=(strlen(argv[i_112])>2&&memcmp(argv[i_112]+strlen(argv[i_112])-2,".o",2)==0));            _condtional_value_X634;            })) {
                list$1char$ph_push_back(object_files_99,(char*)come_increment_ref_count(__builtin_string(argv[i_112])));
            }
            else if(({            (_condtional_value_X635=(strlen(argv[i_112])>2&&memcmp(argv[i_112]+strlen(argv[i_112])-2,".a",2)==0));            _condtional_value_X635;            })) {
                list$1char$ph_push_back(object_files_99,(char*)come_increment_ref_count(__builtin_string(argv[i_112])));
            }
            else if(({            (_condtional_value_X636=(string_operator_equals(ext_name_113,"c")));            _condtional_value_X636;            })) {
        ...
        for(        ({        (_condtional_value_X637=(o2_saved=(struct list$1char$ph*)come_increment_ref_count(files_98),it=list$1char$ph_begin(o2_saved)));        _condtional_value_X637;        });        ({        (_condtional_value_X638=(!list$1char$ph_end(o2_saved)));        _condtional_value_X638;        });        ({        (_condtional_value_X639=(it=list$1char$ph_next(o2_saved)));        _condtional_value_X639;        })        ){
            memset(&info_116,0,sizeof(struct sInfo));
            Value_117=fopen(it,"r");
            if(({            (_condtional_value_X640=(Value_117));            _condtional_value_X640;            })) {
                fclose(Value_117);
            }
            else {
            ...
            info_116.funcs=(struct map$2char$phsFun$ph*)come_increment_ref_count(map$2char$phsFun$ph_initialize((struct map$2char$phsFun$ph*)come_increment_ref_count((struct map$2char$phsFun$ph*)come_calloc_v2(1, sizeof(struct map$2char$phsFun$ph)*(1), "02transpile.c", 1193, "struct map$2char$phsFun$ph*"))));
            ...
            info_116.uniq_funcs=(struct map$2char$phsFun$ph*)come_increment_ref_count(map$2char$phsFun$ph_initialize((struct map$2char$phsFun$ph*)come_increment_ref_count((struct map$2char$phsFun$ph*)come_calloc_v2(1, sizeof(struct map$2char$phsFun$ph)*(1), "02transpile.c", 1194, "struct map$2char$phsFun$ph*"))));
            ...
            info_116.struct_definition=(struct map$2char$phbuffer$ph*)come_increment_ref_count(map$2char$phbuffer$ph_initialize((struct map$2char$phbuffer$ph*)come_increment_ref_count((struct map$2char$phbuffer$ph*)come_calloc_v2(1, sizeof(struct map$2char$phbuffer$ph)*(1), "02transpile.c", 1195, "struct map$2char$phbuffer$ph*"))));
            ...
            info_116.uniq_definition=(struct map$2char$phchar$ph*)come_increment_ref_count(map$2char$phchar$ph_initialize((struct map$2char$phchar$ph*)come_increment_ref_count((struct map$2char$phchar$ph*)come_calloc_v2(1, sizeof(struct map$2char$phchar$ph)*(1), "02transpile.c", 1196, "struct map$2char$phchar$ph*"))));
            ...
            info_116.classes=(struct map$2char$phsClass$ph*)come_increment_ref_count(map$2char$phsClass$ph_initialize((struct map$2char$phsClass$ph*)come_increment_ref_count((struct map$2char$phsClass$ph*)come_calloc_v2(1, sizeof(struct map$2char$phsClass$ph)*(1), "02transpile.c", 1199, "struct map$2char$phsClass$ph*"))));
            ...
            info_116.types=(struct map$2char$phsType$ph*)come_increment_ref_count(map$2char$phsType$ph_initialize((struct map$2char$phsType$ph*)come_increment_ref_count((struct map$2char$phsType$ph*)come_calloc_v2(1, sizeof(struct map$2char$phsType$ph)*(1), "02transpile.c", 1201, "struct map$2char$phsType$ph*"))));
            ...
            info_116.module=(struct sModule*)come_increment_ref_count(sModule_initialize((struct sModule*)come_increment_ref_count((struct sModule*)come_calloc_v2(1, sizeof(struct sModule)*(1), "02transpile.c", 1202, "struct sModule*"))));
            ...
            info_116.stack=(struct list$1CVALUE$ph*)come_increment_ref_count(list$1CVALUE$ph_initialize((struct list$1CVALUE$ph*)come_increment_ref_count((struct list$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list$1CVALUE$ph)*(1), "02transpile.c", 1204, "struct list$1CVALUE$ph*"))));
            ...
            info_116.gv_table=(struct sVarTable*)come_increment_ref_count(sVarTable_initialize((struct sVarTable*)come_increment_ref_count((struct sVarTable*)come_calloc_v2(1, sizeof(struct sVarTable)*(1), "02transpile.c", 1205, "struct sVarTable*")),(_Bool)1,((void*)0)));
            come_call_finalizer(sVarTable_finalize, __dec_obj80,(void*)0, (void*)0, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, (void*)0);
            lv_table_118=(struct sVarTable*)come_increment_ref_count(sVarTable_initialize((struct sVarTable*)come_increment_ref_count((struct sVarTable*)come_calloc_v2(1, sizeof(struct sVarTable)*(1), "02transpile.c", 1206, "struct sVarTable*")),(_Bool)0,((void*)0)));
            info_116.lv_table=lv_table_118;
            __dec_obj81=info_116.generics_type_names,
            info_116.generics_type_names=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "02transpile.c", 1208, "struct list$1char$ph*"))));
            ...
            info_116.method_generics_type_names=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "02transpile.c", 1209, "struct list$1char$ph*"))));
            ...
            info_116.generics_classes=(struct map$2char$phsClass$ph*)come_increment_ref_count(map$2char$phsClass$ph_initialize((struct map$2char$phsClass$ph*)come_increment_ref_count((struct map$2char$phsClass$ph*)come_calloc_v2(1, sizeof(struct map$2char$phsClass$ph)*(1), "02transpile.c", 1210, "struct map$2char$phsClass$ph*"))));
            ...
            if(({            (_condtional_value_X641=(!Value_119));            _condtional_value_X641;            })) {
                printf("transpile failed\n");
                exit(2);
            }
            else {
            ...
            if(({            (_condtional_value_X642=(output_file_name_104));            _condtional_value_X642;            })) {
            ...
            if(({            (_condtional_value_X643=(!Value_120));            _condtional_value_X643;            })) {
                transpile(&info_116);
                Value_121=output_source_file(&info_116);
                if(({                (_condtional_value_X644=(!Value_121));                _condtional_value_X644;                })) {
                    printf("output source file faield\n");
                    exit(2);
                }
                else {
                }
                if(({                (_condtional_value_X645=(info_116.err_num>0));                _condtional_value_X645;                })) {
                    printf("transpile error. err num %d\n",info_116.err_num);
                    exit(2);
                }
                Value_122=output_object_file_flag_103;
                if(({                (_condtional_value_X646=(Value_122));                _condtional_value_X646;                })) {
                    Value_123=compile(&info_116,output_object_file_100,object_files_99);
                    if(({                    (_condtional_value_X647=(!Value_123));                    _condtional_value_X647;                    })) {
            ...
            if(({            (_condtional_value_X648=(output_cpp_file_101));            _condtional_value_X648;            })) {
            }
            else if(({            (_condtional_value_X649=(info_116.err_num>0));            _condtional_value_X649;            })) {
            }
            else if(({            (_condtional_value_X650=(output_source_file_flag_102));            _condtional_value_X650;            })) {
        ...
        if(({        (_condtional_value_X651=(!output_object_file_100&&!output_cpp_file_101&&(list$1char$ph_length(files_98)>0||list$1char$ph_length(object_files_99)>0)));        _condtional_value_X651;        })) {
            memset(&info_124,0,sizeof(struct sInfo));
            __dec_obj87=info_124.sname,
            info_124.sname=(char*)come_increment_ref_count((char*)come_memdup(((char*)(__right_value602=list$1char$ph_operator_load_element(files_98,0))), "02transpile.c", 1276, "char*"));
            ...
            if(({            (_condtional_value_X658=(output_file_name_104));            _condtional_value_X658;            })) {
            ...
            if(({            (_condtional_value_X659=(output_object_file_flag_103));            _condtional_value_X659;            })) {
                Value_125=linker(&info_124,object_files_99);
                if(({                (_condtional_value_X660=(!Value_125));                _condtional_value_X660;                })) {
            ...
            if(({            (_condtional_value_X661=(!output_cpp_file_101&&!output_source_file_flag_102));            _condtional_value_X661;            })) {
...
char* __result_obj__45;
    ...
    n=0;
    for(    ({    (_condtional_value_X309=(it=list$1char$ph_begin(self)));    _condtional_value_X309;    });    ({    (_condtional_value_X310=(!list$1char$ph_end(self)));    _condtional_value_X310;    });    ({    (_condtional_value_X311=(it=list$1char$ph_next(self)));    _condtional_value_X311;    })    ){
        buffer_append_str(buf,it);
        if(({        (_condtional_value_X313=(n<list$1char$ph_length(self)-1));        _condtional_value_X313;        })) {
...
struct map$2char$phsFun$ph* __result_obj__47;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value381=(char**)come_calloc_v2(1, sizeof(char*)*(1*(128)), "/usr/local/include/comelang.h", 1931, "char**"))));
    self->items=(struct sFun**)come_increment_ref_count(((struct sFun**)(__right_value382=(struct sFun**)come_calloc_v2(1, sizeof(struct sFun*)*(1*(128)), "/usr/local/include/comelang.h", 1932, "struct sFun**"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value383=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(128)), "/usr/local/include/comelang.h", 1933, "_Bool*"))));
    for(    ({    (_condtional_value_X315=(i=0));    _condtional_value_X315;    });    ({    (_condtional_value_X316=(i<128));    _condtional_value_X316;    });    ({    (_condtional_value_X317=(i++));    _condtional_value_X317;    })    ){
...
struct list_item$1char$ph* prev_it;
    it=self->head;
    while(({    (_condtional_value_X319=(it!=((void*)0)));    _condtional_value_X319;    })) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1char$ph$p_finalize, prev_it, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
...
_Bool _condtional_value_X353;
    for(    ({    (_condtional_value_X320=(i=0));    _condtional_value_X320;    });    ({    (_condtional_value_X321=(i<self->size));    _condtional_value_X321;    });    ({    (_condtional_value_X322=(i++));    _condtional_value_X322;    })    ){
        if(({        (_condtional_value_X323=(self->item_existance[i]));        _condtional_value_X323;        })) {
            if(({            (_condtional_value_X324=(1));            _condtional_value_X324;            })) {
                come_call_finalizer(sFun_finalize, self->items[i], (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
            }
        }
    }
    come_free_v2((char*)self->items);
    for(    ({    (_condtional_value_X349=(i_68=0));    _condtional_value_X349;    });    ({    (_condtional_value_X350=(i_68<self->size));    _condtional_value_X350;    });    ({    (_condtional_value_X351=(i_68++));    _condtional_value_X351;    })    ){
        if(({        (_condtional_value_X352=(self->item_existance[i_68]));        _condtional_value_X352;        })) {
            if(({            (_condtional_value_X353=(1));            _condtional_value_X353;            })) {
...
_Bool _condtional_value_X348;
    if(({    (_condtional_value_X325=(self!=((void*)0)&&self->mName!=((void*)0)));    _condtional_value_X325;    })) {
        (self->mName = come_decrement_ref_count(self->mName, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X326=(self!=((void*)0)&&self->mResultType!=((void*)0)));    _condtional_value_X326;    })) {
        come_call_finalizer(sType_finalize, self->mResultType, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X327=(self!=((void*)0)&&self->mParamTypes!=((void*)0)));    _condtional_value_X327;    })) {
        come_call_finalizer(list$1sType$ph$p_finalize, self->mParamTypes, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X328=(self!=((void*)0)&&self->mParamNames!=((void*)0)));    _condtional_value_X328;    })) {
        come_call_finalizer(list$1char$ph$p_finalize, self->mParamNames, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X329=(self!=((void*)0)&&self->mParamDefaultParametors!=((void*)0)));    _condtional_value_X329;    })) {
...
struct list_item$1sVar$ph* prev_it;
    it=self->head;
    while(({    (_condtional_value_X332=(it!=((void*)0)));    _condtional_value_X332;    })) {
        prev_it=it;
        it=it->next;
...
_Bool _condtional_value_X333;
    if(({    (_condtional_value_X333=(self!=((void*)0)&&self->item!=((void*)0)));    _condtional_value_X333;    })) {
...
_Bool _condtional_value_X337;
    if(({    (_condtional_value_X334=(self!=((void*)0)&&self->mName!=((void*)0)));    _condtional_value_X334;    })) {
        (self->mName = come_decrement_ref_count(self->mName, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X335=(self!=((void*)0)&&self->mCValueName!=((void*)0)));    _condtional_value_X335;    })) {
        (self->mCValueName = come_decrement_ref_count(self->mCValueName, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X336=(self!=((void*)0)&&self->mType!=((void*)0)));    _condtional_value_X336;    })) {
        come_call_finalizer(sType_finalize, self->mType, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X337=(self!=((void*)0)&&self->mFunName!=((void*)0)));    _condtional_value_X337;    })) {
...
_Bool _condtional_value_X340;
    if(({    (_condtional_value_X339=(self!=((void*)0)&&self->mNodes!=((void*)0)));    _condtional_value_X339;    })) {
        come_call_finalizer(list$1sNode$ph$p_finalize, self->mNodes, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X340=(self!=((void*)0)&&self->mVarTable!=((void*)0)));    _condtional_value_X340;    })) {
...
_Bool _condtional_value_X363;
    for(    ({    (_condtional_value_X354=(i=0));    _condtional_value_X354;    });    ({    (_condtional_value_X355=(i<self->size));    _condtional_value_X355;    });    ({    (_condtional_value_X356=(i++));    _condtional_value_X356;    })    ){
        if(({        (_condtional_value_X357=(self->item_existance[i]));        _condtional_value_X357;        })) {
            if(({            (_condtional_value_X358=(1));            _condtional_value_X358;            })) {
                come_call_finalizer(sFun_finalize, self->items[i], (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
            }
        }
    }
    come_free_v2((char*)self->items);
    for(    ({    (_condtional_value_X359=(i_69=0));    _condtional_value_X359;    });    ({    (_condtional_value_X360=(i_69<self->size));    _condtional_value_X360;    });    ({    (_condtional_value_X361=(i_69++));    _condtional_value_X361;    })    ){
        if(({        (_condtional_value_X362=(self->item_existance[i_69]));        _condtional_value_X362;        })) {
...
struct map$2char$phbuffer$ph* __result_obj__48;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value390=(char**)come_calloc_v2(1, sizeof(char*)*(1*(128)), "/usr/local/include/comelang.h", 1931, "char**"))));
    self->items=(struct buffer**)come_increment_ref_count(((struct buffer**)(__right_value391=(struct buffer**)come_calloc_v2(1, sizeof(struct buffer*)*(1*(128)), "/usr/local/include/comelang.h", 1932, "struct buffer**"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value392=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(128)), "/usr/local/include/comelang.h", 1933, "_Bool*"))));
    for(    ({    (_condtional_value_X364=(i=0));    _condtional_value_X364;    });    ({    (_condtional_value_X365=(i<128));    _condtional_value_X365;    });    ({    (_condtional_value_X366=(i++));    _condtional_value_X366;    })    ){
        self->item_existance[i]=(_Bool)0;
    }
    self->size=128;
    self->len=0;
...
_Bool _condtional_value_X376;
    for(    ({    (_condtional_value_X367=(i=0));    _condtional_value_X367;    });    ({    (_condtional_value_X368=(i<self->size));    _condtional_value_X368;    });    ({    (_condtional_value_X369=(i++));    _condtional_value_X369;    })    ){
        if(({        (_condtional_value_X370=(self->item_existance[i]));        _condtional_value_X370;        })) {
            if(({            (_condtional_value_X371=(1));            _condtional_value_X371;            })) {
                come_call_finalizer(buffer_finalize, self->items[i], (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
            }
        }
    }
    come_free_v2((char*)self->items);
    for(    ({    (_condtional_value_X372=(i_70=0));    _condtional_value_X372;    });    ({    (_condtional_value_X373=(i_70<self->size));    _condtional_value_X373;    });    ({    (_condtional_value_X374=(i_70++));    _condtional_value_X374;    })    ){
        if(({        (_condtional_value_X375=(self->item_existance[i_70]));        _condtional_value_X375;        })) {
            if(({            (_condtional_value_X376=(1));            _condtional_value_X376;            })) {
...
_Bool _condtional_value_X386;
    for(    ({    (_condtional_value_X377=(i=0));    _condtional_value_X377;    });    ({    (_condtional_value_X378=(i<self->size));    _condtional_value_X378;    });    ({    (_condtional_value_X379=(i++));    _condtional_value_X379;    })    ){
        if(({        (_condtional_value_X380=(self->item_existance[i]));        _condtional_value_X380;        })) {
            if(({            (_condtional_value_X381=(1));            _condtional_value_X381;            })) {
                come_call_finalizer(buffer_finalize, self->items[i], (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
            }
        }
    }
    come_free_v2((char*)self->items);
    for(    ({    (_condtional_value_X382=(i_71=0));    _condtional_value_X382;    });    ({    (_condtional_value_X383=(i_71<self->size));    _condtional_value_X383;    });    ({    (_condtional_value_X384=(i_71++));    _condtional_value_X384;    })    ){
        if(({        (_condtional_value_X385=(self->item_existance[i_71]));        _condtional_value_X385;        })) {
            if(({            (_condtional_value_X386=(1));            _condtional_value_X386;            })) {
...
struct map$2char$phchar$ph* __result_obj__49;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value397=(char**)come_calloc_v2(1, sizeof(char*)*(1*(128)), "/usr/local/include/comelang.h", 1931, "char**"))));
    self->items=(char**)come_increment_ref_count(((char**)(__right_value398=(char**)come_calloc_v2(1, sizeof(char*)*(1*(128)), "/usr/local/include/comelang.h", 1932, "char**"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value399=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(128)), "/usr/local/include/comelang.h", 1933, "_Bool*"))));
    for(    ({    (_condtional_value_X387=(i=0));    _condtional_value_X387;    });    ({    (_condtional_value_X388=(i<128));    _condtional_value_X388;    });    ({    (_condtional_value_X389=(i++));    _condtional_value_X389;    })    ){
        self->item_existance[i]=(_Bool)0;
    }
    self->size=128;
    self->len=0;
...
_Bool _condtional_value_X399;
    for(    ({    (_condtional_value_X390=(i=0));    _condtional_value_X390;    });    ({    (_condtional_value_X391=(i<self->size));    _condtional_value_X391;    });    ({    (_condtional_value_X392=(i++));    _condtional_value_X392;    })    ){
        if(({        (_condtional_value_X393=(self->item_existance[i]));        _condtional_value_X393;        })) {
            if(({            (_condtional_value_X394=(1));            _condtional_value_X394;            })) {
                (self->items[i] = come_decrement_ref_count(self->items[i], (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
            }
        }
    }
    come_free_v2((char*)self->items);
    for(    ({    (_condtional_value_X395=(i_72=0));    _condtional_value_X395;    });    ({    (_condtional_value_X396=(i_72<self->size));    _condtional_value_X396;    });    ({    (_condtional_value_X397=(i_72++));    _condtional_value_X397;    })    ){
        if(({        (_condtional_value_X398=(self->item_existance[i_72]));        _condtional_value_X398;        })) {
            if(({            (_condtional_value_X399=(1));            _condtional_value_X399;            })) {
...
_Bool _condtional_value_X409;
    for(    ({    (_condtional_value_X400=(i=0));    _condtional_value_X400;    });    ({    (_condtional_value_X401=(i<self->size));    _condtional_value_X401;    });    ({    (_condtional_value_X402=(i++));    _condtional_value_X402;    })    ){
        if(({        (_condtional_value_X403=(self->item_existance[i]));        _condtional_value_X403;        })) {
            if(({            (_condtional_value_X404=(1));            _condtional_value_X404;            })) {
                (self->items[i] = come_decrement_ref_count(self->items[i], (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
            }
        }
    }
    come_free_v2((char*)self->items);
    for(    ({    (_condtional_value_X405=(i_73=0));    _condtional_value_X405;    });    ({    (_condtional_value_X406=(i_73<self->size));    _condtional_value_X406;    });    ({    (_condtional_value_X407=(i_73++));    _condtional_value_X407;    })    ){
        if(({        (_condtional_value_X408=(self->item_existance[i_73]));        _condtional_value_X408;        })) {
...
struct map$2char$phsGenericsFun$ph* __result_obj__50;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value406=(char**)come_calloc_v2(1, sizeof(char*)*(1*(128)), "/usr/local/include/comelang.h", 1931, "char**"))));
    self->items=(struct sGenericsFun**)come_increment_ref_count(((struct sGenericsFun**)(__right_value407=(struct sGenericsFun**)come_calloc_v2(1, sizeof(struct sGenericsFun*)*(1*(128)), "/usr/local/include/comelang.h", 1932, "struct sGenericsFun**"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value408=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(128)), "/usr/local/include/comelang.h", 1933, "_Bool*"))));
    for(    ({    (_condtional_value_X410=(i=0));    _condtional_value_X410;    });    ({    (_condtional_value_X411=(i<128));    _condtional_value_X411;    });    ({    (_condtional_value_X412=(i++));    _condtional_value_X412;    })    ){
        self->item_existance[i]=(_Bool)0;
    }
    self->size=128;
    self->len=0;
...
_Bool _condtional_value_X432;
    for(    ({    (_condtional_value_X413=(i=0));    _condtional_value_X413;    });    ({    (_condtional_value_X414=(i<self->size));    _condtional_value_X414;    });    ({    (_condtional_value_X415=(i++));    _condtional_value_X415;    })    ){
        if(({        (_condtional_value_X416=(self->item_existance[i]));        _condtional_value_X416;        })) {
            if(({            (_condtional_value_X417=(1));            _condtional_value_X417;            })) {
                come_call_finalizer(sGenericsFun_finalize, self->items[i], (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
            }
        }
    }
    come_free_v2((char*)self->items);
    for(    ({    (_condtional_value_X428=(i_74=0));    _condtional_value_X428;    });    ({    (_condtional_value_X429=(i_74<self->size));    _condtional_value_X429;    });    ({    (_condtional_value_X430=(i_74++));    _condtional_value_X430;    })    ){
        if(({        (_condtional_value_X431=(self->item_existance[i_74]));        _condtional_value_X431;        })) {
            if(({            (_condtional_value_X432=(1));            _condtional_value_X432;            })) {
...
_Bool _condtional_value_X427;
    if(({    (_condtional_value_X418=(self!=((void*)0)&&self->mImplType!=((void*)0)));    _condtional_value_X418;    })) {
        come_call_finalizer(sType_finalize, self->mImplType, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X419=(self!=((void*)0)&&self->mGenericsTypeNames!=((void*)0)));    _condtional_value_X419;    })) {
    ...
    if(({    (_condtional_value_X420=(self!=((void*)0)&&self->mMethodGenericsTypeNames!=((void*)0)));    _condtional_value_X420;    })) {
    ...
    if(({    (_condtional_value_X421=(self!=((void*)0)&&self->mName!=((void*)0)));    _condtional_value_X421;    })) {
        (self->mName = come_decrement_ref_count(self->mName, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X422=(self!=((void*)0)&&self->mResultType!=((void*)0)));    _condtional_value_X422;    })) {
        come_call_finalizer(sType_finalize, self->mResultType, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X423=(self!=((void*)0)&&self->mParamTypes!=((void*)0)));    _condtional_value_X423;    })) {
        come_call_finalizer(list$1sType$ph$p_finalize, self->mParamTypes, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X424=(self!=((void*)0)&&self->mParamNames!=((void*)0)));    _condtional_value_X424;    })) {
        come_call_finalizer(list$1char$ph$p_finalize, self->mParamNames, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X425=(self!=((void*)0)&&self->mParamDefaultParametors!=((void*)0)));    _condtional_value_X425;    })) {
        come_call_finalizer(list$1char$ph$p_finalize, self->mParamDefaultParametors, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X426=(self!=((void*)0)&&self->mBlock!=((void*)0)));    _condtional_value_X426;    })) {
        (self->mBlock = come_decrement_ref_count(self->mBlock, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X427=(self!=((void*)0)&&self->mGenericsSName!=((void*)0)));    _condtional_value_X427;    })) {
...
_Bool _condtional_value_X442;
    for(    ({    (_condtional_value_X433=(i=0));    _condtional_value_X433;    });    ({    (_condtional_value_X434=(i<self->size));    _condtional_value_X434;    });    ({    (_condtional_value_X435=(i++));    _condtional_value_X435;    })    ){
        if(({        (_condtional_value_X436=(self->item_existance[i]));        _condtional_value_X436;        })) {
    ...
    come_free_v2((char*)self->items);
    for(    ({    (_condtional_value_X438=(i_75=0));    _condtional_value_X438;    });    ({    (_condtional_value_X439=(i_75<self->size));    _condtional_value_X439;    });    ({    (_condtional_value_X440=(i_75++));    _condtional_value_X440;    })    ){
        if(({        (_condtional_value_X441=(self->item_existance[i_75]));        _condtional_value_X441;        })) {
...
struct map$2char$phsClass$ph* __result_obj__51;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value413=(char**)come_calloc_v2(1, sizeof(char*)*(1*(128)), "/usr/local/include/comelang.h", 1931, "char**"))));
    self->items=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value414=(struct sClass**)come_calloc_v2(1, sizeof(struct sClass*)*(1*(128)), "/usr/local/include/comelang.h", 1932, "struct sClass**"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value415=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(128)), "/usr/local/include/comelang.h", 1933, "_Bool*"))));
    for(    ({    (_condtional_value_X443=(i=0));    _condtional_value_X443;    });    ({    (_condtional_value_X444=(i<128));    _condtional_value_X444;    });    ({    (_condtional_value_X445=(i++));    _condtional_value_X445;    })    ){
        self->item_existance[i]=(_Bool)0;
    }
    self->size=128;
    self->len=0;
...
_Bool _condtional_value_X455;
    for(    ({    (_condtional_value_X446=(i=0));    _condtional_value_X446;    });    ({    (_condtional_value_X447=(i<self->size));    _condtional_value_X447;    });    ({    (_condtional_value_X448=(i++));    _condtional_value_X448;    })    ){
        if(({        (_condtional_value_X449=(self->item_existance[i]));        _condtional_value_X449;        })) {
    ...
    come_free_v2((char*)self->items);
    for(    ({    (_condtional_value_X451=(i_76=0));    _condtional_value_X451;    });    ({    (_condtional_value_X452=(i_76<self->size));    _condtional_value_X452;    });    ({    (_condtional_value_X453=(i_76++));    _condtional_value_X453;    })    ){
        if(({        (_condtional_value_X454=(self->item_existance[i_76]));        _condtional_value_X454;        })) {
            if(({            (_condtional_value_X455=(1));            _condtional_value_X455;            })) {
...
_Bool _condtional_value_X465;
    for(    ({    (_condtional_value_X456=(i=0));    _condtional_value_X456;    });    ({    (_condtional_value_X457=(i<self->size));    _condtional_value_X457;    });    ({    (_condtional_value_X458=(i++));    _condtional_value_X458;    })    ){
        if(({        (_condtional_value_X459=(self->item_existance[i]));        _condtional_value_X459;        })) {
            if(({            (_condtional_value_X460=(1));            _condtional_value_X460;            })) {
                come_call_finalizer(sClass_finalize, self->items[i], (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
            }
        }
    }
    come_free_v2((char*)self->items);
    for(    ({    (_condtional_value_X461=(i_77=0));    _condtional_value_X461;    });    ({    (_condtional_value_X462=(i_77<self->size));    _condtional_value_X462;    });    ({    (_condtional_value_X463=(i_77++));    _condtional_value_X463;    })    ){
        if(({        (_condtional_value_X464=(self->item_existance[i_77]));        _condtional_value_X464;        })) {
            if(({            (_condtional_value_X465=(1));            _condtional_value_X465;            })) {
...
struct map$2char$phsClassModule$ph* __result_obj__52;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value420=(char**)come_calloc_v2(1, sizeof(char*)*(1*(128)), "/usr/local/include/comelang.h", 1931, "char**"))));
    self->items=(struct sClassModule**)come_increment_ref_count(((struct sClassModule**)(__right_value421=(struct sClassModule**)come_calloc_v2(1, sizeof(struct sClassModule*)*(1*(128)), "/usr/local/include/comelang.h", 1932, "struct sClassModule**"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value422=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(128)), "/usr/local/include/comelang.h", 1933, "_Bool*"))));
    for(    ({    (_condtional_value_X466=(i=0));    _condtional_value_X466;    });    ({    (_condtional_value_X467=(i<128));    _condtional_value_X467;    });    ({    (_condtional_value_X468=(i++));    _condtional_value_X468;    })    ){
        self->item_existance[i]=(_Bool)0;
    }
    self->size=128;
    self->len=0;
...
_Bool _condtional_value_X482;
    for(    ({    (_condtional_value_X469=(i=0));    _condtional_value_X469;    });    ({    (_condtional_value_X470=(i<self->size));    _condtional_value_X470;    });    ({    (_condtional_value_X471=(i++));    _condtional_value_X471;    })    ){
        if(({        (_condtional_value_X472=(self->item_existance[i]));        _condtional_value_X472;        })) {
            if(({            (_condtional_value_X473=(1));            _condtional_value_X473;            })) {
                come_call_finalizer(sClassModule_finalize, self->items[i], (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
            }
        }
    }
    come_free_v2((char*)self->items);
    for(    ({    (_condtional_value_X478=(i_78=0));    _condtional_value_X478;    });    ({    (_condtional_value_X479=(i_78<self->size));    _condtional_value_X479;    });    ({    (_condtional_value_X480=(i_78++));    _condtional_value_X480;    })    ){
        if(({        (_condtional_value_X481=(self->item_existance[i_78]));        _condtional_value_X481;        })) {
            if(({            (_condtional_value_X482=(1));            _condtional_value_X482;            })) {
...
_Bool _condtional_value_X477;
    if(({    (_condtional_value_X474=(self!=((void*)0)&&self->mName!=((void*)0)));    _condtional_value_X474;    })) {
        (self->mName = come_decrement_ref_count(self->mName, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X475=(self!=((void*)0)&&self->mText!=((void*)0)));    _condtional_value_X475;    })) {
        (self->mText = come_decrement_ref_count(self->mText, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X476=(self!=((void*)0)&&self->mParams!=((void*)0)));    _condtional_value_X476;    })) {
        come_call_finalizer(list$1char$ph$p_finalize, self->mParams, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X477=(self!=((void*)0)&&self->mSName!=((void*)0)));    _condtional_value_X477;    })) {
...
_Bool _condtional_value_X492;
    for(    ({    (_condtional_value_X483=(i=0));    _condtional_value_X483;    });    ({    (_condtional_value_X484=(i<self->size));    _condtional_value_X484;    });    ({    (_condtional_value_X485=(i++));    _condtional_value_X485;    })    ){
        if(({        (_condtional_value_X486=(self->item_existance[i]));        _condtional_value_X486;        })) {
            if(({            (_condtional_value_X487=(1));            _condtional_value_X487;            })) {
                come_call_finalizer(sClassModule_finalize, self->items[i], (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
            }
        }
    }
    come_free_v2((char*)self->items);
    for(    ({    (_condtional_value_X488=(i_79=0));    _condtional_value_X488;    });    ({    (_condtional_value_X489=(i_79<self->size));    _condtional_value_X489;    });    ({    (_condtional_value_X490=(i_79++));    _condtional_value_X490;    })    ){
        if(({        (_condtional_value_X491=(self->item_existance[i_79]));        _condtional_value_X491;        })) {
            if(({            (_condtional_value_X492=(1));            _condtional_value_X492;            })) {
...
struct map$2char$phsType$ph* __result_obj__53;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value427=(char**)come_calloc_v2(1, sizeof(char*)*(1*(128)), "/usr/local/include/comelang.h", 1931, "char**"))));
    self->items=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value428=(struct sType**)come_calloc_v2(1, sizeof(struct sType*)*(1*(128)), "/usr/local/include/comelang.h", 1932, "struct sType**"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value429=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(128)), "/usr/local/include/comelang.h", 1933, "_Bool*"))));
    for(    ({    (_condtional_value_X493=(i=0));    _condtional_value_X493;    });    ({    (_condtional_value_X494=(i<128));    _condtional_value_X494;    });    ({    (_condtional_value_X495=(i++));    _condtional_value_X495;    })    ){
        self->item_existance[i]=(_Bool)0;
    }
    self->size=128;
    self->len=0;
...
_Bool _condtional_value_X505;
    for(    ({    (_condtional_value_X496=(i=0));    _condtional_value_X496;    });    ({    (_condtional_value_X497=(i<self->size));    _condtional_value_X497;    });    ({    (_condtional_value_X498=(i++));    _condtional_value_X498;    })    ){
        if(({        (_condtional_value_X499=(self->item_existance[i]));        _condtional_value_X499;        })) {
    ...
    come_free_v2((char*)self->items);
    for(    ({    (_condtional_value_X501=(i_80=0));    _condtional_value_X501;    });    ({    (_condtional_value_X502=(i_80<self->size));    _condtional_value_X502;    });    ({    (_condtional_value_X503=(i_80++));    _condtional_value_X503;    })    ){
        if(({        (_condtional_value_X504=(self->item_existance[i_80]));        _condtional_value_X504;        })) {
            if(({            (_condtional_value_X505=(1));            _condtional_value_X505;            })) {
...
_Bool _condtional_value_X515;
    ...
    come_free_v2((char*)self->items);
    for(    ({    (_condtional_value_X511=(i_81=0));    _condtional_value_X511;    });    ({    (_condtional_value_X512=(i_81<self->size));    _condtional_value_X512;    });    ({    (_condtional_value_X513=(i_81++));    _condtional_value_X513;    })    ){
        if(({        (_condtional_value_X514=(self->item_existance[i_81]));        _condtional_value_X514;        })) {
...
_Bool _condtional_value_X521;
    if(({    (_condtional_value_X516=(self!=((void*)0)&&self->mSourceHead!=((void*)0)));    _condtional_value_X516;    })) {
        come_call_finalizer(buffer_finalize, self->mSourceHead, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X517=(self!=((void*)0)&&self->mSource!=((void*)0)));    _condtional_value_X517;    })) {
        come_call_finalizer(buffer_finalize, self->mSource, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X518=(self!=((void*)0)&&self->mLastCode!=((void*)0)));    _condtional_value_X518;    })) {
        (self->mLastCode = come_decrement_ref_count(self->mLastCode, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X519=(self!=((void*)0)&&self->mLastCode2!=((void*)0)));    _condtional_value_X519;    })) {
        (self->mLastCode2 = come_decrement_ref_count(self->mLastCode2, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X520=(self!=((void*)0)&&self->mHeader!=((void*)0)));    _condtional_value_X520;    })) {
    ...
    if(({    (_condtional_value_X521=(self!=((void*)0)&&self->mHeaderStructs!=((void*)0)));    _condtional_value_X521;    })) {
...
struct list_item$1sRightValueObject$ph* prev_it;
    it=self->head;
    while(({    (_condtional_value_X522=(it!=((void*)0)));    _condtional_value_X522;    })) {
        prev_it=it;
        it=it->next;
...
_Bool _condtional_value_X523;
    if(({    (_condtional_value_X523=(self!=((void*)0)&&self->item!=((void*)0)));    _condtional_value_X523;    })) {
...
_Bool _condtional_value_X528;
    if(({    (_condtional_value_X524=(self!=((void*)0)&&self->mType!=((void*)0)));    _condtional_value_X524;    })) {
        come_call_finalizer(sType_finalize, self->mType, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X525=(self!=((void*)0)&&self->mVarName!=((void*)0)));    _condtional_value_X525;    })) {
        (self->mVarName = come_decrement_ref_count(self->mVarName, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X526=(self!=((void*)0)&&self->mFunName!=((void*)0)));    _condtional_value_X526;    })) {
        (self->mFunName = come_decrement_ref_count(self->mFunName, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X527=(self!=((void*)0)&&self->mObjType!=((void*)0)));    _condtional_value_X527;    })) {
        come_call_finalizer(sType_finalize, self->mObjType, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X528=(self!=((void*)0)&&self->mObjValue!=((void*)0)));    _condtional_value_X528;    })) {
...
struct list_item$1CVALUE$ph* prev_it;
    it=self->head;
    while(({    (_condtional_value_X532=(it!=((void*)0)));    _condtional_value_X532;    })) {
        prev_it=it;
        it=it->next;
        come_call_finalizer(list_item$1CVALUE$ph$p_finalize, prev_it, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
...
_Bool _condtional_value_X570;
    if(({    (_condtional_value_X536=(self!=((void*)0)&&self->source!=((void*)0)));    _condtional_value_X536;    })) {
        come_call_finalizer(buffer_finalize, self->source, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X537=(self!=((void*)0)&&self->sname!=((void*)0)));    _condtional_value_X537;    })) {
        (self->sname = come_decrement_ref_count(self->sname, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X538=(self!=((void*)0)&&self->sname_at_head!=((void*)0)));    _condtional_value_X538;    })) {
        (self->sname_at_head = come_decrement_ref_count(self->sname_at_head, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X539=(self!=((void*)0)&&self->base_sname!=((void*)0)));    _condtional_value_X539;    })) {
        (self->base_sname = come_decrement_ref_count(self->base_sname, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X540=(self!=((void*)0)&&self->clang_option!=((void*)0)));    _condtional_value_X540;    })) {
        (self->clang_option = come_decrement_ref_count(self->clang_option, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X541=(self!=((void*)0)&&self->cpp_option!=((void*)0)));    _condtional_value_X541;    })) {
        (self->cpp_option = come_decrement_ref_count(self->cpp_option, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X542=(self!=((void*)0)&&self->linker_option!=((void*)0)));    _condtional_value_X542;    })) {
        (self->linker_option = come_decrement_ref_count(self->linker_option, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X543=(self!=((void*)0)&&self->funcs!=((void*)0)));    _condtional_value_X543;    })) {
    ...
    if(({    (_condtional_value_X544=(self!=((void*)0)&&self->uniq_funcs!=((void*)0)));    _condtional_value_X544;    })) {
    ...
    if(({    (_condtional_value_X545=(self!=((void*)0)&&self->generics_funcs!=((void*)0)));    _condtional_value_X545;    })) {
    ...
    if(({    (_condtional_value_X546=(self!=((void*)0)&&self->classes!=((void*)0)));    _condtional_value_X546;    })) {
    ...
    if(({    (_condtional_value_X547=(self!=((void*)0)&&self->modules!=((void*)0)));    _condtional_value_X547;    })) {
    ...
    if(({    (_condtional_value_X548=(self!=((void*)0)&&self->types!=((void*)0)));    _condtional_value_X548;    })) {
    ...
    if(({    (_condtional_value_X549=(self!=((void*)0)&&self->generics_classes!=((void*)0)));    _condtional_value_X549;    })) {
    ...
    if(({    (_condtional_value_X550=(self!=((void*)0)&&self->struct_definition!=((void*)0)));    _condtional_value_X550;    })) {
    ...
    if(({    (_condtional_value_X551=(self!=((void*)0)&&self->previous_struct_definition!=((void*)0)));    _condtional_value_X551;    })) {
    ...
    if(({    (_condtional_value_X552=(self!=((void*)0)&&self->module!=((void*)0)));    _condtional_value_X552;    })) {
        come_call_finalizer(sModule_finalize, self->module, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X553=(self!=((void*)0)&&self->type!=((void*)0)));    _condtional_value_X553;    })) {
        come_call_finalizer(sType_finalize, self->type, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X554=(self!=((void*)0)&&self->right_value_objects!=((void*)0)));    _condtional_value_X554;    })) {
    ...
    if(({    (_condtional_value_X555=(self!=((void*)0)&&self->generics_type!=((void*)0)));    _condtional_value_X555;    })) {
        come_call_finalizer(sType_finalize, self->generics_type, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X556=(self!=((void*)0)&&self->method_generics_types!=((void*)0)));    _condtional_value_X556;    })) {
    ...
    if(({    (_condtional_value_X557=(self!=((void*)0)&&self->stack!=((void*)0)));    _condtional_value_X557;    })) {
        come_call_finalizer(list$1CVALUE$ph$p_finalize, self->stack, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X558=(self!=((void*)0)&&self->come_function_result_type!=((void*)0)));    _condtional_value_X558;    })) {
    ...
    if(({    (_condtional_value_X559=(self!=((void*)0)&&self->come_method_block_function_result_type!=((void*)0)));    _condtional_value_X559;    })) {
    ...
    if(({    (_condtional_value_X560=(self!=((void*)0)&&self->gv_table!=((void*)0)));    _condtional_value_X560;    })) {
        come_call_finalizer(sVarTable_finalize, self->gv_table, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X561=(self!=((void*)0)&&self->generics_type_names!=((void*)0)));    _condtional_value_X561;    })) {
    ...
    if(({    (_condtional_value_X562=(self!=((void*)0)&&self->method_generics_type_names!=((void*)0)));    _condtional_value_X562;    })) {
    ...
    if(({    (_condtional_value_X563=(self!=((void*)0)&&self->impl_type!=((void*)0)));    _condtional_value_X563;    })) {
        come_call_finalizer(sType_finalize, self->impl_type, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X564=(self!=((void*)0)&&self->class_type!=((void*)0)));    _condtional_value_X564;    })) {
        come_call_finalizer(sType_finalize, self->class_type, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    if(({    (_condtional_value_X565=(self!=((void*)0)&&self->output_file_name!=((void*)0)));    _condtional_value_X565;    })) {
        (self->output_file_name = come_decrement_ref_count(self->output_file_name, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X566=(self!=((void*)0)&&self->function_result_type!=((void*)0)));    _condtional_value_X566;    })) {
    ...
    if(({    (_condtional_value_X567=(self!=((void*)0)&&self->module_params!=((void*)0)));    _condtional_value_X567;    })) {
    ...
    if(({    (_condtional_value_X568=(self!=((void*)0)&&self->if_result_var_name!=((void*)0)));    _condtional_value_X568;    })) {
        (self->if_result_var_name = come_decrement_ref_count(self->if_result_var_name, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
    }
    if(({    (_condtional_value_X569=(self!=((void*)0)&&self->match_it_var!=((void*)0)));    _condtional_value_X569;    })) {
    ...
    if(({    (_condtional_value_X570=(self!=((void*)0)&&self->uniq_definition!=((void*)0)));    _condtional_value_X570;    })) {
...
default_value = (void*)0;
    if(({    (_condtional_value_X655=(position<0));    _condtional_value_X655;    })) {
        position+=self->len;
    }
    it=self->head;
    i=0;
    while(({    (_condtional_value_X656=(it!=((void*)0)));    _condtional_value_X656;    })) {
        if(({        (_condtional_value_X657=(position==i));        _condtional_value_X657;        })) {
