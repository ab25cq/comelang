...
_Bool __result_obj__167;
    ...
    (sname_250 = come_decrement_ref_count(sname_250, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
...
void* __right_value193 = (void*)0;
    ...
    if(    input_file_name_254!=((void*)0)&&string_operator_not_equals(input_file_name_254,"")) {
        (void)system(((char*)(__right_value193=xsprintf("%s %s.*",RM,input_file_name_254))));
...
void* __right_value194 = (void*)0;
    ...
    if(    input_file_name_255!=((void*)0)&&string_operator_not_equals(input_file_name_255,"")) {
        (void)system(((char*)(__right_value194=xsprintf("%s %s.i* %s.c*",RM,input_file_name_255,input_file_name_255))));
...
void* __right_value195 = (void*)0;
    ...
    if(    input_file_name_256!=((void*)0)&&string_operator_not_equals(input_file_name_256,"")) {
        (void)system(((char*)(__right_value195=xsprintf("%s %s.i* %s.c.out",RM,input_file_name_256,input_file_name_256))));
...
static _Bool cpp(struct sInfo* info){
char* input_file_name_257;
char* output_file_name_258;
void* __right_value196 = (void*)0;
char* __dec_obj18;
void* __right_value197 = (void*)0;
char* __dec_obj19;
_Bool exist_common_h_259;
struct _IO_FILE* Value_260;
int is_mac_261;
int is_android_262;
int is_debian_263;
int is_linux_264;
...
output_file_name_258 = (void*)0;
    input_file_name_257=(char*)come_increment_ref_count(info->sname);
    if(    !info->output_header_file&&info->output_file_name) {
        __dec_obj18=output_file_name_258,
        output_file_name_258=(char*)come_increment_ref_count(string_operator_add(info->output_file_name,".i"));
        __dec_obj18 = come_decrement_ref_count(__dec_obj18, (void*)0, (void*)0, 0/* no_decrement */,0/* no_free */,0/*force_delete*/, (void*)0);
    }
    else {
        __dec_obj19=output_file_name_258,
        output_file_name_258=(char*)come_increment_ref_count(string_operator_add(info->sname,".i"));
        __dec_obj19 = come_decrement_ref_count(__dec_obj19, (void*)0, (void*)0, 0/* no_decrement */,0/* no_free */,0/*force_delete*/, (void*)0);
    }
    exist_common_h_259=(_Bool)0;
    {
        Value_260=fopen("common.h","r");
        if(        Value_260) {
            exist_common_h_259=(_Bool)1;
            fclose(Value_260);
        }
        else {
        }
    ...
    is_mac_261=system("uname -a | grep Darwin 1> /dev/null 2>/dev/null")==0;
    is_android_262=system("uname -a | grep Android 1> /dev/null 2>/dev/null")==0;
    is_debian_263=system("uname -a | grep Debian 1> /dev/null 2>/dev/null")==0;
    is_linux_264=1;
    is_m5stack_265=info->m5stack_cpp;
    is_pico_266=info->pico_cpp;
    is_emb_267=info->emb_cpp;
    if(    is_android_262) {
        cmd3_268=(char*)come_increment_ref_count(xsprintf("cpp %s -lang-c %s -I. -I%s/include -DPREFIX=\"\\\"%s\\\"\" -I%s/include -I/data/data/com.termux/files/usr/include/mariadb -D__ANDROID__ %s %s > %s 2> %s.cpp.out",(((info->remove_comment)?(""):(" -C"))),info->cpp_option,getenv("HOME"),"/usr/local/","/usr/local/",((exist_common_h_259)?(((char*)(__right_value198=__builtin_string(" -include common.h ")))):("")),input_file_name_257,output_file_name_258,output_file_name_258));
        (__right_value198 = come_decrement_ref_count(__right_value198, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        if(        info->verbose) {
            puts(cmd3_268);
        }
        rc_269=system(cmd3_268);
        command2_270=(char*)come_increment_ref_count(xsprintf("grep error\\: %s.cpp.out 2>/dev/null",output_file_name_258));
        if(        info->verbose) {
            puts(command2_270);
        }
        ...
        (cmd3_268 = come_decrement_ref_count(cmd3_268, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        (command2_270 = come_decrement_ref_count(command2_270, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    }
    else if(    is_m5stack_265) {
        cmd2_271=(char*)come_increment_ref_count(xsprintf("xtensa-esp-elf-cpp -E %s -lang-c %s -I. -I/usr/local/include -DPREFIX=\"\\\"%s\\\"\" -I%s/include -DNEO_C -D__M5STACK__ %s %s > %s 2> %s.cpp.out",((info->remove_comment)?(""):(" -C")),info->cpp_option,"/usr/local/","/usr/local/",((exist_common_h_259)?(((char*)(__right_value201=__builtin_string(" -include common.h ")))):("")),input_file_name_257,output_file_name_258,output_file_name_258));
        (__right_value201 = come_decrement_ref_count(__right_value201, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        if(        info->verbose) {
            puts(cmd2_271);
        }
        rc_272=system(cmd2_271);
        command2_273=(char*)come_increment_ref_count(xsprintf("grep error\\: %s.cpp.out 2>/dev/null",output_file_name_258));
        if(        info->verbose) {
            puts(command2_273);
        }
        ...
        command2_274=(char*)come_increment_ref_count(xsprintf("grep error\\: %s.cpp.out 2>/dev/null",output_file_name_258));
        if(        info->verbose) {
            puts(command2_274);
        }
        ...
        cmd2_275=(char*)come_increment_ref_count(xsprintf("arm-none-eabi-gcc -E %s -lang-c %s -I. -I/usr/local/include -DPREFIX=\"\\\"%s\\\"\" -I%s/include -DNEO_C -D__PICO__ %s %s > %s 2> %s.cpp.out",((info->remove_comment)?(""):(" -C")),info->cpp_option,"/usr/local/","/usr/local/",((exist_common_h_259)?(((char*)(__right_value205=__builtin_string(" -include common.h ")))):("")),input_file_name_257,output_file_name_258,output_file_name_258));
        (__right_value205 = come_decrement_ref_count(__right_value205, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        if(        info->verbose) {
            puts(cmd2_275);
        }
        command2_276=(char*)come_increment_ref_count(xsprintf("grep error\\: %s.cpp.out 2>/dev/null",output_file_name_258));
        if(        info->verbose) {
            puts(command2_276);
        }
        (void)system(command2_276);
        rc_277=system(cmd2_275);
        if(        rc_277!=0) {
            printf("failed to cpp(2) (%s)\n",cmd2_275);
            exit(5);
        }
        (command2_276 = come_decrement_ref_count(command2_276, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        command2_278=(char*)come_increment_ref_count(xsprintf("grep error\\: %s.cpp.out 2>/dev/null",output_file_name_258));
        if(        info->verbose) {
            puts(command2_278);
        }
        (void)system(command2_278);
        (cmd2_275 = come_decrement_ref_count(cmd2_275, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        (command2_278 = come_decrement_ref_count(command2_278, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    }
    else if(    is_mac_261) {
        cmd2_279=(char*)come_increment_ref_count(xsprintf("gcc -E %s -lang-c %s -I. -I/usr/local/include -DPREFIX=\"\\\"%s\\\"\" -I%s/include -DNEO_C -D__MAC__ -I/opt/homebrew/opt/pcre/include -I/opt/homebrew/opt/boehmgc/include/ -I/opt/homebrew/opt/openssl/include -I/opt/homebrew/opt/mysql/include %s %s > %s 2> %s.cpp.out",((info->remove_comment)?(""):(" -C")),info->cpp_option,"/usr/local/","/usr/local/",((exist_common_h_259)?(((char*)(__right_value209=__builtin_string(" -include common.h ")))):("")),input_file_name_257,output_file_name_258,output_file_name_258));
        (__right_value209 = come_decrement_ref_count(__right_value209, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        if(        info->verbose) {
            puts(cmd2_279);
        }
        command2_280=(char*)come_increment_ref_count(xsprintf("grep error\\: %s.cpp.out 2>/dev/null",output_file_name_258));
        if(        info->verbose) {
            puts(command2_280);
        }
        (void)system(command2_280);
        rc_281=system(cmd2_279);
        if(        rc_281!=0) {
            printf("failed to cpp(2) (%s)\n",cmd2_279);
            exit(5);
        }
        (command2_280 = come_decrement_ref_count(command2_280, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        command2_282=(char*)come_increment_ref_count(xsprintf("grep error\\: %s.cpp.out 2>/dev/null",output_file_name_258));
        if(        info->verbose) {
            puts(command2_282);
        }
        (void)system(command2_282);
        (cmd2_279 = come_decrement_ref_count(cmd2_279, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        (command2_282 = come_decrement_ref_count(command2_282, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    }
    else if(    is_emb_267) {
        cmd3_283=(char*)come_increment_ref_count(xsprintf("cpp %s -lang-c %s -I. -I%s/include -DPREFIX=\"\\\"%s\\\"\" -I%s/include -D__EMB__ %s %s > %s 2> %s.cpp.out",(((info->remove_comment)?(""):(" -C"))),info->cpp_option,getenv("HOME"),"/usr/local/","/usr/local/",((exist_common_h_259)?(((char*)(__right_value213=__builtin_string(" -include common.h ")))):("")),input_file_name_257,output_file_name_258,output_file_name_258));
        ...
        command2_285=(char*)come_increment_ref_count(xsprintf("grep error\\: %s.cpp.out 2>/dev/null",output_file_name_258));
        if(        info->verbose) {
            puts(command2_285);
        }
        (void)system(command2_285);
        if(        rc_284!=0) {
            cmd4_286=(char*)come_increment_ref_count(xsprintf("cpp %s -I. %s -DPREFIX=%s -I%s/include -D__EMB__ %s %s > %s 2> %s.cpp.out",((info->remove_comment)?(""):(" -C")),info->cpp_option,"/usr/local/","/usr/local/",((exist_common_h_259)?(((char*)(__right_value216=__builtin_string(" -include common.h ")))):("")),input_file_name_257,output_file_name_258,output_file_name_258));
            (__right_value216 = come_decrement_ref_count(__right_value216, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
            if(            is_debian_263) {
                __dec_obj20=cmd4_286,
                cmd4_286=(char*)come_increment_ref_count(xsprintf("cpp %s -D__DEBIAN__ -I. %s -DPREFIX=%s -I%s/include -D__EMB__ %s %s > %s 2> %s.cpp.out",((info->remove_comment)?(""):(" -C")),info->cpp_option,"/usr/local/","/usr/local/",((exist_common_h_259)?(((char*)(__right_value218=__builtin_string(" -include common.h ")))):("")),input_file_name_257,output_file_name_258,output_file_name_258));
            ...
            command2_287=(char*)come_increment_ref_count(xsprintf("grep error\\: %s.cpp.out 2>/dev/null",output_file_name_258));
            if(            info->verbose) {
                puts(command2_287);
            }
    ...
    else if(    is_linux_264) {
        cmd3_288=(char*)come_increment_ref_count(xsprintf("cpp %s -lang-c %s -I. -I%s/include -DPREFIX=\"\\\"%s\\\"\" -I%s/include -D__LINUX__ %s %s > %s 2> %s.cpp.out",(((info->remove_comment)?(""):(" -C"))),info->cpp_option,getenv("HOME"),"/usr/local/","/usr/local/",((exist_common_h_259)?(((char*)(__right_value221=__builtin_string(" -include common.h ")))):("")),input_file_name_257,output_file_name_258,output_file_name_258));
        (__right_value221 = come_decrement_ref_count(__right_value221, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        if(        is_debian_263) {
            __dec_obj21=cmd3_288,
            cmd3_288=(char*)come_increment_ref_count(xsprintf("cpp %s -lang-c %s -I. -D__DEBIAN__ -I%s/include -DPREFIX=\"\\\"%s\\\"\" -I%s/include -D__LINUX__ %s %s > %s 2> %s.cpp.out",((info->remove_comment)?(""):(" -C")),info->cpp_option,getenv("HOME"),"/usr/local/","/usr/local/",((exist_common_h_259)?(((char*)(__right_value223=__builtin_string(" -include common.h ")))):("")),input_file_name_257,output_file_name_258,output_file_name_258));
        ...
        command2_290=(char*)come_increment_ref_count(xsprintf("grep error\\: %s.cpp.out 2>/dev/null",output_file_name_258));
        if(        info->verbose) {
            puts(command2_290);
        }
        (void)system(command2_290);
        if(        rc_289!=0) {
            cmd4_291=(char*)come_increment_ref_count(xsprintf("cpp %s -I. %s -DPREFIX=%s -I%s/include -D__LINUX__ %s %s > %s 2> %s.cpp.out",((info->remove_comment)?(""):(" -C")),info->cpp_option,"/usr/local/","/usr/local/",((exist_common_h_259)?(((char*)(__right_value226=__builtin_string(" -include common.h ")))):("")),input_file_name_257,output_file_name_258,output_file_name_258));
            (__right_value226 = come_decrement_ref_count(__right_value226, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
            if(            is_debian_263) {
                __dec_obj22=cmd4_291,
                cmd4_291=(char*)come_increment_ref_count(xsprintf("cpp %s -D__DEBIAN__ -I. %s -DPREFIX=%s -I%s/include -D__LINUX__ %s %s > %s 2> %s.cpp.out",((info->remove_comment)?(""):(" -C")),info->cpp_option,"/usr/local/","/usr/local/",((exist_common_h_259)?(((char*)(__right_value228=__builtin_string(" -include common.h ")))):("")),input_file_name_257,output_file_name_258,output_file_name_258));
            ...
            command2_292=(char*)come_increment_ref_count(xsprintf("grep error\\: %s.cpp.out 2>/dev/null",output_file_name_258));
            if(            info->verbose) {
                puts(command2_292);
            }
            ...
            (cmd4_291 = come_decrement_ref_count(cmd4_291, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
            (command2_292 = come_decrement_ref_count(command2_292, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        }
        (cmd3_288 = come_decrement_ref_count(cmd3_288, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    ...
    (input_file_name_257 = come_decrement_ref_count(input_file_name_257, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    (output_file_name_258 = come_decrement_ref_count(output_file_name_258, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    return __result_obj__168;
}

static _Bool compile(struct sInfo* info, _Bool output_object_file, struct list$1char$ph* object_files){
void* __right_value231 = (void*)0;
char* input_file_name_293;
...
output_file_name_294 = (void*)0;
    input_file_name_293=(char*)come_increment_ref_count(string_operator_add(info->sname,".c"));
    if(    info->output_file_name&&output_object_file) {
        __dec_obj23=output_file_name_294,
        output_file_name_294=(char*)come_increment_ref_count(__builtin_string(info->output_file_name));
        __dec_obj23 = come_decrement_ref_count(__dec_obj23, (void*)0, (void*)0, 0/* no_decrement */,0/* no_free */,0/*force_delete*/, (void*)0);
    }
    else {
        __dec_obj24=output_file_name_294,
        output_file_name_294=(char*)come_increment_ref_count(string_operator_add(info->sname,".o"));
        __dec_obj24 = come_decrement_ref_count(__dec_obj24, (void*)0, (void*)0, 0/* no_decrement */,0/* no_free */,0/*force_delete*/, (void*)0);
    }
    command_295=(char*)come_increment_ref_count(xsprintf("%s -o %s -c %s %s >> %s.out 2>&1",CC,output_file_name_294,input_file_name_293,info->clang_option,input_file_name_293));
    if(    info->verbose) {
        puts(command_295);
    }
    rc_296=system(command_295);
    if(    rc_296!=0) {
        __dec_obj25=command_295,
        command_295=(char*)come_increment_ref_count(xsprintf("%s -o %s -c %s %s >> %s.out 2>&1","gcc",output_file_name_294,input_file_name_293,info->clang_option,input_file_name_293));
        __dec_obj25 = come_decrement_ref_count(__dec_obj25, (void*)0, (void*)0, 0/* no_decrement */,0/* no_free */,0/*force_delete*/, (void*)0);
        if(        info->verbose) {
            puts(command_295);
        }
        rc_297=system(command_295);
        if(        rc_297!=0) {
            printf("%s is faild\n",CC);
            command2_298=(char*)come_increment_ref_count(xsprintf("grep error\\: %s.out 2>/dev/null",input_file_name_293));
            if(            info->verbose) {
                puts(command2_298);
            }
    ...
    if(    !output_object_file) {
        list$1char$ph_insert(object_files,0,(char*)come_increment_ref_count(__builtin_string(output_file_name_294)));
    }
    __result_obj__171 = (_Bool)1;
    (input_file_name_293 = come_decrement_ref_count(input_file_name_293, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    (output_file_name_294 = come_decrement_ref_count(output_file_name_294, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    (command_295 = come_decrement_ref_count(command_295, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
...
struct list_item$1char$ph* litem_303;
char* __dec_obj27;
...
default_value_301 = (void*)0;
    ...
    if(    self->len==0||position>=self->len) {
        len_299=self->len;
        for(        i_300=0;        i_300<position-len_299;        i_300++        ){
            memset(&default_value_301,0,sizeof(char*));
            list$1char$ph_push_back(self,(char*)come_increment_ref_count(default_value_301));
            (default_value_301 = come_decrement_ref_count(default_value_301, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        }
    ...
    if(    position==0) {
        litem_302=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value237=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "./comelang.h", 1387, "struct list_item$1char$ph*"))));
        litem_302->prev=((void*)0);
        litem_302->next=self->head;
        __dec_obj26=litem_302->item,
        ...
        self->head->prev=litem_302;
        self->head=litem_302;
        self->len++;
    }
    else if(    self->len==1) {
        litem_303=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value238=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "./comelang.h", 1399, "struct list_item$1char$ph*"))));
        litem_303->prev=self->head;
        litem_303->next=self->tail;
        __dec_obj27=litem_303->item,
        litem_303->item=(char*)come_increment_ref_count(item);
        __dec_obj27 = come_decrement_ref_count(__dec_obj27, (void*)0, (void*)0, 0/* no_decrement */,0/* no_free */,0/*force_delete*/, (void*)0);
        self->tail->prev=litem_303;
        ...
        while(it_304!=((void*)0)) {
            if(            position==i_305) {
                litem_306=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value239=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "./comelang.h", 1415, "struct list_item$1char$ph*"))));
                litem_306->prev=it_304->prev;
                litem_306->next=it_304;
                __dec_obj28=litem_306->item,
                litem_306->item=(char*)come_increment_ref_count(item);
                __dec_obj28 = come_decrement_ref_count(__dec_obj28, (void*)0, (void*)0, 0/* no_decrement */,0/* no_free */,0/*force_delete*/, (void*)0);
                it_304->prev->next=litem_306;
                it_304->prev=litem_306;
                self->len++;
            }
            it_304=it_304->next;
            i_305++;
...
struct buffer* command_308;
void* __right_value245 = (void*)0;
void* __right_value246 = (void*)0;
struct list$1char$ph* o2_saved_309;
char* it_312;
int is_mac_315;
...
_Bool __result_obj__179;
    ...
    if(    info->output_file_name) {
        __dec_obj29=output_file_name_307,
        output_file_name_307=(char*)come_increment_ref_count(__builtin_string(info->output_file_name));
        __dec_obj29 = come_decrement_ref_count(__dec_obj29, (void*)0, (void*)0, 0/* no_decrement */,0/* no_free */,0/*force_delete*/, (void*)0);
    }
    else {
        __dec_obj30=output_file_name_307,
        output_file_name_307=(char*)come_increment_ref_count(xnoextname(info->sname));
        __dec_obj30 = come_decrement_ref_count(__dec_obj30, (void*)0, (void*)0, 0/* no_decrement */,0/* no_free */,0/*force_delete*/, (void*)0);
    }
    command_308=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "02transpile.c", 319, "struct buffer*"))));
    buffer_append_format(command_308,"%s -o %s ",CC,output_file_name_307);
    buffer_append_str(command_308,((char*)(__right_value246=string_operator_add(((char*)(__right_value245=charp_operator_add(" ",info->linker_option)))," "))));
    ...
    for(    o2_saved_309=(object_files),it_312=list$1char$ph_begin((o2_saved_309));    !list$1char$ph_end((o2_saved_309));    it_312=list$1char$ph_next((o2_saved_309))    ){
        buffer_append_format(command_308,"%s ",it_312);
    }
    is_mac_315=system("uname -a | grep Darwin 1> /dev/null 2>/dev/null")==0;
    if(    is_mac_315) {
        buffer_append_str(command_308," -L/opt/homebrew/opt/pcre/lib -L/opt/homebrew/opt/openssl/lib -L/opt/homebrew/opt/boehmgc/lib -L/opt/homebrew/opt/mysql/lib -L/opt/homebrew/opt/zstd/lib ");
    }
    cmd_316=(char*)come_increment_ref_count(xsprintf("ls /usr/local/lib 1> /dev/null 2>/dev/null"));
    rc_317=system(cmd_316);
    if(    rc_317==0) {
        buffer_append_str(command_308," -L. -L/usr/local/lib ");
    }
    (cmd_316 = come_decrement_ref_count(cmd_316, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    cmd_318=(char*)come_increment_ref_count(xsprintf("ls %s/lib 1> /dev/null 2>/dev/null",getenv("HOME")));
    rc_319=system(cmd_318);
    if(    rc_319==0) {
        buffer_append_format(command_308," -L%s/lib ",getenv("HOME"));
    }
    (cmd_318 = come_decrement_ref_count(cmd_318, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    cmd_320=(char*)come_increment_ref_count(xsprintf("ls %s/lib 1> /dev/null 2>/dev/null","/usr/local/"));
    rc_321=system(cmd_320);
    if(    rc_321==0) {
        buffer_append_format(command_308," -L%s/lib ","/usr/local/");
    }
    buffer_append_format(command_308," %s ",info->clang_option);
    if(    gComeStr) {
        buffer_append_format(command_308," -lpcre ");
    }
    if(    gComeGC) {
        buffer_append_str(command_308," -lgc ");
    }
    if(    gComePthread) {
        buffer_append_str(command_308," -lpthread ");
    }
    if(    gComeNet) {
        is_apline_322=system("which apk 1> /dev/null 2>/dev/null")==0;
        is_debian_323=system("uname -a | grep Debian 1> /dev/null 2>/dev/null")==0;
        is_android_324=system("uname -a | grep Android 1>/dev/null 2>/dev/null")==0;
        if(        is_android_324) {
            buffer_append_str(command_308," -lssl -I/data/data/com.termux/files/usr/include/mariadb -lmariadb");
        }
        else if(        is_apline_322||is_debian_323) {
            buffer_append_str(command_308," -lssl -I/usr/include/mariadb -L/usr/lib -lmariadb");
        }
        else if(        is_mac_315) {
            buffer_append_format(command_308," -lssl `mysql_config --cflags --libs`");
        }
        else {
            buffer_append_str(command_308," -lssl `mysql_config --cflags --libs`");
        }
    }
    if(    info->verbose) {
        puts(((char*)(__right_value250=buffer_to_string(command_308))));
        (__right_value250 = come_decrement_ref_count(__right_value250, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    }
    Value_325=system(((char*)(__right_value251=buffer_to_string(command_308))));
    if(    (_if_conditional1=(Value_325)),    (__right_value251 = come_decrement_ref_count(__right_value251, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0)),
    _if_conditional1) {
        str_326=(char*)come_increment_ref_count(charp_operator_add(((char*)(__right_value252=xsprintf("gcc"))),((char*)(__right_value254=charp_substring(((char*)(__right_value253=buffer_to_string(command_308))),strlen(CC),-1)))));
        ...
        Value_327=system(str_326);
        if(        Value_327) {
            printf("%s is failed\n",CC);
            __result_obj__178 = (_Bool)0;
            (str_326 = come_decrement_ref_count(str_326, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
            (output_file_name_307 = come_decrement_ref_count(output_file_name_307, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
            /*c*/ come_call_finalizer3(command_308,buffer_finalize, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
            (cmd_320 = come_decrement_ref_count(cmd_320, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
...
result_314 = (void*)0;
    ...
    __result_obj__177 = result_314;
    return __result_obj__177;
}

_Bool new_project(int argc, char** argv){
void* __right_value256 = (void*)0;
char* project_name_328;
void* __right_value257 = (void*)0;
void* __right_value258 = (void*)0;
void* __right_value259 = (void*)0;
char* project_name_debug_329;
...
_Bool __result_obj__180;
    project_name_328=(char*)come_increment_ref_count(__builtin_string(argv[2]));
    project_name_debug_329=(char*)come_increment_ref_count(string_operator_add(((char*)(__right_value257=__builtin_string(argv[2]))),((char*)(__right_value258=__builtin_string("-debug")))));
    ...
    cc_330=(char*)come_increment_ref_count(__builtin_string("comelang"));
    install_331=(char*)come_increment_ref_count(__builtin_string("install"));
    libs_332=(char*)come_increment_ref_count(__builtin_string("-lpcre"));
    os_333=(char*)come_increment_ref_count(__builtin_string("linux"));
    prefix_334=(char*)come_increment_ref_count(__builtin_string("/usr/local/"));
    cflags_335=(char*)come_increment_ref_count(__builtin_string(" -common-header -O2 "));
    cflags_debug_336=(char*)come_increment_ref_count(__builtin_string(" -common-header -gdwarf-4 -cg "));
    Value_337=system(((char*)(__right_value268=xsprintf("mkdir \%s",((char*)(__right_value267=string_to_string(project_name_328)))))));
    if(    (_if_conditional2=(Value_337<0)),    (__right_value267 = come_decrement_ref_count(__right_value267, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0)),
    ...
    charp_write(((char*)(__right_value294=xsprintf("\#########################################\n\# istalled directories\n\#########################################\nexec_prefix=${prefix}\nbindir=${exec_prefix}/bin\ndatadir=${datarootdir}\nmandir=${datarootdir}/man\nsharedstatedir=${prefix}/\%s\nsysconfdir=${prefix}/etc/\%s\nincludedir=${prefix}/include/\%s\ndatarootdir=${prefix}/share/\%s\ndocdir=${datarootdir}/doc\nlibdir=${exec_prefix}/lib\n\n\#########################################\n\# environmnet variables\n\#########################################\nCC=\%s\nINSTALL=\%s\nCFLAGS=\%s\nCFLAGS_DEBUG=\%s\nLIBS=\%s\nOS=\%s\nDESTDIR=\%s\nSRCS=$(wildcard *.c)\nSINGLE_SRCS=$(filter-out %%.c.c, $(SRCS))\nOBJS=$(SINGLE_SRCS:.c=.o)\nDEBUG_OBJS=$(SINGLE_SRCS:.c=.debug.o)\nTARGET=\%s\nTARGET_DEBUG=\%s\n\n\#########################################\n\# main\n\#########################################\nall: $(TARGET)\n\n$(TARGET): $(OBJS)\n\t$(CC) $(CFLAGS) $^ -o $@\n\n$(TARGET_DEBUG): $(DEBUG_OBJS)\n\t$(CC) $(CFLAGS_DEBUG) $^ -o $@\n\n%%.o: %%.c\n\t$(CC) $(CFLAGS) -c $< -o $@\n\n%%.debug.o: %%.c\n\t$(CC) $(CFLAGS_DEBUG) -c $< -o $@\n\n\#########################################\n\# header\n\#########################################\n\nheader: common.h\n\ncommon.h: $(SINGLE_SRCS)\n\tcomelang header -common-header $(SINGLE_SRCS)\n\n\#########################################\n\# install\n\#########################################\ninstall:\n\tmkdir -p \"$(DESTDIR)/bin\"\n\t$(INSTALL) -m 755 ./\%s \"$(DESTDIR)/bin\"\n\tmkdir -p \"$(DESTDIR)/include\"\n\tmkdir -p \"$(DESTDIR)/lib\"\n\tmkdir -p \"$(DESTDIR)/share/doc/\%s\"\n\t$(INSTALL) -m 644 README.md \"$(DESTDIR)/share/doc/\%s/README.md\"\n\n\#########################################\n\# clean\n\#########################################\nclean:\n\trm -fR *.o *.c.i *.c.out *.c.c \%s *.log *.out common.h \%s tmp-common-header.c\n\n\#########################################\n\# uninstall\n\#########################################\nuninstall:\n\trm -f \"$(DESTDIR)\"/bin/\%s\n\trm -f \"$(DESTDIR)/share/doc/\%s/README.md\"\n\nrun: \%s\n\trm -f *.log\n\t./\%s\n\ncompile: \%s\n\ndebug: \%s\n\trm -f *.log\n\t./\%s\n",((char*)(__right_value269=string_to_string(project_name_328))),((char*)(__right_value270=string_to_string(project_name_328))),((char*)(__right_value271=string_to_string(project_name_328))),((char*)(__right_value272=string_to_string(project_name_328))),((char*)(__right_value273=string_to_string(cc_330))),((char*)(__right_value274=string_to_string(install_331))),((char*)(__right_value275=string_to_string(cflags_335))),((char*)(__right_value276=string_to_string(cflags_debug_336))),((char*)(__right_value277=string_to_string(libs_332))),((char*)(__right_value278=string_to_string(os_333))),((char*)(__right_value279=string_to_string(prefix_334))),((char*)(__right_value280=string_to_string(project_name_328))),((char*)(__right_value281=string_to_string(project_name_debug_329))),((char*)(__right_value282=string_to_string(project_name_328))),((char*)(__right_value283=string_to_string(project_name_328))),((char*)(__right_value284=string_to_string(project_name_328))),((char*)(__right_value285=string_to_string(project_name_328))),((char*)(__right_value286=string_to_string(project_name_debug_329))),((char*)(__right_value287=string_to_string(project_name_328))),((char*)(__right_value288=string_to_string(project_name_328))),((char*)(__right_value289=string_to_string(project_name_328))),((char*)(__right_value290=string_to_string(project_name_328))),((char*)(__right_value291=string_to_string(project_name_328))),((char*)(__right_value292=string_to_string(project_name_debug_329))),((char*)(__right_value293=string_to_string(project_name_debug_329)))))),((char*)(__right_value296=xsprintf("\%s/Makefile",((char*)(__right_value295=string_to_string(project_name_328)))))),(_Bool)0);
    ...
    (project_name_328 = come_decrement_ref_count(project_name_328, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    (project_name_debug_329 = come_decrement_ref_count(project_name_debug_329, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    (cc_330 = come_decrement_ref_count(cc_330, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    (install_331 = come_decrement_ref_count(install_331, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    (libs_332 = come_decrement_ref_count(libs_332, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    (os_333 = come_decrement_ref_count(os_333, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    (prefix_334 = come_decrement_ref_count(prefix_334, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    (cflags_335 = come_decrement_ref_count(cflags_335, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
    (cflags_debug_336 = come_decrement_ref_count(cflags_debug_336, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
...
_Bool __exception_result_var_b10;
    Value_349=system(((char*)(__right_value298=xsprintf("make install DESTDIR=\%s",((char*)(__right_value297=charp_to_string(prefix)))))));
    if(    (_if_conditional3=(Value_349<0)),    (__right_value297 = come_decrement_ref_count(__right_value297, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0)),
...
void* __right_value454 = (void*)0;
    ...
    for(    i_395=0;    i_395<7;    i_395++    ){
        ...
        map$2char$phsClass$ph_insert(info->classes,(char*)come_increment_ref_count(generics_type_396),(struct sClass*)come_increment_ref_count(sClass_initialize((struct sClass*)come_increment_ref_count((struct sClass*)come_calloc(1, sizeof(struct sClass)*(1), "02transpile.c", 608, "struct sClass*")),(char*)come_increment_ref_count(generics_type_396),(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0,(_Bool)0,-1,i_395,(_Bool)0,info)));
    ...
    if(    is_mac_397) {
        ...
        type_399=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "02transpile.c", 617, "struct sType*")),(char*)come_increment_ref_count(xsprintf("__builtin_va_list")),(_Bool)0,info));
        __dec_obj31=type_399->mOriginalTypeName,
...
default_value_372 = (void*)0;
    ...
    keys_351=(char**)come_increment_ref_count(((char**)(__right_value299=(char**)come_calloc(1, sizeof(char*)*(1*(size_350)), "./comelang.h", 2281, "char**"))));
    items_352=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value300=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_350)), "./comelang.h", 2282, "struct sClass**"))));
    item_existance_353=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value301=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_350)), "./comelang.h", 2283, "_Bool*"))));
    len_354=0;
    for(    it_357=map$2char$phsClass$ph_begin(self);    !map$2char$phsClass$ph_end(self);    it_357=map$2char$phsClass$ph_next(self)    ){
        ...
        it2_361=((struct sClass*)(__right_value302=map$2char$phsClass$ph_at(self,it_357,(struct sClass*)come_increment_ref_count(default_value_360))));
        ...
        while((_Bool)1) {
            if(            item_existance_353[n_371]) {
                ...
                items_352[n_371]=((struct sClass*)(__right_value303=map$2char$phsClass$ph_at(self,it_357,(struct sClass*)come_increment_ref_count(default_value_372))));
    ...
    while((_Bool)1) {
        if(        self->item_existance[it_363]) {
            if(            string_equals(self->keys[it_363],key)) {
                __result_obj__187 = come_increment_ref_count(self->items[it_363]);
...
default_value_416 = (void*)0;
    ...
    keys_401=(char**)come_increment_ref_count(((char**)(__right_value371=(char**)come_calloc(1, sizeof(char*)*(1*(size_400)), "./comelang.h", 2281, "char**"))));
    items_402=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value372=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_400)), "./comelang.h", 2282, "struct sType**"))));
    item_existance_403=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value373=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_400)), "./comelang.h", 2283, "_Bool*"))));
    len_404=0;
    for(    it_407=map$2char$phsType$ph_begin(self);    !map$2char$phsType$ph_end(self);    it_407=map$2char$phsType$ph_next(self)    ){
        ...
        it2_411=((struct sType*)(__right_value374=map$2char$phsType$ph_at(self,it_407,(struct sType*)come_increment_ref_count(default_value_410))));
        ...
        while((_Bool)1) {
            if(            item_existance_403[n_415]) {
                ...
                items_402[n_415]=((struct sType*)(__right_value375=map$2char$phsType$ph_at(self,it_407,(struct sType*)come_increment_ref_count(default_value_416))));
    ...
    while((_Bool)1) {
        if(        self->item_existance[it_413]) {
            if(            string_equals(self->keys[it_413],key)) {
                __result_obj__202 = come_increment_ref_count(self->items[it_413]);
...
struct tuple2$2char$phsType$ph* __result_obj__224;
    ...
    result_425=(struct tuple2$2char$phsType$ph*)come_increment_ref_count((struct tuple2$2char$phsType$ph*)come_calloc(1, sizeof(struct tuple2$2char$phsType$ph)*(1), "tuple2$2char$phsType$ph_clone", 3, "struct tuple2$2char$phsType$ph*"));
    if(    self!=((void*)0)&&self->v1!=((void*)0)) {
        __dec_obj35=result_425->v1,
    ...
    __result_obj__224 = come_increment_ref_count(result_425);
    /*c*/ come_call_finalizer3(result_425,tuple2$2char$phsType$ph_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 0/* force_delete */ , (void*)0);
...
struct sType* __result_obj__223;
    ...
    result_426=(struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "sType_clone", 3, "struct sType*"));
    if(    self!=((void*)0)) {
        result_426->mClass=self->mClass;
    }
    if(    self!=((void*)0)&&self->mOriginalLoadVarType!=((void*)0)) {
        __dec_obj36=result_426->mOriginalLoadVarType,
        result_426->mOriginalLoadVarType=(struct sType*)come_increment_ref_count(come_call_cloner(sType_clone, self->mOriginalLoadVarType));
        /*b*/ come_call_finalizer3(__dec_obj36,sType_finalize, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, 0/* force_delete_ */, (void*)0);
    }
    if(    self!=((void*)0)&&self->mChannelType!=((void*)0)) {
        __dec_obj37=result_426->mChannelType,
        result_426->mChannelType=(struct sType*)come_increment_ref_count(come_call_cloner(sType_clone, self->mChannelType));
        /*b*/ come_call_finalizer3(__dec_obj37,sType_finalize, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, 0/* force_delete_ */, (void*)0);
    }
    if(    self!=((void*)0)&&self->mGenericsTypes!=((void*)0)) {
        __dec_obj41=result_426->mGenericsTypes,
        result_426->mGenericsTypes=(struct list$1sType$ph*)come_increment_ref_count(come_call_cloner(list$1sType$ph$p_clone, self->mGenericsTypes));
    ...
    if(    self!=((void*)0)&&self->mNoSolvedGenericsType!=((void*)0)) {
        __dec_obj42=result_426->mNoSolvedGenericsType,
        result_426->mNoSolvedGenericsType=(struct sType*)come_increment_ref_count(come_call_cloner(sType_clone, self->mNoSolvedGenericsType));
    ...
    if(    self!=((void*)0)&&self->mAnyOriginalType!=((void*)0)) {
        __dec_obj43=result_426->mAnyOriginalType,
        result_426->mAnyOriginalType=(struct sType*)come_increment_ref_count(come_call_cloner(sType_clone, self->mAnyOriginalType));
        /*b*/ come_call_finalizer3(__dec_obj43,sType_finalize, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, 0/* force_delete_ */, (void*)0);
    }
    if(    self!=((void*)0)&&self->mSizeNum!=((void*)0)) {
        __dec_obj44=result_426->mSizeNum,
        result_426->mSizeNum=(struct sNode*)come_increment_ref_count(come_call_cloner(sNode_clone, self->mSizeNum));
    ...
    if(    self!=((void*)0)&&self->mAlignas!=((void*)0)) {
        __dec_obj45=result_426->mAlignas,
        result_426->mAlignas=(struct sNode*)come_increment_ref_count(come_call_cloner(sNode_clone, self->mAlignas));
    ...
    if(    self!=((void*)0)&&self->mTupleName!=((void*)0)) {
        __dec_obj46=result_426->mTupleName,
    ...
    if(    self!=((void*)0)&&self->mAttribute!=((void*)0)) {
        __dec_obj47=result_426->mAttribute,
    ...
    if(    self!=((void*)0)&&self->mAsmName!=((void*)0)) {
        __dec_obj48=result_426->mAsmName,
        result_426->mAsmName=(char*)come_increment_ref_count((char*)come_memdup(self->mAsmName, "sType_clone", 38, "char*"));
    ...
    if(    self!=((void*)0)&&self->mArrayNum!=((void*)0)) {
        __dec_obj52=result_426->mArrayNum,
        result_426->mArrayNum=(struct list$1sNode$ph*)come_increment_ref_count(come_call_cloner(list$1sNode$ph$p_clone, self->mArrayNum));
    ...
    if(    self!=((void*)0)&&self->mOriginalTypeName!=((void*)0)) {
        __dec_obj53=result_426->mOriginalTypeName,
        result_426->mOriginalTypeName=(char*)come_increment_ref_count((char*)come_memdup(self->mOriginalTypeName, "sType_clone", 48, "char*"));
    ...
    if(    self!=((void*)0)&&self->mParamTypes!=((void*)0)) {
        __dec_obj54=result_426->mParamTypes,
        result_426->mParamTypes=(struct list$1sType$ph*)come_increment_ref_count(come_call_cloner(list$1sType$ph$p_clone, self->mParamTypes));
    ...
    if(    self!=((void*)0)&&self->mParamNames!=((void*)0)) {
        __dec_obj58=result_426->mParamNames,
        result_426->mParamNames=(struct list$1char$ph*)come_increment_ref_count(come_call_cloner(list$1char$ph$p_clone, self->mParamNames));
        /*b*/ come_call_finalizer3(__dec_obj58,list$1char$ph_finalize, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, 0/* force_delete_ */, (void*)0);
    }
    if(    self!=((void*)0)&&self->mResultType!=((void*)0)) {
        __dec_obj59=result_426->mResultType,
        result_426->mResultType=(struct sType*)come_increment_ref_count(come_call_cloner(sType_clone, self->mResultType));
    ...
    __result_obj__223 = come_increment_ref_count(result_426);
    /*c*/ come_call_finalizer3(result_426,sType_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 0/* force_delete */ , (void*)0);
...
struct list$1sType$ph* __result_obj__213;
    ...
    result_427=(struct list$1sType$ph*)come_increment_ref_count(list$1sType$ph_initialize((struct list$1sType$ph*)come_increment_ref_count((struct list$1sType$ph*)come_calloc(1, sizeof(struct list$1sType$ph)*(1), "./comelang.h", 1138, "struct list$1sType$ph*"))));
    it_428=self->head;
    while(it_428!=((void*)0)) {
        if(        1) {
            list$1sType$ph_add(result_427,(struct sType*)come_increment_ref_count(come_call_cloner(sType_clone, it_428->item)));
        }
        else {
            list$1sType$ph_add(result_427,(struct sType*)come_increment_ref_count(come_call_cloner(sType_clone, it_428->item)));
        }
    ...
    __result_obj__213 = come_increment_ref_count(result_427);
    /*c*/ come_call_finalizer3(result_427,list$1sType$ph$p_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 0/* force_delete */ , (void*)0);
...
struct list$1sType$ph* __result_obj__212;
    if(    self->len==0) {
        litem_429=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value394=(struct list_item$1sType$ph*)come_calloc(1, sizeof(struct list_item$1sType$ph)*(1), "./comelang.h", 1157, "struct list_item$1sType$ph*"))));
        litem_429->prev=((void*)0);
        litem_429->next=((void*)0);
        __dec_obj38=litem_429->item,
        ...
        litem_430=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value395=(struct list_item$1sType$ph*)come_calloc(1, sizeof(struct list_item$1sType$ph)*(1), "./comelang.h", 1167, "struct list_item$1sType$ph*"))));
        litem_430->prev=self->head;
        litem_430->next=((void*)0);
        __dec_obj39=litem_430->item,
        ...
        litem_431=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value396=(struct list_item$1sType$ph*)come_calloc(1, sizeof(struct list_item$1sType$ph)*(1), "./comelang.h", 1177, "struct list_item$1sType$ph*"))));
        litem_431->prev=self->tail;
        litem_431->next=((void*)0);
        __dec_obj40=litem_431->item,
...
struct sNode* __result_obj__215;
    ...
    result_434=(struct sNode*)come_increment_ref_count((struct sNode*)come_calloc(1, sizeof(struct sNode)*(1), "sNode_clone", 3, "struct sNode*"));
    ...
    __result_obj__215 = come_increment_ref_count(result_434);
    ((result_434) ? result_434 = come_decrement_ref_count(result_434, ((struct sNode*)result_434)->finalize, ((struct sNode*)result_434)->_protocol_obj, 0/* no_decrement */, 1/*no_free*/,0/*force_delete*/, (void*)0):(void*)0);
...
struct list$1sNode$ph* __result_obj__219;
    ...
    result_435=(struct list$1sNode$ph*)come_increment_ref_count(list$1sNode$ph_initialize((struct list$1sNode$ph*)come_increment_ref_count((struct list$1sNode$ph*)come_calloc(1, sizeof(struct list$1sNode$ph)*(1), "./comelang.h", 1138, "struct list$1sNode$ph*"))));
    it_436=self->head;
    while(it_436!=((void*)0)) {
        if(        1) {
            list$1sNode$ph_add(result_435,(struct sNode*)come_increment_ref_count(come_call_cloner(sNode_clone, it_436->item)));
        }
        else {
            list$1sNode$ph_add(result_435,(struct sNode*)come_increment_ref_count(come_call_cloner(sNode_clone, it_436->item)));
        }
    ...
    __result_obj__219 = come_increment_ref_count(result_435);
    /*c*/ come_call_finalizer3(result_435,list$1sNode$ph$p_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 0/* force_delete */ , (void*)0);
...
struct list$1sNode$ph* __result_obj__218;
    if(    self->len==0) {
        litem_437=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value410=(struct list_item$1sNode$ph*)come_calloc(1, sizeof(struct list_item$1sNode$ph)*(1), "./comelang.h", 1157, "struct list_item$1sNode$ph*"))));
        ...
        litem_438=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value411=(struct list_item$1sNode$ph*)come_calloc(1, sizeof(struct list_item$1sNode$ph)*(1), "./comelang.h", 1167, "struct list_item$1sNode$ph*"))));
        ...
        litem_439=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value412=(struct list_item$1sNode$ph*)come_calloc(1, sizeof(struct list_item$1sNode$ph)*(1), "./comelang.h", 1177, "struct list_item$1sNode$ph*"))));
...
struct list$1char$ph* __result_obj__222;
    ...
    result_442=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), "./comelang.h", 1138, "struct list$1char$ph*"))));
    it_443=self->head;
    while(it_443!=((void*)0)) {
        if(        1) {
            list$1char$ph_add(result_442,(char*)come_increment_ref_count((char*)come_memdup(it_443->item, "./comelang.h", 1143, "char*")));
        }
        else {
            list$1char$ph_add(result_442,(char*)come_increment_ref_count((char*)come_memdup(it_443->item, "./comelang.h", 1146, "char*")));
        }
        it_443=it_443->next;
    }
    __result_obj__222 = come_increment_ref_count(result_442);
    /*c*/ come_call_finalizer3(result_442,list$1char$ph$p_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 0/* force_delete */ , (void*)0);
...
struct list$1char$ph* __result_obj__221;
    if(    self->len==0) {
        litem_444=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value420=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "./comelang.h", 1157, "struct list_item$1char$ph*"))));
        ...
        litem_445=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value421=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "./comelang.h", 1167, "struct list_item$1char$ph*"))));
        ...
        litem_446=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value422=(struct list_item$1char$ph*)come_calloc(1, sizeof(struct list_item$1char$ph)*(1), "./comelang.h", 1177, "struct list_item$1char$ph*"))));
        litem_446->prev=self->tail;
        litem_446->next=((void*)0);
        __dec_obj57=litem_446->item,
...
void* __right_value465 = (void*)0;
    if(    getenv("PICO_SDK_PATH")) {
        Value_458=(char*)come_increment_ref_count(charp_read((((char*)(__right_value455=charp_operator_add(getenv("PICO_SDK_PATH"),"/pico_sdk_version.cmake"))))));
        if(        (_if_conditional4=(Value_458)),        (__right_value455 = come_decrement_ref_count(__right_value455, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0)),
        _if_conditional4) {
            version_major_459=0;
            ...
            version_string_465=(char*)come_increment_ref_count(xsprintf("\%s.\%s.\%s",((char*)(__right_value457=int_to_string(version_major_459))),((char*)(__right_value458=int_to_string(version_miner_461))),((char*)(__right_value459=int_to_string(version_revision_463)))));
            ...
            if(            !Value_466) {
                charp_write(((char*)(__right_value465=xsprintf("\#ifndef _PICO_VERSION_H\n\#define _PICO_VERSION_H\n\n\#define PICO_SDK_VERSION_MAJOR \%s\n\#define PICO_SDK_VERSION_MINOR \%s\n\#define PICO_SDK_VERSION_REVISION \%s\n\#define PICO_SDK_VERSION_STRING \"\%s\"\n\n\#endif\n",((char*)(__right_value461=int_to_string(version_major_459))),((char*)(__right_value462=int_to_string(version_miner_461))),((char*)(__right_value463=int_to_string(version_revision_463))),((char*)(__right_value464=string_to_string(version_string_465)))))),"pico/version.h",(_Bool)0);
...
memset(&info_589, 0, sizeof(struct sInfo));
    if(    charp_operator_equals(argv[1],"header")&&argc>=3) {
        ...
        clang_option_469=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "02transpile.c", 698, "struct buffer*"))));
        linker_option_470=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "02transpile.c", 699, "struct buffer*"))));
        cpp_option_471=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "02transpile.c", 700, "struct buffer*"))));
        buffer_append_str(cpp_option_471,"-U__GNUC__");
        files_472=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), "02transpile.c", 702, "struct list$1char$ph*"))));
        object_files_473=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), "02transpile.c", 703, "struct list$1char$ph*"))));
        ...
        for(        i_486=start_num_467;        i_486<argc;        i_486++        ){
            ...
            if(            charp_operator_equals(argv[i_486],"-o")&&i_486+1<argc) {
                __dec_obj63=output_file_name_478,
                ...
                buffer_append_str(linker_option_470,((char*)(__right_value480=xsprintf("-e \%s",((char*)(__right_value479=charp_to_string(argv[i_486+1])))))));
                ...
                gComeGC=(_Bool)1;
                buffer_append_format(cpp_option_471,((char*)(__right_value481=xsprintf(" -DENABLE_GC "))));
                ...
                __dec_obj64=cpp_option_471,
                cpp_option_471=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "02transpile.c", 746, "struct buffer*"))));
                /*b*/ come_call_finalizer3(__dec_obj64,buffer_finalize, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, 0/* force_delete_ */, (void*)0);
                buffer_append_format(cpp_option_471,((char*)(__right_value486=xsprintf(" -I $PICO_SDK_PATH/src/common/pico_stdlib_headers/include/ -I$PICO_SDK_PATH/src/common/pico_base_headers/include/ -I \%s/src/rp2_common/hardware_sync/include \$(find \%s -type d -name include | sed 's/^/ -I/g') -I$PICO_SDK_PATH/src/boards/include -I$PICO_SDK_PATH/src/rp2040/pico_platform/include/ -I$PICO_SDK_PATH/src/rp2040/hardware_regs/include/ -I$PICO_SDK_PATH/src/rp2040/hardware_structs/include -I$PICO_SDK_PATH/src/rp2350/hardware_structs/include/ -I build/generated/pico_base/ -D__PICO__",((char*)(__right_value484=charp_to_string(env_488))),((char*)(__right_value485=charp_to_string(env_488)))))));
                ...
                __dec_obj65=cpp_option_471,
                cpp_option_471=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "02transpile.c", 763, "struct buffer*"))));
                /*b*/ come_call_finalizer3(__dec_obj65,buffer_finalize, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, 0/* force_delete_ */, (void*)0);
                buffer_append_format(cpp_option_471,((char*)(__right_value510=xsprintf(" -I\%s/.espressif/tools/xtensa-esp-elf/esp-14.2.0_20241119/xtensa-esp-elf/xtensa-esp-elf/include -I\%s/components/freertos/include -I\%s/components/esp32/include -I\%s/components/driver/include -I\%s/components/lwip/include -I\%s/components/freertos/FreeRTOS-Kernel/include -I\%s/components/freertos/config/include/freertos -I\%s/components/freertos/config/xtensa/include -I\%s/components/xtensa/include -I\%s/components/xtensa/esp32/include -I\%s/components/freertos/FreeRTOS-Kernel/portable/xtensa/include/freertos -I\%s/components/esp_hw_support/include -I\%s/components/soc/esp32/include/ -I\%s/components/esp_common/include/components $(find \%s/components -type d -name include | grep esp_ | sed 's/^/ -I/g') -I\%s/components/esp_common/include/ -I\%s/components/soc/esp32/register/soc/ -I\%s/components/soc/esp32/register -I\%s/components/heap/include -I\%s/components/hal/include -I\%s/components/newlib/platform_include -D__M5STACK__",((char*)(__right_value489=charp_to_string(getenv("HOME")))),((char*)(__right_value490=charp_to_string(env_489))),((char*)(__right_value491=charp_to_string(env_489))),((char*)(__right_value492=charp_to_string(env_489))),((char*)(__right_value493=charp_to_string(env_489))),((char*)(__right_value494=charp_to_string(env_489))),((char*)(__right_value495=charp_to_string(env_489))),((char*)(__right_value496=charp_to_string(env_489))),((char*)(__right_value497=charp_to_string(env_489))),((char*)(__right_value498=charp_to_string(env_489))),((char*)(__right_value499=charp_to_string(env_489))),((char*)(__right_value500=charp_to_string(env_489))),((char*)(__right_value501=charp_to_string(env_489))),((char*)(__right_value502=charp_to_string(env_489))),((char*)(__right_value503=charp_to_string(env_489))),((char*)(__right_value504=charp_to_string(env_489))),((char*)(__right_value505=charp_to_string(env_489))),((char*)(__right_value506=charp_to_string(env_489))),((char*)(__right_value507=charp_to_string(env_489))),((char*)(__right_value508=charp_to_string(env_489))),((char*)(__right_value509=charp_to_string(env_489)))))),"/usr/local/");
                ...
                buffer_append_str(clang_option_469,((char*)(__right_value512=xsprintf("-target \%s",((char*)(__right_value511=charp_to_string(argv[i_486+1])))))));
                ...
                buffer_append_str(clang_option_469,((char*)(__right_value514=xsprintf(" -T \%s ",((char*)(__right_value513=charp_to_string(argv[i_486+1])))))));
                ...
                buffer_append_str(cpp_option_471,((char*)(__right_value516=xsprintf("\%s ",((char*)(__right_value515=charp_to_string(argv[i_486])))))));
                ...
                buffer_append_str(cpp_option_471,((char*)(__right_value518=xsprintf("\%s ",((char*)(__right_value517=charp_to_string(argv[i_486])))))));
                ...
                buffer_append_str(cpp_option_471,((char*)(__right_value520=xsprintf("\%s ",((char*)(__right_value519=charp_to_string(argv[i_486])))))));
                ...
                buffer_append_str(cpp_option_471,((char*)(__right_value522=xsprintf("\%s ",((char*)(__right_value521=charp_to_string(argv[i_486])))))));
                ...
                buffer_append_str(cpp_option_471,((char*)(__right_value524=xsprintf("\%s ",((char*)(__right_value523=charp_to_string(argv[i_486])))))));
                ...
                buffer_append_str(cpp_option_471,((char*)(__right_value526=xsprintf("\%s ",((char*)(__right_value525=charp_to_string(argv[i_486])))))));
                ...
                buffer_append_str(cpp_option_471,((char*)(__right_value528=xsprintf("\%s ",((char*)(__right_value527=charp_to_string(argv[i_486])))))));
                ...
                buffer_append_str(cpp_option_471,((char*)(__right_value530=xsprintf("\%s ",((char*)(__right_value529=charp_to_string(argv[i_486])))))));
                ...
                buffer_append_str(cpp_option_471,((char*)(__right_value532=xsprintf("\%s ",((char*)(__right_value531=charp_to_string(argv[i_486])))))));
                ...
                buffer_append_str(clang_option_469,((char*)(__right_value534=xsprintf("-target \%s",((char*)(__right_value533=charp_to_string(argv[i_486+1])))))));
                ...
                buffer_append_str(cpp_option_471,((char*)(__right_value536=xsprintf("-iclude \%s",((char*)(__right_value535=charp_to_string(argv[i_486+1])))))));
                ...
                buffer_append_str(cpp_option_471,((char*)(__right_value538=xsprintf("-isystem \%s",((char*)(__right_value537=charp_to_string(argv[i_486+1])))))));
                ...
                buffer_append_str(clang_option_469,((char*)(__right_value540=xsprintf("-isystem \%s",((char*)(__right_value539=charp_to_string(argv[i_486+1])))))));
                ...
                buffer_append_str(clang_option_469,((char*)(__right_value542=xsprintf(" -T \%s ",((char*)(__right_value541=charp_to_string(argv[i_486+1])))))));
            ...
            else if(            (_elif_conditional1=(string_operator_equals(((char*)(__right_value543=charp_operator_load_range_element(argv[i_486],0,2))),"-O"))),            (__right_value543 = come_decrement_ref_count(__right_value543, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0)),
            _elif_conditional1) {
                buffer_append_str(clang_option_469,((char*)(__right_value545=xsprintf(" \%s ",((char*)(__right_value544=charp_to_string(argv[i_486])))))));
            ...
            else if(            (_elif_conditional2=(string_operator_equals(((char*)(__right_value546=charp_operator_load_range_element(argv[i_486],0,2))),"-D"))),            (__right_value546 = come_decrement_ref_count(__right_value546, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0)),
            _elif_conditional2) {
                ...
                buffer_append_str(clang_option_469,((char*)(__right_value550=xsprintf(" \%s ",((char*)(__right_value549=charp_to_string(argv[i_486])))))));
            ...
            else if(            (_elif_conditional3=(string_operator_equals(((char*)(__right_value551=charp_operator_load_range_element(argv[i_486],0,2))),"-U"))),            (__right_value551 = come_decrement_ref_count(__right_value551, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0)),
            _elif_conditional3) {
                buffer_append_str(cpp_option_471,((char*)(__right_value553=xsprintf(" \%s ",((char*)(__right_value552=charp_to_string(argv[i_486])))))));
                ...
                buffer_append_str(clang_option_469,((char*)(__right_value555=xsprintf(" \%s ",((char*)(__right_value554=charp_to_string(argv[i_486])))))));
                ...
                buffer_append_str(cpp_option_471,((char*)(__right_value557=string_operator_add(((char*)(__right_value556=charp_operator_add(" ",argv[i_486])))," "))));
                ...
                buffer_append_str(clang_option_469,((char*)(__right_value558=charp_operator_add(argv[i_486]," "))));
                ...
                buffer_append_str(clang_option_469,((char*)(__right_value562=charp_operator_add(argv[i_486]," "))));
        ...
        Value_490=system(((char*)(__right_value563=xsprintf("%s %s",RM,output_file_name_478))));
        if(        (_if_conditional5=(Value_490<0)),        (__right_value563 = come_decrement_ref_count(__right_value563, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0)),
        _if_conditional5) {
        ...
        Value_496=system(((char*)(__right_value571=xsprintf("cat \%s > \%s",((char*)(__right_value569=string_to_string(((char*)(__right_value568=list$1char$ph_join(files_472," ")))))),((char*)(__right_value570=string_to_string(tmp_file_492)))))));
        if(        (_if_conditional6=(Value_496<0)),        (__right_value568 = come_decrement_ref_count(__right_value568, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0)),
        ...
        __dec_obj72=info_497.funcs,
        info_497.funcs=(struct map$2char$phsFun$ph*)come_increment_ref_count(map$2char$phsFun$ph_initialize((struct map$2char$phsFun$ph*)come_increment_ref_count((struct map$2char$phsFun$ph*)come_calloc(1, sizeof(struct map$2char$phsFun$ph)*(1), "02transpile.c", 930, "struct map$2char$phsFun$ph*"))));
        ...
        __dec_obj74=info_497.struct_definition,
        info_497.struct_definition=(struct map$2char$phbuffer$ph*)come_increment_ref_count(map$2char$phbuffer$ph_initialize((struct map$2char$phbuffer$ph*)come_increment_ref_count((struct map$2char$phbuffer$ph*)come_calloc(1, sizeof(struct map$2char$phbuffer$ph)*(1), "02transpile.c", 931, "struct map$2char$phbuffer$ph*"))));
        ...
        __dec_obj76=info_497.uniq_definition,
        info_497.uniq_definition=(struct map$2char$phchar$ph*)come_increment_ref_count(map$2char$phchar$ph_initialize((struct map$2char$phchar$ph*)come_increment_ref_count((struct map$2char$phchar$ph*)come_calloc(1, sizeof(struct map$2char$phchar$ph)*(1), "02transpile.c", 932, "struct map$2char$phchar$ph*"))));
        ...
        __dec_obj77=info_497.previous_struct_definition,
        ...
        __dec_obj79=info_497.generics_funcs,
        ...
        __dec_obj81=info_497.classes,
        info_497.classes=(struct map$2char$phsClass$ph*)come_increment_ref_count(map$2char$phsClass$ph_initialize((struct map$2char$phsClass$ph*)come_increment_ref_count((struct map$2char$phsClass$ph*)come_calloc(1, sizeof(struct map$2char$phsClass$ph)*(1), "02transpile.c", 935, "struct map$2char$phsClass$ph*"))));
        ...
        __dec_obj83=info_497.modules,
        info_497.modules=(struct map$2char$phsClassModule$ph*)come_increment_ref_count(map$2char$phsClassModule$ph_initialize((struct map$2char$phsClassModule$ph*)come_increment_ref_count((struct map$2char$phsClassModule$ph*)come_calloc(1, sizeof(struct map$2char$phsClassModule$ph)*(1), "02transpile.c", 936, "struct map$2char$phsClassModule$ph*"))));
        ...
        __dec_obj85=info_497.types,
        info_497.types=(struct map$2char$phsType$ph*)come_increment_ref_count(map$2char$phsType$ph_initialize((struct map$2char$phsType$ph*)come_increment_ref_count((struct map$2char$phsType$ph*)come_calloc(1, sizeof(struct map$2char$phsType$ph)*(1), "02transpile.c", 937, "struct map$2char$phsType$ph*"))));
        ...
        __dec_obj86=info_497.module,
        info_497.module=(struct sModule*)come_increment_ref_count(sModule_initialize((struct sModule*)come_increment_ref_count((struct sModule*)come_calloc(1, sizeof(struct sModule)*(1), "02transpile.c", 938, "struct sModule*"))));
        /*b*/ come_call_finalizer3(__dec_obj86,sModule_finalize, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, 0/* force_delete_ */, (void*)0);
        __dec_obj87=info_497.right_value_objects,
        info_497.right_value_objects=(struct list$1sRightValueObject$ph*)come_increment_ref_count(list$1sRightValueObject$ph_initialize((struct list$1sRightValueObject$ph*)come_increment_ref_count((struct list$1sRightValueObject$ph*)come_calloc(1, sizeof(struct list$1sRightValueObject$ph)*(1), "02transpile.c", 939, "struct list$1sRightValueObject$ph*"))));
        ...
        __dec_obj88=info_497.stack,
        info_497.stack=(struct list$1CVALUE$ph*)come_increment_ref_count(list$1CVALUE$ph_initialize((struct list$1CVALUE$ph*)come_increment_ref_count((struct list$1CVALUE$ph*)come_calloc(1, sizeof(struct list$1CVALUE$ph)*(1), "02transpile.c", 940, "struct list$1CVALUE$ph*"))));
        ...
        __dec_obj89=info_497.gv_table,
        info_497.gv_table=(struct sVarTable*)come_increment_ref_count(sVarTable_initialize((struct sVarTable*)come_increment_ref_count((struct sVarTable*)come_calloc(1, sizeof(struct sVarTable)*(1), "02transpile.c", 941, "struct sVarTable*")),(_Bool)1,((void*)0)));
        /*b*/ come_call_finalizer3(__dec_obj89,sVarTable_finalize, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, 0/* force_delete_ */, (void*)0);
        lv_table_541=(struct sVarTable*)come_increment_ref_count(sVarTable_initialize((struct sVarTable*)come_increment_ref_count((struct sVarTable*)come_calloc(1, sizeof(struct sVarTable)*(1), "02transpile.c", 942, "struct sVarTable*")),(_Bool)0,((void*)0)));
        info_497.lv_table=lv_table_541;
        __dec_obj90=info_497.generics_type_names,
        info_497.generics_type_names=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), "02transpile.c", 944, "struct list$1char$ph*"))));
        /*b*/ come_call_finalizer3(__dec_obj90,list$1char$ph_finalize, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, 0/* force_delete_ */, (void*)0);
        __dec_obj91=info_497.method_generics_type_names,
        info_497.method_generics_type_names=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), "02transpile.c", 945, "struct list$1char$ph*"))));
        /*b*/ come_call_finalizer3(__dec_obj91,list$1char$ph_finalize, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, 0/* force_delete_ */, (void*)0);
        __dec_obj92=info_497.generics_classes,
        info_497.generics_classes=(struct map$2char$phsClass$ph*)come_increment_ref_count(map$2char$phsClass$ph_initialize((struct map$2char$phsClass$ph*)come_increment_ref_count((struct map$2char$phsClass$ph*)come_calloc(1, sizeof(struct map$2char$phsClass$ph)*(1), "02transpile.c", 946, "struct map$2char$phsClass$ph*"))));
        ...
        __dec_obj93=info_497.output_file_name,
        ...
        if(        !Value_543) {
            ...
            system(((char*)(__right_value645=xsprintf("%s %s*",RM,tmp_file_492))));
            (__right_value645 = come_decrement_ref_count(__right_value645, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
            exit(2);
        }
        else {
        }
        __dec_obj94=info_497.original_source,
        info_497.original_source=(struct buffer*)come_increment_ref_count(charp_to_buffer(((char*)(__right_value647=charp_read(((char*)(__right_value646=xsprintf("%s",tmp_file_492))))))));
        ...
        __dec_obj95=info_497.source,
        info_497.source=(struct buffer*)come_increment_ref_count(charp_to_buffer(((char*)(__right_value650=charp_read(((char*)(__right_value649=xsprintf("%s.i",tmp_file_492))))))));
        ...
        if(        !Value_544) {
            ...
            if(            !Value_545) {
                ...
                system(((char*)(__right_value652=xsprintf("%s %s*",RM,tmp_file_492))));
        ...
        system(((char*)(__right_value653=xsprintf("%s %s*",RM,tmp_file_492))));
        ...
        clang_option_558=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "02transpile.c", 698, "struct buffer*"))));
        linker_option_559=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "02transpile.c", 699, "struct buffer*"))));
        cpp_option_560=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "02transpile.c", 700, "struct buffer*"))));
        buffer_append_str(cpp_option_560,"-U__GNUC__");
        files_561=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), "02transpile.c", 702, "struct list$1char$ph*"))));
        object_files_562=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), "02transpile.c", 703, "struct list$1char$ph*"))));
        ...
        for(        i_575=start_num_556;        i_575<argc;        i_575++        ){
            ...
            if(            charp_operator_equals(argv[i_575],"-o")&&i_575+1<argc) {
                __dec_obj96=output_file_name_567,
                ...
                buffer_append_str(linker_option_559,((char*)(__right_value667=xsprintf("-e \%s",((char*)(__right_value666=charp_to_string(argv[i_575+1])))))));
                ...
                gComeGC=(_Bool)1;
                buffer_append_format(cpp_option_560,((char*)(__right_value668=xsprintf(" -DENABLE_GC "))));
                ...
                __dec_obj97=cpp_option_560,
                cpp_option_560=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "02transpile.c", 746, "struct buffer*"))));
                /*b*/ come_call_finalizer3(__dec_obj97,buffer_finalize, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, 0/* force_delete_ */, (void*)0);
                buffer_append_format(cpp_option_560,((char*)(__right_value673=xsprintf(" -I $PICO_SDK_PATH/src/common/pico_stdlib_headers/include/ -I$PICO_SDK_PATH/src/common/pico_base_headers/include/ -I \%s/src/rp2_common/hardware_sync/include \$(find \%s -type d -name include | sed 's/^/ -I/g') -I$PICO_SDK_PATH/src/boards/include -I$PICO_SDK_PATH/src/rp2040/pico_platform/include/ -I$PICO_SDK_PATH/src/rp2040/hardware_regs/include/ -I$PICO_SDK_PATH/src/rp2040/hardware_structs/include -I$PICO_SDK_PATH/src/rp2350/hardware_structs/include/ -I build/generated/pico_base/ -D__PICO__",((char*)(__right_value671=charp_to_string(env_577))),((char*)(__right_value672=charp_to_string(env_577)))))));
                ...
                __dec_obj98=cpp_option_560,
                cpp_option_560=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "02transpile.c", 763, "struct buffer*"))));
                /*b*/ come_call_finalizer3(__dec_obj98,buffer_finalize, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, 0/* force_delete_ */, (void*)0);
                buffer_append_format(cpp_option_560,((char*)(__right_value697=xsprintf(" -I\%s/.espressif/tools/xtensa-esp-elf/esp-14.2.0_20241119/xtensa-esp-elf/xtensa-esp-elf/include -I\%s/components/freertos/include -I\%s/components/esp32/include -I\%s/components/driver/include -I\%s/components/lwip/include -I\%s/components/freertos/FreeRTOS-Kernel/include -I\%s/components/freertos/config/include/freertos -I\%s/components/freertos/config/xtensa/include -I\%s/components/xtensa/include -I\%s/components/xtensa/esp32/include -I\%s/components/freertos/FreeRTOS-Kernel/portable/xtensa/include/freertos -I\%s/components/esp_hw_support/include -I\%s/components/soc/esp32/include/ -I\%s/components/esp_common/include/components $(find \%s/components -type d -name include | grep esp_ | sed 's/^/ -I/g') -I\%s/components/esp_common/include/ -I\%s/components/soc/esp32/register/soc/ -I\%s/components/soc/esp32/register -I\%s/components/heap/include -I\%s/components/hal/include -I\%s/components/newlib/platform_include -D__M5STACK__",((char*)(__right_value676=charp_to_string(getenv("HOME")))),((char*)(__right_value677=charp_to_string(env_578))),((char*)(__right_value678=charp_to_string(env_578))),((char*)(__right_value679=charp_to_string(env_578))),((char*)(__right_value680=charp_to_string(env_578))),((char*)(__right_value681=charp_to_string(env_578))),((char*)(__right_value682=charp_to_string(env_578))),((char*)(__right_value683=charp_to_string(env_578))),((char*)(__right_value684=charp_to_string(env_578))),((char*)(__right_value685=charp_to_string(env_578))),((char*)(__right_value686=charp_to_string(env_578))),((char*)(__right_value687=charp_to_string(env_578))),((char*)(__right_value688=charp_to_string(env_578))),((char*)(__right_value689=charp_to_string(env_578))),((char*)(__right_value690=charp_to_string(env_578))),((char*)(__right_value691=charp_to_string(env_578))),((char*)(__right_value692=charp_to_string(env_578))),((char*)(__right_value693=charp_to_string(env_578))),((char*)(__right_value694=charp_to_string(env_578))),((char*)(__right_value695=charp_to_string(env_578))),((char*)(__right_value696=charp_to_string(env_578)))))),"/usr/local/");
                ...
                buffer_append_str(clang_option_558,((char*)(__right_value699=xsprintf("-target \%s",((char*)(__right_value698=charp_to_string(argv[i_575+1])))))));
                ...
                buffer_append_str(clang_option_558,((char*)(__right_value701=xsprintf(" -T \%s ",((char*)(__right_value700=charp_to_string(argv[i_575+1])))))));
                ...
                buffer_append_str(cpp_option_560,((char*)(__right_value703=xsprintf("\%s ",((char*)(__right_value702=charp_to_string(argv[i_575])))))));
                ...
                buffer_append_str(cpp_option_560,((char*)(__right_value705=xsprintf("\%s ",((char*)(__right_value704=charp_to_string(argv[i_575])))))));
                ...
                buffer_append_str(cpp_option_560,((char*)(__right_value707=xsprintf("\%s ",((char*)(__right_value706=charp_to_string(argv[i_575])))))));
                ...
                buffer_append_str(cpp_option_560,((char*)(__right_value709=xsprintf("\%s ",((char*)(__right_value708=charp_to_string(argv[i_575])))))));
                ...
                buffer_append_str(cpp_option_560,((char*)(__right_value711=xsprintf("\%s ",((char*)(__right_value710=charp_to_string(argv[i_575])))))));
                ...
                buffer_append_str(cpp_option_560,((char*)(__right_value713=xsprintf("\%s ",((char*)(__right_value712=charp_to_string(argv[i_575])))))));
                ...
                buffer_append_str(cpp_option_560,((char*)(__right_value715=xsprintf("\%s ",((char*)(__right_value714=charp_to_string(argv[i_575])))))));
                ...
                buffer_append_str(cpp_option_560,((char*)(__right_value717=xsprintf("\%s ",((char*)(__right_value716=charp_to_string(argv[i_575])))))));
                ...
                buffer_append_str(cpp_option_560,((char*)(__right_value719=xsprintf("\%s ",((char*)(__right_value718=charp_to_string(argv[i_575])))))));
                ...
                buffer_append_str(clang_option_558,((char*)(__right_value721=xsprintf("-target \%s",((char*)(__right_value720=charp_to_string(argv[i_575+1])))))));
                ...
                buffer_append_str(cpp_option_560,((char*)(__right_value723=xsprintf("-iclude \%s",((char*)(__right_value722=charp_to_string(argv[i_575+1])))))));
                ...
                buffer_append_str(cpp_option_560,((char*)(__right_value725=xsprintf("-isystem \%s",((char*)(__right_value724=charp_to_string(argv[i_575+1])))))));
                ...
                buffer_append_str(clang_option_558,((char*)(__right_value727=xsprintf("-isystem \%s",((char*)(__right_value726=charp_to_string(argv[i_575+1])))))));
            ...
            else if(            (_elif_conditional4=(string_operator_equals(((char*)(__right_value730=charp_operator_load_range_element(argv[i_575],0,2))),"-O"))),            (__right_value730 = come_decrement_ref_count(__right_value730, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0)),
            _elif_conditional4) {
                buffer_append_str(clang_option_558,((char*)(__right_value732=xsprintf(" \%s ",((char*)(__right_value731=charp_to_string(argv[i_575])))))));
            ...
            else if(            (_elif_conditional5=(string_operator_equals(((char*)(__right_value733=charp_operator_load_range_element(argv[i_575],0,2))),"-D"))),            (__right_value733 = come_decrement_ref_count(__right_value733, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0)),
            _elif_conditional5) {
                ...
                buffer_append_str(clang_option_558,((char*)(__right_value737=xsprintf(" \%s ",((char*)(__right_value736=charp_to_string(argv[i_575])))))));
            ...
            else if(            (_elif_conditional6=(string_operator_equals(((char*)(__right_value738=charp_operator_load_range_element(argv[i_575],0,2))),"-U"))),            (__right_value738 = come_decrement_ref_count(__right_value738, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0)),
            _elif_conditional6) {
                ...
                buffer_append_str(clang_option_558,((char*)(__right_value742=xsprintf(" \%s ",((char*)(__right_value741=charp_to_string(argv[i_575])))))));
                ...
                buffer_append_str(cpp_option_560,((char*)(__right_value744=string_operator_add(((char*)(__right_value743=charp_operator_add(" ",argv[i_575])))," "))));
                ...
                buffer_append_str(clang_option_558,((char*)(__right_value745=charp_operator_add(argv[i_575]," "))));
                ...
                buffer_append_str(clang_option_558,((char*)(__right_value749=charp_operator_add(argv[i_575]," "))));
        ...
        for(        o2_saved_579=(struct list$1char$ph*)come_increment_ref_count((files_561)),it_580=list$1char$ph_begin((o2_saved_579));        !list$1char$ph_end((o2_saved_579));        it_580=list$1char$ph_next((o2_saved_579))        ){
            ...
            __dec_obj103=info_581.funcs,
            info_581.funcs=(struct map$2char$phsFun$ph*)come_increment_ref_count(map$2char$phsFun$ph_initialize((struct map$2char$phsFun$ph*)come_increment_ref_count((struct map$2char$phsFun$ph*)come_calloc(1, sizeof(struct map$2char$phsFun$ph)*(1), "02transpile.c", 1049, "struct map$2char$phsFun$ph*"))));
            ...
            __dec_obj104=info_581.struct_definition,
            info_581.struct_definition=(struct map$2char$phbuffer$ph*)come_increment_ref_count(map$2char$phbuffer$ph_initialize((struct map$2char$phbuffer$ph*)come_increment_ref_count((struct map$2char$phbuffer$ph*)come_calloc(1, sizeof(struct map$2char$phbuffer$ph)*(1), "02transpile.c", 1050, "struct map$2char$phbuffer$ph*"))));
            ...
            __dec_obj105=info_581.uniq_definition,
            info_581.uniq_definition=(struct map$2char$phchar$ph*)come_increment_ref_count(map$2char$phchar$ph_initialize((struct map$2char$phchar$ph*)come_increment_ref_count((struct map$2char$phchar$ph*)come_calloc(1, sizeof(struct map$2char$phchar$ph)*(1), "02transpile.c", 1051, "struct map$2char$phchar$ph*"))));
            ...
            __dec_obj106=info_581.previous_struct_definition,
            ...
            __dec_obj107=info_581.generics_funcs,
            info_581.generics_funcs=(struct map$2char$phsGenericsFun$ph*)come_increment_ref_count(map$2char$phsGenericsFun$ph_initialize((struct map$2char$phsGenericsFun$ph*)come_increment_ref_count((struct map$2char$phsGenericsFun$ph*)come_calloc(1, sizeof(struct map$2char$phsGenericsFun$ph)*(1), "02transpile.c", 1053, "struct map$2char$phsGenericsFun$ph*"))));
            ...
            __dec_obj108=info_581.classes,
            info_581.classes=(struct map$2char$phsClass$ph*)come_increment_ref_count(map$2char$phsClass$ph_initialize((struct map$2char$phsClass$ph*)come_increment_ref_count((struct map$2char$phsClass$ph*)come_calloc(1, sizeof(struct map$2char$phsClass$ph)*(1), "02transpile.c", 1054, "struct map$2char$phsClass$ph*"))));
            ...
            __dec_obj109=info_581.modules,
            info_581.modules=(struct map$2char$phsClassModule$ph*)come_increment_ref_count(map$2char$phsClassModule$ph_initialize((struct map$2char$phsClassModule$ph*)come_increment_ref_count((struct map$2char$phsClassModule$ph*)come_calloc(1, sizeof(struct map$2char$phsClassModule$ph)*(1), "02transpile.c", 1055, "struct map$2char$phsClassModule$ph*"))));
            ...
            __dec_obj110=info_581.types,
            info_581.types=(struct map$2char$phsType$ph*)come_increment_ref_count(map$2char$phsType$ph_initialize((struct map$2char$phsType$ph*)come_increment_ref_count((struct map$2char$phsType$ph*)come_calloc(1, sizeof(struct map$2char$phsType$ph)*(1), "02transpile.c", 1056, "struct map$2char$phsType$ph*"))));
            ...
            __dec_obj111=info_581.module,
            info_581.module=(struct sModule*)come_increment_ref_count(sModule_initialize((struct sModule*)come_increment_ref_count((struct sModule*)come_calloc(1, sizeof(struct sModule)*(1), "02transpile.c", 1057, "struct sModule*"))));
            /*b*/ come_call_finalizer3(__dec_obj111,sModule_finalize, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, 0/* force_delete_ */, (void*)0);
            __dec_obj112=info_581.right_value_objects,
            info_581.right_value_objects=(struct list$1sRightValueObject$ph*)come_increment_ref_count(list$1sRightValueObject$ph_initialize((struct list$1sRightValueObject$ph*)come_increment_ref_count((struct list$1sRightValueObject$ph*)come_calloc(1, sizeof(struct list$1sRightValueObject$ph)*(1), "02transpile.c", 1058, "struct list$1sRightValueObject$ph*"))));
            ...
            __dec_obj113=info_581.stack,
            info_581.stack=(struct list$1CVALUE$ph*)come_increment_ref_count(list$1CVALUE$ph_initialize((struct list$1CVALUE$ph*)come_increment_ref_count((struct list$1CVALUE$ph*)come_calloc(1, sizeof(struct list$1CVALUE$ph)*(1), "02transpile.c", 1059, "struct list$1CVALUE$ph*"))));
            ...
            __dec_obj114=info_581.gv_table,
            info_581.gv_table=(struct sVarTable*)come_increment_ref_count(sVarTable_initialize((struct sVarTable*)come_increment_ref_count((struct sVarTable*)come_calloc(1, sizeof(struct sVarTable)*(1), "02transpile.c", 1060, "struct sVarTable*")),(_Bool)1,((void*)0)));
            /*b*/ come_call_finalizer3(__dec_obj114,sVarTable_finalize, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, 0/* force_delete_ */, (void*)0);
            lv_table_583=(struct sVarTable*)come_increment_ref_count(sVarTable_initialize((struct sVarTable*)come_increment_ref_count((struct sVarTable*)come_calloc(1, sizeof(struct sVarTable)*(1), "02transpile.c", 1061, "struct sVarTable*")),(_Bool)0,((void*)0)));
            info_581.lv_table=lv_table_583;
            __dec_obj115=info_581.generics_type_names,
            info_581.generics_type_names=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), "02transpile.c", 1063, "struct list$1char$ph*"))));
            ...
            __dec_obj116=info_581.method_generics_type_names,
            info_581.method_generics_type_names=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc(1, sizeof(struct list$1char$ph)*(1), "02transpile.c", 1064, "struct list$1char$ph*"))));
            ...
            __dec_obj117=info_581.generics_classes,
            info_581.generics_classes=(struct map$2char$phsClass$ph*)come_increment_ref_count(map$2char$phsClass$ph_initialize((struct map$2char$phsClass$ph*)come_increment_ref_count((struct map$2char$phsClass$ph*)come_calloc(1, sizeof(struct map$2char$phsClass$ph)*(1), "02transpile.c", 1065, "struct map$2char$phsClass$ph*"))));
            ...
            __dec_obj118=info_581.original_source,
            info_581.original_source=(struct buffer*)come_increment_ref_count(charp_to_buffer(((char*)(__right_value787=charp_read(((char*)(__right_value786=xsprintf("%s",it_580))))))));
            ...
            __dec_obj119=info_581.source,
            info_581.source=(struct buffer*)come_increment_ref_count(charp_to_buffer(((char*)(__right_value790=charp_read(((char*)(__right_value789=xsprintf("%s.i",it_580))))))));
            ...
            if(            output_file_name_567) {
                __dec_obj120=info_581.output_file_name,
        ...
        if(        !output_object_file_563&&!output_cpp_file_564&&(list$1char$ph_length(files_561)>0||list$1char$ph_length(object_files_562)>0)) {
            memset(&info_589,0,sizeof(struct sInfo));
            __dec_obj122=info_589.sname,
            info_589.sname=(char*)come_increment_ref_count((char*)come_memdup(((char*)(__right_value793=list$1char$ph$p_operator_load_element(files_561,0))), "02transpile.c", 1132, "char*"));
            ...
            __dec_obj123=info_589.clang_option,
            ...
            __dec_obj124=info_589.linker_option,
            ...
            if(            output_file_name_567) {
                __dec_obj125=info_589.output_file_name,
            ...
            if(            output_object_file_flag_566) {
                Value_593=linker(&info_589,object_files_562);
                if(                !Value_593) {
...
char* __result_obj__226;
    buf_493=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "./comelang.h", 2002, "struct buffer*"))));
    n_494=0;
    ...
    __result_obj__226 = come_increment_ref_count(((char*)(__right_value567=buffer_to_string(buf_493))));
...
default_value_592 = (void*)0;
    ...
    while(it_590!=((void*)0)) {
        if(        position==i_591) {
            __result_obj__237 = come_increment_ref_count(it_590->item);
    ...
    __result_obj__238 = come_increment_ref_count(default_value_592);
    (default_value_592 = come_decrement_ref_count(default_value_592, (void*)0, (void*)0, 0/* no_decrement*/, 1/* no_free*/, 0/* force_delete_*/, (void*)0));
