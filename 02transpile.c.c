...
struct list$1charph* __result199__;
    result_258=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "./comelang.h", 1540, "list$1charph"))));
    if(    begin<0) {
        begin+=self->len;
    }
    if(    tail<0) {
...
struct list$1charph* __result204__;
    result_267=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "./comelang.h", 1752, "list$1charph"))));
    it_268=self->head;
    while(it_268!=((void*)0)) {
...
char* __result212__;
    buf_270=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "./comelang.h", 1862, "buffer"))));
    n_271=0;
...
default_value_316 = (void*)0;
    ...
    if(    position==0) {
        litem_317=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value302=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 1270, "list_item$1charph"))));
        ...
        litem_318=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value303=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 1282, "list_item$1charph"))));
        ...
        while(it_319!=((void*)0)) {
            if(            position==i_320) {
                litem_321=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value304=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 1298, "list_item$1charph"))));
...
default_value_389 = (void*)0;
    ...
    keys_360=(char**)come_increment_ref_count(((char**)(__right_value360=(char**)come_calloc(1, sizeof(char*)*(1*(size_359)), "./comelang.h", 2515, "char*%"))));
    items_361=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value361=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_359)), "./comelang.h", 2516, "sClass*%"))));
    item_existance_362=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value362=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_359)), "./comelang.h", 2517, "bool"))));
    len_363=0;
...
default_value_437 = (void*)0;
    ...
    keys_422=(char**)come_increment_ref_count(((char**)(__right_value415=(char**)come_calloc(1, sizeof(char*)*(1*(size_421)), "./comelang.h", 2515, "char*%"))));
    items_423=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value416=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_421)), "./comelang.h", 2516, "sType*%"))));
    item_existance_424=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value417=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_421)), "./comelang.h", 2517, "bool"))));
    len_425=0;
...
struct list$1tuple2$2charphsTypephph* __result254__;
    if(    self->len==0) {
        litem_443=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value421=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "./comelang.h", 1110, "list_item$1tuple2$2charphsTypephph"))));
        ...
        litem_444=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value422=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "./comelang.h", 1120, "list_item$1tuple2$2charphsTypephph"))));
        ...
        litem_445=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value423=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "./comelang.h", 1130, "list_item$1tuple2$2charphsTypephph"))));
...
struct map$2charphsFunph* __result257__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value538=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 2287, "char*%"))));
    self->items=(struct sFun**)come_increment_ref_count(((struct sFun**)(__right_value539=(struct sFun**)come_calloc(1, sizeof(struct sFun*)*(1*(128)), "./comelang.h", 2288, "sFun*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value540=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 2289, "bool"))));
    ...
    self->key_list=(struct list$1charp*)come_increment_ref_count(list$1charp_initialize((struct list$1charp*)come_increment_ref_count((struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "./comelang.h", 2299, "list$1charp"))));
...
struct map$2charphbufferph* __result258__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value545=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 2287, "char*%"))));
    self->items=(struct buffer**)come_increment_ref_count(((struct buffer**)(__right_value546=(struct buffer**)come_calloc(1, sizeof(struct buffer*)*(1*(128)), "./comelang.h", 2288, "buffer*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value547=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 2289, "bool"))));
...
struct map$2charphcharph* __result259__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value552=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 2287, "char*%"))));
    self->items=(char**)come_increment_ref_count(((char**)(__right_value553=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 2288, "char*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value554=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 2289, "bool"))));
...
struct map$2charphsGenericsFunph* __result260__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value561=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 2287, "char*%"))));
    self->items=(struct sGenericsFun**)come_increment_ref_count(((struct sGenericsFun**)(__right_value562=(struct sGenericsFun**)come_calloc(1, sizeof(struct sGenericsFun*)*(1*(128)), "./comelang.h", 2288, "sGenericsFun*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value563=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 2289, "bool"))));
...
struct map$2charphsClassph* __result261__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value568=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 2287, "char*%"))));
    self->items=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value569=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(128)), "./comelang.h", 2288, "sClass*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value570=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 2289, "bool"))));
...
struct map$2charphsClassModuleph* __result262__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value575=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 2287, "char*%"))));
    self->items=(struct sClassModule**)come_increment_ref_count(((struct sClassModule**)(__right_value576=(struct sClassModule**)come_calloc(1, sizeof(struct sClassModule*)*(1*(128)), "./comelang.h", 2288, "sClassModule*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value577=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 2289, "bool"))));
...
struct map$2charphsTypeph* __result263__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value582=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 2287, "char*%"))));
    self->items=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value583=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(128)), "./comelang.h", 2288, "sType*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value584=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 2289, "bool"))));
...
struct map$2charphint* __result266__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value605=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 2287, "char*%"))));
    self->items=(int*)come_increment_ref_count(((int*)(__right_value606=(int*)come_calloc(1, sizeof(int)*(1*(128)), "./comelang.h", 2288, "int"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value607=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 2289, "bool"))));
