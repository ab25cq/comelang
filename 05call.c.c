...
default_value_166 = (void*)0;
    ...
    keys_147=(char**)come_increment_ref_count(((char**)(__right_value188=(char**)come_calloc(1, sizeof(char*)*(1*(size_146)), "./comelang.h", 1658, "char*%"))));
    items_148=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value189=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_146)), "./comelang.h", 1659, "sClass*%"))));
    item_existance_149=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value190=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_146)), "./comelang.h", 1660, "bool"))));
    len_150=0;
