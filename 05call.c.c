...
struct list$1CVALUE$ph* __result_obj__195;
    if(    self->len==0) {
        litem_304=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value269=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./comelang.h", 1111, "struct list_item$1CVALUE$ph*"))));
        ...
        litem_305=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value270=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./comelang.h", 1121, "struct list_item$1CVALUE$ph*"))));
        ...
        litem_306=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value271=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./comelang.h", 1131, "struct list_item$1CVALUE$ph*"))));
...
default_value_360 = (void*)0;
    ...
    keys_343=(char**)come_increment_ref_count(((char**)(__right_value296=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size_342)), "./comelang.h", 2165, "char**"))));
    items_344=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value297=(struct sClass**)come_calloc_v2(1, sizeof(struct sClass*)*(1*(size_342)), "./comelang.h", 2166, "struct sClass**"))));
    item_existance_345=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value298=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(size_342)), "./comelang.h", 2167, "_Bool*"))));
    len_346=0;
...
struct list$1sType$ph* __result_obj__298;
    if(    self->len==0) {
        litem_475=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value410=(struct list_item$1sType$ph*)come_calloc_v2(1, sizeof(struct list_item$1sType$ph)*(1), "./comelang.h", 1111, "struct list_item$1sType$ph*"))));
        ...
        litem_476=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value411=(struct list_item$1sType$ph*)come_calloc_v2(1, sizeof(struct list_item$1sType$ph)*(1), "./comelang.h", 1121, "struct list_item$1sType$ph*"))));
        ...
        litem_477=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value412=(struct list_item$1sType$ph*)come_calloc_v2(1, sizeof(struct list_item$1sType$ph)*(1), "./comelang.h", 1131, "struct list_item$1sType$ph*"))));
...
struct list$1CVALUE$ph* __result_obj__308;
    if(    self->len==0) {
        litem_497=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value419=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./comelang.h", 1041, "struct list_item$1CVALUE$ph*"))));
        ...
        litem_498=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value420=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./comelang.h", 1051, "struct list_item$1CVALUE$ph*"))));
        ...
        litem_499=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value421=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "./comelang.h", 1061, "struct list_item$1CVALUE$ph*"))));
...
struct list$1sBlock$ph* __result_obj__416;
    if(    self->len==0) {
        litem_847=(struct list_item$1sBlock$ph*)come_increment_ref_count(((struct list_item$1sBlock$ph*)(__right_value861=(struct list_item$1sBlock$ph*)come_calloc_v2(1, sizeof(struct list_item$1sBlock$ph)*(1), "./comelang.h", 1041, "struct list_item$1sBlock$ph*"))));
        ...
        litem_848=(struct list_item$1sBlock$ph*)come_increment_ref_count(((struct list_item$1sBlock$ph*)(__right_value862=(struct list_item$1sBlock$ph*)come_calloc_v2(1, sizeof(struct list_item$1sBlock$ph)*(1), "./comelang.h", 1051, "struct list_item$1sBlock$ph*"))));
        ...
        litem_849=(struct list_item$1sBlock$ph*)come_increment_ref_count(((struct list_item$1sBlock$ph*)(__right_value863=(struct list_item$1sBlock$ph*)come_calloc_v2(1, sizeof(struct list_item$1sBlock$ph)*(1), "./comelang.h", 1061, "struct list_item$1sBlock$ph*"))));
...
struct list$1sBlock$ph* __result_obj__436;
    ...
    result_851=(struct list$1sBlock$ph*)come_increment_ref_count(list$1sBlock$ph_initialize((struct list$1sBlock$ph*)come_increment_ref_count((struct list$1sBlock$ph*)come_calloc_v2(1, sizeof(struct list$1sBlock$ph)*(1), "./comelang.h", 1022, "struct list$1sBlock$ph*"))));
    it_852=self->head;
    while(it_852!=((void*)0)) {
        if(        1) {
...
struct list$1sNode$ph* __result_obj__421;
    ...
    result_854=(struct list$1sNode$ph*)come_increment_ref_count(list$1sNode$ph_initialize((struct list$1sNode$ph*)come_increment_ref_count((struct list$1sNode$ph*)come_calloc_v2(1, sizeof(struct list$1sNode$ph)*(1), "./comelang.h", 1022, "struct list$1sNode$ph*"))));
    it_855=self->head;
    while(it_855!=((void*)0)) {
        if(        1) {
...
default_value_860 = (void*)0;
    ...
    result_858=(struct map$2char$phsVar$ph*)come_increment_ref_count(map$2char$phsVar$ph_initialize((struct map$2char$phsVar$ph*)come_increment_ref_count((struct map$2char$phsVar$ph*)come_calloc_v2(1, sizeof(struct map$2char$phsVar$ph)*(1), "./comelang.h", 1997, "struct map$2char$phsVar$ph*"))));
    __dec_obj220=result_858->key_list,
    result_858->key_list=(struct list$1char$p*)come_increment_ref_count(list$1char$p_initialize((struct list$1char$p*)come_increment_ref_count((struct list$1char$p*)come_calloc_v2(1, sizeof(struct list$1char$p)*(1), "./comelang.h", 1999, "struct list$1char$p*"))));
    ...
    for(    it_859=map$2char$phsVar$ph_begin(self);    !map$2char$phsVar$ph_end(self);    it_859=map$2char$phsVar$ph_next(self)    ){
        ...
        if(        1&&1) {
            map$2char$phsVar$ph_put(result_858,(char*)come_increment_ref_count((char*)come_memdup(it_859, "./comelang.h", 2008, "char*")),(struct sVar*)come_increment_ref_count(sVar_clone(it2_863)));
        }
        else if(        1) {
            map$2char$phsVar$ph_put(result_858,(char*)come_increment_ref_count((char*)come_memdup(it_859, "./comelang.h", 2011, "char*")),(struct sVar*)come_increment_ref_count(sVar_clone(it2_863)));
        }
        else if(        1) {
...
struct map$2char$phsVar$ph* __result_obj__425;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value879=(char**)come_calloc_v2(1, sizeof(char*)*(1*(128)), "./comelang.h", 1926, "char**"))));
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value880=(struct sVar**)come_calloc_v2(1, sizeof(struct sVar*)*(1*(128)), "./comelang.h", 1927, "struct sVar**"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value881=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 1928, "_Bool*"))));
...
default_value_874 = (void*)0;
    ...
    keys_865=(char**)come_increment_ref_count(((char**)(__right_value888=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size_864)), "./comelang.h", 2165, "char**"))));
    items_866=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value889=(struct sVar**)come_calloc_v2(1, sizeof(struct sVar*)*(1*(size_864)), "./comelang.h", 2166, "struct sVar**"))));
    item_existance_867=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value890=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(size_864)), "./comelang.h", 2167, "_Bool*"))));
    len_868=0;
