...
struct list$1sBlockph* __result475__;
    if(    self->len==0) {
        litem_804=(struct list_item$1sBlockph*)come_increment_ref_count(((struct list_item$1sBlockph*)(__right_value767=(struct list_item$1sBlockph*)come_calloc(1, sizeof(struct list_item$1sBlockph)*(1), "./comelang.h", 1057, "list_item$1sBlockph"))));
        ...
        litem_805=(struct list_item$1sBlockph*)come_increment_ref_count(((struct list_item$1sBlockph*)(__right_value768=(struct list_item$1sBlockph*)come_calloc(1, sizeof(struct list_item$1sBlockph)*(1), "./comelang.h", 1067, "list_item$1sBlockph"))));
        ...
        litem_806=(struct list_item$1sBlockph*)come_increment_ref_count(((struct list_item$1sBlockph*)(__right_value769=(struct list_item$1sBlockph*)come_calloc(1, sizeof(struct list_item$1sBlockph)*(1), "./comelang.h", 1077, "list_item$1sBlockph"))));
...
struct list$1sBlockph* __result489__;
    ...
    result_808=(struct list$1sBlockph*)come_increment_ref_count(list$1sBlockph_initialize((struct list$1sBlockph*)come_increment_ref_count((struct list$1sBlockph*)come_calloc(1, sizeof(struct list$1sBlockph)*(1), "./comelang.h", 1043, "list$1sBlockph"))));
    it_809=self->head;
    while(it_809!=((void*)0)) {
...
struct list$1sNodeph* __result480__;
    ...
    result_811=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count((struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "./comelang.h", 1043, "list$1sNodeph"))));
    it_812=self->head;
    while(it_812!=((void*)0)) {
...
default_value_817 = (void*)0;
    ...
    result_815=(struct map$2charphsVarph*)come_increment_ref_count(map$2charphsVarph_initialize((struct map$2charphsVarph*)come_increment_ref_count((struct map$2charphsVarph*)come_calloc(1, sizeof(struct map$2charphsVarph)*(1), "./comelang.h", 2375, "map$2charphsVarph"))));
    __dec_obj363=result_815->key_list;
    result_815->key_list=(struct list$1charp*)come_increment_ref_count(list$1charp_initialize((struct list$1charp*)come_increment_ref_count((struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "./comelang.h", 2377, "list$1charp"))));
...
default_value_829 = (void*)0;
    ...
    keys_820=(char**)come_increment_ref_count(((char**)(__right_value792=(char**)come_calloc(1, sizeof(char*)*(1*(size_819)), "./comelang.h", 2532, "char*%"))));
    items_821=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value793=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_819)), "./comelang.h", 2533, "sVar*%"))));
    item_existance_822=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value794=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_819)), "./comelang.h", 2534, "bool"))));
    len_823=0;
