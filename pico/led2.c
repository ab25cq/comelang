...
struct buffer* __result1__;
    result_0=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 2338, "buffer"))));
...
struct buffer* __result2__;
    result_1=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 2345, "buffer"))));
...
struct buffer* __result3__;
    result_3=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 2354, "buffer"))));
...
struct buffer* __result4__;
    result_4=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 2361, "buffer"))));
...
struct buffer* __result5__;
    result_5=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 2368, "buffer"))));
...
struct buffer* __result6__;
    result_6=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 2375, "buffer"))));
...
struct buffer* __result7__;
    result_7=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 2382, "buffer"))));
...
struct smart_pointer$1char* __result11__;
    __result11__ = gComeFunResultObject = __result_obj__ = ((struct smart_pointer$1char*)(__right_value18=smart_pointer$1char_initialize_with_value((struct smart_pointer$1char*)come_increment_ref_count((struct smart_pointer$1char*)come_calloc(1, sizeof(struct smart_pointer$1char)*(1), "/usr/local/include/comelang-pico.h", 2682, "smart_pointer$1char")),(struct buffer*)come_increment_ref_count(buffer_clone(self)))));
...
struct smart_pointer$1char* __result12__;
    __result12__ = gComeFunResultObject = __result_obj__ = ((struct smart_pointer$1char*)(__right_value21=smart_pointer$1char_initialize_with_value((struct smart_pointer$1char*)come_increment_ref_count((struct smart_pointer$1char*)come_calloc(1, sizeof(struct smart_pointer$1char)*(1), "/usr/local/include/comelang-pico.h", 2687, "smart_pointer$1char")),(struct buffer*)come_increment_ref_count(buffer_clone(self)))));
...
struct smart_pointer$1short* __result14__;
    __result14__ = gComeFunResultObject = __result_obj__ = ((struct smart_pointer$1short*)(__right_value24=smart_pointer$1short_initialize_with_value((struct smart_pointer$1short*)come_increment_ref_count((struct smart_pointer$1short*)come_calloc(1, sizeof(struct smart_pointer$1short)*(1), "/usr/local/include/comelang-pico.h", 2692, "smart_pointer$1short")),(struct buffer*)come_increment_ref_count(buffer_clone(self)))));
...
struct smart_pointer$1int* __result16__;
    __result16__ = gComeFunResultObject = __result_obj__ = ((struct smart_pointer$1int*)(__right_value27=smart_pointer$1int_initialize_with_value((struct smart_pointer$1int*)come_increment_ref_count((struct smart_pointer$1int*)come_calloc(1, sizeof(struct smart_pointer$1int)*(1), "/usr/local/include/comelang-pico.h", 2697, "smart_pointer$1int")),(struct buffer*)come_increment_ref_count(buffer_clone(self)))));
...
struct smart_pointer$1long* __result18__;
    __result18__ = gComeFunResultObject = __result_obj__ = ((struct smart_pointer$1long*)(__right_value30=smart_pointer$1long_initialize_with_value((struct smart_pointer$1long*)come_increment_ref_count((struct smart_pointer$1long*)come_calloc(1, sizeof(struct smart_pointer$1long)*(1), "/usr/local/include/comelang-pico.h", 2702, "smart_pointer$1long")),(struct buffer*)come_increment_ref_count(buffer_clone(self)))));
...
void* __right_value41 = (void*)0;
    buf_9=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 2763, "buffer"))));
...
void* __result24__;
    if(    gComeDebugLib) {
        ...
        if(        gNumComeStackFrame<16) {
            memcpy(it_27->sname,gComeStackFrameSName,sizeof(char*)*gNumComeStackFrame);
            memcpy(it_27->sline,gComeStackFrameSLine,sizeof(int)*gNumComeStackFrame);
            memcpy(it_27->id,gComeStackFrameID,sizeof(int)*gNumComeStackFrame);
        }
        else {
            memcpy(it_27->sname,gComeStackFrameSName+gNumComeStackFrame-16-1,sizeof(char*)*16);
            memcpy(it_27->sline,gComeStackFrameSLine+gNumComeStackFrame-16-1,sizeof(int)*16);
            memcpy(it_27->id,gComeStackFrameID+gNumComeStackFrame-16-1,sizeof(int)*16);
        }
        come_pop_stackframe();
...
void* __result28__;
    ...
    memcpy(result_47,block,size_46);
...
char* __result41__;
    ...
    len_72=strlen(str)+1;
    result_73=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_72)), "/usr/local/include/comelang-pico.h", 3578, "char"));
    strncpy(result_73,str,len_72);
...
struct buffer* __result55__;
    ...
    self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang-pico.h", 3667, "char"));
...
struct buffer* __result59__;
    ...
    if(    self->len+size+1+1>=self->size) {
        old_buf_77=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang-pico.h", 3727, "char"));
        memcpy(old_buf_77,self->buf,self->size);
        old_len_78=self->len;
        new_size_79=(self->size+size+1)*2;
        __dec_obj13=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_79)), "/usr/local/include/comelang-pico.h", 3731, "char"));
        /*G*/ __dec_obj13 = come_decrement_ref_count2(__dec_obj13, (void*)0, (void*)0, 0,0,0, (void*)0);
        memcpy(self->buf,old_buf_77,old_len_78);
...
struct buffer* __result61__;
    ...
    if(    self->len+1+1+1>=self->size) {
        old_buf_80=(char*)come_increment_ref_count((char*)come_memdup(self->buf, "/usr/local/include/comelang-pico.h", 3750, "char*"));
        old_len_81=self->len;
        new_size_82=(self->size+10+1)*2;
        __dec_obj14=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_82)), "/usr/local/include/comelang-pico.h", 3754, "char"));
        /*G*/ __dec_obj14 = come_decrement_ref_count2(__dec_obj14, (void*)0, (void*)0, 0,0,0, (void*)0);
        memcpy(self->buf,old_buf_80,old_len_81);
...
struct buffer* __result63__;
    ...
    if(    self->len+size_83+1+1>=self->size) {
        old_buf_84=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang-pico.h", 3776, "char"));
        memcpy(old_buf_84,self->buf,self->size);
        old_len_85=self->len;
        new_size_86=(self->size+size_83+1)*2;
        __dec_obj15=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_86)), "/usr/local/include/comelang-pico.h", 3780, "char"));
    ...
    memcpy(self->buf+self->len,mem,size_83);
    self->len+=size_83;
    self->buf[self->len]=0;
...
result_88 = (void*)0;
    ...
    if(    self->len+size_91+1+1>=self->size) {
        old_buf_92=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang-pico.h", 3813, "char"));
        memcpy(old_buf_92,self->buf,self->size);
        old_len_93=self->len;
        new_size_94=(self->size+size_91+1)*2;
        __dec_obj16=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_94)), "/usr/local/include/comelang-pico.h", 3817, "char"));
...
struct buffer* __result68__;
    ...
    if(    self->len+size_95+1+1+1>=self->size) {
        old_buf_96=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang-pico.h", 3839, "char"));
        memcpy(old_buf_96,self->buf,self->size);
        old_len_97=self->len;
        new_size_98=(self->size+size_95+1)*2;
        __dec_obj17=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_98)), "/usr/local/include/comelang-pico.h", 3843, "char"));
    ...
    memcpy(self->buf+self->len,mem,size_95);
    self->len+=size_95;
    self->buf[self->len]=0;
    self->len++;
...
struct buffer* __result70__;
    ...
    if(    self->len+size_100+1+1>=self->size) {
        old_buf_101=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang-pico.h", 3866, "char"));
        memcpy(old_buf_101,self->buf,self->size);
        old_len_102=self->len;
        new_size_103=(self->size+size_100+1)*2;
        __dec_obj18=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_103)), "/usr/local/include/comelang-pico.h", 3870, "char"));
...
struct buffer* __result71__;
    ...
    if(    self->len+size_105+1+1>=self->size) {
        old_buf_106=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang-pico.h", 3889, "char"));
        memcpy(old_buf_106,self->buf,self->size);
        old_len_107=self->len;
        new_size_108=(self->size+size_105+1)*2;
        __dec_obj19=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_108)), "/usr/local/include/comelang-pico.h", 3893, "char"));
...
struct buffer* __result73__;
    ...
    if(    self->len+size_110+1+1>=self->size) {
        old_buf_111=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang-pico.h", 3916, "char"));
        memcpy(old_buf_111,self->buf,self->size);
        old_len_112=self->len;
        new_size_113=(self->size+size_110+1)*2;
        __dec_obj20=self->buf;
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_113)), "/usr/local/include/comelang-pico.h", 3920, "char"));
    ...
    memcpy(self->buf+self->len,mem_109,size_110);
    self->len+=size_110;
    self->buf[self->len]=0;
...
struct buffer* __result75__;
    ...
    if(    len_114>=self->size) {
        ...
        self->buf=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(new_size_115)), "/usr/local/include/comelang-pico.h", 3944, "char"));
...
struct buffer* __result77__;
    result_117=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 3974, "buffer"))));
    if(    self==((void*)0)) {
...
struct buffer* __result79__;
    result_118=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 3987, "buffer"))));
    if(    self==((void*)0)) {
...
char* __result83__;
    ...
    result_120=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_119+1)), "/usr/local/include/comelang-pico.h", 4214, "char"));
    strncpy(result_120,self,len_119+1);
    strncat(result_120,right,len_119+1);
...
char* __result85__;
    ...
    result_122=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_121+1)), "/usr/local/include/comelang-pico.h", 4229, "char"));
...
char* __result87__;
    ...
    buf_123=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 4242, "buffer"))));
...
char* __result89__;
    ...
    buf_125=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 4256, "buffer"))));
...
char* __result95__;
    ...
    len_135=strlen(str);
    result_136=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_135+1)), "/usr/local/include/comelang-pico.h", 4473, "char"));
...
char* __result97__;
    ...
    len_138=strlen(str);
    result_139=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_138+1)), "/usr/local/include/comelang-pico.h", 4490, "char"));
...
char* __result102__;
    ...
    result_142=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "/usr/local/include/comelang-pico.h", 4535, "char"));
...
char* __result107__;
    ...
    result_144=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "/usr/local/include/comelang-pico.h", 4578, "char"));
...
char* __result112__;
    ...
    result_146=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "/usr/local/include/comelang-pico.h", 4621, "char"));
...
char* __result117__;
    ...
    result_148=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "/usr/local/include/comelang-pico.h", 4664, "char"));
...
char* __result124__;
    ...
    memcpy(str+head,sub_str_154,string_length(sub_str_154)+1);
...
struct list$1charph* __result132__;
    if(    self==((void*)0)) {
        __result130__ = gComeFunResultObject = __result_obj__ = ((struct list$1charph*)(__right_value139=list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang-pico.h", 4775, "list$1charph")))));
        /*g*/come_call_finalizer3(__right_value139,list$1charphp_finalize, 0, 1, 0, 0, __result_obj__);
        gComeFunResultObject = (void*)0;
        return __result130__;
    }
    result_159=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang-pico.h", 4778, "list$1charph"))));
    str_160=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 4780, "buffer"))));
...
struct list$1charph* __result134__;
    if(    self==((void*)0)) {
        __result133__ = gComeFunResultObject = __result_obj__ = ((struct list$1charph*)(__right_value150=list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang-pico.h", 4801, "list$1charph")))));
        /*g*/come_call_finalizer3(__right_value150,list$1charphp_finalize, 0, 1, 0, 0, __result_obj__);
        gComeFunResultObject = (void*)0;
        return __result133__;
    }
    result_165=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang-pico.h", 4804, "list$1charph"))));
    str_166=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 4806, "buffer"))));
...
char* __result148__;
    ...
    buf_172=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 5073, "buffer"))));
    while(1) {
        char buf2_173[1024];
...
memset(&args_177, 0, sizeof(va_list));
    ...
    vsnprintf(msg2_176,1024*2*2*2,msg,args_177);
...
char* __result155__;
    ...
    buf_186=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 5213, "buffer"))));
    while(1) {
        char buf2_187[1024];
...
char* __result159__;
    ...
    buf_192=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 5250, "buffer"))));
    while(1) {
        char buf2_193[1024];
...
struct list$1charph* __result161__;
    result_197=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang-pico.h", 5277, "list$1charph"))));
    if(    f==((void*)0)) {
...
struct integer* __result173__;
    __result173__ = gComeFunResultObject = __result_obj__ = ((struct integer*)(__right_value200=integer_initialize((struct integer*)come_increment_ref_count((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "/usr/local/include/comelang-pico.h", 5444, "integer")),self)));
...
struct integer* __result174__;
    __result174__ = gComeFunResultObject = __result_obj__ = ((struct integer*)(__right_value202=integer_initialize((struct integer*)come_increment_ref_count((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "/usr/local/include/comelang-pico.h", 5449, "integer")),self)));
...
struct integer* __result175__;
    __result175__ = gComeFunResultObject = __result_obj__ = ((struct integer*)(__right_value204=integer_initialize((struct integer*)come_increment_ref_count((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "/usr/local/include/comelang-pico.h", 5454, "integer")),self)));
...
struct integer* __result176__;
    __result176__ = gComeFunResultObject = __result_obj__ = ((struct integer*)(__right_value206=integer_initialize((struct integer*)come_increment_ref_count((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "/usr/local/include/comelang-pico.h", 5459, "integer")),self)));
...
struct integer* __result177__;
    __result177__ = gComeFunResultObject = __result_obj__ = ((struct integer*)(__right_value208=integer_initialize((struct integer*)come_increment_ref_count((struct integer*)come_calloc(1, sizeof(struct integer)*(1), "/usr/local/include/comelang-pico.h", 5464, "integer")),self)));
...
struct floating* __result180__;
    __result180__ = gComeFunResultObject = __result_obj__ = ((struct floating*)(__right_value211=floating_initialize((struct floating*)come_increment_ref_count((struct floating*)come_calloc(1, sizeof(struct floating)*(1), "/usr/local/include/comelang-pico.h", 5604, "floating")),self)));
...
struct floating* __result181__;
    __result181__ = gComeFunResultObject = __result_obj__ = ((struct floating*)(__right_value213=floating_initialize((struct floating*)come_increment_ref_count((struct floating*)come_calloc(1, sizeof(struct floating)*(1), "/usr/local/include/comelang-pico.h", 5609, "floating")),self)));
...
struct smart_pointer$1char* __result183__;
    buf_205=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 5736, "buffer"))));
    buffer_append(buf_205,(char*)self,sizeof(char)*len);
    __result183__ = gComeFunResultObject = __result_obj__ = ((struct smart_pointer$1char*)(__right_value218=smart_pointer$1char_initialize_with_value((struct smart_pointer$1char*)come_increment_ref_count((struct smart_pointer$1char*)come_calloc(1, sizeof(struct smart_pointer$1char)*(1), "/usr/local/include/comelang-pico.h", 5738, "smart_pointer$1char")),(struct buffer*)come_increment_ref_count(buf_205))));
...
struct smart_pointer$1charp* __result185__;
    buf_206=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 5743, "buffer"))));
    buffer_append(buf_206,(char*)self,sizeof(char*)*len);
    __result185__ = gComeFunResultObject = __result_obj__ = ((struct smart_pointer$1charp*)(__right_value222=smart_pointer$1charp_initialize_with_value((struct smart_pointer$1charp*)come_increment_ref_count((struct smart_pointer$1charp*)come_calloc(1, sizeof(struct smart_pointer$1charp)*(1), "/usr/local/include/comelang-pico.h", 5745, "smart_pointer$1charp")),(struct buffer*)come_increment_ref_count(buf_206))));
...
struct smart_pointer$1short* __result186__;
    buf_207=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 5750, "buffer"))));
    buffer_append(buf_207,(char*)self,sizeof(short)*len);
    __result186__ = gComeFunResultObject = __result_obj__ = ((struct smart_pointer$1short*)(__right_value226=smart_pointer$1short_initialize_with_value((struct smart_pointer$1short*)come_increment_ref_count((struct smart_pointer$1short*)come_calloc(1, sizeof(struct smart_pointer$1short)*(1), "/usr/local/include/comelang-pico.h", 5752, "smart_pointer$1short")),(struct buffer*)come_increment_ref_count(buf_207))));
...
struct smart_pointer$1int* __result187__;
    buf_208=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 5757, "buffer"))));
    buffer_append(buf_208,(char*)self,sizeof(int)*len);
    __result187__ = gComeFunResultObject = __result_obj__ = ((struct smart_pointer$1int*)(__right_value230=smart_pointer$1int_initialize_with_value((struct smart_pointer$1int*)come_increment_ref_count((struct smart_pointer$1int*)come_calloc(1, sizeof(struct smart_pointer$1int)*(1), "/usr/local/include/comelang-pico.h", 5759, "smart_pointer$1int")),(struct buffer*)come_increment_ref_count(buf_208))));
...
struct smart_pointer$1long* __result188__;
    buf_209=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 5764, "buffer"))));
    buffer_append(buf_209,(char*)self,sizeof(long)*len);
    __result188__ = gComeFunResultObject = __result_obj__ = ((struct smart_pointer$1long*)(__right_value234=smart_pointer$1long_initialize_with_value((struct smart_pointer$1long*)come_increment_ref_count((struct smart_pointer$1long*)come_calloc(1, sizeof(struct smart_pointer$1long)*(1), "/usr/local/include/comelang-pico.h", 5766, "smart_pointer$1long")),(struct buffer*)come_increment_ref_count(buf_209))));
...
struct smart_pointer$1float* __result190__;
    buf_210=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 5771, "buffer"))));
    buffer_append(buf_210,(char*)self,sizeof(float)*len);
    __result190__ = gComeFunResultObject = __result_obj__ = ((struct smart_pointer$1float*)(__right_value238=smart_pointer$1float_initialize_with_value((struct smart_pointer$1float*)come_increment_ref_count((struct smart_pointer$1float*)come_calloc(1, sizeof(struct smart_pointer$1float)*(1), "/usr/local/include/comelang-pico.h", 5773, "smart_pointer$1float")),(struct buffer*)come_increment_ref_count(buf_210))));
...
struct smart_pointer$1double* __result192__;
    buf_211=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang-pico.h", 5778, "buffer"))));
    buffer_append(buf_211,(char*)self,sizeof(double)*len);
    __result192__ = gComeFunResultObject = __result_obj__ = ((struct smart_pointer$1double*)(__right_value242=smart_pointer$1double_initialize_with_value((struct smart_pointer$1double*)come_increment_ref_count((struct smart_pointer$1double*)come_calloc(1, sizeof(struct smart_pointer$1double)*(1), "/usr/local/include/comelang-pico.h", 5780, "smart_pointer$1double")),(struct buffer*)come_increment_ref_count(buf_211))));
...
struct list$1char* __result195__;
    __result195__ = gComeFunResultObject = __result_obj__ = ((struct list$1char*)(__right_value247=list$1char_initialize_with_values((struct list$1char*)come_increment_ref_count((struct list$1char*)come_calloc(1, sizeof(struct list$1char)*(1), "/usr/local/include/comelang-pico.h", 5785, "list$1char")),len,self)));
...
struct list$1charp* __result198__;
    __result198__ = gComeFunResultObject = __result_obj__ = ((struct list$1charp*)(__right_value252=list$1charp_initialize_with_values((struct list$1charp*)come_increment_ref_count((struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "/usr/local/include/comelang-pico.h", 5790, "list$1charp")),len,self)));
...
struct list$1short* __result201__;
    __result201__ = gComeFunResultObject = __result_obj__ = ((struct list$1short*)(__right_value257=list$1short_initialize_with_values((struct list$1short*)come_increment_ref_count((struct list$1short*)come_calloc(1, sizeof(struct list$1short)*(1), "/usr/local/include/comelang-pico.h", 5795, "list$1short")),len,self)));
...
struct list$1int* __result204__;
    __result204__ = gComeFunResultObject = __result_obj__ = ((struct list$1int*)(__right_value262=list$1int_initialize_with_values((struct list$1int*)come_increment_ref_count((struct list$1int*)come_calloc(1, sizeof(struct list$1int)*(1), "/usr/local/include/comelang-pico.h", 5800, "list$1int")),len,self)));
...
struct list$1long* __result207__;
    __result207__ = gComeFunResultObject = __result_obj__ = ((struct list$1long*)(__right_value267=list$1long_initialize_with_values((struct list$1long*)come_increment_ref_count((struct list$1long*)come_calloc(1, sizeof(struct list$1long)*(1), "/usr/local/include/comelang-pico.h", 5805, "list$1long")),len,self)));
...
struct list$1float* __result210__;
    __result210__ = gComeFunResultObject = __result_obj__ = ((struct list$1float*)(__right_value272=list$1float_initialize_with_values((struct list$1float*)come_increment_ref_count((struct list$1float*)come_calloc(1, sizeof(struct list$1float)*(1), "/usr/local/include/comelang-pico.h", 5810, "list$1float")),len,self)));
...
struct list$1double* __result213__;
    __result213__ = gComeFunResultObject = __result_obj__ = ((struct list$1double*)(__right_value277=list$1double_initialize_with_values((struct list$1double*)come_increment_ref_count((struct list$1double*)come_calloc(1, sizeof(struct list$1double)*(1), "/usr/local/include/comelang-pico.h", 5815, "list$1double")),len,self)));
...
struct vector$1char* __result215__;
    __result215__ = gComeFunResultObject = __result_obj__ = ((struct vector$1char*)(__right_value280=vector$1char_initialize_with_values((struct vector$1char*)come_increment_ref_count((struct vector$1char*)come_calloc(1, sizeof(struct vector$1char)*(1), "/usr/local/include/comelang-pico.h", 5820, "vector$1char")),len,self)));
...
struct vector$1charp* __result217__;
    __result217__ = gComeFunResultObject = __result_obj__ = ((struct vector$1charp*)(__right_value283=vector$1charp_initialize_with_values((struct vector$1charp*)come_increment_ref_count((struct vector$1charp*)come_calloc(1, sizeof(struct vector$1charp)*(1), "/usr/local/include/comelang-pico.h", 5825, "vector$1charp")),len,self)));
...
struct vector$1short* __result219__;
    __result219__ = gComeFunResultObject = __result_obj__ = ((struct vector$1short*)(__right_value286=vector$1short_initialize_with_values((struct vector$1short*)come_increment_ref_count((struct vector$1short*)come_calloc(1, sizeof(struct vector$1short)*(1), "/usr/local/include/comelang-pico.h", 5830, "vector$1short")),len,self)));
...
struct vector$1int* __result221__;
    __result221__ = gComeFunResultObject = __result_obj__ = ((struct vector$1int*)(__right_value289=vector$1int_initialize_with_values((struct vector$1int*)come_increment_ref_count((struct vector$1int*)come_calloc(1, sizeof(struct vector$1int)*(1), "/usr/local/include/comelang-pico.h", 5835, "vector$1int")),len,self)));
...
struct vector$1long* __result223__;
    __result223__ = gComeFunResultObject = __result_obj__ = ((struct vector$1long*)(__right_value292=vector$1long_initialize_with_values((struct vector$1long*)come_increment_ref_count((struct vector$1long*)come_calloc(1, sizeof(struct vector$1long)*(1), "/usr/local/include/comelang-pico.h", 5840, "vector$1long")),len,self)));
...
struct vector$1float* __result225__;
    __result225__ = gComeFunResultObject = __result_obj__ = ((struct vector$1float*)(__right_value295=vector$1float_initialize_with_values((struct vector$1float*)come_increment_ref_count((struct vector$1float*)come_calloc(1, sizeof(struct vector$1float)*(1), "/usr/local/include/comelang-pico.h", 5845, "vector$1float")),len,self)));
...
struct vector$1double* __result227__;
    __result227__ = gComeFunResultObject = __result_obj__ = ((struct vector$1double*)(__right_value298=vector$1double_initialize_with_values((struct vector$1double*)come_increment_ref_count((struct vector$1double*)come_calloc(1, sizeof(struct vector$1double)*(1), "/usr/local/include/comelang-pico.h", 5850, "vector$1double")),len,self)));
