...
right_value2_298 = (void*)0;
    ...
    if(    list$1sTypeph_length(type->mGenericsTypes)>0) {
        ...
        operator_fun_279=map$2charphsFunphp_operator_load_element(info->funcs,fun_name2_278);
        /* U13 */none_generics_name_280 = come_decrement_ref_count2(none_generics_name_280, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(obj_type_281,sType_finalize, 0, 0, 0, 0, (void*)0);
        /* U13 */fun_name3_282 = come_decrement_ref_count2(fun_name3_282, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    }
        ...
        for(        i_289=128-1;        i_289>=1;        i_289--        ){
            ...
            operator_fun_279=map$2charphsFunphp_operator_load_element(info->funcs,new_fun_name_290);
            if(            operator_fun_279) {
    ...
    if(    operator_fun_279) {
        ...
        check_assign_type(((char*)(__right_value293=xsprintf("\%s is assigned to",((char*)(__right_value292=string_to_string(fun_name2_278)))))),((struct sType*)come_null_check(list$1sTypephp_operator_load_element(operator_fun_279->mParamTypes,0), "18field.c", 63, 0)),left_value->type,left_value,(_Bool)0,(_Bool)1,(_Bool)0,info);
        ...
        if(        ((struct sType*)come_null_check(list$1sTypephp_operator_load_element(operator_fun_279->mParamTypes,0), "18field.c", 64, 1))->mHeap&&left_value->type->mHeap) {
            std_move(((struct sType*)come_null_check(list$1sTypephp_operator_load_element(operator_fun_279->mParamTypes,0), "18field.c", 65, 2)),left_value->type,left_value,info,(_Bool)1);
        ...
        check_assign_type(((char*)(__right_value297=xsprintf("\%s is assigned to",((char*)(__right_value296=string_to_string(fun_name2_278)))))),((struct sType*)come_null_check(list$1sTypephp_operator_load_element(operator_fun_279->mParamTypes,1), "18field.c", 72, 3)),middle_value->type,middle_value,(_Bool)0,(_Bool)1,(_Bool)0,info);
        ...
        if(        ((struct sType*)come_null_check(list$1sTypephp_operator_load_element(operator_fun_279->mParamTypes,1), "18field.c", 73, 4))->mHeap&&middle_value->type->mHeap) {
            std_move(((struct sType*)come_null_check(list$1sTypephp_operator_load_element(operator_fun_279->mParamTypes,1), "18field.c", 74, 5)),middle_value->type,middle_value,info,(_Bool)1);
        ...
        check_assign_type(((char*)(__right_value301=xsprintf("\%s is assigned to",((char*)(__right_value300=string_to_string(fun_name2_278)))))),((struct sType*)come_null_check(list$1sTypephp_operator_load_element(operator_fun_279->mParamTypes,2), "18field.c", 81, 6)),right_value->type,right_value,(_Bool)0,(_Bool)1,(_Bool)0,info);
        ...
        if(        ((struct sType*)come_null_check(list$1sTypephp_operator_load_element(operator_fun_279->mParamTypes,2), "18field.c", 82, 7))->mHeap&&right_value->type->mHeap) {
            std_move(((struct sType*)come_null_check(list$1sTypephp_operator_load_element(operator_fun_279->mParamTypes,2), "18field.c", 83, 8)),right_value->type,right_value,info,(_Bool)1);
        ...
        come_value_292->c_value=(char*)come_increment_ref_count(xsprintf("\%s(\%s,\%s,\%s)",((char*)(__right_value304=string_to_string(fun_name2_278))),((char*)(__right_value305=string_to_string(left_value2_293))),((char*)(__right_value306=string_to_string(middle_value2_297))),((char*)(__right_value307=string_to_string(right_value2_298)))));
        ...
        if(        result_type2_300->mGuardValue&&result_type2_300->mPointerNum>0) {
            ...
            come_value_292->c_value=(char*)come_increment_ref_count(xsprintf("((%s)come_null_check(%s, \"%s\", %d, %d))",((char*)(__right_value312=make_type_name_string(result_type2_300,(_Bool)0,(_Bool)0,(_Bool)0,info,(_Bool)0))),come_value_292->c_value,info->sname,info->sline,gComeDebugStackFrameID++));
...
struct list$1CVALUEph* __result226__;
    if(    self->len==0) {
        litem_301=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(__right_value315=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "./comelang.h", 1106, "list_item$1CVALUEph"))));
        ...
        litem_302=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(__right_value316=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "./comelang.h", 1116, "list_item$1CVALUEph"))));
        ...
        litem_303=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(__right_value317=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "./comelang.h", 1126, "list_item$1CVALUEph"))));
...
char* __result229__;
    __result229__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value322=__builtin_string("sStoreFieldNode")));
...
c_value_353 = (void*)0;
    ...
    if(    string_operator_equals(left_type2_309->mClass->mName,"tuple1")||string_operator_equals(left_type2_309->mClass->mName,"tuple2")||string_operator_equals(left_type2_309->mClass->mName,"tuple3")||string_operator_equals(left_type2_309->mClass->mName,"tuple3")||string_operator_equals(left_type2_309->mClass->mName,"tuple4")||string_operator_equals(left_type2_309->mClass->mName,"tuple5")) {
        for(        i_310=0;        i_310<list$1sTypeph_length(left_type2_309->mGenericsTypes);        i_310++        ){
            if(            string_operator_equals(name_306,((struct sType*)come_null_check(list$1sTypephp_operator_load_element(left_type2_309->mGenericsTypes,i_310), "18field.c", 156, 9))->mTupleName)) {
    ...
    if(    gComeDebug&&left_value_308->type->mPointerNum>0) {
        ...
        left_value_308->c_value=(char*)come_increment_ref_count(xsprintf("((%s)come_null_check(%s, \"%s\", %d, %d))",((char*)(__right_value326=make_type_name_string(left_value_308->type,(_Bool)0,(_Bool)0,(_Bool)0,info,(_Bool)0))),left_value_308->c_value,info->sname,info->sline,gComeDebugStackFrameID++));
    ...
    new_channel_312=string_operator_equals(((char*)(__right_value328=right_305->kind(right_305->_protocol_obj))),"sNewChannel");
    ...
    klass_317=map$2charphsClassphp_operator_load_element(info->classes,klass_317->mName);
    ...
    check_assign_type(((char*)(__right_value338=xsprintf("\%s is assigned to",((char*)(__right_value337=string_to_string(name_306)))))),field_type_325,right_type_314,right_value_313,(_Bool)0,(_Bool)1,(_Bool)0,info);
    ...
    right_type_314=((struct sType*)(__right_value339=sType_clone(right_value_313->type)));
...
char* __result252__;
    __result252__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value376=__builtin_string("sNullCheckNode")));
...
_Bool __result258__;
    ...
    if(    !self->mOnlyNullCecker&&left_value_357->type->mNoSolvedGenericsType&&left_value_357->type->mNoSolvedGenericsType->v1&&left_value_357->type->mNoSolvedGenericsType->v1->mClass&&string_operator_equals(left_value_357->type->mNoSolvedGenericsType->v1->mClass->mName,"optional")) {
        ...
        fun_363=map$2charphsFunphp_operator_load_element(info->funcs,method_name_358);
        if(        fun_363==((void*)0)) {
        ...
        come_value_366->c_value=(char*)come_increment_ref_count(xsprintf("((%s)come_null_check(%s, \"%s\", %d, %d))",((char*)(__right_value388=make_type_name_string(left_value_357->type,(_Bool)0,(_Bool)0,(_Bool)0,info,(_Bool)0))),left_value_357->c_value,info->sname,info->sline,gComeDebugStackFrameID++));
...
char* __result260__;
    __result260__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value393=__builtin_string("sNullableNode")));
...
struct sNode* __result266__;
    ...
    _inf_obj_value1=(struct sNullableNode*)come_increment_ref_count(((struct sNullableNode*)(__right_value401=sNullableNode_initialize((struct sNullableNode*)come_increment_ref_count((struct sNullableNode*)come_calloc(1, sizeof(struct sNullableNode)*(1), "18field.c", 561, "sNullableNode")),left,info))));
    ...
    __result266__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value405=_inf_value1));
    /*g*/come_call_finalizer3(__right_value401,sNullableNode_finalize, 0, 1, 0, 0, __result_obj__);
...
char* __result268__;
    __result268__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value410=__builtin_string("sRangeCheckNode")));
...
_Bool __result271__;
    ...
    if(    left_value_375->type->mPointerNum>0) {
        if(        !gComeDebug) {
            ...
            come_value_382->c_value=(char*)come_increment_ref_count(xsprintf("(*((%s)%s))",((char*)(__right_value416=make_type_name_string(left_value_375->type,(_Bool)0,(_Bool)0,(_Bool)0,info,(_Bool)0))),left_value_375->c_value));
            ...
            come_value_383->c_value=(char*)come_increment_ref_count(xsprintf("(*((%s)come_range_check(%s, %s, %s, \"%s\", %d)))",((char*)(__right_value421=make_type_name_string(left_value_375->type,(_Bool)0,(_Bool)0,(_Bool)0,info,(_Bool)0))),left_value_375->c_value,begin_value_378->c_value,end_value_381->c_value,info->sname,info->sline));
...
char* __result273__;
    __result273__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value427=__builtin_string("sLoadFieldNode")));
...
_Bool __result279__;
    ...
    if(    string_operator_equals(left_type2_388->mClass->mName,"tuple1")||string_operator_equals(left_type2_388->mClass->mName,"tuple2")||string_operator_equals(left_type2_388->mClass->mName,"tuple3")||string_operator_equals(left_type2_388->mClass->mName,"tuple3")||string_operator_equals(left_type2_388->mClass->mName,"tuple4")||string_operator_equals(left_type2_388->mClass->mName,"tuple5")) {
        for(        i_389=0;        i_389<list$1sTypeph_length(left_type2_388->mGenericsTypes);        i_389++        ){
            if(            string_operator_equals(name_385,((struct sType*)come_null_check(list$1sTypephp_operator_load_element(left_type2_388->mGenericsTypes,i_389), "18field.c", 680, 10))->mTupleName)) {
    ...
    if(    gComeDebug&&left_value_387->type->mPointerNum>0) {
        ...
        left_value_387->c_value=(char*)come_increment_ref_count(xsprintf("((%s)come_null_check(%s, \"%s\", %d, %d))",((char*)(__right_value431=make_type_name_string(left_value_387->type,(_Bool)0,(_Bool)0,(_Bool)0,info,(_Bool)0))),left_value_387->c_value,info->sname,info->sline,gComeDebugStackFrameID++));
    ...
    klass_392=map$2charphsClassphp_operator_load_element(info->classes,klass_392->mName);
...
struct sNode* __result282__;
    ...
    _inf_obj_value2=(struct sLoadFieldNode*)come_increment_ref_count(((struct sLoadFieldNode*)(__right_value449=sLoadFieldNode_initialize((struct sLoadFieldNode*)come_increment_ref_count((struct sLoadFieldNode*)come_calloc(1, sizeof(struct sLoadFieldNode)*(1), "18field.c", 807, "sLoadFieldNode")),left,(char*)come_increment_ref_count(name),info))));
    ...
    __result282__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value454=_inf_value2));
    if(left) { left = come_decrement_ref_count2(left, ((struct sNode*)left)->finalize, ((struct sNode*)left)->_protocol_obj, 0, 0, 0, (void*)0); } 
    /* U13 */name = come_decrement_ref_count2(name, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    /*g*/come_call_finalizer3(__right_value449,sLoadFieldNode_finalize, 0, 1, 0, 0, __result_obj__);
...
char* __result284__;
    __result284__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value459=__builtin_string("sStoreArrayNode")));
...
memset(&calling_fun_437, 0, sizeof(_Bool));
    ...
    if(    gComeDebug&&left_value_418->type->mPointerNum>0) {
        ...
        left_value_418->c_value=(char*)come_increment_ref_count(xsprintf("((%s)come_null_check(%s, \"%s\", %d, %d))",((char*)(__right_value461=make_type_name_string(left_value_418->type,(_Bool)0,(_Bool)0,(_Bool)0,info,(_Bool)0))),left_value_418->c_value,info->sname,info->sline,gComeDebugStackFrameID++));
    ...
    if(    self->mQuote) {
        ...
        calling_fun_437=operator_overload_fun2(type_435,fun_name_436,left_value_418,((struct CVALUE*)come_null_check(list$1CVALUEphp_operator_load_element(array_num_420,0), "18field.c", 878, 11)),right_value_432,info);
    }
    if(    !calling_fun_437) {
        ...
        check_assign_type(((char*)(__right_value483=xsprintf("array is assinged to"))),left_type_419,right_type_433,right_value_432,(_Bool)0,(_Bool)1,(_Bool)0,info);
...
char* __result308__;
    __result308__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value495=__builtin_string("sLoadArrayNode")));
    /* U11 */__right_value495 = come_decrement_ref_count2(__right_value495, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
    gComeFunResultObject = (void*)0;
...
memset(&calling_fun_491, 0, sizeof(_Bool));
    ...
    if(    gComeDebug&&left_value_482->type->mPointerNum>0&&!self->mBreakGuard) {
        ...
        left_value_482->c_value=(char*)come_increment_ref_count(xsprintf("((%s)come_null_check(%s, \"%s\", %d, %d))",((char*)(__right_value497=make_type_name_string(left_value_482->type,(_Bool)0,(_Bool)0,(_Bool)0,info,(_Bool)0))),left_value_482->c_value,info->sname,info->sline,gComeDebugStackFrameID++));
    ...
    if(    self->mQuote) {
        ...
        calling_fun_491=operator_overload_fun(type_489,fun_name_490,left_value_482,((struct CVALUE*)come_null_check(list$1CVALUEphp_operator_load_element(array_num_484,0), "18field.c", 1096, 12)),self->mBreakGuard,info);
    }
    if(    !calling_fun_491) {
        if(        gComeDebug&&left_value_482->var&&left_value_482->var->mType&&list$1sNodeph_length(left_value_482->var->mType->mArrayNum)>0) {
            ...
            buffer_append_format(buf_497,"*(%s)come_range_check(&%s",((char*)(__right_value512=make_type_name_string(result_type2_498,(_Bool)0,(_Bool)0,(_Bool)0,info,(_Bool)0))),left_value_482->c_value);
...
char* __result312__;
    __result312__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value530=__builtin_string("sLoadRangeArrayNode")));
...
memset(&calling_fun_527, 0, sizeof(_Bool));
    ...
    if(    self->mQuote) {
        ...
        calling_fun_527=operator_overload_fun2(type_525,fun_name_526,left_value_518,((struct CVALUE*)come_null_check(list$1CVALUEphp_operator_load_element(array_num_520,0), "18field.c", 1306, 13)),((struct CVALUE*)come_null_check(list$1CVALUEphp_operator_load_element(array_num_520,1), "18field.c", 1306, 14)),info);
    }
    if(    !calling_fun_527) {
...
struct sNode* __result318__;
    ...
    _inf_obj_value3=(struct sStoreFieldNode*)come_increment_ref_count(((struct sStoreFieldNode*)(__right_value548=sStoreFieldNode_initialize((struct sStoreFieldNode*)come_increment_ref_count((struct sStoreFieldNode*)come_calloc(1, sizeof(struct sStoreFieldNode)*(1), "18field.c", 1386, "sStoreFieldNode")),left,(struct sNode*)come_increment_ref_count(right),(char*)come_increment_ref_count(name),info))));
    ...
    __result318__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value554=_inf_value3));
    if(right) { right = come_decrement_ref_count2(right, ((struct sNode*)right)->finalize, ((struct sNode*)right)->_protocol_obj, 0, 0, 0, (void*)0); } 
    /* U13 */name = come_decrement_ref_count2(name, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    /*g*/come_call_finalizer3(__right_value548,sStoreFieldNode_finalize, 0, 1, 0, 0, __result_obj__);
...
struct sNode* __result340__;
    while((_Bool)1) {
        ...
        if(        range_array_537&&(*info->p==92&&*(info->p+1)==91||*info->p==91)) {
            ...
            _inf_obj_value4=(struct sLoadRangeArrayNode*)come_increment_ref_count(((struct sLoadRangeArrayNode*)(__right_value564=sLoadRangeArrayNode_initialize((struct sLoadRangeArrayNode*)come_increment_ref_count((struct sLoadRangeArrayNode*)come_calloc(1, sizeof(struct sLoadRangeArrayNode)*(1), "18field.c", 1451, "sLoadRangeArrayNode")),node,(struct list$1sNodeph*)come_increment_ref_count(array_num_545),quote_544,info))));
            ...
            /*g*/come_call_finalizer3(__right_value564,sLoadRangeArrayNode_finalize, 0, 1, 0, 0, __result_obj__);
            ...
            if(            !info->no_assign&&*info->p==61&&*(info->p+1)!=61&&*(info->p+1)!=62) {
                ...
                /*g*/come_call_finalizer3(__right_value576,sStoreArrayNode_finalize, 0, 1, 0, 0, __result_obj__);
                ...
                /*g*/come_call_finalizer3(__right_value584,sLoadArrayNode_finalize, 0, 1, 0, 0, __result_obj__);
            }
            ...
            /*g*/come_call_finalizer3(__right_value593,sRangeCheckNode_finalize, 0, 1, 0, 0, __result_obj__);
            ...
            _inf_obj_value8=(struct sNullCheckNode*)come_increment_ref_count(((struct sNullCheckNode*)(__right_value601=sNullCheckNode_initialize((struct sNullCheckNode*)come_increment_ref_count((struct sNullCheckNode*)come_calloc(1, sizeof(struct sNullCheckNode)*(1), "18field.c", 1566, "sNullCheckNode")),node,(_Bool)0,info))));
            ...
            /*g*/come_call_finalizer3(__right_value601,sNullCheckNode_finalize, 0, 1, 0, 0, __result_obj__);
        }
            ...
            _inf_obj_value9=(struct sNullableNode*)come_increment_ref_count(((struct sNullableNode*)(__right_value607=sNullableNode_initialize((struct sNullableNode*)come_increment_ref_count((struct sNullableNode*)come_calloc(1, sizeof(struct sNullableNode)*(1), "18field.c", 1574, "sNullableNode")),node,info))));
            ...
            /*g*/come_call_finalizer3(__right_value607,sNullableNode_finalize, 0, 1, 0, 0, __result_obj__);
        }
            ...
            if(            !info->no_assign&&*info->p==61&&*(info->p+1)!=61&&*(info->p+1)!=62) {
                ...
                _inf_obj_value10=(struct sStoreFieldNode*)come_increment_ref_count(((struct sStoreFieldNode*)(__right_value618=sStoreFieldNode_initialize((struct sStoreFieldNode*)come_increment_ref_count((struct sStoreFieldNode*)come_calloc(1, sizeof(struct sStoreFieldNode)*(1), "18field.c", 1630, "sStoreFieldNode")),node,(struct sNode*)come_increment_ref_count(right_node_578),(char*)come_increment_ref_count(field_name_573),info))));
                ...
                /*g*/come_call_finalizer3(__right_value618,sStoreFieldNode_finalize, 0, 1, 0, 0, __result_obj__);
                ...
                if(                string_operator_equals(field_name_573,"if")) {
                    ...
                    _inf_obj_value11=(struct sNullCheckNode*)come_increment_ref_count(((struct sNullCheckNode*)(__right_value641=sNullCheckNode_initialize((struct sNullCheckNode*)come_increment_ref_count((struct sNullCheckNode*)come_calloc(1, sizeof(struct sNullCheckNode)*(1), "18field.c", 1656, "sNullCheckNode")),((struct sNode*)(__right_value640=sNode_clone(node))),(_Bool)1,info))));
                    ...
                    /*g*/come_call_finalizer3(__right_value641,sNullCheckNode_finalize, 0, 1, 0, 0, __result_obj__);
                    __dec_obj350=node;
                ...
                _inf_obj_value12=(struct sNullCheckNode*)come_increment_ref_count(((struct sNullCheckNode*)(__right_value650=sNullCheckNode_initialize((struct sNullCheckNode*)come_increment_ref_count((struct sNullCheckNode*)come_calloc(1, sizeof(struct sNullCheckNode)*(1), "18field.c", 1661, "sNullCheckNode")),((struct sNode*)(__right_value649=sNode_clone(node))),(_Bool)1,info))));
                ...
                /*g*/come_call_finalizer3(__right_value650,sNullCheckNode_finalize, 0, 1, 0, 0, __result_obj__);
                _inf_value13=(struct sNode*)come_calloc(1, sizeof(struct sNode), "18field.c", 1662, "struct sNode");
                _inf_obj_value13=(struct sLoadFieldNode*)come_increment_ref_count(((struct sLoadFieldNode*)(__right_value656=sLoadFieldNode_initialize((struct sLoadFieldNode*)come_increment_ref_count((struct sLoadFieldNode*)come_calloc(1, sizeof(struct sLoadFieldNode)*(1), "18field.c", 1662, "sLoadFieldNode")),node,(char*)come_increment_ref_count(field_name_573),info))));
                ...
                /*g*/come_call_finalizer3(__right_value656,sLoadFieldNode_finalize, 0, 1, 0, 0, __result_obj__);
            }
...
struct list$1sNodeph* __result319__;
    if(    self->len==0) {
        litem_547=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value559=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang.h", 1106, "list_item$1sNodeph"))));
        ...
        litem_548=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value560=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang.h", 1116, "list_item$1sNodeph"))));
        ...
        litem_549=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value561=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang.h", 1126, "list_item$1sNodeph"))));
