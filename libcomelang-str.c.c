...
char* __result120__;
    ...
    else if(    self[len_254-1]==13) {
        result_253[len_254-1]=0;
    }
    else if(    len_254>2&&self[len_254-2]==13&&self[len_254-1]==10) {
