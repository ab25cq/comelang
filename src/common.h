...
struct sNodeTreeStruct 
{
    ...
    union {
        ...
        struct {
            int mNumVars;
            char mVarNames[64][VAR_NAME_MAX];
            BOOL mAlloc;
        ...
        struct {
            sVarTable* mVarTable;
            char mCurrentStackFrameTypeName[VAR_NAME_MAX];
        } sStack;
...
void free_protocol_object(LLVMValueRef protocol_obj, sCompileInfo* info);
...
/// node_op.c ///
//////////////////////////////
BOOL call_operator_function(char* fun_base_name, sNodeType* left_type, int num_params, LVALUE* params, BOOL* found, BOOL move_, sCompileInfo* info);
