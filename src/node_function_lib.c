...
sFunction* create_fun(char* name, int num_params, char** param_names, sNodeType** param_types, char** param_default_values, BOOL* param_labels, sNodeType* result_type, LLVMValueRef llvm_fun, char* block_text, BOOL generics_function, BOOL var_args, int num_generics, char** generics_type_names, int num_method_generics, char** mgenerics_type_names, BOOL extern_, char* asm_fun_name, BOOL user, char* source, char* sname, int sline, BOOL immutable_, BOOL flag_asm_fun_name)
{
