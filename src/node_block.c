...
BOOL parse_block_easy(ALLOC sNodeBlock** node_block, BOOL extern_c_lang, BOOL result_type_is_void, sParserInfo* info)
{
    ...
    *node_block = ALLOC sNodeBlock_alloc();
    ...
    if(!parse_block(*node_block, extern_c_lang, single_expression, result_type_is_void, FALSE, info)) {
...
BOOL parse_block(sNodeBlock* node_block, BOOL extern_c_lang, BOOL single_expression, BOOL result_type_is_void, BOOL return_self, sParserInfo* info)
{
