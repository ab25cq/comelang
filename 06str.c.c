...
memset(&c_450, 0, sizeof(unsigned int));
...
memset(&size_458, 0, sizeof(int));
    if(    *info->p==34&&*(info->p+1)==34&&*(info->p+2)==34&&*(info->p+3)==10) {
        ...
        if(        *info->p==92) {
            ...
            if(            p2_457>127) {
                char str_459[4+1];
                memset(&str_459, 0, sizeof(char)                *(4+1)                );
        ...
        wstr_467=(unsigned int*)come_increment_ref_count((unsigned int*)come_calloc(1, sizeof(unsigned int)*(1*(len_466+1)), "06str.c", 2310, "int"));
...
struct sWStringNode* __result222__;
    ...
    if(    self!=((void*)0)&&self->value!=((void*)0)) {
        ...
        result_469->value=(unsigned int*)come_increment_ref_count((unsigned int*)come_memdup(self->value, "sWStringNode_clone", 6, "unsigned int*"));
