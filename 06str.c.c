...
memset(&lont_395, 0, sizeof(unsigned long unsigned  int));
    if(    *info->p==34&&*(info->p+1)==34&&*(info->p+2)==34&&*(info->p+3)==10) {
        ...
        if(        *info->p==92) {
            ...
            if(            p2_383>127) {
                char str_385[6+1];
                memset(&str_385, 0, sizeof(char)                *(6+1)                );
        ...
        wstr_399=(int*)come_increment_ref_count((int*)come_calloc(1, sizeof(int)*(1*(len_398+1)), "06str.c", 1931, "int"));
        ...
        _inf_obj_value9=come_increment_ref_count(((struct sWStringNode*)(__right_value615=sWStringNode_initialize((struct sWStringNode*)come_increment_ref_count((struct sWStringNode*)come_calloc(1, sizeof(struct sWStringNode)*(1), "06str.c", 1942, "sWStringNode")),(int*)come_increment_ref_count(wstr_399),sline_387,info))));
...
struct sWStringNode* __result198__;
    ...
    if(    self!=((void*)0)&&self->value!=((void*)0)) {
        ...
        result_401->value=(int*)come_increment_ref_count((int*)come_memdup(self->value, "sWStringNode_clone", 6, "int*"));
