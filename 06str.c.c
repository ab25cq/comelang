        ...
        for(        o2_saved_90=(struct list$1sNodeph*)come_increment_ref_count((self->exps)),it_93=list$1sNodeph_begin((o2_saved_90));        !list$1sNodeph_end((o2_saved_90));        it_93=list$1sNodeph_next((o2_saved_90))        ){
            ...
            if(            map$2charphsFunph_at(info->funcs,method_name_110,((void*)0))==((void*)0)) {
                ...
                if(                obj_type_113&&list$1sTypeph_length(obj_type_113->mGenericsTypes)>0) {
                    ...
                    multiple_assign_var1=((struct tuple2$2sFunpcharph*)(__right_value176=create_to_string_automatically(come_value_type_97,"to_string",info)));
            ...
            c_value_119=(char*)come_increment_ref_count(append_object_to_right_values(((char*)(__right_value181=buffer_to_string(buf2_117))),(struct sType*)come_increment_ref_count(type_118),info));
...
struct sType* __result95__;
    ...
    if(    self!=((void*)0)&&self->mNoSolvedGenericsType!=((void*)0)) {
        __dec_obj59=result_98->mNoSolvedGenericsType;
    ...
    if(    self!=((void*)0)&&self->mOriginalLoadVarType!=((void*)0)) {
        __dec_obj60=result_98->mOriginalLoadVarType;
    ...
    if(    self!=((void*)0)&&self->mNoExceptionType!=((void*)0)) {
        __dec_obj61=result_98->mNoExceptionType;
    ...
    if(    self!=((void*)0)&&self->mGenericsName!=((void*)0)) {
        __dec_obj62=result_98->mGenericsName;
    ...
    if(    self!=((void*)0)&&self->mGenericsTypes!=((void*)0)) {
        __dec_obj66=result_98->mGenericsTypes;
    ...
    if(    self!=((void*)0)&&self->mArrayNum!=((void*)0)) {
        __dec_obj67=result_98->mArrayNum;
    ...
    if(    self!=((void*)0)&&self->mParamTypes!=((void*)0)) {
        __dec_obj68=result_98->mParamTypes;
    ...
    if(    self!=((void*)0)&&self->mParamNames!=((void*)0)) {
        __dec_obj72=result_98->mParamNames;
    ...
    if(    self!=((void*)0)&&self->mResultType!=((void*)0)) {
        __dec_obj73=result_98->mResultType;
    ...
    if(    self!=((void*)0)&&self->mAlignas!=((void*)0)) {
        __dec_obj74=result_98->mAlignas;
    ...
    if(    self!=((void*)0)&&self->mChannelType!=((void*)0)) {
        __dec_obj75=result_98->mChannelType;
        result_98->mChannelType=(struct tuple1$1sTypeph*)come_increment_ref_count(tuple1$1sTypephp_clone(self->mChannelType));
    ...
    if(    self!=((void*)0)) {
        result_98->mChannel=self->mChannel;
    }
    if(    self!=((void*)0)) {
    ...
    if(    self!=((void*)0)&&self->mSizeNum!=((void*)0)) {
        __dec_obj76=result_98->mSizeNum;
    ...
    if(    self!=((void*)0)&&self->mOriginalTypeName!=((void*)0)) {
        __dec_obj77=result_98->mOriginalTypeName;
    ...
    if(    self!=((void*)0)&&self->mAsmName!=((void*)0)) {
        __dec_obj78=result_98->mAsmName;
...
struct list$1sTypeph* __result90__;
    ...
    result_100=(struct list$1sTypeph*)come_increment_ref_count(list$1sTypeph_initialize((struct list$1sTypeph*)come_increment_ref_count((struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "/usr/local/include/comelang.h", 135, "list$1sTypeph"))));
    it_101=self->head;
    while(it_101!=((void*)0)) {
...
struct list$1sTypeph* __result89__;
    if(    self->len==0) {
        litem_102=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value152=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang.h", 149, "list_item$1sTypeph"))));
        ...
        litem_103=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value153=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang.h", 159, "list_item$1sTypeph"))));
        litem_103->prev=self->head;
        litem_103->next=((void*)0);
        __dec_obj64=litem_103->item;
        ...
        litem_104=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value154=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang.h", 169, "list_item$1sTypeph"))));
        litem_104->prev=self->tail;
        litem_104->next=((void*)0);
        __dec_obj65=litem_104->item;
...
struct list$1charph* __result94__;
    ...
    result_105=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang.h", 135, "list$1charph"))));
    it_106=self->head;
    while(it_106!=((void*)0)) {
...
struct list$1charph* __result93__;
    if(    self->len==0) {
        litem_107=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value161=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 149, "list_item$1charph"))));
        ...
        litem_108=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value162=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 159, "list_item$1charph"))));
        litem_108->prev=self->head;
        litem_108->next=((void*)0);
        __dec_obj70=litem_108->item;
        ...
        litem_109=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value163=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 169, "list_item$1charph"))));
...
_Bool __result103__;
    ...
    __dec_obj101=come_value_121->type;
...
_Bool __result106__;
    ...
    if(    self->quote) {
        __dec_obj103=come_value_122->c_value;
    ...
    __dec_obj105=come_value_122->type;
...
struct list$1tuple2$2charphsNodephph* __result115__;
    if(    self->len==0) {
        litem_129=(struct list_item$1tuple2$2charphsNodephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsNodephph*)(__right_value220=(struct list_item$1tuple2$2charphsNodephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsNodephph)*(1), "/usr/local/include/comelang.h", 149, "list_item$1tuple2$2charphsNodephph"))));
        litem_129->prev=((void*)0);
        litem_129->next=((void*)0);
        __dec_obj121=litem_129->item;
        ...
        litem_130=(struct list_item$1tuple2$2charphsNodephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsNodephph*)(__right_value221=(struct list_item$1tuple2$2charphsNodephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsNodephph)*(1), "/usr/local/include/comelang.h", 159, "list_item$1tuple2$2charphsNodephph"))));
        litem_130->prev=self->head;
        litem_130->next=((void*)0);
        __dec_obj124=litem_130->item;
...
struct sType* list_type_164;
void* __right_value297 = (void*)0;
void* __right_value298 = (void*)0;
struct sType* obj_type_168;
char* fun_name_169;
...
struct CVALUE* obj_value_174;
void* __right_value307 = (void*)0;
void* __right_value308 = (void*)0;
struct buffer* num_string_175;
...
_Bool __result137__;
    ...
    for(    o2_saved_139=(list_elements_133),it_140=list$1sNodeph_begin((o2_saved_139));    !list$1sNodeph_end((o2_saved_139));    it_140=list$1sNodeph_next((o2_saved_139))    ){
        if(        (_if_conditional1=(string_operator_equals(((char*)(__right_value263=it_140->kind(it_140->_protocol_obj))),"sWildCard"))),        /* U10 */ (__right_value263 = come_decrement_ref_count2(__right_value263, (void*)0, (void*)0, 1, 0, 0, (void*)0)),
        _if_conditional1) {
            value_node_141=(struct sNode*)come_increment_ref_count(create_load_var(((char*)(__right_value264=xsprintf("Value"))),info));
            ...
            exp_143=(struct sNode*)come_increment_ref_count(create_method_call(((char*)(__right_value275=xsprintf("operator_load_element"))),(struct sNode*)come_increment_ref_count(value_node_141),(struct list$1tuple2$2charphsNodephph*)come_increment_ref_count(params_142),((void*)0),0,((void*)0),info));
            /* U11 */__right_value275 = come_decrement_ref_count2(__right_value275, (void*)0, (void*)0, 1, 0, 0, (void*)0);
            __dec_obj136=exp_143;
        ...
        if(        list_element_type_137) {
            check_assign_type(((char*)(__right_value279=xsprintf("invalid list element type"))),list_element_type_137,come_value_144->type,come_value_144,(_Bool)0,(_Bool)1,(_Bool)0,info);
        ...
        __dec_obj137=list_element_type_137;
    ...
    add_come_code_at_function_head(info,"%s;\n",((char*)(__right_value288=make_define_var(type_values_145,var__151->mCValueName,(_Bool)0,info))));
    ...
    for(    o2_saved_154=(struct list$1CVALUEph*)come_increment_ref_count((params_134)),it_157=list$1CVALUEph_begin((o2_saved_154));    !list$1CVALUEph_end((o2_saved_154));    it_157=list$1CVALUEph_next((o2_saved_154))    ){
        if(        list_element_type_137->mHeap) {
            c_value_160=(char*)come_increment_ref_count(increment_ref_count_object(((struct CVALUE*)come_null_check(list$1CVALUEphp_operator_load_element(params_134,i_153), "06str.c", 346, 0))->type,((struct CVALUE*)come_null_check(list$1CVALUEphp_operator_load_element(params_134,i_153), "06str.c", 346, 1))->c_value,info));
            buffer_append_format(source_152,"%s[%d]=%s,\n",var__151->mCValueName,i_153,c_value_160);
            /* U13 */c_value_160 = come_decrement_ref_count2(c_value_160, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        }
        else {
            buffer_append_format(source_152,"%s[%d]=%s,\n",var__151->mCValueName,i_153,((struct CVALUE*)come_null_check(list$1CVALUEphp_operator_load_element(params_134,i_153), "06str.c", 350, 2))->c_value);
        }
        i_153++;
    }
    /*i*/come_call_finalizer3(o2_saved_154,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
    list_type_164=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "06str.c", 359, "sType")),"list",(_Bool)0,info));
    list$1sTypeph_push_back(list_type_164->mGenericsTypes,(struct sType*)come_increment_ref_count(sType_clone(list_element_type_137)));
    obj_type_168=(struct sType*)come_increment_ref_count(sType_clone(list_type_164));
    fun_name_169="initialize_with_values";
    generics_fun_name_170=(char*)come_increment_ref_count(string_to_string(((char*)(__right_value300=make_generics_function(obj_type_168,(char*)come_increment_ref_count(__builtin_string(fun_name_169)),info,(_Bool)1)))));
    /* U11 */__right_value300 = come_decrement_ref_count2(__right_value300, (void*)0, (void*)0, 1, 0, 0, (void*)0);
    fun_171=map$2charphsFunph_at(info->funcs,generics_fun_name_170,((void*)0));
    if(    fun_171==((void*)0)) {
        __dec_obj144=generics_fun_name_170;
        generics_fun_name_170=(char*)come_increment_ref_count(create_method_name(obj_type_168,(_Bool)0,((char*)(__right_value302=__builtin_string(fun_name_169))),info,(_Bool)1));
        ...
        if(        fun_171==((void*)0)) {
            ...
            /*i*/come_call_finalizer3(list_type_164,sType_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(obj_type_168,sType_finalize, 0, 0, 0, 0, (void*)0);
            /* U13 */generics_fun_name_170 = come_decrement_ref_count2(generics_fun_name_170, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            return __result134__;
        }
    }
    result_type_172=(struct sType*)come_increment_ref_count(sType_clone(fun_171->mResultType));
    result_type_172->mStatic=(_Bool)0;
    type_173=list_type_164;
    obj_value_174=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 385, "CVALUE"))));
    num_string_175=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 387, "buffer"))));
    buffer_append_str(num_string_175,"1");
    type2_176=(struct sType*)come_increment_ref_count(solve_generics(type_173,type_173,info));
    type_name_177=(char*)come_increment_ref_count(make_type_name_string(type2_176,(_Bool)0,(_Bool)1,(_Bool)0,info,(_Bool)0));
    __dec_obj145=obj_value_174->c_value;
    obj_value_174->c_value=(char*)come_increment_ref_count(xsprintf("(%s*)come_calloc(1, sizeof(%s)*(%s), \"%s\", %d, \"%s\")",type_name_177,type_name_177,((char*)(__right_value311=buffer_to_string(num_string_175))),info->sname,info->sline,type_name_177));
    ...
    type3_178=(struct sType*)come_increment_ref_count(sType_clone(type2_176));
    type3_178->mPointerNum++;
    type3_178->mHeap=(_Bool)1;
    type2_176->mHeap=(_Bool)1;
    __dec_obj146=obj_value_174->type;
    obj_value_174->type=(struct sType*)come_increment_ref_count(sType_clone(type2_176));
    come_call_finalizer3(__dec_obj146,sType_finalize, 0, 0, 0, 0, (void*)0);
    obj_value_174->type->mPointerNum++;
    obj_value_174->var=((void*)0);
    append_object_to_right_values2(obj_value_174,(struct sType*)come_increment_ref_count(type3_178),info,(_Bool)0);
    come_params_179=(struct list$1CVALUEph*)come_increment_ref_count(list$1CVALUEph_initialize((struct list$1CVALUEph*)come_increment_ref_count((struct list$1CVALUEph*)come_calloc(1, sizeof(struct list$1CVALUEph)*(1), "06str.c", 407, "list$1CVALUEph"))));
    if(    ((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_171->mParamTypes,0), "06str.c", 409, 3))->mHeap&&obj_value_174->type->mHeap) {
        std_move(((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_171->mParamTypes,0), "06str.c", 410, 4)),obj_value_174->type,obj_value_174,info,(_Bool)1);
    }
    list$1CVALUEph_push_back(come_params_179,(struct CVALUE*)come_increment_ref_count(obj_value_174));
    come_value2_183=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 414, "CVALUE"))));
    __dec_obj147=come_value2_183->c_value;
    come_value2_183->c_value=(char*)come_increment_ref_count(xsprintf("%d",list$1CVALUEph_length(params_134)));
    /*G*/ __dec_obj147 = come_decrement_ref_count2(__dec_obj147, (void*)0, (void*)0, 0,0,0, (void*)0);
    __dec_obj148=come_value2_183->type;
    come_value2_183->type=((void*)0);
    come_call_finalizer3(__dec_obj148,sType_finalize, 0, 0, 0, 0, (void*)0);
    come_value2_183->var=((void*)0);
    list$1CVALUEph_push_back(come_params_179,(struct CVALUE*)come_increment_ref_count(come_value2_183));
    come_value3_184=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 422, "CVALUE"))));
    __dec_obj149=come_value3_184->c_value;
    come_value3_184->c_value=(char*)come_increment_ref_count(xsprintf("%s",var__151->mCValueName));
    /*G*/ __dec_obj149 = come_decrement_ref_count2(__dec_obj149, (void*)0, (void*)0, 0,0,0, (void*)0);
    __dec_obj150=come_value3_184->type;
    come_value3_184->type=((void*)0);
    come_call_finalizer3(__dec_obj150,sType_finalize, 0, 0, 0, 0, (void*)0);
    come_value3_184->var=((void*)0);
    list$1CVALUEph_push_back(come_params_179,(struct CVALUE*)come_increment_ref_count(come_value3_184));
    buffer_append_str(source_152,generics_fun_name_170);
    buffer_append_str(source_152,"(");
    j_185=0;
    for(    o2_saved_186=(struct list$1CVALUEph*)come_increment_ref_count((come_params_179)),it_187=list$1CVALUEph_begin((o2_saved_186));    !list$1CVALUEph_end((o2_saved_186));    it_187=list$1CVALUEph_next((o2_saved_186))    ){
        buffer_append_str(source_152,it_187->c_value);
        if(        j_185!=list$1CVALUEph_length(come_params_179)-1) {
            buffer_append_str(source_152,",");
        }
        j_185++;
    }
    /*i*/come_call_finalizer3(o2_saved_186,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
    buffer_append_str(source_152,")");
    buffer_append_str(source_152,")");
    come_value4_188=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 448, "CVALUE"))));
    __dec_obj151=come_value4_188->c_value;
    come_value4_188->c_value=(char*)come_increment_ref_count(buffer_to_string(source_152));
    /*G*/ __dec_obj151 = come_decrement_ref_count2(__dec_obj151, (void*)0, (void*)0, 0,0,0, (void*)0);
    __dec_obj152=come_value4_188->type;
    come_value4_188->type=(struct sType*)come_increment_ref_count(sType_clone(result_type_172));
    come_call_finalizer3(__dec_obj152,sType_finalize, 0, 0, 0, 0, (void*)0);
    come_value4_188->type->mStatic=(_Bool)0;
    come_value4_188->var=((void*)0);
    if(    result_type_172->mHeap) {
        append_object_to_right_values2(come_value4_188,(struct sType*)come_increment_ref_count(result_type_172),info,(_Bool)0);
    }
    list$1CVALUEph_push_back(info->stack,(struct CVALUE*)come_increment_ref_count(come_value4_188));
    add_come_last_code(info,"%s",come_value4_188->c_value);
    ...
    /*i*/come_call_finalizer3(obj_type_168,sType_finalize, 0, 0, 0, 0, (void*)0);
    /* U13 */generics_fun_name_170 = come_decrement_ref_count2(generics_fun_name_170, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(result_type_172,sType_finalize, 0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(obj_value_174,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(num_string_175,buffer_finalize, 0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(type2_176,sType_finalize, 0, 0, 0, 0, (void*)0);
    /* U13 */type_name_177 = come_decrement_ref_count2(type_name_177, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(type3_178,sType_finalize, 0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(come_params_179,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(come_value2_183,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(come_value3_184,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(come_value4_188,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
...
struct list$1sNodeph* __result124__;
    if(    self->len==0) {
        litem_146=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value282=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 219, "list_item$1sNodeph"))));
        litem_146->prev=((void*)0);
        litem_146->next=((void*)0);
        __dec_obj138=litem_146->item;
        ...
        litem_147=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value283=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 229, "list_item$1sNodeph"))));
        litem_147->prev=self->head;
        litem_147->next=((void*)0);
        __dec_obj139=litem_147->item;
        ...
        litem_148=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value284=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 239, "list_item$1sNodeph"))));
        litem_148->prev=self->tail;
        litem_148->next=((void*)0);
        __dec_obj140=litem_148->item;
...
struct CVALUE* default_value_163;
...
default_value_163 = (void*)0;
    ...
    while(it_161!=((void*)0)) {
        if(        position==i_162) {
            __result131__ = gComeFunResultObject = __result_obj__ = it_161->item;
            gComeFunResultObject = (void*)0;
    ...
    memset(&default_value_163,0,sizeof(struct CVALUE*));
    __result132__ = gComeFunResultObject = __result_obj__ = default_value_163;
    /*i*/come_call_finalizer3(default_value_163,CVALUE_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
struct list$1sTypeph* __result133__;
    if(    self->len==0) {
        litem_165=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value294=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang.h", 219, "list_item$1sTypeph"))));
        litem_165->prev=((void*)0);
        litem_165->next=((void*)0);
        __dec_obj141=litem_165->item;
        ...
        litem_166=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value295=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang.h", 229, "list_item$1sTypeph"))));
        litem_166->prev=self->head;
        litem_166->next=((void*)0);
        __dec_obj142=litem_166->item;
        ...
        litem_167=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value296=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang.h", 239, "list_item$1sTypeph"))));
        litem_167->prev=self->tail;
        litem_167->next=((void*)0);
        __dec_obj143=litem_167->item;
...
default_value_182 = (void*)0;
    ...
    while(it_180!=((void*)0)) {
        if(        position==i_181) {
            __result135__ = gComeFunResultObject = __result_obj__ = it_180->item;
            gComeFunResultObject = (void*)0;
    ...
    __result136__ = gComeFunResultObject = __result_obj__ = default_value_182;
    /*i*/come_call_finalizer3(default_value_182,sType_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
_Bool sTupleNode_compile(struct sTupleNode* self, struct sInfo* info){
struct list$1sNodeph* tuple_elements_189;
void* __right_value329 = (void*)0;
void* __right_value330 = (void*)0;
struct list$1sTypeph* tuple_types_190;
void* __right_value331 = (void*)0;
void* __right_value332 = (void*)0;
struct list$1CVALUEph* tuple_values_191;
int n_192;
...
struct CVALUE* obj_value_206;
void* __right_value351 = (void*)0;
void* __right_value352 = (void*)0;
struct buffer* num_string_207;
...
struct list$1CVALUEph* come_params_216;
int i_217;
...
_Bool __result151__;
    tuple_elements_189=self->tuple_elements;
    tuple_types_190=(struct list$1sTypeph*)come_increment_ref_count(list$1sTypeph_initialize((struct list$1sTypeph*)come_increment_ref_count((struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "06str.c", 485, "list$1sTypeph"))));
    tuple_values_191=(struct list$1CVALUEph*)come_increment_ref_count(list$1CVALUEph_initialize((struct list$1CVALUEph*)come_increment_ref_count((struct list$1CVALUEph*)come_calloc(1, sizeof(struct list$1CVALUEph)*(1), "06str.c", 486, "list$1CVALUEph"))));
    n_192=0;
    for(    o2_saved_193=(tuple_elements_189),it_194=list$1sNodeph_begin((o2_saved_193));    !list$1sNodeph_end((o2_saved_193));    it_194=list$1sNodeph_next((o2_saved_193))    ){
        if(        (_if_conditional2=(string_operator_equals(((char*)(__right_value333=it_194->kind(it_194->_protocol_obj))),"sWildCard"))),        /* U10 */ (__right_value333 = come_decrement_ref_count2(__right_value333, (void*)0, (void*)0, 1, 0, 0, (void*)0)),
        _if_conditional2) {
            value_node_195=(struct sNode*)come_increment_ref_count(create_load_var(((char*)(__right_value334=xsprintf("Value"))),info));
            /* U11 */__right_value334 = come_decrement_ref_count2(__right_value334, (void*)0, (void*)0, 1, 0, 0, (void*)0);
            exp_196=(struct sNode*)come_increment_ref_count(load_field((struct sNode*)come_increment_ref_count(value_node_195),(char*)come_increment_ref_count(xsprintf("v%d",n_192+1)),info));
            if(            !node_compile(exp_196,info)) {
                __result140__ = (_Bool)0;
                if(value_node_195) { value_node_195 = come_decrement_ref_count2(value_node_195, ((struct sNode*)value_node_195)->finalize, ((struct sNode*)value_node_195)->_protocol_obj, 0, 0, 0, (void*)0); } 
                ...
                /*i*/come_call_finalizer3(tuple_types_190,list$1sTypephp_finalize, 0, 0, 0, 0, (void*)0);
                /*i*/come_call_finalizer3(tuple_values_191,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
        ...
        come_value_197=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        dec_stack_ptr(1,info);
        list$1CVALUEph_push_back(tuple_values_191,(struct CVALUE*)come_increment_ref_count(CVALUE_clone(come_value_197)));
        list$1sTypeph_push_back(tuple_types_190,(struct sType*)come_increment_ref_count(sType_clone(come_value_197->type)));
        n_192++;
        /*i*/come_call_finalizer3(come_value_197,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    type_199=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "06str.c", 512, "sType")),((char*)(__right_value346=xsprintf("tuple%d",list$1sTypeph_length(tuple_types_190)))),(_Bool)0,info));
    /* U11 */__right_value346 = come_decrement_ref_count2(__right_value346, (void*)0, (void*)0, 1, 0, 0, (void*)0);
    for(    o2_saved_200=(struct list$1sTypeph*)come_increment_ref_count((tuple_types_190)),it_203=list$1sTypeph_begin((o2_saved_200));    !list$1sTypeph_end((o2_saved_200));    it_203=list$1sTypeph_next((o2_saved_200))    ){
        list$1sTypeph_push_back(type_199->mGenericsTypes,(struct sType*)come_increment_ref_count(sType_clone(it_203)));
    }
    /*i*/come_call_finalizer3(o2_saved_200,list$1sTypephp_finalize, 0, 0, 0, 0, (void*)0);
    obj_value_206=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 518, "CVALUE"))));
    num_string_207=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 520, "buffer"))));
    buffer_append_str(num_string_207,"1");
    type2_208=(struct sType*)come_increment_ref_count(solve_generics(type_199,type_199,info));
    type_name_209=(char*)come_increment_ref_count(make_type_name_string(type2_208,(_Bool)0,(_Bool)1,(_Bool)0,info,(_Bool)0));
    __dec_obj159=obj_value_206->c_value;
    obj_value_206->c_value=(char*)come_increment_ref_count(xsprintf("(%s*)come_calloc(1, sizeof(%s)*(%s), \"%s\", %d, \"%s\")",type_name_209,type_name_209,((char*)(__right_value355=buffer_to_string(num_string_207))),info->sname,info->sline,type_name_209));
    ...
    type3_210=(struct sType*)come_increment_ref_count(sType_clone(type2_208));
    type3_210->mPointerNum++;
    type3_210->mHeap=(_Bool)1;
    type2_208->mHeap=(_Bool)1;
    __dec_obj160=obj_value_206->type;
    obj_value_206->type=(struct sType*)come_increment_ref_count(sType_clone(type2_208));
    come_call_finalizer3(__dec_obj160,sType_finalize, 0, 0, 0, 0, (void*)0);
    obj_value_206->type->mPointerNum++;
    obj_value_206->var=((void*)0);
    append_object_to_right_values2(obj_value_206,(struct sType*)come_increment_ref_count(type3_210),info,(_Bool)0);
    obj_type_211=(struct sType*)come_increment_ref_count(sType_clone(type2_208));
    fun_name_212="initialize";
    generics_fun_name_213=(char*)come_increment_ref_count(string_to_string(((char*)(__right_value361=make_generics_function(obj_type_211,(char*)come_increment_ref_count(__builtin_string(fun_name_212)),info,(_Bool)1)))));
    ...
    if(    fun_214==((void*)0)) {
        __dec_obj161=generics_fun_name_213;
        generics_fun_name_213=(char*)come_increment_ref_count(create_method_name(obj_type_211,(_Bool)0,((char*)(__right_value363=__builtin_string(fun_name_212))),info,(_Bool)1));
        ...
        if(        fun_214==((void*)0)) {
            ...
            /*i*/come_call_finalizer3(obj_value_206,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(num_string_207,buffer_finalize, 0, 0, 0, 0, (void*)0);
            ...
            /*i*/come_call_finalizer3(type3_210,sType_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(obj_type_211,sType_finalize, 0, 0, 0, 0, (void*)0);
            /* U13 */generics_fun_name_213 = come_decrement_ref_count2(generics_fun_name_213, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            return __result150__;
        }
    }
    result_type_215=(struct sType*)come_increment_ref_count(sType_clone(fun_214->mResultType));
    result_type_215->mStatic=(_Bool)0;
    come_params_216=(struct list$1CVALUEph*)come_increment_ref_count(list$1CVALUEph_initialize((struct list$1CVALUEph*)come_increment_ref_count((struct list$1CVALUEph*)come_calloc(1, sizeof(struct list$1CVALUEph)*(1), "06str.c", 561, "list$1CVALUEph"))));
    if(    ((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_214->mParamTypes,0), "06str.c", 563, 5))->mHeap&&obj_value_206->type->mHeap) {
        std_move(((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_214->mParamTypes,0), "06str.c", 564, 6)),obj_value_206->type,obj_value_206,info,(_Bool)1);
    }
    list$1CVALUEph_push_back(come_params_216,(struct CVALUE*)come_increment_ref_count(obj_value_206));
    i_217=1;
    for(    o2_saved_218=(struct list$1CVALUEph*)come_increment_ref_count((tuple_values_191)),it_219=list$1CVALUEph_begin((o2_saved_218));    !list$1CVALUEph_end((o2_saved_218));    it_219=list$1CVALUEph_next((o2_saved_218))    ){
        come_value_220=(struct CVALUE*)come_increment_ref_count(CVALUE_clone(it_219));
        if(        ((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_214->mParamTypes,i_217), "06str.c", 572, 7))&&((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_214->mParamTypes,i_217), "06str.c", 572, 8))->mHeap&&come_value_220->type->mHeap) {
            std_move(((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_214->mParamTypes,i_217), "06str.c", 573, 9)),come_value_220->type,come_value_220,info,(_Bool)1);
        }
        list$1CVALUEph_push_back(come_params_216,(struct CVALUE*)come_increment_ref_count(come_value_220));
        i_217++;
        /*i*/come_call_finalizer3(come_value_220,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    /*i*/come_call_finalizer3(o2_saved_218,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
    buf_221=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 580, "buffer"))));
    buffer_append_str(buf_221,generics_fun_name_213);
    buffer_append_str(buf_221,"(");
    j_222=0;
    for(    o2_saved_223=(struct list$1CVALUEph*)come_increment_ref_count((come_params_216)),it_224=list$1CVALUEph_begin((o2_saved_223));    !list$1CVALUEph_end((o2_saved_223));    it_224=list$1CVALUEph_next((o2_saved_223))    ){
        buffer_append_str(buf_221,it_224->c_value);
        if(        j_222!=list$1CVALUEph_length(come_params_216)-1) {
            buffer_append_str(buf_221,",");
        }
        j_222++;
    }
    /*i*/come_call_finalizer3(o2_saved_223,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
    buffer_append_str(buf_221,")");
    come_value2_225=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 597, "CVALUE"))));
    __dec_obj162=come_value2_225->c_value;
    come_value2_225->c_value=(char*)come_increment_ref_count(buffer_to_string(buf_221));
    /*G*/ __dec_obj162 = come_decrement_ref_count2(__dec_obj162, (void*)0, (void*)0, 0,0,0, (void*)0);
    __dec_obj163=come_value2_225->type;
    come_value2_225->type=(struct sType*)come_increment_ref_count(sType_clone(result_type_215));
    come_call_finalizer3(__dec_obj163,sType_finalize, 0, 0, 0, 0, (void*)0);
    come_value2_225->type->mStatic=(_Bool)0;
    come_value2_225->var=((void*)0);
    if(    result_type_215->mHeap) {
        append_object_to_right_values2(come_value2_225,(struct sType*)come_increment_ref_count(result_type_215),info,(_Bool)0);
    }
    ...
    /*i*/come_call_finalizer3(obj_type_211,sType_finalize, 0, 0, 0, 0, (void*)0);
    /* U13 */generics_fun_name_213 = come_decrement_ref_count2(generics_fun_name_213, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(result_type_215,sType_finalize, 0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(come_params_216,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
...
struct CVALUE* __result143__;
    ...
    result_198=(struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "CVALUE_clone", 3, "CVALUE"));
    if(    self!=((void*)0)&&self->c_value!=((void*)0)) {
        __dec_obj156=result_198->c_value;
        result_198->c_value=(char*)come_increment_ref_count(string_clone(self->c_value));
        /*G*/ __dec_obj156 = come_decrement_ref_count2(__dec_obj156, (void*)0, (void*)0, 0,0,0, (void*)0);
    }
    if(    self!=((void*)0)&&self->type!=((void*)0)) {
        __dec_obj157=result_198->type;
        result_198->type=(struct sType*)come_increment_ref_count(sType_clone(self->type));
        come_call_finalizer3(__dec_obj157,sType_finalize, 0, 0, 0, 0, (void*)0);
    }
    if(    self!=((void*)0)) {
        result_198->var=self->var;
    }
    if(    self!=((void*)0)) {
        result_198->right_value_objects=self->right_value_objects;
    }
    if(    self!=((void*)0)&&self->c_value_without_right_value_objects!=((void*)0)) {
        __dec_obj158=result_198->c_value_without_right_value_objects;
        result_198->c_value_without_right_value_objects=(char*)come_increment_ref_count(string_clone(self->c_value_without_right_value_objects));
        /*G*/ __dec_obj158 = come_decrement_ref_count2(__dec_obj158, (void*)0, (void*)0, 0,0,0, (void*)0);
    }
    __result143__ = gComeFunResultObject = __result_obj__ = result_198;
    /*i*/come_call_finalizer3(result_198,CVALUE_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
result_202 = (void*)0;
    if(    self==((void*)0)) {
        ...
        __result144__ = gComeFunResultObject = __result_obj__ = result_201;
        gComeFunResultObject = (void*)0;
    ...
    __result146__ = gComeFunResultObject = __result_obj__ = result_202;
    gComeFunResultObject = (void*)0;
...
result_205 = (void*)0;
    if(    self==((void*)0)||self->it==((void*)0)) {
        ...
        __result147__ = gComeFunResultObject = __result_obj__ = result_204;
        gComeFunResultObject = (void*)0;
    ...
    __result149__ = gComeFunResultObject = __result_obj__ = result_205;
    gComeFunResultObject = (void*)0;
...
_Bool sSomeNode_compile(struct sSomeNode* self, struct sInfo* info){
struct list$1sNodeph* tuple_elements_226;
void* __right_value377 = (void*)0;
void* __right_value378 = (void*)0;
struct list$1sTypeph* tuple_types_227;
void* __right_value379 = (void*)0;
void* __right_value380 = (void*)0;
struct list$1CVALUEph* tuple_values_228;
struct list$1sNodeph* o2_saved_229;
struct sNode* it_230;
_Bool __result154__;
...
struct CVALUE* obj_value_235;
void* __right_value390 = (void*)0;
void* __right_value391 = (void*)0;
struct buffer* num_string_236;
...
struct sType* type3_239;
void* __right_value397 = (void*)0;
struct sType* __dec_obj168;
void* __right_value398 = (void*)0;
struct sType* obj_type_240;
char* fun_name_241;
...
struct list$1CVALUEph* come_params_245;
int i_246;
...
_Bool __result156__;
    tuple_elements_226=self->tuple_elements;
    tuple_types_227=(struct list$1sTypeph*)come_increment_ref_count(list$1sTypeph_initialize((struct list$1sTypeph*)come_increment_ref_count((struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "06str.c", 634, "list$1sTypeph"))));
    tuple_values_228=(struct list$1CVALUEph*)come_increment_ref_count(list$1CVALUEph_initialize((struct list$1CVALUEph*)come_increment_ref_count((struct list$1CVALUEph*)come_calloc(1, sizeof(struct list$1CVALUEph)*(1), "06str.c", 635, "list$1CVALUEph"))));
    for(    o2_saved_229=(tuple_elements_226),it_230=list$1sNodeph_begin((o2_saved_229));    !list$1sNodeph_end((o2_saved_229));    it_230=list$1sNodeph_next((o2_saved_229))    ){
        if(        !node_compile(it_230,info)) {
            __result154__ = (_Bool)0;
            /*i*/come_call_finalizer3(tuple_types_227,list$1sTypephp_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(tuple_values_228,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
            return __result154__;
        }
        come_value_231=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        dec_stack_ptr(1,info);
        list$1CVALUEph_push_back(tuple_values_228,(struct CVALUE*)come_increment_ref_count(CVALUE_clone(come_value_231)));
        list$1sTypeph_push_back(tuple_types_227,(struct sType*)come_increment_ref_count(sType_clone(come_value_231->type)));
        /*i*/come_call_finalizer3(come_value_231,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    type_232=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "06str.c", 649, "sType")),((char*)(__right_value385=xsprintf("tuple%d",list$1sTypeph_length(tuple_types_227)))),(_Bool)0,info));
    /* U11 */__right_value385 = come_decrement_ref_count2(__right_value385, (void*)0, (void*)0, 1, 0, 0, (void*)0);
    for(    o2_saved_233=(struct list$1sTypeph*)come_increment_ref_count((tuple_types_227)),it_234=list$1sTypeph_begin((o2_saved_233));    !list$1sTypeph_end((o2_saved_233));    it_234=list$1sTypeph_next((o2_saved_233))    ){
        list$1sTypeph_push_back(type_232->mGenericsTypes,(struct sType*)come_increment_ref_count(sType_clone(it_234)));
    }
    /*i*/come_call_finalizer3(o2_saved_233,list$1sTypephp_finalize, 0, 0, 0, 0, (void*)0);
    obj_value_235=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 655, "CVALUE"))));
    num_string_236=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 657, "buffer"))));
    buffer_append_str(num_string_236,"1");
    type2_237=(struct sType*)come_increment_ref_count(solve_generics(type_232,type_232,info));
    type_name_238=(char*)come_increment_ref_count(make_type_name_string(type2_237,(_Bool)0,(_Bool)1,(_Bool)0,info,(_Bool)0));
    __dec_obj167=obj_value_235->c_value;
    obj_value_235->c_value=(char*)come_increment_ref_count(xsprintf("(%s*)come_calloc(1, sizeof(%s)*(%s), \"%s\", %d, \"%s\")",type_name_238,type_name_238,((char*)(__right_value394=buffer_to_string(num_string_236))),info->sname,info->sline,type_name_238));
    ...
    type3_239=(struct sType*)come_increment_ref_count(sType_clone(type2_237));
    type3_239->mPointerNum++;
    type3_239->mHeap=(_Bool)1;
    type2_237->mHeap=(_Bool)1;
    __dec_obj168=obj_value_235->type;
    obj_value_235->type=(struct sType*)come_increment_ref_count(sType_clone(type2_237));
    come_call_finalizer3(__dec_obj168,sType_finalize, 0, 0, 0, 0, (void*)0);
    obj_value_235->type->mPointerNum++;
    obj_value_235->var=((void*)0);
    append_object_to_right_values2(obj_value_235,(struct sType*)come_increment_ref_count(type3_239),info,(_Bool)0);
    obj_type_240=(struct sType*)come_increment_ref_count(sType_clone(type2_237));
    fun_name_241="initialize";
    generics_fun_name_242=(char*)come_increment_ref_count(string_to_string(((char*)(__right_value400=make_generics_function(obj_type_240,(char*)come_increment_ref_count(__builtin_string(fun_name_241)),info,(_Bool)1)))));
    ...
    if(    fun_243==((void*)0)) {
        __dec_obj169=generics_fun_name_242;
        generics_fun_name_242=(char*)come_increment_ref_count(create_method_name(obj_type_240,(_Bool)0,((char*)(__right_value402=__builtin_string(fun_name_241))),info,(_Bool)1));
        ...
        fun_243=map$2charphsFunph_at(info->funcs,generics_fun_name_242,((void*)0));
        if(        fun_243==((void*)0)) {
            err_msg(info,"function not found(%s) at method(%s)(2)\n",generics_fun_name_242,info->come_fun->mName);
            __result155__ = (_Bool)1;
            /*i*/come_call_finalizer3(tuple_types_227,list$1sTypephp_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(tuple_values_228,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(type_232,sType_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(obj_value_235,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(num_string_236,buffer_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(type2_237,sType_finalize, 0, 0, 0, 0, (void*)0);
            /* U13 */type_name_238 = come_decrement_ref_count2(type_name_238, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(type3_239,sType_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(obj_type_240,sType_finalize, 0, 0, 0, 0, (void*)0);
            /* U13 */generics_fun_name_242 = come_decrement_ref_count2(generics_fun_name_242, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            return __result155__;
        }
    }
    result_type_244=(struct sType*)come_increment_ref_count(sType_clone(fun_243->mResultType));
    result_type_244->mStatic=(_Bool)0;
    come_params_245=(struct list$1CVALUEph*)come_increment_ref_count(list$1CVALUEph_initialize((struct list$1CVALUEph*)come_increment_ref_count((struct list$1CVALUEph*)come_calloc(1, sizeof(struct list$1CVALUEph)*(1), "06str.c", 698, "list$1CVALUEph"))));
    if(    ((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_243->mParamTypes,0), "06str.c", 700, 10))->mHeap&&obj_value_235->type->mHeap) {
        std_move(((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_243->mParamTypes,0), "06str.c", 701, 11)),obj_value_235->type,obj_value_235,info,(_Bool)1);
    }
    list$1CVALUEph_push_back(come_params_245,(struct CVALUE*)come_increment_ref_count(obj_value_235));
    i_246=1;
    for(    o2_saved_247=(struct list$1CVALUEph*)come_increment_ref_count((tuple_values_228)),it_248=list$1CVALUEph_begin((o2_saved_247));    !list$1CVALUEph_end((o2_saved_247));    it_248=list$1CVALUEph_next((o2_saved_247))    ){
        come_value_249=(struct CVALUE*)come_increment_ref_count(CVALUE_clone(it_248));
        if(        ((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_243->mParamTypes,i_246), "06str.c", 709, 12))&&((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_243->mParamTypes,i_246), "06str.c", 709, 13))->mHeap&&come_value_249->type->mHeap) {
            std_move(((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_243->mParamTypes,i_246), "06str.c", 710, 14)),come_value_249->type,come_value_249,info,(_Bool)1);
        }
        list$1CVALUEph_push_back(come_params_245,(struct CVALUE*)come_increment_ref_count(come_value_249));
        i_246++;
    ...
    buf_250=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 717, "buffer"))));
    buffer_append_str(buf_250,generics_fun_name_242);
    buffer_append_str(buf_250,"(");
    j_251=0;
    for(    o2_saved_252=(struct list$1CVALUEph*)come_increment_ref_count((come_params_245)),it_253=list$1CVALUEph_begin((o2_saved_252));    !list$1CVALUEph_end((o2_saved_252));    it_253=list$1CVALUEph_next((o2_saved_252))    ){
        buffer_append_str(buf_250,it_253->c_value);
        if(        j_251!=list$1CVALUEph_length(come_params_245)-1) {
            buffer_append_str(buf_250,",");
        }
        j_251++;
    }
    /*i*/come_call_finalizer3(o2_saved_252,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
    buffer_append_str(buf_250,")");
    come_value2_254=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 734, "CVALUE"))));
    __dec_obj170=come_value2_254->c_value;
    ...
    __dec_obj171=come_value2_254->type;
    come_value2_254->type=(struct sType*)come_increment_ref_count(sType_clone(result_type_244));
    ...
    if(    result_type_244->mHeap) {
        append_object_to_right_values2(come_value2_254,(struct sType*)come_increment_ref_count(result_type_244),info,(_Bool)0);
    }
    add_come_last_code(info,"%s",come_value2_254->c_value);
    ...
    /*i*/come_call_finalizer3(come_params_245,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
...
struct sType* __dec_obj174;
    if(    info->come_fun) {
        come_value_255=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 769, "CVALUE"))));
        buf_256=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 771, "buffer"))));
        static int num_257=0;
        num_257++;
        var_name_258=(char*)come_increment_ref_count(xsprintf("__null_value\%s",((char*)(__right_value420=int_to_string(num_257)))));
        /* U11 */__right_value420 = come_decrement_ref_count2(__right_value420, (void*)0, (void*)0, 1, 0, 0, (void*)0);
        result_type_259=(struct sType*)come_increment_ref_count(sType_clone(info->come_fun->mResultType));
        result_type2_260=(struct sType*)come_increment_ref_count(solve_generics(result_type_259,info->generics_type,info));
        left_type_261=(struct sType*)come_increment_ref_count(result_type2_260);
        add_come_code_at_function_head(info,"%s;\n",((char*)(__right_value424=make_define_var(left_type_261,var_name_258,(_Bool)0,info))));
        /* U11 */__right_value424 = come_decrement_ref_count2(__right_value424, (void*)0, (void*)0, 1, 0, 0, (void*)0);
        add_come_code_at_function_head2(info,"memset(&%s, 0, sizeof(%s));\n",var_name_258,((char*)(__right_value425=make_type_name_string(left_type_261,(_Bool)0,(_Bool)0,(_Bool)0,info,(_Bool)1))));
        /* U11 */__right_value425 = come_decrement_ref_count2(__right_value425, (void*)0, (void*)0, 1, 0, 0, (void*)0);
        come_value2_262=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 787, "CVALUE"))));
        __dec_obj173=come_value2_262->c_value;
        come_value2_262->c_value=(char*)come_increment_ref_count(var_name_258);
        /*G*/ __dec_obj173 = come_decrement_ref_count2(__dec_obj173, (void*)0, (void*)0, 0,0,0, (void*)0);
        __dec_obj174=come_value2_262->type;
        come_value2_262->type=(struct sType*)come_increment_ref_count(result_type2_260);
        ...
        /* U13 */var_name_258 = come_decrement_ref_count2(var_name_258, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(result_type_259,sType_finalize, 0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(result_type2_260,sType_finalize, 0, 0, 0, 0, (void*)0);
...
struct sNullReturnValue* result_263;
...
struct sNullReturnValue* __result160__;
    ...
    result_263=(struct sNullReturnValue*)come_increment_ref_count((struct sNullReturnValue*)come_calloc(1, sizeof(struct sNullReturnValue)*(1), "sNullReturnValue_clone", 3, "sNullReturnValue"));
    if(    self!=((void*)0)) {
        result_263->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj176=result_263->sname;
    ...
    __result160__ = gComeFunResultObject = __result_obj__ = result_263;
    /*i*/come_call_finalizer3(result_263,sNullReturnValue_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
struct sType* result_type2_269;
struct sType* __dec_obj178;
void* __right_value443 = (void*)0;
struct sType* left_type_270;
_Bool __result164__;
...
struct sType* __dec_obj180;
    if(    info->come_fun) {
        come_value_264=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 822, "CVALUE"))));
        buf_265=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 824, "buffer"))));
        static int num_266=0;
        num_266++;
        var_name_267=(char*)come_increment_ref_count(xsprintf("__null_value\%s",((char*)(__right_value439=int_to_string(num_266)))));
        /* U11 */__right_value439 = come_decrement_ref_count2(__right_value439, (void*)0, (void*)0, 1, 0, 0, (void*)0);
        result_type_268=(struct sType*)come_increment_ref_count(sType_clone(info->come_fun->mResultType));
        result_type2_269=(struct sType*)come_increment_ref_count(solve_generics(result_type_268,info->generics_type,info));
        if(        result_type2_269->mNoSolvedGenericsType->v1) {
            __dec_obj178=result_type2_269;
            result_type2_269=(struct sType*)come_increment_ref_count(result_type2_269->mNoSolvedGenericsType->v1);
            come_call_finalizer3(__dec_obj178,sType_finalize, 0, 0, 0, 0, (void*)0);
        }
        left_type_270=(struct sType*)come_increment_ref_count(sType_clone(list$1sTypephp_operator_load_element(result_type2_269->mGenericsTypes,0)));
        if(        left_type_270==((void*)0)||string_operator_not_equals(result_type2_269->mClass->mName,"tuple2")) {
            ...
            /* U13 */var_name_267 = come_decrement_ref_count2(var_name_267, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(result_type_268,sType_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(result_type2_269,sType_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(left_type_270,sType_finalize, 0, 0, 0, 0, (void*)0);
            return __result164__;
        }
        add_come_code_at_function_head(info,"%s;\n",((char*)(__right_value444=make_define_var(left_type_270,var_name_267,(_Bool)0,info))));
        /* U11 */__right_value444 = come_decrement_ref_count2(__right_value444, (void*)0, (void*)0, 1, 0, 0, (void*)0);
        add_come_code_at_function_head2(info,"memset(&%s, 0, sizeof(%s));\n",var_name_267,((char*)(__right_value445=make_type_name_string(left_type_270,(_Bool)0,(_Bool)0,(_Bool)0,info,(_Bool)1))));
        /* U11 */__right_value445 = come_decrement_ref_count2(__right_value445, (void*)0, (void*)0, 1, 0, 0, (void*)0);
        come_value2_271=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 849, "CVALUE"))));
        __dec_obj179=come_value2_271->c_value;
        come_value2_271->c_value=(char*)come_increment_ref_count(var_name_267);
        /*G*/ __dec_obj179 = come_decrement_ref_count2(__dec_obj179, (void*)0, (void*)0, 0,0,0, (void*)0);
        __dec_obj180=come_value2_271->type;
        come_value2_271->type=(struct sType*)come_increment_ref_count(left_type_270);
        come_call_finalizer3(__dec_obj180,sType_finalize, 0, 0, 0, 0, (void*)0);
        come_value2_271->type->mStatic=(_Bool)0;
        come_value2_271->var=((void*)0);
        list$1CVALUEph_push_back(info->stack,(struct CVALUE*)come_increment_ref_count(come_value2_271));
        /*i*/come_call_finalizer3(come_value_264,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(buf_265,buffer_finalize, 0, 0, 0, 0, (void*)0);
        /* U13 */var_name_267 = come_decrement_ref_count2(var_name_267, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(result_type_268,sType_finalize, 0, 0, 0, 0, (void*)0);
...
struct sNullReturnValueOfException* result_272;
...
struct sNullReturnValueOfException* __result166__;
    ...
    result_272=(struct sNullReturnValueOfException*)come_increment_ref_count((struct sNullReturnValueOfException*)come_calloc(1, sizeof(struct sNullReturnValueOfException)*(1), "sNullReturnValueOfException_clone", 3, "sNullReturnValueOfException"));
    if(    self!=((void*)0)) {
        result_272->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj182=result_272->sname;
        result_272->sname=(char*)come_increment_ref_count(string_clone(self->sname));
        /*G*/ __dec_obj182 = come_decrement_ref_count2(__dec_obj182, (void*)0, (void*)0, 0,0,0, (void*)0);
    }
    __result166__ = gComeFunResultObject = __result_obj__ = result_272;
    /*i*/come_call_finalizer3(result_272,sNullReturnValueOfException_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
_Bool __result170__;
    come_value_273=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 885, "CVALUE"))));
    buf_274=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 887, "buffer"))));
    static int num_275=0;
    num_275++;
    var_name_276=(char*)come_increment_ref_count(xsprintf("__null_value2_\%s",((char*)(__right_value459=int_to_string(num_275)))));
    /* U11 */__right_value459 = come_decrement_ref_count2(__right_value459, (void*)0, (void*)0, 1, 0, 0, (void*)0);
    left_type_277=(struct sType*)come_increment_ref_count(self->type);
    add_come_code_at_function_head(info,"%s;\n",((char*)(__right_value461=make_define_var(left_type_277,var_name_276,(_Bool)0,info))));
    /* U11 */__right_value461 = come_decrement_ref_count2(__right_value461, (void*)0, (void*)0, 1, 0, 0, (void*)0);
    add_come_code_at_function_head2(info,"memset(&%s, 0, sizeof(%s));\n",var_name_276,((char*)(__right_value462=make_type_name_string(left_type_277,(_Bool)0,(_Bool)0,(_Bool)0,info,(_Bool)1))));
    /* U11 */__right_value462 = come_decrement_ref_count2(__right_value462, (void*)0, (void*)0, 1, 0, 0, (void*)0);
    come_value2_278=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 899, "CVALUE"))));
    __dec_obj186=come_value2_278->c_value;
    come_value2_278->c_value=(char*)come_increment_ref_count(var_name_276);
    /*G*/ __dec_obj186 = come_decrement_ref_count2(__dec_obj186, (void*)0, (void*)0, 0,0,0, (void*)0);
    __dec_obj187=come_value2_278->type;
    come_value2_278->type=(struct sType*)come_increment_ref_count(self->type);
    ...
    /* U13 */var_name_276 = come_decrement_ref_count2(var_name_276, (void*)0, (void*)0, 0, 0, 0, (void*)0);
...
struct sNullValue* __result172__;
    ...
    result_279=(struct sNullValue*)come_increment_ref_count((struct sNullValue*)come_calloc(1, sizeof(struct sNullValue)*(1), "sNullValue_clone", 3, "sNullValue"));
    if(    self!=((void*)0)) {
        result_279->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj190=result_279->sname;
    ...
    __result172__ = gComeFunResultObject = __result_obj__ = result_279;
    /*i*/come_call_finalizer3(result_279,sNullValue_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
_Bool sNoneNode_compile(struct sNoneNode* self, struct sInfo* info){
struct list$1sNodeph* tuple_elements_280;
void* __right_value473 = (void*)0;
void* __right_value474 = (void*)0;
struct list$1sTypeph* tuple_types_281;
void* __right_value475 = (void*)0;
void* __right_value476 = (void*)0;
struct list$1CVALUEph* tuple_values_282;
int i_283;
...
struct CVALUE* obj_value_291;
void* __right_value489 = (void*)0;
void* __right_value490 = (void*)0;
struct buffer* num_string_292;
...
struct list$1CVALUEph* come_params_301;
struct list$1CVALUEph* o2_saved_302;
struct CVALUE* it_303;
...
_Bool __result178__;
    tuple_elements_280=self->tuple_elements;
    tuple_types_281=(struct list$1sTypeph*)come_increment_ref_count(list$1sTypeph_initialize((struct list$1sTypeph*)come_increment_ref_count((struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "06str.c", 935, "list$1sTypeph"))));
    tuple_values_282=(struct list$1CVALUEph*)come_increment_ref_count(list$1CVALUEph_initialize((struct list$1CVALUEph*)come_increment_ref_count((struct list$1CVALUEph*)come_calloc(1, sizeof(struct list$1CVALUEph)*(1), "06str.c", 936, "list$1CVALUEph"))));
    i_283=0;
    for(    o2_saved_284=(tuple_elements_280),it_285=list$1sNodeph_begin((o2_saved_284));    !list$1sNodeph_end((o2_saved_284));    it_285=list$1sNodeph_next((o2_saved_284))    ){
        if(        !node_compile(it_285,info)) {
            __result176__ = (_Bool)0;
            /*i*/come_call_finalizer3(tuple_types_281,list$1sTypephp_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(tuple_values_282,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
            return __result176__;
        }
        come_value_286=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
        dec_stack_ptr(1,info);
        list$1CVALUEph_push_back(tuple_values_282,(struct CVALUE*)come_increment_ref_count(CVALUE_clone(come_value_286)));
        list$1sTypeph_push_back(tuple_types_281,(struct sType*)come_increment_ref_count(sType_clone(come_value_286->type)));
        if(        i_283==1) {
            string_type_287=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "06str.c", 951, "sType")),"char*",(_Bool)0,info));
            string_type_287->mHeap=(_Bool)1;
            check_assign_type(((char*)(__right_value482=xsprintf("invalid none type"))),string_type_287,come_value_286->type,come_value_286,(_Bool)0,(_Bool)1,(_Bool)0,info);
            /* U11 */__right_value482 = come_decrement_ref_count2(__right_value482, (void*)0, (void*)0, 1, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(string_type_287,sType_finalize, 0, 0, 0, 0, (void*)0);
        }
        i_283++;
        /*i*/come_call_finalizer3(come_value_286,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    type_288=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "06str.c", 959, "sType")),((char*)(__right_value484=xsprintf("tuple%d",list$1sTypeph_length(tuple_types_281)))),(_Bool)0,info));
    /* U11 */__right_value484 = come_decrement_ref_count2(__right_value484, (void*)0, (void*)0, 1, 0, 0, (void*)0);
    for(    o2_saved_289=(struct list$1sTypeph*)come_increment_ref_count((tuple_types_281)),it_290=list$1sTypeph_begin((o2_saved_289));    !list$1sTypeph_end((o2_saved_289));    it_290=list$1sTypeph_next((o2_saved_289))    ){
        list$1sTypeph_push_back(type_288->mGenericsTypes,(struct sType*)come_increment_ref_count(sType_clone(it_290)));
    }
    /*i*/come_call_finalizer3(o2_saved_289,list$1sTypephp_finalize, 0, 0, 0, 0, (void*)0);
    obj_value_291=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 965, "CVALUE"))));
    num_string_292=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 967, "buffer"))));
    buffer_append_str(num_string_292,"1");
    type2_293=(struct sType*)come_increment_ref_count(solve_generics(type_288,type_288,info));
    type_name_294=(char*)come_increment_ref_count(make_type_name_string(type2_293,(_Bool)0,(_Bool)1,(_Bool)0,info,(_Bool)0));
    __dec_obj195=obj_value_291->c_value;
    obj_value_291->c_value=(char*)come_increment_ref_count(xsprintf("(%s*)come_calloc(1, sizeof(%s)*(%s), \"%s\", %d, \"%s\")",type_name_294,type_name_294,((char*)(__right_value493=buffer_to_string(num_string_292))),info->sname,info->sline,type_name_294));
    ...
    type3_295=(struct sType*)come_increment_ref_count(sType_clone(type2_293));
    type3_295->mPointerNum++;
    type3_295->mHeap=(_Bool)1;
    type2_293->mHeap=(_Bool)1;
    __dec_obj196=obj_value_291->type;
    obj_value_291->type=(struct sType*)come_increment_ref_count(sType_clone(type2_293));
    come_call_finalizer3(__dec_obj196,sType_finalize, 0, 0, 0, 0, (void*)0);
    obj_value_291->type->mPointerNum++;
    obj_value_291->var=((void*)0);
    append_object_to_right_values2(obj_value_291,(struct sType*)come_increment_ref_count(type3_295),info,(_Bool)0);
    obj_type_296=(struct sType*)come_increment_ref_count(sType_clone(type2_293));
    fun_name_297="initialize";
    generics_fun_name_298=(char*)come_increment_ref_count(string_to_string(((char*)(__right_value499=make_generics_function(obj_type_296,(char*)come_increment_ref_count(__builtin_string(fun_name_297)),info,(_Bool)1)))));
    /* U11 */__right_value499 = come_decrement_ref_count2(__right_value499, (void*)0, (void*)0, 1, 0, 0, (void*)0);
    fun_299=map$2charphsFunph_at(info->funcs,generics_fun_name_298,((void*)0));
    if(    fun_299==((void*)0)) {
        __dec_obj197=generics_fun_name_298;
        generics_fun_name_298=(char*)come_increment_ref_count(create_method_name(obj_type_296,(_Bool)0,((char*)(__right_value501=__builtin_string(fun_name_297))),info,(_Bool)1));
        ...
        fun_299=map$2charphsFunph_at(info->funcs,generics_fun_name_298,((void*)0));
        if(        fun_299==((void*)0)) {
            err_msg(info,"function not found(%s) at method(%s)(2)\n",generics_fun_name_298,info->come_fun->mName);
            __result177__ = (_Bool)1;
            /*i*/come_call_finalizer3(tuple_types_281,list$1sTypephp_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(tuple_values_282,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(type_288,sType_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(obj_value_291,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(num_string_292,buffer_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(type2_293,sType_finalize, 0, 0, 0, 0, (void*)0);
            /* U13 */type_name_294 = come_decrement_ref_count2(type_name_294, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(type3_295,sType_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(obj_type_296,sType_finalize, 0, 0, 0, 0, (void*)0);
            /* U13 */generics_fun_name_298 = come_decrement_ref_count2(generics_fun_name_298, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            return __result177__;
        }
    }
    result_type_300=(struct sType*)come_increment_ref_count(sType_clone(fun_299->mResultType));
    result_type_300->mStatic=(_Bool)0;
    come_params_301=(struct list$1CVALUEph*)come_increment_ref_count(list$1CVALUEph_initialize((struct list$1CVALUEph*)come_increment_ref_count((struct list$1CVALUEph*)come_calloc(1, sizeof(struct list$1CVALUEph)*(1), "06str.c", 1008, "list$1CVALUEph"))));
    if(    ((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_299->mParamTypes,0), "06str.c", 1010, 15))->mHeap&&obj_value_291->type->mHeap) {
        std_move(((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_299->mParamTypes,0), "06str.c", 1011, 16)),obj_value_291->type,obj_value_291,info,(_Bool)1);
    }
    list$1CVALUEph_push_back(come_params_301,(struct CVALUE*)come_increment_ref_count(obj_value_291));
    i_283=1;
    for(    o2_saved_302=(struct list$1CVALUEph*)come_increment_ref_count((tuple_values_282)),it_303=list$1CVALUEph_begin((o2_saved_302));    !list$1CVALUEph_end((o2_saved_302));    it_303=list$1CVALUEph_next((o2_saved_302))    ){
        come_value_304=(struct CVALUE*)come_increment_ref_count(CVALUE_clone(it_303));
        if(        ((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_299->mParamTypes,i_283), "06str.c", 1019, 17))&&((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_299->mParamTypes,i_283), "06str.c", 1019, 18))->mHeap&&come_value_304->type->mHeap) {
            std_move(((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_299->mParamTypes,i_283), "06str.c", 1020, 19)),come_value_304->type,come_value_304,info,(_Bool)1);
        }
        list$1CVALUEph_push_back(come_params_301,(struct CVALUE*)come_increment_ref_count(come_value_304));
        i_283++;
        /*i*/come_call_finalizer3(come_value_304,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    }
    /*i*/come_call_finalizer3(o2_saved_302,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
    buf_305=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 1027, "buffer"))));
    buffer_append_str(buf_305,generics_fun_name_298);
    buffer_append_str(buf_305,"(");
    j_306=0;
    for(    o2_saved_307=(struct list$1CVALUEph*)come_increment_ref_count((come_params_301)),it_308=list$1CVALUEph_begin((o2_saved_307));    !list$1CVALUEph_end((o2_saved_307));    it_308=list$1CVALUEph_next((o2_saved_307))    ){
        buffer_append_str(buf_305,it_308->c_value);
        if(        j_306!=list$1CVALUEph_length(come_params_301)-1) {
            buffer_append_str(buf_305,",");
        }
        j_306++;
    }
    /*i*/come_call_finalizer3(o2_saved_307,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
    buffer_append_str(buf_305,")");
    come_value2_309=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 1044, "CVALUE"))));
    __dec_obj198=come_value2_309->c_value;
    come_value2_309->c_value=(char*)come_increment_ref_count(buffer_to_string(buf_305));
    /*G*/ __dec_obj198 = come_decrement_ref_count2(__dec_obj198, (void*)0, (void*)0, 0,0,0, (void*)0);
    __dec_obj199=come_value2_309->type;
    come_value2_309->type=(struct sType*)come_increment_ref_count(sType_clone(result_type_300));
    come_call_finalizer3(__dec_obj199,sType_finalize, 0, 0, 0, 0, (void*)0);
    come_value2_309->type->mStatic=(_Bool)0;
    come_value2_309->var=((void*)0);
    if(    result_type_300->mHeap) {
        append_object_to_right_values2(come_value2_309,(struct sType*)come_increment_ref_count(result_type_300),info,(_Bool)0);
    }
    add_come_last_code(info,"%s",come_value2_309->c_value);
    ...
    /*i*/come_call_finalizer3(come_params_301,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(buf_305,buffer_finalize, 0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(come_value2_309,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
...
_Bool sMapNode_compile(struct sMapNode* self, struct sInfo* info){
struct list$1sNodeph* map_key_elements_310;
struct list$1sNodeph* map_elements_311;
void* __right_value515 = (void*)0;
void* __right_value516 = (void*)0;
struct list$1CVALUEph* key_params_312;
void* __right_value517 = (void*)0;
void* __right_value518 = (void*)0;
struct list$1CVALUEph* element_params_313;
struct sType* map_key_type_314;
struct sType* map_element_type_315;
int i_316;
struct sNode* key_elements_317;
struct sNode* elements_321;
...
struct sType* key_type_values_335;
...
struct sType* element_type_values_338;
void* __right_value580 = (void*)0;
void* __right_value581 = (void*)0;
char* var_name2_339;
void* __right_value582 = (void*)0;
struct sVar* var2__340;
void* __right_value583 = (void*)0;
void* __right_value584 = (void*)0;
void* __right_value585 = (void*)0;
struct buffer* source_341;
int i_342;
struct CVALUE* key_param_343;
struct CVALUE* element_param_344;
...
struct CVALUE* obj_value_354;
void* __right_value601 = (void*)0;
void* __right_value602 = (void*)0;
struct buffer* num_string_355;
...
struct CVALUE* come_value3_361;
void* __right_value616 = (void*)0;
char* __dec_obj220;
struct sType* __dec_obj221;
void* __right_value617 = (void*)0;
void* __right_value618 = (void*)0;
struct CVALUE* come_value4_362;
void* __right_value619 = (void*)0;
char* __dec_obj222;
struct sType* __dec_obj223;
int j_363;
struct list$1CVALUEph* o2_saved_364;
struct CVALUE* it_365;
void* __right_value620 = (void*)0;
void* __right_value621 = (void*)0;
struct CVALUE* come_value5_366;
...
exp_323 = (void*)0;
exp2_329 = (void*)0;
    map_key_elements_310=self->map_key_elements;
    map_elements_311=self->map_elements;
    key_params_312=(struct list$1CVALUEph*)come_increment_ref_count(list$1CVALUEph_initialize((struct list$1CVALUEph*)come_increment_ref_count((struct list$1CVALUEph*)come_calloc(1, sizeof(struct list$1CVALUEph)*(1), "06str.c", 1084, "list$1CVALUEph"))));
    element_params_313=(struct list$1CVALUEph*)come_increment_ref_count(list$1CVALUEph_initialize((struct list$1CVALUEph*)come_increment_ref_count((struct list$1CVALUEph*)come_calloc(1, sizeof(struct list$1CVALUEph)*(1), "06str.c", 1085, "list$1CVALUEph"))));
    map_key_type_314=((void*)0);
    map_element_type_315=((void*)0);
    for(    i_316=0;    i_316<list$1sNodeph_length(map_key_elements_310);    i_316++    ){
        key_elements_317=((struct sNode*)come_null_check(list$1sNodephp_operator_load_element(map_key_elements_310,i_316), "06str.c", 1090, 20));
        elements_321=((struct sNode*)come_null_check(list$1sNodephp_operator_load_element(map_elements_311,i_316), "06str.c", 1091, 21));
        if(        (_if_conditional3=(string_operator_equals(((char*)(__right_value519=key_elements_317->kind(key_elements_317->_protocol_obj))),"sWildCard"))),        /* U10 */ (__right_value519 = come_decrement_ref_count2(__right_value519, (void*)0, (void*)0, 1, 0, 0, (void*)0)),
        _if_conditional3) {
            value_node_322=(struct sNode*)come_increment_ref_count(create_load_var(((char*)(__right_value520=xsprintf("Value"))),info));
            /* U11 */__right_value520 = come_decrement_ref_count2(__right_value520, (void*)0, (void*)0, 1, 0, 0, (void*)0);
            {
                params_324=(struct list$1tuple2$2charphsNodephph*)come_increment_ref_count(list$1tuple2$2charphsNodephph_initialize((struct list$1tuple2$2charphsNodephph*)come_increment_ref_count((struct list$1tuple2$2charphsNodephph*)come_calloc(1, sizeof(struct list$1tuple2$2charphsNodephph)*(1), "06str.c", 1098, "list$1tuple2$2charphsNodephph"))));
                list$1tuple2$2charphsNodephph_add(params_324,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1099, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("self")),(struct sNode*)come_increment_ref_count(value_node_322))));
                __dec_obj205=exp_323;
                exp_323=(struct sNode*)come_increment_ref_count(create_method_call(((char*)(__right_value527=xsprintf("keys"))),(struct sNode*)come_increment_ref_count(value_node_322),(struct list$1tuple2$2charphsNodephph*)come_increment_ref_count(params_324),((void*)0),0,((void*)0),info));
            ...
            {
                params_325=(struct list$1tuple2$2charphsNodephph*)come_increment_ref_count(list$1tuple2$2charphsNodephph_initialize((struct list$1tuple2$2charphsNodephph*)come_increment_ref_count((struct list$1tuple2$2charphsNodephph*)come_calloc(1, sizeof(struct list$1tuple2$2charphsNodephph)*(1), "06str.c", 1104, "list$1tuple2$2charphsNodephph"))));
                list$1tuple2$2charphsNodephph_add(params_325,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1105, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("self")),(struct sNode*)come_increment_ref_count(exp_323))));
                list$1tuple2$2charphsNodephph_add(params_325,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1106, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("position")),(struct sNode*)come_increment_ref_count(create_int_node(i_316,info)))));
                __dec_obj206=exp_323;
                exp_323=(struct sNode*)come_increment_ref_count(create_method_call(((char*)(__right_value538=xsprintf("operator_load_element"))),(struct sNode*)come_increment_ref_count(exp_323),(struct list$1tuple2$2charphsNodephph*)come_increment_ref_count(params_325),((void*)0),0,((void*)0),info));
                ...
                /*i*/come_call_finalizer3(params_325,list$1tuple2$2charphsNodephphp_finalize, 0, 0, 0, 0, (void*)0);
            }
            if(            !node_compile(exp_323,info)) {
                ...
                /*i*/come_call_finalizer3(key_params_312,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
                /*i*/come_call_finalizer3(element_params_313,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
                /*i*/come_call_finalizer3(map_key_type_314,sType_finalize, 0, 0, 0, 0, (void*)0);
                /*i*/come_call_finalizer3(map_element_type_315,sType_finalize, 0, 0, 0, 0, (void*)0);
                return __result183__;
            }
            come_value_326=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
            dec_stack_ptr(1,info);
            list$1CVALUEph_push_back(key_params_312,(struct CVALUE*)come_increment_ref_count(come_value_326));
            __dec_obj208=map_key_type_314;
            map_key_type_314=(struct sType*)come_increment_ref_count(sType_clone(come_value_326->type));
            ...
            if(            !node_compile(key_elements_317,info)) {
            ...
            dec_stack_ptr(1,info);
            if(            map_key_type_314) {
                check_assign_type(((char*)(__right_value544=xsprintf("invalid map key type"))),map_key_type_314,come_value_327->type,come_value_327,(_Bool)0,(_Bool)1,(_Bool)0,info);
                /* U11 */__right_value544 = come_decrement_ref_count2(__right_value544, (void*)0, (void*)0, 1, 0, 0, (void*)0);
            }
            list$1CVALUEph_push_back(key_params_312,(struct CVALUE*)come_increment_ref_count(come_value_327));
            __dec_obj209=map_key_type_314;
            map_key_type_314=(struct sType*)come_increment_ref_count(sType_clone(come_value_327->type));
        ...
        if(        (_if_conditional4=(string_operator_equals(((char*)(__right_value546=elements_321->kind(elements_321->_protocol_obj))),"sWildCard"))),        /* U10 */ (__right_value546 = come_decrement_ref_count2(__right_value546, (void*)0, (void*)0, 1, 0, 0, (void*)0)),
        _if_conditional4) {
            value_node_328=(struct sNode*)come_increment_ref_count(create_load_var(((char*)(__right_value547=xsprintf("Value"))),info));
            /* U11 */__right_value547 = come_decrement_ref_count2(__right_value547, (void*)0, (void*)0, 1, 0, 0, (void*)0);
            {
                params_330=(struct list$1tuple2$2charphsNodephph*)come_increment_ref_count(list$1tuple2$2charphsNodephph_initialize((struct list$1tuple2$2charphsNodephph*)come_increment_ref_count((struct list$1tuple2$2charphsNodephph*)come_calloc(1, sizeof(struct list$1tuple2$2charphsNodephph)*(1), "06str.c", 1142, "list$1tuple2$2charphsNodephph"))));
                list$1tuple2$2charphsNodephph_add(params_330,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1143, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("self")),(struct sNode*)come_increment_ref_count(value_node_328))));
                __dec_obj210=exp2_329;
                exp2_329=(struct sNode*)come_increment_ref_count(create_method_call(((char*)(__right_value554=xsprintf("values"))),(struct sNode*)come_increment_ref_count(value_node_328),(struct list$1tuple2$2charphsNodephph*)come_increment_ref_count(params_330),((void*)0),0,((void*)0),info));
            ...
            }
            {
                ...
                list$1tuple2$2charphsNodephph_add(params_331,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1149, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("self")),(struct sNode*)come_increment_ref_count(exp2_329))));
                list$1tuple2$2charphsNodephph_add(params_331,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1150, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("position")),(struct sNode*)come_increment_ref_count(create_int_node(i_316,info)))));
                __dec_obj211=exp2_329;
                exp2_329=(struct sNode*)come_increment_ref_count(create_method_call(((char*)(__right_value565=xsprintf("operator_load_element"))),(struct sNode*)come_increment_ref_count(exp2_329),(struct list$1tuple2$2charphsNodephph*)come_increment_ref_count(params_331),((void*)0),0,((void*)0),info));
                ...
                __dec_obj212=exp2_329;
                exp2_329=(struct sNode*)come_increment_ref_count(create_nullable_node(exp2_329,info));
            ...
            if(            !node_compile(exp2_329,info)) {
                __result185__ = (_Bool)0;
                if(value_node_328) { value_node_328 = come_decrement_ref_count2(value_node_328, ((struct sNode*)value_node_328)->finalize, ((struct sNode*)value_node_328)->_protocol_obj, 0, 0, 0, (void*)0); } 
                if(exp2_329) { exp2_329 = come_decrement_ref_count2(exp2_329, ((struct sNode*)exp2_329)->finalize, ((struct sNode*)exp2_329)->_protocol_obj, 0, 0, 0, (void*)0); } 
                /*i*/come_call_finalizer3(key_params_312,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
                /*i*/come_call_finalizer3(element_params_313,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
                /*i*/come_call_finalizer3(map_key_type_314,sType_finalize, 0, 0, 0, 0, (void*)0);
                /*i*/come_call_finalizer3(map_element_type_315,sType_finalize, 0, 0, 0, 0, (void*)0);
            ...
            dec_stack_ptr(1,info);
            if(            map_element_type_315) {
                check_assign_type(((char*)(__right_value569=xsprintf("invalid map element type"))),map_element_type_315,come_value2_332->type,come_value2_332,(_Bool)0,(_Bool)1,(_Bool)0,info);
                /* U11 */__right_value569 = come_decrement_ref_count2(__right_value569, (void*)0, (void*)0, 1, 0, 0, (void*)0);
            }
            list$1CVALUEph_push_back(element_params_313,(struct CVALUE*)come_increment_ref_count(come_value2_332));
            __dec_obj213=map_element_type_315;
            map_element_type_315=(struct sType*)come_increment_ref_count(sType_clone(come_value2_332->type));
            ...
            if(            !node_compile(elements_321,info)) {
            ...
            come_value2_333=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
            dec_stack_ptr(1,info);
            if(            map_element_type_315) {
                check_assign_type(((char*)(__right_value572=xsprintf("invalid map element type"))),map_element_type_315,come_value2_333->type,come_value2_333,(_Bool)0,(_Bool)1,(_Bool)0,info);
                /* U11 */__right_value572 = come_decrement_ref_count2(__right_value572, (void*)0, (void*)0, 1, 0, 0, (void*)0);
            }
            list$1CVALUEph_push_back(element_params_313,(struct CVALUE*)come_increment_ref_count(come_value2_333));
            __dec_obj214=map_element_type_315;
            map_element_type_315=(struct sType*)come_increment_ref_count(sType_clone(come_value2_333->type));
            come_call_finalizer3(__dec_obj214,sType_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(come_value2_333,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
        }
    }
    static int map_value_num_334=0;
    key_type_values_335=(struct sType*)come_increment_ref_count(sType_clone(map_key_type_314));
    list$1sNodeph_push_back(key_type_values_335->mArrayNum,(struct sNode*)come_increment_ref_count(create_int_node(list$1CVALUEph_length(key_params_312),info)));
    key_type_values_335->mHeap=(_Bool)0;
    var_name_336=(char*)come_increment_ref_count(xsprintf("__map_keys%d__",++map_value_num_334));
    add_variable_to_table(var_name_336,(struct sType*)come_increment_ref_count(sType_clone(key_type_values_335)),info);
    var__337=get_variable_from_table(info->lv_table,var_name_336);
    add_come_code_at_function_head(info,"%s;\n",((char*)(__right_value578=make_define_var(key_type_values_335,var__337->mCValueName,(_Bool)0,info))));
    /* U11 */__right_value578 = come_decrement_ref_count2(__right_value578, (void*)0, (void*)0, 1, 0, 0, (void*)0);
    element_type_values_338=(struct sType*)come_increment_ref_count(sType_clone(map_element_type_315));
    list$1sNodeph_push_back(element_type_values_338->mArrayNum,(struct sNode*)come_increment_ref_count(create_int_node(list$1CVALUEph_length(element_params_313),info)));
    element_type_values_338->mHeap=(_Bool)0;
    var_name2_339=(char*)come_increment_ref_count(xsprintf("__map_element%d__",map_value_num_334));
    add_variable_to_table(var_name2_339,(struct sType*)come_increment_ref_count(sType_clone(element_type_values_338)),info);
    var2__340=get_variable_from_table(info->lv_table,var_name2_339);
    add_come_code_at_function_head(info,"%s;\n",((char*)(__right_value583=make_define_var(element_type_values_338,var2__340->mCValueName,(_Bool)0,info))));
    /* U11 */__right_value583 = come_decrement_ref_count2(__right_value583, (void*)0, (void*)0, 1, 0, 0, (void*)0);
    source_341=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 1211, "buffer"))));
    buffer_append_str(source_341,"(");
    for(    i_342=0;    i_342<list$1CVALUEph_length(key_params_312);    i_342++    ){
        key_param_343=((struct CVALUE*)come_null_check(list$1CVALUEphp_operator_load_element(key_params_312,i_342), "06str.c", 1216, 22));
        element_param_344=((struct CVALUE*)come_null_check(list$1CVALUEphp_operator_load_element(element_params_313,i_342), "06str.c", 1217, 23));
        if(        map_key_type_314->mHeap) {
            c_value_345=(char*)come_increment_ref_count(increment_ref_count_object(key_param_343->type,key_param_343->c_value,info));
            buffer_append_format(source_341,"%s[%d]=%s,\n",var__337->mCValueName,i_342,c_value_345);
            /* U13 */c_value_345 = come_decrement_ref_count2(c_value_345, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        }
        else {
            buffer_append_format(source_341,"%s[%d]=%s,\n",var__337->mCValueName,i_342,key_param_343->c_value);
        }
        if(        map_element_type_315->mHeap) {
            c_value_346=(char*)come_increment_ref_count(increment_ref_count_object(element_param_344->type,element_param_344->c_value,info));
            buffer_append_format(source_341,"%s[%d]=%s,\n",var2__340->mCValueName,i_342,c_value_346);
            /* U13 */c_value_346 = come_decrement_ref_count2(c_value_346, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        }
        else {
            buffer_append_format(source_341,"%s[%d]=%s,\n",var2__340->mCValueName,i_342,element_param_344->c_value);
        }
    }
    map_type_347=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "06str.c", 1236, "sType")),"map",(_Bool)0,info));
    list$1sTypeph_push_back(map_type_347->mGenericsTypes,(struct sType*)come_increment_ref_count(sType_clone(map_key_type_314)));
    list$1sTypeph_push_back(map_type_347->mGenericsTypes,(struct sType*)come_increment_ref_count(sType_clone(map_element_type_315)));
    obj_type_348=(struct sType*)come_increment_ref_count(sType_clone(map_type_347));
    fun_name_349="initialize_with_values";
    generics_fun_name_350=(char*)come_increment_ref_count(string_to_string(((char*)(__right_value594=make_generics_function(obj_type_348,(char*)come_increment_ref_count(__builtin_string(fun_name_349)),info,(_Bool)1)))));
    ...
    if(    fun_351==((void*)0)) {
        __dec_obj215=generics_fun_name_350;
        generics_fun_name_350=(char*)come_increment_ref_count(create_method_name(obj_type_348,(_Bool)0,((char*)(__right_value596=__builtin_string(fun_name_349))),info,(_Bool)1));
        ...
        if(        fun_351==((void*)0)) {
            ...
            /*i*/come_call_finalizer3(map_key_type_314,sType_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(map_element_type_315,sType_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(key_type_values_335,sType_finalize, 0, 0, 0, 0, (void*)0);
            /* U13 */var_name_336 = come_decrement_ref_count2(var_name_336, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(element_type_values_338,sType_finalize, 0, 0, 0, 0, (void*)0);
            /* U13 */var_name2_339 = come_decrement_ref_count2(var_name2_339, (void*)0, (void*)0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(source_341,buffer_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(map_type_347,sType_finalize, 0, 0, 0, 0, (void*)0);
    ...
    result_type_352=(struct sType*)come_increment_ref_count(sType_clone(fun_351->mResultType));
    result_type_352->mStatic=(_Bool)0;
    type_353=map_type_347;
    obj_value_354=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 1263, "CVALUE"))));
    num_string_355=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 1265, "buffer"))));
    buffer_append_str(num_string_355,"1");
    type2_356=(struct sType*)come_increment_ref_count(solve_generics(type_353,type_353,info));
    type_name_357=(char*)come_increment_ref_count(make_type_name_string(type2_356,(_Bool)0,(_Bool)1,(_Bool)0,info,(_Bool)0));
    __dec_obj216=obj_value_354->c_value;
    obj_value_354->c_value=(char*)come_increment_ref_count(xsprintf("(%s*)come_calloc(1, sizeof(%s)*(%s), \"%s\", %d, \"%s\")",type_name_357,type_name_357,((char*)(__right_value605=buffer_to_string(num_string_355))),info->sname,info->sline,type_name_357));
    ...
    type3_358=(struct sType*)come_increment_ref_count(sType_clone(type2_356));
    type3_358->mPointerNum++;
    type3_358->mHeap=(_Bool)1;
    type2_356->mHeap=(_Bool)1;
    __dec_obj217=obj_value_354->type;
    obj_value_354->type=(struct sType*)come_increment_ref_count(sType_clone(type2_356));
    come_call_finalizer3(__dec_obj217,sType_finalize, 0, 0, 0, 0, (void*)0);
    obj_value_354->type->mPointerNum++;
    obj_value_354->var=((void*)0);
    append_object_to_right_values2(obj_value_354,(struct sType*)come_increment_ref_count(type3_358),info,(_Bool)0);
    come_params_359=(struct list$1CVALUEph*)come_increment_ref_count(list$1CVALUEph_initialize((struct list$1CVALUEph*)come_increment_ref_count((struct list$1CVALUEph*)come_calloc(1, sizeof(struct list$1CVALUEph)*(1), "06str.c", 1285, "list$1CVALUEph"))));
    if(    ((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_351->mParamTypes,0), "06str.c", 1287, 24))->mHeap&&obj_value_354->type->mHeap) {
        std_move(((struct sType*)come_null_check(list$1sTypephp_operator_load_element(fun_351->mParamTypes,0), "06str.c", 1288, 25)),obj_value_354->type,obj_value_354,info,(_Bool)1);
    }
    list$1CVALUEph_push_back(come_params_359,(struct CVALUE*)come_increment_ref_count(obj_value_354));
    come_value2_360=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 1292, "CVALUE"))));
    __dec_obj218=come_value2_360->c_value;
    come_value2_360->c_value=(char*)come_increment_ref_count(xsprintf("%d",list$1CVALUEph_length(key_params_312)));
    /*G*/ __dec_obj218 = come_decrement_ref_count2(__dec_obj218, (void*)0, (void*)0, 0,0,0, (void*)0);
    __dec_obj219=come_value2_360->type;
    come_value2_360->type=((void*)0);
    come_call_finalizer3(__dec_obj219,sType_finalize, 0, 0, 0, 0, (void*)0);
    come_value2_360->var=((void*)0);
    list$1CVALUEph_push_back(come_params_359,(struct CVALUE*)come_increment_ref_count(come_value2_360));
    come_value3_361=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 1300, "CVALUE"))));
    __dec_obj220=come_value3_361->c_value;
    come_value3_361->c_value=(char*)come_increment_ref_count(xsprintf("%s",var__337->mCValueName));
    /*G*/ __dec_obj220 = come_decrement_ref_count2(__dec_obj220, (void*)0, (void*)0, 0,0,0, (void*)0);
    __dec_obj221=come_value3_361->type;
    come_value3_361->type=((void*)0);
    come_call_finalizer3(__dec_obj221,sType_finalize, 0, 0, 0, 0, (void*)0);
    come_value3_361->var=((void*)0);
    list$1CVALUEph_push_back(come_params_359,(struct CVALUE*)come_increment_ref_count(come_value3_361));
    come_value4_362=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 1308, "CVALUE"))));
    __dec_obj222=come_value4_362->c_value;
    come_value4_362->c_value=(char*)come_increment_ref_count(xsprintf("%s",var2__340->mCValueName));
    /*G*/ __dec_obj222 = come_decrement_ref_count2(__dec_obj222, (void*)0, (void*)0, 0,0,0, (void*)0);
    __dec_obj223=come_value4_362->type;
    come_value4_362->type=((void*)0);
    come_call_finalizer3(__dec_obj223,sType_finalize, 0, 0, 0, 0, (void*)0);
    come_value4_362->var=((void*)0);
    list$1CVALUEph_push_back(come_params_359,(struct CVALUE*)come_increment_ref_count(come_value4_362));
    buffer_append_str(source_341,generics_fun_name_350);
    buffer_append_str(source_341,"(");
    j_363=0;
    for(    o2_saved_364=(struct list$1CVALUEph*)come_increment_ref_count((come_params_359)),it_365=list$1CVALUEph_begin((o2_saved_364));    !list$1CVALUEph_end((o2_saved_364));    it_365=list$1CVALUEph_next((o2_saved_364))    ){
        buffer_append_str(source_341,it_365->c_value);
        if(        j_363!=list$1CVALUEph_length(come_params_359)-1) {
            buffer_append_str(source_341,",");
        }
        j_363++;
    }
    /*i*/come_call_finalizer3(o2_saved_364,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
    buffer_append_str(source_341,")");
    buffer_append_str(source_341,")");
    come_value5_366=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "06str.c", 1334, "CVALUE"))));
    __dec_obj224=come_value5_366->c_value;
    come_value5_366->c_value=(char*)come_increment_ref_count(buffer_to_string(source_341));
    /*G*/ __dec_obj224 = come_decrement_ref_count2(__dec_obj224, (void*)0, (void*)0, 0,0,0, (void*)0);
    __dec_obj225=come_value5_366->type;
    come_value5_366->type=(struct sType*)come_increment_ref_count(sType_clone(result_type_352));
    come_call_finalizer3(__dec_obj225,sType_finalize, 0, 0, 0, 0, (void*)0);
    come_value5_366->type->mStatic=(_Bool)0;
    come_value5_366->var=((void*)0);
    if(    result_type_352->mHeap) {
        append_object_to_right_values2(come_value5_366,(struct sType*)come_increment_ref_count(result_type_352),info,(_Bool)0);
    }
    add_come_last_code(info,"%s",come_value5_366->c_value);
    list$1CVALUEph_push_back(info->stack,(struct CVALUE*)come_increment_ref_count(come_value5_366));
    ...
    /*i*/come_call_finalizer3(obj_value_354,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(num_string_355,buffer_finalize, 0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(type2_356,sType_finalize, 0, 0, 0, 0, (void*)0);
    /* U13 */type_name_357 = come_decrement_ref_count2(type_name_357, (void*)0, (void*)0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(type3_358,sType_finalize, 0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(come_params_359,list$1CVALUEphp_finalize, 0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(come_value2_360,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(come_value3_361,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(come_value4_362,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    /*i*/come_call_finalizer3(come_value5_366,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
...
struct sNode* default_value_320;
...
default_value_320 = (void*)0;
    ...
    while(it_318!=((void*)0)) {
        if(        position==i_319) {
            __result181__ = gComeFunResultObject = __result_obj__ = it_318->item;
            gComeFunResultObject = (void*)0;
    ...
    memset(&default_value_320,0,sizeof(struct sNode*));
    __result182__ = gComeFunResultObject = __result_obj__ = default_value_320;
    if(default_value_320) { default_value_320 = come_decrement_ref_count2(default_value_320, ((struct sNode*)default_value_320)->finalize, ((struct sNode*)default_value_320)->_protocol_obj, 0, 1, 0, (void*)0); } 
    gComeFunResultObject = (void*)0;
...
struct list$1sNodeph* exps_368;
void* __right_value626 = (void*)0;
void* __right_value627 = (void*)0;
struct buffer* value_369;
char* head_of_last_line_370;
int len_371;
...
_Bool global_383;
_Bool ignore_case_384;
_Bool catch_exception_385;
...
struct sNode* obj_386;
void* __right_value655 = (void*)0;
void* __right_value656 = (void*)0;
struct list$1tuple2$2charphsNodephph* params_388;
...
struct buffer* method_block_389;
int method_block_sline_390;
...
struct buffer* value_394;
char* p_395;
int sline_396;
int len_397;
int sline2_398;
_Bool global_399;
_Bool ignore_case_400;
_Bool catch_exception_401;
...
struct list$1tuple2$2charphsNodephph* params_404;
...
struct list$1sTypeph* method_generics_types_407;
...
int n_418;
int n_419;
unsigned long long int n_422;
unsigned char p2_423;
int size_424;
...
struct list$1sNodeph* exps_443;
void* __right_value773 = (void*)0;
void* __right_value774 = (void*)0;
struct buffer* value_444;
char* p_445;
int sline_446;
...
struct buffer* first_element_source_457;
void* __right_value788 = (void*)0;
void* __right_value789 = (void*)0;
struct list$1sNodeph* list_elements_458;
void* __right_value790 = (void*)0;
void* __right_value791 = (void*)0;
struct list$1sNodeph* map_keys_459;
void* __right_value792 = (void*)0;
void* __right_value793 = (void*)0;
struct list$1sNodeph* map_elements_460;
_Bool no_comma_461;
void* __right_value794 = (void*)0;
struct sNode* node2_462;
...
struct sNode* node2_465;
void* __right_value803 = (void*)0;
struct sNode* node3_466;
...
memset(&c_409, 0, sizeof(int));
memset(&c_416, 0, sizeof(int));
memset(&quote_417, 0, sizeof(_Bool));
memset(&size_424, 0, sizeof(int));
memset(&lont_435, 0, sizeof(unsigned long  int));
    if(    *info->p==34&&*(info->p+1)==34&&*(info->p+2)==34&&*(info->p+3)==10) {
        info->p+=4;
        info->sline++;
        sline_367=info->sline;
        exps_368=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count((struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "06str.c", 1362, "list$1sNodeph"))));
        value_369=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 1363, "buffer"))));
        head_of_last_line_370=((void*)0);
        while(1) {
            if(            *info->p==34&&*(info->p+1)==34&&*(info->p+2)==34) {
                if(                head_of_last_line_370) {
                    buffer_trim(value_369,info->p-head_of_last_line_370);
                }
                info->p+=3;
                ...
                buffer_append_char(value_369,37);
                buffer_append_char(value_369,37);
                info->p++;
            }
            else if(            *info->p==34) {
                buffer_append_char(value_369,92);
                buffer_append_char(value_369,34);
                info->p++;
            }
            else if(            *info->p==92) {
                buffer_append_char(value_369,92);
                ...
                if(                xisdigit(*info->p)) {
                    len_371=0;
                    while(xisdigit(*info->p)&&len_371<3) {
                        buffer_append_char(value_369,*info->p);
                        info->p++;
                        len_371++;
                    }
                }
                    ...
                    info->p++;
                    exp_372=(struct sNode*)come_increment_ref_count(expression_v13(info));
                    list$1sNodeph_add(exps_368,(struct sNode*)come_increment_ref_count(exp_372));
                    if(                    *info->p==125) {
                        info->p++;
                    }
                    buffer_append_str(value_369,"%s");
                ...
                if(                *info->p==10) {
                    buffer_append_char(value_369,92);
                    buffer_append_char(value_369,110);
                    info->p++;
                    info->sline++;
                    head_of_last_line_370=info->p;
                }
                else {
                    buffer_append_char(value_369,*info->p);
                    info->p++;
        ...
        _inf_obj_value5=(struct sSStringNode*)come_increment_ref_count(((struct sSStringNode*)(__right_value631=sSStringNode_initialize((struct sSStringNode*)come_increment_ref_count((struct sSStringNode*)come_calloc(1, sizeof(struct sSStringNode)*(1), "06str.c", 1512, "sSStringNode")),(char*)come_increment_ref_count(buffer_to_string(value_369)),(struct list$1sNodeph*)come_increment_ref_count(exps_368),sline_367,info))));
        ...
        /*i*/come_call_finalizer3(exps_368,list$1sNodephp_finalize, 0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(value_369,buffer_finalize, 0, 0, 0, 0, (void*)0);
        ...
        value_376=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 1520, "buffer"))));
        while(1) {
            if(            *info->p==34) {
                info->p++;
                p_377=info->p;
                ...
                sline2_379=info->sline;
                info->sline=sline_375;
                err_msg(info,"close \" to make c string value");
                info->sline=sline2_379;
                exit(2);
            }
            else {
                if(                *info->p==10) {
        ...
        _inf_obj_value6=(struct sStrNode*)come_increment_ref_count(((struct sStrNode*)(__right_value641=sStrNode_initialize((struct sStrNode*)come_increment_ref_count((struct sStrNode*)come_calloc(1, sizeof(struct sStrNode)*(1), "06str.c", 1572, "sStrNode")),(char*)come_increment_ref_count(buffer_to_string(value_376)),sline_375,info))));
        ...
        /*i*/come_call_finalizer3(value_376,buffer_finalize, 0, 0, 0, 0, (void*)0);
        ...
        buf_382=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 1579, "buffer"))));
        while((_Bool)1) {
        ...
        if(        strncmp(info->p,".rescue",strlen(".rescue"))==0||strncmp(info->p,".exception_throw",strlen(".exception_throw"))==0||strncmp(info->p,".exception_value",strlen(".exception_value"))==0||strncmp(info->p,"!!",strlen("!!"))==0) {
            catch_exception_385=(_Bool)1;
        }
        _inf_value7=(struct sNode*)come_calloc(1, sizeof(struct sNode), "06str.c", 1623, "struct sNode");
        _inf_obj_value7=(struct sStrNode*)come_increment_ref_count(((struct sStrNode*)(__right_value650=sStrNode_initialize((struct sStrNode*)come_increment_ref_count((struct sStrNode*)come_calloc(1, sizeof(struct sStrNode)*(1), "06str.c", 1623, "sStrNode")),(char*)come_increment_ref_count(buffer_to_string(buf_382)),sline_381,info))));
        ...
        obj_386=(struct sNode*)come_increment_ref_count(_inf_value7);
        /*g*/come_call_finalizer3(__right_value650,sStrNode_finalize, 0, 1, 0, 0, __result_obj__);
        params_388=(struct list$1tuple2$2charphsNodephph*)come_increment_ref_count(list$1tuple2$2charphsNodephph_initialize((struct list$1tuple2$2charphsNodephph*)come_increment_ref_count((struct list$1tuple2$2charphsNodephph*)come_calloc(1, sizeof(struct list$1tuple2$2charphsNodephph)*(1), "06str.c", 1625, "list$1tuple2$2charphsNodephph"))));
        list$1tuple2$2charphsNodephph_add(params_388,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1627, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("self")),(struct sNode*)come_increment_ref_count(obj_386))));
        list$1tuple2$2charphsNodephph_add(params_388,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1628, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("ignore_case")),(struct sNode*)come_increment_ref_count(((ignore_case_384)?(((struct sNode*)(__right_value661=create_int_node(1,info)))):(((struct sNode*)(__right_value662=create_int_node(0,info)))))))));
        ...
        list$1tuple2$2charphsNodephph_add(params_388,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1629, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("multiline")),(struct sNode*)come_increment_ref_count(create_int_node(0,info)))));
        list$1tuple2$2charphsNodephph_add(params_388,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1630, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("global")),(struct sNode*)come_increment_ref_count(((global_383)?(((struct sNode*)(__right_value670=create_int_node(1,info)))):(((struct sNode*)(__right_value671=create_int_node(0,info)))))))));
        ...
        list$1tuple2$2charphsNodephph_add(params_388,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1631, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("extended")),(struct sNode*)come_increment_ref_count(create_int_node(0,info)))));
        list$1tuple2$2charphsNodephph_add(params_388,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1632, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("dotall")),(struct sNode*)come_increment_ref_count(create_int_node(0,info)))));
        list$1tuple2$2charphsNodephph_add(params_388,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1633, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("anchored")),(struct sNode*)come_increment_ref_count(create_int_node(0,info)))));
        list$1tuple2$2charphsNodephph_add(params_388,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1634, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("dollar_endonly")),(struct sNode*)come_increment_ref_count(create_int_node(0,info)))));
        list$1tuple2$2charphsNodephph_add(params_388,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1635, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("ungreedy")),(struct sNode*)come_increment_ref_count(create_int_node(0,info)))));
        method_block_389=((void*)0);
        method_block_sline_390=info->sline;
        method_generics_types_391=(struct list$1sTypeph*)come_increment_ref_count(list$1sTypeph_initialize((struct list$1sTypeph*)come_increment_ref_count((struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "06str.c", 1641, "list$1sTypeph"))));
        node_392=(struct sNode*)come_increment_ref_count(create_method_call("to_regex",(struct sNode*)come_increment_ref_count(obj_386),(struct list$1tuple2$2charphsNodephph*)come_increment_ref_count(params_388),method_block_389,method_block_sline_390,method_generics_types_391,info));
        if(        !catch_exception_385) {
            __dec_obj240=node_392;
            node_392=(struct sNode*)come_increment_ref_count(create_exception_value((struct sNode*)come_increment_ref_count(sNode_clone(node_392)),info));
        ...
        __result197__ = gComeFunResultObject = __result_obj__ = node_392;
        /*i*/come_call_finalizer3(buf_382,buffer_finalize, 0, 0, 0, 0, (void*)0);
        if(obj_386) { obj_386 = come_decrement_ref_count2(obj_386, ((struct sNode*)obj_386)->finalize, ((struct sNode*)obj_386)->_protocol_obj, 0, 0, 0, (void*)0); } 
        /*i*/come_call_finalizer3(params_388,list$1tuple2$2charphsNodephphp_finalize, 0, 0, 0, 0, (void*)0);
        ...
        value_394=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 1656, "buffer"))));
        while(1) {
            if(            *info->p==34) {
                info->p++;
                p_395=info->p;
                ...
                buffer_append_char(value_394,92);
                info->p++;
                if(                xisdigit(*info->p)) {
                    len_397=0;
                    while(xisdigit(*info->p)&&len_397<3) {
                        buffer_append_char(value_394,*info->p);
                        info->p++;
                        len_397++;
                    }
                }
        ...
        skip_spaces_and_lf(info);
        catch_exception_401=(_Bool)0;
        if(        strncmp(info->p,".rescue",strlen(".rescue"))==0||strncmp(info->p,".exception_throw",strlen(".exception_throw"))==0||strncmp(info->p,".exception_value",strlen(".exception_value"))==0||strncmp(info->p,"!!",strlen("!!"))==0) {
            catch_exception_401=(_Bool)1;
        }
        _inf_value8=(struct sNode*)come_calloc(1, sizeof(struct sNode), "06str.c", 1787, "struct sNode");
        _inf_obj_value8=(struct sStrNode*)come_increment_ref_count(((struct sStrNode*)(__right_value703=sStrNode_initialize((struct sStrNode*)come_increment_ref_count((struct sStrNode*)come_calloc(1, sizeof(struct sStrNode)*(1), "06str.c", 1787, "sStrNode")),(char*)come_increment_ref_count(buffer_to_string(value_394)),sline_393,info))));
        ...
        params_404=(struct list$1tuple2$2charphsNodephph*)come_increment_ref_count(list$1tuple2$2charphsNodephph_initialize((struct list$1tuple2$2charphsNodephph*)come_increment_ref_count((struct list$1tuple2$2charphsNodephph*)come_calloc(1, sizeof(struct list$1tuple2$2charphsNodephph)*(1), "06str.c", 1789, "list$1tuple2$2charphsNodephph"))));
        list$1tuple2$2charphsNodephph_add(params_404,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1791, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("self")),(struct sNode*)come_increment_ref_count(obj_402))));
        list$1tuple2$2charphsNodephph_add(params_404,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1792, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("ignore_case")),(struct sNode*)come_increment_ref_count(((ignore_case_400)?(((struct sNode*)(__right_value714=create_int_node(1,info)))):(((struct sNode*)(__right_value715=create_int_node(0,info)))))))));
        ...
        list$1tuple2$2charphsNodephph_add(params_404,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1793, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("multiline")),(struct sNode*)come_increment_ref_count(create_int_node(0,info)))));
        list$1tuple2$2charphsNodephph_add(params_404,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1794, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("global")),(struct sNode*)come_increment_ref_count(((global_399)?(((struct sNode*)(__right_value723=create_int_node(1,info)))):(((struct sNode*)(__right_value724=create_int_node(0,info)))))))));
        ...
        list$1tuple2$2charphsNodephph_add(params_404,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1795, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("extended")),(struct sNode*)come_increment_ref_count(create_int_node(0,info)))));
        list$1tuple2$2charphsNodephph_add(params_404,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1796, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("dotall")),(struct sNode*)come_increment_ref_count(create_int_node(0,info)))));
        list$1tuple2$2charphsNodephph_add(params_404,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1797, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("anchored")),(struct sNode*)come_increment_ref_count(create_int_node(0,info)))));
        list$1tuple2$2charphsNodephph_add(params_404,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1798, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("dollar_endonly")),(struct sNode*)come_increment_ref_count(create_int_node(0,info)))));
        list$1tuple2$2charphsNodephph_add(params_404,(struct tuple2$2charphsNodeph*)come_increment_ref_count(tuple2$2charphsNodeph_initialize((struct tuple2$2charphsNodeph*)come_increment_ref_count((struct tuple2$2charphsNodeph*)come_calloc(1, sizeof(struct tuple2$2charphsNodeph)*(1), "06str.c", 1799, "struct tuple2$2charphsNodeph")),(char*)come_increment_ref_count(xsprintf("ungreedy")),(struct sNode*)come_increment_ref_count(create_int_node(0,info)))));
        method_block_405=((void*)0);
        method_block_sline_406=info->sline;
        method_generics_types_407=(struct list$1sTypeph*)come_increment_ref_count(list$1sTypeph_initialize((struct list$1sTypeph*)come_increment_ref_count((struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "06str.c", 1805, "list$1sTypeph"))));
        node_408=(struct sNode*)come_increment_ref_count(create_method_call("to_regex",(struct sNode*)come_increment_ref_count(obj_402),(struct list$1tuple2$2charphsNodephph*)come_increment_ref_count(params_404),method_block_405,method_block_sline_406,method_generics_types_407,info));
        if(        !catch_exception_401) {
            __dec_obj245=node_408;
            node_408=(struct sNode*)come_increment_ref_count(create_exception_value((struct sNode*)come_increment_ref_count(sNode_clone(node_408)),info));
        ...
        __result200__ = gComeFunResultObject = __result_obj__ = node_408;
        /*i*/come_call_finalizer3(value_394,buffer_finalize, 0, 0, 0, 0, (void*)0);
        if(obj_402) { obj_402 = come_decrement_ref_count2(obj_402, ((struct sNode*)obj_402)->finalize, ((struct sNode*)obj_402)->_protocol_obj, 0, 0, 0, (void*)0); } 
        /*i*/come_call_finalizer3(params_404,list$1tuple2$2charphsNodephphp_finalize, 0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(method_generics_types_407,list$1sTypephp_finalize, 0, 0, 0, 0, (void*)0);
            ...
            if(            xisdigit(*info->p)) {
                ...
                switch (*info->p) {
                    ...
                    case 88:
                    {
                        info->p++;
                        char buf_412[128];
                        memset(&buf_412, 0, sizeof(char)                        *(128)                        );
                        strncpy(buf_412,"0x",128);
                        while(*info->p>=48&&*info->p<=57||*info->p>=97&&*info->p<=102||*info->p>=65&&*info->p<=70) {
                            char buf2_413[2];
                            memset(&buf2_413, 0, sizeof(char)                            *(2)                            );
                            buf2_413[0]=*info->p;
                            buf2_413[1]=0;
                            info->p++;
                            strncat(buf_412,buf2_413,128);
                        }
                        n_414=strtoll(buf_412,((void*)0),0);
                        c_409=n_414;
                    }
                    break;
                    default:
        ...
        if(        *info->p!=39) {
            ...
            _inf_obj_value9=(struct sCharNode*)come_increment_ref_count(((struct sCharNode*)(__right_value753=sCharNode_initialize((struct sCharNode*)come_increment_ref_count((struct sCharNode*)come_calloc(1, sizeof(struct sCharNode)*(1), "06str.c", 1930, "sCharNode")),c_409,info))));
        ...
        if(        *info->p==92) {
            ...
            if(            xisdigit(*info->p)) {
                ...
                switch (*info->p) {
                    ...
                    case 88:
                    {
                        info->p++;
                        char buf_420[128];
                        memset(&buf_420, 0, sizeof(char)                        *(128)                        );
                        strncpy(buf_420,"0x",128);
                        while(*info->p>=48&&*info->p<=57||*info->p>=97&&*info->p<=102||*info->p>=65&&*info->p<=70) {
                            char buf2_421[2];
                            memset(&buf2_421, 0, sizeof(char)                            *(2)                            );
                            buf2_421[0]=*info->p;
                            buf2_421[1]=0;
                            info->p++;
                            strncat(buf_420,buf2_421,128);
                        }
                        n_422=strtoll(buf_420,((void*)0),0);
                        c_416=n_422;
                    }
                    break;
                    default:
            ...
            quote_417=(_Bool)0;
            p2_423=*(unsigned char*)info->p;
            if(            p2_423>127) {
                char str_425[6+1];
                memset(&str_425, 0, sizeof(char)                *(6+1)                );
                size_424=((p2_423&128)>>7)+((p2_423&64)>>6)+((p2_423&32)>>5)+((p2_423&16)>>4);
                if(                size_424>6) {
                    err_msg(info,"invalid utf-8 character. MB_LEN_MAX");
                    info->err_num++;
                }
                else {
                    memcpy(str_425,info->p,size_424);
                    str_425[size_424]=0;
                    if(                    mbtowc(&c_416,str_425,size_424)<0) {
                        perror("mbtowc");
        ...
        if(        *info->p!=39) {
            ...
            _inf_obj_value10=(struct sWCharNode*)come_increment_ref_count(((struct sWCharNode*)(__right_value758=sWCharNode_initialize((struct sWCharNode*)come_increment_ref_count((struct sWCharNode*)come_calloc(1, sizeof(struct sWCharNode)*(1), "06str.c", 2069, "sWCharNode")),c_416,quote_417,info))));
        ...
        value_428=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 2078, "buffer"))));
        while(1) {
            if(            *info->p==34) {
                info->p++;
                p_429=info->p;
                ...
                if(                xisdigit(*info->p)) {
                    ...
                    buffer_append_char(value_428,n_432);
                }
                else if(                *info->p==120||*info->p==88) {
                    info->p++;
                    char buf_433[128];
                    ...
                    n_436=strtoll(buf_433,((void*)0),0);
                    buffer_append_char(value_428,(char)n_436);
                }
                else {
                    switch (*info->p) {
                        case 48:
                        buffer_append_char(value_428,0);
                        info->p++;
                        break;
                        case 110:
                        buffer_append_char(value_428,10);
                        info->p++;
                        break;
                        case 116:
                        buffer_append_char(value_428,9);
                        info->p++;
                        break;
                        case 114:
                        buffer_append_char(value_428,13);
                        info->p++;
                        break;
                        case 118:
                        buffer_append_char(value_428,11);
                        info->p++;
                        break;
                        case 102:
                        buffer_append_char(value_428,12);
                        info->p++;
                        break;
                        case 97:
                        buffer_append_char(value_428,7);
                        info->p++;
                        break;
                        case 98:
                        buffer_append_char(value_428,8);
                        info->p++;
                        break;
                        case 92:
        ...
        skip_spaces_and_lf(info);
        len_438=value_428->len;
        wstr_439=(int*)come_increment_ref_count((int*)come_calloc(1, sizeof(int)*(1*(len_438+1)), "06str.c", 2201, "int"));
        str_440=value_428->buf;
        if(        mbstowcs(wstr_439,str_440,len_438+1)<0) {
            perror("mbstowcs");
            exit(1);
        }
        wstr_439[len_438]=0;
        _inf_value11=(struct sNode*)come_calloc(1, sizeof(struct sNode), "06str.c", 2212, "struct sNode");
        _inf_obj_value11=(struct sWStringNode*)come_increment_ref_count(((struct sWStringNode*)(__right_value766=sWStringNode_initialize((struct sWStringNode*)come_increment_ref_count((struct sWStringNode*)come_calloc(1, sizeof(struct sWStringNode)*(1), "06str.c", 2212, "sWStringNode")),(int*)come_increment_ref_count(wstr_439),sline_427,info))));
        ...
        /* U13 */wstr_439 = come_decrement_ref_count2(wstr_439, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        ...
        exps_443=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count((struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "06str.c", 2220, "list$1sNodeph"))));
        value_444=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 2221, "buffer"))));
        while(1) {
            if(            *info->p==34) {
                info->p++;
                p_445=info->p;
                ...
                buffer_append_char(value_444,37);
                buffer_append_char(value_444,37);
                info->p++;
            }
            else if(            *info->p==36) {
                ...
                list$1sNodeph_add(exps_443,(struct sNode*)come_increment_ref_count(exp_447));
                buffer_append_str(value_444,"%s");
                p_448=info->p-1;
                ...
                buffer_append_char(value_444,92);
                info->p++;
                if(                xisdigit(*info->p)) {
                    len_449=0;
                    while(xisdigit(*info->p)&&len_449<3) {
                        buffer_append_char(value_444,*info->p);
                        info->p++;
                        len_449++;
                    }
                }
                    ...
                    list$1sNodeph_add(exps_443,(struct sNode*)come_increment_ref_count(exp_450));
                    if(                    *info->p==125) {
                        info->p++;
                    }
                    buffer_append_str(value_444,"%s");
        ...
        _inf_obj_value12=(struct sSStringNode*)come_increment_ref_count(((struct sSStringNode*)(__right_value779=sSStringNode_initialize((struct sSStringNode*)come_increment_ref_count((struct sSStringNode*)come_calloc(1, sizeof(struct sSStringNode)*(1), "06str.c", 2366, "sSStringNode")),(char*)come_increment_ref_count(buffer_to_string(value_444)),(struct list$1sNodeph*)come_increment_ref_count(exps_443),sline_442,info))));
        ...
        /*i*/come_call_finalizer3(exps_443,list$1sNodephp_finalize, 0, 0, 0, 0, (void*)0);
        /*i*/come_call_finalizer3(value_444,buffer_finalize, 0, 0, 0, 0, (void*)0);
        ...
        p2_456=info->p;
        first_element_source_457=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "06str.c", 2383, "buffer"))));
        buffer_append(first_element_source_457,p_453,p2_456-p_453);
        buffer_append_char(first_element_source_457,0);
        list_elements_458=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count((struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "06str.c", 2388, "list$1sNodeph"))));
        map_keys_459=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count((struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "06str.c", 2390, "list$1sNodeph"))));
        map_elements_460=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count((struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "06str.c", 2391, "list$1sNodeph"))));
        if(        *info->p==58) {
            info->p++;
            skip_spaces_and_lf(info);
            list$1sNodeph_push_back(map_keys_459,(struct sNode*)come_increment_ref_count(node_455));
            no_comma_461=info->no_comma;
            info->no_comma=(_Bool)1;
            node2_462=(struct sNode*)come_increment_ref_count(expression_v13(info));
            info->no_comma=no_comma_461;
            list$1sNodeph_push_back(map_elements_460,(struct sNode*)come_increment_ref_count(node2_462));
            if(            *info->p==93) {
                info->p++;
                skip_spaces_and_lf(info);
                _inf_value13=(struct sNode*)come_calloc(1, sizeof(struct sNode), "06str.c", 2414, "struct sNode");
                _inf_obj_value13=(struct sMapNode*)come_increment_ref_count(((struct sMapNode*)(__right_value796=sMapNode_initialize((struct sMapNode*)come_increment_ref_count((struct sMapNode*)come_calloc(1, sizeof(struct sMapNode)*(1), "06str.c", 2414, "sMapNode")),(struct list$1sNodeph*)come_increment_ref_count(map_keys_459),(struct list$1sNodeph*)come_increment_ref_count(map_elements_460),info))));
                ...
                if(node2_462) { node2_462 = come_decrement_ref_count2(node2_462, ((struct sNode*)node2_462)->finalize, ((struct sNode*)node2_462)->_protocol_obj, 0, 0, 0, (void*)0); } 
                ...
                /*i*/come_call_finalizer3(first_element_source_457,buffer_finalize, 0, 0, 0, 0, (void*)0);
                /*i*/come_call_finalizer3(list_elements_458,list$1sNodephp_finalize, 0, 0, 0, 0, (void*)0);
                /*i*/come_call_finalizer3(map_keys_459,list$1sNodephp_finalize, 0, 0, 0, 0, (void*)0);
                /*i*/come_call_finalizer3(map_elements_460,list$1sNodephp_finalize, 0, 0, 0, 0, (void*)0);
                ...
                while((_Bool)1) {
                    ...
                    info->no_comma=(_Bool)1;
                    node2_465=(struct sNode*)come_increment_ref_count(expression_v13(info));
                    info->no_comma=no_comma_464;
                    list$1sNodeph_push_back(map_keys_459,(struct sNode*)come_increment_ref_count(node2_465));
                    expected_next_character(58,info);
                    no_comma_464=info->no_comma;
                    info->no_comma=(_Bool)1;
                    node3_466=(struct sNode*)come_increment_ref_count(expression_v13(info));
                    info->no_comma=no_comma_464;
                    list$1sNodeph_push_back(map_elements_460,(struct sNode*)come_increment_ref_count(node3_466));
                    if(                    *info->p==0) {
                        ...
                        info->p++;
                        skip_spaces_and_lf(info);
                        if(node2_465) { node2_465 = come_decrement_ref_count2(node2_465, ((struct sNode*)node2_465)->finalize, ((struct sNode*)node2_465)->_protocol_obj, 0, 0, 0, (void*)0); } 
                        if(node3_466) { node3_466 = come_decrement_ref_count2(node3_466, ((struct sNode*)node3_466)->finalize, ((struct sNode*)node3_466)->_protocol_obj, 0, 0, 0, (void*)0); } 
                        break;
                    }
                    else {
                ...
                _inf_obj_value14=(struct sMapNode*)come_increment_ref_count(((struct sMapNode*)(__right_value805=sMapNode_initialize((struct sMapNode*)come_increment_ref_count((struct sMapNode*)come_calloc(1, sizeof(struct sMapNode)*(1), "06str.c", 2459, "sMapNode")),(struct list$1sNodeph*)come_increment_ref_count(map_keys_459),(struct list$1sNodeph*)come_increment_ref_count(map_elements_460),info))));
            ...
            info->p++;
            skip_spaces_and_lf(info);
            list$1sNodeph_push_back(list_elements_458,(struct sNode*)come_increment_ref_count(node_455));
        }
        else if(        *info->p==44) {
            info->p++;
            skip_spaces_and_lf(info);
            ...
            while((_Bool)1) {
                ...
                info->no_comma=(_Bool)1;
                node2_469=(struct sNode*)come_increment_ref_count(expression_v13(info));
                info->no_comma=no_comma_468;
                list$1sNodeph_push_back(list_elements_458,(struct sNode*)come_increment_ref_count(node2_469));
                if(                *info->p==0) {
                    err_msg(info,"invalid source end");
                    exit(2);
                }
                    ...
                    info->p++;
                    skip_spaces_and_lf(info);
                    if(node2_469) { node2_469 = come_decrement_ref_count2(node2_469, ((struct sNode*)node2_469)->finalize, ((struct sNode*)node2_469)->_protocol_obj, 0, 0, 0, (void*)0); } 
                    break;
                }
                else {
        ...
        node_471=(struct sNode*)come_increment_ref_count(expression_node_v95(info));
        __result222__ = gComeFunResultObject = __result_obj__ = node_471;
        if(node_471) { node_471 = come_decrement_ref_count2(node_471, ((struct sNode*)node_471)->finalize, ((struct sNode*)node_471)->_protocol_obj, 0, 1, 0, (void*)0); } 
        gComeFunResultObject = (void*)0;
...
struct sStrNode* __result199__;
    ...
    result_403=(struct sStrNode*)come_increment_ref_count((struct sStrNode*)come_calloc(1, sizeof(struct sStrNode)*(1), "sStrNode_clone", 3, "sStrNode"));
    if(    self!=((void*)0)) {
        result_403->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj243=result_403->sname;
    ...
    if(    self!=((void*)0)&&self->value!=((void*)0)) {
        __dec_obj244=result_403->value;
        result_403->value=(char*)come_increment_ref_count(string_clone(self->value));
        /*G*/ __dec_obj244 = come_decrement_ref_count2(__dec_obj244, (void*)0, (void*)0, 0,0,0, (void*)0);
    }
    __result199__ = gComeFunResultObject = __result_obj__ = result_403;
    /*i*/come_call_finalizer3(result_403,sStrNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
struct sCharNode* __result202__;
    ...
    result_415=(struct sCharNode*)come_increment_ref_count((struct sCharNode*)come_calloc(1, sizeof(struct sCharNode)*(1), "sCharNode_clone", 3, "sCharNode"));
    if(    self!=((void*)0)) {
        result_415->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj247=result_415->sname;
    ...
    if(    self!=((void*)0)) {
        result_415->value=self->value;
    }
    __result202__ = gComeFunResultObject = __result_obj__ = result_415;
    /*i*/come_call_finalizer3(result_415,sCharNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
struct sWCharNode* __result205__;
    ...
    result_426=(struct sWCharNode*)come_increment_ref_count((struct sWCharNode*)come_calloc(1, sizeof(struct sWCharNode)*(1), "sWCharNode_clone", 3, "sWCharNode"));
    if(    self!=((void*)0)) {
        result_426->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj249=result_426->sname;
    ...
    if(    self!=((void*)0)) {
        result_426->value=self->value;
    }
    if(    self!=((void*)0)) {
        result_426->quote=self->quote;
    }
    __result205__ = gComeFunResultObject = __result_obj__ = result_426;
    /*i*/come_call_finalizer3(result_426,sWCharNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
struct sWStringNode* result_441;
...
struct sWStringNode* __result208__;
    ...
    result_441=(struct sWStringNode*)come_increment_ref_count((struct sWStringNode*)come_calloc(1, sizeof(struct sWStringNode)*(1), "sWStringNode_clone", 3, "sWStringNode"));
    if(    self!=((void*)0)) {
        result_441->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj252=result_441->sname;
    ...
    if(    self!=((void*)0)&&self->value!=((void*)0)) {
        __dec_obj253=result_441->value;
        result_441->value=(int*)come_increment_ref_count((int*)come_memdup(self->value, "sWStringNode_clone", 6, "int*"));
        /*G*/ __dec_obj253 = come_decrement_ref_count2(__dec_obj253, (void*)0, (void*)0, 0,0,0, (void*)0);
    }
    __result208__ = gComeFunResultObject = __result_obj__ = result_441;
    /*i*/come_call_finalizer3(result_441,sWStringNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
struct sSStringNode* result_452;
...
struct sSStringNode* __result211__;
    ...
    result_452=(struct sSStringNode*)come_increment_ref_count((struct sSStringNode*)come_calloc(1, sizeof(struct sSStringNode)*(1), "sSStringNode_clone", 3, "sSStringNode"));
    if(    self!=((void*)0)) {
        result_452->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj257=result_452->sname;
    ...
    if(    self!=((void*)0)&&self->value!=((void*)0)) {
        __dec_obj258=result_452->value;
        result_452->value=(char*)come_increment_ref_count(string_clone(self->value));
        /*G*/ __dec_obj258 = come_decrement_ref_count2(__dec_obj258, (void*)0, (void*)0, 0,0,0, (void*)0);
    }
    if(    self!=((void*)0)&&self->exps!=((void*)0)) {
        __dec_obj259=result_452->exps;
        result_452->exps=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodephp_clone(self->exps));
        come_call_finalizer3(__dec_obj259,list$1sNodeph_finalize, 0, 0, 0, 0, (void*)0);
    }
    __result211__ = gComeFunResultObject = __result_obj__ = result_452;
    /*i*/come_call_finalizer3(result_452,sSStringNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
struct sMapNode* __result217__;
    ...
    result_467=(struct sMapNode*)come_increment_ref_count((struct sMapNode*)come_calloc(1, sizeof(struct sMapNode)*(1), "sMapNode_clone", 3, "sMapNode"));
    if(    self!=((void*)0)) {
        result_467->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj269=result_467->sname;
    ...
    if(    self!=((void*)0)&&self->map_key_elements!=((void*)0)) {
        __dec_obj270=result_467->map_key_elements;
        result_467->map_key_elements=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodephp_clone(self->map_key_elements));
        come_call_finalizer3(__dec_obj270,list$1sNodeph_finalize, 0, 0, 0, 0, (void*)0);
    }
    if(    self!=((void*)0)&&self->map_elements!=((void*)0)) {
        __dec_obj271=result_467->map_elements;
        result_467->map_elements=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodephp_clone(self->map_elements));
        come_call_finalizer3(__dec_obj271,list$1sNodeph_finalize, 0, 0, 0, 0, (void*)0);
    }
    __result217__ = gComeFunResultObject = __result_obj__ = result_467;
    /*i*/come_call_finalizer3(result_467,sMapNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
struct sListNode* __result220__;
    ...
    result_470=(struct sListNode*)come_increment_ref_count((struct sListNode*)come_calloc(1, sizeof(struct sListNode)*(1), "sListNode_clone", 3, "sListNode"));
    if(    self!=((void*)0)) {
        result_470->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj274=result_470->sname;
    ...
    if(    self!=((void*)0)&&self->list_elements!=((void*)0)) {
        __dec_obj275=result_470->list_elements;
        result_470->list_elements=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodephp_clone(self->list_elements));
        come_call_finalizer3(__dec_obj275,list$1sNodeph_finalize, 0, 0, 0, 0, (void*)0);
    }
    __result220__ = gComeFunResultObject = __result_obj__ = result_470;
    /*i*/come_call_finalizer3(result_470,sListNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
struct list$1sNodeph* tuple_elements_472;
char* p_473;
_Bool no_comma_474;
...
struct sNode* __result226__;
    tuple_elements_472=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count((struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "06str.c", 2525, "list$1sNodeph"))));
    while((_Bool)1) {
        p_473=info->p;
        no_comma_474=info->no_comma;
        info->no_comma=(_Bool)1;
        node_475=(struct sNode*)come_increment_ref_count(expression_v13(info));
        __dec_obj276=node_475;
        ...
        list$1sNodeph_push_back(tuple_elements_472,(struct sNode*)come_increment_ref_count(node_475));
        if(        *info->p==44) {
            info->p++;
            skip_spaces_and_lf(info);
        }
    ...
    /*i*/come_call_finalizer3(tuple_elements_472,list$1sNodephp_finalize, 0, 0, 0, 0, (void*)0);
...
struct sTupleNode* __result225__;
    ...
    result_476=(struct sTupleNode*)come_increment_ref_count((struct sTupleNode*)come_calloc(1, sizeof(struct sTupleNode)*(1), "sTupleNode_clone", 3, "sTupleNode"));
    if(    self!=((void*)0)) {
        result_476->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj279=result_476->sname;
    ...
    if(    self!=((void*)0)&&self->tuple_elements!=((void*)0)) {
        __dec_obj280=result_476->tuple_elements;
        result_476->tuple_elements=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodephp_clone(self->tuple_elements));
        come_call_finalizer3(__dec_obj280,list$1sNodeph_finalize, 0, 0, 0, 0, (void*)0);
    }
    __result225__ = gComeFunResultObject = __result_obj__ = result_476;
    /*i*/come_call_finalizer3(result_476,sTupleNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
struct sNode* __result229__;
    tuple_elements_477=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count((struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "06str.c", 2559, "list$1sNodeph"))));
    node_478=(struct sNode*)come_increment_ref_count(exp);
    list$1sNodeph_push_back(tuple_elements_477,(struct sNode*)come_increment_ref_count(node_478));
    node2_479=(struct sNode*)come_increment_ref_count(create_null_node(info));
    list$1sNodeph_push_back(tuple_elements_477,(struct sNode*)come_increment_ref_count(node2_479));
    _inf_value17=(struct sNode*)come_calloc(1, sizeof(struct sNode), "06str.c", 2569, "struct sNode");
    _inf_obj_value17=(struct sSomeNode*)come_increment_ref_count(((struct sSomeNode*)(__right_value833=sSomeNode_initialize((struct sSomeNode*)come_increment_ref_count((struct sSomeNode*)come_calloc(1, sizeof(struct sSomeNode)*(1), "06str.c", 2569, "sSomeNode")),(struct list$1sNodeph*)come_increment_ref_count(tuple_elements_477),info))));
    ...
    if(node2_479) { node2_479 = come_decrement_ref_count2(node2_479, ((struct sNode*)node2_479)->finalize, ((struct sNode*)node2_479)->_protocol_obj, 0, 0, 0, (void*)0); } 
...
struct list$1sNodeph* tuple_elements_481;
...
struct sNode* __result232__;
    tuple_elements_481=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count((struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "06str.c", 2574, "list$1sNodeph"))));
    expected_next_character(40,info);
    node_482=(struct sNode*)come_increment_ref_count(expression_v13(info));
    __dec_obj285=node_482;
    node_482=(struct sNode*)come_increment_ref_count(post_position_operator_v99((struct sNode*)come_increment_ref_count(node_482),info));
    ...
    list$1sNodeph_push_back(tuple_elements_481,(struct sNode*)come_increment_ref_count(node_482));
    node2_483=(struct sNode*)come_increment_ref_count(create_null_node(info));
    list$1sNodeph_push_back(tuple_elements_481,(struct sNode*)come_increment_ref_count(node2_483));
    _inf_value18=(struct sNode*)come_calloc(1, sizeof(struct sNode), "06str.c", 2587, "struct sNode");
    _inf_obj_value18=(struct sSomeNode*)come_increment_ref_count(((struct sSomeNode*)(__right_value844=sSomeNode_initialize((struct sSomeNode*)come_increment_ref_count((struct sSomeNode*)come_calloc(1, sizeof(struct sSomeNode)*(1), "06str.c", 2587, "sSomeNode")),(struct list$1sNodeph*)come_increment_ref_count(tuple_elements_481),info))));
    ...
    /*i*/come_call_finalizer3(tuple_elements_481,list$1sNodephp_finalize, 0, 0, 0, 0, (void*)0);
...
struct sSomeNode* __result231__;
    ...
    result_484=(struct sSomeNode*)come_increment_ref_count((struct sSomeNode*)come_calloc(1, sizeof(struct sSomeNode)*(1), "sSomeNode_clone", 3, "sSomeNode"));
    if(    self!=((void*)0)) {
        result_484->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj288=result_484->sname;
    ...
    if(    self!=((void*)0)&&self->tuple_elements!=((void*)0)) {
        __dec_obj289=result_484->tuple_elements;
        result_484->tuple_elements=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodephp_clone(self->tuple_elements));
        come_call_finalizer3(__dec_obj289,list$1sNodeph_finalize, 0, 0, 0, 0, (void*)0);
    }
    __result231__ = gComeFunResultObject = __result_obj__ = result_484;
    /*i*/come_call_finalizer3(result_484,sSomeNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
struct sNode* node2_487;
struct sNode* node3_488;
...
struct sNode* __result235__;
    tuple_elements_485=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count((struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "06str.c", 2592, "list$1sNodeph"))));
    expected_next_character(40,info);
    node_486=(struct sNode*)come_increment_ref_count(expression_v13(info));
    __dec_obj290=node_486;
    node_486=(struct sNode*)come_increment_ref_count(post_position_operator_v99((struct sNode*)come_increment_ref_count(node_486),info));
    ...
    expected_next_character(41,info);
    node2_487=(struct sNode*)come_increment_ref_count(create_null_return_value_of_exception(info));
    list$1sNodeph_push_back(tuple_elements_485,(struct sNode*)come_increment_ref_count(node2_487));
    node3_488=(struct sNode*)come_increment_ref_count(node_486);
    list$1sNodeph_push_back(tuple_elements_485,(struct sNode*)come_increment_ref_count(node3_488));
    _inf_value19=(struct sNode*)come_calloc(1, sizeof(struct sNode), "06str.c", 2607, "struct sNode");
    _inf_obj_value19=(struct sNoneNode*)come_increment_ref_count(((struct sNoneNode*)(__right_value855=sNoneNode_initialize((struct sNoneNode*)come_increment_ref_count((struct sNoneNode*)come_calloc(1, sizeof(struct sNoneNode)*(1), "06str.c", 2607, "sNoneNode")),(struct list$1sNodeph*)come_increment_ref_count(tuple_elements_485),info))));
    ...
    /*i*/come_call_finalizer3(tuple_elements_485,list$1sNodephp_finalize, 0, 0, 0, 0, (void*)0);
    ...
    if(node2_487) { node2_487 = come_decrement_ref_count2(node2_487, ((struct sNode*)node2_487)->finalize, ((struct sNode*)node2_487)->_protocol_obj, 0, 0, 0, (void*)0); } 
    if(node3_488) { node3_488 = come_decrement_ref_count2(node3_488, ((struct sNode*)node3_488)->finalize, ((struct sNode*)node3_488)->_protocol_obj, 0, 0, 0, (void*)0); } 
...
struct sNoneNode* __result234__;
    ...
    result_489=(struct sNoneNode*)come_increment_ref_count((struct sNoneNode*)come_calloc(1, sizeof(struct sNoneNode)*(1), "sNoneNode_clone", 3, "sNoneNode"));
    if(    self!=((void*)0)) {
        result_489->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj293=result_489->sname;
    ...
    if(    self!=((void*)0)&&self->tuple_elements!=((void*)0)) {
        __dec_obj294=result_489->tuple_elements;
    ...
    __result234__ = gComeFunResultObject = __result_obj__ = result_489;
    /*i*/come_call_finalizer3(result_489,sNoneNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
