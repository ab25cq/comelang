...
void load_context(struct context* anonymous_var_nameX38);
void save_context(struct context* anonymous_var_nameX39);
void reset_watchdog();
void putc(char c);
void yield();
void task1();
...
char* __result_obj__24;
    ...
    __result_obj__24 = (char*)come_increment_ref_count(result_59);
...
void* __right_value7 = (void*)0;
    ...
    gComeStackFrameBuffer=strdup(((char*)(__right_value7=buffer_to_string(buf_61))));
...
memset(&i_84, 0, sizeof(int));
    if(    gComeDebugLib    ) {
        ...
        gAllocMem=it_82;
        gNumAlloc++;
        __result_obj__28 = (char*)result_81+sizeof(struct sMemHeader);
...
void* __result_obj__32;
    ...
    *size2_94=size*count+sizeof(unsigned long  int)+sizeof(unsigned long  int);
    __result_obj__32 = mem_92+sizeof(unsigned long  int)+sizeof(unsigned long  int);
...
char* __result_obj__44;
    ...
    __result_obj__44 = (char*)come_increment_ref_count(result_115);
...
struct buffer* __result_obj__48;
    ...
    __result_obj__48 = (struct buffer*)come_increment_ref_count(result_116);
...
struct buffer* __result_obj__57;
    ...
    char result_127[128];
    memset(&result_127, 0, sizeof(char)    *(128)    );
    __builtin_va_start(args_128,msg);
    snprintf(result_127,128,args_128);
    __builtin_va_end(args_128);
    len_129=strlen(result_127);
    mem_130=(char*)come_increment_ref_count(__builtin_string(result_127));
    size_131=strlen(mem_130);
    if(    self->len+size_131+1+1>=self->size    ) {
        old_buf_132=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3049, "char*"));
        memcpy(old_buf_132,self->buf,self->size);
        old_len_133=self->len;
        new_size_134=(self->size+size_131+1)*2;
        __dec_obj7=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size_134)), "/usr/local/include/comelang.h", 3053, "char*"));
...
struct buffer* __result_obj__59;
    ...
    if(    self->len+size_135+1+1+1>=self->size    ) {
        old_buf_136=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3075, "char*"));
        memcpy(old_buf_136,self->buf,self->size);
        old_len_137=self->len;
        new_size_138=(self->size+size_135+1)*2;
        __dec_obj8=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size_138)), "/usr/local/include/comelang.h", 3079, "char*"));
...
struct buffer* __result_obj__61;
    ...
    if(    self->len+size_140+1+1>=self->size    ) {
        old_buf_141=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3102, "char*"));
        memcpy(old_buf_141,self->buf,self->size);
        old_len_142=self->len;
        new_size_143=(self->size+size_140+1)*2;
        __dec_obj9=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size_143)), "/usr/local/include/comelang.h", 3106, "char*"));
...
struct buffer* __result_obj__62;
    ...
    if(    self->len+size_145+1+1>=self->size    ) {
        old_buf_146=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3125, "char*"));
        memcpy(old_buf_146,self->buf,self->size);
        old_len_147=self->len;
        new_size_148=(self->size+size_145+1)*2;
        __dec_obj10=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size_148)), "/usr/local/include/comelang.h", 3129, "char*"));
...
struct buffer* __result_obj__64;
    ...
    if(    self->len+size_150+1+1>=self->size    ) {
        old_buf_151=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(self->size)), "/usr/local/include/comelang.h", 3152, "char*"));
        memcpy(old_buf_151,self->buf,self->size);
        old_len_152=self->len;
        new_size_153=(self->size+size_150+1)*2;
        __dec_obj11=self->buf,
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size_153)), "/usr/local/include/comelang.h", 3156, "char*"));
...
struct buffer* __result_obj__66;
    ...
    if(    len_154>=self->size    ) {
        ...
        self->buf=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(new_size_155)), "/usr/local/include/comelang.h", 3180, "char*"));
...
struct buffer* __result_obj__68;
    result_157=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 3210, "struct buffer*"))));
    if(    self==((void*)0)    ) {
        __result_obj__67 = (struct buffer*)come_increment_ref_count(result_157);
    ...
    __result_obj__68 = (struct buffer*)come_increment_ref_count(result_157);
    come_call_finalizer(buffer_finalize, result_157, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
...
struct buffer* __result_obj__72;
    result_158=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 3237, "struct buffer*"))));
...
struct buffer* __result_obj__73;
    result_159=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 3244, "struct buffer*"))));
    for(    i_160=0    ;    i_160<len    ;    i_160++    ){
        buffer_append(result_159,self[i_160],strlen(self[i_160]));
    }
    __result_obj__73 = (struct buffer*)come_increment_ref_count(result_159);
...
struct buffer* __result_obj__74;
    result_161=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 3253, "struct buffer*"))));
...
struct buffer* __result_obj__75;
    result_162=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 3260, "struct buffer*"))));
...
struct buffer* __result_obj__76;
    result_163=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 3267, "struct buffer*"))));
...
struct buffer* __result_obj__77;
    result_164=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 3274, "struct buffer*"))));
...
struct buffer* __result_obj__78;
    result_165=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 3281, "struct buffer*"))));
    buffer_append(result_165,(char*)self,sizeof(double)*len);
    __result_obj__78 = (struct buffer*)come_increment_ref_count(result_165);
...
char* __result_obj__79;
    len_166=self->len;
    result_167=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len_166*2+1)), "/usr/local/include/comelang.h", 3289, "char*"));
    n_168=0;
    ...
    result_167[n_168]=0;
    __result_obj__79 = (char*)come_increment_ref_count(result_167);
...
struct list$1char$* __result_obj__80;
    if(    self->len==0    ) {
        litem_172=(struct list_item$1char$*)come_increment_ref_count(((struct list_item$1char$*)(__right_value54=(struct list_item$1char$*)come_calloc_v2(1, sizeof(struct list_item$1char$)*(1), "/usr/local/include/comelang.h", 1100, "struct list_item$1char$*"))));
        ...
        litem_173=(struct list_item$1char$*)come_increment_ref_count(((struct list_item$1char$*)(__right_value55=(struct list_item$1char$*)come_calloc_v2(1, sizeof(struct list_item$1char$)*(1), "/usr/local/include/comelang.h", 1110, "struct list_item$1char$*"))));
        ...
        litem_174=(struct list_item$1char$*)come_increment_ref_count(((struct list_item$1char$*)(__right_value56=(struct list_item$1char$*)come_calloc_v2(1, sizeof(struct list_item$1char$)*(1), "/usr/local/include/comelang.h", 1120, "struct list_item$1char$*"))));
...
struct list$1char$p* __result_obj__83;
    if(    self->len==0    ) {
        litem_178=(struct list_item$1char$p*)come_increment_ref_count(((struct list_item$1char$p*)(__right_value59=(struct list_item$1char$p*)come_calloc_v2(1, sizeof(struct list_item$1char$p)*(1), "/usr/local/include/comelang.h", 1100, "struct list_item$1char$p*"))));
        ...
        litem_179=(struct list_item$1char$p*)come_increment_ref_count(((struct list_item$1char$p*)(__right_value60=(struct list_item$1char$p*)come_calloc_v2(1, sizeof(struct list_item$1char$p)*(1), "/usr/local/include/comelang.h", 1110, "struct list_item$1char$p*"))));
        ...
        litem_180=(struct list_item$1char$p*)come_increment_ref_count(((struct list_item$1char$p*)(__right_value61=(struct list_item$1char$p*)come_calloc_v2(1, sizeof(struct list_item$1char$p)*(1), "/usr/local/include/comelang.h", 1120, "struct list_item$1char$p*"))));
...
struct list$1short$* __result_obj__86;
    if(    self->len==0    ) {
        litem_184=(struct list_item$1short$*)come_increment_ref_count(((struct list_item$1short$*)(__right_value64=(struct list_item$1short$*)come_calloc_v2(1, sizeof(struct list_item$1short$)*(1), "/usr/local/include/comelang.h", 1100, "struct list_item$1short$*"))));
        ...
        litem_185=(struct list_item$1short$*)come_increment_ref_count(((struct list_item$1short$*)(__right_value65=(struct list_item$1short$*)come_calloc_v2(1, sizeof(struct list_item$1short$)*(1), "/usr/local/include/comelang.h", 1110, "struct list_item$1short$*"))));
        ...
        litem_186=(struct list_item$1short$*)come_increment_ref_count(((struct list_item$1short$*)(__right_value66=(struct list_item$1short$*)come_calloc_v2(1, sizeof(struct list_item$1short$)*(1), "/usr/local/include/comelang.h", 1120, "struct list_item$1short$*"))));
...
struct list$1int$* __result_obj__89;
    if(    self->len==0    ) {
        litem_190=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value69=(struct list_item$1int$*)come_calloc_v2(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/comelang.h", 1100, "struct list_item$1int$*"))));
        ...
        litem_191=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value70=(struct list_item$1int$*)come_calloc_v2(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/comelang.h", 1110, "struct list_item$1int$*"))));
        ...
        litem_192=(struct list_item$1int$*)come_increment_ref_count(((struct list_item$1int$*)(__right_value71=(struct list_item$1int$*)come_calloc_v2(1, sizeof(struct list_item$1int$)*(1), "/usr/local/include/comelang.h", 1120, "struct list_item$1int$*"))));
...
struct list$1long$* __result_obj__92;
    if(    self->len==0    ) {
        litem_196=(struct list_item$1long$*)come_increment_ref_count(((struct list_item$1long$*)(__right_value74=(struct list_item$1long$*)come_calloc_v2(1, sizeof(struct list_item$1long$)*(1), "/usr/local/include/comelang.h", 1100, "struct list_item$1long$*"))));
        ...
        litem_197=(struct list_item$1long$*)come_increment_ref_count(((struct list_item$1long$*)(__right_value75=(struct list_item$1long$*)come_calloc_v2(1, sizeof(struct list_item$1long$)*(1), "/usr/local/include/comelang.h", 1110, "struct list_item$1long$*"))));
        ...
        litem_198=(struct list_item$1long$*)come_increment_ref_count(((struct list_item$1long$*)(__right_value76=(struct list_item$1long$*)come_calloc_v2(1, sizeof(struct list_item$1long$)*(1), "/usr/local/include/comelang.h", 1120, "struct list_item$1long$*"))));
...
struct list$1float$* __result_obj__95;
    if(    self->len==0    ) {
        litem_202=(struct list_item$1float$*)come_increment_ref_count(((struct list_item$1float$*)(__right_value79=(struct list_item$1float$*)come_calloc_v2(1, sizeof(struct list_item$1float$)*(1), "/usr/local/include/comelang.h", 1100, "struct list_item$1float$*"))));
        ...
        litem_203=(struct list_item$1float$*)come_increment_ref_count(((struct list_item$1float$*)(__right_value80=(struct list_item$1float$*)come_calloc_v2(1, sizeof(struct list_item$1float$)*(1), "/usr/local/include/comelang.h", 1110, "struct list_item$1float$*"))));
        ...
        litem_204=(struct list_item$1float$*)come_increment_ref_count(((struct list_item$1float$*)(__right_value81=(struct list_item$1float$*)come_calloc_v2(1, sizeof(struct list_item$1float$)*(1), "/usr/local/include/comelang.h", 1120, "struct list_item$1float$*"))));
...
struct list$1double$* __result_obj__98;
    if(    self->len==0    ) {
        litem_208=(struct list_item$1double$*)come_increment_ref_count(((struct list_item$1double$*)(__right_value84=(struct list_item$1double$*)come_calloc_v2(1, sizeof(struct list_item$1double$)*(1), "/usr/local/include/comelang.h", 1100, "struct list_item$1double$*"))));
        ...
        litem_209=(struct list_item$1double$*)come_increment_ref_count(((struct list_item$1double$*)(__right_value85=(struct list_item$1double$*)come_calloc_v2(1, sizeof(struct list_item$1double$)*(1), "/usr/local/include/comelang.h", 1110, "struct list_item$1double$*"))));
        ...
        litem_210=(struct list_item$1double$*)come_increment_ref_count(((struct list_item$1double$*)(__right_value86=(struct list_item$1double$*)come_calloc_v2(1, sizeof(struct list_item$1double$)*(1), "/usr/local/include/comelang.h", 1120, "struct list_item$1double$*"))));
...
char* __result_obj__102;
    ...
    result_214=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len_213+1)), "/usr/local/include/comelang.h", 3589, "char*"));
    strncpy(result_214,self,len_213+1);
    strncat(result_214,right,len_213+1);
    __result_obj__102 = (char*)come_increment_ref_count(result_214);
...
char* __result_obj__104;
    ...
    result_216=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len_215+1)), "/usr/local/include/comelang.h", 3604, "char*"));
    strncpy(result_216,self,len_215+1);
    strncat(result_216,right,len_215+1);
    __result_obj__104 = (char*)come_increment_ref_count(result_216);
...
char* __result_obj__106;
    ...
    buf_217=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 3617, "struct buffer*"))));
    for(    i_218=0    ;    i_218<right    ;    i_218++    ){
        buffer_append_str(buf_217,self);
    }
    __result_obj__106 = (char*)come_increment_ref_count(((char*)(__right_value95=buffer_to_string(buf_217))));
...
char* __result_obj__108;
    ...
    buf_219=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 3631, "struct buffer*"))));
    for(    i_220=0    ;    i_220<right    ;    i_220++    ){
        buffer_append_str(buf_219,self);
    }
    __result_obj__108 = (char*)come_increment_ref_count(((char*)(__right_value99=buffer_to_string(buf_219))));
...
char* __result_obj__110;
    ...
    len_229=strlen(str);
    result_230=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len_229+1)), "/usr/local/include/comelang.h", 3899, "char*"));
    for(    i_231=0    ;    i_231<len_229    ;    i_231++    ){
        result_230[i_231]=str[len_229-i_231-1];
    }
    result_230[len_229]=0;
    __result_obj__110 = (char*)come_increment_ref_count(result_230);
...
char* __result_obj__115;
    ...
    result_233=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(tail-head+1)), "/usr/local/include/comelang.h", 3945, "char*"));
    memcpy(result_233,str+head,tail-head);
    result_233[tail-head]=0;
    __result_obj__115 = (char*)come_increment_ref_count(result_233);
...
char* __result_obj__120;
    ...
    result_235=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(tail-head+1)), "/usr/local/include/comelang.h", 3988, "char*"));
    memcpy(result_235,str+head,tail-head);
    result_235[tail-head]=0;
    __result_obj__120 = (char*)come_increment_ref_count(result_235);
...
char* __result_obj__125;
    ...
    result_237=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(tail-head+1)), "/usr/local/include/comelang.h", 4031, "char*"));
    memcpy(result_237,str+head,tail-head);
    result_237[tail-head]=0;
    __result_obj__125 = (char*)come_increment_ref_count(result_237);
...
result_239 = (void*)0;
    ...
    free(result_239);
    __result_obj__128 = (char*)come_increment_ref_count(result2_241);
...
char* __result_obj__132;
    ...
    result_243=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len_242-(tail-head)+1)), "/usr/local/include/comelang.h", 4093, "char*"));
...
struct list$1char$ph* __result_obj__135;
    if(    self->len==0    ) {
        litem_249=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value133=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1100, "struct list_item$1char$ph*"))));
        ...
        litem_250=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value134=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1110, "struct list_item$1char$ph*"))));
        ...
        litem_251=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value135=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1120, "struct list_item$1char$ph*"))));
...
struct list$1char$ph* __result_obj__136;
    ...
    result_246=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/comelang.h", 4109, "struct list$1char$ph*"))));
    str_247=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 4111, "struct buffer*"))));
    ...
    __result_obj__136 = (struct list$1char$ph*)come_increment_ref_count(result_246);
...
char* __result_obj__139;
    ...
    result_253=(char*)come_increment_ref_count((char*)come_calloc_v2(1, sizeof(char)*(1*(len_252*2+1)), "/usr/local/include/comelang.h", 4143, "char*"));
    n_254=0;
    ...
    result_253[n_254]=0;
    __result_obj__139 = (char*)come_increment_ref_count(result_253);
...
char* __result_obj__141;
    ...
    result_257=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "/usr/local/include/comelang.h", 4171, "struct buffer*"))));
    p_258=self;
    while(    (_Bool)1    ) {
    ...
    __result_obj__141 = (char*)come_increment_ref_count(((char*)(__right_value144=buffer_to_string(result_257))));
...
char* __result_obj__145;
    ...
    if(    p_260<path    ) {
        ...
        __result_obj__144 = (char*)come_increment_ref_count(((char*)(__right_value147=__builtin_string(p_260+1))));
...
char* __result_obj__149;
    ...
    if(    p_262<path2_261    ) {
        __result_obj__147 = (char*)come_increment_ref_count(((char*)(__right_value151=__builtin_string(path2_261))));
        ...
        __result_obj__148 = (char*)come_increment_ref_count(((char*)(__right_value152=charp_substring(path2_261,0,p_262-path2_261))));
        (path2_261 = come_decrement_ref_count(path2_261, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
...
char* __result_obj__153;
    ...
    if(    p_263<path    ) {
        ...
        __result_obj__152 = (char*)come_increment_ref_count(((char*)(__right_value156=__builtin_string(p_263+1))));
...
msg2_264 = (void*)0;
    ...
    char msg2_265[128];
    memset(&msg2_265, 0, sizeof(char)    *(128)    );
    __builtin_va_start(args_266,self);
    len_267=snprintf(msg2_265,128,self,args_266);
