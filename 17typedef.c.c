...
struct list$1tuple2$2sTypephcharphph* __result245__;
    ...
    result_301=(struct list$1tuple2$2sTypephcharphph*)come_increment_ref_count(list$1tuple2$2sTypephcharphph_initialize((struct list$1tuple2$2sTypephcharphph*)come_increment_ref_count((struct list$1tuple2$2sTypephcharphph*)come_calloc(1, sizeof(struct list$1tuple2$2sTypephcharphph)*(1), "./comelang.h", 1051, "list$1tuple2$2sTypephcharphph"))));
    it_302=self->head;
    while(it_302!=((void*)0)) {
...
struct list$1tuple2$2sTypephcharphph* __result242__;
    if(    self->len==0) {
        litem_303=(struct list_item$1tuple2$2sTypephcharphph*)come_increment_ref_count(((struct list_item$1tuple2$2sTypephcharphph*)(__right_value322=(struct list_item$1tuple2$2sTypephcharphph*)come_calloc(1, sizeof(struct list_item$1tuple2$2sTypephcharphph)*(1), "./comelang.h", 1065, "list_item$1tuple2$2sTypephcharphph"))));
        ...
        litem_304=(struct list_item$1tuple2$2sTypephcharphph*)come_increment_ref_count(((struct list_item$1tuple2$2sTypephcharphph*)(__right_value323=(struct list_item$1tuple2$2sTypephcharphph*)come_calloc(1, sizeof(struct list_item$1tuple2$2sTypephcharphph)*(1), "./comelang.h", 1075, "list_item$1tuple2$2sTypephcharphph"))));
        ...
        litem_305=(struct list_item$1tuple2$2sTypephcharphph*)come_increment_ref_count(((struct list_item$1tuple2$2sTypephcharphph*)(__right_value324=(struct list_item$1tuple2$2sTypephcharphph*)come_calloc(1, sizeof(struct list_item$1tuple2$2sTypephcharphph)*(1), "./comelang.h", 1085, "list_item$1tuple2$2sTypephcharphph"))));
...
default_value_330 = (void*)0;
    ...
    keys_311=(char**)come_increment_ref_count(((char**)(__right_value332=(char**)come_calloc(1, sizeof(char*)*(1*(size_310)), "./comelang.h", 2540, "char*%"))));
    items_312=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value333=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_310)), "./comelang.h", 2541, "sClass*%"))));
    item_existance_313=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value334=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_310)), "./comelang.h", 2542, "bool"))));
    len_314=0;
...
default_value_372 = (void*)0;
    ...
    keys_357=(char**)come_increment_ref_count(((char**)(__right_value341=(char**)come_calloc(1, sizeof(char*)*(1*(size_356)), "./comelang.h", 2540, "char*%"))));
    items_358=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value342=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_356)), "./comelang.h", 2541, "sType*%"))));
    item_existance_359=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value343=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_356)), "./comelang.h", 2542, "bool"))));
    len_360=0;
...
default_value_393 = (void*)0;
    ...
    keys_378=(char**)come_increment_ref_count(((char**)(__right_value346=(char**)come_calloc(1, sizeof(char*)*(1*(size_377)), "./comelang.h", 2540, "char*%"))));
    items_379=(struct buffer**)come_increment_ref_count(((struct buffer**)(__right_value347=(struct buffer**)come_calloc(1, sizeof(struct buffer*)*(1*(size_377)), "./comelang.h", 2541, "buffer*%"))));
    item_existance_380=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value348=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_377)), "./comelang.h", 2542, "bool"))));
    len_381=0;
...
struct list$1tuple2$2sTypephcharphph* __result299__;
    if(    self->len==0) {
        litem_419=(struct list_item$1tuple2$2sTypephcharphph*)come_increment_ref_count(((struct list_item$1tuple2$2sTypephcharphph*)(__right_value381=(struct list_item$1tuple2$2sTypephcharphph*)come_calloc(1, sizeof(struct list_item$1tuple2$2sTypephcharphph)*(1), "./comelang.h", 1135, "list_item$1tuple2$2sTypephcharphph"))));
        ...
        litem_420=(struct list_item$1tuple2$2sTypephcharphph*)come_increment_ref_count(((struct list_item$1tuple2$2sTypephcharphph*)(__right_value382=(struct list_item$1tuple2$2sTypephcharphph*)come_calloc(1, sizeof(struct list_item$1tuple2$2sTypephcharphph)*(1), "./comelang.h", 1145, "list_item$1tuple2$2sTypephcharphph"))));
        ...
        litem_421=(struct list_item$1tuple2$2sTypephcharphph*)come_increment_ref_count(((struct list_item$1tuple2$2sTypephcharphph*)(__right_value383=(struct list_item$1tuple2$2sTypephcharphph*)come_calloc(1, sizeof(struct list_item$1tuple2$2sTypephcharphph)*(1), "./comelang.h", 1155, "list_item$1tuple2$2sTypephcharphph"))));
