...
struct list$1tuple2$2sTypephcharphph* __result220__;
    ...
    result_277=(struct list$1tuple2$2sTypephcharphph*)come_increment_ref_count(list$1tuple2$2sTypephcharphph_initialize((struct list$1tuple2$2sTypephcharphph*)come_increment_ref_count((struct list$1tuple2$2sTypephcharphph*)come_calloc(1, sizeof(struct list$1tuple2$2sTypephcharphph)*(1), "./comelang.h", 1026, "list$1tuple2$2sTypephcharphph"))));
    it_278=self->head;
    while(it_278!=((void*)0)) {
...
struct list$1tuple2$2sTypephcharphph* __result217__;
    if(    self->len==0) {
        litem_279=(struct list_item$1tuple2$2sTypephcharphph*)come_increment_ref_count(((struct list_item$1tuple2$2sTypephcharphph*)(__right_value287=(struct list_item$1tuple2$2sTypephcharphph*)come_calloc(1, sizeof(struct list_item$1tuple2$2sTypephcharphph)*(1), "./comelang.h", 1040, "list_item$1tuple2$2sTypephcharphph"))));
        ...
        litem_280=(struct list_item$1tuple2$2sTypephcharphph*)come_increment_ref_count(((struct list_item$1tuple2$2sTypephcharphph*)(__right_value288=(struct list_item$1tuple2$2sTypephcharphph*)come_calloc(1, sizeof(struct list_item$1tuple2$2sTypephcharphph)*(1), "./comelang.h", 1050, "list_item$1tuple2$2sTypephcharphph"))));
        ...
        litem_281=(struct list_item$1tuple2$2sTypephcharphph*)come_increment_ref_count(((struct list_item$1tuple2$2sTypephcharphph*)(__right_value289=(struct list_item$1tuple2$2sTypephcharphph*)come_calloc(1, sizeof(struct list_item$1tuple2$2sTypephcharphph)*(1), "./comelang.h", 1060, "list_item$1tuple2$2sTypephcharphph"))));
...
default_value_306 = (void*)0;
    ...
    keys_287=(char**)come_increment_ref_count(((char**)(__right_value297=(char**)come_calloc(1, sizeof(char*)*(1*(size_286)), "./comelang.h", 2515, "char*%"))));
    items_288=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value298=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_286)), "./comelang.h", 2516, "sClass*%"))));
    item_existance_289=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value299=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_286)), "./comelang.h", 2517, "bool"))));
    len_290=0;
...
default_value_348 = (void*)0;
    ...
    keys_333=(char**)come_increment_ref_count(((char**)(__right_value306=(char**)come_calloc(1, sizeof(char*)*(1*(size_332)), "./comelang.h", 2515, "char*%"))));
    items_334=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value307=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_332)), "./comelang.h", 2516, "sType*%"))));
    item_existance_335=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value308=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_332)), "./comelang.h", 2517, "bool"))));
    len_336=0;
...
default_value_369 = (void*)0;
    ...
    keys_354=(char**)come_increment_ref_count(((char**)(__right_value311=(char**)come_calloc(1, sizeof(char*)*(1*(size_353)), "./comelang.h", 2515, "char*%"))));
    items_355=(struct buffer**)come_increment_ref_count(((struct buffer**)(__right_value312=(struct buffer**)come_calloc(1, sizeof(struct buffer*)*(1*(size_353)), "./comelang.h", 2516, "buffer*%"))));
    item_existance_356=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value313=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_353)), "./comelang.h", 2517, "bool"))));
    len_357=0;
...
struct list$1tuple2$2sTypephcharphph* __result274__;
    if(    self->len==0) {
        litem_395=(struct list_item$1tuple2$2sTypephcharphph*)come_increment_ref_count(((struct list_item$1tuple2$2sTypephcharphph*)(__right_value346=(struct list_item$1tuple2$2sTypephcharphph*)come_calloc(1, sizeof(struct list_item$1tuple2$2sTypephcharphph)*(1), "./comelang.h", 1110, "list_item$1tuple2$2sTypephcharphph"))));
        ...
        litem_396=(struct list_item$1tuple2$2sTypephcharphph*)come_increment_ref_count(((struct list_item$1tuple2$2sTypephcharphph*)(__right_value347=(struct list_item$1tuple2$2sTypephcharphph*)come_calloc(1, sizeof(struct list_item$1tuple2$2sTypephcharphph)*(1), "./comelang.h", 1120, "list_item$1tuple2$2sTypephcharphph"))));
        ...
        litem_397=(struct list_item$1tuple2$2sTypephcharphph*)come_increment_ref_count(((struct list_item$1tuple2$2sTypephcharphph*)(__right_value348=(struct list_item$1tuple2$2sTypephcharphph*)come_calloc(1, sizeof(struct list_item$1tuple2$2sTypephcharphph)*(1), "./comelang.h", 1130, "list_item$1tuple2$2sTypephcharphph"))));
