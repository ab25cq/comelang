...
default_value_125 = (void*)0;
    ...
    keys_106=(char**)come_increment_ref_count(((char**)(__right_value166=(char**)come_calloc(1, sizeof(char*)*(1*(size_105)), "./comelang.h", 1620, "char*%"))));
    items_107=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value167=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_105)), "./comelang.h", 1621, "sClass*%"))));
    item_existance_108=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value168=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_105)), "./comelang.h", 1622, "bool"))));
    len_109=0;
...
default_value_167 = (void*)0;
    ...
    keys_152=(char**)come_increment_ref_count(((char**)(__right_value175=(char**)come_calloc(1, sizeof(char*)*(1*(size_151)), "./comelang.h", 1620, "char*%"))));
    items_153=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value176=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_151)), "./comelang.h", 1621, "sType*%"))));
    item_existance_154=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value177=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_151)), "./comelang.h", 1622, "bool"))));
    len_155=0;
