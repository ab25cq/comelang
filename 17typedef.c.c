...
default_value_127 = (void*)0;
    ...
    keys_108=(char**)come_increment_ref_count(((char**)(__right_value167=(char**)come_calloc(1, sizeof(char*)*(1*(size_107)), "./comelang.h", 1658, "char*%"))));
    items_109=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value168=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_107)), "./comelang.h", 1659, "sClass*%"))));
    item_existance_110=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value169=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_107)), "./comelang.h", 1660, "bool"))));
    len_111=0;
...
default_value_169 = (void*)0;
    ...
    keys_154=(char**)come_increment_ref_count(((char**)(__right_value176=(char**)come_calloc(1, sizeof(char*)*(1*(size_153)), "./comelang.h", 1658, "char*%"))));
    items_155=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value177=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_153)), "./comelang.h", 1659, "sType*%"))));
    item_existance_156=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value178=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_153)), "./comelang.h", 1660, "bool"))));
    len_157=0;
