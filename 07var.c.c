...
default_value_256 = (void*)0;
    ...
    keys_241=(char**)come_increment_ref_count(((char**)(__right_value369=(char**)come_calloc(1, sizeof(char*)*(1*(size_240)), "/usr/local/include/comelang.h", 1621, "char*%"))));
    items_242=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value370=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_240)), "/usr/local/include/comelang.h", 1622, "sVar*%"))));
    item_existance_243=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value371=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_240)), "/usr/local/include/comelang.h", 1623, "bool"))));
    len_244=0;
