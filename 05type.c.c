...
struct list$1sNodeph* __result143__;
    if(self->len==0) {
        litem_211=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value261=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 221, "list_item$1sNodeph"))));
        ...
        if(self->len==1) {
            litem_212=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value262=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 231, "list_item$1sNodeph"))));
            ...
            litem_213=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value263=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 241, "list_item$1sNodeph"))));
...
default_value_352 = (void*)0;
    ...
    keys_337=(char**)come_increment_ref_count(((char**)(__right_value431=(char**)come_calloc(1, sizeof(char*)*(1*(size_336)), "/usr/local/include/comelang.h", 1621, "char*%"))));
    items_338=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value432=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_336)), "/usr/local/include/comelang.h", 1622, "sClass*%"))));
    item_existance_339=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value433=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_336)), "/usr/local/include/comelang.h", 1623, "bool"))));
    len_340=0;
