...
struct list$1charph* __result69__;
    ...
    result_69=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang.h", 143, "list$1charph"))));
    it_70=self->head;
    while(it_70!=((void*)0)) {
...
struct list$1charph* __result68__;
    if(    self->len==0) {
        litem_71=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value123=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 157, "list_item$1charph"))));
        ...
        litem_72=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value124=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 167, "list_item$1charph"))));
        ...
        litem_73=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value125=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 177, "list_item$1charph"))));
...
struct sNode* __result111__;
    if(    charp_operator_equals(buf,"module")) {
        ...
        _inf_obj_value2=come_increment_ref_count(((struct sHeaderNode*)(__right_value166=sHeaderNode_initialize((struct sHeaderNode*)come_increment_ref_count((struct sHeaderNode*)come_calloc(1, sizeof(struct sHeaderNode)*(1), "24module.c", 187, "sHeaderNode")),(char*)come_increment_ref_count(contents_136),info))));
        ...
        _inf_obj_value3=come_increment_ref_count(((struct sHeaderNode*)(__right_value174=sHeaderNode_initialize((struct sHeaderNode*)come_increment_ref_count((struct sHeaderNode*)come_calloc(1, sizeof(struct sHeaderNode)*(1), "24module.c", 202, "sHeaderNode")),(char*)come_increment_ref_count(contents_140),info))));
        ...
        _inf_obj_value4=come_increment_ref_count(((struct sHeaderNode*)(__right_value183=sHeaderNode_initialize((struct sHeaderNode*)come_increment_ref_count((struct sHeaderNode*)come_calloc(1, sizeof(struct sHeaderNode)*(1), "24module.c", 251, "sHeaderNode")),(char*)come_increment_ref_count(xsprintf("")),info))));
...
default_value_108 = (void*)0;
    ...
    keys_93=(char**)come_increment_ref_count(((char**)(__right_value151=(char**)come_calloc(1, sizeof(char*)*(1*(size_92)), "/usr/local/include/comelang.h", 1655, "char*%"))));
    items_94=(struct sClassModule**)come_increment_ref_count(((struct sClassModule**)(__right_value152=(struct sClassModule**)come_calloc(1, sizeof(struct sClassModule*)*(1*(size_92)), "/usr/local/include/comelang.h", 1656, "sClassModule*%"))));
    item_existance_95=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value153=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_92)), "/usr/local/include/comelang.h", 1657, "bool"))));
    len_96=0;
