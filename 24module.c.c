...
char* name_18;
struct sClassModule* module_19;
_Bool __result_obj__9;
    name_18=(char*)come_increment_ref_count(__builtin_string(self->name));
    module_19=self->module;
    __result_obj__9 = (_Bool)1;
    (name_18 = come_decrement_ref_count(name_18, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
...
struct sClassModule* __result_obj__6;
    ...
    result_10=(struct sClassModule*)come_increment_ref_count((struct sClassModule*)come_calloc_v2(1, sizeof(struct sClassModule)*(1), "sClassModule_clone", 3, "struct sClassModule*"));
    if(    self!=((void*)0)&&self->mName!=((void*)0)    ) {
        __dec_obj2=result_10->mName,
        result_10->mName=(char*)come_increment_ref_count((char*)come_memdup(self->mName, "sClassModule_clone", 4, "char*"));
        __dec_obj2 = come_decrement_ref_count(__dec_obj2, (void*)0, (void*)0, 0/* no_decrement */,0/* no_free */, (void*)0);
    }
    if(    self!=((void*)0)&&self->mText!=((void*)0)    ) {
        __dec_obj3=result_10->mText,
        result_10->mText=(char*)come_increment_ref_count((char*)come_memdup(self->mText, "sClassModule_clone", 5, "char*"));
        __dec_obj3 = come_decrement_ref_count(__dec_obj3, (void*)0, (void*)0, 0/* no_decrement */,0/* no_free */, (void*)0);
    }
    if(    self!=((void*)0)&&self->mParams!=((void*)0)    ) {
        __dec_obj7=result_10->mParams,
        result_10->mParams=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph$p_clone(self->mParams));
        come_call_finalizer(list$1char$ph_finalize, __dec_obj7,(void*)0, (void*)0, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, (void*)0);
    }
    if(    self!=((void*)0)&&self->mSName!=((void*)0)    ) {
        __dec_obj8=result_10->mSName,
        result_10->mSName=(char*)come_increment_ref_count((char*)come_memdup(self->mSName, "sClassModule_clone", 7, "char*"));
        __dec_obj8 = come_decrement_ref_count(__dec_obj8, (void*)0, (void*)0, 0/* no_decrement */,0/* no_free */, (void*)0);
    }
    if(    self!=((void*)0)    ) {
        result_10->mSLine=self->mSLine;
    }
    __result_obj__6 = (struct sClassModule*)come_increment_ref_count(result_10);
    come_call_finalizer(sClassModule_finalize, result_10, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
...
struct list$1char$ph* result_11;
...
struct list$1char$ph* __result_obj__5;
    ...
    result_11=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "/usr/local/include/comelang.h", 1008, "struct list$1char$ph*"))));
    it_12=self->head;
    while(    it_12!=((void*)0)    ) {
        if(        1        ) {
            list$1char$ph_add(result_11,(char*)come_increment_ref_count((char*)come_memdup(it_12->item, "/usr/local/include/comelang.h", 1013, "char*")));
        }
        else {
            list$1char$ph_add(result_11,(char*)come_increment_ref_count((char*)come_memdup(it_12->item, "/usr/local/include/comelang.h", 1016, "char*")));
        }
        it_12=it_12->next;
    }
    __result_obj__5 = (struct list$1char$ph*)come_increment_ref_count(result_11);
    come_call_finalizer(list$1char$ph$p_finalize, result_11, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
...
struct list$1char$ph* __result_obj__4;
    if(    self->len==0    ) {
        litem_13=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value7=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1027, "struct list_item$1char$ph*"))));
        litem_13->prev=((void*)0);
        litem_13->next=((void*)0);
        __dec_obj4=litem_13->item,
        ...
        litem_14=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value8=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1037, "struct list_item$1char$ph*"))));
        litem_14->prev=self->head;
        litem_14->next=((void*)0);
        __dec_obj5=litem_14->item,
        ...
        litem_15=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value9=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1047, "struct list_item$1char$ph*"))));
...
_Bool __result_obj__12;
    contents_20=(char*)come_increment_ref_count(self->contents);
    __result_obj__12 = (_Bool)1;
    (contents_20 = come_decrement_ref_count(contents_20, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
...
struct sNode* exp2_24;
_Bool Value_25;
_Bool __result_obj__16;
void* __right_value23 = (void*)0;
struct CVALUE* come_value2_30;
void* __right_value24 = (void*)0;
void* __right_value25 = (void*)0;
struct CVALUE* come_value3_31;
...
_Bool __result_obj__17;
    exp_21=(struct sNode*)come_increment_ref_count(self->exp);
    Value_22=node_compile(exp_21,info);
    if(    !Value_22    ) {
        __result_obj__15 = (_Bool)0;
        ((exp_21) ? exp_21 = come_decrement_ref_count(exp_21, ((struct sNode*)exp_21)->finalize, ((struct sNode*)exp_21)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,(void*)0):(void*)0);
        return __result_obj__15;
    }
    else {
    }
    come_value_23=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
    exp2_24=(struct sNode*)come_increment_ref_count(self->exp2);
    Value_25=node_compile(exp2_24,info);
    if(    !Value_25    ) {
        __result_obj__16 = (_Bool)0;
        ((exp_21) ? exp_21 = come_decrement_ref_count(exp_21, ((struct sNode*)exp_21)->finalize, ((struct sNode*)exp_21)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,(void*)0):(void*)0);
        come_call_finalizer(CVALUE_finalize, come_value_23, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
        ((exp2_24) ? exp2_24 = come_decrement_ref_count(exp2_24, ((struct sNode*)exp2_24)->finalize, ((struct sNode*)exp2_24)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,(void*)0):(void*)0);
        return __result_obj__16;
    }
    else {
    }
    come_value2_30=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
    come_value3_31=(struct CVALUE*)come_increment_ref_count(CVALUE_initialize((struct CVALUE*)come_increment_ref_count((struct CVALUE*)come_calloc_v2(1, sizeof(struct CVALUE)*(1), "24module.c", 76, "struct CVALUE*"))));
    __dec_obj13=come_value3_31->c_value,
    come_value3_31->c_value=(char*)come_increment_ref_count(xsprintf("_Static_assert(%s, %s)",come_value_23->c_value,come_value2_30->c_value));
    __dec_obj13 = come_decrement_ref_count(__dec_obj13, (void*)0, (void*)0, 0/* no_decrement */,0/* no_free */, (void*)0);
    __dec_obj14=come_value3_31->type,
    come_value3_31->type=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc_v2(1, sizeof(struct sType)*(1), "24module.c", 79, "struct sType*")),(char*)come_increment_ref_count(xsprintf("void")),(_Bool)0,info));
    come_call_finalizer(sType_finalize, __dec_obj14,(void*)0, (void*)0, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, (void*)0);
    come_value3_31->var=((void*)0);
    add_come_last_code(info,"%s",come_value2_30->c_value);
    __result_obj__17 = (_Bool)1;
    ((exp_21) ? exp_21 = come_decrement_ref_count(exp_21, ((struct sNode*)exp_21)->finalize, ((struct sNode*)exp_21)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,(void*)0):(void*)0);
    come_call_finalizer(CVALUE_finalize, come_value_23, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    ((exp2_24) ? exp2_24 = come_decrement_ref_count(exp2_24, ((struct sNode*)exp2_24)->finalize, ((struct sNode*)exp2_24)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,(void*)0):(void*)0);
    come_call_finalizer(CVALUE_finalize, come_value2_30, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    come_call_finalizer(CVALUE_finalize, come_value3_31, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
...
struct sStaticAssert* result_32;
...
struct sStaticAssert* __result_obj__21;
    ...
    result_32=(struct sStaticAssert*)come_increment_ref_count((struct sStaticAssert*)come_calloc_v2(1, sizeof(struct sStaticAssert)*(1), "sStaticAssert_clone", 3, "struct sStaticAssert*"));
    if(    self!=((void*)0)    ) {
        result_32->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)    ) {
        __dec_obj15=result_32->sname,
        result_32->sname=(char*)come_increment_ref_count((char*)come_memdup(self->sname, "sStaticAssert_clone", 5, "char*"));
    ...
    if(    self!=((void*)0)&&self->exp!=((void*)0)    ) {
        __dec_obj16=result_32->exp,
        result_32->exp=(struct sNode*)come_increment_ref_count(sNode_clone(self->exp));
    ...
    if(    self!=((void*)0)&&self->exp2!=((void*)0)    ) {
        __dec_obj17=result_32->exp2,
        result_32->exp2=(struct sNode*)come_increment_ref_count(sNode_clone(self->exp2));
    ...
    __result_obj__21 = result_32;
    come_call_finalizer(sStaticAssert_finalize, result_32, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
...
struct sNode* __result_obj__20;
    ...
    result_33=(struct sNode*)come_increment_ref_count((struct sNode*)come_calloc_v2(1, sizeof(struct sNode)*(1), "sNode_clone", 3, "struct sNode*"));
    ...
    if(    self!=((void*)0)    ) {
        result_33->sline_real=self->sline_real;
    }
    if(    self!=((void*)0)    ) {
    ...
    if(    self!=((void*)0)    ) {
        result_33->no_mutex=self->no_mutex;
    }
    __result_obj__20 = (struct sNode*)come_increment_ref_count(result_33);
    ((result_33) ? result_33 = come_decrement_ref_count(result_33, ((struct sNode*)result_33)->finalize, ((struct sNode*)result_33)->_protocol_obj, 0/* no_decrement */, 1/*no_free*/,(void*)0):(void*)0);
...
struct list$1char$ph* params_37;
...
_Bool no_output_come_code2_103;
_Bool block_104;
char* head_105;
int head_sline_106;
...
struct sNode* __result_obj__54;
    if(    charp_operator_equals(buf,"module")    ) {
        ...
        sname_35=(char*)come_increment_ref_count(info->sname);
        sline_36=info->sline;
        params_37=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph_initialize((struct list$1char$ph*)come_increment_ref_count((struct list$1char$ph*)come_calloc_v2(1, sizeof(struct list$1char$ph)*(1), "24module.c", 101, "struct list$1char$ph*"))));
        if(        *info->p==60        ) {
            info->p++;
            skip_spaces_and_lf(info);
            while(            (_Bool)1            ) {
                word_38=(char*)come_increment_ref_count(parse_word(info));
                list$1char$ph_add(params_37,(char*)come_increment_ref_count(word_38));
                if(                *info->p==44                ) {
                    info->p++;
                    skip_spaces_and_lf(info);
                }
                    ...
                    info->p++;
                    skip_spaces_and_lf(info);
                    (word_38 = come_decrement_ref_count(word_38, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
                    break;
                }
                else {
        ...
        source_head_39=info->p;
        source_tail_40=((void*)0);
        buf_41=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "24module.c", 137, "struct buffer*"))));
        squort_42=(_Bool)0;
        dquort_43=(_Bool)0;
        nest_44=1;
        while(        1        ) {
            if(            *info->p==0            ) {
                ...
                buffer_append_char(buf_41,*info->p);
                info->p++;
                if(                *info->p==10                ) {
                    info->sline++;
                }
            ...
            else if(            !squort_42&&*info->p==34            ) {
                buffer_append_char(buf_41,*info->p);
                info->p++;
                dquort_43=!dquort_43;
            }
            else if(            !dquort_43&&*info->p==39            ) {
                buffer_append_char(buf_41,*info->p);
                info->p++;
                squort_42=!squort_42;
            }
            else if(            squort_42||dquort_43            ) {
                buffer_append_char(buf_41,*info->p);
                if(                *info->p==10                ) {
                    info->sline++;
                }
        ...
        if(        info->output_header_file        ) {
            header_45=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc_v2(1, sizeof(struct buffer)*(1), "24module.c", 204, "struct buffer*"))));
            buffer_append_str(header_45,((char*)(__right_value50=xsprintf("module \%s\n",((char*)(__right_value49=string_to_string(type_name_34)))))));
            ...
            buffer_append_str(header_45,"{\n");
            buffer_append(header_45,source_head_39,source_tail_40-source_head_39);
            buffer_append_str(header_45,"\n}\n");
            id_46=(char*)come_increment_ref_count(__builtin_string(type_name_34));
            add_come_code_at_come_header(info,id_46,"%s\n",((char*)(__right_value52=buffer_to_string(header_45))));
            (__right_value52 = come_decrement_ref_count(__right_value52, (void*)0, (void*)0, 1/* no_decrement*/, 0/* no_free*/, (void*)0));
            come_call_finalizer(buffer_finalize, header_45, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
            (id_46 = come_decrement_ref_count(id_46, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
        }
        module_47=(struct sClassModule*)come_increment_ref_count(sClassModule_initialize((struct sClassModule*)come_increment_ref_count((struct sClassModule*)come_calloc_v2(1, sizeof(struct sClassModule)*(1), "24module.c", 215, "struct sClassModule*")),(char*)come_increment_ref_count(type_name_34),(char*)come_increment_ref_count(buffer_to_string(buf_41)),(char*)come_increment_ref_count(sname_35),sline_36));
        __dec_obj18=module_47->mParams,
        module_47->mParams=(struct list$1char$ph*)come_increment_ref_count(list$1char$ph$p_clone(params_37));
        come_call_finalizer(list$1char$ph_finalize, __dec_obj18,(void*)0, (void*)0, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, (void*)0);
        map$2char$phsClassModule$ph_operator_store_element(info->modules,(char*)come_increment_ref_count(__builtin_string(type_name_34)),(struct sClassModule*)come_increment_ref_count(module_47));
        ...
        (type_name_34 = come_decrement_ref_count(type_name_34, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
        (sname_35 = come_decrement_ref_count(sname_35, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
        come_call_finalizer(list$1char$ph$p_finalize, params_37, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
        come_call_finalizer(buffer_finalize, buf_41, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
        come_call_finalizer(sClassModule_finalize, module_47, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
        ...
        (block_text_93 = come_decrement_ref_count(block_text_93, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
        (contents_95 = come_decrement_ref_count(contents_95, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
        (anonymous_name_97 = come_decrement_ref_count(anonymous_name_97, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
        ...
        block_text_99=(char*)come_increment_ref_count(skip_block(info,(_Bool)0));
        p_100=block_text_99+strlen(block_text_99);
        while(        p_100>=block_text_99&&*p_100!=125        ) {
            p_100--;
        }
        contents_101=(char*)come_increment_ref_count(charp_substring(block_text_99,1,p_100-(block_text_99+strlen(block_text_99))-1));
        add_come_code(info,"%s\n",contents_101);
        _inf_value4=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "24module.c", 254, "struct sNode");
        _inf_obj_value4=(struct sHeaderNode*)come_increment_ref_count(((struct sHeaderNode*)(__right_value87=sHeaderNode_initialize((struct sHeaderNode*)come_increment_ref_count((struct sHeaderNode*)come_calloc_v2(1, sizeof(struct sHeaderNode)*(1), "24module.c", 254, "struct sHeaderNode*")),(char*)come_increment_ref_count(contents_101),info))));
        ...
        (block_text_99 = come_decrement_ref_count(block_text_99, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
        (contents_101 = come_decrement_ref_count(contents_101, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
        ...
        no_output_come_code2_103=info->no_output_come_code2;
        info->no_output_come_code=(_Bool)1;
        info->no_output_come_code2=(_Bool)1;
        block_104=(_Bool)1;
        while(        *info->p        ) {
            parse_sharp_v5(info);
            if(            block_104&&*info->p==125            ) {
                info->p++;
                skip_spaces_and_lf(info);
                break;
            }
            head_105=info->p;
            head_sline_106=info->sline;
            buf_107=(char*)come_increment_ref_count(parse_word(info));
            parse_sharp_v5(info);
            node_108=(struct sNode*)come_increment_ref_count(top_level_v99(buf_107,head_105,head_sline_106,info));
            parse_sharp_v5(info);
            while(            *info->p==59            ) {
                info->p++;
                skip_spaces_and_lf(info);
            ...
            if(            block_104&&*info->p==125            ) {
                info->p++;
                skip_spaces_and_lf(info);
                (buf_107 = come_decrement_ref_count(buf_107, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
                ((node_108) ? node_108 = come_decrement_ref_count(node_108, ((struct sNode*)node_108)->finalize, ((struct sNode*)node_108)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,(void*)0):(void*)0);
                break;
            }
            (buf_107 = come_decrement_ref_count(buf_107, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
            ((node_108) ? node_108 = come_decrement_ref_count(node_108, ((struct sNode*)node_108)->finalize, ((struct sNode*)node_108)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,(void*)0):(void*)0);
        ...
        info->no_output_come_code2=no_output_come_code2_103;
        ...
        ((exp2_111) ? exp2_111 = come_decrement_ref_count(exp2_111, ((struct sNode*)exp2_111)->finalize, ((struct sNode*)exp2_111)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,(void*)0):(void*)0);
...
struct map$2char$phsClassModule$ph* __result_obj__44;
    ...
    while(    (_Bool)1    ) {
        if(        self->item_existance[it_66]        ) {
            if(            string_equals(self->keys[it_66],key)            ) {
                if(                1                ) {
                    list$1char$ph_remove(self->key_list,self->keys[it_66]);
                    (self->keys[it_66] = come_decrement_ref_count(self->keys[it_66], (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, (void*)0));
                    self->keys[it_66]=(char*)come_increment_ref_count(key);
                }
                else {
                    list$1char$ph_remove(self->key_list,self->keys[it_66]);
                    self->keys[it_66]=key;
                ...
                if(                1                ) {
                    come_call_finalizer(sClassModule_finalize, self->items[it_66], (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
                    self->items[it_66]=(struct sClassModule*)come_increment_ref_count(item);
                }
                else {
                    self->items[it_66]=item;
                }
                break;
            }
            it_66++;
            ...
            self->item_existance[it_66]=(_Bool)1;
            if(            1            ) {
                self->keys[it_66]=(char*)come_increment_ref_count(key);
            }
            else {
    ...
    for(    it2_86=list$1char$ph_begin(self->key_list)    ;    !list$1char$ph_end(self->key_list)    ;    it2_86=list$1char$ph_next(self->key_list)    ){
        if(        string_equals(it2_86,key)        ) {
            same_key_exist_83=(_Bool)1;
        }
    }
    if(    !same_key_exist_83    ) {
...
struct sClassModule** items_50;
void* __right_value60 = (void*)0;
_Bool* item_existance_51;
int len_52;
char* it_55;
struct sClassModule* default_value_58;
void* __right_value61 = (void*)0;
struct sClassModule* it2_59;
unsigned int hash_62;
int n_63;
struct sClassModule* default_value_64;
void* __right_value62 = (void*)0;
default_value_58 = (void*)0;
default_value_64 = (void*)0;
    size_48=self->size*10;
    keys_49=(char**)come_increment_ref_count(((char**)(__right_value58=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size_48)), "/usr/local/include/comelang.h", 2163, "char**"))));
    items_50=(struct sClassModule**)come_increment_ref_count(((struct sClassModule**)(__right_value59=(struct sClassModule**)come_calloc_v2(1, sizeof(struct sClassModule*)*(1*(size_48)), "/usr/local/include/comelang.h", 2164, "struct sClassModule**"))));
    item_existance_51=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value60=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(size_48)), "/usr/local/include/comelang.h", 2165, "_Bool*"))));
    len_52=0;
    for(    it_55=map$2char$phsClassModule$ph_begin(self)    ;    !map$2char$phsClassModule$ph_end(self)    ;    it_55=map$2char$phsClassModule$ph_next(self)    ){
        memset(&default_value_58,0,sizeof(struct sClassModule*));
        it2_59=((struct sClassModule*)(__right_value61=map$2char$phsClassModule$ph_at(self,it_55,(struct sClassModule*)come_increment_ref_count(default_value_58))));
        come_call_finalizer(sClassModule_finalize, __right_value61, (void*)0, (void*)0, 0/* alloca value */, 1/* no_decrement */, 0/* no_free */, (void*)0);
        hash_62=string_get_hash_key(((char*)it_55))%size_48;
        n_63=hash_62;
        while(        (_Bool)1        ) {
            if(            item_existance_51[n_63]            ) {
                n_63++;
                if(                n_63>=size_48                ) {
                    n_63=0;
                }
                else if(                n_63==hash_62                ) {
                ...
                item_existance_51[n_63]=(_Bool)1;
                keys_49[n_63]=it_55;
                items_50[n_63]=((struct sClassModule*)(__right_value62=map$2char$phsClassModule$ph_at(self,it_55,(struct sClassModule*)come_increment_ref_count(default_value_64))));
                come_call_finalizer(sClassModule_finalize, __right_value62, (void*)0, (void*)0, 0/* alloca value */, 1/* no_decrement */, 0/* no_free */, (void*)0);
                len_52++;
                come_call_finalizer(sClassModule_finalize, default_value_64, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
                break;
                come_call_finalizer(sClassModule_finalize, default_value_64, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
            }
        }
        come_call_finalizer(sClassModule_finalize, default_value_58, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
    }
    ...
    self->keys=keys_49;
    self->items=items_50;
    self->item_existance=item_existance_51;
    self->size=size_48;
    self->len=len_52;
}
    ...
    while(    (_Bool)1    ) {
        if(        self->item_existance[it_61]        ) {
            if(            string_equals(self->keys[it_61],key)            ) {
                __result_obj__29 = (struct sClassModule*)come_increment_ref_count(self->items[it_61]);
...
struct list$1char$ph* __result_obj__36;
    ...
    it_68=self->head;
    while(    it_68!=((void*)0)    ) {
        if(        string_equals(it_68->item,item)        ) {
            list$1char$ph_delete(self,it2_67,it2_67+1);
            break;
        }
        it2_67++;
        it_68=it_68->next;
...
struct list_item$1char$ph* head_prev_it_79;
struct list_item$1char$ph* tail_it_80;
int i_81;
...
struct list$1char$ph* __result_obj__43;
    if(    self->len==0    ) {
        litem_89=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value63=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1097, "struct list_item$1char$ph*"))));
        ...
        litem_90=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value64=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1107, "struct list_item$1char$ph*"))));
        litem_90->prev=self->head;
        litem_90->next=((void*)0);
        __dec_obj20=litem_90->item,
        ...
        litem_91=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value65=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 1117, "struct list_item$1char$ph*"))));
        litem_91->prev=self->tail;
        litem_91->next=((void*)0);
        __dec_obj21=litem_91->item,
...
struct sModuleNode* __result_obj__46;
    ...
    result_92=(struct sModuleNode*)come_increment_ref_count((struct sModuleNode*)come_calloc_v2(1, sizeof(struct sModuleNode)*(1), "sModuleNode_clone", 3, "struct sModuleNode*"));
    if(    self!=((void*)0)    ) {
        result_92->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)    ) {
        __dec_obj22=result_92->sname,
        result_92->sname=(char*)come_increment_ref_count((char*)come_memdup(self->sname, "sModuleNode_clone", 5, "char*"));
    ...
    if(    self!=((void*)0)&&self->name!=((void*)0)    ) {
        __dec_obj23=result_92->name,
        result_92->name=(char*)come_increment_ref_count((char*)come_memdup(self->name, "sModuleNode_clone", 7, "char*"));
        __dec_obj23 = come_decrement_ref_count(__dec_obj23, (void*)0, (void*)0, 0/* no_decrement */,0/* no_free */, (void*)0);
    }
    if(    self!=((void*)0)&&self->module!=((void*)0)    ) {
        __dec_obj24=result_92->module,
        result_92->module=(struct sClassModule*)come_increment_ref_count(sClassModule_clone(self->module));
        come_call_finalizer(sClassModule_finalize, __dec_obj24,(void*)0, (void*)0, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, (void*)0);
    }
    __result_obj__46 = result_92;
    come_call_finalizer(sModuleNode_finalize, result_92, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
...
struct sHeaderNode* __result_obj__49;
    ...
    result_98=(struct sHeaderNode*)come_increment_ref_count((struct sHeaderNode*)come_calloc_v2(1, sizeof(struct sHeaderNode)*(1), "sHeaderNode_clone", 3, "struct sHeaderNode*"));
    if(    self!=((void*)0)    ) {
        result_98->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)    ) {
        __dec_obj25=result_98->sname,
        result_98->sname=(char*)come_increment_ref_count((char*)come_memdup(self->sname, "sHeaderNode_clone", 5, "char*"));
        __dec_obj25 = come_decrement_ref_count(__dec_obj25, (void*)0, (void*)0, 0/* no_decrement */,0/* no_free */, (void*)0);
    }
    if(    self!=((void*)0)    ) {
        result_98->sline_real=self->sline_real;
    }
    if(    self!=((void*)0)&&self->contents!=((void*)0)    ) {
        __dec_obj26=result_98->contents,
        result_98->contents=(char*)come_increment_ref_count((char*)come_memdup(self->contents, "sHeaderNode_clone", 7, "char*"));
        __dec_obj26 = come_decrement_ref_count(__dec_obj26, (void*)0, (void*)0, 0/* no_decrement */,0/* no_free */, (void*)0);
    }
    __result_obj__49 = result_98;
    come_call_finalizer(sHeaderNode_finalize, result_98, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
