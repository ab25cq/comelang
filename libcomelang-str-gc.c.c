...
struct real_pcre8_or_16* pcre_compile(const char* anonymous_var_nameX526, int anonymous_var_nameX527, const char** anonymous_var_nameX528, int* anonymous_var_nameX529, const unsigned char* anonymous_var_nameX530);
struct real_pcre8_or_16* pcre16_compile(const unsigned short int* anonymous_var_nameX531, int anonymous_var_nameX532, const char** anonymous_var_nameX533, int* anonymous_var_nameX534, const unsigned char* anonymous_var_nameX535);
struct real_pcre32* pcre32_compile(const unsigned int* anonymous_var_nameX536, int anonymous_var_nameX537, const char** anonymous_var_nameX538, int* anonymous_var_nameX539, const unsigned char* anonymous_var_nameX540);
struct real_pcre8_or_16* pcre_compile2(const char* anonymous_var_nameX541, int anonymous_var_nameX542, int* anonymous_var_nameX543, const char** anonymous_var_nameX544, int* anonymous_var_nameX545, const unsigned char* anonymous_var_nameX546);
struct real_pcre8_or_16* pcre16_compile2(const unsigned short int* anonymous_var_nameX547, int anonymous_var_nameX548, int* anonymous_var_nameX549, const char** anonymous_var_nameX550, int* anonymous_var_nameX551, const unsigned char* anonymous_var_nameX552);
struct real_pcre32* pcre32_compile2(const unsigned int* anonymous_var_nameX553, int anonymous_var_nameX554, int* anonymous_var_nameX555, const char** anonymous_var_nameX556, int* anonymous_var_nameX557, const unsigned char* anonymous_var_nameX558);
int pcre_config(int anonymous_var_nameX559, void* anonymous_var_nameX560);
int pcre16_config(int anonymous_var_nameX561, void* anonymous_var_nameX562);
int pcre32_config(int anonymous_var_nameX563, void* anonymous_var_nameX564);
int pcre_copy_named_substring(const struct real_pcre8_or_16* anonymous_var_nameX565, const char* anonymous_var_nameX566, int* anonymous_var_nameX567, int anonymous_var_nameX568, const char* anonymous_var_nameX569, char* anonymous_var_nameX570, int anonymous_var_nameX571);
int pcre16_copy_named_substring(const struct real_pcre8_or_16* anonymous_var_nameX572, const unsigned short int* anonymous_var_nameX573, int* anonymous_var_nameX574, int anonymous_var_nameX575, const unsigned short int* anonymous_var_nameX576, unsigned short int* anonymous_var_nameX577, int anonymous_var_nameX578);
int pcre32_copy_named_substring(const struct real_pcre32* anonymous_var_nameX579, const unsigned int* anonymous_var_nameX580, int* anonymous_var_nameX581, int anonymous_var_nameX582, const unsigned int* anonymous_var_nameX583, unsigned int* anonymous_var_nameX584, int anonymous_var_nameX585);
int pcre_copy_substring(const char* anonymous_var_nameX586, int* anonymous_var_nameX587, int anonymous_var_nameX588, int anonymous_var_nameX589, char* anonymous_var_nameX590, int anonymous_var_nameX591);
int pcre16_copy_substring(const unsigned short int* anonymous_var_nameX592, int* anonymous_var_nameX593, int anonymous_var_nameX594, int anonymous_var_nameX595, unsigned short int* anonymous_var_nameX596, int anonymous_var_nameX597);
int pcre32_copy_substring(const unsigned int* anonymous_var_nameX598, int* anonymous_var_nameX599, int anonymous_var_nameX600, int anonymous_var_nameX601, unsigned int* anonymous_var_nameX602, int anonymous_var_nameX603);
int pcre_dfa_exec(const struct real_pcre8_or_16* anonymous_var_nameX604, const struct pcre_extra* anonymous_var_nameX605, const char* anonymous_var_nameX606, int anonymous_var_nameX607, int anonymous_var_nameX608, int anonymous_var_nameX609, int* anonymous_var_nameX610, int anonymous_var_nameX611, int* anonymous_var_nameX612, int anonymous_var_nameX613);
int pcre16_dfa_exec(const struct real_pcre8_or_16* anonymous_var_nameX614, const struct pcre16_extra* anonymous_var_nameX615, const unsigned short int* anonymous_var_nameX616, int anonymous_var_nameX617, int anonymous_var_nameX618, int anonymous_var_nameX619, int* anonymous_var_nameX620, int anonymous_var_nameX621, int* anonymous_var_nameX622, int anonymous_var_nameX623);
int pcre32_dfa_exec(const struct real_pcre32* anonymous_var_nameX624, const struct pcre32_extra* anonymous_var_nameX625, const unsigned int* anonymous_var_nameX626, int anonymous_var_nameX627, int anonymous_var_nameX628, int anonymous_var_nameX629, int* anonymous_var_nameX630, int anonymous_var_nameX631, int* anonymous_var_nameX632, int anonymous_var_nameX633);
int pcre_exec(const struct real_pcre8_or_16* anonymous_var_nameX634, const struct pcre_extra* anonymous_var_nameX635, const char* anonymous_var_nameX636, int anonymous_var_nameX637, int anonymous_var_nameX638, int anonymous_var_nameX639, int* anonymous_var_nameX640, int anonymous_var_nameX641);
int pcre16_exec(const struct real_pcre8_or_16* anonymous_var_nameX642, const struct pcre16_extra* anonymous_var_nameX643, const unsigned short int* anonymous_var_nameX644, int anonymous_var_nameX645, int anonymous_var_nameX646, int anonymous_var_nameX647, int* anonymous_var_nameX648, int anonymous_var_nameX649);
int pcre32_exec(const struct real_pcre32* anonymous_var_nameX650, const struct pcre32_extra* anonymous_var_nameX651, const unsigned int* anonymous_var_nameX652, int anonymous_var_nameX653, int anonymous_var_nameX654, int anonymous_var_nameX655, int* anonymous_var_nameX656, int anonymous_var_nameX657);
int pcre_jit_exec(const struct real_pcre8_or_16* anonymous_var_nameX658, const struct pcre_extra* anonymous_var_nameX659, const char* anonymous_var_nameX660, int anonymous_var_nameX661, int anonymous_var_nameX662, int anonymous_var_nameX663, int* anonymous_var_nameX664, int anonymous_var_nameX665, struct real_pcre_jit_stack* anonymous_var_nameX666);
int pcre16_jit_exec(const struct real_pcre8_or_16* anonymous_var_nameX667, const struct pcre16_extra* anonymous_var_nameX668, const unsigned short int* anonymous_var_nameX669, int anonymous_var_nameX670, int anonymous_var_nameX671, int anonymous_var_nameX672, int* anonymous_var_nameX673, int anonymous_var_nameX674, struct real_pcre16_jit_stack* anonymous_var_nameX675);
int pcre32_jit_exec(const struct real_pcre32* anonymous_var_nameX676, const struct pcre32_extra* anonymous_var_nameX677, const unsigned int* anonymous_var_nameX678, int anonymous_var_nameX679, int anonymous_var_nameX680, int anonymous_var_nameX681, int* anonymous_var_nameX682, int anonymous_var_nameX683, struct real_pcre32_jit_stack* anonymous_var_nameX684);
void pcre_free_substring(const char* anonymous_var_nameX685);
void pcre16_free_substring(const unsigned short int* anonymous_var_nameX686);
void pcre32_free_substring(const unsigned int* anonymous_var_nameX687);
void pcre_free_substring_list(const char** anonymous_var_nameX688);
void pcre16_free_substring_list(const unsigned short int** anonymous_var_nameX689);
void pcre32_free_substring_list(const unsigned int** anonymous_var_nameX690);
int pcre_fullinfo(const struct real_pcre8_or_16* anonymous_var_nameX691, const struct pcre_extra* anonymous_var_nameX692, int anonymous_var_nameX693, void* anonymous_var_nameX694);
int pcre16_fullinfo(const struct real_pcre8_or_16* anonymous_var_nameX695, const struct pcre16_extra* anonymous_var_nameX696, int anonymous_var_nameX697, void* anonymous_var_nameX698);
int pcre32_fullinfo(const struct real_pcre32* anonymous_var_nameX699, const struct pcre32_extra* anonymous_var_nameX700, int anonymous_var_nameX701, void* anonymous_var_nameX702);
int pcre_get_named_substring(const struct real_pcre8_or_16* anonymous_var_nameX703, const char* anonymous_var_nameX704, int* anonymous_var_nameX705, int anonymous_var_nameX706, const char* anonymous_var_nameX707, const char** anonymous_var_nameX708);
int pcre16_get_named_substring(const struct real_pcre8_or_16* anonymous_var_nameX709, const unsigned short int* anonymous_var_nameX710, int* anonymous_var_nameX711, int anonymous_var_nameX712, const unsigned short int* anonymous_var_nameX713, const unsigned short int** anonymous_var_nameX714);
int pcre32_get_named_substring(const struct real_pcre32* anonymous_var_nameX715, const unsigned int* anonymous_var_nameX716, int* anonymous_var_nameX717, int anonymous_var_nameX718, const unsigned int* anonymous_var_nameX719, const unsigned int** anonymous_var_nameX720);
int pcre_get_stringnumber(const struct real_pcre8_or_16* anonymous_var_nameX721, const char* anonymous_var_nameX722);
int pcre16_get_stringnumber(const struct real_pcre8_or_16* anonymous_var_nameX723, const unsigned short int* anonymous_var_nameX724);
int pcre32_get_stringnumber(const struct real_pcre32* anonymous_var_nameX725, const unsigned int* anonymous_var_nameX726);
int pcre_get_stringtable_entries(const struct real_pcre8_or_16* anonymous_var_nameX727, const char* anonymous_var_nameX728, char** anonymous_var_nameX729, char** anonymous_var_nameX730);
int pcre16_get_stringtable_entries(const struct real_pcre8_or_16* anonymous_var_nameX731, const unsigned short int* anonymous_var_nameX732, unsigned short int** anonymous_var_nameX733, unsigned short int** anonymous_var_nameX734);
int pcre32_get_stringtable_entries(const struct real_pcre32* anonymous_var_nameX735, const unsigned int* anonymous_var_nameX736, unsigned int** anonymous_var_nameX737, unsigned int** anonymous_var_nameX738);
int pcre_get_substring(const char* anonymous_var_nameX739, int* anonymous_var_nameX740, int anonymous_var_nameX741, int anonymous_var_nameX742, const char** anonymous_var_nameX743);
int pcre16_get_substring(const unsigned short int* anonymous_var_nameX744, int* anonymous_var_nameX745, int anonymous_var_nameX746, int anonymous_var_nameX747, const unsigned short int** anonymous_var_nameX748);
int pcre32_get_substring(const unsigned int* anonymous_var_nameX749, int* anonymous_var_nameX750, int anonymous_var_nameX751, int anonymous_var_nameX752, const unsigned int** anonymous_var_nameX753);
int pcre_get_substring_list(const char* anonymous_var_nameX754, int* anonymous_var_nameX755, int anonymous_var_nameX756, const char*** anonymous_var_nameX757);
int pcre16_get_substring_list(const unsigned short int* anonymous_var_nameX758, int* anonymous_var_nameX759, int anonymous_var_nameX760, const unsigned short int*** anonymous_var_nameX761);
int pcre32_get_substring_list(const unsigned int* anonymous_var_nameX762, int* anonymous_var_nameX763, int anonymous_var_nameX764, const unsigned int*** anonymous_var_nameX765);
const unsigned char* pcre_maketables();
const unsigned char* pcre16_maketables();
const unsigned char* pcre32_maketables();
int pcre_refcount(struct real_pcre8_or_16* anonymous_var_nameX766, int anonymous_var_nameX767);
int pcre16_refcount(struct real_pcre8_or_16* anonymous_var_nameX768, int anonymous_var_nameX769);
int pcre32_refcount(struct real_pcre32* anonymous_var_nameX770, int anonymous_var_nameX771);
struct pcre_extra* pcre_study(const struct real_pcre8_or_16* anonymous_var_nameX772, int anonymous_var_nameX773, const char** anonymous_var_nameX774);
struct pcre16_extra* pcre16_study(const struct real_pcre8_or_16* anonymous_var_nameX775, int anonymous_var_nameX776, const char** anonymous_var_nameX777);
struct pcre32_extra* pcre32_study(const struct real_pcre32* anonymous_var_nameX778, int anonymous_var_nameX779, const char** anonymous_var_nameX780);
void pcre_free_study(struct pcre_extra* anonymous_var_nameX781);
void pcre16_free_study(struct pcre16_extra* anonymous_var_nameX782);
void pcre32_free_study(struct pcre32_extra* anonymous_var_nameX783);
const char* pcre_version();
const char* pcre16_version();
const char* pcre32_version();
int pcre_pattern_to_host_byte_order(struct real_pcre8_or_16* anonymous_var_nameX784, struct pcre_extra* anonymous_var_nameX785, const unsigned char* anonymous_var_nameX786);
int pcre16_pattern_to_host_byte_order(struct real_pcre8_or_16* anonymous_var_nameX787, struct pcre16_extra* anonymous_var_nameX788, const unsigned char* anonymous_var_nameX789);
int pcre32_pattern_to_host_byte_order(struct real_pcre32* anonymous_var_nameX790, struct pcre32_extra* anonymous_var_nameX791, const unsigned char* anonymous_var_nameX792);
int pcre16_utf16_to_host_byte_order(unsigned short int* anonymous_var_nameX793, const unsigned short int* anonymous_var_nameX794, int anonymous_var_nameX795, int* anonymous_var_nameX796, int anonymous_var_nameX797);
int pcre32_utf32_to_host_byte_order(unsigned int* anonymous_var_nameX798, const unsigned int* anonymous_var_nameX799, int anonymous_var_nameX800, int* anonymous_var_nameX801, int anonymous_var_nameX802);
struct real_pcre_jit_stack* pcre_jit_stack_alloc(int anonymous_var_nameX803, int anonymous_var_nameX804);
struct real_pcre16_jit_stack* pcre16_jit_stack_alloc(int anonymous_var_nameX805, int anonymous_var_nameX806);
struct real_pcre32_jit_stack* pcre32_jit_stack_alloc(int anonymous_var_nameX807, int anonymous_var_nameX808);
void pcre_jit_stack_free(struct real_pcre_jit_stack* anonymous_var_nameX809);
void pcre16_jit_stack_free(struct real_pcre16_jit_stack* anonymous_var_nameX810);
void pcre32_jit_stack_free(struct real_pcre32_jit_stack* anonymous_var_nameX811);
void pcre_assign_jit_stack(struct pcre_extra* anonymous_var_nameX812, struct real_pcre_jit_stack* (*anonymous_var_nameX813)(void*), void* anonymous_var_nameX814);
void pcre16_assign_jit_stack(struct pcre16_extra* anonymous_var_nameX815, struct real_pcre16_jit_stack* (*anonymous_var_nameX816)(void*), void* anonymous_var_nameX817);
void pcre32_assign_jit_stack(struct pcre32_extra* anonymous_var_nameX818, struct real_pcre32_jit_stack* (*anonymous_var_nameX819)(void*), void* anonymous_var_nameX820);
void pcre_jit_free_unused_memory();
void pcre16_jit_free_unused_memory();
void pcre32_jit_free_unused_memory();
char* asctime(const struct tm* anonymous_var_nameX821);
unsigned long unsigned  int clock();
char* ctime(const long* anonymous_var_nameX822);
double difftime(long anonymous_var_nameX823, long anonymous_var_nameX824);
struct tm* getdate(const char* anonymous_var_nameX825);
struct tm* gmtime(const long* anonymous_var_nameX826);
struct tm* localtime(const long* anonymous_var_nameX827);
long mktime(struct tm* anonymous_var_nameX828);
unsigned long unsigned  int strftime(char* anonymous_var_nameX829, unsigned long unsigned  int anonymous_var_nameX830, const char* anonymous_var_nameX831, const struct tm* anonymous_var_nameX832);
char* strptime(const char* anonymous_var_nameX833, const char* anonymous_var_nameX834, struct tm* anonymous_var_nameX835);
long time(long* anonymous_var_nameX836);
void tzset();
char* asctime_r(const struct tm* anonymous_var_nameX837, char* anonymous_var_nameX838);
char* ctime_r(const long* anonymous_var_nameX839, char* anonymous_var_nameX840);
struct tm* gmtime_r(const long* anonymous_var_nameX841, struct tm* anonymous_var_nameX842);
struct tm* localtime_r(const long* anonymous_var_nameX843, struct tm* anonymous_var_nameX844);
long posix2time(long anonymous_var_nameX845);
void tzsetwall();
long time2posix(long anonymous_var_nameX846);
long timelocal(struct tm* anonymous_var_nameX847);
long timegm(struct tm* anonymous_var_nameX848);
...
int isalnum(int anonymous_var_nameX863);
int isalpha(int anonymous_var_nameX864);
int isblank(int anonymous_var_nameX865);
int iscntrl(int anonymous_var_nameX866);
int isdigit(int anonymous_var_nameX867);
int isgraph(int anonymous_var_nameX868);
int islower(int anonymous_var_nameX869);
int isprint(int anonymous_var_nameX870);
int ispunct(int anonymous_var_nameX871);
int isspace(int anonymous_var_nameX872);
int isupper(int anonymous_var_nameX873);
int isxdigit(int anonymous_var_nameX874);
int tolower(int anonymous_var_nameX875);
int toupper(int anonymous_var_nameX876);
int isascii(int anonymous_var_nameX877);
int toascii(int anonymous_var_nameX878);
int _tolower(int anonymous_var_nameX879);
int _toupper(int anonymous_var_nameX880);
int digittoint(int anonymous_var_nameX881);
int ishexnumber(int anonymous_var_nameX882);
int isideogram(int anonymous_var_nameX883);
int isnumber(int anonymous_var_nameX884);
int isphonogram(int anonymous_var_nameX885);
int isrune(int anonymous_var_nameX886);
int isspecial(int anonymous_var_nameX887);
int iswalnum(int anonymous_var_nameX888);
int iswalpha(int anonymous_var_nameX889);
int iswcntrl(int anonymous_var_nameX890);
int iswctype(int anonymous_var_nameX891, unsigned int anonymous_var_nameX892);
int iswdigit(int anonymous_var_nameX893);
int iswgraph(int anonymous_var_nameX894);
int iswlower(int anonymous_var_nameX895);
int iswprint(int anonymous_var_nameX896);
int iswpunct(int anonymous_var_nameX897);
int iswspace(int anonymous_var_nameX898);
int iswupper(int anonymous_var_nameX899);
int iswxdigit(int anonymous_var_nameX900);
int towlower(int anonymous_var_nameX901);
int towupper(int anonymous_var_nameX902);
unsigned int wctype(const char* anonymous_var_nameX903);
int btowc(int anonymous_var_nameX904);
int fgetwc(struct __sFILE* anonymous_var_nameX905);
int* fgetws(int* anonymous_var_nameX906, int anonymous_var_nameX907, struct __sFILE* anonymous_var_nameX908);
int fputwc(int anonymous_var_nameX909, struct __sFILE* anonymous_var_nameX910);
int fputws(const int* anonymous_var_nameX911, struct __sFILE* anonymous_var_nameX912);
int fwide(struct __sFILE* anonymous_var_nameX913, int anonymous_var_nameX914);
int fwprintf(struct __sFILE* anonymous_var_nameX915, const int* anonymous_var_nameX916, ...);
int fwscanf(struct __sFILE* anonymous_var_nameX917, const int* anonymous_var_nameX918, ...);
int getwc(struct __sFILE* anonymous_var_nameX919);
int getwchar();
unsigned long unsigned  int mbrlen(const char* anonymous_var_nameX920, unsigned long unsigned  int anonymous_var_nameX921, union anonymous_typeZ1* anonymous_var_nameX922);
unsigned long unsigned  int mbrtowc(int* anonymous_var_nameX923, const char* anonymous_var_nameX924, unsigned long unsigned  int anonymous_var_nameX925, union anonymous_typeZ1* anonymous_var_nameX926);
int mbsinit(const union anonymous_typeZ1* anonymous_var_nameX927);
unsigned long unsigned  int mbsrtowcs(int* anonymous_var_nameX928, const char** anonymous_var_nameX929, unsigned long unsigned  int anonymous_var_nameX930, union anonymous_typeZ1* anonymous_var_nameX931);
int putwc(int anonymous_var_nameX932, struct __sFILE* anonymous_var_nameX933);
int putwchar(int anonymous_var_nameX934);
int swprintf(int* anonymous_var_nameX935, unsigned long unsigned  int anonymous_var_nameX936, const int* anonymous_var_nameX937, ...);
int swscanf(const int* anonymous_var_nameX938, const int* anonymous_var_nameX939, ...);
int ungetwc(int anonymous_var_nameX940, struct __sFILE* anonymous_var_nameX941);
int vfwprintf(struct __sFILE* anonymous_var_nameX942, const int* anonymous_var_nameX943, __darwin_va_list anonymous_var_nameX944);
int vswprintf(int* anonymous_var_nameX945, unsigned long unsigned  int anonymous_var_nameX946, const int* anonymous_var_nameX947, __darwin_va_list anonymous_var_nameX948);
int vwprintf(const int* anonymous_var_nameX949, __darwin_va_list anonymous_var_nameX950);
unsigned long unsigned  int wcrtomb(char* anonymous_var_nameX951, int anonymous_var_nameX952, union anonymous_typeZ1* anonymous_var_nameX953);
int* wcscat(int* anonymous_var_nameX954, const int* anonymous_var_nameX955);
int* wcschr(const int* anonymous_var_nameX956, int anonymous_var_nameX957);
int wcscmp(const int* anonymous_var_nameX958, const int* anonymous_var_nameX959);
int wcscoll(const int* anonymous_var_nameX960, const int* anonymous_var_nameX961);
int* wcscpy(int* anonymous_var_nameX962, const int* anonymous_var_nameX963);
unsigned long unsigned  int wcscspn(const int* anonymous_var_nameX964, const int* anonymous_var_nameX965);
unsigned long unsigned  int wcsftime(int* anonymous_var_nameX966, unsigned long unsigned  int anonymous_var_nameX967, const int* anonymous_var_nameX968, const struct tm* anonymous_var_nameX969);
unsigned long unsigned  int wcslen(const int* anonymous_var_nameX970);
int* wcsncat(int* anonymous_var_nameX971, const int* anonymous_var_nameX972, unsigned long unsigned  int anonymous_var_nameX973);
int wcsncmp(const int* anonymous_var_nameX974, const int* anonymous_var_nameX975, unsigned long unsigned  int anonymous_var_nameX976);
int* wcsncpy(int* anonymous_var_nameX977, const int* anonymous_var_nameX978, unsigned long unsigned  int anonymous_var_nameX979);
int* wcspbrk(const int* anonymous_var_nameX980, const int* anonymous_var_nameX981);
int* wcsrchr(const int* anonymous_var_nameX982, int anonymous_var_nameX983);
unsigned long unsigned  int wcsrtombs(char* anonymous_var_nameX984, const int** anonymous_var_nameX985, unsigned long unsigned  int anonymous_var_nameX986, union anonymous_typeZ1* anonymous_var_nameX987);
unsigned long unsigned  int wcsspn(const int* anonymous_var_nameX988, const int* anonymous_var_nameX989);
int* wcsstr(const int* anonymous_var_nameX990, const int* anonymous_var_nameX991);
unsigned long unsigned  int wcsxfrm(int* anonymous_var_nameX992, const int* anonymous_var_nameX993, unsigned long unsigned  int anonymous_var_nameX994);
int wctob(int anonymous_var_nameX995);
double wcstod(const int* anonymous_var_nameX996, int** anonymous_var_nameX997);
int* wcstok(int* anonymous_var_nameX998, const int* anonymous_var_nameX999, int** anonymous_var_nameX1000);
long wcstol(const int* anonymous_var_nameX1001, int** anonymous_var_nameX1002, int anonymous_var_nameX1003);
unsigned long unsigned  int wcstoul(const int* anonymous_var_nameX1004, int** anonymous_var_nameX1005, int anonymous_var_nameX1006);
int* wmemchr(const int* anonymous_var_nameX1007, int anonymous_var_nameX1008, unsigned long unsigned  int anonymous_var_nameX1009);
int wmemcmp(const int* anonymous_var_nameX1010, const int* anonymous_var_nameX1011, unsigned long unsigned  int anonymous_var_nameX1012);
int* wmemcpy(int* anonymous_var_nameX1013, const int* anonymous_var_nameX1014, unsigned long unsigned  int anonymous_var_nameX1015);
int* wmemmove(int* anonymous_var_nameX1016, const int* anonymous_var_nameX1017, unsigned long unsigned  int anonymous_var_nameX1018);
int* wmemset(int* anonymous_var_nameX1019, int anonymous_var_nameX1020, unsigned long unsigned  int anonymous_var_nameX1021);
int wprintf(const int* anonymous_var_nameX1022, ...);
int wscanf(const int* anonymous_var_nameX1023, ...);
int wcswidth(const int* anonymous_var_nameX1024, unsigned long unsigned  int anonymous_var_nameX1025);
int wcwidth(int anonymous_var_nameX1026);
int vfwscanf(struct __sFILE* anonymous_var_nameX1027, const int* anonymous_var_nameX1028, __darwin_va_list anonymous_var_nameX1029);
int vswscanf(const int* anonymous_var_nameX1030, const int* anonymous_var_nameX1031, __darwin_va_list anonymous_var_nameX1032);
int vwscanf(const int* anonymous_var_nameX1033, __darwin_va_list anonymous_var_nameX1034);
float wcstof(const int* anonymous_var_nameX1035, int** anonymous_var_nameX1036);
long  double wcstold(const int* anonymous_var_nameX1037, int** anonymous_var_nameX1038);
long long wcstoll(const int* anonymous_var_nameX1039, int** anonymous_var_nameX1040, int anonymous_var_nameX1041);
unsigned long unsigned  long wcstoull(const int* anonymous_var_nameX1042, int** anonymous_var_nameX1043, int anonymous_var_nameX1044);
unsigned long unsigned  int mbsnrtowcs(int* anonymous_var_nameX1045, const char** anonymous_var_nameX1046, unsigned long unsigned  int anonymous_var_nameX1047, unsigned long unsigned  int anonymous_var_nameX1048, union anonymous_typeZ1* anonymous_var_nameX1049);
int* wcpcpy(int* anonymous_var_nameX1050, const int* anonymous_var_nameX1051);
int* wcpncpy(int* anonymous_var_nameX1052, const int* anonymous_var_nameX1053, unsigned long unsigned  int anonymous_var_nameX1054);
int* wcsdup(const int* anonymous_var_nameX1055);
int wcscasecmp(const int* anonymous_var_nameX1056, const int* anonymous_var_nameX1057);
int wcsncasecmp(const int* anonymous_var_nameX1058, const int* anonymous_var_nameX1059, unsigned long unsigned  int n);
unsigned long unsigned  int wcsnlen(const int* anonymous_var_nameX1060, unsigned long unsigned  int anonymous_var_nameX1061);
unsigned long unsigned  int wcsnrtombs(char* anonymous_var_nameX1062, const int** anonymous_var_nameX1063, unsigned long unsigned  int anonymous_var_nameX1064, unsigned long unsigned  int anonymous_var_nameX1065, union anonymous_typeZ1* anonymous_var_nameX1066);
struct __sFILE* open_wmemstream(int** __bufp, unsigned long unsigned  int* __sizep);
int* fgetwln(struct __sFILE* anonymous_var_nameX1067, unsigned long unsigned  int* anonymous_var_nameX1068);
unsigned long unsigned  int wcslcat(int* anonymous_var_nameX1069, const int* anonymous_var_nameX1070, unsigned long unsigned  int anonymous_var_nameX1071);
unsigned long unsigned  int wcslcpy(int* anonymous_var_nameX1072, const int* anonymous_var_nameX1073, unsigned long unsigned  int anonymous_var_nameX1074);
char* basename(char* anonymous_var_nameX1075);
char* dirname(char* anonymous_var_nameX1076);
char* basename_r(const char* anonymous_var_nameX1077, char* anonymous_var_nameX1078);
char* dirname_r(const char* anonymous_var_nameX1079, char* anonymous_var_nameX1080);
...
struct come_regex* __result93__;
    __result93__ = gComeFunResultObject = __result_obj__ = ((struct come_regex*)(__right_value146=come_regex_initialize((struct come_regex*)come_increment_ref_count((struct come_regex*)come_calloc(1, sizeof(struct come_regex)*(1), "libcomelang-str-gc.c", 46, "come_regex")),self,ignore_case,multiline,global,extended,dotall,anchored,dollar_endonly,ungreedy)));
...
struct come_regex* __result94__;
    __result94__ = gComeFunResultObject = __result_obj__ = ((struct come_regex*)(__right_value148=come_regex_initialize((struct come_regex*)come_increment_ref_count((struct come_regex*)come_calloc(1, sizeof(struct come_regex)*(1), "libcomelang-str-gc.c", 51, "come_regex")),self,ignore_case,multiline,global,extended,dotall,anchored,dollar_endonly,ungreedy)));
...
memset(&erro_ofs_71, 0, sizeof(int));
    ...
    result_69=(struct come_regex*)come_increment_ref_count((struct come_regex*)come_calloc(1, sizeof(struct come_regex)*(1), "libcomelang-str-gc.c", 61, "come_regex"));
...
int* __result104__;
    ...
    result_77=(int*)come_increment_ref_count((int*)come_calloc(1, sizeof(int)*(1*(tail-head+1)), "libcomelang-str-gc.c", 156, "int"));
...
int* __result106__;
    ...
    len_78=strlen(str);
    wstr_79=(int*)come_increment_ref_count((int*)come_calloc(1, sizeof(int)*(1*(len_78+1)), "libcomelang-str-gc.c", 171, "int"));
...
memset(&erro_ofs_132, 0, sizeof(int));
    result_125=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 357, "list$1charph"))));
    offset_126=0;
    ovec_max_127=16;
    ...
    while((_Bool)1) {
        ...
        if(regex_result_138==1) {
            ...
            group_strings_142=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 391, "list$1charph"))));
            ...
            if(regex_result_138>1) {
                ...
                group_strings_148=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 408, "list$1charph"))));
...
struct list$1charph* __result109__;
    if(self->len==0) {
        litem_144=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value167=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 221, "list_item$1charph"))));
        ...
        if(self->len==1) {
            litem_145=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value168=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 231, "list_item$1charph"))));
            ...
            litem_146=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value169=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 241, "list_item$1charph"))));
...
memset(&erro_ofs_159, 0, sizeof(int));
    result_152=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 438, "list$1charph"))));
    offset_153=0;
    ovec_max_154=16;
    ...
    while((_Bool)1) {
        ...
        if(regex_result_166==1) {
            ...
            group_strings_170=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 474, "list$1charph"))));
            ...
            if(regex_result_166>1) {
                ...
                group_strings_173=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 496, "list$1charph"))));
...
memset(&erro_ofs_178, 0, sizeof(int));
    ...
    str_180=reg->str;
    re_181=reg->re;
    result_182=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 538, "list$1charph"))));
    offset_183=0;
    ovec_max_184=16;
    ...
    while((_Bool)1) {
        ...
        if(regex_result_190==1) {
            ...
            match_strings_194=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 565, "list$1charph"))));
            ...
            if(regex_result_190>1) {
                ...
                match_strings_197=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 588, "list$1charph"))));
    ...
    if(offset_183<charp_length(self)) {
        ...
        match_strings_202=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 607, "list$1charph"))));
...
memset(&erro_ofs_205, 0, sizeof(int));
    ...
    str_207=reg->str;
    re_208=reg->re;
    result_209=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 625, "list$1charph"))));
    offset_210=0;
    ovec_max_211=16;
    ...
    while((_Bool)1) {
        ...
        if(regex_result_218==1) {
            ...
            match_strings_222=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 654, "list$1charph"))));
            ...
            if(regex_result_218>1) {
                ...
                match_strings_225=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 677, "list$1charph"))));
...
memset(&erro_ofs_236, 0, sizeof(int));
    result_229=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 741, "list$1charph"))));
    offset_230=0;
    ovec_max_231=16;
...
char* __result115__;
    ...
    if(self[len_250-1]==10) {
        ...
        if(self[len_250-1]==13) {
            result_249[len_250-1]=0;
        }
        else {
            if(len_250>2&&self[len_250-2]==13&&self[len_250-1]==10) {
...
char* __result116__;
    ...
    result_252=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_251*2+1)), "libcomelang-str-gc.c", 835, "char"));
    n_253=0;
...
char* __result117__;
    ...
    result_257=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_256)), "libcomelang-str-gc.c", 861, "char"));
...
int* __result122__;
    len_266=wcslen(str);
    result_267=(int*)come_increment_ref_count((int*)come_calloc(1, sizeof(int)*(1*(len_266+1)), "libcomelang-str-gc.c", 961, "int"));
...
int* __result123__;
    ...
    result_270=(int*)come_increment_ref_count((int*)come_calloc(1, sizeof(int)*(1*(len_269)), "libcomelang-str-gc.c", 976, "int"));
    result_270[0]=0;
...
int* __result124__;
    ...
    result_273=(int*)come_increment_ref_count((int*)come_calloc(1, sizeof(int)*(1*(len_272*2+1)), "libcomelang-str-gc.c", 990, "int"));
    n_274=0;
...
int* result_297;
int* __result128__;
    result_297=(int*)come_increment_ref_count((int*)come_calloc(1, sizeof(int)*(1*(wcslen(left)+wcslen(right)+1)), "libcomelang-str-gc.c", 1154, "int"));
...
int* result_298;
int* __result129__;
    result_298=(int*)come_increment_ref_count((int*)come_calloc(1, sizeof(int)*(1*(wcslen(left)+wcslen(right)+1)), "libcomelang-str-gc.c", 1164, "int"));
...
char* __result132__;
    ...
    result_318=(char*)come_increment_ref_count((char*)come_calloc(1, sizeof(char)*(1*(len_317)), "libcomelang-str-gc.c", 1262, "char"));
    result_318[0]=0;
...
memset(&erro_ofs_326, 0, sizeof(int));
    ...
    str_328=reg->str;
    re_329=reg->re;
    result_330=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang-str-gc.c", 1290, "buffer"))));
    while((_Bool)1) {
        options_331=2097152;
        len_332=strlen(self);
    ...
    __result133__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value244=buffer_to_string(result_330)));
...
memset(&erro_ofs_345, 0, sizeof(int));
    ...
    str_347=reg->str;
    re_348=reg->re;
    result_349=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang-str-gc.c", 1353, "buffer"))));
    n_350=0;
    while((_Bool)1) {
        options_351=2097152;
        len_352=strlen(self);
    ...
    __result134__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value251=buffer_to_string(result_349)));
...
struct list$1charph* __result135__;
    result_360=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 1412, "list$1charph"))));
    buf_361=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang-str-gc.c", 1414, "buffer"))));
...
memset(&erro_ofs_370, 0, sizeof(int));
    result_363=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 1435, "list$1charph"))));
    offset_364=0;
    ovec_max_365=16;
...
memset(&erro_ofs_384, 0, sizeof(int));
    ...
    str_386=reg->str;
    re_387=reg->re;
    result_388=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 1516, "list$1charph"))));
    offset_389=0;
    ovec_max_390=16;
...
memset(&erro_ofs_420, 0, sizeof(int));
    ...
    str_422=reg->str;
    re_423=reg->re;
    result_424=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 1638, "list$1charph"))));
    offset_425=0;
    ovec_max_426=16;
...
memset(&erro_ofs_481, 0, sizeof(int));
    ...
    str_483=reg->str;
    re_484=reg->re;
    result_485=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang-str-gc.c", 1850, "buffer"))));
    while((_Bool)1) {
        options_486=2097152;
        len_487=strlen(self);
        ...
        if(regex_result_488==1) {
            ...
            group_strings_492=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 1870, "list$1charph"))));
            ...
            if(regex_result_488>1) {
                ...
                group_strings_497=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 1905, "list$1charph"))));
    ...
    __result140__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value293=buffer_to_string(result_485)));
...
memset(&erro_ofs_510, 0, sizeof(int));
    ...
    str_512=reg->str;
    re_513=reg->re;
    result_514=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang-str-gc.c", 1951, "buffer"))));
    n_515=0;
    while((_Bool)1) {
        options_516=2097152;
        len_517=strlen(self);
        ...
        if(regex_result_518==1) {
            ...
            group_strings_522=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 1974, "list$1charph"))));
            ...
            if(regex_result_518>1) {
                ...
                group_strings_528=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang-str-gc.c", 2017, "list$1charph"))));
    ...
    __result141__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value313=buffer_to_string(result_514)));
...
char* __result144__;
    ...
    if(result_538[string_length(result_538)-1]==10) {
        __result143__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value316=string_substring(result_538,0,-2)));
