...
unsigned int* __result104__;
    ...
    result_77=(unsigned int*)come_increment_ref_count((unsigned int*)come_calloc(1, sizeof(unsigned int)*(1*(tail-head+1)), "libcomelang-str-gc.c", 156, "int"));
...
unsigned int* __result106__;
    ...
    len_78=strlen(str);
    wstr_79=(unsigned int*)come_increment_ref_count((unsigned int*)come_calloc(1, sizeof(unsigned int)*(1*(len_78+1)), "libcomelang-str-gc.c", 171, "int"));
...
unsigned int* __result122__;
    len_266=wcslen(str);
    result_267=(unsigned int*)come_increment_ref_count((unsigned int*)come_calloc(1, sizeof(unsigned int)*(1*(len_266+1)), "libcomelang-str-gc.c", 961, "int"));
...
unsigned int* __result123__;
    ...
    result_270=(unsigned int*)come_increment_ref_count((unsigned int*)come_calloc(1, sizeof(unsigned int)*(1*(len_269)), "libcomelang-str-gc.c", 976, "int"));
    result_270[0]=0;
...
unsigned int* __result124__;
    ...
    result_273=(unsigned int*)come_increment_ref_count((unsigned int*)come_calloc(1, sizeof(unsigned int)*(1*(len_272*2+1)), "libcomelang-str-gc.c", 990, "int"));
    n_274=0;
...
unsigned int* __result128__;
    result_297=(unsigned int*)come_increment_ref_count((unsigned int*)come_calloc(1, sizeof(unsigned int)*(1*(wcslen(left)+wcslen(right)+1)), "libcomelang-str-gc.c", 1154, "int"));
...
unsigned int* __result129__;
    result_298=(unsigned int*)come_increment_ref_count((unsigned int*)come_calloc(1, sizeof(unsigned int)*(1*(wcslen(left)+wcslen(right)+1)), "libcomelang-str-gc.c", 1164, "int"));
