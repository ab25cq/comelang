...
unsigned int* __result104__;
    ...
    result_55=(unsigned int*)come_calloc(1, sizeof(unsigned int)*(1*(tail-head+1)), "libcomelang-str-gc.c", 183, "int");
...
unsigned int* __result106__;
    ...
    len_56=strlen(str);
    wstr_57=(unsigned int*)come_calloc(1, sizeof(unsigned int)*(1*(len_56+1)), "libcomelang-str-gc.c", 198, "int");
...
unsigned int* __result121__;
    len_244=wcslen(str);
    result_245=(unsigned int*)come_calloc(1, sizeof(unsigned int)*(1*(len_244+1)), "libcomelang-str-gc.c", 988, "int");
...
unsigned int* __result122__;
    ...
    result_248=(unsigned int*)come_calloc(1, sizeof(unsigned int)*(1*(len_247)), "libcomelang-str-gc.c", 1003, "int");
    result_248[0]=0;
...
unsigned int* __result123__;
    ...
    result_251=(unsigned int*)come_calloc(1, sizeof(unsigned int)*(1*(len_250*2+1)), "libcomelang-str-gc.c", 1017, "int");
    n_252=0;
...
unsigned int* __result127__;
    result_275=(unsigned int*)come_calloc(1, sizeof(unsigned int)*(1*(wcslen(left)+wcslen(right)+1)), "libcomelang-str-gc.c", 1181, "int");
...
unsigned int* __result128__;
    result_276=(unsigned int*)come_calloc(1, sizeof(unsigned int)*(1*(wcslen(left)+wcslen(right)+1)), "libcomelang-str-gc.c", 1191, "int");
