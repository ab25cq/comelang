...
int* __result104__;
    ...
    result_55=(int*)come_calloc(1, sizeof(int)*(1*(tail-head+1)), "libcomelang-str-gc.c", 181, "int");
...
int* __result106__;
    ...
    len_56=strlen(str);
    wstr_57=(int*)come_calloc(1, sizeof(int)*(1*(len_56+1)), "libcomelang-str-gc.c", 196, "int");
...
int* __result121__;
    len_244=wcslen(str);
    result_245=(int*)come_calloc(1, sizeof(int)*(1*(len_244+1)), "libcomelang-str-gc.c", 986, "int");
...
int* __result122__;
    ...
    result_248=(int*)come_calloc(1, sizeof(int)*(1*(len_247)), "libcomelang-str-gc.c", 1001, "int");
    result_248[0]=0;
...
int* __result123__;
    ...
    result_251=(int*)come_calloc(1, sizeof(int)*(1*(len_250*2+1)), "libcomelang-str-gc.c", 1015, "int");
    n_252=0;
...
int* result_275;
int* __result127__;
    result_275=(int*)come_calloc(1, sizeof(int)*(1*(wcslen(left)+wcslen(right)+1)), "libcomelang-str-gc.c", 1179, "int");
...
int* result_276;
int* __result128__;
    result_276=(int*)come_calloc(1, sizeof(int)*(1*(wcslen(left)+wcslen(right)+1)), "libcomelang-str-gc.c", 1189, "int");
