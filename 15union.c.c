...
default_value_114 = (void*)0;
    ...
    keys_99=(char**)come_increment_ref_count(((char**)(__right_value152=(char**)come_calloc(1, sizeof(char*)*(1*(size_98)), "/usr/local/include/comelang.h", 1620, "char*%"))));
    items_100=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value153=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_98)), "/usr/local/include/comelang.h", 1621, "sType*%"))));
    item_existance_101=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value154=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_98)), "/usr/local/include/comelang.h", 1622, "bool"))));
    len_102=0;
...
default_value_172 = (void*)0;
    ...
    keys_159=(char**)come_increment_ref_count(((char**)(__right_value167=(char**)come_calloc(1, sizeof(char*)*(1*(size_158)), "/usr/local/include/comelang.h", 1620, "char*%"))));
    items_160=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value168=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_158)), "/usr/local/include/comelang.h", 1621, "sClass*%"))));
    item_existance_161=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value169=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_158)), "/usr/local/include/comelang.h", 1622, "bool"))));
    len_162=0;
...
struct list$1tuple2$2charphsTypephph* __result133__;
    ...
    result_178=(struct list$1tuple2$2charphsTypephph*)come_increment_ref_count(list$1tuple2$2charphsTypephph_initialize((struct list$1tuple2$2charphsTypephph*)come_increment_ref_count((struct list$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang.h", 137, "list$1tuple2$2charphsTypephph"))));
    it_179=self->head;
    while(it_179!=((void*)0)) {
...
struct list$1tuple2$2charphsTypephph* __result130__;
    if(self->len==0) {
        litem_180=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value175=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang.h", 151, "list_item$1tuple2$2charphsTypephph"))));
        ...
        if(self->len==1) {
            ...
            litem_182=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value177=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang.h", 171, "list_item$1tuple2$2charphsTypephph"))));
...
struct list$1tuple2$2charphsTypephph* __result135__;
    if(self->len==0) {
        litem_188=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value190=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang.h", 221, "list_item$1tuple2$2charphsTypephph"))));
        ...
        if(self->len==1) {
            ...
            litem_190=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value192=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang.h", 241, "list_item$1tuple2$2charphsTypephph"))));
