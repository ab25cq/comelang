...
default_value_288 = (void*)0;
    ...
    keys_273=(char**)come_increment_ref_count(((char**)(__right_value249=(char**)come_calloc(1, sizeof(char*)*(1*(size_272)), "/usr/local/include/comelang.h", 2515, "char*%"))));
    items_274=(struct buffer**)come_increment_ref_count(((struct buffer**)(__right_value250=(struct buffer**)come_calloc(1, sizeof(struct buffer*)*(1*(size_272)), "/usr/local/include/comelang.h", 2516, "buffer*%"))));
    item_existance_275=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value251=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_272)), "/usr/local/include/comelang.h", 2517, "bool"))));
    len_276=0;
...
default_value_334 = (void*)0;
    ...
    keys_321=(char**)come_increment_ref_count(((char**)(__right_value255=(char**)come_calloc(1, sizeof(char*)*(1*(size_320)), "/usr/local/include/comelang.h", 2515, "char*%"))));
    items_322=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value256=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_320)), "/usr/local/include/comelang.h", 2516, "sClass*%"))));
    item_existance_323=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value257=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_320)), "/usr/local/include/comelang.h", 2517, "bool"))));
    len_324=0;
...
default_value_356 = (void*)0;
    ...
    keys_341=(char**)come_increment_ref_count(((char**)(__right_value264=(char**)come_calloc(1, sizeof(char*)*(1*(size_340)), "/usr/local/include/comelang.h", 2515, "char*%"))));
    items_342=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value265=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_340)), "/usr/local/include/comelang.h", 2516, "sType*%"))));
    item_existance_343=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value266=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_340)), "/usr/local/include/comelang.h", 2517, "bool"))));
    len_344=0;
...
struct list$1sTypeph* __result260__;
    ...
    result_363=(struct list$1sTypeph*)come_increment_ref_count(list$1sTypeph_initialize((struct list$1sTypeph*)come_increment_ref_count((struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "/usr/local/include/comelang.h", 1026, "list$1sTypeph"))));
    it_364=self->head;
    while(it_364!=((void*)0)) {
...
struct list$1sTypeph* __result259__;
    if(    self->len==0) {
        litem_365=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value275=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang.h", 1040, "list_item$1sTypeph"))));
        ...
        litem_366=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value276=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang.h", 1050, "list_item$1sTypeph"))));
        ...
        litem_367=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value277=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang.h", 1060, "list_item$1sTypeph"))));
...
struct list$1sNodeph* __result266__;
    ...
    result_368=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count((struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "/usr/local/include/comelang.h", 1026, "list$1sNodeph"))));
    it_369=self->head;
    while(it_369!=((void*)0)) {
...
struct list$1sNodeph* __result263__;
    if(    self->len==0) {
        litem_370=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value282=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 1040, "list_item$1sNodeph"))));
        ...
        litem_371=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value283=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 1050, "list_item$1sNodeph"))));
        ...
        litem_372=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value284=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 1060, "list_item$1sNodeph"))));
...
struct list$1charph* __result269__;
    ...
    result_374=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang.h", 1026, "list$1charph"))));
    it_375=self->head;
    while(it_375!=((void*)0)) {
...
struct list$1charph* __result268__;
    if(    self->len==0) {
        litem_376=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value291=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 1040, "list_item$1charph"))));
        ...
        litem_377=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value292=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 1050, "list_item$1charph"))));
        ...
        litem_378=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value293=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 1060, "list_item$1charph"))));
...
struct list$1tuple2$2charphsTypephph* __result271__;
    if(    self->len==0) {
        litem_386=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value309=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang.h", 1110, "list_item$1tuple2$2charphsTypephph"))));
        ...
        litem_387=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value310=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang.h", 1120, "list_item$1tuple2$2charphsTypephph"))));
        ...
        litem_388=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value311=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang.h", 1130, "list_item$1tuple2$2charphsTypephph"))));
