...
default_value_114 = (void*)0;
    ...
    keys_99=(char**)come_increment_ref_count(((char**)(__right_value152=(char**)come_calloc(1, sizeof(char*)*(1*(size_98)), "./comelang.h", 1620, "char*%"))));
    items_100=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value153=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_98)), "./comelang.h", 1621, "sType*%"))));
    item_existance_101=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value154=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_98)), "./comelang.h", 1622, "bool"))));
    len_102=0;
...
default_value_172 = (void*)0;
    ...
    keys_159=(char**)come_increment_ref_count(((char**)(__right_value167=(char**)come_calloc(1, sizeof(char*)*(1*(size_158)), "./comelang.h", 1620, "char*%"))));
    items_160=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value168=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_158)), "./comelang.h", 1621, "sClass*%"))));
    item_existance_161=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value169=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_158)), "./comelang.h", 1622, "bool"))));
    len_162=0;
