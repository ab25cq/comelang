...
default_value_116 = (void*)0;
    ...
    keys_101=(char**)come_increment_ref_count(((char**)(__right_value153=(char**)come_calloc(1, sizeof(char*)*(1*(size_100)), "./comelang.h", 1658, "char*%"))));
    items_102=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value154=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_100)), "./comelang.h", 1659, "sType*%"))));
    item_existance_103=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value155=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_100)), "./comelang.h", 1660, "bool"))));
    len_104=0;
...
default_value_174 = (void*)0;
    ...
    keys_161=(char**)come_increment_ref_count(((char**)(__right_value168=(char**)come_calloc(1, sizeof(char*)*(1*(size_160)), "./comelang.h", 1658, "char*%"))));
    items_162=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value169=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_160)), "./comelang.h", 1659, "sClass*%"))));
    item_existance_163=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value170=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_160)), "./comelang.h", 1660, "bool"))));
    len_164=0;
