...
default_value_312 = (void*)0;
    ...
    keys_297=(char**)come_increment_ref_count(((char**)(__right_value283=(char**)come_calloc(1, sizeof(char*)*(1*(size_296)), "/usr/local/include/comelang.h", 2548, "char*%"))));
    items_298=(struct buffer**)come_increment_ref_count(((struct buffer**)(__right_value284=(struct buffer**)come_calloc(1, sizeof(struct buffer*)*(1*(size_296)), "/usr/local/include/comelang.h", 2549, "buffer*%"))));
    item_existance_299=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value285=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_296)), "/usr/local/include/comelang.h", 2550, "bool"))));
    len_300=0;
...
default_value_358 = (void*)0;
    ...
    keys_345=(char**)come_increment_ref_count(((char**)(__right_value289=(char**)come_calloc(1, sizeof(char*)*(1*(size_344)), "/usr/local/include/comelang.h", 2548, "char*%"))));
    items_346=(struct sClass**)come_increment_ref_count(((struct sClass**)(__right_value290=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_344)), "/usr/local/include/comelang.h", 2549, "sClass*%"))));
    item_existance_347=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value291=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_344)), "/usr/local/include/comelang.h", 2550, "bool"))));
    len_348=0;
...
default_value_380 = (void*)0;
    ...
    keys_365=(char**)come_increment_ref_count(((char**)(__right_value298=(char**)come_calloc(1, sizeof(char*)*(1*(size_364)), "/usr/local/include/comelang.h", 2548, "char*%"))));
    items_366=(struct sType**)come_increment_ref_count(((struct sType**)(__right_value299=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_364)), "/usr/local/include/comelang.h", 2549, "sType*%"))));
    item_existance_367=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value300=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_364)), "/usr/local/include/comelang.h", 2550, "bool"))));
    len_368=0;
...
struct list$1sTypeph* __result285__;
    ...
    result_387=(struct list$1sTypeph*)come_increment_ref_count(list$1sTypeph_initialize((struct list$1sTypeph*)come_increment_ref_count((struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "/usr/local/include/comelang.h", 1059, "list$1sTypeph"))));
    it_388=self->head;
    while(it_388!=((void*)0)) {
...
struct list$1sTypeph* __result284__;
    if(    self->len==0) {
        litem_389=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value309=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang.h", 1073, "list_item$1sTypeph"))));
        ...
        litem_390=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value310=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang.h", 1083, "list_item$1sTypeph"))));
        ...
        litem_391=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value311=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang.h", 1093, "list_item$1sTypeph"))));
...
struct list$1sNodeph* __result291__;
    ...
    result_392=(struct list$1sNodeph*)come_increment_ref_count(list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count((struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "/usr/local/include/comelang.h", 1059, "list$1sNodeph"))));
    it_393=self->head;
    while(it_393!=((void*)0)) {
...
struct list$1sNodeph* __result288__;
    if(    self->len==0) {
        litem_394=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value316=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 1073, "list_item$1sNodeph"))));
        ...
        litem_395=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value317=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 1083, "list_item$1sNodeph"))));
        ...
        litem_396=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value318=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 1093, "list_item$1sNodeph"))));
...
struct list$1charph* __result294__;
    ...
    result_398=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang.h", 1059, "list$1charph"))));
    it_399=self->head;
    while(it_399!=((void*)0)) {
...
struct list$1charph* __result293__;
    if(    self->len==0) {
        litem_400=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value325=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 1073, "list_item$1charph"))));
        ...
        litem_401=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value326=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 1083, "list_item$1charph"))));
        ...
        litem_402=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value327=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang.h", 1093, "list_item$1charph"))));
...
struct list$1tuple2$2charphsTypephph* __result296__;
    if(    self->len==0) {
        litem_410=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value343=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang.h", 1143, "list_item$1tuple2$2charphsTypephph"))));
        ...
        litem_411=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value344=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang.h", 1153, "list_item$1tuple2$2charphsTypephph"))));
        ...
        litem_412=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(__right_value345=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang.h", 1163, "list_item$1tuple2$2charphsTypephph"))));
