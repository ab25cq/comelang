...
struct sNode* __result238__;
    if(    charp_operator_equals(buf,"while")) {
        ...
        come_call_finalizer3(block_328,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        come_call_finalizer3(__right_value279,sWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
...
struct sWhileNode* __result236__;
    ...
    come_call_finalizer3(result_329,sWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
