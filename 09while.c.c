...
struct sNode* __result_obj__56;
    if(    charp_operator_equals(buf,"while")    ) {
        sname=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "09while.c", 60, "char*"));
        sline=info->sline;
        ...
        __right_value0 = (void*)0;
        _inf_value1=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "09while.c", 72, "struct sNode");
        _inf_obj_value1=(struct sWhileNode*)come_increment_ref_count(((struct sWhileNode*)(__right_value1=sWhileNode_initialize((struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc_v2(1, sizeof(struct sWhileNode)*(1), "09while.c", 72, "struct sWhileNode*")),(struct sNode*)come_increment_ref_count(expression_node),block,info))));
    ...
    __right_value0 = (void*)0;
    __result_obj__56 = (struct sNode*)come_increment_ref_count(((struct sNode*)(__right_value0=string_node_v8(buf,head,head_sline,info))));
