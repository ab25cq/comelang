...
struct sWhileNode* __result268__;
...
char* __result269__;
    __result269__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value318=__builtin_string("sWhileNode")));
...
int num_while_conditional_stack_388;
    ...
    if(    normal_if_384) {
        ...
        add_come_code(info,"while((_while_condtional%d=(%s)),",num_while_condtional_387,conditional_value_386->c_value);
    ...
    transpile_block(block_383,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    add_come_code(info,"}\n");
...
struct sNode* __result273__;
    if(    charp_operator_equals(buf,"while")) {
        ...
        block_392=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "09while.c", 103, "struct sNode", (void*)0, (void*)0, (void*)0);
        _inf_obj_value1=(struct sWhileNode*)come_increment_ref_count(((struct sWhileNode*)(__right_value325=sWhileNode_initialize((struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "09while.c", 103, "struct sWhileNode*", (void*)0, (void*)0, (void*)0)),(struct sNode*)come_increment_ref_count(expression_node_391),block_392,info))));
        ...
        __result272__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value330=_inf_value1));
        ...
        come_call_finalizer3(block_392,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        come_call_finalizer3(__right_value325,sWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
    ...
    __result273__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value331=string_node_v8(buf,head,head_sline,info)));
...
struct sWhileNode* __result271__;
    if(    self==(void*)0) {
        __result270__ = gComeFunResultObject = __result_obj__ = (void*)0;
        gComeFunResultObject = (void*)0;
        return __result270__;
    }
    result_394=(struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "sWhileNode_clone", 3, "struct sWhileNode", sWhileNode_finalize, sWhileNode_clone, sWhileNode_get_hash_key));
    if(    self!=((void*)0)) {
        result_394->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj101=result_394->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj102=result_394->mExpressionNode;
        result_394->mExpressionNode=(struct sNode*)come_increment_ref_count(come_call_cloner(sNode_clone, self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj103=result_394->mBlock;
        result_394->mBlock=(struct sBlock*)come_increment_ref_count(come_call_cloner(sBlock_clone, self->mBlock));
    ...
    come_call_finalizer3(result_394,sWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
unsigned int result_393;
    ...
    result_393+=int_get_hash_key(((int)self->mExpressionNode));
    result_393+=int_get_hash_key(((int)self->mBlock));
    return result_393;
}
