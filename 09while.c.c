...
char* __result102__;
    __result102__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value144=__builtin_string("sWhileNode")));
...
struct sNode* __result106__;
    if(    charp_operator_equals(buf,"while")) {
        ...
        __result105__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value156=_inf_value1));
    ...
    __result106__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value157=string_node_v8(buf,head,head_sline,info)));
