...
struct sWhileNode* __result264__;
...
char* __result265__;
    __result265__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value320=__builtin_string("sWhileNode")));
...
int num_while_conditional_stack_364;
    ...
    if(    normal_if_360) {
        ...
        add_come_code(info,"while((_while_condtional%d=(%s)),",num_while_condtional_363,conditional_value_362->c_value);
...
struct sNode* __result269__;
    if(    charp_operator_equals(buf,"while")) {
        ...
        __result268__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value332=_inf_value1));
        ...
        come_call_finalizer3(block_368,sBlock_finalize, 0, 0, 0, 0, (void*)0);
    ...
    __result269__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value333=string_node_v8(buf,head,head_sline,info)));
...
static struct sWhileNode* sWhileNode_clone(struct sWhileNode* self){
void* __result_obj__=(void*)0;
struct sWhileNode* __result266__;
void* __right_value328 = (void*)0;
struct sWhileNode* result_369;
...
struct sWhileNode* __result267__;
    ...
    result_369=(struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "sWhileNode_clone", 3, "struct sWhileNode*", (void*)0, (void*)0));
    if(    self!=((void*)0)) {
        result_369->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj103=result_369->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj104=result_369->mExpressionNode;
        result_369->mExpressionNode=(struct sNode*)come_increment_ref_count(come_call_cloner(sNode_clone, self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj105=result_369->mBlock;
        result_369->mBlock=(struct sBlock*)come_increment_ref_count(come_call_cloner(sBlock_clone, self->mBlock));
    ...
    come_call_finalizer3(result_369,sWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
