...
struct sNode* __result_obj__56;
    if(    charp_operator_equals(buf,"while")    ) {
        sname_97=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "09while.c", 81, "char*"));
        sline_98=info->sline;
...
struct sWhileNode* __result_obj__54;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)    ) {
        __dec_obj40=result_101->mExpressionNode,
