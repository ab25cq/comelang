...
char* __result259__;
    __result259__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value307=__builtin_string("sWhileNode")));
...
int num_while_conditional_stack_348;
    ...
    if(    normal_if_344) {
        ...
        add_come_code(info,"while((_while_condtional%d=(%s)),",num_while_condtional_347,conditional_value_346->c_value);
    ...
    transpile_block(block_343,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    add_come_code(info,"}\n");
...
struct sNode* __result263__;
    if(    charp_operator_equals(buf,"while")) {
        ...
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "09while.c", 101, "struct sNode");
        _inf_obj_value1=(struct sWhileNode*)come_increment_ref_count(((struct sWhileNode*)(__right_value314=sWhileNode_initialize((struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "09while.c", 101, "sWhileNode")),(struct sNode*)come_increment_ref_count(expression_node_351),block_352,info))));
        ...
        __result262__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value319=_inf_value1));
        ...
        /*i*/come_call_finalizer3(block_352,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        /*g*/come_call_finalizer3(__right_value314,sWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
    ...
    __result263__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value320=string_node_v8(buf,head,head_sline,info)));
...
struct sWhileNode* __result261__;
    ...
    result_353=(struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "sWhileNode_clone", 3, "sWhileNode"));
    if(    self!=((void*)0)) {
        result_353->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj78=result_353->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj79=result_353->mExpressionNode;
        result_353->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj80=result_353->mBlock;
        result_353->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
        come_call_finalizer3(__dec_obj80,sBlock_finalize, 0, 0, 0, 0, (void*)0);
    }
    __result261__ = gComeFunResultObject = __result_obj__ = result_353;
    /*i*/come_call_finalizer3(result_353,sWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
