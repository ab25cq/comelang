...
struct sWhileNode* __result_obj__215;
    ...
    /*c*/ come_call_finalizer3(__result_obj__215,sWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 0/* force_delete */ , (void*)0);
...
char* __result_obj__216;
    __result_obj__216 = come_increment_ref_count(((char*)(__right_value262=__builtin_string("sWhileNode"))));
...
int num_while_conditional_stack_344;
    if(    info->comma_instead_of_semicolon) {
        multiple_assign_var1=((struct tuple2$2int$char$ph*)(__right_value263=err_msg(info,"In conditional operator comelang can't use while statment")));
    ...
    if(    normal_if_340) {
        ...
        add_come_code(info,"while((_while_condtional%d=(%s)),",num_while_condtional_343,conditional_value_342->c_value);
...
struct sNode* __result_obj__221;
    if(    charp_operator_equals(buf,"while")) {
        sname_345=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "09while.c", 91, "char*"));
        sline_346=info->sline;
        expected_next_character(40,info);
        expression_node_347=(struct sNode*)come_increment_ref_count(expression_v13(info));
        expected_next_character(41,info);
        block_348=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "09while.c", 103, "struct sNode");
        _inf_obj_value1=(struct sWhileNode*)come_increment_ref_count(((struct sWhileNode*)(__right_value270=sWhileNode_initialize((struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "09while.c", 103, "struct sWhileNode*")),(struct sNode*)come_increment_ref_count(expression_node_347),block_348,info))));
        ...
        __result_obj__220 = come_increment_ref_count(((struct sNode*)(__right_value275=_inf_value1)));
        (sname_345 = come_decrement_ref_count(sname_345, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        ((expression_node_347) ? expression_node_347 = come_decrement_ref_count(expression_node_347, ((struct sNode*)expression_node_347)->finalize, ((struct sNode*)expression_node_347)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,0/*force_delete*/, (void*)0):(void*)0);
        /*c*/ come_call_finalizer3(block_348,sBlock_finalize, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
        /*c*/ come_call_finalizer3(__right_value270,sWhileNode_finalize, 0/* alloca value */, 1/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
    ...
    __result_obj__221 = come_increment_ref_count(((struct sNode*)(__right_value276=string_node_v8(buf,head,head_sline,info))));
...
static struct sWhileNode* sWhileNode_clone(struct sWhileNode* self){
struct sWhileNode* __result_obj__218;
void* __right_value271 = (void*)0;
struct sWhileNode* result_349;
...
struct sWhileNode* __result_obj__219;
    if(    self==(void*)0) {
        __result_obj__218 = (void*)0;
        return __result_obj__218;
    }
    result_349=(struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "sWhileNode_clone", 3, "struct sWhileNode*"));
    if(    self!=((void*)0)) {
        result_349->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj51=result_349->sname,
        result_349->sname=(char*)come_increment_ref_count((char*)come_memdup(self->sname, "sWhileNode_clone", 5, "char*"));
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj52=result_349->mExpressionNode,
        result_349->mExpressionNode=(struct sNode*)come_increment_ref_count(come_call_cloner(sNode_clone, self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj53=result_349->mBlock,
        result_349->mBlock=(struct sBlock*)come_increment_ref_count(come_call_cloner(sBlock_clone, self->mBlock));
        /*b*/ come_call_finalizer3(__dec_obj53,sBlock_finalize, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, 0/* force_delete_ */, (void*)0);
    }
    __result_obj__219 = result_349;
    /*c*/ come_call_finalizer3(result_349,sWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 0/* force_delete */ , (void*)0);
