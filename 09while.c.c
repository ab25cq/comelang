...
struct sWhileNode* __result100__;
...
char* __result101__;
    __result101__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value143=__builtin_string("sWhileNode")));
...
int num_while_conditional_stack_152;
    ...
    if(    normal_if_148) {
        ...
        add_come_code(info,"while((_while_condtional%d=(%s)),",num_while_condtional_151,conditional_value_150->c_value);
    ...
    transpile_block(block_147,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    add_come_code(info,"}\n");
...
struct sNode* __result105__;
    if(    charp_operator_equals(buf,"while")) {
        ...
        expression_node_155=(struct sNode*)come_increment_ref_count(expression_v13(info));
        ...
        _inf_obj_value1=come_increment_ref_count(((struct sWhileNode*)(__right_value150=sWhileNode_initialize((struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "09while.c", 103, "sWhileNode")),(struct sNode*)come_increment_ref_count(expression_node_155),block_156,info))));
        ...
        __result104__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value155=_inf_value1));
        /* U13 */sname_153 = come_decrement_ref_count2(sname_153, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        if(expression_node_155) { expression_node_155 = come_decrement_ref_count2(expression_node_155, ((struct sNode*)expression_node_155)->finalize, ((struct sNode*)expression_node_155)->_protocol_obj, 0, 0, 0, (void*)0); } 
        /*i*/come_call_finalizer3(block_156,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        /*g*/come_call_finalizer3(__right_value150,sWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
        if(__right_value155) { __right_value155 = come_decrement_ref_count2(__right_value155, ((struct sNode*)__right_value155)->finalize, ((struct sNode*)__right_value155)->_protocol_obj, 1, 0, 0, __result_obj__); } 
        gComeFunResultObject = (void*)0;
    ...
    __result105__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value156=string_node_v8(buf,head,head_sline,info)));
...
struct sWhileNode* __result103__;
    if(    self==(void*)0) {
        __result102__ = gComeFunResultObject = __result_obj__ = (void*)0;
        gComeFunResultObject = (void*)0;
        return __result102__;
    }
    result_157=(struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "sWhileNode_clone", 3, "sWhileNode"));
    if(    self!=((void*)0)) {
        result_157->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj63=result_157->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj64=result_157->mExpressionNode;
    ...
    /*i*/come_call_finalizer3(result_157,sWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
