...
struct sNode* __result_obj__297;
    if(    charp_operator_equals(buf,"while")) {
        ...
        ((expression_node_471) ? expression_node_471 = come_decrement_ref_count2(expression_node_471, ((struct sNode*)expression_node_471)->finalize, ((struct sNode*)expression_node_471)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,0/*force_delete*/, (void*)0):(void*)0);
...
struct sWhileNode* __result_obj__295;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj59=result_473->mExpressionNode;
