...
struct CVALUE* conditional_value_104;
    ...
    add_come_code(info,") {\n");
    transpile_block(block_101,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    add_come_code(info,"}\n");
...
struct sNode* __result_obj__56;
    if(    charp_operator_equals(buf,"while")    ) {
        sname_105=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "09while.c", 81, "char*"));
        sline_106=info->sline;
        expected_next_character(40,info);
        expression_node_107=(struct sNode*)come_increment_ref_count(expression_v13(info));
        expected_next_character(41,info);
        block_108=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        ...
        ((expression_node_107) ? expression_node_107 = come_decrement_ref_count(expression_node_107, ((struct sNode*)expression_node_107)->finalize, ((struct sNode*)expression_node_107)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,(void*)0):(void*)0);
        come_call_finalizer(sBlock_finalize, block_108, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, (void*)0);
...
struct sWhileNode* __result_obj__54;
    ...
    result_109=(struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc_v2(1, sizeof(struct sWhileNode)*(1), "sWhileNode_clone", 3, "struct sWhileNode*"));
    if(    self!=((void*)0)    ) {
        result_109->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)    ) {
        __dec_obj38=result_109->sname,
        result_109->sname=(char*)come_increment_ref_count((char*)come_memdup(self->sname, "sWhileNode_clone", 5, "char*"));
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)    ) {
        __dec_obj39=result_109->mExpressionNode,
        result_109->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)    ) {
        __dec_obj40=result_109->mBlock,
        result_109->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
    ...
    come_call_finalizer(sWhileNode_finalize, result_109, (void*)0, (void*)0, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, (void*)0);
