...
struct sWhileNode* __result_obj__291;
    ...
    come_call_finalizer3(__result_obj__291,sWhileNode_finalize, 0, 0, 1, 0, (void*)0);
...
char* __result_obj__292;
    __result_obj__292 = come_increment_ref_count(((char*)(__right_value341=__builtin_string("sWhileNode"))));
...
int num_while_conditional_stack_473;
    ...
    if(    normal_if_469) {
        ...
        add_come_code(info,"while((_while_condtional%d=(%s)),",num_while_condtional_472,conditional_value_471->c_value);
...
struct sNode* __result_obj__297;
    if(    charp_operator_equals(buf,"while")) {
        ...
        __result_obj__296 = come_increment_ref_count(((struct sNode*)(__right_value354=_inf_value1)));
    ...
    __result_obj__297 = come_increment_ref_count(((struct sNode*)(__right_value355=string_node_v8(buf,head,head_sline,info))));
...
static struct sWhileNode* sWhileNode_clone(struct sWhileNode* self){
struct sWhileNode* __result_obj__294;
void* __right_value350 = (void*)0;
struct sWhileNode* result_478;
...
struct sWhileNode* __result_obj__295;
    ...
    result_478=(struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "sWhileNode_clone", 3, "struct sWhileNode*", (void*)0, (void*)0, (void*)0, (void*)0));
    if(    self!=((void*)0)) {
        result_478->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj58=result_478->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj59=result_478->mExpressionNode;
    ...
    __result_obj__295 = result_478;
    come_call_finalizer3(result_478,sWhileNode_finalize, 0, 0, 1, 0, (void*)0);
