...
int num_while_conditional_stack_343;
    ...
    Value_337=node_compile(expression_node_334,info);
    if(    !Value_337) {
        return (_Bool)0;
    }
    else {
    ...
    if(    normal_if_339) {
        ...
        add_come_code(info,"while((_while_condtional%d=(%s)),",num_while_condtional_342,conditional_value_341->c_value);
...
struct sNode* expression_node_346;
...
struct sNode* __result_obj__221;
    if(    charp_operator_equals(buf,"while")) {
        sname_344=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "09while.c", 91, "char*"));
        sline_345=info->sline;
        expected_next_character(40,info);
        expression_node_346=(struct sNode*)come_increment_ref_count(expression_v13(info));
        ...
        ((expression_node_346) ? expression_node_346 = come_decrement_ref_count(expression_node_346, ((struct sNode*)expression_node_346)->finalize, ((struct sNode*)expression_node_346)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,0/*force_delete*/, (void*)0):(void*)0);
...
struct sWhileNode* __result_obj__219;
    ...
    result_348=(struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "sWhileNode_clone", 3, "struct sWhileNode*"));
    if(    self!=((void*)0)) {
        result_348->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj51=result_348->sname,
        result_348->sname=(char*)come_increment_ref_count((char*)come_memdup(self->sname, "sWhileNode_clone", 5, "char*"));
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj52=result_348->mExpressionNode,
        result_348->mExpressionNode=(struct sNode*)come_increment_ref_count(come_call_cloner(sNode_clone, self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj53=result_348->mBlock,
        result_348->mBlock=(struct sBlock*)come_increment_ref_count(come_call_cloner(sBlock_clone, self->mBlock));
    ...
    /*c*/ come_call_finalizer3(result_348,sWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 0/* force_delete */ , (void*)0);
