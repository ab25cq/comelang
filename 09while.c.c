...
static unsigned int sWhileNode_get_hash_key(struct sWhileNode* self);
static _Bool sWhileNode_equals(struct sWhileNode* left, struct sWhileNode* right);
...
struct sWhileNode* __result279__;
...
char* __result280__;
    __result280__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value321=__builtin_string("sWhileNode")));
...
int num_while_conditional_stack_420;
    ...
    if(    normal_if_416) {
        ...
        add_come_code(info,"while((_while_condtional%d=(%s)),",num_while_condtional_419,conditional_value_418->c_value);
    ...
    transpile_block(block_415,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    add_come_code(info,"}\n");
...
struct sNode* expression_node_423;
...
struct sNode* __result284__;
    if(    charp_operator_equals(buf,"while")) {
        ...
        expression_node_423=(struct sNode*)come_increment_ref_count(expression_v13(info));
        expected_next_character(41,info);
        block_424=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "09while.c", 103, "struct sNode", (void*)0, (void*)0, (void*)0, (void*)0);
        _inf_obj_value1=(struct sWhileNode*)come_increment_ref_count(((struct sWhileNode*)(__right_value328=sWhileNode_initialize((struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "09while.c", 103, "struct sWhileNode*", (void*)0, (void*)0, (void*)0, (void*)0)),(struct sNode*)come_increment_ref_count(expression_node_423),block_424,info))));
        ...
        __result283__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value333=_inf_value1));
        sname_421 = come_decrement_ref_count2(sname_421, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        if(expression_node_423) { expression_node_423 = come_decrement_ref_count2(expression_node_423, ((struct sNode*)expression_node_423)->finalize, ((struct sNode*)expression_node_423)->_protocol_obj, 0, 0, 0, (void*)0); } 
        come_call_finalizer3(block_424,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        come_call_finalizer3(__right_value328,sWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
    ...
    __result284__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value334=string_node_v8(buf,head,head_sline,info)));
...
static struct sWhileNode* sWhileNode_clone(struct sWhileNode* self){
void* __result_obj__=(void*)0;
struct sWhileNode* __result281__;
void* __right_value329 = (void*)0;
struct sWhileNode* result_426;
...
struct sWhileNode* __result282__;
    if(    self==(void*)0) {
        __result281__ = gComeFunResultObject = __result_obj__ = (void*)0;
        gComeFunResultObject = (void*)0;
        return __result281__;
    }
    result_426=(struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "sWhileNode_clone", 3, "struct sWhileNode", sWhileNode_finalize, sWhileNode_clone, sWhileNode_get_hash_key, sWhileNode_equals));
    if(    self!=((void*)0)) {
        result_426->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj101=result_426->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj102=result_426->mExpressionNode;
        result_426->mExpressionNode=(struct sNode*)come_increment_ref_count(come_call_cloner(sNode_clone, self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj103=result_426->mBlock;
        result_426->mBlock=(struct sBlock*)come_increment_ref_count(come_call_cloner(sBlock_clone, self->mBlock));
        come_call_finalizer3(__dec_obj103,sBlock_finalize, 0, 0, 0, 0, (void*)0);
    }
    __result282__ = gComeFunResultObject = __result_obj__ = result_426;
    come_call_finalizer3(result_426,sWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
...
unsigned int result_425;
    ...
    result_425+=int_get_hash_key(((int)self->mExpressionNode));
    result_425+=int_get_hash_key(((int)self->mBlock));
    return result_425;
}
