...
struct sWhileNode* __result_obj__238;
    ...
    /*c*/ come_call_finalizer3(self,sWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 0/* force_delete */ , (void*)0);
    ...
    /*c*/ come_call_finalizer3(__result_obj__238,sWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 0/* force_delete */ , (void*)0);
...
char* __result_obj__239;
    __result_obj__239 = come_increment_ref_count(((char*)(__right_value307=__builtin_string("sWhileNode"))));
...
int num_while_conditional_stack_350;
    if(    info->comma_instead_of_semicolon) {
        multiple_assign_var1=((struct tuple2$2int$char$ph*)(__right_value308=err_msg(info,"In conditional operator comelang can't use while statment")));
    ...
    if(    normal_if_346) {
        ...
        add_come_code(info,"while((_while_condtional%d=(%s)),",num_while_condtional_349,conditional_value_348->c_value);
    ...
    transpile_block(block_345,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    add_come_code(info,"}\n");
...
struct sNode* __result_obj__244;
    if(    charp_operator_equals(buf,"while")) {
        ...
        block_354=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "09while.c", 103, "struct sNode");
        _inf_obj_value1=(struct sWhileNode*)come_increment_ref_count(((struct sWhileNode*)(__right_value315=sWhileNode_initialize((struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "09while.c", 103, "struct sWhileNode*")),(struct sNode*)come_increment_ref_count(expression_node_353),block_354,info))));
        ...
        __result_obj__243 = come_increment_ref_count(((struct sNode*)(__right_value320=_inf_value1)));
        (sname_351 = come_decrement_ref_count(sname_351, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        ((expression_node_353) ? expression_node_353 = come_decrement_ref_count(expression_node_353, ((struct sNode*)expression_node_353)->finalize, ((struct sNode*)expression_node_353)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,0/*force_delete*/, (void*)0):(void*)0);
        /*c*/ come_call_finalizer3(block_354,sBlock_finalize, 0/* alloca value */, 0/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
        /*c*/ come_call_finalizer3(__right_value315,sWhileNode_finalize, 0/* alloca value */, 1/* no_decrement */, 0/* no_free */, 0/* force_delete */ , (void*)0);
    ...
    __result_obj__244 = come_increment_ref_count(((struct sNode*)(__right_value321=string_node_v8(buf,head,head_sline,info))));
...
static struct sWhileNode* sWhileNode_clone(struct sWhileNode* self){
struct sWhileNode* __result_obj__241;
void* __right_value316 = (void*)0;
struct sWhileNode* result_355;
...
struct sWhileNode* __result_obj__242;
    if(    self==(void*)0) {
        __result_obj__241 = (void*)0;
        return __result_obj__241;
    }
    result_355=(struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "sWhileNode_clone", 3, "struct sWhileNode*"));
    if(    self!=((void*)0)) {
        result_355->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj58=result_355->sname,
        result_355->sname=(char*)come_increment_ref_count(come_call_cloner(string_clone, self->sname));
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj59=result_355->mExpressionNode,
        result_355->mExpressionNode=(struct sNode*)come_increment_ref_count(come_call_cloner(sNode_clone, self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj60=result_355->mBlock,
        result_355->mBlock=(struct sBlock*)come_increment_ref_count(come_call_cloner(sBlock_clone, self->mBlock));
    ...
    /*c*/ come_call_finalizer3(result_355,sWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 0/* force_delete */ , (void*)0);
