...
struct sWhileNode* __result235__;
...
char* __result236__;
    __result236__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value276=__builtin_string("sWhileNode")));
...
int num_while_conditional_stack_327;
    ...
    if(    normal_if_323) {
        ...
        add_come_code(info,"while((_while_condtional%d=(%s)),",num_while_condtional_326,conditional_value_325->c_value);
...
struct sNode* __result240__;
    if(    charp_operator_equals(buf,"while")) {
        ...
        expression_node_330=(struct sNode*)come_increment_ref_count(expression_v13(info));
        expected_next_character(41,info);
        block_331=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "09while.c", 103, "struct sNode");
        _inf_obj_value1=(struct sWhileNode*)come_increment_ref_count(((struct sWhileNode*)(__right_value283=sWhileNode_initialize((struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "09while.c", 103, "sWhileNode")),(struct sNode*)come_increment_ref_count(expression_node_330),block_331,info))));
        ...
        __result239__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value288=_inf_value1));
        sname_328 = come_decrement_ref_count2(sname_328, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        if(expression_node_330) { expression_node_330 = come_decrement_ref_count2(expression_node_330, ((struct sNode*)expression_node_330)->finalize, ((struct sNode*)expression_node_330)->_protocol_obj, 0, 0, 0, (void*)0); } 
        come_call_finalizer3(block_331,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        come_call_finalizer3(__right_value283,sWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
    ...
    __result240__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value289=string_node_v8(buf,head,head_sline,info)));
...
static struct sWhileNode* sWhileNode_clone(struct sWhileNode* self){
void* __result_obj__=(void*)0;
struct sWhileNode* __result237__;
void* __right_value284 = (void*)0;
struct sWhileNode* result_332;
...
struct sWhileNode* __result238__;
    if(    self==(void*)0) {
        __result237__ = gComeFunResultObject = __result_obj__ = (void*)0;
        gComeFunResultObject = (void*)0;
        return __result237__;
    }
    result_332=(struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "sWhileNode_clone", 3, "sWhileNode"));
    if(    self!=((void*)0)) {
        result_332->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj78=result_332->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj79=result_332->mExpressionNode;
        result_332->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode));
        if(__dec_obj79) { __dec_obj79 = come_decrement_ref_count2(__dec_obj79, ((struct sNode*)__dec_obj79)->finalize, ((struct sNode*)__dec_obj79)->_protocol_obj, 0,0,0, (void*)0); };
    }
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj80=result_332->mBlock;
        result_332->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
        come_call_finalizer3(__dec_obj80,sBlock_finalize, 0, 0, 0, 0, (void*)0);
    }
    __result238__ = gComeFunResultObject = __result_obj__ = result_332;
    come_call_finalizer3(result_332,sWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
