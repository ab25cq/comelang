...
int num_while_conditional_stack_99;
    ...
    without_semicolon_92=info->without_semicolon;
    info->without_semicolon=(_Bool)1;
    Value_93=node_compile(expression_node_90,info);
    if(    !Value_93) {
        return (_Bool)0;
    }
    else {
    }
    info->without_semicolon=without_semicolon_92;
    info->comma_instead_of_semicolon=comma_instead_of_semicolon_91;
    block_94=self->mBlock;
    ...
    if(    normal_if_95) {
        ...
        add_come_code(info,"(_while_condtional%d=(%s)),",num_while_conditional_stack_99,conditional_value_97->c_value);
    ...
    transpile_block(block_94,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    add_come_code(info,"}\n");
...
struct sNode* __result_obj__56;
    if(    charp_operator_equals(buf,"while")) {
        sname_100=(char*)come_increment_ref_count((char*)come_memdup(info->sname, "09while.c", 86, "char*"));
        ...
        _inf_value1=(struct sNode*)come_calloc_v2(1, sizeof(struct sNode), "09while.c", 98, "struct sNode");
        _inf_obj_value1=(struct sWhileNode*)come_increment_ref_count(((struct sWhileNode*)(__right_value86=sWhileNode_initialize((struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc_v2(1, sizeof(struct sWhileNode)*(1), "09while.c", 98, "struct sWhileNode*")),(struct sNode*)come_increment_ref_count(expression_node_102),block_103,info))));
...
struct sWhileNode* __result_obj__54;
    ...
    result_104=(struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc_v2(1, sizeof(struct sWhileNode)*(1), "sWhileNode_clone", 3, "struct sWhileNode*"));
    if(    self!=((void*)0)) {
        result_104->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj38=result_104->sname,
        result_104->sname=(char*)come_increment_ref_count((char*)come_memdup(self->sname, "sWhileNode_clone", 5, "char*"));
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj39=result_104->mExpressionNode,
        result_104->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj40=result_104->mBlock,
        result_104->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
        /*b*/ come_call_finalizer3(__dec_obj40,sBlock_finalize, 0/* alloca value */, 0/* no decrement */, 0/* no_free */, 0/* force_delete_ */, (void*)0);
    }
    __result_obj__54 = result_104;
    /*c*/ come_call_finalizer3(result_104,sWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 1/* force_delete */ , (void*)0);
