...
struct sWhileNode* __result_obj__245;
    ...
    /*c*/ come_call_finalizer3(__result_obj__245,sWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 0/* force_delete */ , (void*)0);
...
char* __result_obj__246;
    __result_obj__246 = come_increment_ref_count(((char*)(__right_value307=__builtin_string("sWhileNode"))));
...
int num_while_conditional_stack_368;
    ...
    without_semicolon_361=info->without_semicolon;
    ...
    info->without_semicolon=without_semicolon_361;
    ...
    if(    normal_if_364) {
        ...
        add_come_code(info,"while((_while_condtional%d=(%s)),",num_while_condtional_367,conditional_value_366->c_value);
...
struct sNode* __result_obj__251;
    if(    charp_operator_equals(buf,"while")) {
        ...
        __result_obj__250 = come_increment_ref_count(((struct sNode*)(__right_value320=_inf_value1)));
        (sname_369 = come_decrement_ref_count(sname_369, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        ((expression_node_371) ? expression_node_371 = come_decrement_ref_count(expression_node_371, ((struct sNode*)expression_node_371)->finalize, ((struct sNode*)expression_node_371)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,0/*force_delete*/, (void*)0):(void*)0);
    ...
    __result_obj__251 = come_increment_ref_count(((struct sNode*)(__right_value321=string_node_v8(buf,head,head_sline,info))));
...
static struct sWhileNode* sWhileNode_clone(struct sWhileNode* self){
struct sWhileNode* __result_obj__248;
void* __right_value316 = (void*)0;
struct sWhileNode* result_373;
...
struct sWhileNode* __result_obj__249;
    if(    self==(void*)0) {
        __result_obj__248 = (void*)0;
        return __result_obj__248;
    }
    result_373=(struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "sWhileNode_clone", 3, "struct sWhileNode*"));
    if(    self!=((void*)0)) {
        result_373->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj58=result_373->sname,
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj59=result_373->mExpressionNode,
    ...
    /*c*/ come_call_finalizer3(result_373,sWhileNode_finalize, 0/* alloca value */, 0/* no_decrement */, 1/* no_free */, 0/* force_delete */ , (void*)0);
