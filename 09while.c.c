...
struct sWhileNode* __result_obj__287;
    ...
    come_call_finalizer3(__result_obj__287,sWhileNode_finalize, 0, 0, 1, 0, (void*)0);
...
char* __result_obj__288;
    __result_obj__288 = come_increment_ref_count(((char*)(__right_value337=__builtin_string("sWhileNode"))));
...
int num_while_conditional_stack_466;
    if(    info->comma_instead_of_semicolon) {
        multiple_assign_var1=((struct tuple2$2int$char$ph*)(__right_value338=err_msg(info,"In conditional operator comelang can't use while statment")));
    ...
    if(    normal_if_462) {
        ...
        add_come_code(info,"while((_while_condtional%d=(%s)),",num_while_condtional_465,conditional_value_464->c_value);
    ...
    transpile_block(block_461,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    add_come_code(info,"}\n");
...
struct sNode* __result_obj__293;
    if(    charp_operator_equals(buf,"while")) {
        ...
        expression_node_469=(struct sNode*)come_increment_ref_count(expression_v13(info));
        expected_next_character(41,info);
        block_470=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "09while.c", 104, "struct sNode", (void*)0, (void*)0, (void*)0, (void*)0);
        _inf_obj_value1=(struct sWhileNode*)come_increment_ref_count(((struct sWhileNode*)(__right_value345=sWhileNode_initialize((struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "09while.c", 104, "struct sWhileNode*", (void*)0, (void*)0, (void*)0, (void*)0)),(struct sNode*)come_increment_ref_count(expression_node_469),block_470,info))));
        ...
        __result_obj__292 = come_increment_ref_count(((struct sNode*)(__right_value350=_inf_value1)));
        (sname_467 = come_decrement_ref_count2(sname_467, (void*)0, (void*)0, 0/* no_decrement*/, 0/* no_free*/, 0/* force_delete_*/, (void*)0));
        ((expression_node_469) ? expression_node_469 = come_decrement_ref_count2(expression_node_469, ((struct sNode*)expression_node_469)->finalize, ((struct sNode*)expression_node_469)->_protocol_obj, 0/* no_decrement */, 0/*no_free*/,0/*force_delete*/, (void*)0):(void*)0);
        come_call_finalizer3(block_470,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        come_call_finalizer3(__right_value345,sWhileNode_finalize, 0, 1, 0, 0, (void*)0);
    ...
    __result_obj__293 = come_increment_ref_count(((struct sNode*)(__right_value351=string_node_v8(buf,head,head_sline,info))));
...
static struct sWhileNode* sWhileNode_clone(struct sWhileNode* self){
struct sWhileNode* __result_obj__290;
void* __right_value346 = (void*)0;
struct sWhileNode* result_471;
...
struct sWhileNode* __result_obj__291;
    if(    self==(void*)0) {
        __result_obj__290 = (void*)0;
        return __result_obj__290;
    }
    result_471=(struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "sWhileNode_clone", 3, "struct sWhileNode*", (void*)0, (void*)0, (void*)0, (void*)0));
    if(    self!=((void*)0)) {
        result_471->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj58=result_471->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj59=result_471->mExpressionNode;
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj60=result_471->mBlock;
        result_471->mBlock=(struct sBlock*)come_increment_ref_count(come_call_cloner(sBlock_clone, self->mBlock));
    ...
    come_call_finalizer3(result_471,sWhileNode_finalize, 0, 0, 1, 0, (void*)0);
