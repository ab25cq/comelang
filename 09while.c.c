...
struct sWhileNode* __result233__;
...
char* __result234__;
    __result234__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value272=__builtin_string("sWhileNode")));
...
int num_while_conditional_stack_324;
    ...
    if(    normal_if_320) {
        ...
        add_come_code(info,"while((_while_condtional%d=(%s)),",num_while_condtional_323,conditional_value_322->c_value);
...
struct sNode* __result238__;
    if(    charp_operator_equals(buf,"while")) {
        ...
        expression_node_327=(struct sNode*)come_increment_ref_count(expression_v13(info));
        expected_next_character(41,info);
        block_328=(struct sBlock*)come_increment_ref_count(parse_block(info,(_Bool)0,(_Bool)0,(_Bool)0));
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "09while.c", 103, "struct sNode");
        _inf_obj_value1=(struct sWhileNode*)come_increment_ref_count(((struct sWhileNode*)(__right_value279=sWhileNode_initialize((struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "09while.c", 103, "sWhileNode")),(struct sNode*)come_increment_ref_count(expression_node_327),block_328,info))));
        ...
        __result237__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value284=_inf_value1));
        /* U13 */sname_325 = come_decrement_ref_count2(sname_325, (void*)0, (void*)0, 0, 0, 0, (void*)0);
        if(expression_node_327) { expression_node_327 = come_decrement_ref_count2(expression_node_327, ((struct sNode*)expression_node_327)->finalize, ((struct sNode*)expression_node_327)->_protocol_obj, 0, 0, 0, (void*)0); } 
        /*i*/come_call_finalizer3(block_328,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        /*g*/come_call_finalizer3(__right_value279,sWhileNode_finalize, 0, 1, 0, 0, __result_obj__);
    ...
    __result238__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value285=string_node_v8(buf,head,head_sline,info)));
...
struct sWhileNode* __result236__;
    if(    self==(void*)0) {
        __result235__ = gComeFunResultObject = __result_obj__ = (void*)0;
        gComeFunResultObject = (void*)0;
        return __result235__;
    }
    result_329=(struct sWhileNode*)come_increment_ref_count((struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "sWhileNode_clone", 3, "sWhileNode"));
    if(    self!=((void*)0)) {
        result_329->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj78=result_329->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj79=result_329->mExpressionNode;
        result_329->mExpressionNode=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj80=result_329->mBlock;
        result_329->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
    ...
    /*i*/come_call_finalizer3(result_329,sWhileNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
