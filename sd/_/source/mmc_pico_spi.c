...
*/
#define DEF_SPI_TX_PIN#define DEF_SPI_RX_PIN#define DEF_SPI_SCK_PIN#define DEF_SPI_CSN_PIN
#define SPIDEV
#define FCLK_FAST(){ }
#define FCLK_SLOW(){ }
...
#define CT_MMC30x01/* MMC ver 3 */
#define CT_MMC40x02/* MMC ver 4+ */
#define CT_MMC40x02#define CT_SDC10x02/* SDC ver 1 */
#define CT_SDC20x04/* SDC ver 2+ */
#define CT_SDC20x04#define CT_BLOCK

/* MMC/SD command */
#define CMD0(0)/* GO_IDLE_STATE */
#define CMD1(1)/* SEND_OP_COND (MMC) */
#define#define CMD8(8)/* SEND_IF_COND */
...
#define#define CMD24(24)/* WRITE_BLOCK */
