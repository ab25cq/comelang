...
struct tuple2$2sFunpcharph* __result406__;
    ...
    if(    type->mPointerNum>0&&klass_943->mStruct||type->mAllocaValue) {
        ...
        for(        o2_saved_953=(struct list$1objectph*)come_increment_ref_count((klass_943->mFields)),it_956=list$1objectph_begin((o2_saved_953));        !list$1objectph_end((o2_saved_953));        it_956=list$1objectph_next((o2_saved_953))        ){
            multiple_assign_var11=((__tmp_infY1=it_956),((struct tuple2$2charphsTypeph*)(__tmp_infY1 ? __tmp_infY1->_protocol_obj:(void*)0)));
        ...
        result_type_969=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "05function.c", 2995, "sType")),"void",(_Bool)0,info));
...
list$1sTypeph_initialize_with_values((struct list$1sTypeph*)come_increment_ref_count((struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "05function.c", 3005, "struct list$1sTypeph")),1,__list_values21___972)));
...
list$1charph_initialize_with_values((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "05function.c", 3006, "struct list$1charph")),1,__list_values22___974)));
        __right_value1059 = come_decrement_ref_count2(__right_value1059, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
        param_default_parametors_976=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "05function.c", 3007, "list$1charph"))));
        list$1charph_push_back(param_default_parametors_976,((void*)0));
        header_buf_977=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "05function.c", 3010, "buffer"))));
        ...
        for(        i_978=0;        i_978<list$1sTypeph_length(param_types_973);        i_978++        ){
            param_type_979=((struct sType*)come_null_check(((struct sType*)(__right_value1067=list$1sTypephp_operator_load_element(param_types_973,i_978))), "05function.c", 3018, 7));
            come_call_finalizer3(__right_value1067,sType_finalize, 0, 1, 0, 0, __result_obj__);
            param_name_980=((char*)come_null_check(((char*)(__right_value1068=list$1charphp_operator_load_element(param_names_975,i_978))), "05function.c", 3019, 8));
        ...
        if(        fun2_981==((void*)0)||fun2_981->mExternal) {
            ...
            _inf_obj_value9=(struct sFunNode*)come_increment_ref_count(((struct sFunNode*)(__right_value1080=sFunNode_initialize((struct sFunNode*)come_increment_ref_count((struct sFunNode*)come_calloc(1, sizeof(struct sFunNode)*(1), "05function.c", 3049, "sFunNode")),(struct sFun*)come_increment_ref_count(fun_982),info))));
    ...
    __result406__ = gComeFunResultObject = __result_obj__ = ((struct tuple2$2sFunpcharph*)(__right_value1086=tuple2$2sFunpcharph_initialize((struct tuple2$2sFunpcharph*)come_increment_ref_count((struct tuple2$2sFunpcharph*)come_calloc(1, sizeof(struct tuple2$2sFunpcharph)*(1), "05function.c", 3073, "struct tuple2$2sFunpcharph")),finalizer_938,(char*)come_increment_ref_count(real_fun_name_939))));
...
struct tuple2$2sFunpcharph* __result409__;
    ...
    if(    type->mPointerNum>0&&!klass_993->mNumber) {
        source_994=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "05function.c", 3099, "buffer"))));
        ...
        if(        klass_993->mProtocol) {
            ...
            for(            o2_saved_997=(struct list$1objectph*)come_increment_ref_count((klass_993->mFields)),it_998=list$1objectph_begin((o2_saved_997));            !list$1objectph_end((o2_saved_997));            it_998=list$1objectph_next((o2_saved_997))            ){
                multiple_assign_var12=((__tmp_infY2=it_998),((struct tuple2$2charphsTypeph*)(__tmp_infY2 ? __tmp_infY2->_protocol_obj:(void*)0)));
                ...
                if(                string_operator_equals(type->mClass->mName,field_type_1000->mClass->mName)&&type->mPointerNum==field_type_1000->mPointerNum&&field_type_1000->mHeap) {
        ...
        result_type_1008=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "05function.c", 3145, "sType")),"bool",(_Bool)0,info));
...
list$1sTypeph_initialize_with_values((struct list$1sTypeph*)come_increment_ref_count((struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "05function.c", 3151, "struct list$1sTypeph")),2,__list_values23___1012)));
...
list$1charph_initialize_with_values((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "05function.c", 3152, "struct list$1charph")),2,__list_values24___1014)));
        ...
        param_default_parametors_1016=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "05function.c", 3153, "list$1charph"))));
        list$1charph_push_back(param_default_parametors_1016,((void*)0));
        list$1charph_push_back(param_default_parametors_1016,((void*)0));
        header_buf_1017=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "05function.c", 3157, "buffer"))));
        ...
        for(        i_1018=0;        i_1018<list$1sTypeph_length(param_types_1013);        i_1018++        ){
            param_type_1019=((struct sType*)come_null_check(((struct sType*)(__right_value1110=list$1sTypephp_operator_load_element(param_types_1013,i_1018))), "05function.c", 3165, 9));
            come_call_finalizer3(__right_value1110,sType_finalize, 0, 1, 0, 0, __result_obj__);
            param_name_1020=((char*)come_null_check(((char*)(__right_value1111=list$1charphp_operator_load_element(param_names_1015,i_1018))), "05function.c", 3166, 10));
        ...
        if(        fun2_1021==((void*)0)||fun2_1021->mExternal) {
            ...
            _inf_obj_value10=(struct sFunNode*)come_increment_ref_count(((struct sFunNode*)(__right_value1123=sFunNode_initialize((struct sFunNode*)come_increment_ref_count((struct sFunNode*)come_calloc(1, sizeof(struct sFunNode)*(1), "05function.c", 3194, "sFunNode")),(struct sFun*)come_increment_ref_count(fun_1022),info))));
    ...
    __result409__ = gComeFunResultObject = __result_obj__ = ((struct tuple2$2sFunpcharph*)(__right_value1129=tuple2$2sFunpcharph_initialize((struct tuple2$2sFunpcharph*)come_increment_ref_count((struct tuple2$2sFunpcharph*)come_calloc(1, sizeof(struct tuple2$2sFunpcharph)*(1), "05function.c", 3220, "struct tuple2$2sFunpcharph")),equaler_990,(char*)come_increment_ref_count(real_fun_name_991))));
...
struct tuple2$2sFunpcharph* __result412__;
    ...
    if(    type->mPointerNum>0&&!klass_1033->mNumber) {
        source_1034=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "05function.c", 3245, "buffer"))));
        ...
        if(        klass_1033->mProtocol) {
            ...
            for(            o2_saved_1039=(struct list$1objectph*)come_increment_ref_count((klass_1033->mFields)),it_1040=list$1objectph_begin((o2_saved_1039));            !list$1objectph_end((o2_saved_1039));            it_1040=list$1objectph_next((o2_saved_1039))            ){
                multiple_assign_var13=((__tmp_infY3=it_1040),((struct tuple2$2charphsTypeph*)(__tmp_infY3 ? __tmp_infY3->_protocol_obj:(void*)0)));
                ...
                if(                string_operator_equals(type->mClass->mName,field_type_1042->mClass->mName)&&type->mPointerNum==field_type_1042->mPointerNum&&field_type_1042->mHeap) {
                    err_msg(info,"Define recusively the equals. I recommanded tuple1<%s>*%.\n",type->mClass->mName);
                    exit(2);
                }
        ...
        result_type_1052=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "05function.c", 3311, "sType")),"bool",(_Bool)0,info));
...
list$1sTypeph_initialize_with_values((struct list$1sTypeph*)come_increment_ref_count((struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "05function.c", 3317, "struct list$1sTypeph")),2,__list_values25___1056)));
...
list$1charph_initialize_with_values((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "05function.c", 3318, "struct list$1charph")),2,__list_values26___1058)));
        ...
        param_default_parametors_1060=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "05function.c", 3319, "list$1charph"))));
        list$1charph_push_back(param_default_parametors_1060,((void*)0));
        list$1charph_push_back(param_default_parametors_1060,((void*)0));
        header_buf_1061=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "05function.c", 3323, "buffer"))));
        ...
        for(        i_1062=0;        i_1062<list$1sTypeph_length(param_types_1057);        i_1062++        ){
            param_type_1063=((struct sType*)come_null_check(((struct sType*)(__right_value1153=list$1sTypephp_operator_load_element(param_types_1057,i_1062))), "05function.c", 3331, 11));
            come_call_finalizer3(__right_value1153,sType_finalize, 0, 1, 0, 0, __result_obj__);
            param_name_1064=((char*)come_null_check(((char*)(__right_value1154=list$1charphp_operator_load_element(param_names_1059,i_1062))), "05function.c", 3332, 12));
        ...
        if(        fun2_1065==((void*)0)||fun2_1065->mExternal) {
            ...
            _inf_obj_value11=(struct sFunNode*)come_increment_ref_count(((struct sFunNode*)(__right_value1166=sFunNode_initialize((struct sFunNode*)come_increment_ref_count((struct sFunNode*)come_calloc(1, sizeof(struct sFunNode)*(1), "05function.c", 3360, "sFunNode")),(struct sFun*)come_increment_ref_count(fun_1066),info))));
    ...
    __result412__ = gComeFunResultObject = __result_obj__ = ((struct tuple2$2sFunpcharph*)(__right_value1172=tuple2$2sFunpcharph_initialize((struct tuple2$2sFunpcharph*)come_increment_ref_count((struct tuple2$2sFunpcharph*)come_calloc(1, sizeof(struct tuple2$2sFunpcharph)*(1), "05function.c", 3386, "struct tuple2$2sFunpcharph")),equaler_1030,(char*)come_increment_ref_count(real_fun_name_1031))));
...
struct tuple2$2sFunpcharph* __result415__;
    ...
    if(    type->mPointerNum>0&&!klass_1077->mNumber) {
        source_1078=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "05function.c", 3411, "buffer"))));
        ...
        if(        klass_1077->mProtocol) {
            ...
            for(            o2_saved_1083=(struct list$1objectph*)come_increment_ref_count((klass_1077->mFields)),it_1084=list$1objectph_begin((o2_saved_1083));            !list$1objectph_end((o2_saved_1083));            it_1084=list$1objectph_next((o2_saved_1083))            ){
                multiple_assign_var14=((__tmp_infY4=it_1084),((struct tuple2$2charphsTypeph*)(__tmp_infY4 ? __tmp_infY4->_protocol_obj:(void*)0)));
        ...
        result_type_1096=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "05function.c", 3474, "sType")),"bool",(_Bool)0,info));
...
list$1sTypeph_initialize_with_values((struct list$1sTypeph*)come_increment_ref_count((struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "05function.c", 3480, "struct list$1sTypeph")),2,__list_values27___1100)));
...
list$1charph_initialize_with_values((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "05function.c", 3481, "struct list$1charph")),2,__list_values28___1102)));
        ...
        param_default_parametors_1104=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "05function.c", 3482, "list$1charph"))));
        list$1charph_push_back(param_default_parametors_1104,((void*)0));
        list$1charph_push_back(param_default_parametors_1104,((void*)0));
        header_buf_1105=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "05function.c", 3486, "buffer"))));
        ...
        for(        i_1106=0;        i_1106<list$1sTypeph_length(param_types_1101);        i_1106++        ){
            param_type_1107=((struct sType*)come_null_check(((struct sType*)(__right_value1196=list$1sTypephp_operator_load_element(param_types_1101,i_1106))), "05function.c", 3494, 13));
            come_call_finalizer3(__right_value1196,sType_finalize, 0, 1, 0, 0, __result_obj__);
            param_name_1108=((char*)come_null_check(((char*)(__right_value1197=list$1charphp_operator_load_element(param_names_1103,i_1106))), "05function.c", 3495, 14));
        ...
        if(        fun2_1109==((void*)0)||fun2_1109->mExternal) {
            ...
            _inf_obj_value12=(struct sFunNode*)come_increment_ref_count(((struct sFunNode*)(__right_value1209=sFunNode_initialize((struct sFunNode*)come_increment_ref_count((struct sFunNode*)come_calloc(1, sizeof(struct sFunNode)*(1), "05function.c", 3523, "sFunNode")),(struct sFun*)come_increment_ref_count(fun_1110),info))));
    ...
    __result415__ = gComeFunResultObject = __result_obj__ = ((struct tuple2$2sFunpcharph*)(__right_value1215=tuple2$2sFunpcharph_initialize((struct tuple2$2sFunpcharph*)come_increment_ref_count((struct tuple2$2sFunpcharph*)come_calloc(1, sizeof(struct tuple2$2sFunpcharph)*(1), "05function.c", 3549, "struct tuple2$2sFunpcharph")),equaler_1074,(char*)come_increment_ref_count(real_fun_name_1075))));
...
struct tuple2$2sFunpcharph* __result418__;
    ...
    if(    type->mPointerNum>0&&!klass_1121->mNumber) {
        source_1122=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "05function.c", 3574, "buffer"))));
        ...
        if(        klass_1121->mProtocol) {
            ...
            for(            o2_saved_1126=(struct list$1objectph*)come_increment_ref_count((klass_1121->mFields)),it_1127=list$1objectph_begin((o2_saved_1126));            !list$1objectph_end((o2_saved_1126));            it_1127=list$1objectph_next((o2_saved_1126))            ){
                multiple_assign_var15=((__tmp_infY5=it_1127),((struct tuple2$2charphsTypeph*)(__tmp_infY5 ? __tmp_infY5->_protocol_obj:(void*)0)));
                ...
                if(                string_operator_equals(type->mClass->mName,field_type_1129->mClass->mName)&&type->mPointerNum==field_type_1129->mPointerNum&&field_type_1129->mHeap) {
                    err_msg(info,"Define recusively the equals. I recommanded tuple1<%s>*%.\n",type->mClass->mName);
                    exit(2);
                }
        ...
        result_type_1137=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "05function.c", 3622, "sType")),"bool",(_Bool)0,info));
...
list$1sTypeph_initialize_with_values((struct list$1sTypeph*)come_increment_ref_count((struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "05function.c", 3628, "struct list$1sTypeph")),2,__list_values29___1141)));
...
list$1charph_initialize_with_values((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "05function.c", 3629, "struct list$1charph")),2,__list_values30___1143)));
        ...
        param_default_parametors_1145=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "05function.c", 3630, "list$1charph"))));
        list$1charph_push_back(param_default_parametors_1145,((void*)0));
        list$1charph_push_back(param_default_parametors_1145,((void*)0));
        header_buf_1146=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "05function.c", 3634, "buffer"))));
        ...
        for(        i_1147=0;        i_1147<list$1sTypeph_length(param_types_1142);        i_1147++        ){
            param_type_1148=((struct sType*)come_null_check(((struct sType*)(__right_value1239=list$1sTypephp_operator_load_element(param_types_1142,i_1147))), "05function.c", 3642, 15));
            come_call_finalizer3(__right_value1239,sType_finalize, 0, 1, 0, 0, __result_obj__);
            param_name_1149=((char*)come_null_check(((char*)(__right_value1240=list$1charphp_operator_load_element(param_names_1144,i_1147))), "05function.c", 3643, 16));
        ...
        if(        fun2_1150==((void*)0)||fun2_1150->mExternal) {
            ...
            _inf_obj_value13=(struct sFunNode*)come_increment_ref_count(((struct sFunNode*)(__right_value1252=sFunNode_initialize((struct sFunNode*)come_increment_ref_count((struct sFunNode*)come_calloc(1, sizeof(struct sFunNode)*(1), "05function.c", 3671, "sFunNode")),(struct sFun*)come_increment_ref_count(fun_1151),info))));
    ...
    __result418__ = gComeFunResultObject = __result_obj__ = ((struct tuple2$2sFunpcharph*)(__right_value1258=tuple2$2sFunpcharph_initialize((struct tuple2$2sFunpcharph*)come_increment_ref_count((struct tuple2$2sFunpcharph*)come_calloc(1, sizeof(struct tuple2$2sFunpcharph)*(1), "05function.c", 3697, "struct tuple2$2sFunpcharph")),equaler_1118,(char*)come_increment_ref_count(real_fun_name_1119))));
...
struct object* it_1173;
struct object* __tmp_infY7;
...
struct tuple2$2sFunpcharph* __result421__;
    ...
    if(    type->mPointerNum>0&&!klass_1162->mNumber) {
        source_1163=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "05function.c", 3722, "buffer"))));
        ...
        if(        klass_1162->mProtocol) {
            ...
            for(            o2_saved_1166=(struct list$1objectph*)come_increment_ref_count((klass_1162->mFields)),it_1167=list$1objectph_begin((o2_saved_1166));            !list$1objectph_end((o2_saved_1166));            it_1167=list$1objectph_next((o2_saved_1166))            ){
                multiple_assign_var16=((__tmp_infY6=it_1167),((struct tuple2$2charphsTypeph*)(__tmp_infY6 ? __tmp_infY6->_protocol_obj:(void*)0)));
                ...
                if(                string_operator_equals(type->mClass->mName,field_type_1169->mClass->mName)&&type->mPointerNum==field_type_1169->mPointerNum&&field_type_1169->mHeap) {
            ...
            for(            o2_saved_1172=(struct list$1objectph*)come_increment_ref_count((klass_1162->mFields)),it_1173=list$1objectph_begin((o2_saved_1172));            !list$1objectph_end((o2_saved_1172));            it_1173=list$1objectph_next((o2_saved_1172))            ){
                multiple_assign_var17=((__tmp_infY7=it_1173),((struct tuple2$2charphsTypeph*)(__tmp_infY7 ? __tmp_infY7->_protocol_obj:(void*)0)));
                ...
                if(                string_operator_equals(type->mClass->mName,field_type_1175->mClass->mName)&&type->mPointerNum==field_type_1175->mPointerNum&&field_type_1175->mHeap) {
                    err_msg(info,"Define recusively the cloner. I recommanded tuple1<%s>*%.\n",type->mClass->mName);
                    exit(2);
                }
...
list$1sTypeph_initialize_with_values((struct list$1sTypeph*)come_increment_ref_count((struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "05function.c", 3816, "struct list$1sTypeph")),1,__list_values31___1188)));
...
list$1charph_initialize_with_values((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "05function.c", 3817, "struct list$1charph")),1,__list_values32___1190)));
        __right_value1273 = come_decrement_ref_count2(__right_value1273, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
        param_default_parametors_1192=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "05function.c", 3818, "list$1charph"))));
        list$1charph_push_back(param_default_parametors_1192,((void*)0));
        header_buf_1193=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "05function.c", 3821, "buffer"))));
        ...
        for(        i_1194=0;        i_1194<list$1sTypeph_length(param_types_1189);        i_1194++        ){
            param_type_1195=((struct sType*)come_null_check(((struct sType*)(__right_value1281=list$1sTypephp_operator_load_element(param_types_1189,i_1194))), "05function.c", 3829, 17));
            come_call_finalizer3(__right_value1281,sType_finalize, 0, 1, 0, 0, __result_obj__);
            param_name_1196=((char*)come_null_check(((char*)(__right_value1282=list$1charphp_operator_load_element(param_names_1191,i_1194))), "05function.c", 3830, 18));
        ...
        if(        fun2_1197==((void*)0)||fun2_1197->mExternal) {
            ...
            _inf_obj_value14=(struct sFunNode*)come_increment_ref_count(((struct sFunNode*)(__right_value1294=sFunNode_initialize((struct sFunNode*)come_increment_ref_count((struct sFunNode*)come_calloc(1, sizeof(struct sFunNode)*(1), "05function.c", 3860, "sFunNode")),(struct sFun*)come_increment_ref_count(fun_1198),info))));
    ...
    __result421__ = gComeFunResultObject = __result_obj__ = ((struct tuple2$2sFunpcharph*)(__right_value1300=tuple2$2sFunpcharph_initialize((struct tuple2$2sFunpcharph*)come_increment_ref_count((struct tuple2$2sFunpcharph*)come_calloc(1, sizeof(struct tuple2$2sFunpcharph)*(1), "05function.c", 3888, "struct tuple2$2sFunpcharph")),cloner_1159,(char*)come_increment_ref_count(real_fun_name_1160))));
...
struct object* it_1213;
struct object* __tmp_infY8;
...
struct tuple2$2sFunpcharph* __result424__;
    ...
    if(    type->mPointerNum>0&&!klass_1209->mNumber) {
        source_1210=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "05function.c", 3913, "buffer"))));
        ...
        for(        o2_saved_1212=(struct list$1objectph*)come_increment_ref_count((klass_1209->mFields)),it_1213=list$1objectph_begin((o2_saved_1212));        !list$1objectph_end((o2_saved_1212));        it_1213=list$1objectph_next((o2_saved_1212))        ){
            multiple_assign_var18=((__tmp_infY8=it_1213),((struct tuple2$2charphsTypeph*)(__tmp_infY8 ? __tmp_infY8->_protocol_obj:(void*)0)));
            ...
            if(            string_operator_equals(type->mClass->mName,field_type_1215->mClass->mName)&&type->mPointerNum==field_type_1215->mPointerNum&&field_type_1215->mHeap) {
                err_msg(info,"Define recusively the cloner. I recommanded tuple1<%s>*%.\n",type->mClass->mName);
                exit(2);
            }
        ...
        result_type_1224=(struct sType*)come_increment_ref_count(sType_initialize((struct sType*)come_increment_ref_count((struct sType*)come_calloc(1, sizeof(struct sType)*(1), "05function.c", 3980, "sType")),"char*",(_Bool)0,info));
...
list$1sTypeph_initialize_with_values((struct list$1sTypeph*)come_increment_ref_count((struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "05function.c", 3985, "struct list$1sTypeph")),1,__list_values33___1227)));
...
list$1charph_initialize_with_values((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "05function.c", 3986, "struct list$1charph")),1,__list_values34___1229)));
        __right_value1314 = come_decrement_ref_count2(__right_value1314, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
        param_default_parametors_1231=(struct list$1charph*)come_increment_ref_count(list$1charph_initialize((struct list$1charph*)come_increment_ref_count((struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "05function.c", 3987, "list$1charph"))));
        list$1charph_push_back(param_default_parametors_1231,((void*)0));
        header_buf_1232=(struct buffer*)come_increment_ref_count(buffer_initialize((struct buffer*)come_increment_ref_count((struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "05function.c", 3990, "buffer"))));
        ...
        for(        i_1233=0;        i_1233<list$1sTypeph_length(param_types_1228);        i_1233++        ){
            param_type_1234=((struct sType*)come_null_check(((struct sType*)(__right_value1322=list$1sTypephp_operator_load_element(param_types_1228,i_1233))), "05function.c", 3998, 19));
            come_call_finalizer3(__right_value1322,sType_finalize, 0, 1, 0, 0, __result_obj__);
            param_name_1235=((char*)come_null_check(((char*)(__right_value1323=list$1charphp_operator_load_element(param_names_1230,i_1233))), "05function.c", 3999, 20));
        ...
        if(        fun2_1236==((void*)0)||fun2_1236->mExternal) {
            ...
            _inf_obj_value15=(struct sFunNode*)come_increment_ref_count(((struct sFunNode*)(__right_value1335=sFunNode_initialize((struct sFunNode*)come_increment_ref_count((struct sFunNode*)come_calloc(1, sizeof(struct sFunNode)*(1), "05function.c", 4031, "sFunNode")),(struct sFun*)come_increment_ref_count(fun_1237),info))));
    ...
    __result424__ = gComeFunResultObject = __result_obj__ = ((struct tuple2$2sFunpcharph*)(__right_value1341=tuple2$2sFunpcharph_initialize((struct tuple2$2sFunpcharph*)come_increment_ref_count((struct tuple2$2sFunpcharph*)come_calloc(1, sizeof(struct tuple2$2sFunpcharph)*(1), "05function.c", 4057, "struct tuple2$2sFunpcharph")),cloner_1206,(char*)come_increment_ref_count(real_fun_name_1207))));
