...
struct list$1CVALUE$ph* __result_obj__21;
    if(    self->len==0    ) {
        ...
        __right_value0 = (void*)0;
        litem_6=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value0=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "/usr/local/include/comelang.h", 7639, "struct list_item$1CVALUE$ph*"))));
        ...
        __right_value0 = (void*)0;
        litem_7=(struct list_item$1CVALUE$ph*)come_increment_ref_count(((struct list_item$1CVALUE$ph*)(__right_value0=(struct list_item$1CVALUE$ph*)come_calloc_v2(1, sizeof(struct list_item$1CVALUE$ph)*(1), "/usr/local/include/comelang.h", 7649, "struct list_item$1CVALUE$ph*"))));
...
struct list$1char$ph* __result_obj__57;
    if(    self->len==0    ) {
        ...
        __right_value0 = (void*)0;
        litem_21=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 7639, "struct list_item$1char$ph*"))));
        ...
        __right_value0 = (void*)0;
        litem_22=(struct list_item$1char$ph*)come_increment_ref_count(((struct list_item$1char$ph*)(__right_value0=(struct list_item$1char$ph*)come_calloc_v2(1, sizeof(struct list_item$1char$ph)*(1), "/usr/local/include/comelang.h", 7649, "struct list_item$1char$ph*"))));
...
struct list$1sNode$ph* __result_obj__64;
    if(    self->len==0    ) {
        ...
        __right_value0 = (void*)0;
        litem_23=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc_v2(1, sizeof(struct list_item$1sNode$ph)*(1), "/usr/local/include/comelang.h", 7639, "struct list_item$1sNode$ph*"))));
        ...
        __right_value0 = (void*)0;
        litem_24=(struct list_item$1sNode$ph*)come_increment_ref_count(((struct list_item$1sNode$ph*)(__right_value0=(struct list_item$1sNode$ph*)come_calloc_v2(1, sizeof(struct list_item$1sNode$ph)*(1), "/usr/local/include/comelang.h", 7649, "struct list_item$1sNode$ph*"))));
...
default_value_89 = (void*)0;
    ...
    keys=(char**)come_increment_ref_count(((char**)(__right_value0=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size)), "/usr/local/include/comelang.h", 8736, "char**"))));
    __right_value0 = (void*)0;
    items=(struct sFun**)come_increment_ref_count(((struct sFun**)(__right_value0=(struct sFun**)come_calloc_v2(1, sizeof(struct sFun*)*(1*(size)), "/usr/local/include/comelang.h", 8737, "struct sFun**"))));
    __right_value0 = (void*)0;
    item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value0=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(size)), "/usr/local/include/comelang.h", 8738, "_Bool*"))));
    len=0;
...
struct list$1sType$ph* __result_obj__107;
    if(    self->len==0    ) {
        ...
        __right_value0 = (void*)0;
        litem_98=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value0=(struct list_item$1sType$ph*)come_calloc_v2(1, sizeof(struct list_item$1sType$ph)*(1), "/usr/local/include/comelang.h", 7639, "struct list_item$1sType$ph*"))));
        ...
        __right_value0 = (void*)0;
        litem_99=(struct list_item$1sType$ph*)come_increment_ref_count(((struct list_item$1sType$ph*)(__right_value0=(struct list_item$1sType$ph*)come_calloc_v2(1, sizeof(struct list_item$1sType$ph)*(1), "/usr/local/include/comelang.h", 7649, "struct list_item$1sType$ph*"))));
            ...
            if(            *info->p==40            ) {
                ...
                if(                *info->p!=42                ) {
                    ...
                    if(                    xisalpha(*info->p)||*info->p==95                    ) {
                        ...
                        if(                        !is_type_name(word_125,info)&&*info->p==41                        ) {
                            info->p++;
                            skip_spaces_and_lf(info);
                            if(                            *info->p==40                            ) {
                            }
    ...
    if(    is_type_name_flag&&!define_function_pointer_result_function&&charp_operator_not_equals(buf,"__typeof__")&&!uniq_class    ) {
        ...
        if(        !info->define_struct        ) {
            ...
            if(            xisalnum(*info->p)||*info->p==95            ) {
                ...
                if(                string_operator_equals(word_130,"extern")                ) {
                    __right_value0 = (void*)0;
            ...
            if(            word_130            ) {
                ...
                if(                strlen(word_130)>0&&(*info->p==40||(*info->p==58&&*(info->p+1)==58))                ) {
            ...
            if(            *info->p==40            ) {
                ...
                if(                *info->p==42                ) {
                    ...
                    if(                    *info->p==41                    ) {
                        info->p++;
                        skip_spaces_and_lf(info);
                        if(                        !is_type_name(word_136,info)&&*info->p!=40                        ) {
                            define_variable=(_Bool)1;
                        }
                    }
            ...
            if(            xisalpha(*info->p)||*info->p==95            ) {
                ...
                if(                xisalpha(*info->p)||*info->p==95                ) {
                    ...
                    if(                    xisalpha(*info->p)||*info->p==95                    ) {
                        ...
                        if(                        string_operator_equals(word_138,"extends")                        ) {
                            define_variable=(_Bool)0;
                        }
                    }
...
struct list$1sVar$ph* __result_obj__120;
    ...
    result=(struct list$1sVar$ph*)come_increment_ref_count(list$1sVar$ph_initialize((struct list$1sVar$ph*)come_increment_ref_count((struct list$1sVar$ph*)come_calloc_v2(1, sizeof(struct list$1sVar$ph)*(1), "/usr/local/include/comelang.h", 7532, "struct list$1sVar$ph*"))));
    it=self->head;
    while(    it!=((void*)0)    ) {
        if(        1        ) {
            __right_value0 = (void*)0;
...
struct list$1sVar$ph* __result_obj__117;
    if(    self->len==0    ) {
        ...
        __right_value0 = (void*)0;
        litem_149=(struct list_item$1sVar$ph*)come_increment_ref_count(((struct list_item$1sVar$ph*)(__right_value0=(struct list_item$1sVar$ph*)come_calloc_v2(1, sizeof(struct list_item$1sVar$ph)*(1), "/usr/local/include/comelang.h", 7561, "struct list_item$1sVar$ph*"))));
        ...
        __right_value0 = (void*)0;
        litem_150=(struct list_item$1sVar$ph*)come_increment_ref_count(((struct list_item$1sVar$ph*)(__right_value0=(struct list_item$1sVar$ph*)come_calloc_v2(1, sizeof(struct list_item$1sVar$ph)*(1), "/usr/local/include/comelang.h", 7571, "struct list_item$1sVar$ph*"))));
...
int i_151;
    ...
    come_free_v2((char*)self->items);
    for(    i_151=0    ;    i_151<self->size    ;    i_151++    ){
        if(        self->item_existance[i_151]        ) {
            if(            1            ) {
...
int i_155;
    ...
    come_free_v2((char*)self->items);
    for(    i_155=0    ;    i_155<self->size    ;    i_155++    ){
        if(        self->item_existance[i_155]        ) {
            if(            1            ) {
...
struct tuple2$2char$phbool$* __result_obj__163;
    ...
    for(    o2_saved_162=(struct list$1char$ph*)come_increment_ref_count(generics_fun->mMethodGenericsTypeNames),it_163=list$1char$ph_begin(o2_saved_162)    ;    !list$1char$ph_end(o2_saved_162)    ;    it_163=list$1char$ph_next(o2_saved_162)    ){
        __right_value0 = (void*)0;
...
fun_name = (void*)0;
    ...
    if(    charp_operator_equals(base_fun_name,"lambda")    ) {
        ...
        if(        *info->p==59        ) {
            ...
            come_call_finalizer(tuple2$2char$phchar$ph$p_finalize, __right_value0, (void*)0, (void*)0, 0, 1, 0, (void*)0);
            if(            string_operator_not_equals(asm_fun_189,"")            ) {
                __right_value0 = (void*)0;
...
default_value_172 = (void*)0;
    ...
    keys=(char**)come_increment_ref_count(((char**)(__right_value0=(char**)come_calloc_v2(1, sizeof(char*)*(1*(size)), "/usr/local/include/comelang.h", 8736, "char**"))));
    __right_value0 = (void*)0;
    items=(struct sGenericsFun**)come_increment_ref_count(((struct sGenericsFun**)(__right_value0=(struct sGenericsFun**)come_calloc_v2(1, sizeof(struct sGenericsFun*)*(1*(size)), "/usr/local/include/comelang.h", 8737, "struct sGenericsFun**"))));
    __right_value0 = (void*)0;
    item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value0=(_Bool*)come_calloc_v2(1, sizeof(_Bool)*(1*(size)), "/usr/local/include/comelang.h", 8738, "_Bool*"))));
    len=0;
    ...
    if(    cloner==((void*)0)&&!type->mClass->mNumber&&type->mPointerNum>0    ) {
        ...
        if(        klass->mProtocol        ) {
            ...
            for(            o2_saved=(struct list$1tuple2$2char$phsType$ph$ph*)come_increment_ref_count(klass->mFields),it=list$1tuple2$2char$phsType$ph$ph_begin(o2_saved)            ;            !list$1tuple2$2char$phsType$ph$ph_end(o2_saved)            ;            it=list$1tuple2$2char$phsType$ph$ph_next(o2_saved)            ){
                ...
                if(                string_operator_equals(name_219,"_protocol_obj")                ) {
                }
            ...
            klass=((struct sClass*)(__right_value0=map$2char$phsClass$ph_operator_load_element(info->classes,klass->mName)));
            come_call_finalizer(sClass_finalize, __right_value0, (void*)0, (void*)0, 0, 1, 0, (void*)0);
            for(            o2_saved_222=(struct list$1tuple2$2char$phsType$ph$ph*)come_increment_ref_count(klass->mFields),it_223=list$1tuple2$2char$phsType$ph$ph_begin(o2_saved_222)            ;            !list$1tuple2$2char$phsType$ph$ph_end(o2_saved_222)            ;            it_223=list$1tuple2$2char$phsType$ph$ph_next(o2_saved_222)            ){
                ...
                else if(                list$1sNode$ph_length(field_type_225->mArrayNum)>0                ) {
...
memset(&i, 0, sizeof(int));
    ...
    if(    to_string_fun==((void*)0)&&type->mPointerNum>0&&!klass->mNumber    ) {
        ...
        for(        o2_saved=(struct list$1tuple2$2char$phsType$ph$ph*)come_increment_ref_count(klass->mFields),it=list$1tuple2$2char$phsType$ph$ph_begin(o2_saved)        ;        !list$1tuple2$2char$phsType$ph$ph_end(o2_saved)        ;        it=list$1tuple2$2char$phsType$ph$ph_next(o2_saved)        ){
            ...
            else if(            i_232==list$1tuple2$2char$phsType$ph$ph_length(klass->mFields)-1            ) {
