...
struct list$1sTypeph* __result315__;
    if(    self->len==0) {
        litem_511=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value431=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang.h", 1087, "list_item$1sTypeph"))));
        ...
        litem_512=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value432=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang.h", 1097, "list_item$1sTypeph"))));
        ...
        litem_513=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value433=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang.h", 1107, "list_item$1sTypeph"))));
...
default_value_536 = (void*)0;
    ...
    keys_521=(char**)come_increment_ref_count(((char**)(__right_value452=(char**)come_calloc(1, sizeof(char*)*(1*(size_520)), "/usr/local/include/comelang.h", 2492, "char*%"))));
    items_522=(struct sFun**)come_increment_ref_count(((struct sFun**)(__right_value453=(struct sFun**)come_calloc(1, sizeof(struct sFun*)*(1*(size_520)), "/usr/local/include/comelang.h", 2493, "sFun*%"))));
    item_existance_523=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value454=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_520)), "/usr/local/include/comelang.h", 2494, "bool"))));
    len_524=0;
...
default_value_704 = (void*)0;
    ...
    result_698=(struct map$2charphsVarph*)come_increment_ref_count(map$2charphsVarph_initialize((struct map$2charphsVarph*)come_increment_ref_count((struct map$2charphsVarph*)come_calloc(1, sizeof(struct map$2charphsVarph)*(1), "/usr/local/include/comelang.h", 2335, "map$2charphsVarph"))));
    __dec_obj202=result_698->key_list;
    result_698->key_list=(struct list$1charp*)come_increment_ref_count(list$1charp_initialize((struct list$1charp*)come_increment_ref_count((struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "/usr/local/include/comelang.h", 2337, "list$1charp"))));
...
struct map$2charphsVarph* __result342__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value779=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "/usr/local/include/comelang.h", 2264, "char*%"))));
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value780=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(128)), "/usr/local/include/comelang.h", 2265, "sVar*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value781=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "/usr/local/include/comelang.h", 2266, "bool"))));
...
default_value_718 = (void*)0;
    ...
    keys_709=(char**)come_increment_ref_count(((char**)(__right_value787=(char**)come_calloc(1, sizeof(char*)*(1*(size_708)), "/usr/local/include/comelang.h", 2492, "char*%"))));
    items_710=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value788=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_708)), "/usr/local/include/comelang.h", 2493, "sVar*%"))));
    item_existance_711=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value789=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_708)), "/usr/local/include/comelang.h", 2494, "bool"))));
    len_712=0;
...
default_value_852 = (void*)0;
    ...
    keys_837=(char**)come_increment_ref_count(((char**)(__right_value905=(char**)come_calloc(1, sizeof(char*)*(1*(size_836)), "/usr/local/include/comelang.h", 2492, "char*%"))));
    items_838=(struct sGenericsFun**)come_increment_ref_count(((struct sGenericsFun**)(__right_value906=(struct sGenericsFun**)come_calloc(1, sizeof(struct sGenericsFun*)*(1*(size_836)), "/usr/local/include/comelang.h", 2493, "sGenericsFun*%"))));
    item_existance_839=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value907=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_836)), "/usr/local/include/comelang.h", 2494, "bool"))));
    len_840=0;
