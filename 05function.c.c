...
struct list$1sNodeph* __result94__;
    if(self->len==0) {
        litem_110=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value181=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang.h", 221, "list_item$1sNodeph"))));
        ...
        if(self->len==1) {
            litem_111=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value182=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang.h", 231, "list_item$1sNodeph"))));
            ...
            litem_112=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value183=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang.h", 241, "list_item$1sNodeph"))));
...
struct list$1sTypeph* __result116__;
    if(self->len==0) {
        litem_177=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value221=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "./comelang.h", 221, "list_item$1sTypeph"))));
        ...
        if(self->len==1) {
            litem_178=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value222=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "./comelang.h", 231, "list_item$1sTypeph"))));
            ...
            litem_179=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value223=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "./comelang.h", 241, "list_item$1sTypeph"))));
...
struct list$1charph* __result118__;
    if(self->len==0) {
        litem_183=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value231=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 221, "list_item$1charph"))));
        ...
        if(self->len==1) {
            litem_184=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value232=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 231, "list_item$1charph"))));
            ...
            litem_185=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value233=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 241, "list_item$1charph"))));
...
default_value_205 = (void*)0;
    ...
    keys_190=(char**)come_increment_ref_count(((char**)(__right_value245=(char**)come_calloc(1, sizeof(char*)*(1*(size_189)), "./comelang.h", 1620, "char*%"))));
    items_191=(struct sFun**)come_increment_ref_count(((struct sFun**)(__right_value246=(struct sFun**)come_calloc(1, sizeof(struct sFun*)*(1*(size_189)), "./comelang.h", 1621, "sFun*%"))));
    item_existance_192=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value247=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_189)), "./comelang.h", 1622, "bool"))));
    len_193=0;
...
default_value_393 = (void*)0;
    ...
    result_387=(struct map$2charphsVarph*)come_increment_ref_count(map$2charphsVarph_initialize((struct map$2charphsVarph*)come_increment_ref_count((struct map$2charphsVarph*)come_calloc(1, sizeof(struct map$2charphsVarph)*(1), "./comelang.h", 1463, "map$2charphsVarph"))));
    __dec_obj160=result_387->key_list;
    result_387->key_list=(struct list$1charp*)come_increment_ref_count(list$1charp_initialize((struct list$1charp*)come_increment_ref_count((struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "./comelang.h", 1465, "list$1charp"))));
...
struct map$2charphsVarph* __result155__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value572=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 1369, "char*%"))));
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value573=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(128)), "./comelang.h", 1370, "sVar*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value574=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 1371, "bool"))));
...
default_value_407 = (void*)0;
    ...
    keys_398=(char**)come_increment_ref_count(((char**)(__right_value580=(char**)come_calloc(1, sizeof(char*)*(1*(size_397)), "./comelang.h", 1620, "char*%"))));
    items_399=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value581=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_397)), "./comelang.h", 1621, "sVar*%"))));
    item_existance_400=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value582=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_397)), "./comelang.h", 1622, "bool"))));
    len_401=0;
...
default_value_552 = (void*)0;
    ...
    keys_537=(char**)come_increment_ref_count(((char**)(__right_value700=(char**)come_calloc(1, sizeof(char*)*(1*(size_536)), "./comelang.h", 1620, "char*%"))));
    items_538=(struct sGenericsFun**)come_increment_ref_count(((struct sGenericsFun**)(__right_value701=(struct sGenericsFun**)come_calloc(1, sizeof(struct sGenericsFun*)*(1*(size_536)), "./comelang.h", 1621, "sGenericsFun*%"))));
    item_existance_539=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value702=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_536)), "./comelang.h", 1622, "bool"))));
    len_540=0;
