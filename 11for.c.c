...
struct list$1sNodeph* __result70__;
    if(self->len==0) {
        litem_70=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value124=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang2.h", 151, "list_item$1sNodeph"))));
        ...
        if(self->len==1) {
            litem_71=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value125=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang2.h", 161, "list_item$1sNodeph"))));
            ...
            litem_72=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value126=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang2.h", 171, "list_item$1sNodeph"))));
...
struct map$2charphsVarph* __result75__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value131=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang2.h", 1369, "char*%"))));
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value132=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(128)), "./comelang2.h", 1370, "sVar*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value133=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang2.h", 1371, "bool"))));
...
default_value_107 = (void*)0;
    ...
    keys_98=(char**)come_increment_ref_count(((char**)(__right_value139=(char**)come_calloc(1, sizeof(char*)*(1*(size_97)), "./comelang2.h", 1620, "char*%"))));
    items_99=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value140=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_97)), "./comelang2.h", 1621, "sVar*%"))));
    item_existance_100=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value141=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_97)), "./comelang2.h", 1622, "bool"))));
    len_101=0;
