...
conditional_value3_332 = (void*)0;
    ...
    if(    expression_node_319) {
        ...
        if(        !Value_322) {
            ...
            /*i*/come_call_finalizer3(for_var_table_318,sVarTable_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(conditional_value_320,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    ...
    if(    expression_node2_324) {
        ...
        if(        !Value_327) {
            ...
            /*i*/come_call_finalizer3(for_var_table_318,sVarTable_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(conditional_value_320,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(conditional_value2_325,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
    ...
    if(    expression_node3_331) {
        ...
        if(        !Value_334) {
            ...
            /*i*/come_call_finalizer3(conditional_value_320,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(conditional_value2_325,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(conditional_value3_332,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
        ...
        if(        normal_if_335) {
            ...
            /*i*/come_call_finalizer3(conditional_value3_336,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
        }
        else {
            add_last_code_to_source_with_comma(info);
            ...
            free_right_value_objects(info,(_Bool)1);
            add_come_code(info,"0");
            /*i*/come_call_finalizer3(conditional_value3_337,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
        }
    }
    add_come_code(info,"){\n");
...
struct list$1sNodeph* __result203__;
    if(    self->len==0) {
        litem_253=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value253=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 1040, "list_item$1sNodeph"))));
        ...
        litem_254=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value254=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 1050, "list_item$1sNodeph"))));
        ...
        litem_255=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value255=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 1060, "list_item$1sNodeph"))));
...
struct map$2charphsVarph* __result208__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value260=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "/usr/local/include/comelang.h", 2287, "char*%"))));
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value261=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(128)), "/usr/local/include/comelang.h", 2288, "sVar*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value262=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "/usr/local/include/comelang.h", 2289, "bool"))));
...
default_value_288 = (void*)0;
    ...
    keys_279=(char**)come_increment_ref_count(((char**)(__right_value268=(char**)come_calloc(1, sizeof(char*)*(1*(size_278)), "/usr/local/include/comelang.h", 2515, "char*%"))));
    items_280=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value269=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_278)), "/usr/local/include/comelang.h", 2516, "sVar*%"))));
    item_existance_281=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value270=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_278)), "/usr/local/include/comelang.h", 2517, "bool"))));
    len_282=0;
...
expression_node3_340 = (void*)0;
    if(    charp_operator_equals(buf,"for")) {
        ...
        /*i*/come_call_finalizer3(block_341,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        /*g*/come_call_finalizer3(__right_value288,sForNode_finalize, 0, 1, 0, 0, __result_obj__);
...
struct sForNode* __result240__;
    ...
    /*i*/come_call_finalizer3(result_342,sForNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
