...
struct map$2charphsVarph* __result75__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value131=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 1379, "char*%"))));
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value132=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(128)), "./comelang.h", 1380, "sVar*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value133=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 1381, "bool"))));
...
default_value_109 = (void*)0;
    ...
    keys_100=(char**)come_increment_ref_count(((char**)(__right_value139=(char**)come_calloc(1, sizeof(char*)*(1*(size_99)), "./comelang.h", 1630, "char*%"))));
    items_101=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value140=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_99)), "./comelang.h", 1631, "sVar*%"))));
    item_existance_102=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value141=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_99)), "./comelang.h", 1632, "bool"))));
    len_103=0;
