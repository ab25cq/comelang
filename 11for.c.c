...
char* __result259__;
    __result259__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value309=__builtin_string("sForNode")));
...
struct sVarTable* lv_table_341;
void* __right_value310 = (void*)0;
void* __right_value311 = (void*)0;
struct sVarTable* for_var_table_342;
...
struct sNode* expression_node2_348;
struct CVALUE* conditional_value2_349;
...
int num_for_conditionalA_stack_354;
void* __right_value315 = (void*)0;
struct CVALUE* __dec_obj85;
struct sNode* expression_node3_355;
struct CVALUE* conditional_value3_356;
...
conditional_value3_356 = (void*)0;
    ...
    lv_table_341=info->lv_table;
    for_var_table_342=(struct sVarTable*)come_increment_ref_count(sVarTable_initialize((struct sVarTable*)come_increment_ref_count((struct sVarTable*)come_calloc(1, sizeof(struct sVarTable)*(1), "11for.c", 57, "sVarTable")),(_Bool)0,lv_table_341));
    info->lv_table=for_var_table_342;
    add_come_code(info,"for(");
    expression_node_343=self->mExpressionNode;
    conditional_value_344=((void*)0);
    if(    expression_node_343) {
        ...
        Value_346=node_compile(expression_node_343,info);
        if(        !Value_346) {
            __result260__ = (_Bool)0;
            /*i*/come_call_finalizer3(for_var_table_342,sVarTable_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(conditional_value_344,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
            return __result260__;
        }
        else {
        }
        info->comma_instead_of_semicolon=comma_instead_of_semicolon_345;
        normal_if_347=(_Bool)1;
        if(        existance_free_right_value_objects(info)) {
            normal_if_347=(_Bool)0;
        }
        if(        normal_if_347) {
            __dec_obj82=conditional_value_344;
            ...
            add_come_code(info,"%s;",conditional_value_344->c_value);
        }
        else {
            info->without_semicolon=(_Bool)0;
            add_last_code_to_source_with_comma(info);
            __dec_obj83=conditional_value_344;
            conditional_value_344=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
    ...
    expression_node2_348=self->mExpressionNode2;
    conditional_value2_349=((void*)0);
    if(    expression_node2_348) {
        info->without_semicolon=(_Bool)1;
        comma_instead_of_semicolon_350=info->comma_instead_of_semicolon;
        info->comma_instead_of_semicolon=(_Bool)1;
        Value_351=node_compile(expression_node2_348,info);
        if(        !Value_351) {
            __result261__ = (_Bool)0;
            /*i*/come_call_finalizer3(for_var_table_342,sVarTable_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(conditional_value_344,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(conditional_value2_349,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
        ...
        if(        normal_if_352) {
            __dec_obj84=conditional_value2_349;
            conditional_value2_349=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
            come_call_finalizer3(__dec_obj84,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
            dec_stack_ptr(1,info);
            add_come_code(info,"%s;",conditional_value2_349->c_value);
        }
        else {
            static int num_for_condtionalA_353=0;
            add_come_code_at_function_head(info,"_Bool _for_condtionalA%d;\n",++num_for_condtionalA_353);
            num_for_conditionalA_stack_354=num_for_condtionalA_353;
            __dec_obj85=conditional_value2_349;
            conditional_value2_349=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
            come_call_finalizer3(__dec_obj85,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
            dec_stack_ptr(1,info);
            add_come_code(info,"(_for_condtionalA%d=(%s)), ",num_for_condtionalA_353,conditional_value2_349->c_value);
            add_last_code_to_source_with_comma(info);
            free_right_value_objects(info,(_Bool)1);
            add_come_code(info,"_for_condtionalA%d;",num_for_conditionalA_stack_354);
        }
    }
    else {
        add_come_code(info,";");
    }
    expression_node3_355=self->mExpressionNode3;
    if(    expression_node3_355) {
        comma_instead_of_semicolon_357=info->comma_instead_of_semicolon;
        info->comma_instead_of_semicolon=(_Bool)1;
        info->without_semicolon=(_Bool)1;
        Value_358=node_compile(expression_node3_355,info);
        if(        !Value_358) {
            __result262__ = (_Bool)0;
            /*i*/come_call_finalizer3(for_var_table_342,sVarTable_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(conditional_value_344,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(conditional_value2_349,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
            /*i*/come_call_finalizer3(conditional_value3_356,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
        ...
        if(        normal_if_359) {
            ...
            /*i*/come_call_finalizer3(conditional_value3_360,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
        }
        else {
            add_last_code_to_source_with_comma(info);
            ...
            free_right_value_objects(info,(_Bool)1);
            add_come_code(info,"0");
            /*i*/come_call_finalizer3(conditional_value3_361,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
        }
    }
    add_come_code(info,"){\n");
    transpile_block(block_340,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    add_come_code(info,"}\n");
    free_objects(for_var_table_342,((void*)0),info);
    transpiler_clear_last_code(info);
    info->lv_table=lv_table_341;
...
struct sBlock* __result257__;
    ...
    if(    self!=((void*)0)&&self->mVarTable!=((void*)0)) {
        __dec_obj70=result_272->mVarTable;
...
struct list$1sNodeph* __result228__;
    if(    self->len==0) {
        litem_277=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value288=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 1017, "list_item$1sNodeph"))));
        litem_277->prev=((void*)0);
        litem_277->next=((void*)0);
        __dec_obj40=litem_277->item;
        ...
        litem_278=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value289=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 1027, "list_item$1sNodeph"))));
        litem_278->prev=self->head;
        litem_278->next=((void*)0);
        __dec_obj41=litem_278->item;
        ...
        litem_279=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value290=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang.h", 1037, "list_item$1sNodeph"))));
...
default_value_298 = (void*)0;
    ...
    __dec_obj68=result_292->key_list;
...
struct map$2charphsVarph* __result233__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value295=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "/usr/local/include/comelang.h", 2264, "char*%"))));
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value296=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(128)), "/usr/local/include/comelang.h", 2265, "sVar*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value297=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "/usr/local/include/comelang.h", 2266, "bool"))));
...
default_value_312 = (void*)0;
    ...
    keys_303=(char**)come_increment_ref_count(((char**)(__right_value303=(char**)come_calloc(1, sizeof(char*)*(1*(size_302)), "/usr/local/include/comelang.h", 2492, "char*%"))));
    items_304=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value304=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_302)), "/usr/local/include/comelang.h", 2493, "sVar*%"))));
    item_existance_305=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value305=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_302)), "/usr/local/include/comelang.h", 2494, "bool"))));
    len_306=0;
...
expression_node3_364 = (void*)0;
    if(    charp_operator_equals(buf,"for")) {
        ...
        parse_sharp_v5(info);
        if(        *info->p==59) {
            __dec_obj86=expression_node_362;
            expression_node_362=((void*)0);
            ...
            __dec_obj87=expression_node_362;
        ...
        parse_sharp_v5(info);
        if(        *info->p==59) {
            __dec_obj88=expression_node2_363;
            expression_node2_363=((void*)0);
            ...
            __dec_obj89=expression_node2_363;
        ...
        parse_sharp_v5(info);
        if(        *info->p==41) {
            __dec_obj90=expression_node3_364;
            expression_node3_364=((void*)0);
            ...
            __dec_obj91=expression_node3_364;
        ...
        _inf_obj_value1=(struct sForNode*)come_increment_ref_count(((struct sForNode*)(__right_value323=sForNode_initialize((struct sForNode*)come_increment_ref_count((struct sForNode*)come_calloc(1, sizeof(struct sForNode)*(1), "11for.c", 239, "sForNode")),(struct sNode*)come_increment_ref_count(expression_node_362),(struct sNode*)come_increment_ref_count(expression_node2_363),(struct sNode*)come_increment_ref_count(expression_node3_364),block_365,info))));
        ...
        __result266__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value330=_inf_value1));
        if(expression_node_362) { expression_node_362 = come_decrement_ref_count2(expression_node_362, ((struct sNode*)expression_node_362)->finalize, ((struct sNode*)expression_node_362)->_protocol_obj, 0, 0, 0, (void*)0); } 
        if(expression_node2_363) { expression_node2_363 = come_decrement_ref_count2(expression_node2_363, ((struct sNode*)expression_node2_363)->finalize, ((struct sNode*)expression_node2_363)->_protocol_obj, 0, 0, 0, (void*)0); } 
        if(expression_node3_364) { expression_node3_364 = come_decrement_ref_count2(expression_node3_364, ((struct sNode*)expression_node3_364)->finalize, ((struct sNode*)expression_node3_364)->_protocol_obj, 0, 0, 0, (void*)0); } 
        /*i*/come_call_finalizer3(block_365,sBlock_finalize, 0, 0, 0, 0, (void*)0);
        /*g*/come_call_finalizer3(__right_value323,sForNode_finalize, 0, 1, 0, 0, __result_obj__);
    ...
    __result267__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value331=string_node_v10(buf,head,head_sline,info)));
...
struct sForNode* __result265__;
    ...
    result_366=(struct sForNode*)come_increment_ref_count((struct sForNode*)come_calloc(1, sizeof(struct sForNode)*(1), "sForNode_clone", 3, "sForNode"));
    if(    self!=((void*)0)) {
        result_366->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj97=result_366->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj98=result_366->mExpressionNode;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode2!=((void*)0)) {
        __dec_obj99=result_366->mExpressionNode2;
        result_366->mExpressionNode2=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode2));
    ...
    if(    self!=((void*)0)&&self->mExpressionNode3!=((void*)0)) {
        __dec_obj100=result_366->mExpressionNode3;
        result_366->mExpressionNode3=(struct sNode*)come_increment_ref_count(sNode_clone(self->mExpressionNode3));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj101=result_366->mBlock;
        result_366->mBlock=(struct sBlock*)come_increment_ref_count(sBlock_clone(self->mBlock));
    ...
    /*i*/come_call_finalizer3(result_366,sForNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
