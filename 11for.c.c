...
struct list$1sNodeph* __result203__;
    if(    self->len==0) {
        litem_253=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value253=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang.h", 1040, "list_item$1sNodeph"))));
        ...
        litem_254=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value254=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang.h", 1050, "list_item$1sNodeph"))));
        ...
        litem_255=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value255=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang.h", 1060, "list_item$1sNodeph"))));
...
struct map$2charphsVarph* __result208__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value260=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 2287, "char*%"))));
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value261=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(128)), "./comelang.h", 2288, "sVar*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value262=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 2289, "bool"))));
...
default_value_288 = (void*)0;
    ...
    keys_279=(char**)come_increment_ref_count(((char**)(__right_value268=(char**)come_calloc(1, sizeof(char*)*(1*(size_278)), "./comelang.h", 2515, "char*%"))));
    items_280=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value269=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_278)), "./comelang.h", 2516, "sVar*%"))));
    item_existance_281=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value270=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_278)), "./comelang.h", 2517, "bool"))));
    len_282=0;
