...
char* __result265__;
    __result265__ = gComeFunResultObject = __result_obj__ = ((char*)(__right_value322=__builtin_string("sForNode")));
...
struct sVarTable* for_var_table_358;
...
struct CVALUE* conditional_value2_365;
...
int num_for_conditionalA_stack_370;
void* __right_value328 = (void*)0;
struct CVALUE* __dec_obj113;
struct sNode* expression_node3_371;
struct CVALUE* conditional_value3_372;
_Bool comma_instead_of_semicolon_373;
_Bool Value_374;
_Bool __result268__;
_Bool normal_if_375;
void* __right_value329 = (void*)0;
struct CVALUE* conditional_value3_376;
void* __right_value330 = (void*)0;
struct CVALUE* conditional_value3_377;
_Bool __result269__;
conditional_value3_372 = (void*)0;
    ...
    lv_table_357=info->lv_table;
    for_var_table_358=(struct sVarTable*)come_increment_ref_count(sVarTable_initialize((struct sVarTable*)come_increment_ref_count((struct sVarTable*)come_calloc(1, sizeof(struct sVarTable)*(1), "11for.c", 57, "struct sVarTable*", (void*)0, (void*)0)),(_Bool)0,lv_table_357));
    info->lv_table=for_var_table_358;
    add_come_code(info,"for(");
    expression_node_359=self->mExpressionNode;
    conditional_value_360=((void*)0);
    if(    expression_node_359) {
        ...
        Value_362=node_compile(expression_node_359,info);
        if(        !Value_362) {
            __result266__ = (_Bool)0;
            come_call_finalizer3(for_var_table_358,sVarTable_finalize, 0, 0, 0, 0, (void*)0);
        ...
        normal_if_363=(_Bool)1;
        if(        existance_free_right_value_objects(info)) {
            normal_if_363=(_Bool)0;
        }
        if(        normal_if_363) {
            __dec_obj110=conditional_value_360;
            ...
            add_come_code(info,"%s;",conditional_value_360->c_value);
        }
        else {
            info->without_semicolon=(_Bool)0;
            add_last_code_to_source_with_comma(info);
            __dec_obj111=conditional_value_360;
            conditional_value_360=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
    ...
    expression_node2_364=self->mExpressionNode2;
    conditional_value2_365=((void*)0);
    if(    expression_node2_364) {
        info->without_semicolon=(_Bool)1;
        comma_instead_of_semicolon_366=info->comma_instead_of_semicolon;
        info->comma_instead_of_semicolon=(_Bool)1;
        Value_367=node_compile(expression_node2_364,info);
        if(        !Value_367) {
            __result267__ = (_Bool)0;
            come_call_finalizer3(for_var_table_358,sVarTable_finalize, 0, 0, 0, 0, (void*)0);
            come_call_finalizer3(conditional_value_360,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
            come_call_finalizer3(conditional_value2_365,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
        ...
        if(        normal_if_368) {
            __dec_obj112=conditional_value2_365;
            conditional_value2_365=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
            come_call_finalizer3(__dec_obj112,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
            dec_stack_ptr(1,info);
            add_come_code(info,"%s;",conditional_value2_365->c_value);
        }
        else {
            static int num_for_condtionalA_369=0;
            add_come_code_at_function_head(info,"_Bool _for_condtionalA%d;\n",++num_for_condtionalA_369);
            num_for_conditionalA_stack_370=num_for_condtionalA_369;
            __dec_obj113=conditional_value2_365;
            conditional_value2_365=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
            come_call_finalizer3(__dec_obj113,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
            dec_stack_ptr(1,info);
            add_come_code(info,"(_for_condtionalA%d=(%s)), ",num_for_condtionalA_369,conditional_value2_365->c_value);
            add_last_code_to_source_with_comma(info);
            free_right_value_objects(info,(_Bool)1);
            add_come_code(info,"_for_condtionalA%d;",num_for_conditionalA_stack_370);
        }
    }
    else {
        add_come_code(info,";");
    }
    expression_node3_371=self->mExpressionNode3;
    if(    expression_node3_371) {
        comma_instead_of_semicolon_373=info->comma_instead_of_semicolon;
        info->comma_instead_of_semicolon=(_Bool)1;
        info->without_semicolon=(_Bool)1;
        Value_374=node_compile(expression_node3_371,info);
        if(        !Value_374) {
            __result268__ = (_Bool)0;
            come_call_finalizer3(for_var_table_358,sVarTable_finalize, 0, 0, 0, 0, (void*)0);
            come_call_finalizer3(conditional_value_360,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
            come_call_finalizer3(conditional_value2_365,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
            come_call_finalizer3(conditional_value3_372,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
            return __result268__;
        }
        else {
        }
        info->without_semicolon=(_Bool)0;
        info->comma_instead_of_semicolon=comma_instead_of_semicolon_373;
        normal_if_375=(_Bool)1;
        if(        existance_free_right_value_objects(info)) {
            normal_if_375=(_Bool)0;
        }
        if(        normal_if_375) {
            conditional_value3_376=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
            dec_stack_ptr(1,info);
            add_come_code(info,"%s",conditional_value3_376->c_value);
            come_call_finalizer3(conditional_value3_376,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
        }
        else {
            add_last_code_to_source_with_comma(info);
            conditional_value3_377=(struct CVALUE*)come_increment_ref_count(get_value_from_stack(-1,info));
            dec_stack_ptr(1,info);
            free_right_value_objects(info,(_Bool)1);
            add_come_code(info,"0");
            come_call_finalizer3(conditional_value3_377,CVALUE_finalize, 0, 0, 0, 0, (void*)0);
        }
    }
    add_come_code(info,"){\n");
    transpile_block(block_356,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0);
    add_come_code(info,"}\n");
    free_objects(for_var_table_358,((void*)0),info);
    transpiler_clear_last_code(info);
    info->lv_table=lv_table_357;
...
struct sBlock* __result263__;
    ...
    if(    self!=((void*)0)&&self->mVarTable!=((void*)0)) {
        __dec_obj98=result_273->mVarTable;
...
struct list$1sNodeph* __result219__;
    if(    self->len==0) {
        litem_278=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value257=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang.h", 1235, "struct list_item$1sNodeph*", (void*)0, (void*)0))));
        litem_278->prev=((void*)0);
        litem_278->next=((void*)0);
        __dec_obj39=litem_278->item;
        ...
        litem_279=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value258=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang.h", 1245, "struct list_item$1sNodeph*", (void*)0, (void*)0))));
        litem_279->prev=self->head;
        litem_279->next=((void*)0);
        __dec_obj40=litem_279->item;
        ...
        litem_280=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value259=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang.h", 1255, "struct list_item$1sNodeph*", (void*)0, (void*)0))));
...
default_value_299 = (void*)0;
    ...
    __dec_obj67=result_293->key_list;
...
struct map$2charphsVarph* __result224__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value264=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 2480, "char**", (void*)0, (void*)0))));
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value265=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(128)), "./comelang.h", 2481, "struct sVar**", (void*)0, (void*)0))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value266=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 2482, "_Bool*", (void*)0, (void*)0))));
...
default_value_313 = (void*)0;
    ...
    keys_304=(char**)come_increment_ref_count(((char**)(__right_value273=(char**)come_calloc(1, sizeof(char*)*(1*(size_303)), "./comelang.h", 2708, "char**", (void*)0, (void*)0))));
    items_305=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value274=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_303)), "./comelang.h", 2709, "struct sVar**", (void*)0, (void*)0))));
    item_existance_306=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value275=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_303)), "./comelang.h", 2710, "_Bool*", (void*)0, (void*)0))));
    len_307=0;
    for(    it_308=map$2charphsVarph_begin(self);    !map$2charphsVarph_end(self);    it_308=map$2charphsVarph_next(self)    ){
        ...
        it2_310=((struct sVar*)(__right_value276=map$2charphsVarph_at(self,it_308,default_value_309)));
        ...
        while((_Bool)1) {
            if(            item_existance_306[n_312]) {
                ...
                items_305[n_312]=((struct sVar*)(__right_value277=map$2charphsVarph_at(self,it_308,default_value_313)));
...
struct sVar* __result260__;
    ...
    if(    self!=((void*)0)&&self->mFunName!=((void*)0)) {
        __dec_obj96=result_338->mFunName;
...
struct sType* __result259__;
    ...
    if(    self!=((void*)0)&&self->mNoSolvedGenericsType!=((void*)0)) {
        __dec_obj72=result_339->mNoSolvedGenericsType;
    ...
    if(    self!=((void*)0)&&self->mOriginalLoadVarType!=((void*)0)) {
        __dec_obj73=result_339->mOriginalLoadVarType;
    ...
    if(    self!=((void*)0)&&self->mRefferenceOriginalType!=((void*)0)) {
        __dec_obj74=result_339->mRefferenceOriginalType;
    ...
    if(    self!=((void*)0)&&self->mArrayNum!=((void*)0)) {
        __dec_obj81=result_339->mArrayNum;
    ...
    if(    self!=((void*)0)&&self->mParamTypes!=((void*)0)) {
        __dec_obj82=result_339->mParamTypes;
    ...
    if(    self!=((void*)0)&&self->mParamNames!=((void*)0)) {
        __dec_obj86=result_339->mParamNames;
    ...
    if(    self!=((void*)0)&&self->mResultType!=((void*)0)) {
        __dec_obj87=result_339->mResultType;
    ...
    if(    self!=((void*)0)&&self->mAlignas!=((void*)0)) {
        __dec_obj88=result_339->mAlignas;
    ...
    if(    self!=((void*)0)&&self->mChannelType!=((void*)0)) {
        __dec_obj89=result_339->mChannelType;
    ...
    if(    self!=((void*)0)&&self->mSizeNum!=((void*)0)) {
        __dec_obj90=result_339->mSizeNum;
    ...
    if(    self!=((void*)0)&&self->mOriginalTypeName!=((void*)0)) {
        __dec_obj91=result_339->mOriginalTypeName;
    ...
    if(    self!=((void*)0)&&self->mAsmName!=((void*)0)) {
        __dec_obj92=result_339->mAsmName;
...
struct list$1sTypeph* __result252__;
    if(    self->len==0) {
        litem_343=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value291=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "./comelang.h", 1235, "struct list_item$1sTypeph*", (void*)0, (void*)0))));
        litem_343->prev=((void*)0);
        litem_343->next=((void*)0);
        __dec_obj77=litem_343->item;
        ...
        litem_344=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value292=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "./comelang.h", 1245, "struct list_item$1sTypeph*", (void*)0, (void*)0))));
        litem_344->prev=self->head;
        litem_344->next=((void*)0);
        __dec_obj78=litem_344->item;
        ...
        litem_345=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(__right_value293=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "./comelang.h", 1255, "struct list_item$1sTypeph*", (void*)0, (void*)0))));
        litem_345->prev=self->tail;
        litem_345->next=((void*)0);
        __dec_obj79=litem_345->item;
...
struct list$1charph* __result257__;
    if(    self->len==0) {
        litem_350=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value303=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 1235, "struct list_item$1charph*", (void*)0, (void*)0))));
        litem_350->prev=((void*)0);
        litem_350->next=((void*)0);
        __dec_obj83=litem_350->item;
        ...
        litem_351=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value304=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 1245, "struct list_item$1charph*", (void*)0, (void*)0))));
        litem_351->prev=self->head;
        litem_351->next=((void*)0);
        __dec_obj84=litem_351->item;
        ...
        litem_352=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(__right_value305=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang.h", 1255, "struct list_item$1charph*", (void*)0, (void*)0))));
        litem_352->prev=self->tail;
        litem_352->next=((void*)0);
        __dec_obj85=litem_352->item;
...
struct sNode* expression_node2_379;
struct sNode* __dec_obj116;
void* __right_value332 = (void*)0;
struct sNode* __dec_obj117;
struct sNode* expression_node3_380;
...
expression_node_378 = (void*)0;
expression_node2_379 = (void*)0;
expression_node3_380 = (void*)0;
    if(    charp_operator_equals(buf,"for")) {
        expected_next_character(40,info);
        parse_sharp_v5(info);
        if(        *info->p==59) {
            __dec_obj114=expression_node_378;
            expression_node_378=((void*)0);
            ...
            __dec_obj115=expression_node_378;
        ...
        parse_sharp_v5(info);
        if(        *info->p==59) {
            __dec_obj116=expression_node2_379;
            expression_node2_379=((void*)0);
            ...
            __dec_obj117=expression_node2_379;
            expression_node2_379=(struct sNode*)come_increment_ref_count(expression_v13(info));
        ...
        parse_sharp_v5(info);
        if(        *info->p==41) {
            __dec_obj118=expression_node3_380;
            expression_node3_380=((void*)0);
            ...
            __dec_obj119=expression_node3_380;
            expression_node3_380=(struct sNode*)come_increment_ref_count(expression_v13(info));
        ...
        __result272__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value343=_inf_value1));
        ...
        if(expression_node2_379) { expression_node2_379 = come_decrement_ref_count2(expression_node2_379, ((struct sNode*)expression_node2_379)->finalize, ((struct sNode*)expression_node2_379)->_protocol_obj, 0, 0, 0, (void*)0); } 
        if(expression_node3_380) { expression_node3_380 = come_decrement_ref_count2(expression_node3_380, ((struct sNode*)expression_node3_380)->finalize, ((struct sNode*)expression_node3_380)->_protocol_obj, 0, 0, 0, (void*)0); } 
    ...
    __result273__ = gComeFunResultObject = __result_obj__ = ((struct sNode*)(__right_value344=string_node_v10(buf,head,head_sline,info)));
...
struct sForNode* __result271__;
    ...
    result_382=(struct sForNode*)come_increment_ref_count((struct sForNode*)come_calloc(1, sizeof(struct sForNode)*(1), "sForNode_clone", 3, "struct sForNode*", (void*)0, (void*)0));
    if(    self!=((void*)0)) {
        result_382->sline=self->sline;
    }
    if(    self!=((void*)0)&&self->sname!=((void*)0)) {
        __dec_obj120=result_382->sname;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
        __dec_obj121=result_382->mExpressionNode;
    ...
    if(    self!=((void*)0)&&self->mExpressionNode2!=((void*)0)) {
        __dec_obj122=result_382->mExpressionNode2;
        result_382->mExpressionNode2=(struct sNode*)come_increment_ref_count(come_call_cloner(sNode_clone, self->mExpressionNode2));
    ...
    if(    self!=((void*)0)&&self->mExpressionNode3!=((void*)0)) {
        __dec_obj123=result_382->mExpressionNode3;
        result_382->mExpressionNode3=(struct sNode*)come_increment_ref_count(come_call_cloner(sNode_clone, self->mExpressionNode3));
    ...
    if(    self!=((void*)0)&&self->mBlock!=((void*)0)) {
        __dec_obj124=result_382->mBlock;
    ...
    come_call_finalizer3(result_382,sForNode_finalize, 0, 0, 1, 0, (void*)0);
    gComeFunResultObject = (void*)0;
