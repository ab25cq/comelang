...
struct list$1sNodeph* __result70__;
    if(    self->len==0) {
        litem_72=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value124=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang.h", 157, "list_item$1sNodeph"))));
        ...
        litem_73=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value125=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang.h", 167, "list_item$1sNodeph"))));
        ...
        litem_74=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(__right_value126=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang.h", 177, "list_item$1sNodeph"))));
...
struct map$2charphsVarph* __result75__;
    self->keys=(char**)come_increment_ref_count(((char**)(__right_value131=(char**)come_calloc(1, sizeof(char*)*(1*(128)), "./comelang.h", 1404, "char*%"))));
    self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value132=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(128)), "./comelang.h", 1405, "sVar*%"))));
    self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value133=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(128)), "./comelang.h", 1406, "bool"))));
...
default_value_109 = (void*)0;
    ...
    keys_100=(char**)come_increment_ref_count(((char**)(__right_value139=(char**)come_calloc(1, sizeof(char*)*(1*(size_99)), "./comelang.h", 1655, "char*%"))));
    items_101=(struct sVar**)come_increment_ref_count(((struct sVar**)(__right_value140=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_99)), "./comelang.h", 1656, "sVar*%"))));
    item_existance_102=(_Bool*)come_increment_ref_count(((_Bool*)(__right_value141=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_99)), "./comelang.h", 1657, "bool"))));
    len_103=0;
